...
#define INCLUDED_away3d_materials_passes_OrthoSegmentPass
...
class HXCPP_CLASS_ATTRIBUTES OrthoSegmentPass_obj : public  ::away3d::materials::passes::MaterialPassBase_obj
{
	public:
		typedef  ::away3d::materials::passes::MaterialPassBase_obj super;
		typedef OrthoSegmentPass_obj OBJ_;
		OrthoSegmentPass_obj();

	public:
		enum { _hx_ClassId = 0x666961f8 };

		void __construct(Float thickness);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="away3d.materials.passes.OrthoSegmentPass")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"away3d.materials.passes.OrthoSegmentPass"); }
		static ::hx::ObjectPtr< OrthoSegmentPass_obj > __new(Float thickness);
		static ::hx::ObjectPtr< OrthoSegmentPass_obj > __alloc(::hx::Ctx *_hx_ctx,Float thickness);
		...
		::String __ToString() const { return HX_("OrthoSegmentPass",ec,ed,a0,20); }
...
#endif /* INCLUDED_away3d_materials_passes_OrthoSegmentPass */ 
