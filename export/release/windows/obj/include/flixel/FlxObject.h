...
class HXCPP_CLASS_ATTRIBUTES FlxObject_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		static bool allowCollisionDrag(unsigned char type, ::flixel::FlxObject object1, ::flixel::FlxObject object2);
		...
		int wasTouching;
		int allowCollisions;
		unsigned char collisionXDrag;
		unsigned char collisionYDrag;
		...
		virtual  ::flixel::math::FlxBasePoint getMidpoint( ::flixel::math::FlxBasePoint point);
		...
		virtual bool get_collisonXDrag();
		::Dynamic get_collisonXDrag_dyn();

		virtual bool set_collisonXDrag(bool value);
		::Dynamic set_collisonXDrag_dyn();

		virtual  ::flixel::path::FlxPath set_path( ::flixel::path::FlxPath path);
