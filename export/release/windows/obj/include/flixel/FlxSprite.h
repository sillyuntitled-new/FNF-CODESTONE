...
class HXCPP_CLASS_ATTRIBUTES FlxSprite_obj : public  ::flixel::FlxObject_obj
{
	...
	public:
		...
		bool flipY;
		 ...
		 ::flixel::math::FlxBasePoint frameOffset;
		 ::Dynamic frameOffsetAngle;
		 ::flixel::math::FlxBasePoint scale;
		 ::Dynamic blend;
		int color;
		 ::openfl::geom::ColorTransform colorTransform;
		 ::Dynamic onDraw;
		Dynamic onDraw_dyn() { return onDraw;}
		virtual  ::Dynamic set_onDraw( ::Dynamic drawFunc);
		::Dynamic set_onDraw_dyn();

		bool _hx___drawOverrided;
		bool useColorTransform;
		 ::flixel::math::FlxRect clipRect;
		 ::flixel::graphics::tile::FlxGraphicsShader shader;
		bool shaderEnabled;
		 ::flixel::FlxLayer layer;
		 ::flixel::graphics::frames::FlxFrame _frame;
		 ::flixel::graphics::FlxGraphic _frameGraphic;
		signed char _facingHorizontalMult;
		signed char _facingVerticalMult;
		 ...
		 ::flixel::math::FlxBasePoint _scaledFrameOffset;
		Float _sinAngle;
		Float _cosAngle;
		bool _angleChanged;
		...
		virtual  ::flixel::FlxSprite makeSolid(int Width,int Height,::hx::Null< int >  Color,::hx::Null< bool >  Unique,::String Key);
		::Dynamic makeSolid_dyn();
		...
		virtual void doAdditionalMatrixStuff( ::flixel::math::FlxMatrix matrix, ::flixel::FlxCamera camera);
		::Dynamic doAdditionalMatrixStuff_dyn();
		...
		virtual  ::Dynamic getPixelAt( ::flixel::math::FlxBasePoint worldPoint, ::flixel::FlxCamera camera);
		::Dynamic getPixelAt_dyn();

		virtual  ::Dynamic getPixelAtScreen( ::flixel::math::FlxBasePoint screenPoint, ::flixel::FlxCamera camera);
		::Dynamic getPixelAtScreen_dyn();

		virtual  ::flixel::math::FlxBasePoint transformWorldToPixels( ::flixel::math::FlxBasePoint worldPoint, ::flixel::FlxCamera camera, ::flixel::math::FlxBasePoint result);
		::Dynamic transformWorldToPixels_dyn();

		virtual  ::flixel::math::FlxBasePoint transformWorldToPixelsSimple( ::flixel::math::FlxBasePoint worldPoint, ::flixel::math::FlxBasePoint result);
		::Dynamic transformWorldToPixelsSimple_dyn();

		virtual  ::flixel::math::FlxBasePoint transformScreenToPixels( ::flixel::math::FlxBasePoint screenPoint, ::flixel::FlxCamera camera, ::flixel::math::FlxBasePoint result);
		::Dynamic transformScreenToPixels_dyn();

		virtual void calcFrame(::hx::Null< bool >  force);
		::Dynamic calcFrame_dyn();

		virtual  ::openfl::display::BitmapData updateFramePixels();
		::Dynamic updateFramePixels_dyn();

		virtual  ::flixel::math::FlxBasePoint getGraphicMidpoint( ::flixel::math::FlxBasePoint point);
		...
		virtual  ::flixel::math::FlxRect set_rawClipRect( ::flixel::math::FlxRect rect);
		::Dynamic set_rawClipRect_dyn();

		 ::flixel::math::FlxRect get_rawClipRect();
		::Dynamic get_rawClipRect_dyn();
