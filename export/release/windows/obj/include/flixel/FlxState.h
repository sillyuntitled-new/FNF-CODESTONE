...
class HXCPP_CLASS_ATTRIBUTES FlxState_obj : public  ::flixel::group::FlxTypedGroup_obj
{
	...
	public:
		...
		bool _requestSubStateReset;
		 ::flixel::util::FlxSignal1 _subStateOpened;
		 ::flixel::util::FlxSignal1 _subStateClosed;
		virtual void create();
		::Dynamic create_dyn();
		...
		virtual  ::flixel::util::FlxSignal1 get_subStateOpened();
		::Dynamic get_subStateOpened_dyn();

		virtual  ::flixel::util::FlxSignal1 get_subStateClosed();
