...
class HXCPP_CLASS_ATTRIBUTES FlxTypeText_obj : public  ::flixel::text::FlxText_obj
{
	...
	public:
		...
		virtual void start( ::Dynamic Delay,::hx::Null< bool >  ForceRestart,::hx::Null< bool >  AutoErase,::Array< int > SkipKeys, ::Dynamic Callback);
		::Dynamic start_dyn();

		virtual  ::flixel::text::FlxText applyMarkup(::String input,::Array< ::Dynamic> rules);

		virtual void insertBreakLines();
		::Dynamic insertBreakLines_dyn();

		virtual void erase( ::Dynamic Delay,::hx::Null< bool >  ForceRestart,::Array< int > SkipKeys, ::Dynamic Callback);
		::Dynamic erase_dyn();
