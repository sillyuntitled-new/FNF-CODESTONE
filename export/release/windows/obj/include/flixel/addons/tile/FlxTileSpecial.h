...
class HXCPP_CLASS_ATTRIBUTES FlxTileSpecial_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		virtual void paint( ::openfl::display::BitmapData bmd, ::openfl::geom::Point at);
		::Dynamic paint_dyn();

		virtual void addAnimation(::Array< int > tiles,::hx::Null< Float >  frameRate,::Array< ::Dynamic> framesData);
		::Dynamic addAnimation_dyn();

		virtual void fromSpriteAnimation( ::flixel::animation::FlxAnimation anim);
		::Dynamic fromSpriteAnimation_dyn();

		virtual  ::flixel::math::FlxMatrix getMatrix();
		...
		virtual int set_currTileId(int value);
