...
class HXCPP_CLASS_ATTRIBUTES FlxTransitionableState_obj : public  ::flixel::FlxState_obj
{
	...
	public:
		...
		virtual void transitionToState( ::flixel::FlxState nextState);
		::Dynamic transitionToState_dyn();

		virtual void transitionIn();
		::Dynamic transitionIn_dyn();

		virtual void transitionOut( ::Dynamic OnExit);
		...
		virtual bool get_hasTransIn();
		::Dynamic get_hasTransIn_dyn();

		virtual bool get_hasTransOut();
		::Dynamic get_hasTransOut_dyn();

		virtual  ::flixel::addons::transition::Transition createTransition( ::flixel::addons::transition::TransitionData data);
		::Dynamic createTransition_dyn();

		virtual void finishTransIn();
		::Dynamic finishTransIn_dyn();

		virtual void finishTransOut();
