...
class HXCPP_CLASS_ATTRIBUTES Transition_obj : public  ::flixel::FlxSubState_obj
{
	...
	public:
		...
		virtual  ::flixel::addons::transition::TransitionEffect createEffect( ::flixel::addons::transition::TransitionData Data);
		::Dynamic createEffect_dyn();

		virtual  ::Dynamic get_finishCallback();
		::Dynamic get_finishCallback_dyn();

		virtual  ::Dynamic set_finishCallback( ::Dynamic f);
