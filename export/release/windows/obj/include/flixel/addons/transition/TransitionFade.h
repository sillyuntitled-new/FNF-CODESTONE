...
class HXCPP_CLASS_ATTRIBUTES TransitionFade_obj : public  ::flixel::addons::transition::TransitionEffect_obj
{
	...
	public:
		...
		virtual void setTweenValues(int NewStatus,Float DirX,Float DirY);
		::Dynamic setTweenValues_dyn();

		virtual  ::flixel::FlxSprite makeSprite(Float DirX,Float DirY, ::flixel::math::FlxRect region);
		::Dynamic makeSprite_dyn();

		virtual  ::openfl::display::BitmapData getGradient();
		::Dynamic getGradient_dyn();

		virtual void finishTween( ::flixel::tweens::FlxTween f);
