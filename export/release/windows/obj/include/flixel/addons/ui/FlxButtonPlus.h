...
class HXCPP_CLASS_ATTRIBUTES FlxButtonPlus_obj : public  ::flixel::group::FlxTypedSpriteGroup_obj
{
	...
	public:
		...
		int _status;
		bool _initialized;
		virtual void loadButtonGraphic( ::flixel::FlxSprite Normal, ::flixel::FlxSprite Highlight);
		...
		virtual void updateInactiveButtonColors(::Array< int > Colors);
		::Dynamic updateInactiveButtonColors_dyn();

		virtual void updateActiveButtonColors(::Array< int > Colors);
