...
class HXCPP_CLASS_ATTRIBUTES FlxSlider_obj : public  ::flixel::group::FlxTypedSpriteGroup_obj
{
	...
	public:
		...
		virtual void setTexts(::String Name,::hx::Null< bool >  Value,::String Min,::String Max,::hx::Null< int >  Size);
		::Dynamic setTexts_dyn();

		virtual void destroy();

		virtual Float get_expectedPos();
		::Dynamic get_expectedPos_dyn();

		virtual Float get_relativePos();
		::Dynamic get_relativePos_dyn();

		virtual ::String set_varString(::String Value);
