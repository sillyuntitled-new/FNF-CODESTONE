...
class HXCPP_CLASS_ATTRIBUTES FlxBaseAnimation_obj : public ::hx::Object
{
	...
	public:
		...
		static ::hx::ObjectPtr< FlxBaseAnimation_obj > __new( ::flixel::animation::FlxAnimationController Parent,::String Name,::String Prefix);
		static ::hx::ObjectPtr< FlxBaseAnimation_obj > __alloc(::hx::Ctx *_hx_ctx, ::flixel::animation::FlxAnimationController Parent,::String Name,::String Prefix);
