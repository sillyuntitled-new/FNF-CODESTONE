...
class HXCPP_CLASS_ATTRIBUTES FlxAtlas_obj : public ::hx::Object
{
	...
	public:
		...
		virtual  ::flixel::graphics::atlas::FlxNode tryInsert( ::openfl::display::BitmapData data,::String key);
		...
		virtual  ::flixel::graphics::atlas::FlxNode divideNode( ::flixel::graphics::atlas::FlxNode nodeToDivide,int insertWidth,int insertHeight,bool divideHorizontally, ::openfl::display::BitmapData firstGrandChildData,::String firstGrandChildKey,::hx::Null< bool >  firstGrandChildRotated);
		::Dynamic divideNode_dyn();

		virtual  ::flixel::graphics::atlas::FlxNode insertFirstNodeInRoot( ::openfl::display::BitmapData data,::String key);
		::Dynamic insertFirstNodeInRoot_dyn();

		virtual  ::flixel::graphics::atlas::FlxNode expand( ::openfl::display::BitmapData data,::String key);
		::Dynamic expand_dyn();
		...
		virtual  ::flixel::graphics::frames::FlxTileFrames addNodeWithSpacesAndBorders( ::Dynamic Graphic,::String Key, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxBasePoint tileSpacing, ::flixel::math::FlxBasePoint tileBorder, ::flixel::math::FlxRect region);
		...
		virtual void addFromAtlasObjects(::Array< ::Dynamic> objects);
		...
		virtual  ::flixel::graphics::atlas::FlxAtlas addToQueue( ::openfl::display::BitmapData data,::String key);
		::Dynamic addToQueue_dyn();

		virtual  ::flixel::graphics::atlas::FlxAtlas generateFromQueue();
		::Dynamic generateFromQueue_dyn();

		virtual void onClear( ::flixel::FlxState _);
		::Dynamic onClear_dyn();
		...
		virtual  ::flixel::graphics::FlxGraphic get_graphic();
		::Dynamic get_graphic_dyn();

		virtual bool set_persist(bool value);
