...
class HXCPP_CLASS_ATTRIBUTES FlxNode_obj : public ::hx::Object
{
	...
	public:
		...
		virtual  ::flixel::graphics::frames::FlxTileFrames getTileFrames( ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxBasePoint tileSpacing, ::flixel::math::FlxBasePoint tileBorder);
