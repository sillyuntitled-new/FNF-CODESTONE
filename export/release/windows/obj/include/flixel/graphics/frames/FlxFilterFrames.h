...
class HXCPP_CLASS_ATTRIBUTES FlxFilterFrames_obj : public  ::flixel::graphics::frames::FlxFramesCollection_obj
{
	...
	public:
		...
		virtual void applyToSprite( ::flixel::FlxSprite spr,::hx::Null< bool >  saveAnimations,::hx::Null< bool >  updateFrames);
		::Dynamic applyToSprite_dyn();

		virtual void genFrames();
		...
		virtual void regenAndApplyFilters();
		::Dynamic regenAndApplyFilters_dyn();

		virtual void regenBitmaps(::hx::Null< bool >  fill);
		::Dynamic regenBitmaps_dyn();

		virtual void applyFilter( ::openfl::filters::BitmapFilter filter);
