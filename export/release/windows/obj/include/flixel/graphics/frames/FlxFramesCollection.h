...
class HXCPP_CLASS_ATTRIBUTES FlxFramesCollection_obj : public ::hx::Object
{
	...
	public:
		...
		virtual  ::flixel::graphics::frames::FlxFrame addAtlasFrame( ::flixel::math::FlxRect frame, ::flixel::math::FlxBasePoint sourceSize, ::flixel::math::FlxBasePoint offset,::String name,::hx::Null< signed char >  angle,::hx::Null< bool >  flipX,::hx::Null< bool >  flipY,::hx::Null< Float >  duration);
		::Dynamic addAtlasFrame_dyn();

		virtual void setFrameOffset(::String name,Float offsetX,Float offsetY);
		::Dynamic setFrameOffset_dyn();

		virtual void addFrameOffset(::String name,Float offsetX,Float offsetY);
		::Dynamic addFrameOffset_dyn();

		virtual void setFramesOffsetByPrefix(::String prefix,Float offsetX,Float offsetY);
		::Dynamic setFramesOffsetByPrefix_dyn();

		virtual void addFramesOffsetByPrefix(::String prefix,Float offsetX,Float offsetY);
		::Dynamic addFramesOffsetByPrefix_dyn();

		virtual void setFrameDuration(::String name,Float duration);
		::Dynamic setFrameDuration_dyn();

		virtual void setFramesDurationByPrefix(::String prefix,Float duration);
		::Dynamic setFramesDurationByPrefix_dyn();

		virtual  ::flixel::math::FlxRect checkFrame( ::flixel::math::FlxRect frame,::String name);
