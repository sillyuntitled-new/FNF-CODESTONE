...
class HXCPP_CLASS_ATTRIBUTES FlxTypedGroup_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		int maxSize;
		int length;
		 ::flixel::util::FlxSignal1 _memberAdded;
		 ::flixel::util::FlxSignal1 _memberRemoved;
		int _marker;
		...
		::Dynamic set_maxSize_dyn();
		 ...
		 ::flixel::util::FlxSignal1 get_memberAdded();
		::Dynamic get_memberAdded_dyn();

		 ::flixel::util::FlxSignal1 get_memberRemoved();
