...
class HXCPP_CLASS_ATTRIBUTES FlxTypedSpriteGroup_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void transformChildren_transformChildren_V( ::Dynamic Function, ::Dynamic Value);
		::Dynamic transformChildren_transformChildren_V_dyn();
		...
		virtual void preAdd( ::Dynamic Sprite);
		::Dynamic preAdd_dyn();
