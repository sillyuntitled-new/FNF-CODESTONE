...
class HXCPP_CLASS_ATTRIBUTES FlxPointer_obj : public ::hx::Object
{
	...
	public:
		...
		int _globalScreenX;
		int _globalScreenY;
		virtual  ::flixel::math::FlxBasePoint getWorldPosition( ::flixel::FlxCamera Camera, ::flixel::math::FlxBasePoint point);
		::Dynamic getWorldPosition_dyn();

		virtual  ::flixel::math::FlxBasePoint getScreenPosition( ::flixel::FlxCamera Camera, ::flixel::math::FlxBasePoint point);
		::Dynamic getScreenPosition_dyn();

		virtual  ::flixel::math::FlxBasePoint getPositionInCameraView( ::flixel::FlxCamera Camera, ::flixel::math::FlxBasePoint point);
		::Dynamic getPositionInCameraView_dyn();

		virtual  ::flixel::math::FlxBasePoint getPosition( ::flixel::math::FlxBasePoint point);
