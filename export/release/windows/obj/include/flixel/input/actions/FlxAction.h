...
class HXCPP_CLASS_ATTRIBUTES FlxAction_obj : public ::hx::Object
{
	...
	public:
		...
		int _timestamp;
		bool get__checked();
		::Dynamic get__checked_dyn();

		bool set__checked(bool value);
		::Dynamic set__checked_dyn();

		bool steamOriginsChanged;
		virtual int getFirstSteamOrigin();
		::Dynamic getFirstSteamOrigin_dyn();

		virtual ::Array< int > getSteamOrigins(::Array< int > origins);
		::Dynamic getSteamOrigins_dyn();

		virtual void removeAll(::hx::Null< bool >  Destroy);
		::Dynamic removeAll_dyn();

		virtual void remove( ::flixel::input::actions::FlxActionInput Input,::hx::Null< bool >  Destroy);
		::Dynamic remove_dyn();
		...
		virtual bool match( ::flixel::input::actions::FlxAction other);
		::Dynamic match_dyn();

		virtual  ::flixel::input::actions::FlxAction addGenericInput( ::flixel::input::actions::FlxActionInput input);
		::Dynamic addGenericInput_dyn();

		virtual bool checkExists( ::flixel::input::actions::FlxActionInput input);
