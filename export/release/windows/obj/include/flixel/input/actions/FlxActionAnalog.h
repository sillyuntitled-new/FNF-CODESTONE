...
class HXCPP_CLASS_ATTRIBUTES FlxActionAnalog_obj : public  ::flixel::input::actions::FlxAction_obj
{
	...
	public:
		...
		virtual  ::flixel::input::actions::FlxActionAnalog add( ::flixel::input::actions::FlxActionInputAnalog input);
		::Dynamic add_dyn();

		virtual  ::flixel::input::actions::FlxActionAnalog addMouseClickAndDragMotion(int ButtonID,int Trigger,::hx::Null< int >  Axis,::hx::Null< int >  PixelsPerUnit,::hx::Null< Float >  DeadZone,::hx::Null< bool >  InvertY,::hx::Null< bool >  InvertX);
		::Dynamic addMouseClickAndDragMotion_dyn();

		virtual  ::flixel::input::actions::FlxActionAnalog addMouseMotion(int Trigger,::hx::Null< int >  Axis,::hx::Null< int >  PixelsPerUnit,::hx::Null< Float >  DeadZone,::hx::Null< bool >  InvertY,::hx::Null< bool >  InvertX);
		::Dynamic addMouseMotion_dyn();

		virtual  ::flixel::input::actions::FlxActionAnalog addMousePosition(int Trigger,::hx::Null< int >  Axis);
		::Dynamic addMousePosition_dyn();

		virtual  ::flixel::input::actions::FlxActionAnalog addGamepad(int InputID,int Trigger,::hx::Null< int >  Axis,::hx::Null< int >  GamepadID);
