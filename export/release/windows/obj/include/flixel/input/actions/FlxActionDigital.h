...
class HXCPP_CLASS_ATTRIBUTES FlxActionDigital_obj : public  ::flixel::input::actions::FlxAction_obj
{
	...
	public:
		...
		virtual  ::flixel::input::actions::FlxActionDigital add( ::flixel::input::actions::FlxActionInputDigital input);
		::Dynamic add_dyn();

		virtual  ::flixel::input::actions::FlxActionDigital addInput(::Dynamic Input,int Trigger);
		::Dynamic addInput_dyn();

		virtual  ::flixel::input::actions::FlxActionDigital addGamepad(int InputID,int Trigger,::hx::Null< int >  GamepadID);
		::Dynamic addGamepad_dyn();

		virtual  ::flixel::input::actions::FlxActionDigital addKey(int Key,int Trigger);
		::Dynamic addKey_dyn();

		virtual  ::flixel::input::actions::FlxActionDigital addMouse(int ButtonID,int Trigger);
		::Dynamic addMouse_dyn();

		virtual  ::flixel::input::actions::FlxActionDigital addMouseWheel(bool Positive,int Trigger);
