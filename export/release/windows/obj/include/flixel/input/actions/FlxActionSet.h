...
class HXCPP_CLASS_ATTRIBUTES FlxActionSet_obj : public ::hx::Object
{
	...
	public:
		...
		virtual void attachSteamController(int Handle,::hx::Null< bool >  Attach);
		::Dynamic attachSteamController_dyn();

		virtual bool add( ::flixel::input::actions::FlxAction Action);
		::Dynamic add_dyn();

		virtual void destroy();
		::Dynamic destroy_dyn();

		virtual bool remove( ::flixel::input::actions::FlxAction Action,::hx::Null< bool >  Destroy);
		::Dynamic remove_dyn();

		virtual void update();
		::Dynamic update_dyn();

		virtual void attachSteamControllerSub(int Handle,bool Attach, ::flixel::input::actions::FlxInputType InputType,::Array< ::Dynamic> DigitalActions,::Array< ::Dynamic> AnalogActions);
