...
class HXCPP_CLASS_ATTRIBUTES FlxGamepad_obj : public ::hx::Object
{
	...
	public:
		...
		virtual bool checkButtonArrayState(::Array< int > IDArray,int Status);
		::Dynamic checkButtonArrayState_dyn();

		virtual bool checkButtonArrayStateRaw(::Array< int > IDArray,int Status);
		...
		virtual  ::flixel::math::FlxBasePoint getAnalogAxes(int AxesButtonID);
		...
		virtual Float getAnalogAxisValueIndependent(int axisID);
		::Dynamic getAnalogAxisValueIndependent_dyn();

		virtual void handleAxisMove(int axis,Float newValue,Float oldValue);
		::Dynamic handleAxisMove_dyn();

		virtual void handleAxisMoveSub( ::flixel::input::gamepad::FlxGamepadAnalogStick stick,int axis,Float value,Float oldValue,::hx::Null< Float >  sign);
