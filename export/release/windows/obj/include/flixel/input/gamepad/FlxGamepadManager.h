...
class HXCPP_CLASS_ATTRIBUTES FlxGamepadManager_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::ui::GameInput _gameInput;
		 ...
		 ::flixel::util::FlxSignal1 deviceConnected;
		 ::flixel::util::FlxSignal1 deviceDisconnected;
		...
		virtual void onDeviceAdded( ::openfl::events::GameInputEvent Event);
		::Dynamic onDeviceAdded_dyn();

		virtual void onDeviceRemoved( ::openfl::events::GameInputEvent Event);
		::Dynamic onDeviceRemoved_dyn();

		virtual int findGamepadIndex( ::openfl::ui::GameInputDevice Device);
		::Dynamic findGamepadIndex_dyn();

		virtual void addGamepad( ::openfl::ui::GameInputDevice Device);
		::Dynamic addGamepad_dyn();

		virtual  ::flixel::input::gamepad::FlxGamepadModel getModelFromDeviceName(::String name);
		::Dynamic getModelFromDeviceName_dyn();

		virtual void removeGamepad( ::openfl::ui::GameInputDevice Device);
