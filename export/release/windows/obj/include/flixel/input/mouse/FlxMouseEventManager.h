...
class HXCPP_CLASS_ATTRIBUTES FlxMouseEventManager_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		virtual void traverseFlxGroup( ::flixel::group::FlxTypedGroup group,::Array< ::Dynamic> orderedObjects);
		::Dynamic traverseFlxGroup_dyn();

		 ::flixel::input::mouse::FlxMouseEvent get( ::Dynamic object,::Array< ::Dynamic> list);
		::Dynamic get_dyn();

		virtual int sortByMouseChildren( ::flixel::input::mouse::FlxMouseEvent event1, ::flixel::input::mouse::FlxMouseEvent event2);
