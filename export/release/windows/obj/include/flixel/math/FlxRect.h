...
class HXCPP_CLASS_ATTRIBUTES FlxRect_obj : public ::hx::Object
{
	...
	public:
		...
		virtual  ::flixel::math::FlxRect getRotatedBounds(Float degrees, ::flixel::math::FlxBasePoint origin, ::flixel::math::FlxRect newRect, ::flixel::math::FlxBasePoint innerOffset);
		...
		virtual  ::flixel::math::FlxRect intersection( ::flixel::math::FlxRect rect, ::flixel::math::FlxRect result);
