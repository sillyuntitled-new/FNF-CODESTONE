...
class HXCPP_CLASS_ATTRIBUTES FlxDiagonalPathfinder_obj : public  ::flixel::path::FlxTypedPathfinder_obj
{
	...
	public:
		...
		int diagonalPolicy;
		virtual ::Array< int > getNeighbors( ::Dynamic _tmp_data,int from);

		virtual int getInBoundDirections( ::flixel::path::FlxTypedPathfinderData data,int from);
		::Dynamic getInBoundDirections_dyn();

		virtual bool canGo( ::flixel::path::FlxTypedPathfinderData data,int to,::hx::Null< int >  dir);
		::Dynamic canGo_dyn();

		virtual int getDistance( ::Dynamic _tmp_data,int from,int to);
