...
HX_DECLARE_STACK_FRAME(_hx_pos_ac1e30a014ff1e13_892_new)
...
{
            	HX_STACKFRAME(&_hx_pos_ac1e30a014ff1e13_892_new)
HXLINE( 901)		( ( ::flixel::path::FlxPathDrawData)(__this) )->endSize = 5;
HXLINE( 900)		( ( ::flixel::path::FlxPathDrawData)(__this) )->startSize = 5;
HXLINE( 899)		( ( ::flixel::path::FlxPathDrawData)(__this) )->nodeSize = 3;
HXLINE( 898)		( ( ::flixel::path::FlxPathDrawData)(__this) )->lineSize = 1;
HXLINE( 897)		( ( ::flixel::path::FlxPathDrawData)(__this) )->endColor = -65536;
HXLINE( 896)		( ( ::flixel::path::FlxPathDrawData)(__this) )->startColor = -16744448;
HXLINE( 895)		( ( ::flixel::path::FlxPathDrawData)(__this) )->nodeColor = -1;
HXLINE( 894)		( ( ::flixel::path::FlxPathDrawData)(__this) )->lineColor = -1;
HXLINE( 892)		if (::hx::IsNotNull( lineColor )) {
HXDLIN( 892)			( ( ::flixel::path::FlxPathDrawData)(__this) )->lineColor = ( (int)(lineColor) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( nodeColor )) {
HXDLIN( 892)			( ( ::flixel::path::FlxPathDrawData)(__this) )->nodeColor = ( (int)(nodeColor) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( startColor )) {
HXDLIN( 892)			( ( ::flixel::path::FlxPathDrawData)(__this) )->startColor = ( (int)(startColor) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( endColor )) {
HXDLIN( 892)			( ( ::flixel::path::FlxPathDrawData)(__this) )->endColor = ( (int)(endColor) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( lineSize )) {
HXDLIN( 892)			( ( ::flixel::path::FlxPathDrawData)(__this) )->lineSize = ( (int)(lineSize) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( nodeSize )) {
HXDLIN( 892)			( ( ::flixel::path::FlxPathDrawData)(__this) )->nodeSize = ( (int)(nodeSize) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( startSize )) {
HXDLIN( 892)			( ( ::flixel::path::FlxPathDrawData)(__this) )->startSize = ( (int)(startSize) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( endSize )) {
HXDLIN( 892)			( ( ::flixel::path::FlxPathDrawData)(__this) )->endSize = ( (int)(endSize) );
            		}
            	}
