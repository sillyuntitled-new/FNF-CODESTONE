...
class HXCPP_CLASS_ATTRIBUTES FlxBasePreloader_obj : public  ::flixel::_hx_system::DefaultPreloader_obj
{
	public:
	...
	public:
		...
		virtual void onEnterFrame( ::openfl::events::Event E);
		...
		virtual  ::openfl::display::Bitmap createBitmap(::hx::Class bitmapDataClass, ::Dynamic onLoad);
		::Dynamic createBitmap_dyn();

		virtual  ::openfl::display::BitmapData loadBitmapData(::hx::Class bitmapDataClass, ::Dynamic onLoad);
		::Dynamic loadBitmapData_dyn();

		virtual void checkSiteLock();
