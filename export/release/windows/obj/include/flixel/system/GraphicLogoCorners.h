...
#define INCLUDED_flixel_system_GraphicLogoCorners
...
#endif
HX_DECLARE_CLASS2(flixel,_hx_system,GraphicLogoCorners)
...
class HXCPP_CLASS_ATTRIBUTES GraphicLogoCorners_obj : public  ::openfl::display::BitmapData_obj
{
	...
	public:
		enum { _hx_ClassId = 0x25174e36 };

		void __construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="flixel.system.GraphicLogoCorners")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"flixel.system.GraphicLogoCorners"); }
...
#endif /* INCLUDED_flixel_system_GraphicLogoCorners */ 
