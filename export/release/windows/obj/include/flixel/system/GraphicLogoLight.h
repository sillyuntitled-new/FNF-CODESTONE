...
#define INCLUDED_flixel_system_GraphicLogoLight
...
#endif
HX_DECLARE_CLASS2(flixel,_hx_system,GraphicLogoLight)
...
class HXCPP_CLASS_ATTRIBUTES GraphicLogoLight_obj : public  ::openfl::display::BitmapData_obj
{
	...
	public:
		enum { _hx_ClassId = 0x2f5f68d6 };

		void __construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="flixel.system.GraphicLogoLight")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"flixel.system.GraphicLogoLight"); }
...
#endif /* INCLUDED_flixel_system_GraphicLogoLight */ 
