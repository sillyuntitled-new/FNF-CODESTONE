...
class HXCPP_CLASS_ATTRIBUTES Pointer_obj : public  ::flixel::_hx_system::debug::interaction::tools::Tool_obj
{
	...
	public:
		...
		virtual void calculateSelectionArea();
		...
		virtual void stopSelection(::hx::Null< bool >  findItems);
		::Dynamic stopSelection_dyn();

		virtual void updateConsoleSelection();
		::Dynamic updateConsoleSelection_dyn();

		virtual void handleItemAddition(::Array< ::Dynamic> itemsInSelectionArea);
