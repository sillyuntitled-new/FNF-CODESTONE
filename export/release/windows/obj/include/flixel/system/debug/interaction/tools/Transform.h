...
class HXCPP_CLASS_ATTRIBUTES Transform_obj : public  ::flixel::_hx_system::debug::interaction::tools::Tool_obj
{
	...
	public:
		...
		virtual void updateTargetArea();
		::Dynamic updateTargetArea_dyn();

		virtual void startAction(int whichMarker);
		::Dynamic startAction_dyn();

		virtual void stopAction();
		::Dynamic stopAction_dyn();

		virtual ::String getCursorNameByMarker(int marker);
		::Dynamic getCursorNameByMarker_dyn();

		virtual void handleInteractionsWithMarkersUI();
		::Dynamic handleInteractionsWithMarkersUI_dyn();

		virtual ::String formatFloat(Float number);
		::Dynamic formatFloat_dyn();

		virtual void showTooltip(::String text);
		::Dynamic showTooltip_dyn();

		virtual void updateScaleActionDirection();
		::Dynamic updateScaleActionDirection_dyn();

		virtual void updateScaleAction();
		::Dynamic updateScaleAction_dyn();

		virtual void updateRotateAction();
		::Dynamic updateRotateAction_dyn();

		virtual void updateAction();
		::Dynamic updateAction_dyn();

		virtual void updateMarkersPosition();
		::Dynamic updateMarkersPosition_dyn();

		virtual void updateMarkersRotation(Float outlineWidth,Float outlineHeight);
		::Dynamic updateMarkersRotation_dyn();

		virtual void update();

		virtual void drawTargetAreaOutline( ::openfl::display::Graphics gfx);
		::Dynamic drawTargetAreaOutline_dyn();

		virtual void drawMarkers( ::openfl::display::Graphics gfx);
