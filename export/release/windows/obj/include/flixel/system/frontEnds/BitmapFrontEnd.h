...
class HXCPP_CLASS_ATTRIBUTES BitmapFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		virtual void onAssetsReload( ::Dynamic _);
		...
		virtual ::String findKeyForBitmap( ::openfl::display::BitmapData bmd);
		...
		virtual ::String getKeyWithSpacesAndBorders(::String baseKey, ::flixel::math::FlxBasePoint frameSize, ::flixel::math::FlxBasePoint frameSpacing, ::flixel::math::FlxBasePoint frameBorder, ::flixel::math::FlxRect region);
		...
		bool _hx___doNotDelete;
		::Array< ::Dynamic> _hx___countCache;
		 ::haxe::ds::StringMap _hx___cacheCopy;
		virtual void clearCache();
		::Dynamic clearCache_dyn();

		virtual void mapCacheAsDestroyable();
		::Dynamic mapCacheAsDestroyable_dyn();
