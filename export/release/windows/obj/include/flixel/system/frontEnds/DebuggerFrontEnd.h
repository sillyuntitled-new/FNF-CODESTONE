...
class HXCPP_CLASS_ATTRIBUTES DebuggerFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		bool drawDebug;
		 ::flixel::util::FlxSignal0 drawDebugChanged;
		 ::flixel::util::FlxSignal0 visibilityChanged;
		bool visible;
		...
		virtual  ::flixel::_hx_system::ui::FlxSystemButton addButton( ::flixel::util::FlxHorizontalAlign Alignment, ::openfl::display::BitmapData Icon, ::Dynamic UpHandler,::hx::Null< bool >  ToggleMode,::hx::Null< bool >  UpdateLayout);
		::Dynamic addButton_dyn();

		virtual  ::flixel::_hx_system::debug::Window track( ::Dynamic ObjectOrClass,::String WindowTitle);
		::Dynamic track_dyn();

		void addTrackerProfile( ::flixel::_hx_system::debug::watch::TrackerProfile Profile);
		::Dynamic addTrackerProfile_dyn();

		virtual void removeButton( ::flixel::_hx_system::ui::FlxSystemButton Button,::hx::Null< bool >  UpdateLayout);
