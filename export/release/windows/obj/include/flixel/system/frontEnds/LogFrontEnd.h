...
class HXCPP_CLASS_ATTRIBUTES LogFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::Dynamic onLogs;
		static Dynamic onLogs_dyn() { return onLogs;}
		bool redirectTraces;
		...
		virtual void advanced( ::Dynamic Data, ::flixel::_hx_system::debug::log::LogStyle Style,::hx::Null< bool >  FireOnce);
