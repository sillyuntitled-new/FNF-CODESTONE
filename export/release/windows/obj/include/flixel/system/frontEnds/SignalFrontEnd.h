...
class HXCPP_CLASS_ATTRIBUTES SignalFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_("SignalFrontEnd",5a,d9,b8,94); }
		 ...
		 ::flixel::util::FlxSignal0 preStateSwitch;
		 ::flixel::util::FlxSignal0 postStateSwitch;
		 ::flixel::util::FlxSignal1 preStateCreate;
		 ::flixel::util::FlxSignal2 gameResized;
		 ::flixel::util::FlxSignal0 preGameReset;
		 ::flixel::util::FlxSignal0 postGameReset;
		 ::flixel::util::FlxSignal0 preGameStart;
		 ::flixel::util::FlxSignal0 postGameStart;
		 ::flixel::util::FlxSignal0 preUpdate;
		 ::flixel::util::FlxSignal0 postUpdate;
		 ::flixel::util::FlxSignal0 preDraw;
		 ::flixel::util::FlxSignal0 postDraw;
		 ::flixel::util::FlxSignal0 focusGained;
		 ::flixel::util::FlxSignal0 focusLost;
		virtual  ::flixel::util::FlxSignal0 get_stateSwitched();
		::Dynamic get_stateSwitched_dyn();

		virtual  ::flixel::util::FlxSignal0 get_gameStarted();
