			...
			*(void **)__this = WatchFrontEnd_obj::_hx_vtable;
{
		...
		virtual void removeExpression(::String displayName);
		::Dynamic removeExpression_dyn();

		virtual void addFunction(::String displayName, ::Dynamic func);
		::Dynamic addFunction_dyn();

		virtual void removeFunction(::String displayName);
