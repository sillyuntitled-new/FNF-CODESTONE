...
class HXCPP_CLASS_ATTRIBUTES FrameRecord_obj : public ::hx::Object
{
	...
	public:
		...
		virtual  ::flixel::_hx_system::replay::FrameRecord create(Float Frame,::Array< ::Dynamic> Keys, ::flixel::_hx_system::replay::MouseRecord Mouse);
		::Dynamic create_dyn();
		...
		virtual  ::flixel::_hx_system::replay::FrameRecord load(::String Data);
		::Dynamic load_dyn();
