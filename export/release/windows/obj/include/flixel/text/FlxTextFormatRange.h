...
#define INCLUDED_flixel_text_FlxTextFormatRange
...
class HXCPP_CLASS_ATTRIBUTES FlxTextFormatRange_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x1955d8b8 };

		void __construct( ::flixel::text::FlxTextFormat format,int start,int end);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="flixel.text.FlxTextFormatRange")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"flixel.text.FlxTextFormatRange"); }
...
#endif /* INCLUDED_flixel_text_FlxTextFormatRange */ 
