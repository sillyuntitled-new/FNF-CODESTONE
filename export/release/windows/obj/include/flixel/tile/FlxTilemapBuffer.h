...
class HXCPP_CLASS_ATTRIBUTES FlxTilemapBuffer_obj : public ::hx::Object
{
	...
	public:
		...
		virtual void resize(int TileWidth,int TileHeight,int WidthInTiles,int HeightInTiles, ::flixel::FlxCamera Camera,::hx::Null< Float >  ScaleX,::hx::Null< Float >  ScaleY);
		::Dynamic resize_dyn();
		...
		virtual void draw( ::flixel::FlxCamera Camera, ::openfl::geom::Point FlashPoint,::hx::Null< Float >  ScaleX,::hx::Null< Float >  ScaleY);
		::Dynamic draw_dyn();

		virtual void colorTransform( ::openfl::geom::ColorTransform Transform);
		...
		virtual bool isDirty( ::flixel::tile::FlxTilemap Tilemap, ::flixel::FlxCamera Camera);
		::Dynamic isDirty_dyn();
