...
class HXCPP_CLASS_ATTRIBUTES FlxTween_obj : public ::hx::Object
{
	...
	public:
		...
		static ::cpp::VirtualArray parseFieldString(::String input);
		static ::Dynamic parseFieldString_dyn();
		...
		virtual void setChain(::Array< ::Dynamic> previousChain);
		::Dynamic setChain_dyn();

		virtual void restart();
		::Dynamic restart_dyn();

		virtual bool isTweenOf( ::Dynamic Object, ::Dynamic Field);
