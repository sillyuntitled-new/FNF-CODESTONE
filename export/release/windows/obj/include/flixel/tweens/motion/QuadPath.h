...
class HXCPP_CLASS_ATTRIBUTES QuadPath_obj : public  ::flixel::tweens::motion::Motion_obj
{
	...
	public:
		...
		virtual  ::flixel::math::FlxBasePoint getPoint(::hx::Null< int >  index);
		...
		virtual Float getCurveLength( ::flixel::math::FlxBasePoint start, ::flixel::math::FlxBasePoint control, ::flixel::math::FlxBasePoint finish);
