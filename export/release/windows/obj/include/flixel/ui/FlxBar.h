...
class HXCPP_CLASS_ATTRIBUTES FlxBar_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		virtual int get_floorPercent();
		::Dynamic get_floorPercent_dyn();
		...
		::Dynamic floorFunc_dyn();

		bool get_unbounded();
		::Dynamic get_unbounded_dyn();

		bool set_unbounded(bool value);
		::Dynamic set_unbounded_dyn();
