...
class HXCPP_CLASS_ATTRIBUTES FlxArrayUtil_obj : public ::hx::Object
{
	...
	public:
		...
		static ::cpp::VirtualArray swapAndPop(::cpp::VirtualArray array,int index);
		static ::Dynamic swapAndPop_dyn();
		...
		static ::cpp::VirtualArray flatten2DArray(::Array< ::Dynamic> array);
		static ::Dynamic flatten2DArray_dyn();
