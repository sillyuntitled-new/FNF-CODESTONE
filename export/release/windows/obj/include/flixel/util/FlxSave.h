...
class HXCPP_CLASS_ATTRIBUTES FlxSave_obj : public ::hx::Object
{
	...
	public:
		...
		virtual bool bind(::String name,::String path);
		::Dynamic bind_dyn();

		virtual bool mergeDataFrom(::String name,::String path,::hx::Null< bool >  overwrite,::hx::Null< bool >  eraseSave,::hx::Null< int >  minFileSize);
		::Dynamic mergeDataFrom_dyn();

		virtual bool mergeData( ::Dynamic sourceData,::hx::Null< bool >  overwrite,::hx::Null< int >  minFileSize);
		::Dynamic mergeData_dyn();

		virtual bool close(::hx::Null< int >  minFileSize);
		::Dynamic close_dyn();

		virtual bool flush(::hx::Null< int >  minFileSize);
		::Dynamic flush_dyn();
