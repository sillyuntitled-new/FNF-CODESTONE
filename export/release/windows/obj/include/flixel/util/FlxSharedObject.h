...
#define INCLUDED_flixel_util_FlxSharedObject
...
class HXCPP_CLASS_ATTRIBUTES FlxSharedObject_obj : public  ::openfl::net::SharedObject_obj
{
	...
	public:
		enum { _hx_ClassId = 0x3ef33558 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="flixel.util.FlxSharedObject")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"flixel.util.FlxSharedObject"); }
...
#endif /* INCLUDED_flixel_util_FlxSharedObject */ 
