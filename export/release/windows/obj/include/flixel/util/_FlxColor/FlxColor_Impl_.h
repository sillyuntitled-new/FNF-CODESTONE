...
class HXCPP_CLASS_ATTRIBUTES FlxColor_Impl__obj : public ::hx::Object
{
	...
	public:
		...
		static int setRGBFast(int this1,int Red,int Green,int Blue,::hx::Null< int >  Alpha);
		static ::Dynamic setRGBFast_dyn();

		static int setRGBUnsafe(int this1,int Red,int Green,int Blue,::hx::Null< int >  Alpha);
		static ::Dynamic setRGBUnsafe_dyn();
		...
		static int get_redFast(int this1);
		static ::Dynamic get_redFast_dyn();

		static int get_green(int this1);
		static ::Dynamic get_green_dyn();

		static int get_greenFast(int this1);
		static ::Dynamic get_greenFast_dyn();

		static int get_blue(int this1);
		static ::Dynamic get_blue_dyn();

		static int get_blueFast(int this1);
		static ::Dynamic get_blueFast_dyn();

		static int get_alpha(int this1);
		static ::Dynamic get_alpha_dyn();

		static int get_alphaFast(int this1);
		static ::Dynamic get_alphaFast_dyn();
		...
		static int set_redFast(int this1,int Value);
		static ::Dynamic set_redFast_dyn();

		static int set_greenFast(int this1,int Value);
		static ::Dynamic set_greenFast_dyn();

		static int set_blueFast(int this1,int Value);
		static ::Dynamic set_blueFast_dyn();

		static int set_alphaFast(int this1,int Value);
		static ::Dynamic set_alphaFast_dyn();
		...
		static Float get_hueOld(int this1);
		static ::Dynamic get_hueOld_dyn();
