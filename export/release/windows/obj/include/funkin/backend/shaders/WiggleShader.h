...
#define INCLUDED_funkin_backend_shaders_WiggleShader
...
class HXCPP_CLASS_ATTRIBUTES WiggleShader_obj : public  ::flixel::graphics::tile::FlxGraphicsShader_obj
{
	...
	public:
		enum { _hx_ClassId = 0x5a1f8b9b };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="funkin.backend.shaders.WiggleShader")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"funkin.backend.shaders.WiggleShader"); }
...
#endif /* INCLUDED_funkin_backend_shaders_WiggleShader */ 
