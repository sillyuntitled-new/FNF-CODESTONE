...
class ErrorDef_obj : public ::hx::EnumBase_obj
{
	...
	public:
		...
		static ::hscript::ErrorDef EAlreadyExistingClass(::String className);
		static ::Dynamic EAlreadyExistingClass_dyn();
		...
		static ::hscript::ErrorDef EInvalidClass(::String className);
		static ::Dynamic EInvalidClass_dyn();
