...
class HXCPP_CLASS_ATTRIBUTES Parser_obj : public ::hx::Object
{
	...
	public:
		...
		static void __boot();
		static ::String regexFlags;
		int line;
		::String opChars;
		::String identChars;
		 ::haxe::ds::StringMap opPriority;
		 ::haxe::ds::StringMap opRightAssoc;
		 ::haxe::ds::StringMap preprocessorValues;
		bool allowJSON;
		bool allowRegex;
		bool allowTypes;
		bool allowMetadata;
		...
		::Dynamic getIdent_dyn();
		 ...
		 ::hscript::ExprDef expr( ::hscript::Expr e);
		::Dynamic expr_dyn();
		...
		::Dynamic pmax_dyn();
		 ...
		 ::hscript::Expr mk( ::hscript::ExprDef e, ::Dynamic pmin, ::Dynamic pmax);
		::Dynamic mk_dyn();
		...
		::Dynamic parseFullExpr_dyn();
		 ...
		 ::hscript::Expr parseObject(int p1);
		::Dynamic parseObject_dyn();

		 ::hscript::Expr parseExpr();
		::Dynamic parseExpr_dyn();

		 ::hscript::Expr parseLambda(::Array< ::Dynamic> args,int pmin);
		...
		bool nextIsFinal;
		bool nextIsInline;
		 ::hscript::CType nextType;
		 ::hscript::Expr parseStructure(::String id, ::Dynamic oldPos);
		::Dynamic parseStructure_dyn();

		 ::hscript::Expr parseExprNext( ::hscript::Expr e1);
		::Dynamic parseExprNext_dyn();

		::Array< ::Dynamic> parseFunctionArgs( ::Dynamic enumArgs);
		::Dynamic parseFunctionArgs_dyn();

		 ::hscript::FunctionDecl parseFunctionDecl();
		...
		::Dynamic parseExprList_dyn();
		 ...
		 ::hscript::Expr interpolateString(::String s);
		::Dynamic interpolateString_dyn();

		void checkAccess(unsigned char get,unsigned char set, ::hscript::Expr expr, ::hscript::CType type);
		::Dynamic checkAccess_dyn();
		...
		::String readString(int until,::hx::Null< bool >  regex,::hx::Null< bool >  interpolate);
		::Dynamic readString_dyn();

		::String readFlags();
		::Dynamic readFlags_dyn();
		...
		::Dynamic tokenString_dyn();
		 ...
		 ::haxe::ds::StringMap get_preprocesorValues();
		::Dynamic get_preprocesorValues_dyn();

		 ::haxe::ds::StringMap set_preprocesorValues( ::haxe::ds::StringMap v);
		::Dynamic set_preprocesorValues_dyn();
