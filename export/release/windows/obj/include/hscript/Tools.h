...
class HXCPP_CLASS_ATTRIBUTES Tools_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::hscript::ExprDef expr( ::hscript::Expr e);
		static ::Dynamic expr_dyn();

		static  ::hscript::Expr mk( ::hscript::ExprDef e, ::hscript::Expr p);
		...
		static bool isCustomAbstract( ::Dynamic obj);
		static ::Dynamic isCustomAbstract_dyn();
