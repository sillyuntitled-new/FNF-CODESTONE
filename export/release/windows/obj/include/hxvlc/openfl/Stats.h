...
#define INCLUDED_hxvlc_openfl_Stats
...
class HXCPP_CLASS_ATTRIBUTES Stats_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x0cd123e6 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="hxvlc.openfl.Stats")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,false,"hxvlc.openfl.Stats"); }
		...
		static  ::hxvlc::openfl::Stats fromMediaStats(cpp::Struct<  libvlc_media_stats_t > media_stats);
...
#endif /* INCLUDED_hxvlc_openfl_Stats */ 
