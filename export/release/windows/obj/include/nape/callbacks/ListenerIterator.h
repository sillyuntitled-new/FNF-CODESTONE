...
class HXCPP_CLASS_ATTRIBUTES ListenerIterator_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"nape.callbacks.ListenerIterator"); }
		static ::hx::ObjectPtr< ListenerIterator_obj > __new();
		static ::hx::ObjectPtr< ListenerIterator_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ListenerIterator",a2,76,dc,d6); }
