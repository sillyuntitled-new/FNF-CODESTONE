...
class HXCPP_CLASS_ATTRIBUTES ConvexResultIterator_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"nape.geom.ConvexResultIterator"); }
		static ::hx::ObjectPtr< ConvexResultIterator_obj > __new();
		static ::hx::ObjectPtr< ConvexResultIterator_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ConvexResultIterator",d2,11,7f,1d); }
