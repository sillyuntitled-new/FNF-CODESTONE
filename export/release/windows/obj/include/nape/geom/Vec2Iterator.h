...
class HXCPP_CLASS_ATTRIBUTES Vec2Iterator_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"nape.geom.Vec2Iterator"); }
		static ::hx::ObjectPtr< Vec2Iterator_obj > __new();
		static ::hx::ObjectPtr< Vec2Iterator_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("Vec2Iterator",8c,07,4e,eb); }
