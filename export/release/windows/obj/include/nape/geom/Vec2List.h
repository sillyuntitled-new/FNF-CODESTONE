...
class HXCPP_CLASS_ATTRIBUTES Vec2List_obj : public ::hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_("Vec2List",fc,32,d4,30); }
		...
		::Dynamic empty_dyn();
		 ...
		 ::nape::geom::Vec2Iterator iterator();
		::Dynamic iterator_dyn();

		 ::nape::geom::Vec2List copy(::hx::Null< bool >  deep);
		::Dynamic copy_dyn();

		void merge( ::nape::geom::Vec2List xs);
		::Dynamic merge_dyn();

		virtual ::String toString();
		::Dynamic toString_dyn();

		 ::nape::geom::Vec2List foreach( ::Dynamic lambda);
		::Dynamic foreach_dyn();

		 ::nape::geom::Vec2List filter( ::Dynamic lambda);
		::Dynamic filter_dyn();
