...
class HXCPP_CLASS_ATTRIBUTES IVector_obj {
	public:
		...
		::cpp::VirtualArray (::hx::Object :: *_hx_unsafe_getArray)(); 
		static inline ::cpp::VirtualArray unsafe_getArray( ::Dynamic _hx_) {
			#ifdef HXCPP_CHECK_POINTER
			if (::hx::IsNull(_hx_)) ::hx::NullReference("Object", false);
			#ifdef HXCPP_GC_CHECK_POINTER
				GCCheckPointer(_hx_.mPtr);
			#endif
			#endif
			return (_hx_.mPtr->*( ::hx::interface_cast< ::openfl::_Vector::IVector_obj *>(_hx_.mPtr->_hx_getInterface(0x45e7caba)))->_hx_unsafe_getArray)();
		}
};
