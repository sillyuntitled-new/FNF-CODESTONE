...
class HXCPP_CLASS_ATTRIBUTES Vector_Impl__obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::_Vector::ObjectVector ofArray_away3d_textures_Texture2DBase(::Array< ::Dynamic> array);
		static ::Dynamic ofArray_away3d_textures_Texture2DBase_dyn();
		...
		static  ::openfl::_Vector::ObjectVector ofArray_Class_away3d_loaders_parsers_ParserBase(::Array< ::Dynamic> array);
		static ::Dynamic ofArray_Class_away3d_loaders_parsers_ParserBase_dyn();

		static  ::openfl::_Vector::ObjectVector ofArray_away3d_entities_Mesh(::Array< ::Dynamic> array);
		static ::Dynamic ofArray_away3d_entities_Mesh_dyn();

		static  ::openfl::_Vector::IntVector ofArray_UInt(::Array< int > array);
		static ::Dynamic ofArray_UInt_dyn();
		...
		static ::cpp::VirtualArray unsafe_getArray(::Dynamic this1);
		static ::Dynamic unsafe_getArray_dyn();
