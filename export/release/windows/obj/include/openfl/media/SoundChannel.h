...
class HXCPP_CLASS_ATTRIBUTES SoundChannel_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		Float _hx___lastPeakTime;
		Float _hx___leftPeak;
		Float _hx___rightPeak;
		...
		bool _hx___updatePeaks(Float time);
		::Dynamic _hx___updatePeaks_dyn();

		void _hx___initAudioSource( ::lime::media::AudioSource source);
		...
		::Dynamic set_loopTime_dyn();
		 ...
		 ::Dynamic get_endTime();
		::Dynamic get_endTime_dyn();

		 ::Dynamic set_endTime( ::Dynamic value);
		...
		::Dynamic source_onComplete_dyn();
		 ...
		 ::lime::media::AudioSource get___audioSource();
		::Dynamic get___audioSource_dyn();

		 ::lime::media::AudioSource set___audioSource( ::lime::media::AudioSource source);
		::Dynamic set___audioSource_dyn();
