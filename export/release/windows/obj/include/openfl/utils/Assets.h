...
class HXCPP_CLASS_ATTRIBUTES Assets_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::display::BitmapData getBitmapData(::String id,::hx::Null< bool >  useCache,::hx::Null< bool >  pushToGPU);
		...
		static  ::openfl::media::Sound getMusic(::String id,::hx::Null< bool >  useCache,::hx::Null< bool >  staticFallback);
