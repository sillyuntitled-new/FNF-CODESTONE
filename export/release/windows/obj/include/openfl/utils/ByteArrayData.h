...
class HXCPP_CLASS_ATTRIBUTES ByteArrayData_obj : public  ::haxe::io::Bytes_obj
{
	...
	public:
		...
		static  ::Dynamic unwrapAMFValue( ::format::amf::Value val);
		static ::Dynamic unwrapAMFValue_dyn();

		static  ::Dynamic unwrapAMF3Value( ::format::amf3::Value val);
		static ::Dynamic unwrapAMF3Value_dyn();
