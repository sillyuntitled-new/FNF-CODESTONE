...
class HXCPP_CLASS_ATTRIBUTES EventLoop_obj : public ::hx::Object
{
	...
	public:
		...
		void insertEventByTime( ::sys::thread::_EventLoop::RegularEvent event);
		::Dynamic insertEventByTime_dyn();
		...
		void runPromised( ::Dynamic event);
		::Dynamic runPromised_dyn();
		...
		::Dynamic loop_dyn();
		 ...
		 ::Dynamic _hx___progress(Float now,::Array< ::Dynamic> recycleRegular,::Array< ::Dynamic> recycleOneTimers);
		::Dynamic _hx___progress_dyn();
