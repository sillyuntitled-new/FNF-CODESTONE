...
class HXCPP_CLASS_ATTRIBUTES ZPP_Callback_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x34feeb1f };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.callbacks.ZPP_Callback")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.callbacks.ZPP_Callback"); }
		static ::hx::ObjectPtr< ZPP_Callback_obj > __new();
		static ::hx::ObjectPtr< ZPP_Callback_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_Callback",2a,d1,61,1a); }
		...
		static  ::zpp_nape::callbacks::ZPP_Callback zpp_pool;
		 ...
		 ::nape::callbacks::BodyCallback wrapper_body();
		::Dynamic wrapper_body_dyn();

		 ::nape::callbacks::ConstraintCallback wrapper_con();
		::Dynamic wrapper_con_dyn();

		 ::nape::callbacks::InteractionCallback wrapper_int();
		...
		int length;
		void push( ::zpp_nape::callbacks::ZPP_Callback obj);
		::Dynamic push_dyn();

		void push_rev( ::zpp_nape::callbacks::ZPP_Callback obj);
		::Dynamic push_rev_dyn();

		 ::zpp_nape::callbacks::ZPP_Callback pop();
		::Dynamic pop_dyn();

		 ::zpp_nape::callbacks::ZPP_Callback pop_rev();
		::Dynamic pop_rev_dyn();
		...
		::Dynamic clear_dyn();
		 ...
		 ::zpp_nape::callbacks::ZPP_Callback splice( ::zpp_nape::callbacks::ZPP_Callback o);
		::Dynamic splice_dyn();
		...
		::Dynamic rotateR_dyn();
		 ...
		 ::zpp_nape::callbacks::ZPP_Callback cycleNext( ::zpp_nape::callbacks::ZPP_Callback o);
		::Dynamic cycleNext_dyn();

		 ::zpp_nape::callbacks::ZPP_Callback cyclePrev( ::zpp_nape::callbacks::ZPP_Callback o);
		::Dynamic cyclePrev_dyn();

		 ::zpp_nape::callbacks::ZPP_Callback at(int i);
		::Dynamic at_dyn();

		 ::zpp_nape::callbacks::ZPP_Callback rev_at(int i);
		::Dynamic rev_at_dyn();
