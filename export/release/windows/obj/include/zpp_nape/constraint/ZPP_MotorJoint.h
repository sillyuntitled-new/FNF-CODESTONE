...
class HXCPP_CLASS_ATTRIBUTES ZPP_MotorJoint_obj : public  ::zpp_nape::constraint::ZPP_Constraint_obj
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.constraint.ZPP_MotorJoint"); }
		static ::hx::ObjectPtr< ZPP_MotorJoint_obj > __new();
		static ::hx::ObjectPtr< ZPP_MotorJoint_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_MotorJoint",3a,2b,34,55); }
