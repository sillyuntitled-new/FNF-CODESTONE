...
class HXCPP_CLASS_ATTRIBUTES ZPP_Arbiter_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x1a139d9b };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.dynamics.ZPP_Arbiter")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.dynamics.ZPP_Arbiter"); }
		static ::hx::ObjectPtr< ZPP_Arbiter_obj > __new();
		static ::hx::ObjectPtr< ZPP_Arbiter_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_Arbiter",24,3c,47,61); }
		...
		void lazyRetire( ::zpp_nape::space::ZPP_Space s, ::zpp_nape::phys::ZPP_Body b);
		::Dynamic lazyRetire_dyn();

		void sup_assign( ::zpp_nape::shape::ZPP_Shape s1, ::zpp_nape::shape::ZPP_Shape s2,int id,int di);
