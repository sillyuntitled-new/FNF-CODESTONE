...
class HXCPP_CLASS_ATTRIBUTES ZPP_CutVert_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.geom.ZPP_CutVert"); }
		static ::hx::ObjectPtr< ZPP_CutVert_obj > __new();
		static ::hx::ObjectPtr< ZPP_CutVert_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_CutVert",8e,4b,20,38); }
