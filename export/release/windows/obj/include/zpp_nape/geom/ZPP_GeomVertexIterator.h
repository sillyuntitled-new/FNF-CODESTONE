...
class HXCPP_CLASS_ATTRIBUTES ZPP_GeomVertexIterator_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.geom.ZPP_GeomVertexIterator"); }
		static ::hx::ObjectPtr< ZPP_GeomVertexIterator_obj > __new();
		static ::hx::ObjectPtr< ZPP_GeomVertexIterator_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_GeomVertexIterator",f3,90,5b,bc); }
