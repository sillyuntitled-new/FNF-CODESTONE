...
class HXCPP_CLASS_ATTRIBUTES ZPP_SimpleEvent_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.geom.ZPP_SimpleEvent"); }
		static ::hx::ObjectPtr< ZPP_SimpleEvent_obj > __new();
		static ::hx::ObjectPtr< ZPP_SimpleEvent_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_SimpleEvent",43,74,60,dc); }
