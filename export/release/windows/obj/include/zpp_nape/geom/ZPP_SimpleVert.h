...
class HXCPP_CLASS_ATTRIBUTES ZPP_SimpleVert_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.geom.ZPP_SimpleVert"); }
		static ::hx::ObjectPtr< ZPP_SimpleVert_obj > __new();
		static ::hx::ObjectPtr< ZPP_SimpleVert_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_SimpleVert",a8,00,a3,93); }
