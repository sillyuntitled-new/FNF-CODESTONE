...
class HXCPP_CLASS_ATTRIBUTES ZPP_Interactor_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.phys.ZPP_Interactor"); }
		static ::hx::ObjectPtr< ZPP_Interactor_obj > __new();
		static ::hx::ObjectPtr< ZPP_Interactor_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_Interactor",fe,60,93,17); }
		...
		void _hx___iaddedToSpace();
		::Dynamic _hx___iaddedToSpace_dyn();

		void _hx___iremovedFromSpace();
		::Dynamic _hx___iremovedFromSpace_dyn();

		void wake();
		::Dynamic wake_dyn();

		 ::zpp_nape::util::ZNPList_ZPP_CallbackSet cbsets;
		 ::zpp_nape::space::ZPP_Space getSpace();
		...
		void immutable_midstep(::String n);
		::Dynamic immutable_midstep_dyn();

		 ::zpp_nape::dynamics::ZPP_InteractionGroup lookup_group();
		::Dynamic lookup_group_dyn();

		void copyto( ::nape::phys::Interactor ret);
		::Dynamic copyto_dyn();
