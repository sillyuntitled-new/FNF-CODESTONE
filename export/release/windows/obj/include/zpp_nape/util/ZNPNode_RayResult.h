...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_RayResult_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x71214297 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPNode_RayResult")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_RayResult"); }
		static ::hx::ObjectPtr< ZNPNode_RayResult_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_RayResult_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_RayResult",c6,96,a4,dc); }
