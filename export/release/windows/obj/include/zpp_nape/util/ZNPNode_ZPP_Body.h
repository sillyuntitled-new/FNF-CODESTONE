...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_ZPP_Body_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x45947137 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPNode_ZPP_Body")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_ZPP_Body"); }
		static ::hx::ObjectPtr< ZNPNode_ZPP_Body_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_ZPP_Body_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_ZPP_Body",e8,f7,46,76); }
