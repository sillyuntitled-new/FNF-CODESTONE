...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_ZPP_CallbackSet_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x056c5c04 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPNode_ZPP_CallbackSet")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_ZPP_CallbackSet"); }
		static ::hx::ObjectPtr< ZNPNode_ZPP_CallbackSet_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_ZPP_CallbackSet_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_ZPP_CallbackSet",57,ba,8e,a8); }
