...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_ZPP_CbSet_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x2710760e };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPNode_ZPP_CbSet")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_ZPP_CbSet"); }
		static ::hx::ObjectPtr< ZNPNode_ZPP_CbSet_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_ZPP_CbSet_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_ZPP_CbSet",3d,ca,93,92); }
		...
		::Dynamic free_dyn();
		 ...
		 ::zpp_nape::callbacks::ZPP_CbSet elem();
		::Dynamic elem_dyn();
