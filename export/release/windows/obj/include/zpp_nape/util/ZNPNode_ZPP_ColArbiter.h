...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_ZPP_ColArbiter_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x4dfb83de };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPNode_ZPP_ColArbiter")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_ZPP_ColArbiter"); }
		static ::hx::ObjectPtr< ZNPNode_ZPP_ColArbiter_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_ZPP_ColArbiter_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_ZPP_ColArbiter",4f,a5,ad,0c); }
		...
		::Dynamic free_dyn();
		 ...
		 ::zpp_nape::dynamics::ZPP_ColArbiter elem();
		::Dynamic elem_dyn();
