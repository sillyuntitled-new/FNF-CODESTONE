...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_ZPP_Compound_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x7fb02880 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPNode_ZPP_Compound")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_ZPP_Compound"); }
		static ::hx::ObjectPtr< ZNPNode_ZPP_Compound_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_ZPP_Compound_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_ZPP_Compound",b1,5b,0a,8d); }
		...
		::Dynamic free_dyn();
		 ...
		 ::zpp_nape::phys::ZPP_Compound elem();
		::Dynamic elem_dyn();
