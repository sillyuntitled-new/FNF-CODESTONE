...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_ZPP_Constraint_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_ZPP_Constraint"); }
		static ::hx::ObjectPtr< ZNPNode_ZPP_Constraint_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_ZPP_Constraint_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_ZPP_Constraint",23,b6,11,9c); }
		...
		::Dynamic free_dyn();
		 ...
		 ::zpp_nape::constraint::ZPP_Constraint elem();
		::Dynamic elem_dyn();
