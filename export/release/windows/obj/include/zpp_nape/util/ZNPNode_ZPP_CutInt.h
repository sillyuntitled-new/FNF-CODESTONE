...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_ZPP_CutInt_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_ZPP_CutInt"); }
		static ::hx::ObjectPtr< ZNPNode_ZPP_CutInt_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_ZPP_CutInt_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_ZPP_CutInt",53,f7,14,b5); }
