...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_ZPP_InteractionGroup_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_ZPP_InteractionGroup"); }
		static ::hx::ObjectPtr< ZNPNode_ZPP_InteractionGroup_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_ZPP_InteractionGroup_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_ZPP_InteractionGroup",53,a0,88,ff); }
		...
		::Dynamic free_dyn();
		 ...
		 ::zpp_nape::dynamics::ZPP_InteractionGroup elem();
		::Dynamic elem_dyn();
