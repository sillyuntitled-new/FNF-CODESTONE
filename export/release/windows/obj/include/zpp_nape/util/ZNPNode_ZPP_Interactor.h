...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_ZPP_Interactor_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x08035aae };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPNode_ZPP_Interactor")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_ZPP_Interactor"); }
		static ::hx::ObjectPtr< ZNPNode_ZPP_Interactor_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_ZPP_Interactor_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_ZPP_Interactor",1f,7c,b5,c6); }
		...
		::Dynamic free_dyn();
		 ...
		 ::zpp_nape::phys::ZPP_Interactor elem();
		::Dynamic elem_dyn();
