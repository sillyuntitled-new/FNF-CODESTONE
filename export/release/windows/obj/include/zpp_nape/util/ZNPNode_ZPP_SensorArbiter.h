...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_ZPP_SensorArbiter_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_ZPP_SensorArbiter"); }
		static ::hx::ObjectPtr< ZNPNode_ZPP_SensorArbiter_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_ZPP_SensorArbiter_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_ZPP_SensorArbiter",c9,7a,28,0b); }
		...
		::Dynamic free_dyn();
		 ...
		 ::zpp_nape::dynamics::ZPP_SensorArbiter elem();
		::Dynamic elem_dyn();
