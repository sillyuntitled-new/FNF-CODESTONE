...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_ZPP_SimplifyP_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_ZPP_SimplifyP"); }
		static ::hx::ObjectPtr< ZNPNode_ZPP_SimplifyP_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_ZPP_SimplifyP_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_ZPP_SimplifyP",21,76,c5,f1); }
		...
		::Dynamic free_dyn();
		 ...
		 ::zpp_nape::geom::ZPP_SimplifyP elem();
		::Dynamic elem_dyn();
