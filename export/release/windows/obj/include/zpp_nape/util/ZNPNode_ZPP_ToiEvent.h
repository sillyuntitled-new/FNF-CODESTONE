...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_ZPP_ToiEvent_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x54aa9a89 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPNode_ZPP_ToiEvent")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_ZPP_ToiEvent"); }
		static ::hx::ObjectPtr< ZNPNode_ZPP_ToiEvent_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_ZPP_ToiEvent_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_ZPP_ToiEvent",f2,e6,4f,02); }
		...
		::Dynamic free_dyn();
		 ...
		 ::zpp_nape::geom::ZPP_ToiEvent elem();
		::Dynamic elem_dyn();
