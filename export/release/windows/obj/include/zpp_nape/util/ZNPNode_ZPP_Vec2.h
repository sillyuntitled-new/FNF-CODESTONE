...
class HXCPP_CLASS_ATTRIBUTES ZNPNode_ZPP_Vec2_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x52c51df3 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZNPNode_ZPP_Vec2")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZNPNode_ZPP_Vec2"); }
		static ::hx::ObjectPtr< ZNPNode_ZPP_Vec2_obj > __new();
		static ::hx::ObjectPtr< ZNPNode_ZPP_Vec2_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZNPNode_ZPP_Vec2",a4,a4,77,83); }
