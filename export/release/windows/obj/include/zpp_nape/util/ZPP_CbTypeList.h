...
class HXCPP_CLASS_ATTRIBUTES ZPP_CbTypeList_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZPP_CbTypeList"); }
		static ::hx::ObjectPtr< ZPP_CbTypeList_obj > __new();
		static ::hx::ObjectPtr< ZPP_CbTypeList_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_CbTypeList",9c,04,8a,3d); }
