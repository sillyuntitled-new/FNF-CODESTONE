...
class HXCPP_CLASS_ATTRIBUTES ZPP_ConstraintList_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZPP_ConstraintList"); }
		static ::hx::ObjectPtr< ZPP_ConstraintList_obj > __new();
		static ::hx::ObjectPtr< ZPP_ConstraintList_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_ConstraintList",80,8c,b2,05); }
