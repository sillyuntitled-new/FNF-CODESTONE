...
class HXCPP_CLASS_ATTRIBUTES ZPP_ConvexResultList_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZPP_ConvexResultList"); }
		static ::hx::ObjectPtr< ZPP_ConvexResultList_obj > __new();
		static ::hx::ObjectPtr< ZPP_ConvexResultList_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_ConvexResultList",87,ea,82,7b); }
