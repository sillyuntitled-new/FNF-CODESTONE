...
class HXCPP_CLASS_ATTRIBUTES ZPP_EdgeList_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x3df0906f };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZPP_EdgeList")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZPP_EdgeList"); }
		static ::hx::ObjectPtr< ZPP_EdgeList_obj > __new();
		static ::hx::ObjectPtr< ZPP_EdgeList_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_EdgeList",a0,aa,6b,f3); }
