...
class HXCPP_CLASS_ATTRIBUTES ZPP_Flags_obj : public ::hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,false,"zpp_nape.util.ZPP_Flags"); }

		inline static ::hx::ObjectPtr< ZPP_Flags_obj > __new() {
			::hx::ObjectPtr< ZPP_Flags_obj > __this = new ZPP_Flags_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< ZPP_Flags_obj > __alloc(::hx::Ctx *_hx_ctx) {
			ZPP_Flags_obj *__this = (ZPP_Flags_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(ZPP_Flags_obj), false, "zpp_nape.util.ZPP_Flags"));
			*(void **)__this = ZPP_Flags_obj::_hx_vtable;
			return __this;
		}
		...
		::String __ToString() const { return HX_("ZPP_Flags",c2,92,f8,98); }
