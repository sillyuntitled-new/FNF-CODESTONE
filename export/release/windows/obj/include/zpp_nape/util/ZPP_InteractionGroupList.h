...
class HXCPP_CLASS_ATTRIBUTES ZPP_InteractionGroupList_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x54f7403f };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZPP_InteractionGroupList")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZPP_InteractionGroupList"); }
		static ::hx::ObjectPtr< ZPP_InteractionGroupList_obj > __new();
		static ::hx::ObjectPtr< ZPP_InteractionGroupList_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_InteractionGroupList",f0,5f,89,bd); }
