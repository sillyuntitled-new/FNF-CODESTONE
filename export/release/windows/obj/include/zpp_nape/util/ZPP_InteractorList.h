...
class HXCPP_CLASS_ATTRIBUTES ZPP_InteractorList_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x1fb0ab8b };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZPP_InteractorList")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZPP_InteractorList"); }
		static ::hx::ObjectPtr< ZPP_InteractorList_obj > __new();
		static ::hx::ObjectPtr< ZPP_InteractorList_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_InteractorList",7c,00,17,c7); }
