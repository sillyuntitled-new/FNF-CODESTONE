...
class HXCPP_CLASS_ATTRIBUTES ZPP_ListenerList_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x1bc25a26 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="zpp_nape.util.ZPP_ListenerList")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"zpp_nape.util.ZPP_ListenerList"); }
		static ::hx::ObjectPtr< ZPP_ListenerList_obj > __new();
		static ::hx::ObjectPtr< ZPP_ListenerList_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_("ZPP_ListenerList",d7,e0,74,4c); }
