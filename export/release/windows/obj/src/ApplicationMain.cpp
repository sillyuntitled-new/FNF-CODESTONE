...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("CodenameEngine",fa,d7,5d,39),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("3208",67,fc,db,21));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Yoshman29",f6,6c,2d,69));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("CodenameEngine",fa,d7,5d,39));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin' - Codename Engine",84,29,df,70));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.yoshman29.codenameengine",df,17,51,2d));
HXLINE(  43)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("1.0.1",b6,d1,2e,55));
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin' - Codename Engine",84,29,df,70))
