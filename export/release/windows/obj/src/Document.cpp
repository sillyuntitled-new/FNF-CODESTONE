...
HXLINE(  85)		 ::EReg titles =  ::EReg_obj::__alloc( HX_CTX ,((((((HX_("(",28,00,00,00) + HX_("\"[^\"]+\"",17,1b,be,1e)) + HX_("|",7c,00,00,00)) + HX_("'[^']+'",fc,7d,f7,f1)) + HX_("|",7c,00,00,00)) + HX_("\\([^)]+\\)",55,44,58,f5)) + HX_(")",29,00,00,00)),HX_("",00,00,00,00));
HXLINE(  86)		 ::EReg link =  ::EReg_obj::__alloc( HX_CTX ,((((((((HX_("^[ ]{0,3}",e7,ad,97,1d) + HX_("\\[([^\\]]+)\\]",2f,43,8b,41)) + HX_(":\\s+(\\S+)\\s*(",98,66,10,a8)) + HX_("\"[^\"]+\"",17,1b,be,1e)) + HX_("|",7c,00,00,00)) + HX_("'[^']+'",fc,7d,f7,f1)) + HX_("|",7c,00,00,00)) + HX_("\\([^)]+\\)",55,44,58,f5)) + HX_("|)\\s*$",be,8f,d5,6c)),HX_("",00,00,00,00));
HXLINE(  88)		{
HXLINE(  88)			int _g = 0;
...
HXLINE( 116)				this->refLinks->set(id, ::Link_obj::__alloc( HX_CTX ,id,url,title));
