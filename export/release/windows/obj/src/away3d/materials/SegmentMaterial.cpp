...
HX_DEFINE_STACK_FRAME(_hx_pos_8336dbb5d303d4a3_18_new,"away3d.materials.SegmentMaterial","new",0x21d80edb,"away3d.materials.SegmentMaterial.new","away3d/materials/SegmentMaterial.hx",18,0x110d28b7)
namespace away3d{
namespace materials{

void SegmentMaterial_obj::__construct(::hx::Null< Float >  __o_thickness){
            		Float thickness = __o_thickness.Default(((Float)1.25));
            	HX_GC_STACKFRAME(&_hx_pos_8336dbb5d303d4a3_18_new)
HXLINE(  19)		super::__construct();
HXLINE(  21)		this->set_bothSides(true);
HXLINE(  22)		this->addPass((this->_screenPass =  ::away3d::materials::passes::SegmentPass_obj::__alloc( HX_CTX ,thickness)));
