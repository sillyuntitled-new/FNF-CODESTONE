...
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_87_destroy,"flixel.FlxBasic","destroy",0xc50151da,"flixel.FlxBasic.destroy","flixel/FlxBasic.hx",87,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_99_kill,"flixel.FlxBasic","kill",0x1748eebe,"flixel.FlxBasic.kill","flixel/FlxBasic.hx",99,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_109_revive,"flixel.FlxBasic","revive",0xb3f01175,"flixel.FlxBasic.revive","flixel/FlxBasic.hx",109,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_119_update,"flixel.FlxBasic","update",0x307e9d29,"flixel.FlxBasic.update","flixel/FlxBasic.hx",119,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_130_draw,"flixel.FlxBasic","draw",0x12af3b24,"flixel.FlxBasic.draw","flixel/FlxBasic.hx",130,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_138_toString,"flixel.FlxBasic","toString",0x03b3efcc,"flixel.FlxBasic.toString","flixel/FlxBasic.hx",138,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_8e0e767fe47b03bd_35_set_visible,"flixel.FlxBasic","set_visible",0x942af475,"flixel.FlxBasic.set_visible","modchart/backend/macros/Macro.macro.hx",35,0x7bf3332e)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_155_set_active,"flixel.FlxBasic","set_active",0x086e7723,"flixel.FlxBasic.set_active","flixel/FlxBasic.hx",155,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_161_set_exists,"flixel.FlxBasic","set_exists",0xb2085339,"flixel.FlxBasic.set_exists","flixel/FlxBasic.hx",161,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_167_set_alive,"flixel.FlxBasic","set_alive",0x59c1c910,"flixel.FlxBasic.set_alive","flixel/FlxBasic.hx",167,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_173_get_camera,"flixel.FlxBasic","get_camera",0xa636dd8e,"flixel.FlxBasic.get_camera","flixel/FlxBasic.hx",173,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_178_set_camera,"flixel.FlxBasic","set_camera",0xa9b47c02,"flixel.FlxBasic.set_camera","flixel/FlxBasic.hx",178,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_189_get_cameras,"flixel.FlxBasic","get_cameras",0xc9caff25,"flixel.FlxBasic.get_cameras","flixel/FlxBasic.hx",189,0xd8d6cfcf)
HX_LOCAL_STACK_FRAME(_hx_pos_a86a375242b5e1cf_195_set_cameras,"flixel.FlxBasic","set_cameras",0xd4380631,"flixel.FlxBasic.set_cameras","flixel/FlxBasic.hx",195,0xd8d6cfcf)
...
HXLINE(  72)		this->_fmExtra =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE(  66)		this->_fmVisible = true;
HXLINE(  60)		this->_z = ((Float)0);
HXLINE(  69)		this->flixelType = ( (unsigned char)(0) );
...
void FlxBasic_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_87_destroy)
HXLINE(  88)		this->set_exists(false);
HXLINE(  89)		this->_cameras = null();
            	}
...
void FlxBasic_obj::kill(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_99_kill)
HXLINE( 100)		this->set_alive(false);
HXLINE( 101)		this->set_exists(false);
            	}
...
void FlxBasic_obj::revive(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_109_revive)
HXLINE( 110)		this->set_alive(true);
HXLINE( 111)		this->set_exists(true);
            	}
...
void FlxBasic_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_119_update)
            	}
...
void FlxBasic_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_130_draw)
            	}
...
::String FlxBasic_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_138_toString)
HXLINE( 139)		 ::Dynamic value = this->active;
HXDLIN( 139)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 139)		_this->label = HX_("active",c6,41,46,16);
HXDLIN( 139)		_this->value = value;
HXLINE( 140)		 ::Dynamic value1 = this->visible;
HXDLIN( 140)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 140)		_this1->label = HX_("visible",72,78,24,a3);
HXDLIN( 140)		_this1->value = value1;
HXLINE( 141)		 ::Dynamic value2 = this->alive;
HXDLIN( 141)		 ::flixel::util::LabelValuePair _this2 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 141)		_this2->label = HX_("alive",cd,63,91,21);
HXDLIN( 141)		_this2->value = value2;
HXLINE( 142)		 ::Dynamic value3 = this->exists;
HXDLIN( 142)		 ::flixel::util::LabelValuePair _this3 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 142)		_this3->label = HX_("exists",dc,1d,e0,bf);
HXDLIN( 142)		_this3->value = value3;
HXLINE( 138)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(4)->init(0,_this)->init(1,_this1)->init(2,_this2)->init(3,_this3));
            	}
...
bool FlxBasic_obj::set_visible(bool Value){
            	HX_STACKFRAME(&_hx_pos_8e0e767fe47b03bd_35_set_visible)
HXLINE(  36)		this->visible = Value;
HXLINE(  37)		this->_fmVisible = Value;
...
bool FlxBasic_obj::set_active(bool Value){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_155_set_active)
HXDLIN( 155)		return (this->active = Value);
            	}
...
bool FlxBasic_obj::set_exists(bool Value){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_161_set_exists)
HXDLIN( 161)		return (this->exists = Value);
            	}
...
bool FlxBasic_obj::set_alive(bool Value){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_167_set_alive)
HXDLIN( 167)		return (this->alive = Value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxBasic_obj,set_alive,return )
 ...
 ::flixel::FlxCamera FlxBasic_obj::get_camera(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_173_get_camera)
HXDLIN( 173)		bool _hx_tmp;
HXDLIN( 173)		if (::hx::IsNotNull( this->_cameras )) {
HXDLIN( 173)			_hx_tmp = (this->_cameras->length == 0);
            		}
            		else {
HXDLIN( 173)			_hx_tmp = true;
            		}
HXDLIN( 173)		if (_hx_tmp) {
HXDLIN( 173)			return ::flixel::FlxCamera_obj::_defaultCameras->__get(0).StaticCast<  ::flixel::FlxCamera >();
            		}
            		else {
HXDLIN( 173)			return this->_cameras->__get(0).StaticCast<  ::flixel::FlxCamera >();
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxBasic_obj,get_camera,return )
 ...
 ::flixel::FlxCamera FlxBasic_obj::set_camera( ::flixel::FlxCamera Value){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_178_set_camera)
HXLINE( 179)		if (::hx::IsNull( this->_cameras )) {
HXLINE( 180)			this->_cameras = ::Array_obj< ::Dynamic>::__new(1)->init(0,Value);
            		}
            		else {
HXLINE( 182)			this->_cameras[0] = Value;
            		}
...
::Array< ::Dynamic> FlxBasic_obj::get_cameras(){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_189_get_cameras)
HXDLIN( 189)		if (::hx::IsNull( this->_cameras )) {
HXDLIN( 189)			return ::flixel::FlxCamera_obj::_defaultCameras;
            		}
            		else {
HXDLIN( 189)			return this->_cameras;
            		}
...
::Array< ::Dynamic> FlxBasic_obj::set_cameras(::Array< ::Dynamic> Value){
            	HX_STACKFRAME(&_hx_pos_a86a375242b5e1cf_195_set_cameras)
HXDLIN( 195)		return (this->_cameras = Value);
            	}
...
void FlxBasic_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(_fmVisible,"_fmVisible");
	HX_MARK_MEMBER_NAME(_fmExtra,"_fmExtra");
	HX_MARK_END_CLASS();
}
...
void FlxBasic_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(_fmVisible,"_fmVisible");
	HX_VISIT_MEMBER_NAME(_fmExtra,"_fmExtra");
}
...
::hx::Val FlxBasic_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"_fmExtra") ) { return ::hx::Val( _fmExtra ); }
		break;
	case 9:
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"_fmVisible") ) { return ::hx::Val( _fmVisible ); }
		break;
	case 11:
...
::hx::Val FlxBasic_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"_fmExtra") ) { _fmExtra=inValue.Cast<  ::Dynamic >(); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"flixelType") ) { flixelType=inValue.Cast< unsigned char >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_fmVisible") ) { _fmVisible=inValue.Cast<  ::Dynamic >(); return inValue; }
	}
...
void FlxBasic_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("_fmVisible",ac,89,c2,32));
	outFields->push(HX_("_fmExtra",4a,09,7c,6a));
...
static ::hx::StorageInfo FlxBasic_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsUnknown /* unsigned char */ ,(int)offsetof(FlxBasic_obj,flixelType),HX_("flixelType",36,bf,78,58)},
	{::hx::fsObject /* ::Array< ::Dynamic> */ ,(int)offsetof(FlxBasic_obj,_cameras),HX_("_cameras",af,e3,e9,1c)},
	{::hx::fsFloat,(int)offsetof(FlxBasic_obj,_z),HX_("_z",3b,53,00,00)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(FlxBasic_obj,_fmVisible),HX_("_fmVisible",ac,89,c2,32)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(FlxBasic_obj,_fmExtra),HX_("_fmExtra",4a,09,7c,6a)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String FlxBasic_obj_sMemberFields[] = {
	...
	HX_("_z",3b,53,00,00),
	HX_("_fmVisible",ac,89,c2,32),
	HX_("_fmExtra",4a,09,7c,6a),
	::String(null()) };
