...
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_101_create,"flixel.FlxState","create",0x1148b519,"flixel.FlxState.create","flixel/FlxState.hx",101,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_105_draw,"flixel.FlxState","draw",0x1022c8e1,"flixel.FlxState.draw","flixel/FlxState.hx",105,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_114_openSubState,"flixel.FlxState","openSubState",0x3d5ea838,"flixel.FlxState.openSubState","flixel/FlxState.hx",114,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_124_closeSubState,"flixel.FlxState","closeSubState",0x519577cc,"flixel.FlxState.closeSubState","flixel/FlxState.hx",124,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_132_createPost,"flixel.FlxState","createPost",0x76816619,"flixel.FlxState.createPost","flixel/FlxState.hx",132,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_139_resetSubState,"flixel.FlxState","resetSubState",0x772d18e3,"flixel.FlxState.resetSubState","flixel/FlxState.hx",139,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_183_destroy,"flixel.FlxState","destroy",0x2171383d,"flixel.FlxState.destroy","flixel/FlxState.hx",183,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_203_switchTo,"flixel.FlxState","switchTo",0x5e95c7ec,"flixel.FlxState.switchTo","flixel/FlxState.hx",203,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_212_onFocusLost,"flixel.FlxState","onFocusLost",0x8c2b4d80,"flixel.FlxState.onFocusLost","flixel/FlxState.hx",212,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_222_onFocus,"flixel.FlxState","onFocus",0x97b2097c,"flixel.FlxState.onFocus","flixel/FlxState.hx",222,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_234_onResize,"flixel.FlxState","onResize",0x38e71fd0,"flixel.FlxState.onResize","flixel/FlxState.hx",234,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_240_tryUpdate,"flixel.FlxState","tryUpdate",0xc75023a7,"flixel.FlxState.tryUpdate","flixel/FlxState.hx",240,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_258_get_bgColor,"flixel.FlxState","get_bgColor",0xc8234a38,"flixel.FlxState.get_bgColor","flixel/FlxState.hx",258,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_264_set_bgColor,"flixel.FlxState","set_bgColor",0xd2905144,"flixel.FlxState.set_bgColor","flixel/FlxState.hx",264,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_269_get_subStateOpened,"flixel.FlxState","get_subStateOpened",0x2fcc7460,"flixel.FlxState.get_subStateOpened","flixel/FlxState.hx",269,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_278_get_subStateClosed,"flixel.FlxState","get_subStateClosed",0x1c89bb63,"flixel.FlxState.get_subStateClosed","flixel/FlxState.hx",278,0xdf96844c)
namespace flixel{
...
HXLINE(  48)		this->postCreated = false;
HXLINE(  43)		this->created = false;
...
void FlxState_obj::create(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_101_create)
HXDLIN( 101)		this->created = true;
            	}
...
void FlxState_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_105_draw)
HXLINE( 106)		bool _hx_tmp;
HXDLIN( 106)		if (!(this->persistentDraw)) {
HXLINE( 106)			_hx_tmp = ::hx::IsNull( this->subState );
            		}
            		else {
HXLINE( 106)			_hx_tmp = true;
            		}
HXDLIN( 106)		if (_hx_tmp) {
HXLINE( 107)			this->super::draw();
            		}
HXLINE( 109)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 110)			this->subState->draw();
            		}
            	}


void FlxState_obj::openSubState( ::flixel::FlxSubState SubState){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_114_openSubState)
HXLINE( 115)		this->_requestSubStateReset = true;
HXLINE( 116)		this->_requestedSubState = SubState;
            	}
...
void FlxState_obj::closeSubState(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_124_closeSubState)
HXDLIN( 124)		this->_requestSubStateReset = true;
            	}


HX_DEFINE_DYNAMIC_FUNC0(FlxState_obj,closeSubState,(void))

void FlxState_obj::createPost(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_132_createPost)
HXDLIN( 132)		this->postCreated = true;
            	}


HX_DEFINE_DYNAMIC_FUNC0(FlxState_obj,createPost,(void))

void FlxState_obj::resetSubState(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_139_resetSubState)
HXLINE( 141)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 143)			if (::hx::IsNotNull( this->subState->closeCallback )) {
HXLINE( 144)				this->subState->closeCallback();
            			}
HXLINE( 145)			if (::hx::IsNotNull( this->_subStateClosed )) {
HXLINE( 146)				this->_subStateClosed->dispatch(this->subState);
            			}
HXLINE( 148)			if (this->destroySubStates) {
HXLINE( 149)				this->subState->destroy();
            			}
            		}
HXLINE( 153)		this->subState = this->_requestedSubState;
HXLINE( 154)		this->_requestedSubState = null();
HXLINE( 156)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 159)			if (!(this->persistentUpdate)) {
HXLINE( 160)				::flixel::FlxG_obj::inputs->onStateSwitch();
            			}
HXLINE( 162)			this->subState->_parentState = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 164)			bool didCreate = false;
HXLINE( 166)			didCreate = !(this->subState->_created);
HXDLIN( 166)			if (didCreate) {
HXLINE( 168)				this->subState->_created = true;
HXLINE( 169)				this->subState->create();
            			}
HXLINE( 171)			if (::hx::IsNotNull( this->subState->openCallback )) {
HXLINE( 172)				this->subState->openCallback();
            			}
HXLINE( 174)			if (didCreate) {
HXLINE( 175)				this->subState->createPost();
            			}
HXLINE( 177)			if (::hx::IsNotNull( this->_subStateOpened )) {
HXLINE( 178)				this->_subStateOpened->dispatch(this->subState);
            			}
            		}
            	}
...
void FlxState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_183_destroy)
HXLINE( 184)		::flixel::util::FlxDestroyUtil_obj::destroy(this->_subStateOpened);
HXLINE( 185)		::flixel::util::FlxDestroyUtil_obj::destroy(this->_subStateClosed);
HXLINE( 187)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 189)			this->subState->destroy();
HXLINE( 190)			this->subState = null();
            		}
...
bool FlxState_obj::switchTo( ::flixel::FlxState nextState){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_203_switchTo)
HXDLIN( 203)		return true;
            	}
...
void FlxState_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_212_onFocusLost)
HXDLIN( 212)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 213)			this->subState->onFocusLost();
            		}
            	}
...
void FlxState_obj::onFocus(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_222_onFocus)
HXDLIN( 222)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 223)			this->subState->onFocus();
            		}
            	}
...
void FlxState_obj::onResize(int Width,int Height){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_234_onResize)
HXDLIN( 234)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 235)			this->subState->onResize(Width,Height);
            		}
            	}
...
void FlxState_obj::tryUpdate(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_240_tryUpdate)
HXLINE( 241)		bool _hx_tmp;
HXDLIN( 241)		if (!(this->persistentUpdate)) {
HXLINE( 241)			_hx_tmp = ::hx::IsNull( this->subState );
            		}
            		else {
HXLINE( 241)			_hx_tmp = true;
            		}
HXDLIN( 241)		if (_hx_tmp) {
HXLINE( 242)			this->update(elapsed);
            		}
HXLINE( 244)		if (this->_requestSubStateReset) {
HXLINE( 246)			this->_requestSubStateReset = false;
HXLINE( 247)			this->resetSubState();
            		}
HXLINE( 249)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 251)			this->subState->tryUpdate(elapsed);
            		}
            	}
...
int FlxState_obj::get_bgColor(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_258_get_bgColor)
HXDLIN( 258)		return ::flixel::FlxG_obj::cameras->get_bgColor();
            	}
...
int FlxState_obj::set_bgColor(int Value){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_264_set_bgColor)
HXDLIN( 264)		return ::flixel::FlxG_obj::cameras->set_bgColor(Value);
            	}


HX_DEFINE_DYNAMIC_FUNC1(FlxState_obj,set_bgColor,return )

 ::flixel::util::FlxSignal1 FlxState_obj::get_subStateOpened(){
            	HX_GC_STACKFRAME(&_hx_pos_1b8de2909b3ba780_269_get_subStateOpened)
HXLINE( 270)		if (::hx::IsNull( this->_subStateOpened )) {
HXLINE( 271)			this->_subStateOpened =  ::flixel::util::FlxSignal1_obj::__alloc( HX_CTX );
            		}
HXLINE( 273)		return this->_subStateOpened;
            	}


HX_DEFINE_DYNAMIC_FUNC0(FlxState_obj,get_subStateOpened,return )

 ::flixel::util::FlxSignal1 FlxState_obj::get_subStateClosed(){
            	HX_GC_STACKFRAME(&_hx_pos_1b8de2909b3ba780_278_get_subStateClosed)
HXLINE( 279)		if (::hx::IsNull( this->_subStateClosed )) {
HXLINE( 280)			this->_subStateClosed =  ::flixel::util::FlxSignal1_obj::__alloc( HX_CTX );
            		}
HXLINE( 282)		return this->_subStateClosed;
            	}
...
void FlxState_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(postCreated,"postCreated");
...
void FlxState_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(postCreated,"postCreated");
...
::hx::Val FlxState_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"postCreated") ) { return ::hx::Val( postCreated ); }
...
::hx::Val FlxState_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"postCreated") ) { postCreated=inValue.Cast< bool >(); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"persistentDraw") ) { persistentDraw=inValue.Cast< bool >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"_subStateOpened") ) { _subStateOpened=inValue.Cast<  ::flixel::util::FlxSignal1 >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_subStateClosed") ) { _subStateClosed=inValue.Cast<  ::flixel::util::FlxSignal1 >(); return inValue; }
		break;
	case 16:
...
void FlxState_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("postCreated",68,a5,a2,4d));
...
static ::hx::StorageInfo FlxState_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsBool,(int)offsetof(FlxState_obj,created),HX_("created",e8,b5,6a,11)},
	{::hx::fsBool,(int)offsetof(FlxState_obj,postCreated),HX_("postCreated",68,a5,a2,4d)},
	...
	{::hx::fsObject /*  ::flixel::util::FlxSignal1 */ ,(int)offsetof(FlxState_obj,_subStateOpened),HX_("_subStateOpened",99,56,ce,49)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal1 */ ,(int)offsetof(FlxState_obj,_subStateClosed),HX_("_subStateClosed",9c,9d,8b,36)},
	{ ::hx::fsUnknown, 0, null()}
};
