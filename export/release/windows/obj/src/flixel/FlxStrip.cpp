...
HXLINE(  58)				{
HXLINE(  58)					 ::flixel::math::FlxBasePoint _this = this->getScreenPosition(this->_point,camera);
HXDLIN(  58)					 ::flixel::math::FlxBasePoint point = this->offset;
HXDLIN(  58)					{
HXLINE(  58)						Float y = point->y;
HXDLIN(  58)						_this->set_x((_this->x - point->x));
HXDLIN(  58)						_this->set_y((_this->y - y));
            					}
HXDLIN(  58)					{
HXLINE(  58)						 ::flixel::math::FlxBasePoint _this1 = point;
HXDLIN(  58)						if (_this1->_weak) {
HXLINE(  58)							_this1->put();
            						}
            					}
            				}
