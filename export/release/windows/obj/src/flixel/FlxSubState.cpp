...
HX_DEFINE_STACK_FRAME(_hx_pos_4f421a3440b44d31_14_new,"flixel.FlxSubState","new",0xef991343,"flixel.FlxSubState.new","flixel/FlxSubState.hx",14,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_61_draw,"flixel.FlxSubState","draw",0xafc56fc1,"flixel.FlxSubState.draw","flixel/FlxSubState.hx",61,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_80_destroy,"flixel.FlxSubState","destroy",0xc08a1d5d,"flixel.FlxSubState.destroy","flixel/FlxSubState.hx",80,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_93_close,"flixel.FlxSubState","close",0x85a9195b,"flixel.FlxSubState.close","flixel/FlxSubState.hx",93,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_100_get_bgColor,"flixel.FlxSubState","get_bgColor",0x02e53f58,"flixel.FlxSubState.get_bgColor","flixel/FlxSubState.hx",100,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_105_set_bgColor,"flixel.FlxSubState","set_bgColor",0x0d524664,"flixel.FlxSubState.set_bgColor","flixel/FlxSubState.hx",105,0xd8a3e54e)
namespace flixel{

void FlxSubState_obj::__construct(::hx::Null< int >  __o_BGColor){
            		int BGColor = __o_BGColor.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_4f421a3440b44d31_14_new)
HXLINE(  44)		this->_created = false;
HXLINE(  51)		super::__construct(null());
HXLINE(  52)		this->closeCallback = null();
HXLINE(  53)		this->openCallback = null();
HXLINE(  55)		if (::flixel::FlxG_obj::renderTile) {
HXLINE(  56)			this->_bgSprite =  ::flixel::_hx_system::FlxBGSprite_obj::__alloc( HX_CTX );
            		}
HXLINE(  57)		this->set_bgColor(BGColor);
            	}
...
void FlxSubState_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_61_draw)
HXLINE(  63)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(  65)			int _g = 0;
HXDLIN(  65)			::Array< ::Dynamic> _g1 = this->get_cameras();
HXDLIN(  65)			while((_g < _g1->length)){
HXLINE(  65)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(  65)				_g = (_g + 1);
HXLINE(  67)				camera->fill(this->_bgColor,null(),null(),null());
            			}
            		}
            		else {
HXLINE(  72)			this->_bgSprite->draw();
            		}
...
void FlxSubState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_80_destroy)
HXLINE(  81)		this->super::destroy();
HXLINE(  82)		this->closeCallback = null();
HXLINE(  83)		this->openCallback = null();
HXLINE(  84)		this->_parentState = null();
HXLINE(  85)		this->_bgSprite = null();
            	}


void FlxSubState_obj::close(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_93_close)
HXDLIN(  93)		bool _hx_tmp;
HXDLIN(  93)		if (::hx::IsNotNull( this->_parentState )) {
HXDLIN(  93)			_hx_tmp = ::hx::IsInstanceEq( this->_parentState->subState,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
HXDLIN(  93)			_hx_tmp = false;
            		}
HXDLIN(  93)		if (_hx_tmp) {
HXLINE(  94)			this->_parentState->closeSubState();
            		}
            	}
...
int FlxSubState_obj::get_bgColor(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_100_get_bgColor)
HXDLIN( 100)		return this->_bgColor;
            	}


int FlxSubState_obj::set_bgColor(int Value){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_105_set_bgColor)
HXLINE( 106)		bool _hx_tmp;
HXDLIN( 106)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 106)			_hx_tmp = ::hx::IsNotNull( this->_bgSprite );
            		}
            		else {
HXLINE( 106)			_hx_tmp = false;
            		}
HXDLIN( 106)		if (_hx_tmp) {
HXLINE( 107)			this->_bgSprite->get_pixels()->setPixel32(0,0,Value);
            		}
HXLINE( 109)		return (this->_bgColor = Value);
            	}
