...
HXLINE( 233)			HX_STACK_DO_THROW(HX_("FlxExtendedSprite.enableMouseClicks called but FlxMouseControl plugin not activated",be,48,74,ba));
            		}
...
HXLINE( 268)			HX_STACK_DO_THROW(HX_("FlxExtendedSprite.enableMouseDrag called but FlxMouseControl plugin not activated",87,56,a5,38));
            		}
...
HXLINE( 317)			HX_STACK_DO_THROW(HX_("FlxExtendedSprite.enableMouseThrow called but FlxMouseControl plugin not activated",71,fd,98,01));
            		}
...
HXLINE( 380)			HX_STACK_DO_THROW(HX_("FlxExtendedSprite.enableMouseSpring called but FlxMouseControl plugin not activated",60,88,76,12));
            		}
...
HXLINE( 618)				_hx_tmp1 = (this->_dragPixelPerfect == false);
            			}
            			else {
...
HXLINE( 624)				_hx_tmp2 = ::flixel::util::FlxCollision_obj::pixelPerfectPointCheck(::Math_obj::floor(( (Float)(::flixel::FlxG_obj::mouse->x) )),::Math_obj::floor(( (Float)(::flixel::FlxG_obj::mouse->y) )),::hx::ObjectPtr<OBJ_>(this),this->_clickPixelPerfectAlpha);
            			}
            			else {
...
HXLINE( 631)				_hx_tmp3 = ::flixel::util::FlxCollision_obj::pixelPerfectPointCheck(::Math_obj::floor(( (Float)(::flixel::FlxG_obj::mouse->x) )),::Math_obj::floor(( (Float)(::flixel::FlxG_obj::mouse->y) )),::hx::ObjectPtr<OBJ_>(this),this->_dragPixelPerfectAlpha);
            			}
            			else {
...
HXLINE( 656)			 ::Dynamic _hx_tmp1 = this->mousePressedCallback;
HXDLIN( 656)			int _hx_tmp2 = this->get_mouseX();
HXDLIN( 656)			_hx_tmp1(::hx::ObjectPtr<OBJ_>(this),_hx_tmp2,this->get_mouseY());
            		}
            	}
...
HXLINE( 685)			 ::Dynamic _hx_tmp1 = this->mouseReleasedCallback;
HXDLIN( 685)			int _hx_tmp2 = this->get_mouseX();
HXDLIN( 685)			_hx_tmp1(::hx::ObjectPtr<OBJ_>(this),_hx_tmp2,this->get_mouseY());
            		}
            	}
...
HXLINE( 728)				 ::flixel::math::FlxRect _this1 = this->boundsRect;
HXDLIN( 728)				Float _hx_tmp2 = (_this1->x + _this1->width);
HXDLIN( 728)				this->set_x((_hx_tmp2 - this->get_width()));
            			}
            		}
...
HXLINE( 735)			Float _hx_tmp3 = this->y;
HXDLIN( 735)			Float _hx_tmp4 = (_hx_tmp3 + this->get_height());
HXDLIN( 735)			 ::flixel::math::FlxRect _this2 = this->boundsRect;
HXDLIN( 735)			if ((_hx_tmp4 > (_this2->y + _this2->height))) {
HXLINE( 737)				 ::flixel::math::FlxRect _this3 = this->boundsRect;
HXDLIN( 737)				Float _hx_tmp5 = (_this3->y + _this3->height);
HXDLIN( 737)				this->set_y((_hx_tmp5 - this->get_height()));
            			}
            		}
            	}
...
HXLINE( 752)				Float _hx_tmp3 = this->boundsSprite->x;
HXDLIN( 752)				Float _hx_tmp4 = (_hx_tmp3 + this->boundsSprite->get_width());
HXDLIN( 752)				this->set_x((_hx_tmp4 - this->get_width()));
            			}
            		}
...
HXLINE( 759)			Float _hx_tmp5 = this->y;
HXDLIN( 759)			Float _hx_tmp6 = (_hx_tmp5 + this->get_height());
HXDLIN( 759)			Float _hx_tmp7 = this->boundsSprite->y;
HXDLIN( 759)			if ((_hx_tmp6 > (_hx_tmp7 + this->boundsSprite->get_height()))) {
HXLINE( 761)				Float _hx_tmp8 = this->boundsSprite->y;
HXDLIN( 761)				Float _hx_tmp9 = (_hx_tmp8 + this->boundsSprite->get_height());
HXDLIN( 761)				this->set_y((_hx_tmp9 - this->get_height()));
            			}
            		}
            	}
