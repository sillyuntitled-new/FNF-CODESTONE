...
HXLINE(  98)		Sprite->get_pixels()->copyPixels(grid, ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,Width,Height), ::openfl::geom::Point_obj::__alloc( HX_CTX ,0,0),null(),null(),true);
