...
HXLINE(  68)		this->_vx = (this->_vx + this->_ax);
HXLINE(  69)		this->_vy = (this->_vy + this->_ay);
HXLINE(  71)		this->_vy = (this->_vy + this->gravity);
HXLINE(  72)		this->_vx = (this->_vx * this->friction);
HXLINE(  73)		this->_vy = (this->_vy * this->friction);
