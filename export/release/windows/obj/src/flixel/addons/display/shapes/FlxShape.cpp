...
HXLINE( 126)			this->drawSpecificShape(this->getStrokeOffsetMatrix(this->_matrix));
            		}
            		else {
...
HXLINE( 184)		{
HXLINE( 184)			matrix->a = ( (Float)(1) );
HXDLIN( 184)			matrix->b = ( (Float)(0) );
HXDLIN( 184)			matrix->c = ( (Float)(0) );
HXDLIN( 184)			matrix->d = ( (Float)(1) );
HXDLIN( 184)			matrix->tx = ( (Float)(0) );
HXDLIN( 184)			matrix->ty = ( (Float)(0) );
            		}
HXLINE( 185)		{
HXLINE( 185)			matrix->tx = (matrix->tx + buffer);
HXDLIN( 185)			matrix->ty = (matrix->ty + buffer);
            		}
