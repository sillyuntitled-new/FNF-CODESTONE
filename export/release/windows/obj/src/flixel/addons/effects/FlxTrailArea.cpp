...
HXLINE( 182)			this->_areaPixels->colorTransform( ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,this->_areaPixels->width,this->_areaPixels->height), ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,this->redMultiplier,this->greenMultiplier,this->blueMultiplier,this->alphaMultiplier,this->redOffset,this->greenOffset,this->blueOffset,this->alphaOffset));
HXLINE( 185)			{
HXLINE( 185)				int _g = 0;
...
HXDLIN( 194)							_hx_tmp->copyPixels(_hx_tmp1, ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,member->frameWidth,member->frameHeight), ::openfl::geom::Point_obj::__alloc( HX_CTX ,finalX,finalY),null(),null(),true);
            						}
            						else {
...
HXLINE( 201)							{
HXLINE( 201)								 ::flixel::math::FlxMatrix _this = this->_matrix;
HXDLIN( 201)								_this->a = ( (Float)(1) );
HXDLIN( 201)								_this->b = ( (Float)(0) );
HXDLIN( 201)								_this->c = ( (Float)(0) );
HXDLIN( 201)								_this->d = ( (Float)(1) );
HXDLIN( 201)								_this->tx = ( (Float)(0) );
HXDLIN( 201)								_this->ty = ( (Float)(0) );
            							}
HXLINE( 202)							bool _hx_tmp2;
HXDLIN( 202)							if (!(rotated)) {
HXLINE( 202)								_hx_tmp2 = scaled;
            							}
            							else {
HXLINE( 202)								_hx_tmp2 = true;
            							}
HXDLIN( 202)							if (_hx_tmp2) {
HXLINE( 204)								{
HXLINE( 204)									 ::flixel::math::FlxMatrix _this1 = this->_matrix;
HXDLIN( 204)									_this1->tx = (_this1->tx + -(member->origin->x));
HXDLIN( 204)									_this1->ty = (_this1->ty + -(member->origin->y));
            								}
HXLINE( 205)								if (scaled) {
HXLINE( 207)									 ::flixel::math::FlxMatrix _this2 = this->_matrix;
HXDLIN( 207)									Float sx = member->scale->x;
HXDLIN( 207)									Float sy = member->scale->y;
HXDLIN( 207)									_this2->a = (_this2->a * sx);
HXDLIN( 207)									_this2->b = (_this2->b * sy);
HXDLIN( 207)									_this2->c = (_this2->c * sx);
HXDLIN( 207)									_this2->d = (_this2->d * sy);
HXDLIN( 207)									_this2->tx = (_this2->tx * sx);
HXDLIN( 207)									_this2->ty = (_this2->ty * sy);
            								}
HXLINE( 209)								if (rotated) {
HXLINE( 211)									this->_matrix->rotate((member->angle * ((Float)0.017453292519943295)));
            								}
HXLINE( 213)								{
HXLINE( 213)									 ::flixel::math::FlxMatrix _this3 = this->_matrix;
HXDLIN( 213)									_this3->tx = (_this3->tx + member->origin->x);
HXDLIN( 213)									_this3->ty = (_this3->ty + member->origin->y);
            								}
            							}
HXLINE( 215)							{
HXLINE( 215)								 ::flixel::math::FlxMatrix _this4 = this->_matrix;
HXDLIN( 215)								_this4->tx = (_this4->tx + finalX);
HXDLIN( 215)								_this4->ty = (_this4->ty + finalY);
            							}
HXLINE( 216)							 ::openfl::display::BitmapData _hx_tmp3 = this->_areaPixels;
HXDLIN( 216)							 ::openfl::display::BitmapData _hx_tmp4 = member->updateFramePixels();
HXDLIN( 216)							_hx_tmp3->draw(_hx_tmp4,this->_matrix,member->colorTransform,this->blendMode,null(),this->antialiasing);
            						}
            					}
            				}
            			}
...
HXDLIN( 233)		this->_areaPixels->fillRect( ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,this->_areaPixels->width,this->_areaPixels->height),0);
            	}
