...
HXLINE(  60)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE(  70)		this->_effectOffset = ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->_effectOffset)) );
...
HXDLIN(  85)		 ::flixel::math::FlxBasePoint _this = this->super::getScreenPosition(point,Camera);
HXDLIN(  85)		 ::flixel::math::FlxBasePoint point1 = this->_effectOffset;
HXDLIN(  85)		{
HXDLIN(  85)			Float y = point1->y;
HXDLIN(  85)			_this->set_x((_this->x + point1->x));
HXDLIN(  85)			_this->set_y((_this->y + y));
            		}
HXDLIN(  85)		{
HXDLIN(  85)			 ::flixel::math::FlxBasePoint _this1 = point1;
HXDLIN(  85)			if (_this1->_weak) {
HXDLIN(  85)				_this1->put();
            			}
            		}
HXDLIN(  85)		return _this;
            	}
...
HXLINE( 109)		{
HXLINE( 109)			 ::flixel::math::FlxBasePoint this1 = this->_effectOffset;
...
HXLINE( 121)							 ::flixel::math::FlxBasePoint _this = this->_effectOffset;
HXDLIN( 121)							 ::flixel::math::FlxBasePoint point = ( ( ::flixel::math::FlxBasePoint)(effect->__Field(HX_("offset",93,97,3f,60),::hx::paccDynamic)) );
HXDLIN( 121)							{
HXLINE( 121)								Float y = point->y;
HXDLIN( 121)								_this->set_x((_this->x + point->x));
HXDLIN( 121)								_this->set_y((_this->y + y));
            							}
HXDLIN( 121)							{
HXLINE( 121)								 ::flixel::math::FlxBasePoint _this1 = point;
HXDLIN( 121)								if (_this1->_weak) {
HXLINE( 121)									_this1->put();
            								}
            							}
            						}
            					}
