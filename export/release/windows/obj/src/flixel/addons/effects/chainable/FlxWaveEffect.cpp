...
HXDLIN( 112)		this->_time = (this->_time + (elapsed * this->speed));
            	}
...
HXLINE( 173)				{
HXLINE( 173)					 ::openfl::geom::Rectangle _this = this->_flashRect;
HXDLIN( 173)					_this->x = ( (Float)(0) );
HXDLIN( 173)					_this->y = ( (Float)(p) );
HXDLIN( 173)					_this->width = ( (Float)(bitmapData->width) );
HXDLIN( 173)					_this->height = ( (Float)(size) );
            				}
            			}
            			else {
HXLINE( 177)				this->_flashPoint->setTo(( (Float)(p) ),(this->strength + pixelOffset));
HXLINE( 178)				{
HXLINE( 178)					 ::openfl::geom::Rectangle _this1 = this->_flashRect;
HXDLIN( 178)					_this1->x = ( (Float)(p) );
HXDLIN( 178)					_this1->y = ( (Float)(0) );
HXDLIN( 178)					_this1->width = ( (Float)(size) );
HXDLIN( 178)					_this1->height = ( (Float)(bitmapData->height) );
            				}
            			}
