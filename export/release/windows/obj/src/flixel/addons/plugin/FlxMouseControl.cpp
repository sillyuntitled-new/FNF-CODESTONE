...
HXLINE( 162)					_hx_tmp2 = (::flixel::addons::plugin::FlxMouseControl_obj::clickTarget->draggable == true);
            				}
            				else {
...
HXLINE( 162)						_hx_tmp1 = (::flixel::addons::plugin::FlxMouseControl_obj::_clickCoords->y != ::flixel::FlxG_obj::mouse->y);
            					}
            					else {
...
HXDLIN( 196)			 ::flixel::input::mouse::FlxMouseButton _this1 = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN( 196)			bool _hx_tmp4;
HXDLIN( 196)			if ((_this1->current != 1)) {
HXLINE( 196)				_hx_tmp4 = (_this1->current == 2);
            			}
            			else {
HXLINE( 196)				_hx_tmp4 = true;
            			}
HXDLIN( 196)			if (_hx_tmp4) {
HXLINE( 196)				_hx_tmp3 = (::flixel::addons::plugin::FlxMouseControl_obj::_clickStack->length > 0);
            			}
            			else {
