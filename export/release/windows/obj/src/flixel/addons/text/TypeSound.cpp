...
HX_LOCAL_STACK_FRAME(_hx_pos_5b66793e2c0d6454_18_boot,"flixel.addons.text.TypeSound","boot",0xe50ec223,"flixel.addons.text.TypeSound.boot","flixel/addons/text/FlxTypeText.hx",18,0x9451ed7e)
namespace flixel{
namespace addons{
namespace text{
...
{
{
            	HX_STACKFRAME(&_hx_pos_5b66793e2c0d6454_18_boot)
HXDLIN(  18)		resourceName = HX_("__ASSET__:sound_flixel_addons_text_TypeSound",86,8d,a7,7b);
            	}
}
