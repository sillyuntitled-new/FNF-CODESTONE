...
HXLINE(  84)			this->_frameTimer = (this->_frameTimer + elapsed);
...
HXLINE( 145)		signed char rotation = ( (signed char)(0) );
HXLINE( 146)		if ((this->_tmp_rot == 1)) {
HXLINE( 148)			rotation = ( (signed char)(90) );
            		}
            		else {
HXLINE( 150)			if ((this->_tmp_rot == 2)) {
HXLINE( 152)				rotation = ( (signed char)(-90) );
            			}
            		}
...
HXLINE( 195)		signed char rotation = ( (signed char)(0) );
HXLINE( 196)		if ((this->_tmp_rot == 1)) {
HXLINE( 198)			rotation = ( (signed char)(90) );
            		}
            		else {
HXLINE( 200)			if ((this->_tmp_rot == 2)) {
HXLINE( 202)				rotation = ( (signed char)(-90) );
            			}
            		}
