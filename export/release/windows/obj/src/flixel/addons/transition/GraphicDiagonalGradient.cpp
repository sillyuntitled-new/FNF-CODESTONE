...
HX_DEFINE_STACK_FRAME(_hx_pos_cddacd75fb2305d7_47_new,"flixel.addons.transition.GraphicDiagonalGradient","new",0x29678e4f,"flixel.addons.transition.GraphicDiagonalGradient.new","openfl/utils/_internal/AssetsMacro.hx",47,0xfdd54705)
HX_LOCAL_STACK_FRAME(_hx_pos_a51ef787a7460407_17_boot,"flixel.addons.transition.GraphicDiagonalGradient","boot",0x094df763,"flixel.addons.transition.GraphicDiagonalGradient.boot","flixel/addons/transition/TransitionFade.hx",17,0x307a6abc)
namespace flixel{
namespace addons{
...
void GraphicDiagonalGradient_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
            	...
            	HX_STACKFRAME(&_hx_pos_cddacd75fb2305d7_47_new)
HXLINE(  71)		super::__construct(0,0,transparent,fillRGBA);
HXLINE(  74)		this->_hx___fromImage(::lime::graphics::Image_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::addons::transition::GraphicDiagonalGradient_obj::resourceName)))));
            	}
...
bool GraphicDiagonalGradient_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x073e5103) {
		...
		return inClassId==(int)0x7a94cae5;
	}
}
...
::hx::ObjectPtr< GraphicDiagonalGradient_obj > GraphicDiagonalGradient_obj::__alloc(::hx::Ctx *_hx_ctx,int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA) {
	GraphicDiagonalGradient_obj *__this = (GraphicDiagonalGradient_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(GraphicDiagonalGradient_obj), true, "flixel.addons.transition.GraphicDiagonalGradient"));
...
void GraphicDiagonalGradient_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.addons.transition.GraphicDiagonalGradient",dd,ba,38,47);
...
{
{
            	HX_STACKFRAME(&_hx_pos_a51ef787a7460407_17_boot)
HXDLIN(  17)		resourceName = HX_("__ASSET__:bitmap_flixel_addons_transition_GraphicDiagonalGradient",52,ab,8b,ef);
            	}
}
