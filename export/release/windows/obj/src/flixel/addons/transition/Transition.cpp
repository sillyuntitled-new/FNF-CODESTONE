...
HX_DEFINE_STACK_FRAME(_hx_pos_ab83fa44df0ac8ad_31_new,"flixel.addons.transition.Transition","new",0xa22822f7,"flixel.addons.transition.Transition.new","flixel/addons/transition/Transition.hx",31,0x569ccdd8)
HX_LOCAL_STACK_FRAME(_hx_pos_ab83fa44df0ac8ad_39_update,"flixel.addons.transition.Transition","update",0x58ffabd2,"flixel.addons.transition.Transition.update","flixel/addons/transition/Transition.hx",39,0x569ccdd8)
HX_LOCAL_STACK_FRAME(_hx_pos_ab83fa44df0ac8ad_45_destroy,"flixel.addons.transition.Transition","destroy",0x0d6d1711,"flixel.addons.transition.Transition.destroy","flixel/addons/transition/Transition.hx",45,0x569ccdd8)
...
void Transition_obj::__construct( ::flixel::addons::transition::TransitionData data){
            	HX_STACKFRAME(&_hx_pos_ab83fa44df0ac8ad_31_new)
HXLINE(  32)		super::__construct(0);
HXLINE(  33)		this->_effect = this->createEffect(data);
HXLINE(  34)		{
HXLINE(  34)			 ::flixel::math::FlxBasePoint this1 = this->_effect->scrollFactor;
HXDLIN(  34)			this1->set_x(( (Float)(0) ));
HXDLIN(  34)			this1->set_y(( (Float)(0) ));
            		}
HXLINE(  35)		this->add(this->_effect);
            	}
...
void Transition_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ab83fa44df0ac8ad_39_update)
HXLINE(  40)		this->super::update(elapsed);
HXLINE(  41)		this->_effect->update(elapsed);
            	}


void Transition_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_ab83fa44df0ac8ad_45_destroy)
HXLINE(  46)		this->super::destroy();
HXLINE(  47)		this->set_finishCallback(null());
HXLINE(  48)		this->_effect = ( ( ::flixel::addons::transition::TransitionEffect)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_effect)) );
            	}
