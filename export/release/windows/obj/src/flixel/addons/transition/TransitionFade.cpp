...
HXLINE(  38)		{
HXLINE(  38)			 ::flixel::math::FlxBasePoint this1 = this->back->scrollFactor;
...
HXDLIN( 160)			s->makeGraphic(_hx_tmp1,_hx_tmp2,this->_data->color,false,HX_("transitionx0y0",64,ec,24,76));
            		}
            		else {
...
HXDLIN( 167)				s->makeGraphic(1,_hx_tmp4,this->_data->color,false,(HX_("transitionx0y",4c,96,9e,94) + DirY));
...
HXLINE( 170)				pixels->copyPixels(gvert1,gvert1->rect, ::openfl::geom::Point_obj::__alloc( HX_CTX ,0,locY),null(),null(),null());
HXLINE( 171)				s->set_pixels(pixels);
HXLINE( 172)				{
HXLINE( 172)					 ::flixel::math::FlxBasePoint this1 = s->scale;
HXDLIN( 172)					this1->set_x(region->width);
HXDLIN( 172)					this1->set_y(((Float)1.0));
            				}
...
HXDLIN( 180)					s->makeGraphic(_hx_tmp6,1,this->_data->color,false,((HX_("transitionx",43,55,ec,40) + DirX) + HX_("y0",97,69,00,00)));
...
HXLINE( 183)					pixels->copyPixels(ghorz1,ghorz1->rect, ::openfl::geom::Point_obj::__alloc( HX_CTX ,locX,0),null(),null(),null());
HXLINE( 184)					s->set_pixels(pixels);
HXLINE( 185)					{
HXLINE( 185)						 ::flixel::math::FlxBasePoint this2 = s->scale;
HXDLIN( 185)						Float y = region->height;
HXDLIN( 185)						this2->set_x(((Float)1.0));
HXDLIN( 185)						this2->set_y(y);
            					}
...
HXLINE( 203)		 ::openfl::display::BitmapData gdiag = ( ( ::openfl::display::BitmapData)( ::flixel::addons::transition::GraphicDiagonalGradient_obj::__alloc( HX_CTX ,0,0,null(),null())) );
...
HXLINE( 206)		{
HXLINE( 206)			Float sx = (( (Float)(gdiag_scaled->width) ) / ( (Float)(gdiag->width) ));
HXDLIN( 206)			Float sy = (( (Float)(gdiag_scaled->height) ) / ( (Float)(gdiag->height) ));
HXDLIN( 206)			m->a = (m->a * sx);
HXDLIN( 206)			m->b = (m->b * sy);
HXDLIN( 206)			m->c = (m->c * sx);
HXDLIN( 206)			m->d = (m->d * sy);
HXDLIN( 206)			m->tx = (m->tx * sx);
HXDLIN( 206)			m->ty = (m->ty * sy);
            		}
HXLINE( 207)		gdiag_scaled->draw(gdiag,m,null(),null(),null(),true);
HXLINE( 209)		 ::openfl::display::BitmapData final_pixels =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(::flixel::FlxG_obj::width * 3),(::flixel::FlxG_obj::height * 3),true,this->_data->color);
HXLINE( 210)		final_pixels->copyChannel(gdiag_scaled,gdiag_scaled->rect, ::openfl::geom::Point_obj::__alloc( HX_CTX ,(final_pixels->width - gdiag_scaled->width),(final_pixels->height - gdiag_scaled->height)),1,8);
