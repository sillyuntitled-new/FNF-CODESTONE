...
HXLINE( 138)			{
HXLINE( 138)				 ::flixel::text::FlxText Value2 =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,3,Width,Label,null(),null());
HXDLIN( 138)				if (::hx::IsNull( Value2 )) {
...
HXLINE( 138)						Value2->set_visible(false);
HXDLIN( 138)						this->textHighlight->set_visible(true);
            					}
HXDLIN( 138)					this->group->replace(( ( ::flixel::FlxSprite)(this->textNormal) ),Value2).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 138)					this->textNormal = Value2;
            				}
            			}
HXLINE( 139)			this->textNormal->setFormat(null(),8,16777215,HX_("center",d5,25,db,05),null(),null(),null());
HXLINE( 141)			{
HXLINE( 141)				 ::flixel::text::FlxText Value3 =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,3,Width,Label,null(),null());
HXDLIN( 141)				if (::hx::IsNull( Value3 )) {
...
HXLINE( 141)						Value3->set_visible(false);
HXDLIN( 141)						this->textNormal->set_visible(true);
            					}
HXDLIN( 141)					this->group->replace(( ( ::flixel::FlxSprite)(this->textHighlight) ),Value3).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 141)					this->textHighlight = Value3;
            				}
            			}
...
HXLINE( 324)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(normalKey)) );
HXDLIN( 324)		if (::hx::IsNotNull( graphic )) {
HXLINE( 324)			graphic->mustDestroy = false;
            		}
HXDLIN( 324)		if ((::hx::IsNotNull( graphic ) == false)) {
...
HXLINE( 327)			normalGraphics2->bitmap->fillRect( ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,w,h),this->borderColor);
HXLINE( 328)			 ::openfl::display::BitmapData normalGraphics3 = normalGraphics2->bitmap;
HXDLIN( 328)			int _hx_tmp = ::Std_obj::_hx_int((w - ( (Float)(2) )));
HXDLIN( 328)			int _hx_tmp1 = ::Std_obj::_hx_int((h - ( (Float)(2) )));
HXDLIN( 328)			::flixel::util::FlxGradient_obj::overlayGradientOnBitmapData(normalGraphics3,_hx_tmp,_hx_tmp1,this->offColor,1,1,null(),null(),null());
            		}
HXLINE( 331)		 ::flixel::addons::display::FlxExtendedSprite _hx_tmp2 = this->buttonNormal;
HXDLIN( 331)		 ::flixel::graphics::FlxGraphic graphic1 = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(normalKey)) );
HXDLIN( 331)		if (::hx::IsNotNull( graphic1 )) {
HXLINE( 331)			graphic1->mustDestroy = false;
            		}
HXDLIN( 331)		_hx_tmp2->set_pixels(graphic1->bitmap);
            	}
...
HXLINE( 363)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(highlightKey)) );
HXDLIN( 363)		if (::hx::IsNotNull( graphic )) {
HXLINE( 363)			graphic->mustDestroy = false;
            		}
HXDLIN( 363)		if ((::hx::IsNotNull( graphic ) == false)) {
...
HXLINE( 366)			highlightGraphics2->bitmap->fillRect( ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,w,h),this->borderColor);
HXLINE( 367)			 ::openfl::display::BitmapData highlightGraphics3 = highlightGraphics2->bitmap;
HXDLIN( 367)			int _hx_tmp = ::Std_obj::_hx_int((w - ( (Float)(2) )));
HXDLIN( 367)			int _hx_tmp1 = ::Std_obj::_hx_int((h - ( (Float)(2) )));
HXDLIN( 367)			::flixel::util::FlxGradient_obj::overlayGradientOnBitmapData(highlightGraphics3,_hx_tmp,_hx_tmp1,this->onColor,1,1,null(),null(),null());
            		}
HXLINE( 370)		 ::flixel::addons::display::FlxExtendedSprite _hx_tmp2 = this->buttonHighlight;
HXDLIN( 370)		 ::flixel::graphics::FlxGraphic graphic1 = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(highlightKey)) );
HXDLIN( 370)		if (::hx::IsNotNull( graphic1 )) {
HXLINE( 370)			graphic1->mustDestroy = false;
            		}
HXDLIN( 370)		_hx_tmp2->set_pixels(graphic1->bitmap);
            	}
