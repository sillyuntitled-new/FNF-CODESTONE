...
HXLINE( 190)		if ((MinValue == MaxValue)) {
HXLINE( 192)			::flixel::FlxG_obj::log->advanced(((HX_("FlxSlider: MinValue and MaxValue can't be the same (",b5,38,bb,84) + MinValue) + HX_(")",29,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            		}
HXLINE( 196)		this->decimals = ::flixel::math::FlxMath_obj::getDecimals(MinValue);
HXLINE( 198)		int _hx_tmp = ::flixel::math::FlxMath_obj::getDecimals(MaxValue);
HXDLIN( 198)		if ((_hx_tmp > this->decimals)) {
...
HXDLIN( 226)		_this->_inPool = false;
HXDLIN( 226)		this->_bounds = _this;
...
HXDLIN( 230)		::String colorKey1 = ::StringTools_obj::hex(((this2 >> 24) & 255),2);
HXDLIN( 230)		::String colorKey2 = ((HX_("0x",48,2a,00,00) + colorKey1) + ::StringTools_obj::hex(((this2 >> 16) & 255),2));
HXDLIN( 230)		::String colorKey3 = (colorKey2 + ::StringTools_obj::hex(((this2 >> 8) & 255),2));
HXDLIN( 230)		::String colorKey4 = ((colorKey + (colorKey3 + ::StringTools_obj::hex((this2 & 255),2))) + HX_("T=",69,49,00,00));
HXLINE( 231)		this->body->makeGraphic(this->_width,this->_height,0,false,(colorKey4 + this->_thickness));
HXLINE( 232)		{
...
HXLINE( 296)					_hx_tmp2 = !(this->_justClicked);
            				}
            				else {
...
HXLINE( 303)				_hx_tmp3 = (_this1->current == 2);
            			}
            			else {
...
HXLINE( 319)		bool _hx_tmp4;
HXDLIN( 319)		 ::flixel::input::mouse::FlxMouseButton _this2 = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN( 319)		bool _hx_tmp5;
HXDLIN( 319)		if ((_this2->current != 1)) {
HXLINE( 319)			_hx_tmp5 = (_this2->current == 2);
            		}
            		else {
HXLINE( 319)			_hx_tmp5 = true;
            		}
HXDLIN( 319)		if (_hx_tmp5) {
HXLINE( 319)			_hx_tmp4 = ::flixel::math::FlxMath_obj::mouseInFlxRect(false,this->_bounds);
            		}
            		else {
...
HXLINE( 325)		bool _hx_tmp6;
HXDLIN( 325)		if (::hx::IsNotNull( this->varString )) {
HXLINE( 325)			_hx_tmp6 = ::hx::IsNotNull( ::Reflect_obj::getProperty(this->_object,this->varString) );
            		}
            		else {
...
HXLINE( 331)		Float _hx_tmp7 = this->handle->x;
HXDLIN( 331)		if ((_hx_tmp7 != this->get_expectedPos())) {
HXLINE( 333)			 ::flixel::FlxSprite _hx_tmp8 = this->handle;
HXDLIN( 333)			_hx_tmp8->set_x(this->get_expectedPos());
            		}
HXLINE( 337)		 ::flixel::text::FlxText _hx_tmp9 = this->valueLabel;
HXDLIN( 337)		_hx_tmp9->set_text(::Std_obj::string(::flixel::math::FlxMath_obj::roundDecimal(this->value,this->decimals)));
...
HXLINE( 349)				_hx_tmp1 = ::hx::IsNotNull( this->varString );
            			}
            			else {
HXLINE( 349)				_hx_tmp1 = false;
            			}
HXDLIN( 349)			if (_hx_tmp1) {
HXLINE( 351)				 ::Dynamic _hx_tmp2 = this->_object;
HXDLIN( 351)				::String _hx_tmp3 = this->varString;
HXDLIN( 351)				Float _hx_tmp4 = this->get_relativePos();
HXDLIN( 351)				::Reflect_obj::setProperty(_hx_tmp2,_hx_tmp3,((_hx_tmp4 * (this->maxValue - this->minValue)) + this->minValue));
            			}
HXLINE( 354)			this->_lastPos = this->get_relativePos();
HXLINE( 356)			if (::hx::IsNotNull( this->callback )) {
HXLINE( 357)				 ::Dynamic _hx_tmp5 = this->callback;
HXDLIN( 357)				_hx_tmp5(this->get_relativePos());
            			}
            		}
            	}
...
HXDLIN( 473)					_this->advanced(Data,::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            				}
