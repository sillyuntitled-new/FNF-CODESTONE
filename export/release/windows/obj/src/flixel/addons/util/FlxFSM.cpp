...
HXLINE( 114)			this->age = (this->age + elapsed);
...
HXLINE( 129)					_hx_tmp2 = !(this->pools->exists(newName));
            				}
            				else {
HXLINE( 129)					_hx_tmp2 = false;
            				}
HXDLIN( 129)				if (_hx_tmp2) {
HXLINE( 131)					this->pools->set(newName, ::flixel::util::FlxPool_obj::__alloc( HX_CTX ,newStateClass));
            				}
...
HXLINE( 138)					_hx_tmp4 = ::hx::IsNotNull( curName );
            				}
            				else {
HXLINE( 138)					_hx_tmp4 = false;
            				}
HXDLIN( 138)				if (_hx_tmp4) {
HXLINE( 138)					_hx_tmp3 = this->pools->exists(curName);
            				}
            				else {
