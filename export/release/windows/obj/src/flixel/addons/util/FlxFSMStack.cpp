...
HXLINE( 227)		::flixel::addons::util::FlxFSMStackSignal_obj::_lockSignal->add(this->lockType_dyn());
            	}
...
HXLINE( 293)		this->_lockedTypes = (this->_lockedTypes | bitflag);
...
HXLINE( 398)		::flixel::addons::util::FlxFSMStackSignal_obj::_lockSignal->remove(this->lockType_dyn());
            	}
