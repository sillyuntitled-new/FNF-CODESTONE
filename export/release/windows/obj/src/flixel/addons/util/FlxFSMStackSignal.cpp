...
HX_DEFINE_STACK_FRAME(_hx_pos_d143dcb545195098_419_new,"flixel.addons.util.FlxFSMStackSignal","new",0x0d647eb1,"flixel.addons.util.FlxFSMStackSignal.new","flixel/addons/util/FlxFSM.hx",419,0xe233084c)
HX_LOCAL_STACK_FRAME(_hx_pos_d143dcb545195098_431_globalLock,"flixel.addons.util.FlxFSMStackSignal","globalLock",0x55d214bd,"flixel.addons.util.FlxFSMStackSignal.globalLock","flixel/addons/util/FlxFSM.hx",431,0xe233084c)
namespace flixel{
namespace addons{
namespace util{

void FlxFSMStackSignal_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_d143dcb545195098_419_new)
HXDLIN( 419)		if (::hx::IsNull( ::flixel::addons::util::FlxFSMStackSignal_obj::_lockSignal )) {
HXLINE( 421)			::flixel::addons::util::FlxFSMStackSignal_obj::_lockSignal =  ::flixel::util::FlxSignal1_obj::__alloc( HX_CTX );
            		}
            	}
...
bool FlxFSMStackSignal_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x19e09a31;
}

void FlxFSMStackSignal_obj::globalLock(int type){
            	HX_STACKFRAME(&_hx_pos_d143dcb545195098_431_globalLock)
HXDLIN( 431)		::flixel::addons::util::FlxFSMStackSignal_obj::_lockSignal->dispatch(type);
            	}


HX_DEFINE_DYNAMIC_FUNC1(FlxFSMStackSignal_obj,globalLock,(void))

 ::flixel::util::FlxSignal1 FlxFSMStackSignal_obj::_lockSignal;
...
::hx::ObjectPtr< FlxFSMStackSignal_obj > FlxFSMStackSignal_obj::__alloc(::hx::Ctx *_hx_ctx) {
	FlxFSMStackSignal_obj *__this = (FlxFSMStackSignal_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(FlxFSMStackSignal_obj), false, "flixel.addons.util.FlxFSMStackSignal"));
...
bool FlxFSMStackSignal_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 11:
		if (HX_FIELD_EQ(inName,"_lockSignal") ) { _lockSignal=ioValue.Cast<  ::flixel::util::FlxSignal1 >(); return true; }
	}
	return false;
}
...
static ::hx::StaticInfo FlxFSMStackSignal_obj_sStaticStorageInfo[] = {
	{::hx::fsObject /*  ::flixel::util::FlxSignal1 */ ,(void *) &FlxFSMStackSignal_obj::_lockSignal,HX_("_lockSignal",d2,4d,b6,d1)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
void FlxFSMStackSignal_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.addons.util.FlxFSMStackSignal",3f,52,59,2c);
