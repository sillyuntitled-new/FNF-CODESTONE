...
HXLINE(  75)			HX_STACK_DO_THROW(HX_("baseX and baseY must be greater than 0.",57,20,e0,c1));
            		}
HXLINE(  77)		if ((octaves < 1)) {
HXLINE(  78)			HX_STACK_DO_THROW(HX_("The number of octaves must be greater than 0.",53,4b,87,a6));
            		}
HXLINE(  80)		Float xx = (((x / baseX) * ( (Float)(2) )) * ::Math_obj::PI);
HXDLIN(  80)		Float yy = (((y / baseY) * ( (Float)(2) )) * ::Math_obj::PI);
HXLINE(  81)		::Std_obj::_hx_int((x / baseX));
HXLINE(  82)		::Std_obj::_hx_int((y / baseY));
...
HXLINE(  91)		{
HXLINE(  91)			int _g = 0;
HXDLIN(  91)			while((_g < octaves)){
HXLINE(  91)				_g = (_g + 1);
HXLINE(  93)				Float x1 = (seed + (nx * scale));
HXDLIN(  93)				Float y1 = (seed + (ny * scale));
HXDLIN(  93)				Float z = (seed + (nz * scale));
HXDLIN(  93)				Float w = (seed + (nw * scale));
HXDLIN(  93)				Float t = ((((x1 + y1) + z) + w) * ((Float)0.309016994));
HXDLIN(  93)				::flixel::addons::util::FlxSimplex_obj::i = ::Math_obj::floor((x1 + t));
HXDLIN(  93)				::flixel::addons::util::FlxSimplex_obj::j = ::Math_obj::floor((y1 + t));
...
HXDLIN(  93)				::flixel::addons::util::FlxSimplex_obj::x0 = ((x1 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::i) )) + t);
HXDLIN(  93)				::flixel::addons::util::FlxSimplex_obj::y0 = ((y1 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::j) )) + t);
...
HXDLIN(  93)				{
HXLINE(  93)					::flixel::addons::util::FlxSimplex_obj::A2[3] = 0;
HXDLIN(  93)					::flixel::addons::util::FlxSimplex_obj::A2[2] = 0;
HXDLIN(  93)					::flixel::addons::util::FlxSimplex_obj::A2[1] = 0;
HXDLIN(  93)					::flixel::addons::util::FlxSimplex_obj::A2[0] = 0;
            				}
...
HXDLIN(  93)				Float x2 = ((::flixel::addons::util::FlxSimplex_obj::x0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(0)) )) + s);
HXDLIN(  93)				Float y2 = ((::flixel::addons::util::FlxSimplex_obj::y0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(1)) )) + s);
...
HXDLIN(  93)				Float t1 = ((((((Float).6) - (x2 * x2)) - (y2 * y2)) - (z1 * z1)) - (w1 * w1));
...
HXDLIN(  93)					out = ((t1 * t1) * (((x2 + y2) + z1) + w1));
            				}
...
HXDLIN(  93)				Float x3 = ((::flixel::addons::util::FlxSimplex_obj::x0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(0)) )) + s1);
HXDLIN(  93)				Float y3 = ((::flixel::addons::util::FlxSimplex_obj::y0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(1)) )) + s1);
HXDLIN(  93)				Float z2 = ((::flixel::addons::util::FlxSimplex_obj::z0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(2)) )) + s1);
HXDLIN(  93)				Float w3 = ((::flixel::addons::util::FlxSimplex_obj::w0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(3)) )) + s1);
HXDLIN(  93)				Float t2 = ((((((Float).6) - (x3 * x3)) - (y3 * y3)) - (z2 * z2)) - (w3 * w3));
...
HXLINE(  93)					t2 = (t2 * t2);
HXDLIN(  93)					int h1 = ::hx::Mod(::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::i + a2x1) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::j + a2y1) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::k + a2z1) + ::flixel::addons::util::FlxSimplex_obj::p->__get((::flixel::addons::util::FlxSimplex_obj::l + a2w1)))))))),32);
HXDLIN(  93)					bool b41 = (((h1 >> 4) & 1) == 1);
HXDLIN(  93)					bool b31 = (((h1 >> 3) & 1) == 1);
HXDLIN(  93)					bool b21 = (((h1 >> 2) & 1) == 1);
HXDLIN(  93)					bool b11 = (((h1 >> 1) & 1) == 1);
HXDLIN(  93)					bool b01 = ((h1 & 1) == 1);
HXDLIN(  93)					if (!(b31)) {
...
HXDLIN(  93)					out1 = ((t2 * t2) * (((x3 + y3) + z2) + w3));
            				}
...
HXDLIN(  93)				Float x4 = ((::flixel::addons::util::FlxSimplex_obj::x0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(0)) )) + s2);
HXDLIN(  93)				Float y4 = ((::flixel::addons::util::FlxSimplex_obj::y0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(1)) )) + s2);
HXDLIN(  93)				Float z3 = ((::flixel::addons::util::FlxSimplex_obj::z0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(2)) )) + s2);
HXDLIN(  93)				Float w5 = ((::flixel::addons::util::FlxSimplex_obj::w0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(3)) )) + s2);
HXDLIN(  93)				Float t3 = ((((((Float).6) - (x4 * x4)) - (y4 * y4)) - (z3 * z3)) - (w5 * w5));
...
HXLINE(  93)					t3 = (t3 * t3);
HXDLIN(  93)					int h2 = ::hx::Mod(::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::i + a2x2) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::j + a2y2) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::k + a2z2) + ::flixel::addons::util::FlxSimplex_obj::p->__get((::flixel::addons::util::FlxSimplex_obj::l + a2w2)))))))),32);
HXDLIN(  93)					bool b42 = (((h2 >> 4) & 1) == 1);
HXDLIN(  93)					bool b32 = (((h2 >> 3) & 1) == 1);
HXDLIN(  93)					bool b22 = (((h2 >> 2) & 1) == 1);
HXDLIN(  93)					bool b12 = (((h2 >> 1) & 1) == 1);
HXDLIN(  93)					bool b02 = ((h2 & 1) == 1);
HXDLIN(  93)					if (!(b32)) {
...
HXDLIN(  93)					out2 = ((t3 * t3) * (((x4 + y4) + z3) + w5));
            				}
...
HXDLIN(  93)				Float x5 = ((::flixel::addons::util::FlxSimplex_obj::x0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(0)) )) + s3);
HXDLIN(  93)				Float y5 = ((::flixel::addons::util::FlxSimplex_obj::y0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(1)) )) + s3);
HXDLIN(  93)				Float z4 = ((::flixel::addons::util::FlxSimplex_obj::z0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(2)) )) + s3);
HXDLIN(  93)				Float w7 = ((::flixel::addons::util::FlxSimplex_obj::w0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(3)) )) + s3);
HXDLIN(  93)				Float t4 = ((((((Float).6) - (x5 * x5)) - (y5 * y5)) - (z4 * z4)) - (w7 * w7));
...
HXLINE(  93)					t4 = (t4 * t4);
HXDLIN(  93)					int h3 = ::hx::Mod(::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::i + a2x3) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::j + a2y3) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::k + a2z3) + ::flixel::addons::util::FlxSimplex_obj::p->__get((::flixel::addons::util::FlxSimplex_obj::l + a2w3)))))))),32);
HXDLIN(  93)					bool b43 = (((h3 >> 4) & 1) == 1);
HXDLIN(  93)					bool b33 = (((h3 >> 3) & 1) == 1);
HXDLIN(  93)					bool b23 = (((h3 >> 2) & 1) == 1);
HXDLIN(  93)					bool b13 = (((h3 >> 1) & 1) == 1);
HXDLIN(  93)					bool b03 = ((h3 & 1) == 1);
HXDLIN(  93)					if (!(b33)) {
...
HXDLIN(  93)					out3 = ((t4 * t4) * (((x5 + y5) + z4) + w7));
            				}
...
HXDLIN(  93)				Float x6 = ((::flixel::addons::util::FlxSimplex_obj::x0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(0)) )) + s4);
HXDLIN(  93)				Float y6 = ((::flixel::addons::util::FlxSimplex_obj::y0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(1)) )) + s4);
HXDLIN(  93)				Float z5 = ((::flixel::addons::util::FlxSimplex_obj::z0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(2)) )) + s4);
HXDLIN(  93)				Float w9 = ((::flixel::addons::util::FlxSimplex_obj::w0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(3)) )) + s4);
HXDLIN(  93)				Float t5 = ((((((Float).6) - (x6 * x6)) - (y6 * y6)) - (z5 * z5)) - (w9 * w9));
...
HXLINE(  93)					t5 = (t5 * t5);
HXDLIN(  93)					int h4 = ::hx::Mod(::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::i + a2x4) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::j + a2y4) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::k + a2z4) + ::flixel::addons::util::FlxSimplex_obj::p->__get((::flixel::addons::util::FlxSimplex_obj::l + a2w4)))))))),32);
HXDLIN(  93)					bool b44 = (((h4 >> 4) & 1) == 1);
HXDLIN(  93)					bool b34 = (((h4 >> 3) & 1) == 1);
HXDLIN(  93)					bool b24 = (((h4 >> 2) & 1) == 1);
HXDLIN(  93)					bool b14 = (((h4 >> 1) & 1) == 1);
HXDLIN(  93)					bool b04 = ((h4 & 1) == 1);
HXDLIN(  93)					if (!(b34)) {
HXLINE(  93)						x6 = ( (Float)(0) );
            					}
            					else {
HXLINE(  93)						if (b24) {
HXLINE(  93)							x6 = -(x6);
...
HXDLIN(  93)					out4 = ((t5 * t5) * (((x6 + y6) + z5) + w9));
            				}
...
HXLINE( 115)			HX_STACK_DO_THROW(HX_("The number of octaves must be greater than 0.",53,4b,87,a6));
            		}
...
HXDLIN( 121)				{
HXLINE( 121)					::flixel::addons::util::FlxSimplex_obj::A2[1] = 0;
HXDLIN( 121)					::flixel::addons::util::FlxSimplex_obj::A2[0] = 0;
            				}
...
HXDLIN( 121)					if (!(b3)) {
HXLINE( 121)						if ((((h >> 2) & 1) != 1)) {
HXLINE( 121)							if ((((h >> 1) & 1) == 1)) {
HXLINE( 121)								y2 = -(y2);
            							}
            						}
            						else {
...
HXLINE( 121)					t2 = (t2 * t2);
HXDLIN( 121)					int h1 = ::hx::Mod(::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::i + a2x1) + ::flixel::addons::util::FlxSimplex_obj::p->__get((::flixel::addons::util::FlxSimplex_obj::j + a2y1)))),12);
HXDLIN( 121)					bool b31 = (((h1 >> 3) & 1) == 1);
HXDLIN( 121)					bool b01 = ((h1 & 1) == 1);
HXDLIN( 121)					if (!(b31)) {
HXLINE( 121)						if (b01) {
HXLINE( 121)							x3 = -(x3);
            						}
...
HXDLIN( 121)					if (!(b31)) {
HXLINE( 121)						if ((((h1 >> 2) & 1) != 1)) {
HXLINE( 121)							if ((((h1 >> 1) & 1) == 1)) {
HXLINE( 121)								y3 = -(y3);
            							}
            						}
            						else {
...
HXLINE( 121)					t3 = (t3 * t3);
HXDLIN( 121)					int h2 = ::hx::Mod(::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::i + a2x2) + ::flixel::addons::util::FlxSimplex_obj::p->__get((::flixel::addons::util::FlxSimplex_obj::j + a2y2)))),12);
HXDLIN( 121)					bool b32 = (((h2 >> 3) & 1) == 1);
HXDLIN( 121)					bool b02 = ((h2 & 1) == 1);
HXDLIN( 121)					if (!(b32)) {
HXLINE( 121)						if (b02) {
HXLINE( 121)							x4 = -(x4);
            						}
...
HXDLIN( 121)					if (!(b32)) {
HXLINE( 121)						if ((((h2 >> 2) & 1) != 1)) {
HXLINE( 121)							if ((((h2 >> 1) & 1) == 1)) {
HXLINE( 121)								y4 = -(y4);
            							}
            						}
            						else {
...
HXLINE( 161)		{
HXLINE( 161)			::flixel::addons::util::FlxSimplex_obj::A2[1] = 0;
HXDLIN( 161)			::flixel::addons::util::FlxSimplex_obj::A2[0] = 0;
            		}
...
HXDLIN( 166)			if (!(b3)) {
HXLINE( 166)				if ((((h >> 2) & 1) != 1)) {
HXLINE( 166)					if ((((h >> 1) & 1) == 1)) {
HXLINE( 166)						y1 = -(y1);
            					}
            				}
            				else {
...
HXLINE( 166)			t2 = (t2 * t2);
HXDLIN( 166)			int h1 = ::hx::Mod(::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::i + a2x1) + ::flixel::addons::util::FlxSimplex_obj::p->__get((::flixel::addons::util::FlxSimplex_obj::j + a2y1)))),12);
HXDLIN( 166)			bool b31 = (((h1 >> 3) & 1) == 1);
HXDLIN( 166)			bool b01 = ((h1 & 1) == 1);
HXDLIN( 166)			if (!(b31)) {
HXLINE( 166)				if (b01) {
HXLINE( 166)					x2 = -(x2);
            				}
...
HXDLIN( 166)			if (!(b31)) {
HXLINE( 166)				if ((((h1 >> 2) & 1) != 1)) {
HXLINE( 166)					if ((((h1 >> 1) & 1) == 1)) {
HXLINE( 166)						y2 = -(y2);
            					}
            				}
            				else {
...
HXLINE( 166)			t3 = (t3 * t3);
HXDLIN( 166)			int h2 = ::hx::Mod(::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::i + a2x2) + ::flixel::addons::util::FlxSimplex_obj::p->__get((::flixel::addons::util::FlxSimplex_obj::j + a2y2)))),12);
HXDLIN( 166)			bool b32 = (((h2 >> 3) & 1) == 1);
HXDLIN( 166)			bool b02 = ((h2 & 1) == 1);
HXDLIN( 166)			if (!(b32)) {
HXLINE( 166)				if (b02) {
HXLINE( 166)					x3 = -(x3);
            				}
...
HXDLIN( 166)			if (!(b32)) {
HXLINE( 166)				if ((((h2 >> 2) & 1) != 1)) {
HXLINE( 166)					if ((((h2 >> 1) & 1) == 1)) {
HXLINE( 166)						y3 = -(y3);
            					}
            				}
            				else {
...
HXLINE( 205)		if (!(b3)) {
HXLINE( 205)			if ((((h >> 2) & 1) != 1)) {
HXLINE( 205)				if ((((h >> 1) & 1) == 1)) {
HXLINE( 205)					y = -(y);
            				}
            			}
            			else {
...
HXLINE( 245)		{
HXLINE( 245)			::flixel::addons::util::FlxSimplex_obj::A2[3] = 0;
HXDLIN( 245)			::flixel::addons::util::FlxSimplex_obj::A2[2] = 0;
HXDLIN( 245)			::flixel::addons::util::FlxSimplex_obj::A2[1] = 0;
HXDLIN( 245)			::flixel::addons::util::FlxSimplex_obj::A2[0] = 0;
            		}
...
HXDLIN( 253)		Float w3 = ((::flixel::addons::util::FlxSimplex_obj::w0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(3)) )) + s1);
HXDLIN( 253)		Float t2 = ((((((Float).6) - (x2 * x2)) - (y2 * y2)) - (z2 * z2)) - (w3 * w3));
...
HXLINE( 253)			t2 = (t2 * t2);
HXDLIN( 253)			int h1 = ::hx::Mod(::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::i + a2x1) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::j + a2y1) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::k + a2z1) + ::flixel::addons::util::FlxSimplex_obj::p->__get((::flixel::addons::util::FlxSimplex_obj::l + a2w1)))))))),32);
HXDLIN( 253)			bool b41 = (((h1 >> 4) & 1) == 1);
HXDLIN( 253)			bool b31 = (((h1 >> 3) & 1) == 1);
HXDLIN( 253)			bool b21 = (((h1 >> 2) & 1) == 1);
HXDLIN( 253)			bool b11 = (((h1 >> 1) & 1) == 1);
HXDLIN( 253)			bool b01 = ((h1 & 1) == 1);
HXDLIN( 253)			if (!(b31)) {
...
HXDLIN( 253)			out1 = ((t2 * t2) * (((x2 + y2) + z2) + w3));
            		}
...
HXDLIN( 254)		Float w5 = ((::flixel::addons::util::FlxSimplex_obj::w0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(3)) )) + s2);
HXDLIN( 254)		Float t3 = ((((((Float).6) - (x3 * x3)) - (y3 * y3)) - (z3 * z3)) - (w5 * w5));
...
HXLINE( 254)			t3 = (t3 * t3);
HXDLIN( 254)			int h2 = ::hx::Mod(::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::i + a2x2) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::j + a2y2) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::k + a2z2) + ::flixel::addons::util::FlxSimplex_obj::p->__get((::flixel::addons::util::FlxSimplex_obj::l + a2w2)))))))),32);
HXDLIN( 254)			bool b42 = (((h2 >> 4) & 1) == 1);
HXDLIN( 254)			bool b32 = (((h2 >> 3) & 1) == 1);
HXDLIN( 254)			bool b22 = (((h2 >> 2) & 1) == 1);
HXDLIN( 254)			bool b12 = (((h2 >> 1) & 1) == 1);
HXDLIN( 254)			bool b02 = ((h2 & 1) == 1);
HXDLIN( 254)			if (!(b32)) {
...
HXDLIN( 254)			out2 = ((t3 * t3) * (((x3 + y3) + z3) + w5));
            		}
...
HXDLIN( 255)		Float w7 = ((::flixel::addons::util::FlxSimplex_obj::w0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(3)) )) + s3);
HXDLIN( 255)		Float t4 = ((((((Float).6) - (x4 * x4)) - (y4 * y4)) - (z4 * z4)) - (w7 * w7));
...
HXLINE( 255)			t4 = (t4 * t4);
HXDLIN( 255)			int h3 = ::hx::Mod(::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::i + a2x3) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::j + a2y3) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::k + a2z3) + ::flixel::addons::util::FlxSimplex_obj::p->__get((::flixel::addons::util::FlxSimplex_obj::l + a2w3)))))))),32);
HXDLIN( 255)			bool b43 = (((h3 >> 4) & 1) == 1);
HXDLIN( 255)			bool b33 = (((h3 >> 3) & 1) == 1);
HXDLIN( 255)			bool b23 = (((h3 >> 2) & 1) == 1);
HXDLIN( 255)			bool b13 = (((h3 >> 1) & 1) == 1);
HXDLIN( 255)			bool b03 = ((h3 & 1) == 1);
HXDLIN( 255)			if (!(b33)) {
...
HXDLIN( 255)			out3 = ((t4 * t4) * (((x4 + y4) + z4) + w7));
            		}
...
HXDLIN( 256)		Float w9 = ((::flixel::addons::util::FlxSimplex_obj::w0 - ( (Float)(::flixel::addons::util::FlxSimplex_obj::A2->__get(3)) )) + s4);
HXDLIN( 256)		Float t5 = ((((((Float).6) - (x5 * x5)) - (y5 * y5)) - (z5 * z5)) - (w9 * w9));
...
HXLINE( 256)			t5 = (t5 * t5);
HXDLIN( 256)			int h4 = ::hx::Mod(::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::i + a2x4) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::j + a2y4) + ::flixel::addons::util::FlxSimplex_obj::p->__get(((::flixel::addons::util::FlxSimplex_obj::k + a2z4) + ::flixel::addons::util::FlxSimplex_obj::p->__get((::flixel::addons::util::FlxSimplex_obj::l + a2w4)))))))),32);
HXDLIN( 256)			bool b44 = (((h4 >> 4) & 1) == 1);
HXDLIN( 256)			bool b34 = (((h4 >> 3) & 1) == 1);
HXDLIN( 256)			bool b24 = (((h4 >> 2) & 1) == 1);
HXDLIN( 256)			bool b14 = (((h4 >> 1) & 1) == 1);
HXDLIN( 256)			bool b04 = ((h4 & 1) == 1);
HXDLIN( 256)			if (!(b34)) {
...
HXLINE( 256)				w10 = false;
            			}
HXDLIN( 256)			if (w10) {
HXLINE( 256)				w9 = ( (Float)(0) );
            			}
            			else {
HXLINE( 256)				if (b04) {
HXLINE( 256)					w9 = -(w9);
...
HXDLIN( 256)			out4 = ((t5 * t5) * (((x5 + y5) + z5) + w9));
            		}
