...
HX_LOCAL_STACK_FRAME(_hx_pos_bb2d225a438df606_31_set_curIndex,"flixel.animation.FlxBaseAnimation","set_curIndex",0x05c5f580,"flixel.animation.FlxBaseAnimation.set_curIndex","flixel/animation/FlxBaseAnimation.hx",31,0x062a9a5f)
HX_LOCAL_STACK_FRAME(_hx_pos_bb2d225a438df606_50_destroy,"flixel.animation.FlxBaseAnimation","destroy",0x93a46e09,"flixel.animation.FlxBaseAnimation.destroy","flixel/animation/FlxBaseAnimation.hx",50,0x062a9a5f)
HX_LOCAL_STACK_FRAME(_hx_pos_bb2d225a438df606_55_update,"flixel.animation.FlxBaseAnimation","update",0xf1225bda,"flixel.animation.FlxBaseAnimation.update","flixel/animation/FlxBaseAnimation.hx",55,0x062a9a5f)
HX_LOCAL_STACK_FRAME(_hx_pos_bb2d225a438df606_59_clone,"flixel.animation.FlxBaseAnimation","clone",0xf2c3a2ac,"flixel.animation.FlxBaseAnimation.clone","flixel/animation/FlxBaseAnimation.hx",59,0x062a9a5f)
namespace flixel{
namespace animation{

void FlxBaseAnimation_obj::__construct( ::flixel::animation::FlxAnimationController Parent,::String Name,::String Prefix){
            	HX_STACKFRAME(&_hx_pos_bb2d225a438df606_8_new)
HXLINE(  28)		this->curIndex = 0;
HXLINE(  44)		this->parent = Parent;
HXLINE(  45)		this->name = Name;
HXLINE(  46)		this->prefix = Prefix;
            	}
...
int FlxBaseAnimation_obj::set_curIndex(int Value){
            	HX_STACKFRAME(&_hx_pos_bb2d225a438df606_31_set_curIndex)
HXLINE(  32)		this->curIndex = Value;
HXLINE(  34)		bool _hx_tmp;
HXDLIN(  34)		if (::hx::IsNotNull( this->parent )) {
HXLINE(  34)			_hx_tmp = ::hx::IsInstanceEq( this->parent->_curAnim,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
HXLINE(  34)			_hx_tmp = false;
            		}
HXDLIN(  34)		if (_hx_tmp) {
HXLINE(  36)			this->parent->set_frameIndex(Value);
            		}
...
void FlxBaseAnimation_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_bb2d225a438df606_50_destroy)
HXLINE(  51)		this->parent = null();
HXLINE(  52)		this->name = null();
            	}
...
void FlxBaseAnimation_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_bb2d225a438df606_55_update)
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxBaseAnimation_obj,update,(void))
 ...
 ::flixel::animation::FlxBaseAnimation FlxBaseAnimation_obj::clone( ::flixel::animation::FlxAnimationController Parent){
            	HX_STACKFRAME(&_hx_pos_bb2d225a438df606_59_clone)
...
::hx::ObjectPtr< FlxBaseAnimation_obj > FlxBaseAnimation_obj::__new( ::flixel::animation::FlxAnimationController Parent,::String Name,::String Prefix) {
	::hx::ObjectPtr< FlxBaseAnimation_obj > __this = new FlxBaseAnimation_obj();
	__this->__construct(Parent,Name,Prefix);
	return __this;
}

::hx::ObjectPtr< FlxBaseAnimation_obj > FlxBaseAnimation_obj::__alloc(::hx::Ctx *_hx_ctx, ::flixel::animation::FlxAnimationController Parent,::String Name,::String Prefix) {
...
static ::hx::StorageInfo FlxBaseAnimation_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsString,(int)offsetof(FlxBaseAnimation_obj,prefix),HX_("prefix",92,d9,b6,ae)},
