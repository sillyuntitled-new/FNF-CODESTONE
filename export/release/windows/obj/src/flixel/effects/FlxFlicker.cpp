...
HX_DEFINE_STACK_FRAME(_hx_pos_605e85deecbe4d03_212_new,"flixel.effects.FlxFlicker","new",0x4bc826b6,"flixel.effects.FlxFlicker.new","flixel/effects/FlxFlicker.hx",212,0x4fa53f38)
...
void FlxFlicker_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_605e85deecbe4d03_212_new)
            	}
...
HXLINE( 203)			if (::hx::IsInstanceEq( this->timer,timer )) {
HXLINE( 204)				this->release();
            			}
            		}
            	}
