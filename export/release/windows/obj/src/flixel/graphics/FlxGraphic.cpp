...
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_494_addFrameCollection,"flixel.graphics.FlxGraphic","addFrameCollection",0x06dd03b1,"flixel.graphics.FlxGraphic.addFrameCollection","flixel/graphics/FlxGraphic.hx",494,0xb3633517)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_536_getEmptyFrame,"flixel.graphics.FlxGraphic","getEmptyFrame",0xc5b0f80f,"flixel.graphics.FlxGraphic.getEmptyFrame","flixel/graphics/FlxGraphic.hx",536,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_549_getBitmapFromSystem,"flixel.graphics.FlxGraphic","getBitmapFromSystem",0xb3be27b7,"flixel.graphics.FlxGraphic.getBitmapFromSystem","flixel/graphics/FlxGraphic.hx",549,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_564_get_isLoaded,"flixel.graphics.FlxGraphic","get_isLoaded",0xcad65c3f,"flixel.graphics.FlxGraphic.get_isLoaded","flixel/graphics/FlxGraphic.hx",564,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_569_get_isDestroyed,"flixel.graphics.FlxGraphic","get_isDestroyed",0x1abb03df,"flixel.graphics.FlxGraphic.get_isDestroyed","flixel/graphics/FlxGraphic.hx",569,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_574_get_canBeDumped,"flixel.graphics.FlxGraphic","get_canBeDumped",0x9b8a5e36,"flixel.graphics.FlxGraphic.get_canBeDumped","flixel/graphics/FlxGraphic.hx",574,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_579_get_useCount,"flixel.graphics.FlxGraphic","get_useCount",0x2bcc1fb8,"flixel.graphics.FlxGraphic.get_useCount","flixel/graphics/FlxGraphic.hx",579,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_583_set_useCount,"flixel.graphics.FlxGraphic","set_useCount",0x40c5432c,"flixel.graphics.FlxGraphic.set_useCount","flixel/graphics/FlxGraphic.hx",583,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_592_get_destroyOnNoUse,"flixel.graphics.FlxGraphic","get_destroyOnNoUse",0x7e860bbd,"flixel.graphics.FlxGraphic.get_destroyOnNoUse","flixel/graphics/FlxGraphic.hx",592,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_596_set_destroyOnNoUse,"flixel.graphics.FlxGraphic","set_destroyOnNoUse",0x5b353e31,"flixel.graphics.FlxGraphic.set_destroyOnNoUse","flixel/graphics/FlxGraphic.hx",596,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_604_get_imageFrame,"flixel.graphics.FlxGraphic","get_imageFrame",0xc1224382,"flixel.graphics.FlxGraphic.get_imageFrame","flixel/graphics/FlxGraphic.hx",604,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_613_get_atlasFrames,"flixel.graphics.FlxGraphic","get_atlasFrames",0x774c10a1,"flixel.graphics.FlxGraphic.get_atlasFrames","flixel/graphics/FlxGraphic.hx",613,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_617_set_bitmap,"flixel.graphics.FlxGraphic","set_bitmap",0x39ee9b13,"flixel.graphics.FlxGraphic.set_bitmap","flixel/graphics/FlxGraphic.hx",617,0xb3633517)
...
HXLINE( 401)		this->shader =  ::flixel::graphics::tile::FlxGraphicsShader_obj::__alloc( HX_CTX );
            	}
...
HXLINE( 466)		this->shader = null();
HXLINE( 468)		this->key = null();
HXLINE( 469)		this->assetsKey = null();
HXLINE( 470)		this->assetsClass = null();
HXLINE( 471)		this->_imageFrame = null();
HXLINE( 473)		if (::hx::IsNull( this->frameCollections )) {
HXLINE( 474)			return;
            		}
HXLINE( 476)		::Array< ::Dynamic> collections;
HXLINE( 477)		{
HXLINE( 477)			int _g = 0;
HXDLIN( 477)			::Array< ::Dynamic> _g1 = this->frameCollectionTypes;
HXDLIN( 477)			while((_g < _g1->length)){
HXLINE( 477)				 ::flixel::graphics::frames::FlxFrameCollectionType collectionType = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrameCollectionType >();
HXDLIN( 477)				_g = (_g + 1);
HXLINE( 479)				collections = ( (::Array< ::Dynamic>)(this->frameCollections->get(collectionType)) );
HXLINE( 480)				::flixel::util::FlxDestroyUtil_obj::destroyArray(collections);
            			}
            		}
HXLINE( 483)		this->frameCollections = null();
HXLINE( 484)		this->frameCollectionTypes = null();
            	}
...
void FlxGraphic_obj::addFrameCollection( ::flixel::graphics::frames::FlxFramesCollection collection){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_494_addFrameCollection)
HXDLIN( 494)		if (::hx::IsNotNull( collection->type )) {
HXLINE( 496)			 ::flixel::graphics::frames::FlxFrameCollectionType type = collection->type;
HXDLIN( 496)			::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(this->frameCollections->get(type)) );
HXDLIN( 496)			if (::hx::IsNull( collections )) {
HXLINE( 496)				collections = ::Array_obj< ::Dynamic>::__new();
HXDLIN( 496)				this->frameCollections->set(type,collections);
HXDLIN( 496)				if (!(this->frameCollectionTypes->contains(type))) {
HXLINE( 496)					this->frameCollectionTypes->push(type);
            				}
            			}
HXLINE( 497)			collections->push(collection);
HXLINE( 500)			if (!(this->frameCollectionTypes->contains(collection->type))) {
HXLINE( 501)				this->frameCollectionTypes->push(collection->type);
            			}
            		}
            	}
...
HXLINE( 521)			if (!(this->frameCollectionTypes->contains(type))) {
HXLINE( 522)				this->frameCollectionTypes->push(type);
            			}
            		}
HXLINE( 525)		return collections;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,getFramesCollections,return )
 ...
 ::flixel::graphics::frames::FlxFrame FlxGraphic_obj::getEmptyFrame( ::flixel::math::FlxBasePoint size){
            	HX_GC_STACKFRAME(&_hx_pos_3b8710f86d15c371_536_getEmptyFrame)
HXLINE( 537)		 ::flixel::graphics::frames::FlxFrame frame =  ::flixel::graphics::frames::FlxFrame_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),null(),null(),null(),null());
HXLINE( 538)		frame->type = ( (signed char)(2) );
HXLINE( 539)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 539)		_this->x = ( (Float)(0) );
HXDLIN( 539)		_this->y = ( (Float)(0) );
HXDLIN( 539)		_this->width = ( (Float)(0) );
HXDLIN( 539)		_this->height = ( (Float)(0) );
HXDLIN( 539)		_this->_inPool = false;
HXDLIN( 539)		frame->set_frame(_this);
HXLINE( 540)		{
HXLINE( 540)			frame->sourceSize->set(size->x,size->y);
HXDLIN( 540)			{
HXLINE( 540)				 ::flixel::math::FlxBasePoint _this1 = size;
HXDLIN( 540)				if (_this1->_weak) {
HXLINE( 540)					_this1->put();
            				}
            			}
            		}
HXLINE( 541)		return frame;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,getEmptyFrame,return )
 ...
 ::openfl::display::BitmapData FlxGraphic_obj::getBitmapFromSystem(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_549_getBitmapFromSystem)
HXLINE( 550)		 ::openfl::display::BitmapData newBitmap = null();
HXLINE( 551)		if (::hx::IsNotNull( this->assetsClass )) {
HXLINE( 552)			newBitmap = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(this->assetsClass,::cpp::VirtualArray_obj::__new(0))) );
            		}
            		else {
HXLINE( 553)			if (::hx::IsNotNull( this->assetsKey )) {
HXLINE( 554)				::String id = this->assetsKey;
HXDLIN( 554)				if (::openfl::utils::Assets_obj::exists(id,null())) {
HXLINE( 554)					newBitmap = ::openfl::utils::Assets_obj::getBitmapData(id,false,null());
            				}
            				else {
HXLINE( 554)					::flixel::FlxG_obj::log->advanced(((HX_("Could not find a BitmapData asset with ID '",5f,79,a9,21) + id) + HX_("'.",27,22,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
HXDLIN( 554)					newBitmap = null();
            				}
            			}
            		}
HXLINE( 556)		if (::hx::IsNotNull( newBitmap )) {
HXLINE( 557)			if (this->unique) {
HXLINE( 557)				return newBitmap->clone();
            			}
            			else {
HXLINE( 557)				return newBitmap;
            			}
            		}
...
bool FlxGraphic_obj::get_isLoaded(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_564_get_isLoaded)
HXDLIN( 564)		if (::hx::IsNotNull( this->bitmap )) {
HXDLIN( 564)			 ::openfl::geom::Rectangle _this = this->bitmap->rect;
HXDLIN( 564)			bool _hx_tmp;
HXDLIN( 564)			if (!((_this->width <= 0))) {
HXDLIN( 564)				_hx_tmp = (_this->height <= 0);
            			}
            			else {
HXDLIN( 564)				_hx_tmp = true;
            			}
HXDLIN( 564)			return !(_hx_tmp);
            		}
            		else {
...
bool FlxGraphic_obj::get_isDestroyed(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_569_get_isDestroyed)
HXDLIN( 569)		return ::hx::IsNull( this->shader );
            	}
...
bool FlxGraphic_obj::get_canBeDumped(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_574_get_canBeDumped)
HXDLIN( 574)		if (::hx::IsNull( this->assetsClass )) {
HXDLIN( 574)			return ::hx::IsNotNull( this->assetsKey );
            		}
            		else {
HXDLIN( 574)			return true;
            		}
HXDLIN( 574)		return false;
            	}
...
int FlxGraphic_obj::get_useCount(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_579_get_useCount)
HXDLIN( 579)		return this->_useCount;
            	}
...
int FlxGraphic_obj::set_useCount(int Value){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_583_set_useCount)
HXLINE( 584)		bool _hx_tmp;
HXDLIN( 584)		bool _hx_tmp1;
HXDLIN( 584)		bool _hx_tmp2;
HXDLIN( 584)		if (!(::flixel::FlxG_obj::bitmap->_hx___doNotDelete)) {
HXLINE( 584)			_hx_tmp2 = (Value <= 0);
            		}
            		else {
HXLINE( 584)			_hx_tmp2 = false;
            		}
HXDLIN( 584)		if (_hx_tmp2) {
HXLINE( 584)			_hx_tmp1 = this->_destroyOnNoUse;
            		}
            		else {
HXLINE( 584)			_hx_tmp1 = false;
            		}
HXDLIN( 584)		if (_hx_tmp1) {
HXLINE( 584)			_hx_tmp = !(this->persist);
            		}
            		else {
HXLINE( 584)			_hx_tmp = false;
            		}
HXDLIN( 584)		if (_hx_tmp) {
HXLINE( 585)			::flixel::FlxG_obj::bitmap->remove(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 587)		return (this->_useCount = Value);
            	}
...
bool FlxGraphic_obj::get_destroyOnNoUse(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_592_get_destroyOnNoUse)
HXDLIN( 592)		return this->_destroyOnNoUse;
            	}
...
bool FlxGraphic_obj::set_destroyOnNoUse(bool Value){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_596_set_destroyOnNoUse)
HXLINE( 597)		bool _hx_tmp;
HXDLIN( 597)		bool _hx_tmp1;
HXDLIN( 597)		bool _hx_tmp2;
HXDLIN( 597)		bool _hx_tmp3;
HXDLIN( 597)		if (Value) {
HXLINE( 597)			_hx_tmp3 = !(::flixel::FlxG_obj::bitmap->_hx___doNotDelete);
            		}
            		else {
HXLINE( 597)			_hx_tmp3 = false;
            		}
HXDLIN( 597)		if (_hx_tmp3) {
HXLINE( 597)			_hx_tmp2 = (this->_useCount <= 0);
            		}
            		else {
HXLINE( 597)			_hx_tmp2 = false;
            		}
HXDLIN( 597)		if (_hx_tmp2) {
HXLINE( 597)			_hx_tmp1 = ::hx::IsNotNull( this->key );
            		}
            		else {
HXLINE( 597)			_hx_tmp1 = false;
            		}
HXDLIN( 597)		if (_hx_tmp1) {
HXLINE( 597)			_hx_tmp = !(this->persist);
            		}
            		else {
HXLINE( 597)			_hx_tmp = false;
            		}
HXDLIN( 597)		if (_hx_tmp) {
HXLINE( 598)			::flixel::FlxG_obj::bitmap->remove(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 600)		return (this->_destroyOnNoUse = Value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,set_destroyOnNoUse,return )
 ...
 ::flixel::graphics::frames::FlxImageFrame FlxGraphic_obj::get_imageFrame(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_604_get_imageFrame)
HXLINE( 605)		if (::hx::IsNull( this->_imageFrame )) {
HXLINE( 606)			Float Width = ( (Float)(this->bitmap->width) );
HXDLIN( 606)			Float Height = ( (Float)(this->bitmap->height) );
HXDLIN( 606)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 606)			_this->x = ( (Float)(0) );
HXDLIN( 606)			_this->y = ( (Float)(0) );
HXDLIN( 606)			_this->width = Width;
HXDLIN( 606)			_this->height = Height;
HXDLIN( 606)			_this->_inPool = false;
HXDLIN( 606)			this->_imageFrame = ::flixel::graphics::frames::FlxImageFrame_obj::fromRectangle(::hx::ObjectPtr<OBJ_>(this),_this);
            		}
HXLINE( 608)		return this->_imageFrame;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get_imageFrame,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxGraphic_obj::get_atlasFrames(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_613_get_atlasFrames)
HXDLIN( 613)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(::hx::ObjectPtr<OBJ_>(this),null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get_atlasFrames,return )
 ...
 ::openfl::display::BitmapData FlxGraphic_obj::set_bitmap( ::openfl::display::BitmapData value){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_617_set_bitmap)
HXLINE( 618)		if (::hx::IsNotNull( value )) {
HXLINE( 620)			this->bitmap = value;
HXLINE( 621)			this->width = this->bitmap->width;
HXLINE( 622)			this->height = this->bitmap->height;
            		}
...
HXLINE(  46)				bitmap1 = ::openfl::utils::Assets_obj::getBitmapData(Source,false,null());
            			}
            			else {
...
HXLINE(  53)			graphic->mustDestroy = false;
            		}
HXDLIN(  53)		 ::flixel::graphics::FlxGraphic graphic1 = graphic;
...
HXLINE(  57)			bitmap2 = ::openfl::utils::Assets_obj::getBitmapData(Source,false,null());
            		}
            		else {
...
HXLINE(  61)		graphic1 = ::flixel::graphics::FlxGraphic_obj::createGraphic(bitmap,key,Unique,null());
HXLINE(  62)		graphic1->assetsKey = Source;
HXLINE(  63)		return graphic1;
            	}
...
HXLINE(  85)		::String key = ::Type_obj::getClassName(Source);
...
HXDLIN(  87)		if (::hx::IsNotNull( graphic )) {
HXLINE(  87)			graphic->mustDestroy = false;
            		}
HXDLIN(  87)		 ::flixel::graphics::FlxGraphic graphic1 = graphic;
...
HXLINE(  92)		graphic1 = ::flixel::graphics::FlxGraphic_obj::createGraphic(bitmap,key,Unique,null());
HXLINE(  93)		graphic1->assetsClass = Source;
HXLINE(  94)		return graphic1;
            	}
...
HXLINE( 119)			 ::flixel::graphics::FlxGraphic graphic1 = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
HXDLIN( 119)			if (::hx::IsNotNull( graphic1 )) {
HXLINE( 119)				graphic1->mustDestroy = false;
            			}
HXDLIN( 119)			graphic = graphic1;
HXLINE( 120)			assetKey = graphic1->assetsKey;
HXLINE( 121)			assetClass = graphic1->assetsClass;
            		}
HXLINE( 124)		key = ::flixel::FlxG_obj::bitmap->generateKey(key,Key,Unique);
HXLINE( 125)		 ::flixel::graphics::FlxGraphic graphic2 = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
HXDLIN( 125)		if (::hx::IsNotNull( graphic2 )) {
HXLINE( 125)			graphic2->mustDestroy = false;
            		}
HXDLIN( 125)		graphic = graphic2;
HXLINE( 126)		if (::hx::IsNotNull( graphic2 )) {
HXLINE( 127)			return graphic2;
            		}
...
HXLINE( 153)			graphic->mustDestroy = false;
            		}
HXDLIN( 153)		 ::flixel::graphics::FlxGraphic graphic1 = graphic;
HXLINE( 154)		if (::hx::IsNotNull( graphic )) {
HXLINE( 155)			return graphic;
            		}
HXLINE( 158)		graphic1 = ::flixel::graphics::FlxGraphic_obj::createGraphic(Source->paint(null(),null(),null(),null()),key,Unique,Cache);
HXLINE( 160)		::flixel::graphics::frames::FlxImageFrame_obj::fromGraphic(graphic1,null())->frames->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name = Source->name;
HXLINE( 161)		return graphic1;
            	}
...
HXDLIN( 200)		graphic->mustDestroy = false;
...
HXLINE( 216)		::String key = ::flixel::FlxG_obj::bitmap->generateKey(((((Width + HX_("x",78,00,00,00)) + Height) + HX_(":",3a,00,00,00)) + Color),Key,Unique);
HXLINE( 218)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
HXDLIN( 218)		if (::hx::IsNotNull( graphic )) {
HXLINE( 218)			graphic->mustDestroy = false;
            		}
HXLINE( 219)		if (::hx::IsNotNull( graphic )) {
HXLINE( 220)			return graphic;
            		}
HXLINE( 223)		return ::flixel::graphics::FlxGraphic_obj::createGraphic( ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,Width,Height,true,Color),key,null(),null());
            	}
...
HXDLIN( 257)				graphic->mustDestroy = false;
            			}
            		}
            		else {
...
void FlxGraphic_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(mustDestroy,"mustDestroy");
...
{
	HX_VISIT_MEMBER_NAME(mustDestroy,"mustDestroy");
...
::hx::Val FlxGraphic_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"mustDestroy") ) { return ::hx::Val( mustDestroy ); }
...
::hx::Val FlxGraphic_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"mustDestroy") ) { mustDestroy=inValue.Cast< bool >(); return inValue; }
...
{
	outFields->push(HX_("mustDestroy",f1,a9,e1,5f));
...
static ::hx::StorageInfo FlxGraphic_obj_sMemberStorageInfo[] = {
	{::hx::fsBool,(int)offsetof(FlxGraphic_obj,mustDestroy),HX_("mustDestroy",f1,a9,e1,5f)},
