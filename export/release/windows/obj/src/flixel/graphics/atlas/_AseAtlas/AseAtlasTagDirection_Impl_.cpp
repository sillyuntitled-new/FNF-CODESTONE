...
HX_LOCAL_STACK_FRAME(_hx_pos_1abe9245d4707fb2_140_isForward,"flixel.graphics.atlas._AseAtlas.AseAtlasTagDirection_Impl_","isForward",0x22232775,"flixel.graphics.atlas._AseAtlas.AseAtlasTagDirection_Impl_.isForward","flixel/graphics/atlas/AseAtlas.hx",140,0x195d9311)
HX_LOCAL_STACK_FRAME(_hx_pos_1abe9245d4707fb2_144_isReverse,"flixel.graphics.atlas._AseAtlas.AseAtlasTagDirection_Impl_","isReverse",0x57547ed2,"flixel.graphics.atlas._AseAtlas.AseAtlasTagDirection_Impl_.isReverse","flixel/graphics/atlas/AseAtlas.hx",144,0x195d9311)
HX_LOCAL_STACK_FRAME(_hx_pos_1abe9245d4707fb2_148_isPingPong,"flixel.graphics.atlas._AseAtlas.AseAtlasTagDirection_Impl_","isPingPong",0x240173da,"flixel.graphics.atlas._AseAtlas.AseAtlasTagDirection_Impl_.isPingPong","flixel/graphics/atlas/AseAtlas.hx",148,0x195d9311)
HX_LOCAL_STACK_FRAME(_hx_pos_1abe9245d4707fb2_133_boot,"flixel.graphics.atlas._AseAtlas.AseAtlasTagDirection_Impl_","boot",0x9f4a8df8,"flixel.graphics.atlas._AseAtlas.AseAtlasTagDirection_Impl_.boot","flixel/graphics/atlas/AseAtlas.hx",133,0x195d9311)
...
bool AseAtlasTagDirection_Impl__obj::isForward(::String this1){
            	HX_STACKFRAME(&_hx_pos_1abe9245d4707fb2_140_isForward)
HXDLIN( 140)		if ((this1 != HX_("forward",c5,e1,ca,e5))) {
HXDLIN( 140)			return (this1 == HX_("pingpong",6a,93,43,a8));
            		}
            		else {
...
bool AseAtlasTagDirection_Impl__obj::isReverse(::String this1){
            	HX_STACKFRAME(&_hx_pos_1abe9245d4707fb2_144_isReverse)
HXDLIN( 144)		bool _hx_tmp;
HXDLIN( 144)		if ((this1 != HX_("forward",c5,e1,ca,e5))) {
HXDLIN( 144)			_hx_tmp = (this1 == HX_("pingpong",6a,93,43,a8));
            		}
            		else {
HXDLIN( 144)			_hx_tmp = true;
            		}
HXDLIN( 144)		return !(_hx_tmp);
            	}
...
bool AseAtlasTagDirection_Impl__obj::isPingPong(::String this1){
            	HX_STACKFRAME(&_hx_pos_1abe9245d4707fb2_148_isPingPong)
HXDLIN( 148)		if ((this1 != HX_("pingpong",6a,93,43,a8))) {
HXDLIN( 148)			return (this1 == HX_("pingpong_reverse",0d,a0,38,6f));
            		}
            		else {
...
{
{
            	HX_STACKFRAME(&_hx_pos_1abe9245d4707fb2_133_boot)
