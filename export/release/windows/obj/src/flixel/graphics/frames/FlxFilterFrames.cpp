...
HXLINE(  92)		{
HXLINE(  92)			 ::flixel::math::FlxBasePoint _this = spr->offset;
...
HXLINE( 113)					this->framesByName->set(frame->name,filterFrame);
            				}
            			}
            		}
...
HXLINE( 194)				{
HXLINE( 194)					 ::openfl::geom::Rectangle _this = ::flixel::graphics::frames::FlxFilterFrames_obj::rect;
HXDLIN( 194)					Float widtha = frame->sourceSize->x;
HXDLIN( 194)					Float heighta = frame->sourceSize->y;
HXDLIN( 194)					_this->x = ( (Float)(0) );
HXDLIN( 194)					_this->y = ( (Float)(0) );
HXDLIN( 194)					_this->width = widtha;
HXDLIN( 194)					_this->height = heighta;
            				}
