...
HX_LOCAL_STACK_FRAME(_hx_pos_43be537ea661b39f_116_fromFrameAddSpacesAndBorders,"flixel.graphics.frames.FlxTileFrames","fromFrameAddSpacesAndBorders",0x8cf4341a,"flixel.graphics.frames.FlxTileFrames.fromFrameAddSpacesAndBorders","flixel/graphics/frames/FlxTileFrames.hx",116,0x562d6bb0)
...
HXDLIN( 500)			_this->_inPool = false;
HXDLIN( 500)			_this->_weak = true;
HXDLIN( 500)			region = _this;
            		}
HXLINE( 502)		if (::hx::IsNull( tileSpacing )) {
HXLINE( 503)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 506)			 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 517)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 517)		point->_inPool = false;
HXDLIN( 517)		 ::flixel::math::FlxBasePoint _this = point;
HXDLIN( 517)		 ::flixel::math::FlxBasePoint point1 = this->border;
HXDLIN( 517)		{
HXLINE( 517)			Float y = point1->y;
HXDLIN( 517)			_this->set_x((_this->x + point1->x));
HXDLIN( 517)			_this->set_y((_this->y + y));
            		}
HXDLIN( 517)		{
HXLINE( 517)			 ::flixel::math::FlxBasePoint _this1 = point1;
HXDLIN( 517)			if (_this1->_weak) {
HXLINE( 517)				_this1->put();
            			}
            		}
HXDLIN( 517)		 ::flixel::math::FlxBasePoint _this2 = _this;
HXDLIN( 517)		{
HXLINE( 517)			Float y1 = border->y;
HXDLIN( 517)			_this2->set_x((_this2->x + border->x));
HXDLIN( 517)			_this2->set_y((_this2->y + y1));
            		}
HXDLIN( 517)		{
HXLINE( 517)			 ::flixel::math::FlxBasePoint _this3 = border;
HXDLIN( 517)			if (_this3->_weak) {
HXLINE( 517)				_this3->put();
            			}
            		}
HXDLIN( 517)		 ::flixel::math::FlxBasePoint resultBorder = _this2;
HXLINE( 518)		 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 518)		point2->_inPool = false;
HXDLIN( 518)		 ::flixel::math::FlxBasePoint _this4 = point2;
HXDLIN( 518)		 ::flixel::math::FlxBasePoint p = this->tileSize;
HXDLIN( 518)		_this4->set(p->x,p->y);
HXDLIN( 518)		{
HXLINE( 518)			 ::flixel::math::FlxBasePoint _this5 = p;
HXDLIN( 518)			if (_this5->_weak) {
HXLINE( 518)				_this5->put();
            			}
            		}
HXDLIN( 518)		 ::flixel::math::FlxBasePoint _this6 = _this4;
HXDLIN( 518)		Float y2 = (( (Float)(2) ) * border->y);
HXDLIN( 518)		_this6->set_x((_this6->x - (( (Float)(2) ) * border->x)));
HXDLIN( 518)		_this6->set_y((_this6->y - y2));
HXDLIN( 518)		 ::flixel::math::FlxBasePoint resultSize = _this6;
...
HXLINE( 522)			::flixel::util::FlxDestroyUtil_obj::put(resultSize);
...
HXLINE( 527)		 ::flixel::math::FlxRect _this7 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 527)		_this7->x = ( (Float)(0) );
HXDLIN( 527)		_this7->y = ( (Float)(0) );
HXDLIN( 527)		_this7->width = ( (Float)(0) );
HXDLIN( 527)		_this7->height = ( (Float)(0) );
HXDLIN( 527)		_this7->_inPool = false;
HXDLIN( 527)		 ::flixel::math::FlxRect Rect = this->region;
HXDLIN( 527)		_this7->x = Rect->x;
HXDLIN( 527)		_this7->y = Rect->y;
HXDLIN( 527)		_this7->width = Rect->width;
HXDLIN( 527)		_this7->height = Rect->height;
...
HXDLIN( 527)		tileFrames->region = _this7;
HXLINE( 528)		tileFrames->atlasFrame = this->atlasFrame;
HXLINE( 529)		tileFrames->tileSize = resultSize;
HXLINE( 530)		 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 530)		point3->_inPool = false;
HXDLIN( 530)		 ::flixel::math::FlxBasePoint _this8 = point3;
HXDLIN( 530)		 ::flixel::math::FlxBasePoint p1 = this->tileSpacing;
HXDLIN( 530)		_this8->set(p1->x,p1->y);
HXDLIN( 530)		{
HXLINE( 530)			 ::flixel::math::FlxBasePoint _this9 = p1;
HXDLIN( 530)			if (_this9->_weak) {
HXLINE( 530)				_this9->put();
            			}
            		}
HXDLIN( 530)		tileFrames->tileSpacing = _this8;
HXLINE( 532)		{
HXLINE( 532)			int _g = 0;
...
HXLINE(  78)		 ::flixel::graphics::FlxGraphic graphic1 = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
HXDLIN(  78)		if (::hx::IsNotNull( graphic1 )) {
HXLINE(  78)			graphic1->mustDestroy = false;
            		}
HXDLIN(  78)		 ::flixel::graphics::FlxGraphic result = graphic1;
HXLINE(  79)		if (::hx::IsNull( graphic1 )) {
...
HXLINE(  94)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  94)		point->_inPool = false;
HXDLIN(  94)		 ::flixel::math::FlxBasePoint _this = point;
HXDLIN(  94)		{
HXLINE(  94)			Float y = tileSize->y;
HXDLIN(  94)			_this->set_x((_this->x + tileSize->x));
HXDLIN(  94)			_this->set_y((_this->y + y));
            		}
HXDLIN(  94)		{
HXLINE(  94)			 ::flixel::math::FlxBasePoint _this1 = tileSize;
HXDLIN(  94)			if (_this1->_weak) {
HXLINE(  94)				_this1->put();
            			}
            		}
HXDLIN(  94)		 ::flixel::math::FlxBasePoint _this2 = _this;
HXDLIN(  94)		_this2->set_x((_this2->x + (2 * borderX)));
HXDLIN(  94)		_this2->set_y((_this2->y + (2 * borderY)));
HXDLIN(  94)		 ::flixel::graphics::frames::FlxTileFrames tileFrames = ::flixel::graphics::frames::FlxTileFrames_obj::fromGraphic(result,_this2,null(),tileSpacing);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC5(FlxTileFrames_obj,fromBitmapAddSpacesAndBorders,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxTileFrames_obj::fromFrameAddSpacesAndBorders( ::flixel::graphics::frames::FlxFrame frame, ::flixel::math::FlxBasePoint tileSize, ::flixel::math::FlxBasePoint tileSpacing, ::flixel::math::FlxBasePoint tileBorder){
            	HX_STACKFRAME(&_hx_pos_43be537ea661b39f_116_fromFrameAddSpacesAndBorders)
HXDLIN( 116)		return ::flixel::graphics::frames::FlxTileFrames_obj::fromBitmapAddSpacesAndBorders(frame->paint(null(),null(),null(),null()),tileSize,tileSpacing,tileBorder,null());
            	}
...
HXLINE( 147)		{
HXLINE( 147)			 ::flixel::math::FlxBasePoint _this = tileSpacing;
HXDLIN( 147)			_this->set_x(( (Float)(::Math_obj::floor(_this->x)) ));
HXDLIN( 147)			_this->set_y(( (Float)(::Math_obj::floor(_this->y)) ));
            		}
HXLINE( 148)		{
HXLINE( 148)			 ::flixel::math::FlxBasePoint _this1 = tileSize;
HXDLIN( 148)			_this1->set_x(( (Float)(::Math_obj::floor(_this1->x)) ));
HXDLIN( 148)			_this1->set_y(( (Float)(::Math_obj::floor(_this1->y)) ));
            		}
...
HXDLIN( 156)		 ::flixel::math::FlxRect _this2 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 156)		_this2->x = ( (Float)(0) );
HXDLIN( 156)		_this2->y = ( (Float)(0) );
HXDLIN( 156)		_this2->width = Width;
HXDLIN( 156)		_this2->height = Height;
HXDLIN( 156)		_this2->_inPool = false;
HXLINE( 158)		{
HXLINE( 158)			int _g = 0;
...
HXLINE( 162)						_this2->x = (spacedWidth * ( (Float)((_g2 - 1)) ));
HXLINE( 163)						_this2->y = (spacedHeight * ( (Float)(j) ));
HXLINE( 164)						tileFrames->pushFrame(frame->subFrameTo(_this2,null()));
            					}
            				}
            			}
            		}
HXLINE( 168)		::flixel::util::FlxDestroyUtil_obj::put(_this2);
...
HXLINE( 201)		 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 201)		point1->_inPool = false;
HXDLIN( 201)		 ::flixel::math::FlxBasePoint _this1 = point1;
HXDLIN( 201)		 ::flixel::math::FlxBasePoint p = firstFrame->sourceSize;
HXDLIN( 201)		_this1->set(p->x,p->y);
HXDLIN( 201)		{
HXLINE( 201)			 ::flixel::math::FlxBasePoint _this2 = p;
HXDLIN( 201)			if (_this2->_weak) {
HXLINE( 201)				_this2->put();
            			}
            		}
HXDLIN( 201)		tileFrames->tileSize = _this1;
HXLINE( 202)		 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(0,0);
...
HXLINE( 281)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(0,0);
...
HXLINE( 290)		{
HXLINE( 290)			 ::flixel::math::FlxBasePoint _this1 = tileSpacing;
HXDLIN( 290)			_this1->set_x(( (Float)(::Math_obj::floor(_this1->x)) ));
HXDLIN( 290)			_this1->set_y(( (Float)(::Math_obj::floor(_this1->y)) ));
            		}
HXLINE( 291)		{
HXLINE( 291)			 ::flixel::math::FlxBasePoint _this2 = tileSize;
HXDLIN( 291)			_this2->set_x(( (Float)(::Math_obj::floor(_this2->x)) ));
HXDLIN( 291)			_this2->set_y(( (Float)(::Math_obj::floor(_this2->y)) ));
            		}
...
HXLINE( 305)						Float X = (region->x + (( (Float)((_g2 - 1)) ) * spacedWidth));
HXDLIN( 305)						Float Y = (region->y + (( (Float)(j) ) * spacedHeight));
HXDLIN( 305)						Float Width1 = tileSize->x;
HXDLIN( 305)						Float Height1 = tileSize->y;
HXDLIN( 305)						 ::flixel::math::FlxRect _this3 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 305)						_this3->x = X;
HXDLIN( 305)						_this3->y = Y;
HXDLIN( 305)						_this3->width = Width1;
HXDLIN( 305)						_this3->height = Height1;
HXDLIN( 305)						_this3->_inPool = false;
HXLINE( 306)						tileFrames->addSpriteSheetFrame(_this3);
            					}
            				}
            			}
            		}
...
HXLINE( 419)		cols = ::Std_obj::_hx_int((::Math_obj::sqrt(( (Float)(totalArea) )) / ( (Float)((tileWidth + (2 * borderX))) )));
...
HXLINE( 427)		 ::flixel::graphics::frames::FlxTileFrames result =  ::flixel::graphics::frames::FlxTileFrames_obj::__alloc( HX_CTX ,::flixel::FlxG_obj::bitmap->add(combined,null(),null()),null());
...
HXDLIN( 430)		result->region = _this;
HXLINE( 431)		result->atlasFrame = null();
HXLINE( 432)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(tileWidth,tileHeight);
HXDLIN( 432)		point->_inPool = false;
HXDLIN( 432)		result->tileSize = point;
HXLINE( 433)		 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(spaceX,spaceY);
...
HXDLIN( 443)						_this1->_inPool = false;
HXDLIN( 443)						 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(tileWidth,tileHeight);
HXDLIN( 443)						point2->_inPool = false;
HXDLIN( 443)						 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(0,0);
HXDLIN( 443)						point3->_inPool = false;
HXDLIN( 443)						result->addAtlasFrame(_this1,point2,point3,null(),null(),null(),null(),null());
HXLINE( 444)						destPoint->x = (destPoint->x + ((tileWidth + (2 * borderX)) + spaceX));
HXLINE( 446)						if ((destPoint->x >= combined->width)) {
HXLINE( 448)							destPoint->x = ( (Float)(borderX) );
HXLINE( 449)							destPoint->y = (destPoint->y + ((tileHeight + (2 * borderY)) + spaceY));
            						}
            					}
            				}
            			}
...
HXDLIN( 473)			if (!(graphic->frameCollectionTypes->contains(type))) {
HXLINE( 473)				graphic->frameCollectionTypes->push(type);
            			}
            		}
