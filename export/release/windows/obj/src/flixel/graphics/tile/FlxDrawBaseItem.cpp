...
HX_DEFINE_STACK_FRAME(_hx_pos_0484b113da1bcafb_13_new,"flixel.graphics.tile.FlxDrawBaseItem","new",0x1069797d,"flixel.graphics.tile.FlxDrawBaseItem.new","flixel/graphics/tile/FlxDrawBaseItem.hx",13,0xe6349cf4)
...
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_22_blendToInt,"flixel.graphics.tile.FlxDrawBaseItem","blendToInt",0xc101e4a6,"flixel.graphics.tile.FlxDrawBaseItem.blendToInt","flixel/graphics/tile/FlxDrawBaseItem.hx",22,0xe6349cf4)
HX_LOCAL_STACK_FRAME(_hx_pos_0484b113da1bcafb_18_boot,"flixel.graphics.tile.FlxDrawBaseItem","boot",0x43f9d475,"flixel.graphics.tile.FlxDrawBaseItem.boot","flixel/graphics/tile/FlxDrawBaseItem.hx",18,0xe6349cf4)
namespace flixel{
namespace graphics{
namespace tile{

void FlxDrawBaseItem_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_13_new)
HXLINE(  35)		this->type = ( (unsigned char)(0) );
HXLINE(  32)		this->hasColorOffsets = false;
HXLINE(  31)		this->colored = false;
HXLINE(  30)		this->antialiasing = false;
            	}
...
HXLINE(  55)		this->type = ( (unsigned char)(0) );
...
int FlxDrawBaseItem_obj::blendToInt( ::Dynamic blend){
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_22_blendToInt)
HXDLIN(  22)		return 0;
            	}
...
::hx::Val FlxDrawBaseItem_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"type") ) { type=inValue.Cast< unsigned char >(); return inValue; }
		break;
	case 5:
...
static ::hx::StorageInfo FlxDrawBaseItem_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsUnknown /* unsigned char */ ,(int)offsetof(FlxDrawBaseItem_obj,type),HX_("type",ba,f2,08,4d)},
	{ ::hx::fsUnknown, 0, null()}
};
...
{
{
            	HX_STACKFRAME(&_hx_pos_0484b113da1bcafb_18_boot)
HXDLIN(  18)		drawCalls = 0;
            	}
}
