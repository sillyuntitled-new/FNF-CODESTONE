...
HX_LOCAL_STACK_FRAME(_hx_pos_6d98322fc3998392_126_render,"flixel.graphics.tile.FlxDrawQuadsItem","render",0x6514132c,"flixel.graphics.tile.FlxDrawQuadsItem.render","flixel/graphics/tile/FlxDrawQuadsItem.hx",126,0x0f089c65)
HX_LOCAL_STACK_FRAME(_hx_pos_6d98322fc3998392_192_setParameterValue,"flixel.graphics.tile.FlxDrawQuadsItem","setParameterValue",0x1b657834,"flixel.graphics.tile.FlxDrawQuadsItem.setParameterValue","flixel/graphics/tile/FlxDrawQuadsItem.hx",192,0x0f089c65)
...
HXLINE(  28)		this->type = ( (unsigned char)(1) );
...
HXLINE(  60)		this->rects->push(rect->x);
HXLINE(  61)		this->rects->push(rect->y);
HXLINE(  62)		this->rects->push(rect->width);
HXLINE(  63)		this->rects->push(rect->height);
HXLINE(  65)		this->transforms->push(matrix->a);
HXLINE(  66)		this->transforms->push(matrix->b);
HXLINE(  67)		this->transforms->push(matrix->c);
HXLINE(  68)		this->transforms->push(matrix->d);
HXLINE(  69)		this->transforms->push(matrix->tx);
HXLINE(  70)		this->transforms->push(matrix->ty);
HXLINE(  72)		Float alphaMultiplier;
HXDLIN(  72)		if (::hx::IsNotNull( transform )) {
HXLINE(  72)			alphaMultiplier = transform->alphaMultiplier;
            		}
            		else {
HXLINE(  72)			alphaMultiplier = ((Float)1.0);
            		}
HXLINE(  73)		{
HXLINE(  74)			this->alphas->push(alphaMultiplier);
HXDLIN(  74)			this->alphas->push(alphaMultiplier);
HXDLIN(  74)			this->alphas->push(alphaMultiplier);
HXDLIN(  74)			this->alphas->push(alphaMultiplier);
            		}
HXLINE(  76)		bool _hx_tmp;
HXDLIN(  76)		if (!(this->colored)) {
HXLINE(  76)			_hx_tmp = this->hasColorOffsets;
            		}
            		else {
HXLINE(  76)			_hx_tmp = true;
            		}
HXDLIN(  76)		if (_hx_tmp) {
HXLINE(  78)			if (::hx::IsNull( this->colorMultipliers )) {
HXLINE(  79)				this->colorMultipliers = ::Array_obj< Float >::__new(0);
            			}
HXLINE(  81)			if (::hx::IsNull( this->colorOffsets )) {
HXLINE(  82)				this->colorOffsets = ::Array_obj< Float >::__new(0);
            			}
HXLINE(  84)			{
HXLINE(  84)				int _g = 0;
HXDLIN(  84)				while((_g < 4)){
HXLINE(  84)					_g = (_g + 1);
HXLINE(  86)					if (::hx::IsNotNull( transform )) {
HXLINE(  88)						this->colorMultipliers->push(transform->redMultiplier);
HXLINE(  89)						this->colorMultipliers->push(transform->greenMultiplier);
HXLINE(  90)						this->colorMultipliers->push(transform->blueMultiplier);
HXLINE(  91)						this->colorMultipliers->push(1);
HXLINE(  93)						this->colorOffsets->push(transform->redOffset);
HXLINE(  94)						this->colorOffsets->push(transform->greenOffset);
HXLINE(  95)						this->colorOffsets->push(transform->blueOffset);
HXLINE(  96)						this->colorOffsets->push(transform->alphaOffset);
            					}
            					else {
HXLINE( 100)						this->colorMultipliers->push(1);
HXLINE( 101)						this->colorMultipliers->push(1);
HXLINE( 102)						this->colorMultipliers->push(1);
HXLINE( 103)						this->colorMultipliers->push(1);
HXLINE( 105)						this->colorOffsets->push(0);
HXLINE( 106)						this->colorOffsets->push(0);
HXLINE( 107)						this->colorOffsets->push(0);
HXLINE( 108)						this->colorOffsets->push(0);
            					}
            				}
            			}
            		}
...
void FlxDrawQuadsItem_obj::render( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_6d98322fc3998392_126_render)
HXLINE( 127)		if ((this->rects->_hx___array->length == 0)) {
HXLINE( 128)			return;
            		}
HXLINE( 130)		 ::flixel::graphics::tile::FlxGraphicsShader shader;
HXDLIN( 130)		if (::hx::IsNotNull( this->shader )) {
HXLINE( 130)			shader = this->shader;
            		}
            		else {
HXLINE( 130)			shader = this->graphics->shader;
            		}
HXLINE( 132)		bool _hx_tmp;
HXDLIN( 132)		bool _hx_tmp1;
HXDLIN( 132)		bool _hx_tmp2;
HXDLIN( 132)		if (::hx::IsNotNull( shader )) {
HXLINE( 132)			_hx_tmp2 = ::hx::IsNull( this->graphics );
            		}
            		else {
HXLINE( 132)			_hx_tmp2 = true;
            		}
HXDLIN( 132)		if (!(_hx_tmp2)) {
HXLINE( 132)			_hx_tmp1 = ::hx::IsNull( shader->bitmap );
            		}
            		else {
HXLINE( 132)			_hx_tmp1 = true;
            		}
HXDLIN( 132)		if (!(_hx_tmp1)) {
HXLINE( 132)			_hx_tmp = ::hx::IsNull( this->graphics->bitmap );
            		}
            		else {
...
HXLINE( 134)		shader->bitmap->input = this->graphics->bitmap;
HXLINE( 135)		 ::Dynamic _hx_tmp3;
HXDLIN( 135)		bool _hx_tmp4;
HXDLIN( 135)		if (::flixel::FlxG_obj::enableAntialiasing) {
HXLINE( 135)			if (!(camera->antialiasing)) {
HXLINE( 135)				_hx_tmp4 = this->antialiasing;
            			}
            			else {
...
HXLINE( 135)			_hx_tmp3 = 4;
            		}
            		else {
HXLINE( 135)			_hx_tmp3 = 5;
            		}
HXDLIN( 135)		shader->bitmap->filter = _hx_tmp3;
HXLINE( 136)		shader->alpha->value = this->alphas;
HXLINE( 138)		bool _hx_tmp5;
HXDLIN( 138)		if (!(this->colored)) {
HXLINE( 138)			_hx_tmp5 = this->hasColorOffsets;
            		}
            		else {
HXLINE( 138)			_hx_tmp5 = true;
            		}
HXDLIN( 138)		if (_hx_tmp5) {
HXLINE( 140)			shader->colorMultiplier->value = this->colorMultipliers;
HXLINE( 141)			shader->colorOffset->value = this->colorOffsets;
            		}
HXLINE( 149)		{
HXLINE( 149)			 ::openfl::display::ShaderParameter_Bool parameter = shader->hasTransform;
HXDLIN( 149)			if (::hx::IsNull( parameter->value )) {
HXLINE( 149)				parameter->value = ::Array_obj< bool >::__new(0);
            			}
HXDLIN( 149)			parameter->value[0] = true;
            		}
HXLINE( 150)		{
HXLINE( 150)			 ::openfl::display::ShaderParameter_Bool parameter1 = shader->hasColorTransform;
HXDLIN( 150)			bool value;
HXDLIN( 150)			if (!(this->colored)) {
HXLINE( 150)				value = this->hasColorOffsets;
            			}
            			else {
HXLINE( 150)				value = true;
            			}
HXDLIN( 150)			if (::hx::IsNull( parameter1->value )) {
HXLINE( 150)				parameter1->value = ::Array_obj< bool >::__new(0);
            			}
HXDLIN( 150)			parameter1->value[0] = value;
            		}
HXLINE( 153)		camera->canvas->get_graphics()->overrideBlendMode(this->blend);
HXLINE( 155)		camera->canvas->get_graphics()->beginShaderFill(shader,null());
HXLINE( 156)		camera->canvas->get_graphics()->drawQuads(this->rects,null(),this->transforms);
HXLINE( 188)		this->super::render(camera);
            	}


void FlxDrawQuadsItem_obj::setParameterValue( ::openfl::display::ShaderParameter_Bool parameter,bool value){
            	HX_STACKFRAME(&_hx_pos_6d98322fc3998392_192_setParameterValue)
HXLINE( 193)		if (::hx::IsNull( parameter->value )) {
HXLINE( 194)			parameter->value = ::Array_obj< bool >::__new(0);
            		}
HXLINE( 195)		parameter->value[0] = value;
            	}
