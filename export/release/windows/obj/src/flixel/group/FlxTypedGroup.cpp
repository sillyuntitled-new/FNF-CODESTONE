...
HXLINE( 124)		this->flixelType = ( (unsigned char)(2) );
            	}
...
HXLINE( 221)			::flixel::FlxG_obj::log->advanced(HX_("Cannot add a `null` object to a FlxGroup.",f2,f4,c0,70),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
...
HXLINE( 276)			::flixel::FlxG_obj::log->advanced(HX_("Cannot insert a `null` object into a FlxGroup.",a5,36,f4,8f),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
...
HXLINE( 646)		return ::flixel::FlxG_obj::random->getObject(this->members,null(),StartIndex,Length);
            	}
...
HXLINE( 892)		{
HXLINE( 892)			::cpp::VirtualArray array = this->members;
HXDLIN( 892)			int newLength = this->maxSize;
HXDLIN( 892)			bool _hx_tmp2;
HXDLIN( 892)			if ((newLength > 0)) {
HXLINE( 892)				_hx_tmp2 = (newLength < array->get_length());
            			}
            			else {
HXLINE( 892)				_hx_tmp2 = false;
            			}
HXDLIN( 892)			if (_hx_tmp2) {
HXLINE( 892)				array->resize(newLength);
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTypedGroup_obj,set_maxSize,return )
 ...
 ::flixel::util::FlxSignal1 FlxTypedGroup_obj::get_memberAdded(){
            	HX_GC_STACKFRAME(&_hx_pos_bfa1de30d9ec9fbd_900_get_memberAdded)
HXLINE( 901)		if (::hx::IsNull( this->_memberAdded )) {
HXLINE( 902)			this->_memberAdded =  ::flixel::util::FlxSignal1_obj::__alloc( HX_CTX );
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTypedGroup_obj,get_memberAdded,return )
 ...
 ::flixel::util::FlxSignal1 FlxTypedGroup_obj::get_memberRemoved(){
            	HX_GC_STACKFRAME(&_hx_pos_bfa1de30d9ec9fbd_909_get_memberRemoved)
HXLINE( 910)		if (::hx::IsNull( this->_memberRemoved )) {
HXLINE( 911)			this->_memberRemoved =  ::flixel::util::FlxSignal1_obj::__alloc( HX_CTX );
            		}
...
HXLINE(  59)			if ((ObjectOrGroup->flixelType == ( (unsigned char)(2) ))) {
HXLINE(  61)				group = ( ( ::flixel::group::FlxTypedGroup)(ObjectOrGroup) );
            			}
            			else {
HXLINE(  63)				if ((ObjectOrGroup->flixelType == ( (unsigned char)(4) ))) {
HXLINE(  66)					group = ( ( ::flixel::group::FlxTypedSpriteGroup)(ObjectOrGroup) )->group;
            				}
            			}
            		}
...
::hx::Val FlxTypedGroup_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"_memberAdded") ) { _memberAdded=inValue.Cast<  ::flixel::util::FlxSignal1 >(); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"_memberRemoved") ) { _memberRemoved=inValue.Cast<  ::flixel::util::FlxSignal1 >(); return inValue; }
	}
...
static ::hx::StorageInfo FlxTypedGroup_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::util::FlxSignal1 */ ,(int)offsetof(FlxTypedGroup_obj,_memberAdded),HX_("_memberAdded",07,4a,50,84)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal1 */ ,(int)offsetof(FlxTypedGroup_obj,_memberRemoved),HX_("_memberRemoved",a7,b4,09,cf)},
