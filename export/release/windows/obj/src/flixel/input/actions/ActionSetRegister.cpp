...
HX_DEFINE_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_534_new,"flixel.input.actions.ActionSetRegister","new",0x70e504ba,"flixel.input.actions.ActionSetRegister.new","flixel/input/actions/FlxActionManager.hx",534,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_574_destroy,"flixel.input.actions.ActionSetRegister","destroy",0x59d19654,"flixel.input.actions.ActionSetRegister.destroy","flixel/input/actions/FlxActionManager.hx",574,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_581_activate,"flixel.input.actions.ActionSetRegister","activate",0x525ce119,"flixel.input.actions.ActionSetRegister.activate","flixel/input/actions/FlxActionManager.hx",581,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_585_markActiveSets,"flixel.input.actions.ActionSetRegister","markActiveSets",0x08bde7ca,"flixel.input.actions.ActionSetRegister.markActiveSets","flixel/input/actions/FlxActionManager.hx",585,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_603_update,"flixel.input.actions.ActionSetRegister","update",0xa1aa05ef,"flixel.input.actions.ActionSetRegister.update","flixel/input/actions/FlxActionManager.hx",603,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_610_updateSteam,"flixel.input.actions.ActionSetRegister","updateSteam",0x856af621,"flixel.input.actions.ActionSetRegister.updateSteam","flixel/input/actions/FlxActionManager.hx",610,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_636_setActivate,"flixel.input.actions.ActionSetRegister","setActivate",0x31d103cf,"flixel.input.actions.ActionSetRegister.setActivate","flixel/input/actions/FlxActionManager.hx",636,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_751_updateSteamOrigins,"flixel.input.actions.ActionSetRegister","updateSteamOrigins",0x584737ac,"flixel.input.actions.ActionSetRegister.updateSteamOrigins","flixel/input/actions/FlxActionManager.hx",751,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_756_updateDigitalActionOrigins,"flixel.input.actions.ActionSetRegister","updateDigitalActionOrigins",0xb623234e,"flixel.input.actions.ActionSetRegister.updateDigitalActionOrigins","flixel/input/actions/FlxActionManager.hx",756,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_780_updateAnalogActionOrigins,"flixel.input.actions.ActionSetRegister","updateAnalogActionOrigins",0x366b9db8,"flixel.input.actions.ActionSetRegister.updateAnalogActionOrigins","flixel/input/actions/FlxActionManager.hx",780,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_802_cheapChecksum,"flixel.input.actions.ActionSetRegister","cheapChecksum",0xdf4b20cc,"flixel.input.actions.ActionSetRegister.cheapChecksum","flixel/input/actions/FlxActionManager.hx",802,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_824_updateSteamInputs,"flixel.input.actions.ActionSetRegister","updateSteamInputs",0x3dcdfe2a,"flixel.input.actions.ActionSetRegister.updateSteamInputs","flixel/input/actions/FlxActionManager.hx",824,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_854_changeSteamControllerActionSet,"flixel.input.actions.ActionSetRegister","changeSteamControllerActionSet",0xd8bb6416,"flixel.input.actions.ActionSetRegister.changeSteamControllerActionSet","flixel/input/actions/FlxActionManager.hx",854,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_886_syncDevice,"flixel.input.actions.ActionSetRegister","syncDevice",0xf28e2c37,"flixel.input.actions.ActionSetRegister.syncDevice","flixel/input/actions/FlxActionManager.hx",886,0x69ee576f)
HX_LOCAL_STACK_FRAME(_hx_pos_0a1b33dbb56b8720_937_clearSetFromArray,"flixel.input.actions.ActionSetRegister","clearSetFromArray",0x76fad2d4,"flixel.input.actions.ActionSetRegister.clearSetFromArray","flixel/input/actions/FlxActionManager.hx",937,0x69ee576f)
namespace flixel{
namespace input{
namespace actions{

void ActionSetRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_534_new)
...
static ::flixel::util::IFlxDestroyable_obj _hx_flixel_input_actions_ActionSetRegister__hx_flixel_util_IFlxDestroyable= {
	( void (::hx::Object::*)())&::flixel::input::actions::ActionSetRegister_obj::destroy,
};

void *ActionSetRegister_obj::_hx_getInterface(int inHash) {
	switch(inHash) {
		case (int)0xd4fe2fcd: return &_hx_flixel_input_actions_ActionSetRegister__hx_flixel_util_IFlxDestroyable;
	}
...
void ActionSetRegister_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_574_destroy)
...
void ActionSetRegister_obj::activate(int ActionSet, ::flixel::input::actions::FlxInputDevice Device,::hx::Null< int >  __o_DeviceID){
            	...
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_581_activate)
...
void ActionSetRegister_obj::markActiveSets(::Array< ::Dynamic> sets){
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_585_markActiveSets)
HXLINE( 586)		{
HXLINE( 586)			int _g = 0;
HXDLIN( 586)			int _g1 = sets->length;
HXDLIN( 586)			while((_g < _g1)){
HXLINE( 586)				_g = (_g + 1);
HXLINE( 588)				sets->__get((_g - 1)).StaticCast<  ::flixel::input::actions::FlxActionSet >()->active = false;
            			}
            		}
...
void ActionSetRegister_obj::update(::Array< ::Dynamic> sets){
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_603_update)
HXDLIN( 603)		int _g = 0;
HXDLIN( 603)		int _g1 = sets->length;
HXDLIN( 603)		while((_g < _g1)){
HXDLIN( 603)			_g = (_g + 1);
HXLINE( 605)			sets->__get((_g - 1)).StaticCast<  ::flixel::input::actions::FlxActionSet >()->update();
            		}
            	}
...
void ActionSetRegister_obj::updateSteam(::Array< ::Dynamic> sets){
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_610_updateSteam)
            	}
...
void ActionSetRegister_obj::setActivate(int ActionSet, ::flixel::input::actions::FlxInputDevice Device,::hx::Null< int >  __o_DeviceID,::hx::Null< bool >  __o_DoActivate){
            	...
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_636_setActivate)
...
HXLINE( 675)						this->clearSetFromArray(ActionSet,this->steamControllerSets);
            					...
            					break;
            					case (int)-2: {
HXLINE( 678)						int _hx_tmp7;
HXDLIN( 678)						if (DoActivate) {
HXLINE( 678)							_hx_tmp7 = ActionSet;
            						}
            						else {
HXLINE( 678)							_hx_tmp7 = -1;
            						}
HXDLIN( 678)						this->steamControllerSets[::flixel::input::actions::FlxSteamController_obj::getFirstActiveHandle()] = _hx_tmp7;
            					}
            					break;
            					case (int)-1: {
HXLINE( 665)						int _hx_tmp8;
HXDLIN( 665)						if (DoActivate) {
HXLINE( 665)							_hx_tmp8 = ActionSet;
            						}
            						else {
HXLINE( 665)							_hx_tmp8 = -1;
            						}
HXDLIN( 665)						this->steamControllerAllSet = _hx_tmp8;
HXLINE( 666)						this->clearSetFromArray(-1,this->steamControllerSets);
            					}
            					break;
            					default:{
HXLINE( 681)						int _hx_tmp9;
HXDLIN( 681)						if (DoActivate) {
HXLINE( 681)							_hx_tmp9 = ActionSet;
            						}
            						else {
HXLINE( 681)							_hx_tmp9 = -1;
            						}
HXDLIN( 681)						this->steamControllerSets[DeviceID] = _hx_tmp9;
            					}
            				}
            			}
            			break;
...
::Array< ::Dynamic> ActionSetRegister_obj::updateSteamOrigins(::Array< ::Dynamic> sets){
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_751_updateSteamOrigins)
...
void ActionSetRegister_obj::updateDigitalActionOrigins( ::flixel::input::actions::FlxActionDigital action,int deviceID,int setHandle){
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_756_updateDigitalActionOrigins)
            	}
...
void ActionSetRegister_obj::updateAnalogActionOrigins( ::flixel::input::actions::FlxActionAnalog action,int deviceID,int setHandle){
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_780_updateAnalogActionOrigins)
            	}
...
int ActionSetRegister_obj::cheapChecksum(::Array< int > arr){
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_802_cheapChecksum)
...
void ActionSetRegister_obj::updateSteamInputs(::Array< ::Dynamic> sets){
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_824_updateSteamInputs)
            	}
...
void ActionSetRegister_obj::changeSteamControllerActionSet(int controllerHandle,int newSet,::Array< ::Dynamic> sets){
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_854_changeSteamControllerActionSet)
...
void ActionSetRegister_obj::syncDevice( ::flixel::input::actions::FlxInputDevice device,::Array< ::Dynamic> sets){
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_886_syncDevice)
...
HXLINE( 903)						_g = (_g + 1);
HXLINE( 905)						int gset = this->gamepadSets->__get((_g - 1));
...
HXLINE( 923)						int sset = this->steamControllerSets->__get((_g2 - 1));
...
void ActionSetRegister_obj::clearSetFromArray(::hx::Null< int >  __o_ActionSet,::Array< int > array){
            	...
            	HX_STACKFRAME(&_hx_pos_0a1b33dbb56b8720_937_clearSetFromArray)
HXDLIN( 937)		int _g = 0;
...
::hx::ObjectPtr< ActionSetRegister_obj > ActionSetRegister_obj::__alloc(::hx::Ctx *_hx_ctx) {
	ActionSetRegister_obj *__this = (ActionSetRegister_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(ActionSetRegister_obj), true, "flixel.input.actions.ActionSetRegister"));
...
void ActionSetRegister_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.input.actions.ActionSetRegister",c8,df,29,06);
