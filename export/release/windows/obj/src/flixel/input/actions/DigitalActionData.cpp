...
HX_DEFINE_STACK_FRAME(_hx_pos_7ebd3e01d2ba79f8_298_new,"flixel.input.actions.DigitalActionData","new",0xa5756c23,"flixel.input.actions.DigitalActionData.new","flixel/input/actions/FlxSteamController.hx",298,0xf3119a9a)
namespace flixel{
namespace input{
namespace actions{
...
bool DigitalActionData_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x28977bc5;
}
...
void DigitalActionData_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.input.actions.DigitalActionData",b1,1e,66,6c);
