...
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_348_get__checked,"flixel.input.actions.FlxAction","get__checked",0xeb7498be,"flixel.input.actions.FlxAction.get__checked","flixel/input/actions/FlxAction.hx",348,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_351_set__checked,"flixel.input.actions.FlxAction","set__checked",0x006dbc32,"flixel.input.actions.FlxAction.set__checked","flixel/input/actions/FlxAction.hx",351,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_390_getFirstSteamOrigin,"flixel.input.actions.FlxAction","getFirstSteamOrigin",0x6f5d528f,"flixel.input.actions.FlxAction.getFirstSteamOrigin","flixel/input/actions/FlxAction.hx",390,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_408_getSteamOrigins,"flixel.input.actions.FlxAction","getSteamOrigins",0x8a9d7ee6,"flixel.input.actions.FlxAction.getSteamOrigins","flixel/input/actions/FlxAction.hx",408,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_412_removeAll,"flixel.input.actions.FlxAction","removeAll",0x834d6510,"flixel.input.actions.FlxAction.removeAll","flixel/input/actions/FlxAction.hx",412,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_424_remove,"flixel.input.actions.FlxAction","remove",0x3279bc91,"flixel.input.actions.FlxAction.remove","flixel/input/actions/FlxAction.hx",424,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_436_toString,"flixel.input.actions.FlxAction","toString",0x9d225e39,"flixel.input.actions.FlxAction.toString","flixel/input/actions/FlxAction.hx",436,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_443_check,"flixel.input.actions.FlxAction","check",0x4ba8c11b,"flixel.input.actions.FlxAction.check","flixel/input/actions/FlxAction.hx",443,0xb046b220)
...
HXLINE( 356)		this->steamOriginsChanged = false;
...
HXLINE( 365)		this->type = InputType;
HXLINE( 366)		this->name = Name;
HXLINE( 367)		this->inputs = ::Array_obj< ::Dynamic>::__new(0);
            	}
...
bool FlxAction_obj::get__checked(){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_348_get__checked)
HXDLIN( 348)		return this->triggered;
            	}


HX_DEFINE_DYNAMIC_FUNC0(FlxAction_obj,get__checked,return )

bool FlxAction_obj::set__checked(bool value){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_351_set__checked)
HXDLIN( 351)		return (this->triggered = value);
            	}


HX_DEFINE_DYNAMIC_FUNC1(FlxAction_obj,set__checked,return )

int FlxAction_obj::getFirstSteamOrigin(){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_390_getFirstSteamOrigin)
HXDLIN( 390)		return 0;
            	}
...
::Array< int > FlxAction_obj::getSteamOrigins(::Array< int > origins){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_408_getSteamOrigins)
HXDLIN( 408)		return origins;
            	}
...
void FlxAction_obj::removeAll(::hx::Null< bool >  __o_Destroy){
            	...
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_412_removeAll)
HXLINE( 413)		int len = this->inputs->length;
HXLINE( 414)		{
HXLINE( 414)			int _g = 0;
HXDLIN( 414)			while((_g < len)){
HXLINE( 414)				_g = (_g + 1);
HXLINE( 416)				int j = ((len - (_g - 1)) - 1);
HXLINE( 418)				this->remove(this->inputs->__get(j).StaticCast<  ::flixel::input::actions::FlxActionInput >(),Destroy);
HXLINE( 419)				this->inputs->removeRange(j,1);
            			}
            		}
            	}
...
void FlxAction_obj::remove( ::flixel::input::actions::FlxActionInput Input,::hx::Null< bool >  __o_Destroy){
            	...
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_424_remove)
HXLINE( 425)		if (::hx::IsNull( Input )) {
HXLINE( 426)			return;
            		}
HXLINE( 427)		this->inputs->remove(Input);
HXLINE( 428)		if (Destroy) {
HXLINE( 430)			Input->destroy();
            		}
            	}
...
::String FlxAction_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_436_toString)
HXDLIN( 436)		::String _hx_tmp = ((HX_("FlxAction(",80,bd,59,96) + ::Std_obj::string(this->type)) + HX_(") name:",58,20,e0,0a));
HXDLIN( 436)		return (_hx_tmp + this->name);
            	}
...
bool FlxAction_obj::check(){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_443_check)
HXLINE( 444)		if ((this->_timestamp == ::flixel::FlxG_obj::game->ticks)) {
HXLINE( 445)			return this->triggered;
            		}
HXLINE( 447)		this->_x = null();
HXLINE( 448)		this->_y = null();
HXLINE( 450)		this->_timestamp = ::flixel::FlxG_obj::game->ticks;
HXLINE( 451)		this->triggered = false;
HXLINE( 453)		int i;
HXDLIN( 453)		if (::hx::IsNotNull( this->inputs )) {
HXLINE( 453)			i = this->inputs->length;
            		}
            		else {
HXLINE( 453)			i = 0;
            		}
...
HXLINE( 456)			 ::flixel::input::actions::FlxActionInput input = this->inputs->__get(i).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXLINE( 458)			if (input->destroyed) {
HXLINE( 461)				this->inputs->removeRange(i,1);
HXLINE( 462)				continue;
            			}
HXLINE( 465)			input->update();
HXLINE( 467)			if (input->check(::hx::ObjectPtr<OBJ_>(this))) {
HXLINE( 468)				this->triggered = true;
            			}
            		}
            		_hx_goto_9:;
HXLINE( 471)		return this->triggered;
            	}
...
::hx::Val FlxAction_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"_checked") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( get__checked() ); }
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"get__checked") ) { return ::hx::Val( get__checked_dyn() ); }
		if (HX_FIELD_EQ(inName,"set__checked") ) { return ::hx::Val( set__checked_dyn() ); }
		break;
	case 15:
...
::hx::Val FlxAction_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"_checked") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set__checked(inValue.Cast< bool >()) ); }
		break;
	case 9:
...
static ::String FlxAction_obj_sMemberFields[] = {
	...
	HX_("get__checked",b1,c0,f6,01),
	HX_("set__checked",25,e4,ef,16),
