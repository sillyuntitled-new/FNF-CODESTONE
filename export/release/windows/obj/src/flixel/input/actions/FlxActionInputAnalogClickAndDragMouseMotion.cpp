...
HX_DEFINE_STACK_FRAME(_hx_pos_aa3e9b81dcfc3b35_45_new,"flixel.input.actions.FlxActionInputAnalogClickAndDragMouseMotion","new",0xa8f71c91,"flixel.input.actions.FlxActionInputAnalogClickAndDragMouseMotion.new","flixel/input/actions/FlxActionInputAnalog.hx",45,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_aa3e9b81dcfc3b35_51_updateValues,"flixel.input.actions.FlxActionInputAnalogClickAndDragMouseMotion","updateValues",0xe44ed07a,"flixel.input.actions.FlxActionInputAnalogClickAndDragMouseMotion.updateValues","flixel/input/actions/FlxActionInputAnalog.hx",51,0x00ad3122)
namespace flixel{
namespace input{
namespace actions{
...
void FlxActionInputAnalogClickAndDragMouseMotion_obj::__construct(int ButtonID,int Trigger,::hx::Null< int >  __o_Axis,::hx::Null< int >  __o_PixelsPerUnit,::hx::Null< Float >  __o_DeadZone,::hx::Null< bool >  __o_InvertY,::hx::Null< bool >  __o_InvertX){
            	...
            	HX_STACKFRAME(&_hx_pos_aa3e9b81dcfc3b35_45_new)
HXLINE(  46)		super::__construct(Trigger,Axis,PixelsPerUnit,DeadZone,InvertY,InvertX);
HXLINE(  47)		this->button = ButtonID;
            	}
...
void FlxActionInputAnalogClickAndDragMouseMotion_obj::updateValues(Float X,Float Y){
            	HX_STACKFRAME(&_hx_pos_aa3e9b81dcfc3b35_51_updateValues)
HXLINE(  52)		bool pass = false;
HXLINE(  54)		switch((int)(this->button)){
            			case (int)-3: {
HXLINE(  57)				 ::flixel::input::mouse::FlxMouseButton _this = ::flixel::FlxG_obj::mouse->_rightButton;
...
HXLINE(  57)					pass = true;
            			...
            			break;
            			case (int)-2: {
HXLINE(  58)				 ::flixel::input::mouse::FlxMouseButton _this1 = ::flixel::FlxG_obj::mouse->_middleButton;
HXDLIN(  58)				if ((_this1->current != 1)) {
HXLINE(  58)					pass = (_this1->current == 2);
            				}
            				else {
HXLINE(  58)					pass = true;
            				}
            			...
            			break;
            			case (int)-1: {
HXLINE(  56)				 ::flixel::input::mouse::FlxMouseButton _this2 = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN(  56)				if ((_this2->current != 1)) {
HXLINE(  56)					pass = (_this2->current == 2);
            				}
            				else {
HXLINE(  56)					pass = true;
            				}
...
HXLINE(  66)		this->super::updateValues(X,Y);
            	}
