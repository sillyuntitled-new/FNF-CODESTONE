...
HX_DEFINE_STACK_FRAME(_hx_pos_2807c6723785a0be_73_new,"flixel.input.actions.FlxActionInputAnalogMouseMotion","new",0x363469d4,"flixel.input.actions.FlxActionInputAnalogMouseMotion.new","flixel/input/actions/FlxActionInputAnalog.hx",73,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_2807c6723785a0be_106_update,"flixel.input.actions.FlxActionInputAnalogMouseMotion","update",0xab774d15,"flixel.input.actions.FlxActionInputAnalogMouseMotion.update","flixel/input/actions/FlxActionInputAnalog.hx",106,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_2807c6723785a0be_111_updateXYPosition,"flixel.input.actions.FlxActionInputAnalogMouseMotion","updateXYPosition",0xd2eb6c1f,"flixel.input.actions.FlxActionInputAnalogMouseMotion.updateXYPosition","flixel/input/actions/FlxActionInputAnalog.hx",111,0x00ad3122)
namespace flixel{
namespace input{
namespace actions{
...
void FlxActionInputAnalogMouseMotion_obj::__construct(int Trigger,::hx::Null< int >  __o_Axis,::hx::Null< int >  __o_PixelsPerUnit,::hx::Null< Float >  __o_DeadZone,::hx::Null< bool >  __o_InvertY,::hx::Null< bool >  __o_InvertX){
            	...
            	HX_STACKFRAME(&_hx_pos_2807c6723785a0be_73_new)
HXLINE(  76)		this->lastY = ((Float)0);
HXLINE(  75)		this->lastX = ((Float)0);
HXLINE(  94)		this->pixelsPerUnit = PixelsPerUnit;
HXLINE(  95)		if ((this->pixelsPerUnit < 1)) {
HXLINE(  96)			this->pixelsPerUnit = 1;
            		}
HXLINE(  97)		this->deadZone = DeadZone;
HXLINE(  98)		this->invertX = InvertX;
HXLINE(  99)		this->invertY = InvertY;
HXLINE( 100)		super::__construct(::flixel::input::actions::FlxInputDevice_obj::MOUSE_dyn(),-1,Trigger,Axis,null());
            	}
...
void FlxActionInputAnalogMouseMotion_obj::update(){
            	HX_STACKFRAME(&_hx_pos_2807c6723785a0be_106_update)
HXDLIN( 106)		this->updateXYPosition(( (Float)(::flixel::FlxG_obj::mouse->x) ),( (Float)(::flixel::FlxG_obj::mouse->y) ));
            	}


void FlxActionInputAnalogMouseMotion_obj::updateXYPosition(Float X,Float Y){
            	HX_STACKFRAME(&_hx_pos_2807c6723785a0be_111_updateXYPosition)
HXLINE( 112)		Float xDiff = (X - this->lastX);
HXLINE( 113)		Float yDiff = (Y - this->lastY);
HXLINE( 115)		this->lastX = X;
HXLINE( 116)		this->lastY = Y;
HXLINE( 118)		if (this->invertX) {
HXLINE( 119)			xDiff = (xDiff * ( (Float)(-1) ));
            		}
HXLINE( 120)		if (this->invertY) {
HXLINE( 121)			yDiff = (yDiff * ( (Float)(-1) ));
            		}
HXLINE( 123)		xDiff = (xDiff / ( (Float)(this->pixelsPerUnit) ));
HXLINE( 124)		yDiff = (yDiff / ( (Float)(this->pixelsPerUnit) ));
HXLINE( 126)		if ((::Math_obj::abs(xDiff) < this->deadZone)) {
HXLINE( 127)			xDiff = ( (Float)(0) );
            		}
HXLINE( 128)		if ((::Math_obj::abs(yDiff) < this->deadZone)) {
HXLINE( 129)			yDiff = ( (Float)(0) );
            		}
HXLINE( 131)		this->updateValues(xDiff,yDiff);
            	}
