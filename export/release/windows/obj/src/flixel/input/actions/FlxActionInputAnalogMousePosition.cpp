...
HX_DEFINE_STACK_FRAME(_hx_pos_b426fd3e34bb94f5_147_new,"flixel.input.actions.FlxActionInputAnalogMousePosition","new",0xa7577cc7,"flixel.input.actions.FlxActionInputAnalogMousePosition.new","flixel/input/actions/FlxActionInputAnalog.hx",147,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_b426fd3e34bb94f5_153_update,"flixel.input.actions.FlxActionInputAnalogMousePosition","update",0xd8aa5402,"flixel.input.actions.FlxActionInputAnalogMousePosition.update","flixel/input/actions/FlxActionInputAnalog.hx",153,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_b426fd3e34bb94f5_158_updateValues,"flixel.input.actions.FlxActionInputAnalogMousePosition","updateValues",0x9697b984,"flixel.input.actions.FlxActionInputAnalogMousePosition.updateValues","flixel/input/actions/FlxActionInputAnalog.hx",158,0x00ad3122)
namespace flixel{
namespace input{
namespace actions{
...
void FlxActionInputAnalogMousePosition_obj::__construct(int Trigger,::hx::Null< int >  __o_Axis){
            	...
            	HX_STACKFRAME(&_hx_pos_b426fd3e34bb94f5_147_new)
HXDLIN( 147)		super::__construct(::flixel::input::actions::FlxInputDevice_obj::MOUSE_dyn(),-1,Trigger,Axis,null());
            	}
...
void FlxActionInputAnalogMousePosition_obj::update(){
            	HX_STACKFRAME(&_hx_pos_b426fd3e34bb94f5_153_update)
HXDLIN( 153)		this->updateValues(( (Float)(::flixel::FlxG_obj::mouse->x) ),( (Float)(::flixel::FlxG_obj::mouse->y) ));
            	}


void FlxActionInputAnalogMousePosition_obj::updateValues(Float X,Float Y){
            	HX_STACKFRAME(&_hx_pos_b426fd3e34bb94f5_158_updateValues)
HXLINE( 159)		if ((X != this->x)) {
HXLINE( 161)			this->xMoved->press();
            		}
            		else {
HXLINE( 165)			this->xMoved->release();
            		}
HXLINE( 168)		if ((Y != this->y)) {
HXLINE( 170)			this->yMoved->press();
            		}
            		else {
HXLINE( 174)			this->yMoved->release();
            		}
HXLINE( 177)		this->x = X;
HXLINE( 178)		this->y = Y;
            	}
