...
HX_DEFINE_STACK_FRAME(_hx_pos_0eb872effe6b625f_268_new,"flixel.input.actions.FlxActionInputAnalogSteam","new",0xcbc88569,"flixel.input.actions.FlxActionInputAnalogSteam.new","flixel/input/actions/FlxActionInputAnalog.hx",268,0x00ad3122)
HX_LOCAL_STACK_FRAME(_hx_pos_0eb872effe6b625f_275_update,"flixel.input.actions.FlxActionInputAnalogSteam","update",0x05a2dca0,"flixel.input.actions.FlxActionInputAnalogSteam.update","flixel/input/actions/FlxActionInputAnalog.hx",275,0x00ad3122)
namespace flixel{
namespace input{
namespace actions{
...
void FlxActionInputAnalogSteam_obj::__construct(int ActionHandle,int Trigger,::hx::Null< int >  __o_Axis,::hx::Null< int >  __o_DeviceID){
            	...
            	HX_STACKFRAME(&_hx_pos_0eb872effe6b625f_268_new)
HXDLIN( 268)		super::__construct(::flixel::input::actions::FlxInputDevice_obj::STEAM_CONTROLLER_dyn(),ActionHandle,Trigger,Axis,DeviceID);
            	}
...
void FlxActionInputAnalogSteam_obj::update(){
            	HX_STACKFRAME(&_hx_pos_0eb872effe6b625f_275_update)
            	}
