...
HXDLIN( 292)		 ::flixel::input::actions::DigitalActionData data = ::flixel::input::actions::FlxSteamController_obj::getDigitalActionData(controllerHandle,this->inputID);
...
HXLINE( 305)		 ::flixel::input::actions::DigitalActionData data = ::flixel::input::actions::FlxSteamController_obj::getDigitalActionData(controllerHandle,this->inputID);
