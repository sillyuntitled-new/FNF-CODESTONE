...
HX_LOCAL_STACK_FRAME(_hx_pos_55e4e352cde6aeec_346_exportToJson,"flixel.input.actions.FlxActionManager","exportToJson",0x53d14799,"flixel.input.actions.FlxActionManager.exportToJson","flixel/input/actions/FlxActionManager.hx",346,0x69ee576f)
...
HXLINE(  74)		this->_hx_register =  ::flixel::input::actions::ActionSetRegister_obj::__alloc( HX_CTX );
HXLINE(  75)		this->deviceConnected =  ::flixel::util::FlxSignal3_obj::__alloc( HX_CTX );
HXLINE(  76)		this->deviceDisconnected =  ::flixel::util::FlxSignal3_obj::__alloc( HX_CTX );
HXLINE(  77)		this->inputsChanged =  ::flixel::util::FlxSignal1_obj::__alloc( HX_CTX );
...
HXDLIN( 108)				_g = (_g + 1);
HXLINE( 111)				if (!(this->addAction(Action,null()))) {
...
HXLINE( 133)			this->activateSet(this->addSet(this->defaultSet),::flixel::input::actions::FlxInputDevice_obj::ALL_dyn(),-1);
            		}
...
HXLINE( 179)		this->_hx_register = ( ( ::flixel::input::actions::ActionSetRegister)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_hx_register)) );
            	}
...
HXLINE( 351)				return ( ( ::flixel::input::actions::FlxAction)(value) )->name;
            			}
...
HXLINE( 363)			return value;
            	...
            	HX_STACKFRAME(&_hx_pos_55e4e352cde6aeec_346_exportToJson)
HXDLIN( 346)		return ::haxe::format::JsonPrinter_obj::print( ::Dynamic(::hx::Anon_obj::Create(1)
            			->setFixed(0,HX_("actionSets",67,0d,97,57),this->sets)), ::Dynamic(new _hx_Closure_0()),HX_("\t",09,00,00,00));
            	}
...
::hx::Val FlxActionManager_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"register") ) { _hx_register=inValue.Cast<  ::flixel::input::actions::ActionSetRegister >(); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"defaultSet") ) { defaultSet=inValue.Cast<  ::flixel::input::actions::FlxActionSet >(); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"inputsChanged") ) { inputsChanged=inValue.Cast<  ::flixel::util::FlxSignal1 >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"deviceConnected") ) { deviceConnected=inValue.Cast<  ::flixel::util::FlxSignal3 >(); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"deviceDisconnected") ) { deviceDisconnected=inValue.Cast<  ::flixel::util::FlxSignal3 >(); return inValue; }
...
static ::hx::StorageInfo FlxActionManager_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::input::actions::ActionSetRegister */ ,(int)offsetof(FlxActionManager_obj,_hx_register),HX_("register",63,a6,9f,d0)},
	{::hx::fsObject /*  ::flixel::input::actions::FlxActionSet */ ,(int)offsetof(FlxActionManager_obj,defaultSet),HX_("defaultSet",61,a9,04,26)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal3 */ ,(int)offsetof(FlxActionManager_obj,deviceDisconnected),HX_("deviceDisconnected",71,3d,19,e9)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal3 */ ,(int)offsetof(FlxActionManager_obj,deviceConnected),HX_("deviceConnected",53,a3,18,17)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal1 */ ,(int)offsetof(FlxActionManager_obj,inputsChanged),HX_("inputsChanged",cb,fa,b6,00)},
