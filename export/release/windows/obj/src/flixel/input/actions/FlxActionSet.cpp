...
HX_LOCAL_STACK_FRAME(_hx_pos_266239be989c53a0_173_toJson,"flixel.input.actions.FlxActionSet","toJson",0x9c42c870,"flixel.input.actions.FlxActionSet.toJson","flixel/input/actions/FlxActionSet.hx",173,0x0b1a665a)
...
HXLINE( 184)			return value;
            	...
            	HX_STACKFRAME(&_hx_pos_266239be989c53a0_173_toJson)
HXDLIN( 173)		return ::haxe::format::JsonPrinter_obj::print(::hx::ObjectPtr<OBJ_>(this), ::Dynamic(new _hx_Closure_0()),HX_("\t",09,00,00,00));
            	}
...
HXDLIN( 141)					_g = (_g + 1);
HXLINE( 145)					digitalActions->push( ::flixel::input::actions::FlxActionDigital_obj::__alloc( HX_CTX ,( (::String)(d) ),CallbackDigital));
            				}
            			}
            		}
...
HXLINE( 156)					analogActions->push( ::flixel::input::actions::FlxActionAnalog_obj::__alloc( HX_CTX ,( (::String)(a) ),CallbackAnalog));
            				}
            			}
            		}
HXLINE( 160)		if (::hx::IsNotNull( Data->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic) )) {
HXLINE( 164)			return  ::flixel::input::actions::FlxActionSet_obj::__alloc( HX_CTX ,( (::String)(Data->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) ),digitalActions,analogActions);
            		}
