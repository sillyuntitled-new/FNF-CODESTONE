...
HX_DEFINE_STACK_FRAME(_hx_pos_969c1c973b989b16_305_new,"flixel.input.actions.FlxSteamControllerMetadata","new",0x87ce56a2,"flixel.input.actions.FlxSteamControllerMetadata.new","flixel/input/actions/FlxSteamController.hx",305,0xf3119a9a)
namespace flixel{
namespace input{
namespace actions{

void FlxSteamControllerMetadata_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_969c1c973b989b16_305_new)
...
bool FlxSteamControllerMetadata_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x235e63b8;
}
...
::hx::ObjectPtr< FlxSteamControllerMetadata_obj > FlxSteamControllerMetadata_obj::__alloc(::hx::Ctx *_hx_ctx) {
	FlxSteamControllerMetadata_obj *__this = (FlxSteamControllerMetadata_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(FlxSteamControllerMetadata_obj), true, "flixel.input.actions.FlxSteamControllerMetadata"));
...
void FlxSteamControllerMetadata_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.input.actions.FlxSteamControllerMetadata",b0,1d,ba,8e);
