...
HX_LOCAL_STACK_FRAME(_hx_pos_0a9014dd1064fc14_740_getAnalogYAxisValue,"flixel.input.gamepad.FlxGamepad","getAnalogYAxisValue",0xaf7b2f41,"flixel.input.gamepad.FlxGamepad.getAnalogYAxisValue","flixel/input/gamepad/FlxGamepad.hx",740,0xdb78a809)
HX_LOCAL_STACK_FRAME(_hx_pos_0a9014dd1064fc14_747_getAnalogAxisValueCircular,"flixel.input.gamepad.FlxGamepad","getAnalogAxisValueCircular",0x954ad2e5,"flixel.input.gamepad.FlxGamepad.getAnalogAxisValueCircular","flixel/input/gamepad/FlxGamepad.hx",747,0xdb78a809)
HX_LOCAL_STACK_FRAME(_hx_pos_0a9014dd1064fc14_765_getAnalogAxisValueIndependent,"flixel.input.gamepad.FlxGamepad","getAnalogAxisValueIndependent",0x41d504b4,"flixel.input.gamepad.FlxGamepad.getAnalogAxisValueIndependent","flixel/input/gamepad/FlxGamepad.hx",765,0xdb78a809)
HX_LOCAL_STACK_FRAME(_hx_pos_0a9014dd1064fc14_773_handleAxisMove,"flixel.input.gamepad.FlxGamepad","handleAxisMove",0x0dec85b6,"flixel.input.gamepad.FlxGamepad.handleAxisMove","flixel/input/gamepad/FlxGamepad.hx",773,0xdb78a809)
HX_LOCAL_STACK_FRAME(_hx_pos_0a9014dd1064fc14_792_handleAxisMoveSub,"flixel.input.gamepad.FlxGamepad","handleAxisMoveSub",0xcf80d16a,"flixel.input.gamepad.FlxGamepad.handleAxisMoveSub","flixel/input/gamepad/FlxGamepad.hx",792,0xdb78a809)
HX_LOCAL_STACK_FRAME(_hx_pos_0a9014dd1064fc14_824_createMappingForModel,"flixel.input.gamepad.FlxGamepad","createMappingForModel",0x1a17db56,"flixel.input.gamepad.FlxGamepad.createMappingForModel","flixel/input/gamepad/FlxGamepad.hx",824,0xdb78a809)
HX_LOCAL_STACK_FRAME(_hx_pos_0a9014dd1064fc14_844_get_name,"flixel.input.gamepad.FlxGamepad","get_name",0xdbd29e70,"flixel.input.gamepad.FlxGamepad.get_name","flixel/input/gamepad/FlxGamepad.hx",844,0xdb78a809)
HX_LOCAL_STACK_FRAME(_hx_pos_0a9014dd1064fc14_852_set_model,"flixel.input.gamepad.FlxGamepad","set_model",0xd59c83f0,"flixel.input.gamepad.FlxGamepad.set_model","flixel/input/gamepad/FlxGamepad.hx",852,0xdb78a809)
HX_LOCAL_STACK_FRAME(_hx_pos_0a9014dd1064fc14_860_set_attachment,"flixel.input.gamepad.FlxGamepad","set_attachment",0xa3a9463c,"flixel.input.gamepad.FlxGamepad.set_attachment","flixel/input/gamepad/FlxGamepad.hx",860,0xdb78a809)
HX_LOCAL_STACK_FRAME(_hx_pos_0a9014dd1064fc14_868_get_deadZone,"flixel.input.gamepad.FlxGamepad","get_deadZone",0x3fdae195,"flixel.input.gamepad.FlxGamepad.get_deadZone","flixel/input/gamepad/FlxGamepad.hx",868,0xdb78a809)
HX_LOCAL_STACK_FRAME(_hx_pos_0a9014dd1064fc14_873_set_deadZone,"flixel.input.gamepad.FlxGamepad","set_deadZone",0x54d40509,"flixel.input.gamepad.FlxGamepad.set_deadZone","flixel/input/gamepad/FlxGamepad.hx",873,0xdb78a809)
HX_LOCAL_STACK_FRAME(_hx_pos_0a9014dd1064fc14_881_getInputLabel,"flixel.input.gamepad.FlxGamepad","getInputLabel",0x585a0ba4,"flixel.input.gamepad.FlxGamepad.getInputLabel","flixel/input/gamepad/FlxGamepad.hx",881,0xdb78a809)
HX_LOCAL_STACK_FRAME(_hx_pos_0a9014dd1064fc14_886_toString,"flixel.input.gamepad.FlxGamepad","toString",0x4b874148,"flixel.input.gamepad.FlxGamepad.toString","flixel/input/gamepad/FlxGamepad.hx",886,0xdb78a809)
namespace flixel{
namespace input{
namespace gamepad{
...
HXDLIN( 276)			while((_g2 < numAxis)){
HXLINE( 276)				_g2 = (_g2 + 1);
HXLINE( 278)				this->axis[(_g2 - 1)] = ( (Float)(0) );
            			}
            		}
            	}
...
HXDLIN( 651)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y);
...
HXLINE( 736)			return this->getAnalogAxisValueCircular(stick,stick->x);
            		}
            		else {
HXLINE( 736)			return this->getAnalogAxisValueIndependent(stick->x);
            		}
...
Float FlxGamepad_obj::getAnalogYAxisValue( ::flixel::input::gamepad::FlxGamepadAnalogStick stick){
            	HX_STACKFRAME(&_hx_pos_0a9014dd1064fc14_740_getAnalogYAxisValue)
HXLINE( 741)		if (::hx::IsNull( stick )) {
HXLINE( 742)			return ( (Float)(0) );
            		}
HXLINE( 743)		if (::hx::IsPointerEq( this->deadZoneMode,::flixel::input::gamepad::FlxGamepadDeadZoneMode_obj::CIRCULAR_dyn() )) {
HXLINE( 743)			return this->getAnalogAxisValueCircular(stick,stick->y);
            		}
            		else {
HXLINE( 743)			return this->getAnalogAxisValueIndependent(stick->y);
            		}
HXDLIN( 743)		return ((Float)0.);
            	}
...
Float FlxGamepad_obj::getAnalogAxisValueCircular( ::flixel::input::gamepad::FlxGamepadAnalogStick stick,int axisID){
            	HX_STACKFRAME(&_hx_pos_0a9014dd1064fc14_747_getAnalogAxisValueCircular)
HXLINE( 748)		if (::hx::IsNull( stick )) {
HXLINE( 749)			return ( (Float)(0) );
            		}
HXLINE( 750)		Float xAxis = this->getAxisValue(stick->x);
HXLINE( 751)		Float yAxis = this->getAxisValue(stick->y);
HXLINE( 753)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(xAxis,yAxis);
HXDLIN( 753)		point->_inPool = false;
HXLINE( 754)		Float length = ::Math_obj::sqrt(((point->x * point->x) + (point->y * point->y)));
HXLINE( 755)		point->put();
HXLINE( 757)		if ((length > this->get_deadZone())) {
HXLINE( 759)			return this->getAxisValue(axisID);
            		}
...
Float FlxGamepad_obj::getAnalogAxisValueIndependent(int axisID){
            	HX_STACKFRAME(&_hx_pos_0a9014dd1064fc14_765_getAnalogAxisValueIndependent)
HXLINE( 766)		Float axisValue = this->getAxisValue(axisID);
HXLINE( 767)		Float _hx_tmp = ::Math_obj::abs(axisValue);
HXDLIN( 767)		if ((_hx_tmp > this->get_deadZone())) {
HXLINE( 768)			return axisValue;
            		}
...
void FlxGamepad_obj::handleAxisMove(int axis,Float newValue,Float oldValue){
            	HX_STACKFRAME(&_hx_pos_0a9014dd1064fc14_773_handleAxisMove)
HXLINE( 774)		Float axisValue = newValue;
HXDLIN( 774)		if (this->mapping->isAxisFlipped(axis)) {
HXLINE( 774)			axisValue = (axisValue * ( (Float)(-1) ));
            		}
HXDLIN( 774)		newValue = axisValue;
HXLINE( 775)		Float axisValue1 = oldValue;
HXDLIN( 775)		if (this->mapping->isAxisFlipped(axis)) {
HXLINE( 775)			axisValue1 = (axisValue1 * ( (Float)(-1) ));
            		}
HXDLIN( 775)		oldValue = axisValue1;
HXLINE( 778)		 ::flixel::input::gamepad::FlxGamepadAnalogStick leftStick = this->mapping->leftStick;
HXDLIN( 778)		 ::flixel::input::gamepad::FlxGamepadAnalogStick rightStick = this->mapping->rightStick;
HXDLIN( 778)		 ::flixel::input::gamepad::FlxGamepadAnalogStick stick;
HXDLIN( 778)		bool stick1;
HXDLIN( 778)		bool stick2;
HXDLIN( 778)		if (::hx::IsNotNull( leftStick )) {
HXLINE( 778)			stick2 = (axis == leftStick->x);
            		}
            		else {
HXLINE( 778)			stick2 = false;
            		}
HXDLIN( 778)		if (!(stick2)) {
HXLINE( 778)			stick1 = (axis == leftStick->y);
            		}
            		else {
HXLINE( 778)			stick1 = true;
            		}
HXDLIN( 778)		if (stick1) {
HXLINE( 778)			stick = leftStick;
            		}
            		else {
HXLINE( 778)			bool stick3;
HXDLIN( 778)			bool stick4;
HXDLIN( 778)			if (::hx::IsNotNull( rightStick )) {
HXLINE( 778)				stick4 = (axis == rightStick->x);
            			}
            			else {
HXLINE( 778)				stick4 = false;
            			}
HXDLIN( 778)			if (!(stick4)) {
HXLINE( 778)				stick3 = (axis == rightStick->y);
            			}
            			else {
HXLINE( 778)				stick3 = true;
            			}
HXDLIN( 778)			if (stick3) {
HXLINE( 778)				stick = rightStick;
            			}
            			else {
HXLINE( 778)				stick = null();
            			}
            		}
HXDLIN( 778)		 ::flixel::input::gamepad::FlxGamepadAnalogStick stick5 = stick;
HXLINE( 779)		bool _hx_tmp;
HXDLIN( 779)		if (::hx::IsPointerNotEq( stick5->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::ONLY_DIGITAL_dyn() )) {
HXLINE( 779)			_hx_tmp = ::hx::IsPointerEq( stick5->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::BOTH_dyn() );
            		}
            		else {
HXLINE( 779)			_hx_tmp = true;
            		}
HXDLIN( 779)		if (_hx_tmp) {
HXLINE( 781)			this->handleAxisMoveSub(stick5,axis,newValue,oldValue,((Float)1.0));
HXLINE( 782)			this->handleAxisMoveSub(stick5,axis,newValue,oldValue,((Float)-1.0));
            		}
            	}
...
void FlxGamepad_obj::handleAxisMoveSub( ::flixel::input::gamepad::FlxGamepadAnalogStick stick,int axis,Float value,Float oldValue,::hx::Null< Float >  __o_sign){
            	...
            	HX_STACKFRAME(&_hx_pos_0a9014dd1064fc14_792_handleAxisMoveSub)
HXLINE( 793)		int digitalButton = -1;
HXLINE( 795)		if ((axis == stick->x)) {
HXLINE( 797)			if ((sign < 0)) {
HXLINE( 797)				digitalButton = stick->rawLeft;
            			}
            			else {
HXLINE( 797)				digitalButton = stick->rawRight;
            			}
            		}
            		else {
HXLINE( 799)			if ((axis == stick->y)) {
HXLINE( 801)				if ((sign < 0)) {
HXLINE( 801)					digitalButton = stick->rawUp;
            				}
            				else {
HXLINE( 801)					digitalButton = stick->rawDown;
            				}
            			}
            		}
HXLINE( 804)		Float threshold = stick->digitalThreshold;
HXLINE( 805)		Float valueSign = (value * sign);
HXLINE( 806)		Float oldValueSign = (oldValue * sign);
...
HXLINE( 812)				btn->press();
            			}
            		}
            		else {
HXLINE( 814)			bool _hx_tmp1;
HXDLIN( 814)			if ((valueSign <= threshold)) {
HXLINE( 814)				_hx_tmp1 = (oldValueSign > threshold);
            			}
            			else {
HXLINE( 814)				_hx_tmp1 = false;
            			}
HXDLIN( 814)			if (_hx_tmp1) {
HXLINE( 816)				 ::flixel::input::gamepad::FlxGamepadButton btn1 = this->getButton(digitalButton);
HXLINE( 817)				if (::hx::IsNotNull( btn1 )) {
HXLINE( 818)					btn1->release();
            				}
            			}
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC5(FlxGamepad_obj,handleAxisMoveSub,(void))
 ...
 ::flixel::input::gamepad::mappings::FlxGamepadMapping FlxGamepad_obj::createMappingForModel( ::flixel::input::gamepad::FlxGamepadModel model){
            	HX_GC_STACKFRAME(&_hx_pos_0a9014dd1064fc14_824_createMappingForModel)
HXDLIN( 824)		switch((int)(model->_hx_getIndex())){
            			case (int)0: {
HXLINE( 826)				return  ::flixel::input::gamepad::mappings::LogitechMapping_obj::__alloc( HX_CTX ,this->attachment);
            			}
            			break;
            			case (int)1: {
HXLINE( 827)				return  ::flixel::input::gamepad::mappings::OUYAMapping_obj::__alloc( HX_CTX ,this->attachment);
            			}
            			break;
            			case (int)2: {
HXLINE( 828)				return  ::flixel::input::gamepad::mappings::PS4Mapping_obj::__alloc( HX_CTX ,this->attachment);
            			}
            			break;
            			case (int)3: {
HXLINE( 829)				return  ::flixel::input::gamepad::mappings::PSVitaMapping_obj::__alloc( HX_CTX ,this->attachment);
            			}
            			break;
            			case (int)4: {
HXLINE( 830)				return  ::flixel::input::gamepad::mappings::XInputMapping_obj::__alloc( HX_CTX ,this->attachment);
            			}
            			break;
            			case (int)5: {
HXLINE( 831)				return  ::flixel::input::gamepad::mappings::MayflashWiiRemoteMapping_obj::__alloc( HX_CTX ,this->attachment);
            			}
            			break;
            			case (int)6: {
HXLINE( 832)				return  ::flixel::input::gamepad::mappings::WiiRemoteMapping_obj::__alloc( HX_CTX ,this->attachment);
            			}
            			break;
            			case (int)7: {
HXLINE( 833)				return  ::flixel::input::gamepad::mappings::MFiMapping_obj::__alloc( HX_CTX ,this->attachment);
            			}
            			break;
            			case (int)8: {
HXLINE( 834)				return  ::flixel::input::gamepad::mappings::SwitchProMapping_obj::__alloc( HX_CTX ,this->attachment);
            			}
            			break;
            			case (int)9: {
HXLINE( 835)				return  ::flixel::input::gamepad::mappings::SwitchJoyconLeftMapping_obj::__alloc( HX_CTX ,this->attachment);
            			}
            			break;
            			case (int)10: {
HXLINE( 836)				return  ::flixel::input::gamepad::mappings::SwitchJoyconRightMapping_obj::__alloc( HX_CTX ,this->attachment);
            			}
            			break;
            			default:{
HXLINE( 838)				return  ::flixel::input::gamepad::mappings::XInputMapping_obj::__alloc( HX_CTX ,this->attachment);
            			}
            		}
...
::String FlxGamepad_obj::get_name(){
            	HX_STACKFRAME(&_hx_pos_0a9014dd1064fc14_844_get_name)
HXLINE( 845)		if (::hx::IsNull( this->_device )) {
HXLINE( 846)			return null();
            		}
HXLINE( 847)		return this->_device->name;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGamepad_obj,get_name,return )
 ...
 ::flixel::input::gamepad::FlxGamepadModel FlxGamepad_obj::set_model( ::flixel::input::gamepad::FlxGamepadModel Model){
            	HX_STACKFRAME(&_hx_pos_0a9014dd1064fc14_852_set_model)
HXLINE( 853)		this->model = Model;
HXLINE( 854)		this->mapping = this->createMappingForModel(this->model);
HXLINE( 856)		return this->model;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGamepad_obj,set_model,return )
 ...
 ::flixel::input::gamepad::FlxGamepadAttachment FlxGamepad_obj::set_attachment( ::flixel::input::gamepad::FlxGamepadAttachment Attachment){
            	HX_STACKFRAME(&_hx_pos_0a9014dd1064fc14_860_set_attachment)
HXLINE( 861)		this->attachment = Attachment;
HXLINE( 862)		this->mapping->set_attachment(Attachment);
HXLINE( 863)		return this->attachment;
            	}
...
Float FlxGamepad_obj::get_deadZone(){
            	HX_STACKFRAME(&_hx_pos_0a9014dd1064fc14_868_get_deadZone)
HXDLIN( 868)		bool _hx_tmp;
HXDLIN( 868)		if (::hx::IsNotNull( this->manager )) {
HXDLIN( 868)			_hx_tmp = ::hx::IsNull( this->manager->globalDeadZone );
            		}
            		else {
HXDLIN( 868)			_hx_tmp = true;
            		}
HXDLIN( 868)		if (_hx_tmp) {
HXDLIN( 868)			return this->_deadZone;
            		}
            		else {
HXDLIN( 868)			return ( (Float)(this->manager->globalDeadZone) );
            		}
HXDLIN( 868)		return ((Float)0.);
            	}
...
Float FlxGamepad_obj::set_deadZone(Float deadZone){
            	HX_STACKFRAME(&_hx_pos_0a9014dd1064fc14_873_set_deadZone)
HXDLIN( 873)		return (this->_deadZone = deadZone);
            	}
...
::String FlxGamepad_obj::getInputLabel(int id){
            	HX_STACKFRAME(&_hx_pos_0a9014dd1064fc14_881_getInputLabel)
HXDLIN( 881)		return this->mapping->getInputLabel(id);
            	}
...
::String FlxGamepad_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_0a9014dd1064fc14_886_toString)
HXLINE( 887)		 ::Dynamic value = this->id;
HXDLIN( 887)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 887)		_this->label = HX_("id",db,5b,00,00);
HXDLIN( 887)		_this->value = value;
HXLINE( 888)		 ::Dynamic value1 = this->model;
HXDLIN( 888)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 888)		_this1->label = HX_("model",a9,23,58,0c);
HXDLIN( 888)		_this1->value = value1;
HXLINE( 889)		 ::Dynamic value2 = this->get_deadZone();
HXDLIN( 889)		 ::flixel::util::LabelValuePair _this2 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 889)		_this2->label = HX_("deadZone",f0,3e,2e,58);
HXDLIN( 889)		_this2->value = value2;
HXLINE( 886)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(3)->init(0,_this)->init(1,_this1)->init(2,_this2));
            	}
