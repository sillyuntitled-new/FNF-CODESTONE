...
HX_LOCAL_STACK_FRAME(_hx_pos_dd40c6c1396c027e_417_removeGamepad,"flixel.input.gamepad.FlxGamepadManager","removeGamepad",0xfe38fe4a,"flixel.input.gamepad.FlxGamepadManager.removeGamepad","flixel/input/gamepad/FlxGamepadManager.hx",417,0xccfee0a6)
...
HXLINE( 326)		this->deviceConnected =  ::flixel::util::FlxSignal1_obj::__alloc( HX_CTX );
HXLINE( 327)		this->deviceDisconnected =  ::flixel::util::FlxSignal1_obj::__alloc( HX_CTX );
...
HXLINE( 340)				_g = (_g + 1);
HXLINE( 341)				this->addGamepad(::openfl::ui::GameInput_obj::getDeviceAt((_g - 1)));
            			}
            		}
            	}
...
HXLINE( 404)			return ::flixel::input::gamepad::FlxGamepadModel_obj::OUYA_dyn();
            		}
            		else {
HXLINE( 405)			bool _hx_tmp;
HXDLIN( 405)			if ((name.indexOf(HX_("wireless controller",5e,0b,31,72),null()) == -1)) {
HXLINE( 405)				_hx_tmp = (name.indexOf(HX_("ps4",d1,60,55,00),null()) != -1);
            			}
            			else {
HXLINE( 405)				_hx_tmp = true;
            			}
HXDLIN( 405)			if (_hx_tmp) {
HXLINE( 405)				return ::flixel::input::gamepad::FlxGamepadModel_obj::PS4_dyn();
            			}
            			else {
HXLINE( 406)				if ((name.indexOf(HX_("logitech",3b,70,e5,19),null()) != -1)) {
HXLINE( 406)					return ::flixel::input::gamepad::FlxGamepadModel_obj::LOGITECH_dyn();
            				}
            				else {
HXLINE( 406)					bool _hx_tmp1;
HXDLIN( 406)					bool _hx_tmp2;
HXDLIN( 406)					if ((name.indexOf(HX_("xbox",93,58,9c,4f),null()) != -1)) {
HXLINE( 406)						_hx_tmp2 = (name.indexOf(HX_("360",2d,e2,26,00),null()) != -1);
            					}
            					else {
HXLINE( 406)						_hx_tmp2 = false;
            					}
HXDLIN( 406)					if (!(_hx_tmp2)) {
HXLINE( 406)						_hx_tmp1 = (name.indexOf(HX_("xinput",92,10,f1,b8),null()) != -1);
            					}
            					else {
HXLINE( 406)						_hx_tmp1 = true;
            					}
HXDLIN( 406)					if (_hx_tmp1) {
HXLINE( 407)						return ::flixel::input::gamepad::FlxGamepadModel_obj::XINPUT_dyn();
            					}
            					else {
HXLINE( 407)						if ((name.indexOf(HX_("nintendo rvlcnt01tr",cb,02,13,80),null()) != -1)) {
HXLINE( 407)							return ::flixel::input::gamepad::FlxGamepadModel_obj::WII_REMOTE_dyn();
            						}
            						else {
HXLINE( 408)							if ((name.indexOf(HX_("nintendo rvlcnt01",0d,c0,58,28),null()) != -1)) {
HXLINE( 408)								return ::flixel::input::gamepad::FlxGamepadModel_obj::WII_REMOTE_dyn();
            							}
            							else {
HXLINE( 409)								if ((name.indexOf(HX_("mayflash wiimote pc adapter",ed,5a,02,8e),null()) != -1)) {
HXLINE( 409)									return ::flixel::input::gamepad::FlxGamepadModel_obj::MAYFLASH_WII_REMOTE_dyn();
            								}
            								else {
HXLINE( 410)									bool _hx_tmp3;
HXDLIN( 410)									if ((name.indexOf(HX_("pro controller",af,e5,18,de),null()) == -1)) {
HXLINE( 410)										_hx_tmp3 = (name.indexOf(HX_("joycon l+r",e1,d0,50,00),null()) != -1);
            									}
            									else {
HXLINE( 410)										_hx_tmp3 = true;
            									}
HXDLIN( 410)									if (_hx_tmp3) {
HXLINE( 410)										return ::flixel::input::gamepad::FlxGamepadModel_obj::SWITCH_PRO_dyn();
            									}
            									else {
HXLINE( 410)										if ((name.indexOf(HX_("joycon (l)",f3,6f,1d,00),null()) != -1)) {
HXLINE( 410)											return ::flixel::input::gamepad::FlxGamepadModel_obj::SWITCH_JOYCON_LEFT_dyn();
            										}
            										else {
HXLINE( 411)											if ((name.indexOf(HX_("joycon (r)",2d,75,1d,00),null()) != -1)) {
HXLINE( 411)												return ::flixel::input::gamepad::FlxGamepadModel_obj::SWITCH_JOYCON_RIGHT_dyn();
            											}
            											else {
HXLINE( 411)												if ((name.indexOf(HX_("mfi",f0,0e,53,00),null()) != -1)) {
HXLINE( 412)													return ::flixel::input::gamepad::FlxGamepadModel_obj::MFI_dyn();
            												}
            												else {
HXLINE( 413)													return ::flixel::input::gamepad::FlxGamepadModel_obj::UNKNOWN_dyn();
            												}
            											}
            										}
            									}
...
void FlxGamepadManager_obj::removeGamepad( ::openfl::ui::GameInputDevice Device){
            	HX_STACKFRAME(&_hx_pos_dd40c6c1396c027e_417_removeGamepad)
HXLINE( 418)		if (::hx::IsNull( Device )) {
HXLINE( 419)			return;
            		}
HXLINE( 421)		{
HXLINE( 421)			int _g = 0;
HXDLIN( 421)			int _g1 = this->_gamepads->length;
HXDLIN( 421)			while((_g < _g1)){
HXLINE( 421)				_g = (_g + 1);
HXDLIN( 421)				int i = (_g - 1);
HXLINE( 423)				 ::flixel::input::gamepad::FlxGamepad gamepad = this->_gamepads->__get(i).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXLINE( 424)				bool _hx_tmp;
HXDLIN( 424)				if (::hx::IsNotNull( gamepad )) {
HXLINE( 424)					_hx_tmp = ::hx::IsInstanceEq( gamepad->_device,Device );
            				}
            				else {
HXLINE( 424)					_hx_tmp = false;
            				}
HXDLIN( 424)				if (_hx_tmp) {
HXLINE( 426)					this->removeByID(i);
            				}
            			}
            		}
            	}
...
::hx::Val FlxGamepadManager_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"deviceConnected") ) { deviceConnected=inValue.Cast<  ::flixel::util::FlxSignal1 >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_activeGamepads") ) { _activeGamepads=inValue.Cast< ::Array< ::Dynamic> >(); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"deviceDisconnected") ) { deviceDisconnected=inValue.Cast<  ::flixel::util::FlxSignal1 >(); return inValue; }
	}
...
static ::hx::StorageInfo FlxGamepadManager_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::util::FlxSignal1 */ ,(int)offsetof(FlxGamepadManager_obj,deviceConnected),HX_("deviceConnected",53,a3,18,17)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal1 */ ,(int)offsetof(FlxGamepadManager_obj,deviceDisconnected),HX_("deviceDisconnected",71,3d,19,e9)},
