...
HXLINE(  49)				return 14;
            			...
            			break;
            			default:{
HXLINE(  50)				if ((rawID == this->leftStick->rawUp)) {
HXLINE(  50)					return 34;
            				}
            				else {
HXLINE(  51)					if ((rawID == this->leftStick->rawDown)) {
HXLINE(  51)						return 36;
            					}
            					else {
HXLINE(  52)						if ((rawID == this->leftStick->rawLeft)) {
HXLINE(  52)							return 37;
            						}
            						else {
HXLINE(  53)							if ((rawID == this->leftStick->rawRight)) {
HXLINE(  53)								return 35;
            							}
            							else {
HXLINE(  54)								if ((rawID == this->rightStick->rawUp)) {
HXLINE(  54)									return 38;
            								}
            								else {
HXLINE(  55)									if ((rawID == this->rightStick->rawDown)) {
HXLINE(  55)										return 40;
            									}
            									else {
HXLINE(  56)										if ((rawID == this->rightStick->rawLeft)) {
HXLINE(  56)											return 41;
            										}
            										else {
HXLINE(  57)											if ((rawID == this->rightStick->rawRight)) {
HXLINE(  57)												return 39;
            											}
            											else {
HXLINE(  58)												return -1;
