...
HXLINE(  39)				return 30;
            			...
            			break;
            			default:{
HXLINE(  52)				if ((rawID == this->leftStick->rawUp)) {
HXLINE(  52)					return 34;
            				}
            				else {
HXLINE(  53)					if ((rawID == this->leftStick->rawDown)) {
HXLINE(  53)						return 36;
            					}
            					else {
HXLINE(  54)						if ((rawID == this->leftStick->rawLeft)) {
HXLINE(  54)							return 37;
            						}
            						else {
HXLINE(  55)							if ((rawID == this->leftStick->rawRight)) {
HXLINE(  55)								return 35;
            							}
            							else {
HXLINE(  56)								if ((rawID == this->rightStick->rawUp)) {
HXLINE(  56)									return 38;
            								}
            								else {
HXLINE(  57)									if ((rawID == this->rightStick->rawDown)) {
HXLINE(  57)										return 40;
            									}
            									else {
HXLINE(  58)										if ((rawID == this->rightStick->rawLeft)) {
HXLINE(  58)											return 41;
            										}
            										else {
HXLINE(  59)											if ((rawID == this->rightStick->rawRight)) {
HXLINE(  59)												return 39;
            											}
            											else {
HXLINE(  60)												return -1;
