...
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_246_load,"flixel.input.mouse.FlxMouse","load",0xf3e8bd02,"flixel.input.mouse.FlxMouse.load","flixel/input/mouse/FlxMouse.hx",246,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_318_unload,"flixel.input.mouse.FlxMouse","unload",0x5a7132db,"flixel.input.mouse.FlxMouse.unload","flixel/input/mouse/FlxMouse.hx",318,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_404_destroy,"flixel.input.mouse.FlxMouse","destroy",0x77a13b9e,"flixel.input.mouse.FlxMouse.destroy","flixel/input/mouse/FlxMouse.hx",404,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_443_reset,"flixel.input.mouse.FlxMouse","reset",0xe595a773,"flixel.input.mouse.FlxMouse.reset","flixel/input/mouse/FlxMouse.hx",443,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_492_update,"flixel.input.mouse.FlxMouse","update",0x7bea17e5,"flixel.input.mouse.FlxMouse.update","flixel/input/mouse/FlxMouse.hx",492,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_528_onFocus,"flixel.input.mouse.FlxMouse","onFocus",0xede20cdd,"flixel.input.mouse.FlxMouse.onFocus","flixel/input/mouse/FlxMouse.hx",528,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_542_onFocusLost,"flixel.input.mouse.FlxMouse","onFocusLost",0xc7f71561,"flixel.input.mouse.FlxMouse.onFocusLost","flixel/input/mouse/FlxMouse.hx",542,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_559_onGameStart,"flixel.input.mouse.FlxMouse","onGameStart",0x61da7695,"flixel.input.mouse.FlxMouse.onGameStart","flixel/input/mouse/FlxMouse.hx",559,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_567_onMouseWheel,"flixel.input.mouse.FlxMouse","onMouseWheel",0xdc642911,"flixel.input.mouse.FlxMouse.onMouseWheel","flixel/input/mouse/FlxMouse.hx",567,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_580_onMouseLeave,"flixel.input.mouse.FlxMouse","onMouseLeave",0x84fd296d,"flixel.input.mouse.FlxMouse.onMouseLeave","flixel/input/mouse/FlxMouse.hx",580,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_587_get_justMoved,"flixel.input.mouse.FlxMouse","get_justMoved",0xd61e87e2,"flixel.input.mouse.FlxMouse.get_justMoved","flixel/input/mouse/FlxMouse.hx",587,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_590_get_deltaX,"flixel.input.mouse.FlxMouse","get_deltaX",0x58943105,"flixel.input.mouse.FlxMouse.get_deltaX","flixel/input/mouse/FlxMouse.hx",590,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_593_get_deltaY,"flixel.input.mouse.FlxMouse","get_deltaY",0x58943106,"flixel.input.mouse.FlxMouse.get_deltaY","flixel/input/mouse/FlxMouse.hx",593,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_596_get_deltaScreenX,"flixel.input.mouse.FlxMouse","get_deltaScreenX",0x17615bb9,"flixel.input.mouse.FlxMouse.get_deltaScreenX","flixel/input/mouse/FlxMouse.hx",596,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_599_get_deltaScreenY,"flixel.input.mouse.FlxMouse","get_deltaScreenY",0x17615bba,"flixel.input.mouse.FlxMouse.get_deltaScreenY","flixel/input/mouse/FlxMouse.hx",599,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_602_get_pressed,"flixel.input.mouse.FlxMouse","get_pressed",0x4652635d,"flixel.input.mouse.FlxMouse.get_pressed","flixel/input/mouse/FlxMouse.hx",602,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_605_get_justPressed,"flixel.input.mouse.FlxMouse","get_justPressed",0x70091811,"flixel.input.mouse.FlxMouse.get_justPressed","flixel/input/mouse/FlxMouse.hx",605,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_608_get_released,"flixel.input.mouse.FlxMouse","get_released",0x489a9ba2,"flixel.input.mouse.FlxMouse.get_released","flixel/input/mouse/FlxMouse.hx",608,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_611_get_justReleased,"flixel.input.mouse.FlxMouse","get_justReleased",0x9ec2046e,"flixel.input.mouse.FlxMouse.get_justReleased","flixel/input/mouse/FlxMouse.hx",611,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_614_get_justPressedTimeInTicks,"flixel.input.mouse.FlxMouse","get_justPressedTimeInTicks",0xbe077333,"flixel.input.mouse.FlxMouse.get_justPressedTimeInTicks","flixel/input/mouse/FlxMouse.hx",614,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_618_get_pressedRight,"flixel.input.mouse.FlxMouse","get_pressedRight",0x90e8c73f,"flixel.input.mouse.FlxMouse.get_pressedRight","flixel/input/mouse/FlxMouse.hx",618,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_621_get_justPressedRight,"flixel.input.mouse.FlxMouse","get_justPressedRight",0xa8a2860b,"flixel.input.mouse.FlxMouse.get_justPressedRight","flixel/input/mouse/FlxMouse.hx",621,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_624_get_releasedRight,"flixel.input.mouse.FlxMouse","get_releasedRight",0xdc7574da,"flixel.input.mouse.FlxMouse.get_releasedRight","flixel/input/mouse/FlxMouse.hx",624,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_627_get_justReleasedRight,"flixel.input.mouse.FlxMouse","get_justReleasedRight",0x8742a88e,"flixel.input.mouse.FlxMouse.get_justReleasedRight","flixel/input/mouse/FlxMouse.hx",627,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_630_get_justPressedTimeInTicksRight,"flixel.input.mouse.FlxMouse","get_justPressedTimeInTicksRight",0xf3dc8fa9,"flixel.input.mouse.FlxMouse.get_justPressedTimeInTicksRight","flixel/input/mouse/FlxMouse.hx",630,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_633_get_pressedMiddle,"flixel.input.mouse.FlxMouse","get_pressedMiddle",0x38fe0e92,"flixel.input.mouse.FlxMouse.get_pressedMiddle","flixel/input/mouse/FlxMouse.hx",633,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_636_get_justPressedMiddle,"flixel.input.mouse.FlxMouse","get_justPressedMiddle",0xe3cb4246,"flixel.input.mouse.FlxMouse.get_justPressedMiddle","flixel/input/mouse/FlxMouse.hx",636,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_639_get_releasedMiddle,"flixel.input.mouse.FlxMouse","get_releasedMiddle",0x08894897,"flixel.input.mouse.FlxMouse.get_releasedMiddle","flixel/input/mouse/FlxMouse.hx",639,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_642_get_justReleasedMiddle,"flixel.input.mouse.FlxMouse","get_justReleasedMiddle",0xd1495263,"flixel.input.mouse.FlxMouse.get_justReleasedMiddle","flixel/input/mouse/FlxMouse.hx",642,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_645_get_justPressedTimeInTicksMiddle,"flixel.input.mouse.FlxMouse","get_justPressedTimeInTicksMiddle",0x6b59a2e8,"flixel.input.mouse.FlxMouse.get_justPressedTimeInTicksMiddle","flixel/input/mouse/FlxMouse.hx",645,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_649_showSystemCursor,"flixel.input.mouse.FlxMouse","showSystemCursor",0xf4551c9e,"flixel.input.mouse.FlxMouse.showSystemCursor","flixel/input/mouse/FlxMouse.hx",649,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_660_hideSystemCursor,"flixel.input.mouse.FlxMouse","hideSystemCursor",0xb5438fe3,"flixel.input.mouse.FlxMouse.hideSystemCursor","flixel/input/mouse/FlxMouse.hx",660,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_677_set_useSystemCursor,"flixel.input.mouse.FlxMouse","set_useSystemCursor",0x074e74d3,"flixel.input.mouse.FlxMouse.set_useSystemCursor","flixel/input/mouse/FlxMouse.hx",677,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_691_showCursor,"flixel.input.mouse.FlxMouse","showCursor",0xa585e38f,"flixel.input.mouse.FlxMouse.showCursor","flixel/input/mouse/FlxMouse.hx",691,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_710_hideCursor,"flixel.input.mouse.FlxMouse","hideCursor",0xd396e514,"flixel.input.mouse.FlxMouse.hideCursor","flixel/input/mouse/FlxMouse.hx",710,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_716_set_visible,"flixel.input.mouse.FlxMouse","set_visible",0xb9fd1039,"flixel.input.mouse.FlxMouse.set_visible","flixel/input/mouse/FlxMouse.hx",716,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_727_record,"flixel.input.mouse.FlxMouse","record",0xf2d1086d,"flixel.input.mouse.FlxMouse.record","flixel/input/mouse/FlxMouse.hx",727,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_745_playback,"flixel.input.mouse.FlxMouse","playback",0xaadcd2f7,"flixel.input.mouse.FlxMouse.playback","flixel/input/mouse/FlxMouse.hx",745,0xe4e80b89)
namespace flixel{
namespace input{
namespace mouse{
...
HXLINE( 220)		this->_prevScreenY = 0;
HXLINE( 219)		this->_prevScreenX = 0;
HXLINE( 218)		this->_prevY = 0;
...
HXLINE( 459)		this->cursorContainer = cursorContainer;
HXLINE( 460)		this->cursorContainer->mouseChildren = false;
HXLINE( 461)		this->cursorContainer->mouseEnabled = false;
HXLINE( 463)		this->_leftButton =  ::flixel::input::mouse::FlxMouseButton_obj::__alloc( HX_CTX ,-1);
HXLINE( 465)		this->_stage = ::openfl::Lib_obj::get_current()->stage;
HXLINE( 466)		this->_stage->addEventListener(HX_("mouseDown",27,b1,c2,ee),this->_leftButton->onDown_dyn(),null(),null(),null());
HXLINE( 467)		this->_stage->addEventListener(HX_("mouseUp",e0,f3,72,c0),this->_leftButton->onUp_dyn(),null(),null(),null());
HXLINE( 470)		this->_middleButton =  ::flixel::input::mouse::FlxMouseButton_obj::__alloc( HX_CTX ,-2);
HXLINE( 471)		this->_rightButton =  ::flixel::input::mouse::FlxMouseButton_obj::__alloc( HX_CTX ,-3);
HXLINE( 473)		this->_stage->addEventListener(HX_("middleMouseDown",12,2b,fe,01),this->_middleButton->onDown_dyn(),null(),null(),null());
HXLINE( 474)		this->_stage->addEventListener(HX_("middleMouseUp",0b,8d,f5,3a),this->_middleButton->onUp_dyn(),null(),null(),null());
HXLINE( 475)		this->_stage->addEventListener(HX_("rightMouseDown",ab,29,d7,cd),this->_rightButton->onDown_dyn(),null(),null(),null());
HXLINE( 476)		this->_stage->addEventListener(HX_("rightMouseUp",64,83,21,ab),this->_rightButton->onUp_dyn(),null(),null(),null());
HXLINE( 478)		this->_stage->addEventListener(HX_("mouseLeave",92,28,20,90),this->onMouseLeave_dyn(),null(),null(),null());
HXLINE( 481)		this->_stage->addEventListener(HX_("mouseWheel",36,28,87,e7),this->onMouseWheel_dyn(),null(),null(),null());
HXLINE( 483)		::flixel::FlxG_obj::signals->postGameStart->add(this->onGameStart_dyn());
HXLINE( 484)		::openfl::ui::Mouse_obj::hide();
            	}
...
void FlxMouse_obj::load( ::Dynamic Graphic,::hx::Null< Float >  __o_Scale,::hx::Null< int >  __o_XOffset,::hx::Null< int >  __o_YOffset){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_246_load)
HXLINE( 248)		if (::hx::IsNotNull( this->_cursor )) {
HXLINE( 250)			::flixel::util::FlxDestroyUtil_obj::removeChild(this->cursorContainer,this->_cursor);
            		}
HXLINE( 254)		if (::hx::IsNull( Graphic )) {
HXLINE( 256)			Graphic =  ::flixel::input::mouse::GraphicCursor_obj::__alloc( HX_CTX ,0,0,null(),null());
            		}
HXLINE( 259)		if (::Std_obj::isOfType(Graphic,::hx::ClassOf< ::hx::Class >())) {
HXLINE( 261)			this->_cursor = ( ( ::openfl::display::Bitmap)(::Type_obj::createInstance(Graphic,::cpp::VirtualArray_obj::__new(0))) );
            		}
            		else {
HXLINE( 263)			if (::Std_obj::isOfType(Graphic,::hx::ClassOf< ::openfl::display::BitmapData >())) {
HXLINE( 265)				this->_cursor =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,( ( ::openfl::display::BitmapData)(Graphic) ),null(),null());
            			}
            			else {
HXLINE( 267)				if (::Std_obj::isOfType(Graphic,::hx::ClassOf< ::String >())) {
HXLINE( 269)					::String id = ( (::String)(Graphic) );
HXDLIN( 269)					 ::openfl::display::BitmapData _hx_tmp;
HXDLIN( 269)					if (::openfl::utils::Assets_obj::exists(id,null())) {
HXLINE( 269)						_hx_tmp = ::openfl::utils::Assets_obj::getBitmapData(id,false,null());
            					}
            					else {
HXLINE( 269)						::flixel::FlxG_obj::log->advanced(((HX_("Could not find a BitmapData asset with ID '",5f,79,a9,21) + id) + HX_("'.",27,22,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
HXDLIN( 269)						_hx_tmp = null();
            					}
HXDLIN( 269)					this->_cursor =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,_hx_tmp,null(),null());
            				}
            				else {
HXLINE( 273)					this->_cursor =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::flixel::input::mouse::GraphicCursor_obj::__alloc( HX_CTX ,0,0,null(),null()),null(),null());
            				}
            			}
            		}
HXLINE( 276)		this->_cursor->set_x(( (Float)(XOffset) ));
HXLINE( 277)		this->_cursor->set_y(( (Float)(YOffset) ));
HXLINE( 278)		this->_cursor->set_scaleX(Scale);
HXLINE( 279)		this->_cursor->set_scaleY(Scale);
HXLINE( 308)		this->cursorContainer->addChild(this->_cursor);
            	}
...
void FlxMouse_obj::unload(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_318_unload)
HXDLIN( 318)		if (::hx::IsNotNull( this->_cursor )) {
HXLINE( 320)			if (this->cursorContainer->get_visible()) {
HXLINE( 322)				this->load(null(),null(),null(),null());
            			}
            			else {
HXLINE( 326)				this->_cursor = ( ( ::openfl::display::Bitmap)(::flixel::util::FlxDestroyUtil_obj::removeChild(this->cursorContainer,this->_cursor)) );
            			}
            		}
            	}
...
void FlxMouse_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_404_destroy)
HXLINE( 405)		if (::hx::IsNotNull( this->_stage )) {
HXLINE( 407)			this->_stage->removeEventListener(HX_("mouseDown",27,b1,c2,ee),this->_leftButton->onDown_dyn(),null());
HXLINE( 408)			this->_stage->removeEventListener(HX_("mouseUp",e0,f3,72,c0),this->_leftButton->onUp_dyn(),null());
HXLINE( 411)			this->_stage->removeEventListener(HX_("middleMouseDown",12,2b,fe,01),this->_middleButton->onDown_dyn(),null());
HXLINE( 412)			this->_stage->removeEventListener(HX_("middleMouseUp",0b,8d,f5,3a),this->_middleButton->onUp_dyn(),null());
HXLINE( 413)			this->_stage->removeEventListener(HX_("rightMouseDown",ab,29,d7,cd),this->_rightButton->onDown_dyn(),null());
HXLINE( 414)			this->_stage->removeEventListener(HX_("rightMouseUp",64,83,21,ab),this->_rightButton->onUp_dyn(),null());
HXLINE( 416)			this->_stage->removeEventListener(HX_("mouseLeave",92,28,20,90),this->onMouseLeave_dyn(),null());
HXLINE( 419)			this->_stage->removeEventListener(HX_("mouseWheel",36,28,87,e7),this->onMouseWheel_dyn(),null());
            		}
HXLINE( 422)		this->cursorContainer = null();
HXLINE( 423)		this->_cursor = null();
HXLINE( 429)		this->_leftButton = ( ( ::flixel::input::mouse::FlxMouseButton)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_leftButton)) );
HXLINE( 431)		this->_middleButton = ( ( ::flixel::input::mouse::FlxMouseButton)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_middleButton)) );
HXLINE( 432)		this->_rightButton = ( ( ::flixel::input::mouse::FlxMouseButton)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_rightButton)) );
HXLINE( 435)		this->_cursorBitmapData = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_cursorBitmapData);
HXLINE( 436)		::flixel::FlxG_obj::signals->postGameStart->remove(this->onGameStart_dyn());
            	}
...
void FlxMouse_obj::reset(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_443_reset)
HXLINE( 444)		this->_leftButton->reset();
HXLINE( 447)		this->_middleButton->reset();
HXLINE( 448)		this->_rightButton->reset();
            	}
...
void FlxMouse_obj::update(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_492_update)
HXLINE( 493)		this->_prevX = this->x;
HXLINE( 494)		this->_prevY = this->y;
HXLINE( 495)		this->_prevScreenX = this->screenX;
HXLINE( 496)		this->_prevScreenY = this->screenY;
HXLINE( 499)		{
HXLINE( 499)			Float newX = ::flixel::FlxG_obj::game->get_mouseX();
HXDLIN( 499)			Float newY = ::flixel::FlxG_obj::game->get_mouseY();
HXDLIN( 499)			this->_globalScreenX = ::Std_obj::_hx_int((newX / ::flixel::FlxG_obj::scaleMode->scale->x));
HXDLIN( 499)			this->_globalScreenY = ::Std_obj::_hx_int((newY / ::flixel::FlxG_obj::scaleMode->scale->y));
HXDLIN( 499)			this->updatePositions();
            		}
HXLINE( 502)		if (this->visible) {
HXLINE( 504)			 ::openfl::display::Sprite _hx_tmp = this->cursorContainer;
HXDLIN( 504)			_hx_tmp->set_x(::flixel::FlxG_obj::game->get_mouseX());
HXLINE( 505)			 ::openfl::display::Sprite _hx_tmp1 = this->cursorContainer;
HXDLIN( 505)			_hx_tmp1->set_y(::flixel::FlxG_obj::game->get_mouseY());
            		}
HXLINE( 510)		this->_leftButton->update();
HXLINE( 512)		this->_middleButton->update();
HXLINE( 513)		this->_rightButton->update();
HXLINE( 517)		if (!(this->_wheelUsed)) {
HXLINE( 519)			this->wheel = 0;
            		}
HXLINE( 521)		this->_wheelUsed = false;
            	}
...
void FlxMouse_obj::onFocus(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_528_onFocus)
HXLINE( 529)		this->reset();
HXLINE( 532)		this->set_useSystemCursor(this->useSystemCursor);
HXLINE( 534)		this->set_visible(this->_visibleWhenFocusLost);
            	}
...
void FlxMouse_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_542_onFocusLost)
HXLINE( 544)		this->_visibleWhenFocusLost = this->visible;
HXLINE( 546)		if (this->visible) {
HXLINE( 548)			this->set_visible(false);
            		}
HXLINE( 551)		::openfl::ui::Mouse_obj::show();
            	}
...
void FlxMouse_obj::onGameStart(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_559_onGameStart)
HXDLIN( 559)		this->set_visible(this->visible);
            	}
...
void FlxMouse_obj::onMouseWheel( ::openfl::events::MouseEvent flashEvent){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_567_onMouseWheel)
HXDLIN( 567)		if (this->enabled) {
HXLINE( 569)			this->_wheelUsed = true;
HXLINE( 570)			this->wheel = flashEvent->delta;
            		}
            	}
...
void FlxMouse_obj::onMouseLeave( ::openfl::events::Event _){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_580_onMouseLeave)
HXLINE( 581)		this->_rightButton->onUp(null());
HXLINE( 582)		this->_middleButton->onUp(null());
            	}
...
bool FlxMouse_obj::get_justMoved(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_587_get_justMoved)
HXDLIN( 587)		if ((this->_prevX == this->x)) {
HXDLIN( 587)			return (this->_prevY != this->y);
            		}
            		else {
...
int FlxMouse_obj::get_deltaX(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_590_get_deltaX)
HXDLIN( 590)		return (this->x - this->_prevX);
            	}
...
int FlxMouse_obj::get_deltaY(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_593_get_deltaY)
HXDLIN( 593)		return (this->y - this->_prevY);
            	}
...
int FlxMouse_obj::get_deltaScreenX(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_596_get_deltaScreenX)
HXDLIN( 596)		return (this->screenX - this->_prevScreenX);
            	}
...
int FlxMouse_obj::get_deltaScreenY(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_599_get_deltaScreenY)
HXDLIN( 599)		return (this->screenY - this->_prevScreenY);
            	}
...
bool FlxMouse_obj::get_pressed(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_602_get_pressed)
HXDLIN( 602)		 ::flixel::input::mouse::FlxMouseButton _this = this->_leftButton;
HXDLIN( 602)		if ((_this->current != 1)) {
HXDLIN( 602)			return (_this->current == 2);
            		}
            		else {
HXDLIN( 602)			return true;
            		}
HXDLIN( 602)		return false;
            	}
...
bool FlxMouse_obj::get_justPressed(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_605_get_justPressed)
HXDLIN( 605)		return (this->_leftButton->current == 2);
            	}
...
bool FlxMouse_obj::get_released(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_608_get_released)
HXDLIN( 608)		 ::flixel::input::mouse::FlxMouseButton _this = this->_leftButton;
HXDLIN( 608)		if ((_this->current != 0)) {
HXDLIN( 608)			return (_this->current == -1);
            		}
            		else {
...
bool FlxMouse_obj::get_justReleased(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_611_get_justReleased)
HXDLIN( 611)		return (this->_leftButton->current == -1);
            	}
...
int FlxMouse_obj::get_justPressedTimeInTicks(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_614_get_justPressedTimeInTicks)
HXDLIN( 614)		return this->_leftButton->justPressedTimeInTicks;
            	}
...
bool FlxMouse_obj::get_pressedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_618_get_pressedRight)
HXDLIN( 618)		 ::flixel::input::mouse::FlxMouseButton _this = this->_rightButton;
HXDLIN( 618)		if ((_this->current != 1)) {
HXDLIN( 618)			return (_this->current == 2);
            		}
            		else {
HXDLIN( 618)			return true;
            		}
...
bool FlxMouse_obj::get_justPressedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_621_get_justPressedRight)
HXDLIN( 621)		return (this->_rightButton->current == 2);
            	}
...
bool FlxMouse_obj::get_releasedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_624_get_releasedRight)
HXDLIN( 624)		 ::flixel::input::mouse::FlxMouseButton _this = this->_rightButton;
HXDLIN( 624)		if ((_this->current != 0)) {
HXDLIN( 624)			return (_this->current == -1);
            		}
            		else {
HXDLIN( 624)			return true;
            		}
...
bool FlxMouse_obj::get_justReleasedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_627_get_justReleasedRight)
HXDLIN( 627)		return (this->_rightButton->current == -1);
            	}
...
int FlxMouse_obj::get_justPressedTimeInTicksRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_630_get_justPressedTimeInTicksRight)
HXDLIN( 630)		return this->_rightButton->justPressedTimeInTicks;
            	}
...
bool FlxMouse_obj::get_pressedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_633_get_pressedMiddle)
HXDLIN( 633)		 ::flixel::input::mouse::FlxMouseButton _this = this->_middleButton;
HXDLIN( 633)		if ((_this->current != 1)) {
HXDLIN( 633)			return (_this->current == 2);
            		}
            		else {
HXDLIN( 633)			return true;
            		}
HXDLIN( 633)		return false;
            	}
...
bool FlxMouse_obj::get_justPressedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_636_get_justPressedMiddle)
HXDLIN( 636)		return (this->_middleButton->current == 2);
            	}
...
bool FlxMouse_obj::get_releasedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_639_get_releasedMiddle)
HXDLIN( 639)		 ::flixel::input::mouse::FlxMouseButton _this = this->_middleButton;
HXDLIN( 639)		if ((_this->current != 0)) {
HXDLIN( 639)			return (_this->current == -1);
            		}
            		else {
HXDLIN( 639)			return true;
            		}
...
bool FlxMouse_obj::get_justReleasedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_642_get_justReleasedMiddle)
HXDLIN( 642)		return (this->_middleButton->current == -1);
            	}
...
int FlxMouse_obj::get_justPressedTimeInTicksMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_645_get_justPressedTimeInTicksMiddle)
HXDLIN( 645)		return this->_middleButton->justPressedTimeInTicks;
            	}
...
void FlxMouse_obj::showSystemCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_649_showSystemCursor)
HXLINE( 653)		this->cursorContainer->set_visible(false);
HXLINE( 656)		::openfl::ui::Mouse_obj::show();
            	}
...
void FlxMouse_obj::hideSystemCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_660_hideSystemCursor)
HXLINE( 667)		::openfl::ui::Mouse_obj::hide();
HXLINE( 669)		if (this->visible) {
HXLINE( 671)			this->cursorContainer->set_visible(true);
            		}
            	}
...
bool FlxMouse_obj::set_useSystemCursor(bool value){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_677_set_useSystemCursor)
HXLINE( 678)		if (value) {
HXLINE( 680)			this->showSystemCursor();
            		}
            		else {
HXLINE( 684)			this->hideSystemCursor();
            		}
HXLINE( 686)		return (this->useSystemCursor = value);
            	}
...
void FlxMouse_obj::showCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_691_showCursor)
HXDLIN( 691)		if (this->useSystemCursor) {
HXLINE( 693)			::openfl::ui::Mouse_obj::show();
            		}
            		else {
HXLINE( 697)			if (::hx::IsNull( this->_cursor )) {
HXLINE( 698)				this->load(null(),null(),null(),null());
            			}
HXLINE( 703)			this->cursorContainer->set_visible(true);
HXLINE( 704)			::openfl::ui::Mouse_obj::hide();
            		}
            	}
...
void FlxMouse_obj::hideCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_710_hideCursor)
HXLINE( 711)		this->cursorContainer->set_visible(false);
HXLINE( 712)		::openfl::ui::Mouse_obj::hide();
            	}
...
bool FlxMouse_obj::set_visible(bool value){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_716_set_visible)
HXLINE( 717)		if (value) {
HXLINE( 718)			this->showCursor();
            		}
            		else {
HXLINE( 720)			this->hideCursor();
            		}
HXLINE( 722)		return (this->visible = value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxMouse_obj,set_visible,return )
 ...
 ::flixel::_hx_system::replay::MouseRecord FlxMouse_obj::record(){
            	HX_GC_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_727_record)
HXLINE( 728)		bool _hx_tmp;
HXDLIN( 728)		bool _hx_tmp1;
HXDLIN( 728)		bool _hx_tmp2;
HXDLIN( 728)		if ((this->_lastX == this->_globalScreenX)) {
HXLINE( 728)			_hx_tmp2 = (this->_lastY == this->_globalScreenY);
            		}
            		else {
HXLINE( 728)			_hx_tmp2 = false;
            		}
HXDLIN( 728)		if (_hx_tmp2) {
HXLINE( 728)			_hx_tmp1 = (this->_lastLeftButtonState == this->_leftButton->current);
            		}
            		else {
HXLINE( 728)			_hx_tmp1 = false;
            		}
HXDLIN( 728)		if (_hx_tmp1) {
HXLINE( 728)			_hx_tmp = (this->_lastWheel == this->wheel);
            		}
            		else {
...
HXLINE( 736)		this->_lastX = this->_globalScreenX;
HXLINE( 737)		this->_lastY = this->_globalScreenY;
HXLINE( 738)		this->_lastLeftButtonState = this->_leftButton->current;
HXLINE( 739)		this->_lastWheel = this->wheel;
HXLINE( 740)		return  ::flixel::_hx_system::replay::MouseRecord_obj::__alloc( HX_CTX ,this->_lastX,this->_lastY,this->_leftButton->current,this->_lastWheel);
            	}
...
void FlxMouse_obj::playback( ::flixel::_hx_system::replay::MouseRecord record){
            	HX_GC_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_745_playback)
HXLINE( 749)		bool _hx_tmp;
HXDLIN( 749)		bool _hx_tmp1;
HXDLIN( 749)		if ((this->_lastLeftButtonState != 1)) {
HXLINE( 749)			_hx_tmp1 = (this->_lastLeftButtonState == 2);
            		}
            		else {
HXLINE( 749)			_hx_tmp1 = true;
            		}
HXDLIN( 749)		if (_hx_tmp1) {
HXLINE( 750)			if ((record->button != 0)) {
HXLINE( 749)				_hx_tmp = (record->button == -1);
            			}
            			else {
...
HXLINE( 752)			this->_stage->dispatchEvent( ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("mouseUp",e0,f3,72,c0),true,false,record->x,record->y,null(),null(),null(),null(),null(),null(),null(),null()));
            		}
HXLINE( 754)		this->_lastLeftButtonState = (this->_leftButton->current = record->button);
HXLINE( 755)		this->wheel = record->wheel;
HXLINE( 756)		this->_globalScreenX = record->x;
HXLINE( 757)		this->_globalScreenY = record->y;
HXLINE( 758)		this->updatePositions();
            	}
