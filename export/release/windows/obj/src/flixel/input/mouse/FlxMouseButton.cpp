...
HX_LOCAL_STACK_FRAME(_hx_pos_1a66c6297c27823a_51_destroy,"flixel.input.mouse.FlxMouseButton","destroy",0x9f3f8d30,"flixel.input.mouse.FlxMouseButton.destroy","flixel/input/mouse/FlxMouseButton.hx",51,0x7fcdf6f7)
HX_LOCAL_STACK_FRAME(_hx_pos_1a66c6297c27823a_71_onDown,"flixel.input.mouse.FlxMouseButton","onDown",0x8ad419ab,"flixel.input.mouse.FlxMouseButton.onDown","flixel/input/mouse/FlxMouseButton.hx",71,0x7fcdf6f7)
HX_LOCAL_STACK_FRAME(_hx_pos_1a66c6297c27823a_77_onUp,"flixel.input.mouse.FlxMouseButton","onUp",0x3a027364,"flixel.input.mouse.FlxMouseButton.onUp","flixel/input/mouse/FlxMouseButton.hx",77,0x7fcdf6f7)
...
HXLINE(  25)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE(  44)				::Array< ::Dynamic> _hx_tmp = ::flixel::FlxG_obj::swipes;
HXDLIN(  44)				int _hx_tmp1 = ( (int)(this->ID) );
HXDLIN(  44)				 ::flixel::math::FlxBasePoint _hx_tmp2 = this->justPressedPosition;
HXDLIN(  44)				 ::flixel::input::mouse::FlxMouse _hx_tmp3 = ::flixel::FlxG_obj::mouse;
HXDLIN(  44)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  44)				point->_inPool = false;
HXDLIN(  44)				 ::flixel::math::FlxBasePoint point1 = point;
HXDLIN(  44)				point1->_weak = true;
HXDLIN(  44)				 ::flixel::math::FlxBasePoint _hx_tmp4 = _hx_tmp3->getScreenPosition(null(),point1);
HXDLIN(  44)				_hx_tmp->push( ::flixel::input::FlxSwipe_obj::__alloc( HX_CTX ,_hx_tmp1,_hx_tmp2,_hx_tmp4,this->justPressedTimeInTicks));
            			}
            		}
            	}
...
void FlxMouseButton_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_1a66c6297c27823a_51_destroy)
HXDLIN(  51)		this->justPressedPosition = ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->justPressedPosition)) );
            	}
...
void FlxMouseButton_obj::onDown( ::openfl::events::MouseEvent _){
            	HX_STACKFRAME(&_hx_pos_1a66c6297c27823a_71_onDown)
HXDLIN(  71)		if (::flixel::FlxG_obj::mouse->enabled) {
HXLINE(  72)			this->press();
            		}
            	}
...
void FlxMouseButton_obj::onUp( ::openfl::events::MouseEvent _){
            	HX_STACKFRAME(&_hx_pos_1a66c6297c27823a_77_onUp)
HXDLIN(  77)		if (::flixel::FlxG_obj::mouse->enabled) {
HXLINE(  78)			this->release();
            		}
            	}
