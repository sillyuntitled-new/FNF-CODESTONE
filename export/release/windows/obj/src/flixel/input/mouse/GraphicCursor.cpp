...
HX_DEFINE_STACK_FRAME(_hx_pos_6ae2dcf2317f561d_47_new,"flixel.input.mouse.GraphicCursor","new",0x044c7cf1,"flixel.input.mouse.GraphicCursor.new","openfl/utils/_internal/AssetsMacro.hx",47,0xfdd54705)
HX_LOCAL_STACK_FRAME(_hx_pos_d0784a4fa13e13b1_28_boot,"flixel.input.mouse.GraphicCursor","boot",0xb6b9d681,"flixel.input.mouse.GraphicCursor.boot","flixel/input/mouse/FlxMouse.hx",28,0xe4e80b89)
namespace flixel{
namespace input{
namespace mouse{
...
void GraphicCursor_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
            	...
            	HX_STACKFRAME(&_hx_pos_6ae2dcf2317f561d_47_new)
HXLINE(  71)		super::__construct(0,0,transparent,fillRGBA);
HXLINE(  74)		this->_hx___fromImage(::lime::graphics::Image_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::input::mouse::GraphicCursor_obj::resourceName)))));
            	}
...
bool GraphicCursor_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x073e5103) {
		...
		return inClassId==(int)0x35824b5f;
	}
}
...
::hx::ObjectPtr< GraphicCursor_obj > GraphicCursor_obj::__alloc(::hx::Ctx *_hx_ctx,int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA) {
	GraphicCursor_obj *__this = (GraphicCursor_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(GraphicCursor_obj), true, "flixel.input.mouse.GraphicCursor"));
...
void GraphicCursor_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.input.mouse.GraphicCursor",7f,30,55,bb);
...
{
{
            	HX_STACKFRAME(&_hx_pos_d0784a4fa13e13b1_28_boot)
HXDLIN(  28)		resourceName = HX_("__ASSET__:bitmap_flixel_input_mouse_GraphicCursor",32,e6,b4,52);
            	}
}
