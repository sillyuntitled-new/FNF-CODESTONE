...
HXDLIN(  90)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  90)				point->_inPool = false;
HXDLIN(  90)				 ::flixel::math::FlxBasePoint point1 = point;
HXDLIN(  90)				point1->_weak = true;
HXDLIN(  90)				 ::flixel::math::FlxBasePoint _hx_tmp3 = this->getScreenPosition(null(),point1);
