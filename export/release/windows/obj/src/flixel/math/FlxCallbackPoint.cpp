...
HX_DEFINE_STACK_FRAME(_hx_pos_0e989bab684323cb_1680_new,"flixel.math.FlxCallbackPoint","new",0x2af621df,"flixel.math.FlxCallbackPoint.new","flixel/math/FlxPoint.hx",1680,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1697_set,"flixel.math.FlxCallbackPoint","set",0x2af9ed21,"flixel.math.FlxCallbackPoint.set","flixel/math/FlxPoint.hx",1697,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1705_set_x,"flixel.math.FlxCallbackPoint","set_x",0x4f288a9a,"flixel.math.FlxCallbackPoint.set_x","flixel/math/FlxPoint.hx",1705,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1713_set_y,"flixel.math.FlxCallbackPoint","set_y",0x4f288a9b,"flixel.math.FlxCallbackPoint.set_y","flixel/math/FlxPoint.hx",1713,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1721_destroy,"flixel.math.FlxCallbackPoint","destroy",0xdd08a9f9,"flixel.math.FlxCallbackPoint.destroy","flixel/math/FlxPoint.hx",1721,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1728_put,"flixel.math.FlxCallbackPoint","put",0x2af7b44e,"flixel.math.FlxCallbackPoint.put","flixel/math/FlxPoint.hx",1728,0xb3e1cd2c)
namespace flixel{
namespace math{

void FlxCallbackPoint_obj::__construct( ::Dynamic setXCallback, ::Dynamic setYCallback, ::Dynamic setXYCallback){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1680_new)
HXLINE(1681)		super::__construct(null(),null());
HXLINE(1683)		this->_setXCallback = setXCallback;
HXLINE(1684)		this->_setYCallback = setXYCallback;
HXLINE(1685)		this->_setXYCallback = setXYCallback;
HXLINE(1687)		if (::hx::IsNotNull( this->_setXCallback )) {
HXLINE(1689)			if (::hx::IsNull( this->_setYCallback )) {
HXLINE(1690)				this->_setYCallback = setXCallback;
            			}
HXLINE(1691)			if (::hx::IsNull( this->_setXYCallback )) {
HXLINE(1692)				this->_setXYCallback = setXCallback;
            			}
            		}
            	}
...
bool FlxCallbackPoint_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::math::FlxBasePoint FlxCallbackPoint_obj::set(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1697_set)
HXLINE(1698)		this->super::set(x,y);
HXLINE(1699)		if (::hx::IsNotNull( this->_setXYCallback )) {
HXLINE(1700)			this->_setXYCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE(1701)		return ::hx::ObjectPtr<OBJ_>(this);
            	}


Float FlxCallbackPoint_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1705_set_x)
HXLINE(1706)		this->super::set_x(value);
HXLINE(1707)		if (::hx::IsNotNull( this->_setXCallback )) {
HXLINE(1708)			this->_setXCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE(1709)		return value;
            	}


Float FlxCallbackPoint_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1713_set_y)
HXLINE(1714)		this->super::set_y(value);
HXLINE(1715)		if (::hx::IsNotNull( this->_setYCallback )) {
HXLINE(1716)			this->_setYCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE(1717)		return value;
            	}


void FlxCallbackPoint_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1721_destroy)
HXLINE(1722)		this->super::destroy();
HXLINE(1723)		this->_setXCallback = null();
HXLINE(1724)		this->_setYCallback = null();
HXLINE(1725)		this->_setXYCallback = null();
            	}


void FlxCallbackPoint_obj::put(){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1728_put)
            	}
