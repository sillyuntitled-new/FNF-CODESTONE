...
HXLINE(  42)		{
HXLINE(  42)			this->a = -(this->a);
HXDLIN(  42)			this->b = -(this->b);
HXDLIN(  42)			this->c = -(this->c);
HXDLIN(  42)			this->d = -(this->d);
HXDLIN(  42)			this->tx = -(this->tx);
HXDLIN(  42)			this->ty = -(this->ty);
            		}
...
HXLINE(  52)		{
HXLINE(  52)			Float b = this->a;
HXDLIN(  52)			Float d = this->c;
HXDLIN(  52)			Float ty = this->tx;
HXDLIN(  52)			this->a = -(this->b);
HXDLIN(  52)			this->b = b;
HXDLIN(  52)			this->c = -(this->d);
HXDLIN(  52)			this->d = d;
HXDLIN(  52)			this->tx = -(this->ty);
HXDLIN(  52)			this->ty = ty;
            		}
...
HXLINE(  62)		{
HXLINE(  62)			Float b = -(this->a);
HXDLIN(  62)			Float d = -(this->c);
HXDLIN(  62)			Float ty = -(this->tx);
HXDLIN(  62)			this->a = this->b;
HXDLIN(  62)			this->b = b;
HXDLIN(  62)			this->c = this->d;
HXDLIN(  62)			this->d = d;
HXDLIN(  62)			this->tx = this->ty;
HXDLIN(  62)			this->ty = ty;
            		}
