...
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_262_getObject,"flixel.math.FlxRandom","getObject",0x2a1130e8,"flixel.math.FlxRandom.getObject","flixel/math/FlxRandom.hx",262,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_313_shuffleArray,"flixel.math.FlxRandom","shuffleArray",0xf90f01cd,"flixel.math.FlxRandom.shuffleArray","flixel/math/FlxRandom.hx",313,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_342_shuffle,"flixel.math.FlxRandom","shuffle",0x24083c2c,"flixel.math.FlxRandom.shuffle","flixel/math/FlxRandom.hx",342,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_363_color,"flixel.math.FlxRandom","color",0x54cd64d6,"flixel.math.FlxRandom.color","flixel/math/FlxRandom.hx",363,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_409_generate,"flixel.math.FlxRandom","generate",0xe00ed5a2,"flixel.math.FlxRandom.generate","flixel/math/FlxRandom.hx",409,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_424_set_initialSeed,"flixel.math.FlxRandom","set_initialSeed",0x5f4b69eb,"flixel.math.FlxRandom.set_initialSeed","flixel/math/FlxRandom.hx",424,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_432_get_currentSeed,"flixel.math.FlxRandom","get_currentSeed",0xbfecf714,"flixel.math.FlxRandom.get_currentSeed","flixel/math/FlxRandom.hx",432,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_440_set_currentSeed,"flixel.math.FlxRandom","set_currentSeed",0xbbb87420,"flixel.math.FlxRandom.set_currentSeed","flixel/math/FlxRandom.hx",440,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_448_rangeBound,"flixel.math.FlxRandom","rangeBound",0x5cf038ee,"flixel.math.FlxRandom.rangeBound","flixel/math/FlxRandom.hx",448,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_454_boot,"flixel.math.FlxRandom","boot",0x1eb7001f,"flixel.math.FlxRandom.boot","flixel/math/FlxRandom.hx",454,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_465_boot,"flixel.math.FlxRandom","boot",0x1eb7001f,"flixel.math.FlxRandom.boot","flixel/math/FlxRandom.hx",465,0x4fa37e1d)
...
HXLINE( 416)		this->internalSeed = ((Float)1);
...
HXLINE( 183)		return (Mean + ((StdDev * this->_floatNormalRho) * this->_floatNormalRand1));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxRandom_obj,weightedPick,return )
 ...
 ::Dynamic FlxRandom_obj::getObject(::cpp::VirtualArray Objects,::Array< Float > WeightsArray,::hx::Null< int >  __o_StartIndex, ::Dynamic EndIndex){
            		int StartIndex = __o_StartIndex.Default(0);
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_262_getObject)
HXLINE( 263)		 ::Dynamic selected = null();
HXLINE( 265)		if ((Objects->get_length() != 0)) {
HXLINE( 267)			if (::hx::IsNull( WeightsArray )) {
HXLINE( 269)				::Array< Float > _g = ::Array_obj< Float >::__new(0);
HXDLIN( 269)				{
HXLINE( 269)					int _g1 = 0;
HXDLIN( 269)					int _g2 = Objects->get_length();
HXDLIN( 269)					while((_g1 < _g2)){
HXLINE( 269)						_g1 = (_g1 + 1);
HXDLIN( 269)						_g->push(1);
            					}
            				}
HXDLIN( 269)				WeightsArray = _g;
            			}
HXLINE( 272)			if (::hx::IsNull( EndIndex )) {
HXLINE( 274)				EndIndex = (Objects->get_length() - 1);
            			}
HXLINE( 277)			 ::Dynamic Max = (Objects->get_length() - 1);
HXDLIN( 277)			Float lowerBound;
HXDLIN( 277)			if ((StartIndex < 0)) {
HXLINE( 277)				lowerBound = ( (Float)(0) );
            			}
            			else {
HXLINE( 277)				lowerBound = ( (Float)(StartIndex) );
            			}
HXDLIN( 277)			Float StartIndex1;
HXDLIN( 277)			bool StartIndex2;
HXDLIN( 277)			if (::hx::IsNotNull( Max )) {
HXLINE( 277)				StartIndex2 = ::hx::IsGreater( lowerBound,Max );
            			}
            			else {
HXLINE( 277)				StartIndex2 = false;
            			}
HXDLIN( 277)			if (StartIndex2) {
HXLINE( 277)				StartIndex1 = ( (Float)(Max) );
            			}
            			else {
HXLINE( 277)				StartIndex1 = lowerBound;
            			}
HXDLIN( 277)			StartIndex = ::Std_obj::_hx_int(StartIndex1);
HXLINE( 278)			Float Value = ( (Float)(EndIndex) );
HXDLIN( 278)			 ::Dynamic Max1 = (Objects->get_length() - 1);
HXDLIN( 278)			Float lowerBound1;
HXDLIN( 278)			if ((Value < 0)) {
HXLINE( 278)				lowerBound1 = ( (Float)(0) );
            			}
            			else {
HXLINE( 278)				lowerBound1 = Value;
            			}
HXDLIN( 278)			Float EndIndex1;
HXDLIN( 278)			bool EndIndex2;
HXDLIN( 278)			if (::hx::IsNotNull( Max1 )) {
HXLINE( 278)				EndIndex2 = ::hx::IsGreater( lowerBound1,Max1 );
            			}
            			else {
HXLINE( 278)				EndIndex2 = false;
            			}
HXDLIN( 278)			if (EndIndex2) {
HXLINE( 278)				EndIndex1 = ( (Float)(Max1) );
            			}
            			else {
HXLINE( 278)				EndIndex1 = lowerBound1;
            			}
HXDLIN( 278)			EndIndex = ::Std_obj::_hx_int(EndIndex1);
HXLINE( 281)			if (::hx::IsLess( EndIndex,StartIndex )) {
HXLINE( 283)				StartIndex = (StartIndex + EndIndex);
HXLINE( 284)				EndIndex = (StartIndex - ( (int)(EndIndex) ));
HXLINE( 285)				StartIndex = (StartIndex - ( (int)(EndIndex) ));
            			}
HXLINE( 288)			if (::hx::IsGreater( EndIndex,(WeightsArray->length - 1) )) {
HXLINE( 290)				EndIndex = (WeightsArray->length - 1);
            			}
HXLINE( 293)			::Array< Float > _g3 = ::Array_obj< Float >::__new(0);
HXDLIN( 293)			{
HXLINE( 293)				int _g4 = StartIndex;
HXDLIN( 293)				int _g5 = (EndIndex + 1);
HXDLIN( 293)				while((_g4 < _g5)){
HXLINE( 293)					_g4 = (_g4 + 1);
HXDLIN( 293)					_g3->push(WeightsArray->__get((_g4 - 1)));
            				}
            			}
HXDLIN( 293)			::flixel::math::FlxRandom_obj::_arrayFloatHelper = _g3;
HXLINE( 294)			selected = Objects->__get((StartIndex + this->weightedPick(::flixel::math::FlxRandom_obj::_arrayFloatHelper)));
            		}
HXLINE( 297)		return selected;
            	}


HX_DEFINE_DYNAMIC_FUNC4(FlxRandom_obj,getObject,return )

::cpp::VirtualArray FlxRandom_obj::shuffleArray(::cpp::VirtualArray Objects,int HowManyTimes){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_313_shuffleArray)
HXLINE( 314)		HowManyTimes = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(HowManyTimes) ),( (Float)(0) )));
HXLINE( 316)		 ::Dynamic tempObject = null();
HXLINE( 318)		{
HXLINE( 318)			int _g = 0;
HXDLIN( 318)			int _g1 = HowManyTimes;
HXDLIN( 318)			while((_g < _g1)){
HXLINE( 318)				_g = (_g + 1);
HXLINE( 320)				int pick1 = this->_hx_int(0,(Objects->get_length() - 1),null());
HXLINE( 321)				int pick2 = this->_hx_int(0,(Objects->get_length() - 1),null());
HXLINE( 323)				tempObject = Objects->__get(pick1);
HXLINE( 324)				Objects->set(pick1,Objects->__get(pick2));
HXLINE( 325)				Objects->set(pick2,tempObject);
            			}
            		}
HXLINE( 328)		return Objects;
            	}


HX_DEFINE_DYNAMIC_FUNC2(FlxRandom_obj,shuffleArray,return )

void FlxRandom_obj::shuffle(::cpp::VirtualArray array){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_342_shuffle)
HXLINE( 343)		int maxValidIndex = (array->get_length() - 1);
HXLINE( 344)		{
HXLINE( 344)			int _g = 0;
HXDLIN( 344)			while((_g < maxValidIndex)){
HXLINE( 344)				_g = (_g + 1);
HXDLIN( 344)				int i = (_g - 1);
HXLINE( 346)				int j = this->_hx_int(i,maxValidIndex,null());
HXLINE( 347)				 ::Dynamic tmp = array->__get(i);
HXLINE( 348)				array->set(i,array->__get(j));
HXLINE( 349)				array->set(j,tmp);
            			}
            		}
            	}


HX_DEFINE_DYNAMIC_FUNC1(FlxRandom_obj,shuffle,(void))
...
int FlxRandom_obj::color( ::Dynamic Min, ::Dynamic Max, ::Dynamic Alpha,::hx::Null< bool >  __o_GreyScale){
            	...
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_363_color)
HXLINE( 364)		int red;
HXLINE( 365)		int green;
HXLINE( 366)		int blue;
HXLINE( 367)		int alpha;
HXLINE( 369)		bool _hx_tmp;
HXDLIN( 369)		if (::hx::IsNull( Min )) {
HXLINE( 369)			_hx_tmp = ::hx::IsNull( Max );
            		}
            		else {
HXLINE( 369)			_hx_tmp = false;
            		}
HXDLIN( 369)		if (_hx_tmp) {
HXLINE( 371)			red = this->_hx_int(0,255,null());
HXLINE( 372)			green = this->_hx_int(0,255,null());
HXLINE( 373)			blue = this->_hx_int(0,255,null());
HXLINE( 374)			if (::hx::IsNull( Alpha )) {
HXLINE( 374)				alpha = this->_hx_int(0,255,null());
            			}
            			else {
HXLINE( 374)				alpha = ( (int)(Alpha) );
            			}
            		}
            		else {
HXLINE( 376)			if (::hx::IsNull( Max )) {
HXLINE( 378)				red = this->_hx_int(((( (int)(Min) ) >> 16) & 255),255,null());
HXLINE( 379)				if (GreyScale) {
HXLINE( 379)					green = red;
            				}
            				else {
HXLINE( 379)					green = this->_hx_int(((( (int)(Min) ) >> 8) & 255),255,null());
            				}
HXLINE( 380)				if (GreyScale) {
HXLINE( 380)					blue = red;
            				}
            				else {
HXLINE( 380)					blue = this->_hx_int((( (int)(Min) ) & 255),255,null());
            				}
HXLINE( 381)				if (::hx::IsNull( Alpha )) {
HXLINE( 381)					alpha = this->_hx_int(((( (int)(Min) ) >> 24) & 255),255,null());
            				}
            				else {
HXLINE( 381)					alpha = ( (int)(Alpha) );
            				}
            			}
            			else {
HXLINE( 383)				if (::hx::IsNull( Min )) {
HXLINE( 385)					red = this->_hx_int(0,((( (int)(Max) ) >> 16) & 255),null());
HXLINE( 386)					if (GreyScale) {
HXLINE( 386)						green = red;
            					}
            					else {
HXLINE( 386)						green = this->_hx_int(0,((( (int)(Max) ) >> 8) & 255),null());
            					}
HXLINE( 387)					if (GreyScale) {
HXLINE( 387)						blue = red;
            					}
            					else {
HXLINE( 387)						blue = this->_hx_int(0,(( (int)(Max) ) & 255),null());
            					}
HXLINE( 388)					if (::hx::IsNull( Alpha )) {
HXLINE( 388)						alpha = this->_hx_int(0,((( (int)(Max) ) >> 24) & 255),null());
            					}
            					else {
HXLINE( 388)						alpha = ( (int)(Alpha) );
            					}
            				}
            				else {
HXLINE( 392)					red = this->_hx_int(((( (int)(Min) ) >> 16) & 255),((( (int)(Max) ) >> 16) & 255),null());
HXLINE( 393)					if (GreyScale) {
HXLINE( 393)						green = red;
            					}
            					else {
HXLINE( 393)						green = this->_hx_int(((( (int)(Min) ) >> 8) & 255),((( (int)(Max) ) >> 8) & 255),null());
            					}
HXLINE( 394)					if (GreyScale) {
HXLINE( 394)						blue = red;
            					}
            					else {
HXLINE( 394)						blue = this->_hx_int((( (int)(Min) ) & 255),(( (int)(Max) ) & 255),null());
            					}
HXLINE( 395)					if (::hx::IsNull( Alpha )) {
HXLINE( 395)						alpha = this->_hx_int(((( (int)(Min) ) >> 24) & 255),((( (int)(Max) ) >> 24) & 255),null());
            					}
            					else {
HXLINE( 395)						alpha = ( (int)(Alpha) );
            					}
            				}
            			}
            		}
HXLINE( 398)		int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 398)		int v = red;
HXDLIN( 398)		int color1 = (((((v) > 0xff) ? 0xff : ((v) < 0) ? 0 : (v)) & 255) << 16);
HXDLIN( 398)		int v1 = green;
HXDLIN( 398)		int color2 = (color1 | (((((v1) > 0xff) ? 0xff : ((v1) < 0) ? 0 : (v1)) & 255) << 8));
HXDLIN( 398)		int v2 = blue;
HXDLIN( 398)		int color3 = (color2 | ((((v2) > 0xff) ? 0xff : ((v2) < 0) ? 0 : (v2)) & 255));
HXDLIN( 398)		int v3 = alpha;
HXDLIN( 398)		color = (color3 | (((((v3) > 0xff) ? 0xff : ((v3) < 0) ? 0 : (v3)) & 255) << 24));
HXDLIN( 398)		return color;
            	}
...
Float FlxRandom_obj::generate(){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_409_generate)
HXDLIN( 409)		return (this->internalSeed = ::hx::Mod((this->internalSeed * ((Float)48271.0)),(int)2147483647));
            	}
...
int FlxRandom_obj::set_initialSeed(int NewSeed){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_424_set_initialSeed)
HXDLIN( 424)		Float lowerBound;
HXDLIN( 424)		if ((NewSeed < 1)) {
HXDLIN( 424)			lowerBound = ( (Float)(1) );
            		}
            		else {
HXDLIN( 424)			lowerBound = ( (Float)(NewSeed) );
            		}
HXDLIN( 424)		Float NewSeed1;
HXDLIN( 424)		if ((lowerBound > (int)2147483646)) {
HXDLIN( 424)			NewSeed1 = ( (Float)((int)2147483646) );
            		}
            		else {
HXDLIN( 424)			NewSeed1 = lowerBound;
            		}
HXDLIN( 424)		int NewSeed2 = ::Std_obj::_hx_int(NewSeed1);
HXDLIN( 424)		Float lowerBound1;
HXDLIN( 424)		if ((NewSeed2 < 1)) {
HXDLIN( 424)			lowerBound1 = ( (Float)(1) );
            		}
            		else {
HXDLIN( 424)			lowerBound1 = ( (Float)(NewSeed2) );
            		}
HXDLIN( 424)		Float _hx_tmp;
HXDLIN( 424)		if ((lowerBound1 > (int)2147483646)) {
HXDLIN( 424)			_hx_tmp = ( (Float)((int)2147483646) );
            		}
            		else {
HXDLIN( 424)			_hx_tmp = lowerBound1;
            		}
HXDLIN( 424)		return (this->initialSeed = ::Std_obj::_hx_int((this->internalSeed = ( (Float)(::Std_obj::_hx_int(_hx_tmp)) ))));
            	}
...
int FlxRandom_obj::get_currentSeed(){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_432_get_currentSeed)
HXDLIN( 432)		return ::Std_obj::_hx_int(this->internalSeed);
            	}
...
int FlxRandom_obj::set_currentSeed(int NewSeed){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_440_set_currentSeed)
HXDLIN( 440)		Float lowerBound;
HXDLIN( 440)		if ((NewSeed < 1)) {
HXDLIN( 440)			lowerBound = ( (Float)(1) );
            		}
            		else {
HXDLIN( 440)			lowerBound = ( (Float)(NewSeed) );
            		}
HXDLIN( 440)		Float _hx_tmp;
HXDLIN( 440)		if ((lowerBound > (int)2147483646)) {
HXDLIN( 440)			_hx_tmp = ( (Float)((int)2147483646) );
            		}
            		else {
HXDLIN( 440)			_hx_tmp = lowerBound;
            		}
HXDLIN( 440)		return ::Std_obj::_hx_int((this->internalSeed = ( (Float)(::Std_obj::_hx_int(_hx_tmp)) )));
            	}
...
int FlxRandom_obj::rangeBound(int Value){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_448_rangeBound)
HXDLIN( 448)		Float lowerBound;
HXDLIN( 448)		if ((Value < 1)) {
HXDLIN( 448)			lowerBound = ( (Float)(1) );
            		}
            		else {
HXDLIN( 448)			lowerBound = ( (Float)(Value) );
            		}
HXDLIN( 448)		Float _hx_tmp;
HXDLIN( 448)		if ((lowerBound > (int)2147483646)) {
HXDLIN( 448)			_hx_tmp = ( (Float)((int)2147483646) );
            		}
            		else {
HXDLIN( 448)			_hx_tmp = lowerBound;
            		}
HXDLIN( 448)		return ::Std_obj::_hx_int(_hx_tmp);
            	}
...
::hx::Val FlxRandom_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"shuffleArray") ) { return ::hx::Val( shuffleArray_dyn() ); }
...
static ::String FlxRandom_obj_sMemberFields[] = {
	...
	HX_("getObject",f5,07,96,91),
	HX_("shuffleArray",e0,50,82,41),
...
{
{
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_454_boot)
HXDLIN( 454)		_arrayFloatHelper = null();
            	}
{
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_465_boot)
HXDLIN( 465)		MULTIPLIER = ((Float)48271.0);
            	}
{
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_467_boot)
HXDLIN( 467)		MODULUS = (int)2147483647;
            	}
}
