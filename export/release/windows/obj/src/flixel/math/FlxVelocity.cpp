...
HXLINE(  32)			Speed = ( (Float)(::Std_obj::_hx_int((( (Float)(::Std_obj::_hx_int(::Math_obj::sqrt(((dx * dx) + (dy * dy))))) ) / (( (Float)(MaxTime) ) / ( (Float)(1000) ))))) );
            		}
...
HXLINE(  75)			Speed = ( (Float)(::Std_obj::_hx_int((( (Float)(::Std_obj::_hx_int(::Math_obj::sqrt(((dx * dx) + (dy * dy))))) ) / (( (Float)(MaxTime) ) / ( (Float)(1000) ))))) );
            		}
...
HXLINE( 103)			Speed = ( (Float)(::Std_obj::_hx_int((( (Float)(::Std_obj::_hx_int(::Math_obj::sqrt(((dx * dx) + (dy * dy))))) ) / (( (Float)(MaxTime) ) / ( (Float)(1000) ))))) );
            		}
...
HXLINE( 168)			Speed = ( (Float)(::Std_obj::_hx_int((( (Float)(::Std_obj::_hx_int(::Math_obj::sqrt(((dx * dx) + (dy * dy))))) ) / (( (Float)(MaxTime) ) / ( (Float)(1000) ))))) );
            		}
...
HXLINE( 205)		Float a = (Angle * ((Float)0.017453292519943295));
...
HXDLIN( 219)		return point->setPolarRadians(Speed,(::flixel::util::_FlxDirectionFlags::FlxDirectionFlags_Impl__obj::get_degrees(Parent->facing) * ((Float)0.017453292519943295)));
            	}
