...
HX_DEFINE_STACK_FRAME(_hx_pos_26d2f08d7c116d18_427_new,"flixel.path.FlxDiagonalPathfinder","new",0xac1c604d,"flixel.path.FlxDiagonalPathfinder.new","flixel/path/FlxPathfinder.hx",427,0x74454158)
HX_DEFINE_STACK_FRAME(_hx_pos_26d2f08d7c116d18_426_new,"flixel.path.FlxDiagonalPathfinder","new",0xac1c604d,"flixel.path.FlxDiagonalPathfinder.new","flixel/path/FlxPathfinder.hx",426,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_26d2f08d7c116d18_447_getNeighbors,"flixel.path.FlxDiagonalPathfinder","getNeighbors",0xdcef063e,"flixel.path.FlxDiagonalPathfinder.getNeighbors","flixel/path/FlxPathfinder.hx",447,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_26d2f08d7c116d18_433_getNeighbors,"flixel.path.FlxDiagonalPathfinder","getNeighbors",0xdcef063e,"flixel.path.FlxDiagonalPathfinder.getNeighbors","flixel/path/FlxPathfinder.hx",433,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_26d2f08d7c116d18_483_getInBoundDirections,"flixel.path.FlxDiagonalPathfinder","getInBoundDirections",0x493c04ca,"flixel.path.FlxDiagonalPathfinder.getInBoundDirections","flixel/path/FlxPathfinder.hx",483,0x74454158)
...
void FlxDiagonalPathfinder_obj::__construct(::hx::Null< int >  __o_diagonalPolicy){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(3)
            		 ::flixel::path::FlxTypedPathfinderData _hx_run( ::flixel::tile::FlxBaseTilemap map,int startIndex,int endIndex){
            			HX_GC_STACKFRAME(&_hx_pos_26d2f08d7c116d18_427_new)
HXLINE( 427)			return  ::flixel::path::FlxTypedPathfinderData_obj::__alloc( HX_CTX ,map,startIndex,endIndex);
            		}
            		HX_END_LOCAL_FUNC3(return)

            		int diagonalPolicy = __o_diagonalPolicy.Default(0);
            	HX_STACKFRAME(&_hx_pos_26d2f08d7c116d18_426_new)
HXLINE( 427)		super::__construct( ::Dynamic(new _hx_Closure_0()));
HXLINE( 429)		this->diagonalPolicy = diagonalPolicy;
            	}
...
::Array< int > FlxDiagonalPathfinder_obj::getNeighbors( ::Dynamic _tmp_data,int from){
            		...
            		bool _hx_run(bool condition,int to,int dir){
            			HX_STACKFRAME(&_hx_pos_26d2f08d7c116d18_447_getNeighbors)
HXLINE( 448)			bool condition1;
HXDLIN( 448)			if (condition) {
HXLINE( 448)				if (!(data->excluded->contains(to))) {
HXLINE( 448)					condition1 = _gthis->canGo(data,to,dir);
            				}
            				else {
HXLINE( 448)					condition1 = false;
            				}
            			}
            			else {
HXLINE( 448)				condition1 = false;
            			}
HXLINE( 449)			if (condition1) {
HXLINE( 450)				neighbors->push(to);
            			}
HXLINE( 452)			return condition1;
            		}
            		HX_END_LOCAL_FUNC3(return)

            	HX_STACKFRAME(&_hx_pos_26d2f08d7c116d18_433_getNeighbors)
HXDLIN( 433)		 ::flixel::path::FlxTypedPathfinderData data = ( ( ::flixel::path::FlxTypedPathfinderData)(_tmp_data) );
HXDLIN( 433)		 ::flixel::path::FlxDiagonalPathfinder _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 434)		::Array< int > neighbors = ::Array_obj< int >::__new(0);
HXLINE( 435)		int inBound = this->getInBoundDirections(data,from);
HXLINE( 436)		int dir = 256;
HXDLIN( 436)		bool up = ((inBound & dir) == dir);
HXLINE( 437)		int dir1 = 4096;
HXDLIN( 437)		bool down = ((inBound & dir1) == dir1);
HXLINE( 438)		int dir2 = 1;
HXDLIN( 438)		bool left = ((inBound & dir2) == dir2);
HXLINE( 439)		int dir3 = 16;
HXDLIN( 439)		bool right = ((inBound & dir3) == dir3);
HXLINE( 446)		 ::Dynamic addIf =  ::Dynamic(new _hx_Closure_0(_gthis,neighbors,data));
HXLINE( 455)		int columns = ( ( ::flixel::tile::FlxBaseTilemap)(data->map) )->widthInTiles;
HXLINE( 458)		up = ( (bool)(addIf(up,(from - columns),256)) );
HXLINE( 459)		down = ( (bool)(addIf(down,(from + columns),4096)) );
HXLINE( 460)		left = ( (bool)(addIf(left,(from - 1),1)) );
HXLINE( 461)		right = ( (bool)(addIf(right,(from + 1),16)) );
HXLINE( 464)		if ((this->diagonalPolicy != 0)) {
HXLINE( 467)			bool _hx_tmp;
HXDLIN( 467)			if (up) {
HXLINE( 467)				_hx_tmp = left;
            			}
            			else {
HXLINE( 467)				_hx_tmp = false;
            			}
HXDLIN( 467)			addIf(_hx_tmp,((from - columns) - 1),(256 | 1));
HXLINE( 468)			bool _hx_tmp1;
HXDLIN( 468)			if (up) {
HXLINE( 468)				_hx_tmp1 = right;
            			}
            			else {
HXLINE( 468)				_hx_tmp1 = false;
            			}
HXDLIN( 468)			addIf(_hx_tmp1,((from - columns) + 1),(256 | 16));
HXLINE( 469)			bool _hx_tmp2;
HXDLIN( 469)			if (down) {
HXLINE( 469)				_hx_tmp2 = left;
            			}
            			else {
HXLINE( 469)				_hx_tmp2 = false;
            			}
HXDLIN( 469)			addIf(_hx_tmp2,((from + columns) - 1),(4096 | 1));
HXLINE( 470)			bool _hx_tmp3;
HXDLIN( 470)			if (down) {
HXLINE( 470)				_hx_tmp3 = right;
            			}
            			else {
HXLINE( 470)				_hx_tmp3 = false;
            			}
HXDLIN( 470)			addIf(_hx_tmp3,((from + columns) + 1),(4096 | 16));
            		}
HXLINE( 473)		return neighbors;
            	}


int FlxDiagonalPathfinder_obj::getInBoundDirections( ::flixel::path::FlxTypedPathfinderData data,int from){
            	HX_STACKFRAME(&_hx_pos_26d2f08d7c116d18_483_getInBoundDirections)
HXLINE( 484)		int x = ::hx::Mod(from,( ( ::flixel::tile::FlxBaseTilemap)(data->map) )->widthInTiles);
HXLINE( 485)		int y = ::Std_obj::_hx_int((( (Float)(from) ) / ( (Float)(( ( ::flixel::tile::FlxBaseTilemap)(data->map) )->widthInTiles) )));
HXLINE( 486)		return ::flixel::util::_FlxDirectionFlags::FlxDirectionFlags_Impl__obj::fromBools((x > 0),(x < (( ( ::flixel::tile::FlxBaseTilemap)(data->map) )->widthInTiles - 1)),(y > 0),(y < (( ( ::flixel::tile::FlxBaseTilemap)(data->map) )->heightInTiles - 1)));
            	}
