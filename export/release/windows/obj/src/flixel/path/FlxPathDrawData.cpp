...
HX_DEFINE_STACK_FRAME(_hx_pos_ac1e30a014ff1e13_892_new,"flixel.path.FlxPathDrawData","new",0xd929d100,"flixel.path.FlxPathDrawData.new","flixel/path/FlxPath.hx",892,0xbf2b467e)
namespace flixel{
namespace path{
...
HXLINE( 901)		this->endSize = 5;
HXLINE( 900)		this->startSize = 5;
HXLINE( 899)		this->nodeSize = 3;
HXLINE( 898)		this->lineSize = 1;
HXLINE( 897)		this->endColor = -65536;
HXLINE( 896)		this->startColor = -16744448;
HXLINE( 895)		this->nodeColor = -1;
HXLINE( 894)		this->lineColor = -1;
HXLINE( 892)		if (::hx::IsNotNull( lineColor )) {
HXDLIN( 892)			this->lineColor = ( (int)(lineColor) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( nodeColor )) {
HXDLIN( 892)			this->nodeColor = ( (int)(nodeColor) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( startColor )) {
HXDLIN( 892)			this->startColor = ( (int)(startColor) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( endColor )) {
HXDLIN( 892)			this->endColor = ( (int)(endColor) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( lineSize )) {
HXDLIN( 892)			this->lineSize = ( (int)(lineSize) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( nodeSize )) {
HXDLIN( 892)			this->nodeSize = ( (int)(nodeSize) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( startSize )) {
HXDLIN( 892)			this->startSize = ( (int)(startSize) );
            		}
HXDLIN( 892)		if (::hx::IsNotNull( endSize )) {
HXDLIN( 892)			this->endSize = ( (int)(endSize) );
            		}
            	}
