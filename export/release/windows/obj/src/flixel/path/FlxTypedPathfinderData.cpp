...
HX_DEFINE_STACK_FRAME(_hx_pos_d2197318fd890c91_568_new,"flixel.path.FlxTypedPathfinderData","new",0xf7913c76,"flixel.path.FlxTypedPathfinderData.new","flixel/path/FlxPathfinder.hx",568,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_586_getPathIndicesTo,"flixel.path.FlxTypedPathfinderData","getPathIndicesTo",0xf3c26dd1,"flixel.path.FlxTypedPathfinderData.getPathIndicesTo","flixel/path/FlxPathfinder.hx",586,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_614_getPathIndices,"flixel.path.FlxTypedPathfinderData","getPathIndices",0x38418ab6,"flixel.path.FlxTypedPathfinderData.getPathIndices","flixel/path/FlxPathfinder.hx",614,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_619_hasValidStartEnd,"flixel.path.FlxTypedPathfinderData","hasValidStartEnd",0x4a9b7c25,"flixel.path.FlxTypedPathfinderData.hasValidStartEnd","flixel/path/FlxPathfinder.hx",619,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_623_destroy,"flixel.path.FlxTypedPathfinderData","destroy",0xefba5c10,"flixel.path.FlxTypedPathfinderData.destroy","flixel/path/FlxPathfinder.hx",623,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_638_isExcluded,"flixel.path.FlxTypedPathfinderData","isExcluded",0xe8c134fe,"flixel.path.FlxTypedPathfinderData.isExcluded","flixel/path/FlxPathfinder.hx",638,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_646_getX,"flixel.path.FlxTypedPathfinderData","getX",0xa2e32a2c,"flixel.path.FlxTypedPathfinderData.getX","flixel/path/FlxPathfinder.hx",646,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_654_getY,"flixel.path.FlxTypedPathfinderData","getY",0xa2e32a2d,"flixel.path.FlxTypedPathfinderData.getY","flixel/path/FlxPathfinder.hx",654,0x74454158)
HX_LOCAL_STACK_FRAME(_hx_pos_d2197318fd890c91_663_getTileCollisionsByIndex,"flixel.path.FlxTypedPathfinderData","getTileCollisionsByIndex",0x8a013ca0,"flixel.path.FlxTypedPathfinderData.getTileCollisionsByIndex","flixel/path/FlxPathfinder.hx",663,0x74454158)
namespace flixel{
namespace path{

void FlxTypedPathfinderData_obj::__construct( ::Dynamic map,int startIndex,int endIndex){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_568_new)
HXLINE( 569)		this->map = map;
HXLINE( 570)		::Array< int > _g = ::Array_obj< int >::__new(0);
HXDLIN( 570)		{
HXLINE( 570)			int _g1 = 0;
HXDLIN( 570)			int _g2 = ( ( ::flixel::tile::FlxBaseTilemap)(map) )->totalTiles;
HXDLIN( 570)			while((_g1 < _g2)){
HXLINE( 570)				_g1 = (_g1 + 1);
HXDLIN( 570)				_g->push(-1);
            			}
            		}
HXDLIN( 570)		this->distances = _g;
HXLINE( 571)		this->distances[startIndex] = 0;
HXLINE( 573)		::Array< int > _g3 = ::Array_obj< int >::__new(0);
HXDLIN( 573)		{
HXLINE( 573)			int _g4 = 0;
HXDLIN( 573)			int _g5 = ( ( ::flixel::tile::FlxBaseTilemap)(map) )->totalTiles;
HXDLIN( 573)			while((_g4 < _g5)){
HXLINE( 573)				_g4 = (_g4 + 1);
HXDLIN( 573)				_g3->push(-1);
            			}
            		}
HXDLIN( 573)		this->moves = _g3;
HXLINE( 575)		this->excluded = ::Array_obj< int >::__new(1)->init(0,startIndex);
HXLINE( 577)		this->startIndex = startIndex;
HXLINE( 578)		this->endIndex = endIndex;
            	}
...
::Array< int > FlxTypedPathfinderData_obj::getPathIndicesTo(int index){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_586_getPathIndicesTo)
HXLINE( 587)		if ((index == this->startIndex)) {
HXLINE( 588)			return ::Array_obj< int >::__new(2)->init(0,this->startIndex)->init(1,index);
            		}
HXLINE( 590)		if ((this->moves->__get(index) == -1)) {
HXLINE( 591)			return null();
            		}
HXLINE( 593)		::Array< int > path = ::Array_obj< int >::__new();
HXLINE( 596)		while((index != -1)){
HXLINE( 598)			path->unshift(index);
HXLINE( 599)			index = this->moves->__get(index);
            		}
HXLINE( 602)		if ((path->__get(0) != this->startIndex)) {
HXLINE( 603)			::flixel::FlxG_obj::log->advanced(HX_("getPathIndices ended up somewhere other than the start",7c,aa,6e,b9),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            		}
HXLINE( 605)		return path;
            	}
...
::Array< int > FlxTypedPathfinderData_obj::getPathIndices(){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_614_getPathIndices)
HXDLIN( 614)		return this->getPathIndicesTo(this->endIndex);
            	}
...
bool FlxTypedPathfinderData_obj::hasValidStartEnd(){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_619_hasValidStartEnd)
HXDLIN( 619)		bool _hx_tmp;
HXDLIN( 619)		bool _hx_tmp1;
HXDLIN( 619)		if ((this->startIndex >= 0)) {
HXDLIN( 619)			_hx_tmp1 = (this->endIndex >= 0);
            		}
            		else {
HXDLIN( 619)			_hx_tmp1 = false;
            		}
HXDLIN( 619)		if (_hx_tmp1) {
HXDLIN( 619)			_hx_tmp = (this->startIndex < ( ( ::flixel::tile::FlxBaseTilemap)(this->map) )->totalTiles);
            		}
            		else {
HXDLIN( 619)			_hx_tmp = false;
            		}
HXDLIN( 619)		if (_hx_tmp) {
HXDLIN( 619)			return (this->endIndex < ( ( ::flixel::tile::FlxBaseTilemap)(this->map) )->totalTiles);
            		}
            		else {
...
void FlxTypedPathfinderData_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_623_destroy)
HXLINE( 624)		this->map = null();
HXLINE( 625)		this->distances = null();
HXLINE( 626)		this->moves = null();
HXLINE( 627)		this->excluded = null();
            	}
...
bool FlxTypedPathfinderData_obj::isExcluded(int index){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_638_isExcluded)
HXDLIN( 638)		return this->excluded->contains(index);
            	}
...
int FlxTypedPathfinderData_obj::getX(int tile){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_646_getX)
HXDLIN( 646)		return ::hx::Mod(tile,( ( ::flixel::tile::FlxBaseTilemap)(this->map) )->widthInTiles);
            	}
...
int FlxTypedPathfinderData_obj::getY(int tile){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_654_getY)
HXDLIN( 654)		return ::Std_obj::_hx_int((( (Float)(tile) ) / ( (Float)(( ( ::flixel::tile::FlxBaseTilemap)(this->map) )->widthInTiles) )));
            	}
...
int FlxTypedPathfinderData_obj::getTileCollisionsByIndex(int tile){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_663_getTileCollisionsByIndex)
HXDLIN( 663)		 ::Dynamic _hx_tmp = this->map;
HXDLIN( 663)		return ( ( ::flixel::tile::FlxBaseTilemap)(_hx_tmp) )->getTileCollisions(( ( ::flixel::tile::FlxBaseTilemap)(this->map) )->getTileByIndex(tile));
            	}
