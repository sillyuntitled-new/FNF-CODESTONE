...
HX_DEFINE_STACK_FRAME(_hx_pos_f9788f02d403624e_417_new,"flixel.system.DefaultPreloader","new",0x2bdb85d4,"flixel.system.DefaultPreloader.new","flixel/system/FlxBasePreloader.hx",417,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_f9788f02d403624e_423_onAddedToStage,"flixel.system.DefaultPreloader","onAddedToStage",0xdd5c992e,"flixel.system.DefaultPreloader.onAddedToStage","flixel/system/FlxBasePreloader.hx",423,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_f9788f02d403624e_434_onComplete,"flixel.system.DefaultPreloader","onComplete",0x56637604,"flixel.system.DefaultPreloader.onComplete","flixel/system/FlxBasePreloader.hx",434,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_f9788f02d403624e_445_onProgress,"flixel.system.DefaultPreloader","onProgress",0x5cc66cf8,"flixel.system.DefaultPreloader.onProgress","flixel/system/FlxBasePreloader.hx",445,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_f9788f02d403624e_448_onInit,"flixel.system.DefaultPreloader","onInit",0x5b696edb,"flixel.system.DefaultPreloader.onInit","flixel/system/FlxBasePreloader.hx",448,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_f9788f02d403624e_452_onLoaded,"flixel.system.DefaultPreloader","onLoaded",0xdcea4490,"flixel.system.DefaultPreloader.onLoaded","flixel/system/FlxBasePreloader.hx",452,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_f9788f02d403624e_456_onUpdate,"flixel.system.DefaultPreloader","onUpdate",0x0b808294,"flixel.system.DefaultPreloader.onUpdate","flixel/system/FlxBasePreloader.hx",456,0x863b5dde)
namespace flixel{
namespace _hx_system{

void DefaultPreloader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f9788f02d403624e_417_new)
...
void DefaultPreloader_obj::onAddedToStage( ::openfl::events::Event _){
            	HX_STACKFRAME(&_hx_pos_f9788f02d403624e_423_onAddedToStage)
...
void DefaultPreloader_obj::onComplete( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_f9788f02d403624e_434_onComplete)
...
void DefaultPreloader_obj::onProgress( ::openfl::events::ProgressEvent event){
            	HX_STACKFRAME(&_hx_pos_f9788f02d403624e_445_onProgress)
...
void DefaultPreloader_obj::onInit(){
            	HX_STACKFRAME(&_hx_pos_f9788f02d403624e_448_onInit)
            	}
...
void DefaultPreloader_obj::onLoaded(){
            	HX_GC_STACKFRAME(&_hx_pos_f9788f02d403624e_452_onLoaded)
...
void DefaultPreloader_obj::onUpdate(int bytesLoaded,int bytesTotal){
            	HX_STACKFRAME(&_hx_pos_f9788f02d403624e_456_onUpdate)
...
::hx::ObjectPtr< DefaultPreloader_obj > DefaultPreloader_obj::__alloc(::hx::Ctx *_hx_ctx) {
	DefaultPreloader_obj *__this = (DefaultPreloader_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(DefaultPreloader_obj), true, "flixel.system.DefaultPreloader"));
...
void DefaultPreloader_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.system.DefaultPreloader",e2,4b,8f,6b);
