...
HXLINE(  30)			{
HXLINE(  30)				 ::flixel::math::FlxMatrix _this = this->_matrix;
HXDLIN(  30)				_this->a = ( (Float)(1) );
HXDLIN(  30)				_this->b = ( (Float)(0) );
HXDLIN(  30)				_this->c = ( (Float)(0) );
HXDLIN(  30)				_this->d = ( (Float)(1) );
HXDLIN(  30)				_this->tx = ( (Float)(0) );
HXDLIN(  30)				_this->ty = ( (Float)(0) );
            			}
HXLINE(  31)			{
HXLINE(  31)				 ::flixel::math::FlxMatrix _this1 = this->_matrix;
HXDLIN(  31)				Float sx = (( (Float)(camera->width) ) - (camera->viewMarginX * ( (Float)(2) )));
HXDLIN(  31)				Float sy = (( (Float)(camera->height) ) - (camera->viewMarginY * ( (Float)(2) )));
HXDLIN(  31)				_this1->a = (_this1->a * sx);
HXDLIN(  31)				_this1->b = (_this1->b * sy);
HXDLIN(  31)				_this1->c = (_this1->c * sx);
HXDLIN(  31)				_this1->d = (_this1->d * sy);
HXDLIN(  31)				_this1->tx = (_this1->tx * sx);
HXDLIN(  31)				_this1->ty = (_this1->ty * sy);
            			}
