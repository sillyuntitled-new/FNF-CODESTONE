...
bool FlxPreloader_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0c89e854) {
		if (inClassId<=(int)0x0330636f) {
			...
			return inClassId==(int)0x0a33888f || inClassId==(int)0x0c89e854;
		}
	} else {
...
HXLINE(  58)		 ::openfl::display::Bitmap logoLight = this->createBitmap(::hx::ClassOf< ::flixel::_hx_system::GraphicLogoLight >(), ::Dynamic(new _hx_Closure_0(_gthis)));
...
HXLINE(  71)		this->_text->set_defaultTextFormat( ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,8,6253311,null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
...
HXLINE(  76)		 ::openfl::text::TextField _hx_tmp4 = this->_text;
HXDLIN(  76)		_hx_tmp4->set_y((this->_bmpBar->get_y() - ( (Float)(11) )));
...
HXLINE(  82)		 ::openfl::display::Sprite _hx_tmp5 = this->_logo;
HXDLIN(  82)		_hx_tmp5->set_scaleX(this->_logo->set_scaleY(((( (Float)(this->_height) ) / ( (Float)(8) )) * ((Float)0.04))));
HXLINE(  83)		 ::openfl::display::Sprite _hx_tmp6 = this->_logo;
HXDLIN(  83)		int _hx_tmp7 = this->_width;
HXDLIN(  83)		_hx_tmp6->set_x(((( (Float)(_hx_tmp7) ) - this->_logo->get_width()) / ( (Float)(2) )));
HXLINE(  84)		 ::openfl::display::Sprite _hx_tmp8 = this->_logo;
HXDLIN(  84)		int _hx_tmp9 = this->_height;
HXDLIN(  84)		_hx_tmp8->set_y(((( (Float)(_hx_tmp9) ) - this->_logo->get_height()) / ( (Float)(2) )));
...
HXLINE(  89)		 ::openfl::display::Sprite _hx_tmp10 = this->_logoGlow;
HXDLIN(  89)		_hx_tmp10->set_scaleX(this->_logoGlow->set_scaleY(((( (Float)(this->_height) ) / ( (Float)(8) )) * ((Float)0.04))));
HXLINE(  90)		 ::openfl::display::Sprite _hx_tmp11 = this->_logoGlow;
HXDLIN(  90)		int _hx_tmp12 = this->_width;
HXDLIN(  90)		_hx_tmp11->set_x(((( (Float)(_hx_tmp12) ) - this->_logoGlow->get_width()) / ( (Float)(2) )));
HXLINE(  91)		 ::openfl::display::Sprite _hx_tmp13 = this->_logoGlow;
HXDLIN(  91)		int _hx_tmp14 = this->_height;
HXDLIN(  91)		_hx_tmp13->set_y(((( (Float)(_hx_tmp14) ) - this->_logoGlow->get_height()) / ( (Float)(2) )));
HXLINE(  92)		this->_buffer->addChild(this->_logoGlow);
HXLINE(  93)		 ::openfl::display::Bitmap corners = this->createBitmap(::hx::ClassOf< ::flixel::_hx_system::GraphicLogoCorners >(), ::Dynamic(new _hx_Closure_1(_gthis)));
