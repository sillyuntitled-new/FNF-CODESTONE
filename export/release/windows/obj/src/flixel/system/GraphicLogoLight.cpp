...
HX_DEFINE_STACK_FRAME(_hx_pos_f41d74447c0e45b7_47_new,"flixel.system.GraphicLogoLight","new",0x56af7702,"flixel.system.GraphicLogoLight.new","openfl/utils/_internal/AssetsMacro.hx",47,0xfdd54705)
HX_LOCAL_STACK_FRAME(_hx_pos_163e59da84bec2c9_13_boot,"flixel.system.GraphicLogoLight","boot",0x7af1ab50,"flixel.system.GraphicLogoLight.boot","flixel/system/FlxPreloader.hx",13,0xf0599dad)
namespace flixel{
...
void GraphicLogoLight_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
            	...
            	HX_STACKFRAME(&_hx_pos_f41d74447c0e45b7_47_new)
HXLINE(  71)		super::__construct(0,0,transparent,fillRGBA);
HXLINE(  74)		this->_hx___fromImage(::lime::graphics::Image_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::GraphicLogoLight_obj::resourceName)))));
            	}
...
bool GraphicLogoLight_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x073e5103) {
		...
		return inClassId==(int)0x2f5f68d6;
	}
}
...
::hx::ObjectPtr< GraphicLogoLight_obj > GraphicLogoLight_obj::__alloc(::hx::Ctx *_hx_ctx,int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA) {
	GraphicLogoLight_obj *__this = (GraphicLogoLight_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(GraphicLogoLight_obj), true, "flixel.system.GraphicLogoLight"));
...
void GraphicLogoLight_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.system.GraphicLogoLight",10,8e,ab,69);
...
{
{
            	HX_STACKFRAME(&_hx_pos_163e59da84bec2c9_13_boot)
HXDLIN(  13)		resourceName = HX_("__ASSET__:bitmap_flixel_system_GraphicLogoLight",16,df,60,47);
            	}
}
