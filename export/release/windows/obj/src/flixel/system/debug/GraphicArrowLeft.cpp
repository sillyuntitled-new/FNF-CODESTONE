...
HX_DEFINE_STACK_FRAME(_hx_pos_a7e581f07b396ffa_52_new,"flixel.system.debug.GraphicArrowLeft","new",0x89eb9442,"flixel.system.debug.GraphicArrowLeft.new","flixel/system/debug/FlxDebugger.hx",52,0xd9fc0a74)
namespace flixel{
namespace _hx_system{
namespace debug{

void GraphicArrowLeft_obj::__construct(int width,int height, ::Dynamic transparent, ::Dynamic fillColor){
            	HX_STACKFRAME(&_hx_pos_a7e581f07b396ffa_52_new)
HXDLIN(  52)		super::__construct(width,height,transparent,fillColor);
            	}
