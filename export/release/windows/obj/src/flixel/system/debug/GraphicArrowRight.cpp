...
HX_DEFINE_STACK_FRAME(_hx_pos_d12d58443e0e0eba_55_new,"flixel.system.debug.GraphicArrowRight","new",0x7bbb3ee5,"flixel.system.debug.GraphicArrowRight.new","flixel/system/debug/FlxDebugger.hx",55,0xd9fc0a74)
namespace flixel{
namespace _hx_system{
namespace debug{

void GraphicArrowRight_obj::__construct(int width,int height, ::Dynamic transparent, ::Dynamic fillColor){
            	HX_STACKFRAME(&_hx_pos_d12d58443e0e0eba_55_new)
HXDLIN(  55)		super::__construct(width,height,transparent,fillColor);
            	}
