...
HX_DEFINE_STACK_FRAME(_hx_pos_bb31c4552e01719c_46_new,"flixel.system.debug.GraphicBitmapLog","new",0xf8da4027,"flixel.system.debug.GraphicBitmapLog.new","flixel/system/debug/FlxDebugger.hx",46,0xd9fc0a74)
namespace flixel{
namespace _hx_system{
namespace debug{

void GraphicBitmapLog_obj::__construct(int width,int height, ::Dynamic transparent, ::Dynamic fillColor){
            	HX_STACKFRAME(&_hx_pos_bb31c4552e01719c_46_new)
HXDLIN(  46)		super::__construct(width,height,transparent,fillColor);
            	}
