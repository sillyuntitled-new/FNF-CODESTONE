...
HX_DEFINE_STACK_FRAME(_hx_pos_9923fe68235644cc_58_new,"flixel.system.debug.GraphicCloseButton","new",0xf0ec029c,"flixel.system.debug.GraphicCloseButton.new","flixel/system/debug/FlxDebugger.hx",58,0xd9fc0a74)
namespace flixel{
namespace _hx_system{
namespace debug{

void GraphicCloseButton_obj::__construct(int width,int height, ::Dynamic transparent, ::Dynamic fillColor){
            	HX_STACKFRAME(&_hx_pos_9923fe68235644cc_58_new)
HXDLIN(  58)		super::__construct(width,height,transparent,fillColor);
            	}
