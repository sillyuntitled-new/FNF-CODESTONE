...
HX_DEFINE_STACK_FRAME(_hx_pos_3608a2beee3554fd_49_new,"flixel.system.debug.GraphicConsole","new",0x7eeec0a9,"flixel.system.debug.GraphicConsole.new","flixel/system/debug/FlxDebugger.hx",49,0xd9fc0a74)
namespace flixel{
namespace _hx_system{
namespace debug{

void GraphicConsole_obj::__construct(int width,int height, ::Dynamic transparent, ::Dynamic fillColor){
            	HX_STACKFRAME(&_hx_pos_3608a2beee3554fd_49_new)
HXDLIN(  49)		super::__construct(width,height,transparent,fillColor);
            	}
