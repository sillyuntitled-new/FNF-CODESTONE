...
HX_DEFINE_STACK_FRAME(_hx_pos_8e56f9cbe4884d6a_61_new,"flixel.system.debug.GraphicInteractive","new",0x8c45a4b4,"flixel.system.debug.GraphicInteractive.new","flixel/system/debug/FlxDebugger.hx",61,0xd9fc0a74)
namespace flixel{
namespace _hx_system{
namespace debug{

void GraphicInteractive_obj::__construct(int width,int height, ::Dynamic transparent, ::Dynamic fillColor){
            	HX_STACKFRAME(&_hx_pos_8e56f9cbe4884d6a_61_new)
HXDLIN(  61)		super::__construct(width,height,transparent,fillColor);
            	}
