...
HX_DEFINE_STACK_FRAME(_hx_pos_57449aee0c72ca19_37_new,"flixel.system.debug.GraphicLog","new",0x6b03d456,"flixel.system.debug.GraphicLog.new","flixel/system/debug/FlxDebugger.hx",37,0xd9fc0a74)
namespace flixel{
namespace _hx_system{
namespace debug{

void GraphicLog_obj::__construct(int width,int height, ::Dynamic transparent, ::Dynamic fillColor){
            	HX_STACKFRAME(&_hx_pos_57449aee0c72ca19_37_new)
HXDLIN(  37)		super::__construct(width,height,transparent,fillColor);
            	}
