...
HX_DEFINE_STACK_FRAME(_hx_pos_72648bfda28cf679_40_new,"flixel.system.debug.GraphicStats","new",0xb5925771,"flixel.system.debug.GraphicStats.new","flixel/system/debug/FlxDebugger.hx",40,0xd9fc0a74)
namespace flixel{
namespace _hx_system{
namespace debug{

void GraphicStats_obj::__construct(int width,int height, ::Dynamic transparent, ::Dynamic fillColor){
            	HX_STACKFRAME(&_hx_pos_72648bfda28cf679_40_new)
HXDLIN(  40)		super::__construct(width,height,transparent,fillColor);
            	}
