...
HX_DEFINE_STACK_FRAME(_hx_pos_6ccb06d407f389af_43_new,"flixel.system.debug.GraphicWatch","new",0xb737cfa1,"flixel.system.debug.GraphicWatch.new","flixel/system/debug/FlxDebugger.hx",43,0xd9fc0a74)
namespace flixel{
namespace _hx_system{
namespace debug{

void GraphicWatch_obj::__construct(int width,int height, ::Dynamic transparent, ::Dynamic fillColor){
            	HX_STACKFRAME(&_hx_pos_6ccb06d407f389af_43_new)
HXDLIN(  43)		super::__construct(width,height,transparent,fillColor);
            	}
