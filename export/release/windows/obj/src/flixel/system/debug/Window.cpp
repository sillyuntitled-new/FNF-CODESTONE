...
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_276_toggleVisible,"flixel.system.debug.Window","toggleVisible",0x493d16e8,"flixel.system.debug.Window.toggleVisible","flixel/system/debug/Window.hx",276,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_281_putOnTop,"flixel.system.debug.Window","putOnTop",0xbb5abdfd,"flixel.system.debug.Window.putOnTop","flixel/system/debug/Window.hx",281,0xb8dfd4e5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_299_initWindowsSave,"flixel.system.debug.Window","initWindowsSave",0x601bc45a,"flixel.system.debug.Window.initWindowsSave","flixel/system/debug/Window.hx",299,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_305_saveWindowVisibility,"flixel.system.debug.Window","saveWindowVisibility",0x18e2d0d5,"flixel.system.debug.Window.saveWindowVisibility","flixel/system/debug/Window.hx",305,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_314_update,"flixel.system.debug.Window","update",0xcd50591f,"flixel.system.debug.Window.update","flixel/system/debug/Window.hx",314,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_322_init,"flixel.system.debug.Window","init",0x33a1fca6,"flixel.system.debug.Window.init","flixel/system/debug/Window.hx",322,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_340_onMouseMove,"flixel.system.debug.Window","onMouseMove",0xdd6abbe1,"flixel.system.debug.Window.onMouseMove","flixel/system/debug/Window.hx",340,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_380_onMouseDown,"flixel.system.debug.Window","onMouseDown",0xd777d132,"flixel.system.debug.Window.onMouseDown","flixel/system/debug/Window.hx",380,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_402_onMouseUp,"flixel.system.debug.Window","onMouseUp",0x62a36b2b,"flixel.system.debug.Window.onMouseUp","flixel/system/debug/Window.hx",402,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_412_bound,"flixel.system.debug.Window","bound",0xf2ff51e8,"flixel.system.debug.Window.bound","flixel/system/debug/Window.hx",412,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_423_updateSize,"flixel.system.debug.Window","updateSize",0x6f89a180,"flixel.system.debug.Window.updateSize","flixel/system/debug/Window.hx",423,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_447_close,"flixel.system.debug.Window","close",0x8465b962,"flixel.system.debug.Window.close","flixel/system/debug/Window.hx",447,0xb8dfd4e5)
...
HXLINE( 144)			this->_handle =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,::flixel::_hx_system::debug::DebuggerUtil_obj::fixSize( ::flixel::_hx_system::debug::GraphicWindowHandle_obj::__alloc( HX_CTX ,0,0,null(),null())),null(),null());
...
HXDLIN( 264)		if (!(this->_closable)) {
HXLINE( 264)			if ((::flixel::_hx_system::debug::FlxDebugger_obj::get_save()->status->_hx_getIndex() == 1)) {
...
HXLINE( 265)			this->saveWindowVisibility();
            		}
HXLINE( 267)		if (::hx::IsNotNull( this->toggleButton )) {
HXLINE( 268)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp1 = this->toggleButton;
HXDLIN( 268)			_hx_tmp1->set_toggled(!(this->get_visible()));
            		}
HXLINE( 270)		bool _hx_tmp2;
HXDLIN( 270)		if (this->get_visible()) {
HXLINE( 270)			_hx_tmp2 = this->_alwaysOnTop;
            		}
            		else {
HXLINE( 270)			_hx_tmp2 = false;
            		}
HXDLIN( 270)		if (_hx_tmp2) {
HXLINE( 271)			this->parent->addChild(::hx::ObjectPtr<OBJ_>(this));
            		}
            	}
...
void Window_obj::toggleVisible(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_276_toggleVisible)
HXDLIN( 276)		this->setVisible(!(this->get_visible()));
            	}
...
void Window_obj::putOnTop(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_281_putOnTop)
HXDLIN( 281)		this->parent->addChild(::hx::ObjectPtr<OBJ_>(this));
            	}
...
HXLINE( 286)		 ::flixel::util::FlxSave save = ::flixel::_hx_system::debug::FlxDebugger_obj::get_save();
HXLINE( 287)		bool _hx_tmp;
HXDLIN( 287)		if ((save->status->_hx_getIndex() == 1)) {
...
HXLINE( 290)		if (::hx::IsNull( save->data->__Field(HX_("windowSettings",f3,3c,19,85),::hx::paccDynamic) )) {
HXLINE( 292)			this->initWindowsSave();
HXLINE( 293)			save->flush(null());
            		}
HXLINE( 295)		this->set_visible(( (bool)( ::Dynamic(save->data->__Field(HX_("windowSettings",f3,3c,19,85),::hx::paccDynamic))->__GetItem(this->_id)) ));
            	}
...
void Window_obj::initWindowsSave(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_299_initWindowsSave)
HXLINE( 301)		::cpp::VirtualArray _g = ::cpp::VirtualArray_obj::__new(0);
HXDLIN( 301)		{
HXLINE( 301)			int _g1 = 0;
HXDLIN( 301)			while((_g1 < 10)){
HXLINE( 301)				_g1 = (_g1 + 1);
HXDLIN( 301)				_g->push(true);
            			}
            		}
HXDLIN( 301)		::flixel::_hx_system::debug::FlxDebugger_obj::get_save()->data->__SetField(HX_("windowSettings",f3,3c,19,85),_g,::hx::paccDynamic);
            	}
...
void Window_obj::saveWindowVisibility(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_305_saveWindowVisibility)
HXLINE( 306)		 ::flixel::util::FlxSave save = ::flixel::_hx_system::debug::FlxDebugger_obj::get_save();
HXLINE( 307)		if (::hx::IsNull( save->data->__Field(HX_("windowSettings",f3,3c,19,85),::hx::paccDynamic) )) {
HXLINE( 308)			this->initWindowsSave();
            		}
HXLINE( 310)		 ::Dynamic(save->data->__Field(HX_("windowSettings",f3,3c,19,85),::hx::paccDynamic))->__SetItem(this->_id,this->get_visible());
HXLINE( 311)		save->flush(null());
            	}
...
void Window_obj::update(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_314_update)
            	}
...
void Window_obj::init( ::openfl::events::Event _){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_322_init)
HXLINE( 323)		if (::hx::IsNull( this->stage )) {
HXLINE( 325)			return;
            		}
HXLINE( 327)		this->removeEventListener(HX_("enterFrame",f5,03,50,02),this->init_dyn(),null());
HXLINE( 329)		this->stage->addEventListener(HX_("mouseMove",d6,9b,b5,f4),this->onMouseMove_dyn(),null(),null(),null());
HXLINE( 330)		this->stage->addEventListener(HX_("mouseUp",e0,f3,72,c0),this->onMouseUp_dyn(),null(),null(),null());
HXLINE( 333)		this->addEventListener(HX_("mouseDown",27,b1,c2,ee),this->onMouseDown_dyn(),null(),null(),null());
            	}
...
void Window_obj::onMouseMove( ::openfl::events::MouseEvent _){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_340_onMouseMove)
HXLINE( 342)		Float mouseX;
HXDLIN( 342)		if ((this->get_mouseX() < 0)) {
HXLINE( 342)			mouseX = ( (Float)(0) );
            		}
            		else {
HXLINE( 342)			mouseX = this->get_mouseX();
            		}
HXLINE( 343)		Float mouseY;
HXDLIN( 343)		if ((this->get_mouseY() < 0)) {
HXLINE( 343)			mouseY = ( (Float)(0) );
            		}
            		else {
HXLINE( 343)			mouseY = this->get_mouseY();
            		}
HXLINE( 345)		if (!(this->parent->get_visible())) {
HXLINE( 347)			this->_overHandle = (this->_overHeader = false);
HXLINE( 348)			return;
            		}
HXLINE( 351)		if (this->_dragging) {
HXLINE( 353)			this->_overHeader = true;
HXLINE( 354)			Float _hx_tmp = this->parent->get_mouseX();
HXDLIN( 354)			Float _hx_tmp1 = (_hx_tmp - this->_drag->x);
HXDLIN( 354)			Float _hx_tmp2 = this->parent->get_mouseY();
HXDLIN( 354)			this->reposition(_hx_tmp1,(_hx_tmp2 - this->_drag->y));
            		}
            		else {
HXLINE( 356)			if (this->_resizing) {
HXLINE( 358)				this->_overHandle = true;
HXLINE( 359)				this->resize((mouseX - this->_drag->x),(mouseY - this->_drag->y));
            			}
            			else {
HXLINE( 361)				bool _hx_tmp3;
HXDLIN( 361)				bool _hx_tmp4;
HXDLIN( 361)				bool _hx_tmp5;
HXDLIN( 361)				if ((mouseX >= 0)) {
HXLINE( 361)					_hx_tmp5 = (mouseX <= this->_width);
            				}
            				else {
HXLINE( 361)					_hx_tmp5 = false;
            				}
HXDLIN( 361)				if (_hx_tmp5) {
HXLINE( 361)					_hx_tmp4 = (mouseY >= 0);
            				}
            				else {
HXLINE( 361)					_hx_tmp4 = false;
            				}
HXDLIN( 361)				if (_hx_tmp4) {
HXLINE( 361)					_hx_tmp3 = (mouseY <= this->_height);
            				}
            				else {
...
HXDLIN( 363)					if ((mouseX <= this->_header->get_width())) {
HXLINE( 363)						_hx_tmp6 = (mouseY <= this->_header->get_height());
            					}
            					else {
HXLINE( 363)						_hx_tmp6 = false;
            					}
HXDLIN( 363)					this->_overHeader = _hx_tmp6;
HXLINE( 364)					if (this->_resizable) {
HXLINE( 366)						bool _hx_tmp7;
HXDLIN( 366)						int _hx_tmp8 = this->_width;
HXDLIN( 366)						if ((mouseX >= (( (Float)(_hx_tmp8) ) - this->_handle->get_width()))) {
HXLINE( 366)							int _hx_tmp9 = this->_height;
HXDLIN( 366)							_hx_tmp7 = (mouseY >= (( (Float)(_hx_tmp9) ) - this->_handle->get_height()));
            						}
            						else {
HXLINE( 366)							_hx_tmp7 = false;
            						}
HXDLIN( 366)						this->_overHandle = _hx_tmp7;
            					}
            				}
            				else {
HXLINE( 371)					this->_overHandle = (this->_overHeader = false);
            				}
            			}
            		}
            	}
...
void Window_obj::onMouseDown( ::openfl::events::MouseEvent _){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_380_onMouseDown)
HXDLIN( 380)		if (this->_overHeader) {
HXLINE( 382)			if (this->_alwaysOnTop) {
HXLINE( 383)				this->parent->addChild(::hx::ObjectPtr<OBJ_>(this));
            			}
HXLINE( 384)			this->_dragging = true;
HXLINE( 385)			this->_drag->x = this->get_mouseX();
HXLINE( 386)			this->_drag->y = this->get_mouseY();
            		}
            		else {
HXLINE( 388)			if (this->_overHandle) {
HXLINE( 390)				if (this->_alwaysOnTop) {
HXLINE( 391)					this->parent->addChild(::hx::ObjectPtr<OBJ_>(this));
            				}
HXLINE( 392)				this->_resizing = true;
HXLINE( 393)				int _hx_tmp = this->_width;
HXDLIN( 393)				Float _hx_tmp1 = this->get_mouseX();
HXDLIN( 393)				this->_drag->x = (( (Float)(_hx_tmp) ) - _hx_tmp1);
HXLINE( 394)				int _hx_tmp2 = this->_height;
HXDLIN( 394)				Float _hx_tmp3 = this->get_mouseY();
HXDLIN( 394)				this->_drag->y = (( (Float)(_hx_tmp2) ) - _hx_tmp3);
            			}
            		}
            	}
...
void Window_obj::onMouseUp( ::openfl::events::MouseEvent _){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_402_onMouseUp)
HXLINE( 403)		this->_dragging = false;
HXLINE( 404)		this->_resizing = false;
            	}
...
void Window_obj::bound(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_412_bound)
HXDLIN( 412)		if (::hx::IsNotNull( this->_bounds )) {
HXLINE( 414)			Float Value = this->get_x();
HXDLIN( 414)			 ::Dynamic Min = this->_bounds->get_left();
HXDLIN( 414)			Float Max = this->_bounds->get_right();
HXDLIN( 414)			 ::Dynamic Max1 = (Max - ( (Float)(this->_width) ));
HXDLIN( 414)			Float lowerBound;
HXDLIN( 414)			bool lowerBound1;
HXDLIN( 414)			if (::hx::IsNotNull( Min )) {
HXLINE( 414)				lowerBound1 = ::hx::IsLess( Value,Min );
            			}
            			else {
HXLINE( 414)				lowerBound1 = false;
            			}
HXDLIN( 414)			if (lowerBound1) {
HXLINE( 414)				lowerBound = ( (Float)(Min) );
            			}
            			else {
HXLINE( 414)				lowerBound = Value;
            			}
HXDLIN( 414)			Float _hx_tmp;
HXDLIN( 414)			bool _hx_tmp1;
HXDLIN( 414)			if (::hx::IsNotNull( Max1 )) {
HXLINE( 414)				_hx_tmp1 = ::hx::IsGreater( lowerBound,Max1 );
            			}
            			else {
HXLINE( 414)				_hx_tmp1 = false;
            			}
HXDLIN( 414)			if (_hx_tmp1) {
HXLINE( 414)				_hx_tmp = ( (Float)(Max1) );
            			}
            			else {
HXLINE( 414)				_hx_tmp = lowerBound;
            			}
HXDLIN( 414)			this->set_x(_hx_tmp);
HXLINE( 415)			Float Value1 = this->get_y();
HXDLIN( 415)			 ::Dynamic Min1 = this->_bounds->get_top();
HXDLIN( 415)			Float Max2 = this->_bounds->get_bottom();
HXDLIN( 415)			 ::Dynamic Max3 = (Max2 - ( (Float)(this->_height) ));
HXDLIN( 415)			Float lowerBound2;
HXDLIN( 415)			bool lowerBound3;
HXDLIN( 415)			if (::hx::IsNotNull( Min1 )) {
HXLINE( 415)				lowerBound3 = ::hx::IsLess( Value1,Min1 );
            			}
            			else {
HXLINE( 415)				lowerBound3 = false;
            			}
HXDLIN( 415)			if (lowerBound3) {
HXLINE( 415)				lowerBound2 = ( (Float)(Min1) );
            			}
            			else {
HXLINE( 415)				lowerBound2 = Value1;
            			}
HXDLIN( 415)			Float _hx_tmp2;
HXDLIN( 415)			bool _hx_tmp3;
HXDLIN( 415)			if (::hx::IsNotNull( Max3 )) {
HXLINE( 415)				_hx_tmp3 = ::hx::IsGreater( lowerBound2,Max3 );
            			}
            			else {
HXLINE( 415)				_hx_tmp3 = false;
            			}
HXDLIN( 415)			if (_hx_tmp3) {
HXLINE( 415)				_hx_tmp2 = ( (Float)(Max3) );
            			}
            			else {
HXLINE( 415)				_hx_tmp2 = lowerBound2;
            			}
HXDLIN( 415)			this->set_y(_hx_tmp2);
            		}
            	}
...
void Window_obj::updateSize(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_423_updateSize)
HXLINE( 424)		Float Value = ( (Float)(this->_width) );
HXDLIN( 424)		 ::Dynamic Min = this->minSize->x;
HXDLIN( 424)		 ::Dynamic Max = this->maxSize->x;
HXDLIN( 424)		Float lowerBound;
HXDLIN( 424)		bool lowerBound1;
HXDLIN( 424)		if (::hx::IsNotNull( Min )) {
HXLINE( 424)			lowerBound1 = ::hx::IsLess( Value,Min );
            		}
            		else {
HXLINE( 424)			lowerBound1 = false;
            		}
HXDLIN( 424)		if (lowerBound1) {
HXLINE( 424)			lowerBound = ( (Float)(Min) );
            		}
            		else {
HXLINE( 424)			lowerBound = Value;
            		}
HXDLIN( 424)		Float _hx_tmp;
HXDLIN( 424)		bool _hx_tmp1;
HXDLIN( 424)		if (::hx::IsNotNull( Max )) {
HXLINE( 424)			_hx_tmp1 = ::hx::IsGreater( lowerBound,Max );
            		}
            		else {
HXLINE( 424)			_hx_tmp1 = false;
            		}
HXDLIN( 424)		if (_hx_tmp1) {
HXLINE( 424)			_hx_tmp = ( (Float)(Max) );
            		}
            		else {
HXLINE( 424)			_hx_tmp = lowerBound;
            		}
HXDLIN( 424)		this->_width = ::Std_obj::_hx_int(_hx_tmp);
HXLINE( 425)		Float Value1 = ( (Float)(this->_height) );
HXDLIN( 425)		 ::Dynamic Min1 = this->minSize->y;
HXDLIN( 425)		 ::Dynamic Max1 = this->maxSize->y;
HXDLIN( 425)		Float lowerBound2;
HXDLIN( 425)		bool lowerBound3;
HXDLIN( 425)		if (::hx::IsNotNull( Min1 )) {
HXLINE( 425)			lowerBound3 = ::hx::IsLess( Value1,Min1 );
            		}
            		else {
HXLINE( 425)			lowerBound3 = false;
            		}
HXDLIN( 425)		if (lowerBound3) {
HXLINE( 425)			lowerBound2 = ( (Float)(Min1) );
            		}
            		else {
HXLINE( 425)			lowerBound2 = Value1;
            		}
HXDLIN( 425)		Float _hx_tmp2;
HXDLIN( 425)		bool _hx_tmp3;
HXDLIN( 425)		if (::hx::IsNotNull( Max1 )) {
HXLINE( 425)			_hx_tmp3 = ::hx::IsGreater( lowerBound2,Max1 );
            		}
            		else {
HXLINE( 425)			_hx_tmp3 = false;
            		}
HXDLIN( 425)		if (_hx_tmp3) {
HXLINE( 425)			_hx_tmp2 = ( (Float)(Max1) );
            		}
            		else {
HXLINE( 425)			_hx_tmp2 = lowerBound2;
            		}
HXDLIN( 425)		this->_height = ::Std_obj::_hx_int(_hx_tmp2);
HXLINE( 427)		this->_header->set_scaleX(( (Float)(this->_width) ));
HXLINE( 428)		this->_background->set_scaleX(( (Float)(this->_width) ));
HXLINE( 429)		 ::openfl::display::Bitmap _hx_tmp4 = this->_background;
HXDLIN( 429)		int _hx_tmp5 = this->_height;
HXDLIN( 429)		_hx_tmp4->set_scaleY((( (Float)(_hx_tmp5) ) - this->_header->get_height()));
HXLINE( 430)		this->_shadow->set_scaleX(( (Float)(this->_width) ));
HXLINE( 431)		this->_shadow->set_y(( (Float)(this->_height) ));
HXLINE( 432)		this->_title->set_width(( (Float)((this->_width - 4)) ));
HXLINE( 433)		if (this->_resizable) {
HXLINE( 435)			 ::openfl::display::Bitmap _hx_tmp6 = this->_handle;
HXDLIN( 435)			int _hx_tmp7 = this->_width;
HXDLIN( 435)			_hx_tmp6->set_x((( (Float)(_hx_tmp7) ) - this->_handle->get_width()));
HXLINE( 436)			 ::openfl::display::Bitmap _hx_tmp8 = this->_handle;
HXDLIN( 436)			int _hx_tmp9 = this->_height;
HXDLIN( 436)			_hx_tmp8->set_y((( (Float)(_hx_tmp9) ) - this->_handle->get_height()));
            		}
HXLINE( 438)		if (::hx::IsNotNull( this->_closeButton )) {
HXLINE( 440)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp10 = this->_closeButton;
HXDLIN( 440)			int _hx_tmp11 = this->_width;
HXDLIN( 440)			_hx_tmp10->set_x(((( (Float)(_hx_tmp11) ) - this->_closeButton->get_width()) - ( (Float)(3) )));
HXLINE( 441)			this->_closeButton->set_y(( (Float)(3) ));
            		}
            	}
...
void Window_obj::close(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_447_close)
HXDLIN( 447)		this->destroy();
            	}
