...
HXLINE(  83)				items = ::flixel::_hx_system::debug::console::ConsoleUtil_obj::getFields(::flixel::_hx_system::debug::console::ConsoleUtil_obj::runCommand(path));
            			}
            		} catch( ::Dynamic _hx_e) {
...
HXLINE( 131)		::String insert = this->getCompletedText(this->getTextUntilCaret(),selectedItem);
...
HXDLIN( 139)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 143)			 ::Dynamic output = ::flixel::_hx_system::debug::console::ConsoleUtil_obj::runCommand(this->getCompletedText(this->getLastWord(this->input->get_text()),selectedItem));
HXLINE( 145)			this->watchingSelection = true;
HXLINE( 147)			this->getReadableType(output);
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
...
HXLINE( 164)					return ::flixel::util::FlxStringUtil_obj::getClassName(_g1,true);
            				}
            			}
            			break;
            			case (int)7: {
HXLINE( 165)				return ::flixel::util::FlxStringUtil_obj::getClassName(_g->_hx_getObject(0).StaticCast< ::hx::Class >(),true);
            			}
            			break;
            			case (int)8: {
