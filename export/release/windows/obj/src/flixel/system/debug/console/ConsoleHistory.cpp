...
HX_LOCAL_STACK_FRAME(_hx_pos_e5812cbc80e0d3b8_36_getPreviousCommand,"flixel.system.debug.console.ConsoleHistory","getPreviousCommand",0x3aa09670,"flixel.system.debug.console.ConsoleHistory.getPreviousCommand","flixel/system/debug/console/ConsoleHistory.hx",36,0xc796b240)
HX_LOCAL_STACK_FRAME(_hx_pos_e5812cbc80e0d3b8_43_getNextCommand,"flixel.system.debug.console.ConsoleHistory","getNextCommand",0x2e4e1f34,"flixel.system.debug.console.ConsoleHistory.getNextCommand","flixel/system/debug/console/ConsoleHistory.hx",43,0xc796b240)
HX_LOCAL_STACK_FRAME(_hx_pos_e5812cbc80e0d3b8_50_addCommand,"flixel.system.debug.console.ConsoleHistory","addCommand",0x56eecfbc,"flixel.system.debug.console.ConsoleHistory.addCommand","flixel/system/debug/console/ConsoleHistory.hx",50,0xc796b240)
HX_LOCAL_STACK_FRAME(_hx_pos_e5812cbc80e0d3b8_66_clear,"flixel.system.debug.console.ConsoleHistory","clear",0x0d15483b,"flixel.system.debug.console.ConsoleHistory.clear","flixel/system/debug/console/ConsoleHistory.hx",66,0xc796b240)
HX_LOCAL_STACK_FRAME(_hx_pos_e5812cbc80e0d3b8_73_get_isEmpty,"flixel.system.debug.console.ConsoleHistory","get_isEmpty",0x5caf4b88,"flixel.system.debug.console.ConsoleHistory.get_isEmpty","flixel/system/debug/console/ConsoleHistory.hx",73,0xc796b240)
...
HXLINE(  15)		 ::flixel::util::FlxSave save = ::flixel::_hx_system::debug::FlxDebugger_obj::get_save();
HXLINE(  16)		bool _hx_tmp;
HXDLIN(  16)		if ((save->status->_hx_getIndex() == 1)) {
...
HXLINE(  18)			if (::hx::IsNotNull( save->data->__Field(HX_("history",54,35,47,64),::hx::paccDynamic) )) {
HXLINE(  20)				this->commands = ( (::Array< ::String >)(save->data->__Field(HX_("history",54,35,47,64),::hx::paccDynamic)) );
HXLINE(  21)				this->index = this->commands->length;
            			}
            			else {
HXLINE(  25)				this->commands = ::Array_obj< ::String >::__new(0);
HXLINE(  26)				save->data->__SetField(HX_("history",54,35,47,64),this->commands,::hx::paccDynamic);
            			}
            		}
            		else {
...
::String ConsoleHistory_obj::getPreviousCommand(){
            	HX_STACKFRAME(&_hx_pos_e5812cbc80e0d3b8_36_getPreviousCommand)
HXLINE(  37)		if ((this->index > 0)) {
HXLINE(  38)			this->index--;
            		}
HXLINE(  39)		return this->commands->__get(this->index);
            	}
...
::String ConsoleHistory_obj::getNextCommand(){
            	HX_STACKFRAME(&_hx_pos_e5812cbc80e0d3b8_43_getNextCommand)
HXLINE(  44)		if ((this->index < this->commands->length)) {
HXLINE(  45)			this->index++;
            		}
HXLINE(  46)		if (::hx::IsNotNull( this->commands->__get(this->index) )) {
HXLINE(  46)			return this->commands->__get(this->index);
            		}
            		else {
HXLINE(  46)			return HX_("",00,00,00,00);
            		}
...
void ConsoleHistory_obj::addCommand(::String command){
            	HX_STACKFRAME(&_hx_pos_e5812cbc80e0d3b8_50_addCommand)
HXLINE(  52)		bool _hx_tmp;
HXDLIN(  52)		if (!(this->get_isEmpty())) {
HXLINE(  52)			_hx_tmp = (this->getPreviousCommand() != command);
            		}
            		else {
HXLINE(  52)			_hx_tmp = true;
            		}
HXDLIN(  52)		if (_hx_tmp) {
HXLINE(  54)			this->commands->push(command);
HXLINE(  55)			bool _hx_tmp1;
HXDLIN(  55)			if ((::flixel::_hx_system::debug::FlxDebugger_obj::get_save()->status->_hx_getIndex() == 1)) {
...
HXLINE(  56)				::flixel::_hx_system::debug::FlxDebugger_obj::get_save()->flush(null());
            			}
HXLINE(  58)			if ((this->commands->length > 50)) {
HXLINE(  59)				this->commands->shift();
            			}
            		}
HXLINE(  62)		this->index = this->commands->length;
            	}
...
void ConsoleHistory_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_e5812cbc80e0d3b8_66_clear)
HXLINE(  67)		this->commands->removeRange(0,this->commands->length);
HXLINE(  68)		::flixel::_hx_system::debug::FlxDebugger_obj::get_save()->flush(null());
            	}
...
bool ConsoleHistory_obj::get_isEmpty(){
            	HX_STACKFRAME(&_hx_pos_e5812cbc80e0d3b8_73_get_isEmpty)
HXDLIN(  73)		return (this->commands->length == 0);
            	}
