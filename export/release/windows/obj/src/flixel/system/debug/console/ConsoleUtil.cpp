...
bool ConsoleUtil_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::_hx_system::debug::console::Interp ConsoleUtil_obj::interp;
...
HXLINE(  40)		::flixel::_hx_system::debug::console::ConsoleUtil_obj::interp =  ::flixel::_hx_system::debug::console::Interp_obj::__alloc( HX_CTX );
            	}
...
HXDLIN(  64)		 ::flixel::_hx_system::debug::console::Interp _hx_tmp = ::flixel::_hx_system::debug::console::ConsoleUtil_obj::interp;
...
HXLINE( 158)		::flixel::util::FlxStringUtil_obj::sortAlphabetically(_g);
HXLINE( 159)		::flixel::util::FlxStringUtil_obj::sortAlphabetically(underscoreList);
HXLINE( 161)		return _g->concat(underscoreList);
            	}
...
bool ConsoleUtil_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"interp") ) { interp=ioValue.Cast<  ::flixel::_hx_system::debug::console::Interp >(); return true; }
	}
	return false;
}
...
static ::hx::StaticInfo ConsoleUtil_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::_hx_system::debug::console::Interp */ ,(void *) &ConsoleUtil_obj::interp,HX_("interp",d4,79,86,9e)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
