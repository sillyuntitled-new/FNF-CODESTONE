...
HX_DEFINE_STACK_FRAME(_hx_pos_ef1b3e6d9529fe01_15_new,"flixel.system.debug.interaction.tools.GraphicCursorCross","new",0x7ff5abab,"flixel.system.debug.interaction.tools.GraphicCursorCross.new","flixel/system/debug/interaction/tools/Pointer.hx",15,0x6c93613b)
namespace flixel{
...
void GraphicCursorCross_obj::__construct(int width,int height, ::Dynamic transparent, ::Dynamic fillColor){
            	HX_STACKFRAME(&_hx_pos_ef1b3e6d9529fe01_15_new)
