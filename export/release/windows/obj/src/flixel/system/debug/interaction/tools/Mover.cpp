...
HXLINE(  30)		this->setCursor( ::flixel::_hx_system::debug::interaction::tools::GraphicMoverTool_obj::__alloc( HX_CTX ,0,0,null(),null()));
...
HXLINE(  83)				if (::hx::IsNotNull( member )) {
HXLINE(  85)					member->set_x((member->x + dx));
HXLINE(  86)					member->set_y((member->y + dy));
            				}
            			}
            		}
            	}
