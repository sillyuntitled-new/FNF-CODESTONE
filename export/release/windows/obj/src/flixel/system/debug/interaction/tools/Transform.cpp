...
HXLINE(  75)		this->setButton(::hx::ClassOf< ::flixel::_hx_system::debug::interaction::tools::GraphicTransformTool >());
HXLINE(  76)		this->setCursor( ::flixel::_hx_system::debug::interaction::tools::GraphicTransformCursorDefault_obj::__alloc( HX_CTX ,0,0,null(),null()));
HXLINE(  78)		brain->registerCustomCursor(HX_("transformRotate",e7,c0,75,06), ::flixel::_hx_system::debug::interaction::tools::GraphicTransformCursorRotate_obj::__alloc( HX_CTX ,0,0,null(),null()));
HXLINE(  79)		brain->registerCustomCursor(HX_("transformScaleX",1a,65,7b,77), ::flixel::_hx_system::debug::interaction::tools::GraphicTransformCursorScaleX_obj::__alloc( HX_CTX ,0,0,null(),null()));
HXLINE(  80)		brain->registerCustomCursor(HX_("transformScaleY",1b,65,7b,77), ::flixel::_hx_system::debug::interaction::tools::GraphicTransformCursorScaleY_obj::__alloc( HX_CTX ,0,0,null(),null()));
HXLINE(  81)		brain->registerCustomCursor(HX_("transformScaleXY",ff,11,7d,14), ::flixel::_hx_system::debug::interaction::tools::GraphicTransformCursorScaleXY_obj::__alloc( HX_CTX ,0,0,null(),null()));
...
HXLINE( 158)				if ((this->_mouseCursor->distanceTo(this->_markers->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()) <= ((Float)5.0))) {
...
HXDLIN( 178)		return ::Std_obj::string(::flixel::math::FlxMath_obj::roundDecimal(number,::flixel::FlxG_obj::debugger->precision));
            	}
...
HXDLIN( 196)			if (((this->_mouseCursor->x - this->_actionStartPoint->x) >= 0)) {
...
HXLINE( 210)			this->_target->scale->set_x((this->_actionTargetStartScale->x + ((this->_actionScaleDirection->x * ::Math_obj::abs((this->_mouseCursor->x - this->_actionStartPoint->x))) / ((Float)10.0))));
            		}
...
HXDLIN( 223)		this->showTooltip((_hx_tmp2 + this->formatFloat((this->_target->angle * ((Float)0.017453292519943295)))));
            	}
...
HXLINE( 255)		Float rotationAngleRad = (this->_target->angle * ((Float)0.017453292519943295));
...
HXDLIN( 259)		n1 = (rotationAngleRad * ((Float)0.3183098862));
HXDLIN( 259)		if ((n1 > 1)) {
...
HXLINE( 266)				{
HXLINE( 266)					marker->set_x(((((marker->x - originX) * cos) - ((marker->y - originY) * sin)) + originX));
