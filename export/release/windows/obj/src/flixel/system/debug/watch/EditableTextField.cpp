...
HXDLIN(  99)				this->cycleEnumValue(_g->_hx_getObject(0).StaticCast< ::hx::Class >(),_hx_tmp1);
...
HXLINE( 143)						value = this->get_text();
            			...
            			break;
            			case (int)7: {
HXLINE( 151)				::hx::Class _g1 = _g->_hx_getObject(0).StaticCast< ::hx::Class >();
HXLINE( 152)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 143)					value = ::Type_obj::createEnum(_g1,this->get_text(),null());
            				} catch( ::Dynamic _hx_e) {
