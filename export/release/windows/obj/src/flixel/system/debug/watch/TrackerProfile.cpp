...
HX_DEFINE_STACK_FRAME(_hx_pos_045fa5a979169169_281_new,"flixel.system.debug.watch.TrackerProfile","new",0x3f8f952a,"flixel.system.debug.watch.TrackerProfile.new","flixel/system/debug/watch/Tracker.hx",281,0x14368dcf)
HX_LOCAL_STACK_FRAME(_hx_pos_045fa5a979169169_289_toString,"flixel.system.debug.watch.TrackerProfile","toString",0x9a236fa2,"flixel.system.debug.watch.TrackerProfile.toString","flixel/system/debug/watch/Tracker.hx",289,0x14368dcf)
namespace flixel{
...
void TrackerProfile_obj::__construct(::hx::Class ObjectClass,::Array< ::String > Variables,::Array< ::Dynamic> Extensions){
            	HX_STACKFRAME(&_hx_pos_045fa5a979169169_281_new)
HXLINE( 282)		this->objectClass = ObjectClass;
HXLINE( 283)		this->variables = Variables;
HXLINE( 284)		this->extensions = Extensions;
            	}
...
::String TrackerProfile_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_045fa5a979169169_289_toString)
HXLINE( 290)		 ::Dynamic value = this->variables;
HXDLIN( 290)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 290)		_this->label = HX_("variables",b7,e2,62,82);
HXDLIN( 290)		_this->value = value;
HXLINE( 291)		 ::Dynamic value1 = this->extensions;
HXDLIN( 291)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 291)		_this1->label = HX_("extensions",14,7c,70,89);
HXDLIN( 291)		_this1->value = value1;
HXLINE( 289)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_this)->init(1,_this1));
            	}
