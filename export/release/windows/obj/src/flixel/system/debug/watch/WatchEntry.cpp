...
HXDLIN(  56)		switch((int)(this->data->_hx_getIndex())){
            			case (int)0: {
HXLINE(  58)				return 16777215;
            			}
            			break;
            			case (int)1: {
HXLINE(  59)				return 10875373;
            			}
            			break;
            			case (int)2: {
HXLINE(  60)				return 12910211;
            			}
            			break;
            			case (int)3: {
HXLINE(  61)				return 15836581;
            			}
            			break;
            		}
...
HXDLIN(  93)			switch((int)(_g->_hx_getIndex())){
            				case (int)0: {
HXLINE(  96)					this->setNameText(((::flixel::util::FlxStringUtil_obj::getClassName(_g->_hx_getObject(0),true) + HX_(".",2e,00,00,00)) + _g->_hx_getString(1)));
            				}
            				break;
            				case (int)1: {
            				}
            				break;
            				case (int)2: {
HXLINE(  98)					this->setNameText(_g->_hx_getString(0));
            				}
            				break;
            				case (int)3: {
            				}
...
HXDLIN( 113)		switch((int)(_g->_hx_getIndex())){
            			case (int)0: {
HXLINE( 116)				return ::Reflect_obj::getProperty(_g->_hx_getObject(0),_g->_hx_getString(1));
            			}
            			break;
            			case (int)1: {
HXLINE( 124)				return _g->_hx_getString(0);
            			}
            			break;
            			case (int)2: {
HXLINE( 119)				return ::flixel::_hx_system::debug::console::ConsoleUtil_obj::runExpr(_g->_hx_getObject(1).StaticCast<  ::hscript::Expr >());
            			}
            			break;
            			case (int)3: {
HXLINE( 126)				return _g->_hx_getObject(0)();
            			}
            			break;
            		}
...
HXLINE( 143)			::Reflect_obj::setProperty(_g->_hx_getObject(0),_g->_hx_getString(1),value);
            		}
            	}
