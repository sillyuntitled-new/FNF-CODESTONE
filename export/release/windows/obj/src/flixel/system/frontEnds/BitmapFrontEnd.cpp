...
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_338_clearCache,"flixel.system.frontEnds.BitmapFrontEnd","clearCache",0xad367388,"flixel.system.frontEnds.BitmapFrontEnd.clearCache","flixel/system/frontEnds/BitmapFrontEnd.hx",338,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_374_mapCacheAsDestroyable,"flixel.system.frontEnds.BitmapFrontEnd","mapCacheAsDestroyable",0x74bcc6a9,"flixel.system.frontEnds.BitmapFrontEnd.mapCacheAsDestroyable","flixel/system/frontEnds/BitmapFrontEnd.hx",374,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_403_removeKey,"flixel.system.frontEnds.BitmapFrontEnd","removeKey",0xe84d3108,"flixel.system.frontEnds.BitmapFrontEnd.removeKey","flixel/system/frontEnds/BitmapFrontEnd.hx",403,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_414_reset,"flixel.system.frontEnds.BitmapFrontEnd","reset",0xd15ce89c,"flixel.system.frontEnds.BitmapFrontEnd.reset","flixel/system/frontEnds/BitmapFrontEnd.hx",414,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_437_clearUnused,"flixel.system.frontEnds.BitmapFrontEnd","clearUnused",0x9cfedd10,"flixel.system.frontEnds.BitmapFrontEnd.clearUnused","flixel/system/frontEnds/BitmapFrontEnd.hx",437,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_450_get_maxTextureSize,"flixel.system.frontEnds.BitmapFrontEnd","get_maxTextureSize",0x8d42ecd4,"flixel.system.frontEnds.BitmapFrontEnd.get_maxTextureSize","flixel/system/frontEnds/BitmapFrontEnd.hx",450,0x91a05ae2)
HX_LOCAL_STACK_FRAME(_hx_pos_c7913b0c5b2fbcc7_455_get_whitePixel,"flixel.system.frontEnds.BitmapFrontEnd","get_whitePixel",0xa476cef9,"flixel.system.frontEnds.BitmapFrontEnd.get_whitePixel","flixel/system/frontEnds/BitmapFrontEnd.hx",455,0x91a05ae2)
namespace flixel{
namespace _hx_system{
namespace frontEnds{

void BitmapFrontEnd_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_20_new)
HXLINE( 331)		this->_hx___cacheCopy =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 330)		this->_hx___countCache = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 328)		this->_hx___doNotDelete = false;
...
HXDLIN( 118)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(Key)) );
HXDLIN( 118)		if (::hx::IsNotNull( graphic )) {
HXDLIN( 118)			graphic->mustDestroy = false;
            		}
HXDLIN( 118)		return ::hx::IsNotNull( graphic );
            	}
...
HXLINE( 171)		graphic->mustDestroy = false;
HXLINE( 172)		return graphic;
            	}
...
HXLINE( 182)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key)) );
HXLINE( 183)		if (::hx::IsNotNull( graphic )) {
HXLINE( 184)			graphic->mustDestroy = false;
            		}
HXLINE( 185)		return graphic;
            	}
...
HXLINE( 227)		if (::hx::IsNull( userKey )) {
...
HXLINE( 247)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(baseKey)) );
HXDLIN( 247)		if (::hx::IsNotNull( graphic )) {
HXLINE( 247)			graphic->mustDestroy = false;
            		}
HXDLIN( 247)		if (::hx::IsNull( graphic )) {
...
HXLINE( 257)			 ::flixel::graphics::FlxGraphic graphic1 = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(uniqueKey)) );
HXDLIN( 257)			if (::hx::IsNotNull( graphic1 )) {
HXLINE( 257)				graphic1->mustDestroy = false;
            			}
HXLINE( 252)			if (!(::hx::IsNotNull( graphic1 ))) {
...
HXLINE( 278)			result = (baseKey + (((((((HX_("_Region:",27,96,a5,81) + region->x) + HX_("_",5f,00,00,00)) + region->y) + HX_("_",5f,00,00,00)) + region->width) + HX_("_",5f,00,00,00)) + region->height));
            		}
...
HXLINE( 313)			 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key)) );
HXDLIN( 313)			if (::hx::IsNotNull( graphic )) {
HXLINE( 313)				graphic->mustDestroy = false;
            			}
...
HXLINE( 316)			if (::hx::IsNotNull( graphic )) {
HXLINE( 317)				graphic->destroy();
            			}
            		}
            	}
...
void BitmapFrontEnd_obj::clearCache(){
            	HX_GC_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_338_clearCache)
HXLINE( 339)		if (::hx::IsNull( this->_cache )) {
HXLINE( 341)			this->_cache =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 342)			return;
            		}
HXLINE( 345)		this->_hx___doNotDelete = false;
HXLINE( 347)		{
HXLINE( 347)			int _g = 0;
HXDLIN( 347)			::Array< ::Dynamic> _g1 = this->_hx___countCache;
HXDLIN( 347)			while((_g < _g1->length)){
HXLINE( 347)				 ::flixel::graphics::FlxGraphic g = _g1->__get(_g).StaticCast<  ::flixel::graphics::FlxGraphic >();
HXDLIN( 347)				_g = (_g + 1);
HXLINE( 348)				g->set_useCount((g->get_useCount() - 10));
            			}
            		}
HXLINE( 350)		this->_hx___countCache = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 352)		{
HXLINE( 352)			 ::Dynamic key = this->_hx___cacheCopy->keys();
HXDLIN( 352)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 352)				::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 354)				 ::flixel::graphics::FlxGraphic obj = ( ( ::flixel::graphics::FlxGraphic)(this->_hx___cacheCopy->get(key1)) );
HXLINE( 355)				 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
HXDLIN( 355)				if (::hx::IsNotNull( graphic )) {
HXLINE( 355)					graphic->mustDestroy = false;
            				}
HXLINE( 356)				bool _hx_tmp;
HXDLIN( 356)				if (::hx::IsNotNull( graphic )) {
HXLINE( 356)					_hx_tmp = ::hx::IsInstanceNotEq( graphic,obj );
            				}
            				else {
HXLINE( 356)					_hx_tmp = false;
            				}
HXDLIN( 356)				if (_hx_tmp) {
HXLINE( 358)					obj->destroy();
            				}
HXLINE( 360)				bool _hx_tmp1;
HXDLIN( 360)				if (!(obj->mustDestroy)) {
HXLINE( 360)					bool _hx_tmp2;
HXDLIN( 360)					if (obj->get_destroyOnNoUse()) {
HXLINE( 360)						_hx_tmp2 = !(obj->persist);
            					}
            					else {
HXLINE( 360)						_hx_tmp2 = false;
            					}
HXDLIN( 360)					if (_hx_tmp2) {
HXLINE( 360)						_hx_tmp1 = (obj->get_useCount() <= 0);
            					}
            					else {
...
HXLINE( 362)					if (::hx::IsNotNull( key1 )) {
HXLINE( 362)						::openfl::utils::IAssetCache_obj::removeBitmapData(::openfl::utils::Assets_obj::cache,key1);
HXDLIN( 362)						this->_cache->remove(key1);
            					}
HXLINE( 363)					obj->destroy();
            				}
            			}
            		}
HXLINE( 367)		this->_hx___cacheCopy =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}


HX_DEFINE_DYNAMIC_FUNC0(BitmapFrontEnd_obj,clearCache,(void))

void BitmapFrontEnd_obj::mapCacheAsDestroyable(){
            	HX_GC_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_374_mapCacheAsDestroyable)
HXLINE( 375)		if (::hx::IsNull( this->_cache )) {
HXLINE( 376)			this->_cache =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
HXLINE( 378)		this->_hx___countCache = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 380)		this->_hx___doNotDelete = true;
HXLINE( 381)		this->_hx___cacheCopy =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 382)		{
HXLINE( 382)			::Dynamic this1 = this->_cache;
HXDLIN( 382)			 ::Dynamic _g_keys = ::haxe::IMap_obj::keys(this1);
HXDLIN( 382)			while(( (bool)(_g_keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 382)				::String key = ( (::String)(_g_keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXDLIN( 382)				 ::flixel::graphics::FlxGraphic _g_value = ( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(this1,key)) );
HXLINE( 383)				{
HXLINE( 384)					if (::hx::IsNull( _g_value )) {
HXLINE( 385)						continue;
            					}
HXLINE( 386)					if (::hx::IsNotNull( _g_value->assetsKey )) {
HXLINE( 388)						this->_hx___countCache->push(_g_value);
HXLINE( 389)						_g_value->set_useCount((_g_value->get_useCount() + 10));
            					}
            					else {
HXLINE( 391)						if (_g_value->get_destroyOnNoUse()) {
HXLINE( 393)							::flixel::FlxG_obj::bitmap->removeByKey(key);
HXLINE( 394)							continue;
            						}
            					}
HXLINE( 396)					_g_value->mustDestroy = true;
HXLINE( 397)					this->_hx___cacheCopy->set(key,_g_value);
            				}
            			}
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BitmapFrontEnd_obj,mapCacheAsDestroyable,(void))

void BitmapFrontEnd_obj::removeKey(::String key){
            	HX_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_403_removeKey)
HXDLIN( 403)		if (::hx::IsNotNull( key )) {
HXLINE( 405)			::openfl::utils::IAssetCache_obj::removeBitmapData(::openfl::utils::Assets_obj::cache,key);
HXLINE( 406)			this->_cache->remove(key);
            		}
            	}
...
void BitmapFrontEnd_obj::reset(){
            	HX_GC_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_414_reset)
HXLINE( 415)		if (::hx::IsNull( this->_cache )) {
HXLINE( 417)			this->_cache =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 418)			return;
            		}
HXLINE( 421)		{
HXLINE( 421)			 ::Dynamic key = this->_cache->keys();
HXDLIN( 421)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 421)				::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 423)				 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
HXDLIN( 423)				if (::hx::IsNotNull( graphic )) {
HXLINE( 423)					graphic->mustDestroy = false;
            				}
HXLINE( 424)				if (::hx::IsNotNull( key1 )) {
HXLINE( 424)					::openfl::utils::IAssetCache_obj::removeBitmapData(::openfl::utils::Assets_obj::cache,key1);
HXDLIN( 424)					this->_cache->remove(key1);
            				}
HXLINE( 426)				if (::hx::IsNotNull( graphic )) {
HXLINE( 427)					graphic->destroy();
            				}
            			}
            		}
            	}
...
void BitmapFrontEnd_obj::clearUnused(){
            	HX_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_437_clearUnused)
HXDLIN( 437)		 ::Dynamic key = this->_cache->keys();
HXDLIN( 437)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 437)			::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 439)			 ::flixel::graphics::FlxGraphic obj = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
HXLINE( 440)			bool _hx_tmp;
HXDLIN( 440)			bool _hx_tmp1;
HXDLIN( 440)			bool _hx_tmp2;
HXDLIN( 440)			if (::hx::IsNotNull( obj )) {
HXLINE( 440)				_hx_tmp2 = (obj->get_useCount() <= 0);
            			}
            			else {
HXLINE( 440)				_hx_tmp2 = false;
            			}
HXDLIN( 440)			if (_hx_tmp2) {
HXLINE( 440)				_hx_tmp1 = !(obj->persist);
            			}
            			else {
HXLINE( 440)				_hx_tmp1 = false;
            			}
HXDLIN( 440)			if (_hx_tmp1) {
HXLINE( 440)				_hx_tmp = obj->get_destroyOnNoUse();
            			}
            			else {
HXLINE( 440)				_hx_tmp = false;
            			}
HXDLIN( 440)			if (_hx_tmp) {
HXLINE( 442)				this->removeByKey(key1);
            			}
            		}
            	}
...
int BitmapFrontEnd_obj::get_maxTextureSize(){
            	HX_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_450_get_maxTextureSize)
HXDLIN( 450)		return ( (int)(::lime::graphics::opengl::GL_obj::context->getParameter(3379)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BitmapFrontEnd_obj,get_maxTextureSize,return )
 ...
 ::flixel::graphics::frames::FlxFrame BitmapFrontEnd_obj::get_whitePixel(){
            	HX_GC_STACKFRAME(&_hx_pos_c7913b0c5b2fbcc7_455_get_whitePixel)
HXLINE( 456)		if (::hx::IsNull( this->_whitePixel )) {
HXLINE( 458)			 ::openfl::display::BitmapData bd =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,10,10,true,-1);
HXLINE( 459)			 ::flixel::graphics::FlxGraphic graphic = ::flixel::FlxG_obj::bitmap->add(bd,true,HX_("whitePixels",b6,92,ba,9e));
HXLINE( 460)			graphic->persist = true;
HXLINE( 461)			this->_whitePixel = graphic->get_imageFrame()->get_frame();
            		}
HXLINE( 464)		return this->_whitePixel;
            	}
...
void BitmapFrontEnd_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(_hx___doNotDelete,"__doNotDelete");
	HX_MARK_MEMBER_NAME(_hx___countCache,"__countCache");
	HX_MARK_MEMBER_NAME(_hx___cacheCopy,"__cacheCopy");
	HX_MARK_END_CLASS();
}
...
void BitmapFrontEnd_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(_hx___doNotDelete,"__doNotDelete");
	HX_VISIT_MEMBER_NAME(_hx___countCache,"__countCache");
	HX_VISIT_MEMBER_NAME(_hx___cacheCopy,"__cacheCopy");
}
...
::hx::Val BitmapFrontEnd_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"__cacheCopy") ) { return ::hx::Val( _hx___cacheCopy ); }
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"__countCache") ) { return ::hx::Val( _hx___countCache ); }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"removeIfNoUse") ) { return ::hx::Val( removeIfNoUse_dyn() ); }
		if (HX_FIELD_EQ(inName,"__doNotDelete") ) { return ::hx::Val( _hx___doNotDelete ); }
		break;
	case 14:
...
::hx::Val BitmapFrontEnd_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"__cacheCopy") ) { _hx___cacheCopy=inValue.Cast<  ::haxe::ds::StringMap >(); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"__countCache") ) { _hx___countCache=inValue.Cast< ::Array< ::Dynamic> >(); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"__doNotDelete") ) { _hx___doNotDelete=inValue.Cast< bool >(); return inValue; }
		break;
	case 19:
...
void BitmapFrontEnd_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("__doNotDelete",73,9d,38,89));
	outFields->push(HX_("__countCache",13,72,fb,43));
	outFields->push(HX_("__cacheCopy",f7,13,a6,6b));
...
static ::hx::StorageInfo BitmapFrontEnd_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsBool,(int)offsetof(BitmapFrontEnd_obj,_hx___doNotDelete),HX_("__doNotDelete",73,9d,38,89)},
	{::hx::fsObject /* ::Array< ::Dynamic> */ ,(int)offsetof(BitmapFrontEnd_obj,_hx___countCache),HX_("__countCache",13,72,fb,43)},
	{::hx::fsObject /*  ::haxe::ds::StringMap */ ,(int)offsetof(BitmapFrontEnd_obj,_hx___cacheCopy),HX_("__cacheCopy",f7,13,a6,6b)},
	{ ::hx::fsUnknown, 0, null()}
};
...
static ::String BitmapFrontEnd_obj_sMemberFields[] = {
	...
	HX_("__doNotDelete",73,9d,38,89),
	HX_("__countCache",13,72,fb,43),
	HX_("__cacheCopy",f7,13,a6,6b),
