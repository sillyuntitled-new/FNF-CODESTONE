...
HXLINE(  48)		this->visibilityChanged =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  42)		this->drawDebugChanged =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
...
::hx::Val DebuggerFrontEnd_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"drawDebugChanged") ) { drawDebugChanged=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"visibilityChanged") ) { visibilityChanged=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
	}
...
static ::hx::StorageInfo DebuggerFrontEnd_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(DebuggerFrontEnd_obj,drawDebugChanged),HX_("drawDebugChanged",05,35,de,47)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(DebuggerFrontEnd_obj,visibilityChanged),HX_("visibilityChanged",42,69,31,f5)},
