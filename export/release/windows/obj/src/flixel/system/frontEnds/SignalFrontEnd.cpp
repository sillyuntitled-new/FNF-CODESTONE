...
HXLINE(  53)		this->focusLost =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  52)		this->focusGained =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  51)		this->postDraw =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  50)		this->preDraw =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  49)		this->postUpdate =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  48)		this->preUpdate =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  44)		this->postGameStart =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  38)		this->preGameStart =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  32)		this->postGameReset =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  31)		this->preGameReset =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  29)		this->gameResized =  ::flixel::util::FlxSignal2_obj::__alloc( HX_CTX );
HXLINE(  23)		this->preStateCreate =  ::flixel::util::FlxSignal1_obj::__alloc( HX_CTX );
HXLINE(  19)		this->postStateSwitch =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
HXLINE(  14)		this->preStateSwitch =  ::flixel::util::FlxSignal0_obj::__alloc( HX_CTX );
            	}
...
bool SignalFrontEnd_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::util::FlxSignal0 SignalFrontEnd_obj::get_stateSwitched(){
...
HX_DEFINE_DYNAMIC_FUNC0(SignalFrontEnd_obj,get_stateSwitched,return )
 ...
 ::flixel::util::FlxSignal0 SignalFrontEnd_obj::get_gameStarted(){
...
::hx::Val SignalFrontEnd_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"preDraw") ) { preDraw=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"postDraw") ) { postDraw=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"preUpdate") ) { preUpdate=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
		if (HX_FIELD_EQ(inName,"focusLost") ) { focusLost=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"postUpdate") ) { postUpdate=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"gameResized") ) { gameResized=inValue.Cast<  ::flixel::util::FlxSignal2 >(); return inValue; }
		if (HX_FIELD_EQ(inName,"focusGained") ) { focusGained=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"preGameReset") ) { preGameReset=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
		if (HX_FIELD_EQ(inName,"preGameStart") ) { preGameStart=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"postGameReset") ) { postGameReset=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
		if (HX_FIELD_EQ(inName,"postGameStart") ) { postGameStart=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"preStateSwitch") ) { preStateSwitch=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
		if (HX_FIELD_EQ(inName,"preStateCreate") ) { preStateCreate=inValue.Cast<  ::flixel::util::FlxSignal1 >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"postStateSwitch") ) { postStateSwitch=inValue.Cast<  ::flixel::util::FlxSignal0 >(); return inValue; }
	}
...
static ::hx::StorageInfo SignalFrontEnd_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(SignalFrontEnd_obj,preStateSwitch),HX_("preStateSwitch",82,cb,47,50)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(SignalFrontEnd_obj,postStateSwitch),HX_("postStateSwitch",65,46,a8,db)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal1 */ ,(int)offsetof(SignalFrontEnd_obj,preStateCreate),HX_("preStateCreate",8a,e8,dd,06)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal2 */ ,(int)offsetof(SignalFrontEnd_obj,gameResized),HX_("gameResized",1e,d2,29,48)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(SignalFrontEnd_obj,preGameReset),HX_("preGameReset",da,1b,e3,c1)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(SignalFrontEnd_obj,postGameReset),HX_("postGameReset",fd,07,96,c9)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(SignalFrontEnd_obj,preGameStart),HX_("preGameStart",6d,46,26,5f)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(SignalFrontEnd_obj,postGameStart),HX_("postGameStart",90,32,d9,66)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(SignalFrontEnd_obj,preUpdate),HX_("preUpdate",8c,96,a6,e5)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(SignalFrontEnd_obj,postUpdate),HX_("postUpdate",89,06,3e,dc)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(SignalFrontEnd_obj,preDraw),HX_("preDraw",c7,05,d5,1a)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(SignalFrontEnd_obj,postDraw),HX_("postDraw",84,8c,af,00)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(SignalFrontEnd_obj,focusGained),HX_("focusGained",96,ec,66,a1)},
	{::hx::fsObject /*  ::flixel::util::FlxSignal0 */ ,(int)offsetof(SignalFrontEnd_obj,focusLost),HX_("focusLost",dc,01,43,1f)},
	{ ::hx::fsUnknown, 0, null()}
};
