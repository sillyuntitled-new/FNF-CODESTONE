...
HXLINE( 119)					this->_capacity = (this->_capacity * 2);
HXLINE( 120)					{
HXLINE( 120)						::Array< ::Dynamic> array = this->_frames;
HXDLIN( 120)						int newLength = this->_capacity;
HXDLIN( 120)						bool _hx_tmp;
HXDLIN( 120)						if ((newLength > 0)) {
HXLINE( 120)							_hx_tmp = (newLength < array->length);
            						}
            						else {
HXLINE( 120)							_hx_tmp = false;
            						}
HXDLIN( 120)						if (_hx_tmp) {
HXLINE( 120)							array->resize(newLength);
            						}
            					}
            				}
            			}
...
HXLINE( 185)			this->_capacity = (this->_capacity * 2);
HXLINE( 186)			{
HXLINE( 186)				::Array< ::Dynamic> array = this->_frames;
HXDLIN( 186)				int newLength = this->_capacity;
HXDLIN( 186)				bool _hx_tmp;
HXDLIN( 186)				if ((newLength > 0)) {
HXLINE( 186)					_hx_tmp = (newLength < array->length);
            				}
            				else {
HXLINE( 186)					_hx_tmp = false;
            				}
HXDLIN( 186)				if (_hx_tmp) {
HXLINE( 186)					array->resize(newLength);
            				}
            			}
            		}
            	}
...
HXLINE( 241)		{
HXLINE( 241)			::Array< ::Dynamic> array = this->_frames;
HXDLIN( 241)			int newLength = this->_capacity;
HXDLIN( 241)			bool _hx_tmp;
HXDLIN( 241)			if ((newLength > 0)) {
HXLINE( 241)				_hx_tmp = (newLength < array->length);
            			}
            			else {
HXLINE( 241)				_hx_tmp = false;
            			}
HXDLIN( 241)			if (_hx_tmp) {
HXLINE( 241)				array->resize(newLength);
            			}
            		}
