...
HX_DEFINE_STACK_FRAME(_hx_pos_a69907c6a733237a_1227_new,"flixel.text.FlxTextFormat","new",0x67be2279,"flixel.text.FlxTextFormat.new","flixel/text/FlxText.hx",1227,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_a69907c6a733237a_1233_set_leading,"flixel.text.FlxTextFormat","set_leading",0x68682d02,"flixel.text.FlxTextFormat.set_leading","flixel/text/FlxText.hx",1233,0xdf165a6e)
namespace flixel{
namespace text{

void FlxTextFormat_obj::__construct( ::Dynamic fontColor, ::Dynamic bold, ::Dynamic italic, ::Dynamic borderColor, ::Dynamic underline){
            	HX_GC_STACKFRAME(&_hx_pos_a69907c6a733237a_1227_new)
HXLINE(1228)		this->format =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,null(),null(),fontColor,bold,italic,underline,null(),null(),null(),null(),null(),null(),null());
HXLINE(1229)		int _hx_tmp;
HXDLIN(1229)		if (::hx::IsNull( borderColor )) {
HXLINE(1229)			_hx_tmp = 0;
            		}
            		else {
HXLINE(1229)			_hx_tmp = ( (int)(borderColor) );
            		}
HXDLIN(1229)		this->borderColor = _hx_tmp;
            	}
...
int FlxTextFormat_obj::set_leading(int value){
            	HX_STACKFRAME(&_hx_pos_a69907c6a733237a_1233_set_leading)
HXLINE(1234)		this->format->leading = value;
HXLINE(1235)		return value;
            	}
