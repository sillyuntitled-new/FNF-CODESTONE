...
HX_DEFINE_STACK_FRAME(_hx_pos_415d3a020ae56400_1257_new,"flixel.text.FlxTextFormatMarkerPair","new",0xb549f24d,"flixel.text.FlxTextFormatMarkerPair.new","flixel/text/FlxText.hx",1257,0xdf165a6e)
namespace flixel{
namespace text{

void FlxTextFormatMarkerPair_obj::__construct( ::flixel::text::FlxTextFormat format,::String marker){
            	HX_STACKFRAME(&_hx_pos_415d3a020ae56400_1257_new)
HXLINE(1258)		this->format = format;
HXLINE(1259)		this->marker = marker;
            	}
