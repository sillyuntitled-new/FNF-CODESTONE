...
HX_DEFINE_STACK_FRAME(_hx_pos_3dc37578eee09ecc_1245_new,"flixel.text.FlxTextFormatRange","new",0x6417de28,"flixel.text.FlxTextFormatRange.new","flixel/text/FlxText.hx",1245,0xdf165a6e)
namespace flixel{
namespace text{

void FlxTextFormatRange_obj::__construct( ::flixel::text::FlxTextFormat format,int start,int end){
            	HX_GC_STACKFRAME(&_hx_pos_3dc37578eee09ecc_1245_new)
HXLINE(1246)		this->range =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,start,end);
HXLINE(1247)		this->format = format;
            	}
...
::hx::ObjectPtr< FlxTextFormatRange_obj > FlxTextFormatRange_obj::__alloc(::hx::Ctx *_hx_ctx, ::flixel::text::FlxTextFormat format,int start,int end) {
	FlxTextFormatRange_obj *__this = (FlxTextFormatRange_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(FlxTextFormatRange_obj), true, "flixel.text.FlxTextFormatRange"));
...
void FlxTextFormatRange_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.text.FlxTextFormatRange",36,ea,7b,10);
