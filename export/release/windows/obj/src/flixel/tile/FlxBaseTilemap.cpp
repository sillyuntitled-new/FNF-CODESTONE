...
HX_LOCAL_STACK_FRAME(_hx_pos_36d94048d9e4941f_424_loadMapFromGraphic,"flixel.tile.FlxBaseTilemap","loadMapFromGraphic",0xe93ffe1d,"flixel.tile.FlxBaseTilemap.loadMapFromGraphic","flixel/tile/FlxBaseTilemap.hx",424,0x0139d8e5)
...
HXLINE( 248)		this->flixelType = ( (unsigned char)(3) );
...
HXLINE( 291)		::Array< ::String > lines =  ::EReg_obj::__alloc( HX_CTX ,HX_("[ \t]*((\r\n)|\r|\n)[ \t]*",22,2c,8d,6d),HX_("g",67,00,00,00))->split(mapData);
HXLINE( 292)		::Array< ::String > _g = ::Array_obj< ::String >::__new(0);
HXDLIN( 292)		{
HXLINE( 292)			int _g1 = 0;
HXDLIN( 292)			while((_g1 < lines->length)){
HXLINE( 292)				::String v = lines->__get(_g1);
...
HXLINE( 390)		this->_data = ::flixel::util::FlxArrayUtil_obj::flatten2DArray(mapData);
...
HX_DEFINE_DYNAMIC_FUNC8(FlxBaseTilemap_obj,loadMapFrom2DArray,return )
 ...
 ::flixel::tile::FlxBaseTilemap FlxBaseTilemap_obj::loadMapFromGraphic( ::Dynamic mapGraphic,::hx::Null< bool >  __o_invert,::hx::Null< int >  __o_scale,::Array< int > colorMap, ::Dynamic tileGraphic,::hx::Null< int >  __o_tileWidth,::hx::Null< int >  __o_tileHeight, ::flixel::tile::FlxTilemapAutoTiling autoTile,::hx::Null< int >  __o_startingIndex,::hx::Null< int >  __o_drawIndex,::hx::Null< int >  __o_collideIndex){
            		...
            		int drawIndex = __o_drawIndex.Default(1);
            		int collideIndex = __o_collideIndex.Default(1);
            	HX_STACKFRAME(&_hx_pos_36d94048d9e4941f_424_loadMapFromGraphic)
HXDLIN( 424)		return this->loadMapFromCSV(::flixel::util::FlxStringUtil_obj::bitmapToCSV(::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(mapGraphic),invert,scale,colorMap),tileGraphic,tileWidth,tileHeight,autoTile,startingIndex,drawIndex,collideIndex);
            	}
...
HXDLIN( 552)			base[index] = (base->__get(index) + 1);
            		}
...
HXDLIN( 557)			base1[index] = (base1->__get(index) + 2);
            		}
...
HXDLIN( 562)			base2[index] = (base2->__get(index) + 4);
            		}
...
HXDLIN( 567)			base3[index] = (base3->__get(index) + 8);
            		}
...
HXDLIN( 597)		base4[index] = (base4->__get(index) + 1);
            	}
...
HXDLIN( 624)			base[index] = (base->__get(index) + 1);
            		}
...
HXDLIN( 626)			base1[index] = (base1->__get(index) + 2);
            		}
HXLINE( 627)		if (right) {
HXLINE( 628)			::Array< int > base2 = this->_data;
HXDLIN( 628)			base2[index] = (base2->__get(index) + 4);
            		}
...
HXDLIN( 630)			base3[index] = (base3->__get(index) + 8);
            		}
HXLINE( 631)		if (down) {
HXLINE( 632)			::Array< int > base4 = this->_data;
HXDLIN( 632)			base4[index] = (base4->__get(index) + 16);
            		}
...
HXDLIN( 634)			base5[index] = (base5->__get(index) + 32);
            		}
HXLINE( 635)		if (left) {
HXLINE( 636)			::Array< int > base6 = this->_data;
HXDLIN( 636)			base6[index] = (base6->__get(index) + 64);
            		}
...
HXDLIN( 638)			base7[index] = (base7->__get(index) + 128);
            		}
HXLINE( 640)		::Array< int > base8 = this->_data;
HXDLIN( 640)		base8[index] = (base8->__get(index) - (::flixel::tile::FlxBaseTilemap_obj::offsetAutoTile->__get(this->_data->__get(index)) - 1));
            	}
...
HXLINE( 827)			HX_STACK_DO_THROW(((((((((HX_("Index ",ee,88,87,c8) + end) + HX_(" exceeds the maximum tile index of ",d9,51,06,f4)) + maxIndex) + HX_(". Please verify the Tile (",88,d4,6b,e3)) + tile) + HX_(") and Range (",25,ce,96,19)) + range) + HX_(") parameters.",cd,e3,29,61)));
            		}
HXLINE( 830)		{
HXLINE( 830)			int _g = tile;
HXDLIN( 830)			while((_g < end)){
HXLINE( 830)				_g = (_g + 1);
HXLINE( 832)				 ::Dynamic tileData = this->_tileObjects->__get((_g - 1));
...
HXLINE( 970)			 ::flixel::FlxCamera camera1 = null();
HXDLIN( 970)			bool _hx_tmp;
HXDLIN( 970)			bool _hx_tmp1;
HXDLIN( 970)			if ((objectOrGroup->flixelType != ( (unsigned char)(1) ))) {
HXLINE( 970)				_hx_tmp1 = (objectOrGroup->flixelType == ( (unsigned char)(3) ));
            			}
            			else {
...
HXLINE( 970)				_hx_tmp = this->overlaps(objectOrGroup,false,camera1);
            			}
...
HXDLIN( 979)		if ((objectOrGroup->flixelType != ( (unsigned char)(1) ))) {
HXDLIN( 979)			_hx_tmp = (objectOrGroup->flixelType == ( (unsigned char)(3) ));
            		}
            		else {
...
HXDLIN(1009)			if ((objectOrGroup->flixelType != ( (unsigned char)(1) ))) {
HXLINE(1009)				_hx_tmp1 = (objectOrGroup->flixelType == ( (unsigned char)(3) ));
            			}
            			else {
...
HXDLIN(1019)		if ((objectOrGroup->flixelType != ( (unsigned char)(1) ))) {
HXDLIN(1019)			_hx_tmp = (objectOrGroup->flixelType == ( (unsigned char)(3) ));
            		}
            		else {
...
HXLINE(1044)			{
HXLINE(1044)				 ::flixel::math::FlxBasePoint _this = worldPoint;
HXDLIN(1044)				 ::flixel::math::FlxBasePoint point = camera->scroll;
HXDLIN(1044)				{
HXLINE(1044)					Float y = point->y;
HXDLIN(1044)					_this->set_x((_this->x - point->x));
HXDLIN(1044)					_this->set_y((_this->y - y));
            				}
HXDLIN(1044)				{
HXLINE(1044)					 ::flixel::math::FlxBasePoint _this1 = point;
HXDLIN(1044)					if (_this1->_weak) {
HXLINE(1044)						_this1->put();
            					}
            				}
            			}
HXLINE(1045)			{
HXLINE(1045)				 ::flixel::math::FlxBasePoint _this2 = worldPoint;
HXDLIN(1045)				if (_this2->_weak) {
HXLINE(1045)					_this2->put();
            				}
            			}
            		}
...
HXDLIN(1068)			_this->_inPool = false;
HXDLIN(1068)			bounds = _this;
            		}
