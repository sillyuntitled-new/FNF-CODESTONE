...
HXDLIN( 126)						_this->y = ( (Float)(0) );
HXDLIN( 126)						_this->width = ( (Float)(newWidth) );
HXDLIN( 126)						_this->height = ( (Float)(newHeight) );
            					}
...
HXLINE( 180)			{
HXLINE( 180)				 ::flixel::math::FlxMatrix _this = this->_matrix;
HXDLIN( 180)				_this->a = ( (Float)(1) );
HXDLIN( 180)				_this->b = ( (Float)(0) );
HXDLIN( 180)				_this->c = ( (Float)(0) );
HXDLIN( 180)				_this->d = ( (Float)(1) );
HXDLIN( 180)				_this->tx = ( (Float)(0) );
HXDLIN( 180)				_this->ty = ( (Float)(0) );
            			}
HXLINE( 181)			{
HXLINE( 181)				 ::flixel::math::FlxMatrix _this1 = this->_matrix;
HXDLIN( 181)				_this1->a = (_this1->a * ScaleX);
HXDLIN( 181)				_this1->b = (_this1->b * ScaleY);
HXDLIN( 181)				_this1->c = (_this1->c * ScaleX);
HXDLIN( 181)				_this1->d = (_this1->d * ScaleY);
HXDLIN( 181)				_this1->tx = (_this1->tx * ScaleX);
HXDLIN( 181)				_this1->ty = (_this1->ty * ScaleY);
            			}
HXLINE( 182)			{
HXLINE( 182)				 ::flixel::math::FlxMatrix _this2 = this->_matrix;
HXDLIN( 182)				_this2->tx = (_this2->tx + FlashPoint->x);
HXDLIN( 182)				_this2->ty = (_this2->ty + FlashPoint->y);
            			}
...
HXLINE( 201)		this->columns = (::Math_obj::ceil(((( (Float)(Camera->width) ) - (Camera->viewMarginX * ( (Float)(2) ))) / (( (Float)(TileWidth) ) * ScaleX))) + 1);
...
HXLINE( 220)		this->rows = (::Math_obj::ceil(((( (Float)(Camera->height) ) - (Camera->viewMarginY * ( (Float)(2) ))) / (( (Float)(TileHeight) ) * ScaleY))) + 1);
