...
HX_LOCAL_STACK_FRAME(_hx_pos_c1d34ebf00445d90_105_boot,"flixel.tile.GraphicAuto","boot",0x23888f97,"flixel.tile.GraphicAuto.boot","flixel/tile/FlxTilemap.hx",105,0x448feb74)
namespace flixel{
namespace tile{
...
HXLINE(  74)		this->_hx___fromImage(::lime::graphics::Image_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::tile::GraphicAuto_obj::resourceName)))));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_c1d34ebf00445d90_105_boot)
HXDLIN( 105)		resourceName = HX_("__ASSET__:bitmap_flixel_tile_GraphicAuto",23,e3,b5,f1);
            	}
}
