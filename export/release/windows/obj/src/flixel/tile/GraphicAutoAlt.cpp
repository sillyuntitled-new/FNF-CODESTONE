...
HX_LOCAL_STACK_FRAME(_hx_pos_a636967d4712257f_108_boot,"flixel.tile.GraphicAutoAlt","boot",0x108b01e0,"flixel.tile.GraphicAutoAlt.boot","flixel/tile/FlxTilemap.hx",108,0x448feb74)
namespace flixel{
namespace tile{
...
HXLINE(  74)		this->_hx___fromImage(::lime::graphics::Image_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::tile::GraphicAutoAlt_obj::resourceName)))));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_a636967d4712257f_108_boot)
HXDLIN( 108)		resourceName = HX_("__ASSET__:bitmap_flixel_tile_GraphicAutoAlt",c6,25,2e,70);
            	}
}
