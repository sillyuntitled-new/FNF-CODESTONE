...
HX_LOCAL_STACK_FRAME(_hx_pos_4cc2402574bdb662_111_boot,"flixel.tile.GraphicAutoFull","boot",0x0e9a6708,"flixel.tile.GraphicAutoFull.boot","flixel/tile/FlxTilemap.hx",111,0x448feb74)
namespace flixel{
namespace tile{
...
HXLINE(  74)		this->_hx___fromImage(::lime::graphics::Image_obj::fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::tile::GraphicAutoFull_obj::resourceName)))));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_4cc2402574bdb662_111_boot)
HXDLIN( 111)		resourceName = HX_("__ASSET__:bitmap_flixel_tile_GraphicAutoFull",52,c6,87,bb);
            	}
}
