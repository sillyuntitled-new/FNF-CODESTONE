...
HX_DEFINE_STACK_FRAME(_hx_pos_f55a54b42a9231a6_10_new,"flixel.tweens.misc.AngleTween","new",0x28853ef8,"flixel.tweens.misc.AngleTween.new","flixel/tweens/misc/AngleTween.hx",10,0x989494f7)
HX_LOCAL_STACK_FRAME(_hx_pos_f55a54b42a9231a6_26_destroy,"flixel.tweens.misc.AngleTween","destroy",0x51eec792,"flixel.tweens.misc.AngleTween.destroy","flixel/tweens/misc/AngleTween.hx",26,0x989494f7)
HX_LOCAL_STACK_FRAME(_hx_pos_f55a54b42a9231a6_39_tween,"flixel.tweens.misc.AngleTween","tween",0xc3ccef03,"flixel.tweens.misc.AngleTween.tween","flixel/tweens/misc/AngleTween.hx",39,0x989494f7)
HX_LOCAL_STACK_FRAME(_hx_pos_f55a54b42a9231a6_53_update,"flixel.tweens.misc.AngleTween","update",0xed654671,"flixel.tweens.misc.AngleTween.update","flixel/tweens/misc/AngleTween.hx",53,0x989494f7)
HX_LOCAL_STACK_FRAME(_hx_pos_f55a54b42a9231a6_66_isTweenOf,"flixel.tweens.misc.AngleTween","isTweenOf",0xa7758e30,"flixel.tweens.misc.AngleTween.isTweenOf","flixel/tweens/misc/AngleTween.hx",66,0x989494f7)
namespace flixel{
namespace tweens{
namespace misc{

void AngleTween_obj::__construct( ::Dynamic Options, ::flixel::tweens::FlxTweenManager manager){
            	HX_STACKFRAME(&_hx_pos_f55a54b42a9231a6_10_new)
HXDLIN(  10)		super::__construct(Options,manager);
            	}
...
void AngleTween_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_f55a54b42a9231a6_26_destroy)
...
HXLINE(  28)		this->sprite = null();
 ...
 ::flixel::tweens::misc::AngleTween AngleTween_obj::tween(Float FromAngle,Float ToAngle,Float Duration, ::flixel::FlxSprite Sprite){
            	HX_STACKFRAME(&_hx_pos_f55a54b42a9231a6_39_tween)
HXLINE(  40)		this->_start = (this->angle = FromAngle);
HXLINE(  41)		this->_range = (ToAngle - this->angle);
HXLINE(  42)		this->duration = Duration;
HXLINE(  43)		this->sprite = Sprite;
HXLINE(  44)		if (::hx::IsNotNull( this->sprite )) {
HXLINE(  46)			this->sprite->set_angle(::hx::Mod(this->angle,360));
            		}
...
void AngleTween_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_f55a54b42a9231a6_53_update)
HXLINE(  54)		this->super::update(elapsed);
HXLINE(  55)		this->angle = (this->_start + (this->_range * this->scale));
HXLINE(  57)		if (::hx::IsNotNull( this->sprite )) {
HXLINE(  60)			this->sprite->set_angle(::hx::Mod(this->angle,360));
            		}
            	}


bool AngleTween_obj::isTweenOf( ::Dynamic object, ::Dynamic field){
            	HX_STACKFRAME(&_hx_pos_f55a54b42a9231a6_66_isTweenOf)
HXDLIN(  66)		if (::hx::IsInstanceEq( this->sprite,object )) {
HXDLIN(  66)			if (::hx::IsNotNull( field )) {
HXDLIN(  66)				return ::hx::IsEq( field,HX_("angle",d3,43,e2,22) );
            			}
            			else {
