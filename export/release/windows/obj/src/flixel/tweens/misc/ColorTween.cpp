...
HX_DEFINE_STACK_FRAME(_hx_pos_81f6578febd56b01_12_new,"flixel.tweens.misc.ColorTween","new",0x82c0df68,"flixel.tweens.misc.ColorTween.new","flixel/tweens/misc/ColorTween.hx",12,0xe14ed287)
HX_LOCAL_STACK_FRAME(_hx_pos_81f6578febd56b01_28_destroy,"flixel.tweens.misc.ColorTween","destroy",0x7f5b6002,"flixel.tweens.misc.ColorTween.destroy","flixel/tweens/misc/ColorTween.hx",28,0xe14ed287)
HX_LOCAL_STACK_FRAME(_hx_pos_81f6578febd56b01_43_tween,"flixel.tweens.misc.ColorTween","tween",0xdc858b73,"flixel.tweens.misc.ColorTween.tween","flixel/tweens/misc/ColorTween.hx",43,0xe14ed287)
HX_LOCAL_STACK_FRAME(_hx_pos_81f6578febd56b01_53_update,"flixel.tweens.misc.ColorTween","update",0x76358c01,"flixel.tweens.misc.ColorTween.update","flixel/tweens/misc/ColorTween.hx",53,0xe14ed287)
HX_LOCAL_STACK_FRAME(_hx_pos_81f6578febd56b01_66_isTweenOf,"flixel.tweens.misc.ColorTween","isTweenOf",0x7b8d22a0,"flixel.tweens.misc.ColorTween.isTweenOf","flixel/tweens/misc/ColorTween.hx",66,0xe14ed287)
namespace flixel{
namespace tweens{
namespace misc{

void ColorTween_obj::__construct( ::Dynamic Options, ::flixel::tweens::FlxTweenManager manager){
            	HX_STACKFRAME(&_hx_pos_81f6578febd56b01_12_new)
HXDLIN(  12)		super::__construct(Options,manager);
            	}
...
void ColorTween_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_81f6578febd56b01_28_destroy)
HXLINE(  29)		this->super::destroy();
HXLINE(  30)		this->sprite = null();
            	}


 ::flixel::tweens::misc::ColorTween ColorTween_obj::tween(Float Duration,int FromColor,int ToColor, ::flixel::FlxSprite Sprite){
            	HX_STACKFRAME(&_hx_pos_81f6578febd56b01_43_tween)
HXLINE(  44)		this->color = (this->startColor = FromColor);
HXLINE(  45)		this->endColor = ToColor;
HXLINE(  46)		this->duration = Duration;
HXLINE(  47)		this->sprite = Sprite;
HXLINE(  48)		this->start();
...
void ColorTween_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_81f6578febd56b01_53_update)
HXLINE(  54)		this->super::update(elapsed);
HXLINE(  55)		int Color1 = this->startColor;
HXDLIN(  55)		int Color2 = this->endColor;
HXDLIN(  55)		Float Factor = this->scale;
HXDLIN(  55)		int r = ::Std_obj::_hx_int(((( (Float)((((Color2 >> 16) & 255) - ((Color1 >> 16) & 255))) ) * Factor) + ((Color1 >> 16) & 255)));
HXDLIN(  55)		int g = ::Std_obj::_hx_int(((( (Float)((((Color2 >> 8) & 255) - ((Color1 >> 8) & 255))) ) * Factor) + ((Color1 >> 8) & 255)));
HXDLIN(  55)		int b = ::Std_obj::_hx_int(((( (Float)(((Color2 & 255) - (Color1 & 255))) ) * Factor) + (Color1 & 255)));
HXDLIN(  55)		int a = ::Std_obj::_hx_int(((( (Float)((((Color2 >> 24) & 255) - ((Color1 >> 24) & 255))) ) * Factor) + ((Color1 >> 24) & 255)));
HXDLIN(  55)		int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN(  55)		int v = r;
HXDLIN(  55)		int color1 = (((((v) > 0xff) ? 0xff : ((v) < 0) ? 0 : (v)) & 255) << 16);
HXDLIN(  55)		int v1 = g;
HXDLIN(  55)		int color2 = (color1 | (((((v1) > 0xff) ? 0xff : ((v1) < 0) ? 0 : (v1)) & 255) << 8));
HXDLIN(  55)		int v2 = b;
HXDLIN(  55)		int color3 = (color2 | ((((v2) > 0xff) ? 0xff : ((v2) < 0) ? 0 : (v2)) & 255));
HXDLIN(  55)		int v3 = a;
HXDLIN(  55)		color = (color3 | (((((v3) > 0xff) ? 0xff : ((v3) < 0) ? 0 : (v3)) & 255) << 24));
HXDLIN(  55)		this->color = color;
HXLINE(  57)		if (::hx::IsNotNull( this->sprite )) {
HXLINE(  59)			this->sprite->set_color(this->color);
HXLINE(  60)			this->sprite->set_alpha((( (Float)(((this->color >> 24) & 255)) ) / ( (Float)(255) )));
            		}
            	}


bool ColorTween_obj::isTweenOf( ::Dynamic object, ::Dynamic field){
            	HX_STACKFRAME(&_hx_pos_81f6578febd56b01_66_isTweenOf)
HXDLIN(  66)		if (::hx::IsInstanceEq( this->sprite,object )) {
HXDLIN(  66)			if (::hx::IsNotNull( field )) {
HXDLIN(  66)				return ::hx::IsEq( field,HX_("color",63,71,5c,4a) );
            			}
            			else {
