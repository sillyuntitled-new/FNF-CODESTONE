...
HX_DEFINE_STACK_FRAME(_hx_pos_5f32b179d409136f_11_new,"flixel.tweens.misc.ShakeTween","new",0x2ad72da5,"flixel.tweens.misc.ShakeTween.new","flixel/tweens/misc/ShakeTween.hx",11,0x301fdaea)
HX_LOCAL_STACK_FRAME(_hx_pos_5f32b179d409136f_43_tween,"flixel.tweens.misc.ShakeTween","tween",0x7179a2f0,"flixel.tweens.misc.ShakeTween.tween","flixel/tweens/misc/ShakeTween.hx",43,0x301fdaea)
HX_LOCAL_STACK_FRAME(_hx_pos_5f32b179d409136f_54_destroy,"flixel.tweens.misc.ShakeTween","destroy",0x4b2210bf,"flixel.tweens.misc.ShakeTween.destroy","flixel/tweens/misc/ShakeTween.hx",54,0x301fdaea)
HX_LOCAL_STACK_FRAME(_hx_pos_5f32b179d409136f_65_update,"flixel.tweens.misc.ShakeTween","update",0x36d601e4,"flixel.tweens.misc.ShakeTween.update","flixel/tweens/misc/ShakeTween.hx",65,0x301fdaea)
HX_LOCAL_STACK_FRAME(_hx_pos_5f32b179d409136f_75_isTweenOf,"flixel.tweens.misc.ShakeTween","isTweenOf",0xcaef3c9d,"flixel.tweens.misc.ShakeTween.isTweenOf","flixel/tweens/misc/ShakeTween.hx",75,0x301fdaea)
namespace flixel{
namespace tweens{
namespace misc{

void ShakeTween_obj::__construct( ::Dynamic Options, ::flixel::tweens::FlxTweenManager manager){
            	HX_STACKFRAME(&_hx_pos_5f32b179d409136f_11_new)
...
bool ShakeTween_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::tweens::misc::ShakeTween ShakeTween_obj::tween( ::flixel::FlxSprite Sprite,::hx::Null< Float >  __o_Intensity,::hx::Null< Float >  __o_Duration,::hx::Null< int >  __o_Axes){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_5f32b179d409136f_43_tween)
HXLINE(  44)		this->intensity = Intensity;
HXLINE(  45)		this->sprite = Sprite;
HXLINE(  46)		this->duration = Duration;
HXLINE(  47)		this->axes = Axes;
HXLINE(  48)		this->initialOffset =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,Sprite->offset->x,Sprite->offset->y);
HXLINE(  49)		this->start();
...
void ShakeTween_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_5f32b179d409136f_54_destroy)
HXLINE(  55)		this->super::destroy();
HXLINE(  57)		bool _hx_tmp;
HXDLIN(  57)		if (::hx::IsNotNull( this->sprite )) {
HXLINE(  57)			 ::flixel::math::FlxBasePoint _this = this->sprite->offset;
HXDLIN(  57)			 ::flixel::math::FlxBasePoint point = this->initialOffset;
HXDLIN(  57)			bool result;
HXDLIN(  57)			if ((::Math_obj::abs((_this->x - point->x)) <= ((Float)0.0000001))) {
HXLINE(  57)				result = (::Math_obj::abs((_this->y - point->y)) <= ((Float)0.0000001));
            			}
            			else {
HXLINE(  57)				result = false;
            			}
HXDLIN(  57)			if (point->_weak) {
HXLINE(  57)				point->put();
            			}
HXDLIN(  57)			_hx_tmp = !(result);
            		}
            		else {
HXLINE(  57)			_hx_tmp = false;
            		}
HXDLIN(  57)		if (_hx_tmp) {
HXLINE(  58)			 ::flixel::math::FlxBasePoint this1 = this->sprite->offset;
HXDLIN(  58)			Float y = this->initialOffset->y;
HXDLIN(  58)			this1->set_x(this->initialOffset->x);
HXDLIN(  58)			this1->set_y(y);
            		}
HXLINE(  60)		this->sprite = null();
HXLINE(  61)		this->initialOffset = null();
            	}


void ShakeTween_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_5f32b179d409136f_65_update)
HXLINE(  66)		this->super::update(elapsed);
HXLINE(  67)		int this1 = this->axes;
HXDLIN(  67)		bool _hx_tmp;
HXDLIN(  67)		if ((this1 != 1)) {
HXLINE(  67)			_hx_tmp = (this1 == 17);
            		}
            		else {
HXLINE(  67)			_hx_tmp = true;
            		}
HXDLIN(  67)		if (_hx_tmp) {
HXLINE(  68)			 ::flixel::math::FlxBasePoint this2 = this->sprite->offset;
HXDLIN(  68)			Float x = this->initialOffset->x;
HXDLIN(  68)			 ::flixel::math::FlxRandom x1 = ::flixel::FlxG_obj::random;
HXDLIN(  68)			Float x2 = -(this->intensity);
HXDLIN(  68)			Float x3 = (x2 * this->sprite->get_width());
HXDLIN(  68)			Float x4 = this->intensity;
HXDLIN(  68)			this2->set_x((x + x1->_hx_float(x3,(x4 * this->sprite->get_width()),null())));
            		}
HXLINE(  69)		int this3 = this->axes;
HXDLIN(  69)		bool _hx_tmp1;
HXDLIN(  69)		if ((this3 != 16)) {
HXLINE(  69)			_hx_tmp1 = (this3 == 17);
            		}
            		else {
HXLINE(  69)			_hx_tmp1 = true;
            		}
HXDLIN(  69)		if (_hx_tmp1) {
HXLINE(  70)			 ::flixel::math::FlxBasePoint this4 = this->sprite->offset;
HXDLIN(  70)			Float y = this->initialOffset->y;
HXDLIN(  70)			 ::flixel::math::FlxRandom y1 = ::flixel::FlxG_obj::random;
HXDLIN(  70)			Float y2 = -(this->intensity);
HXDLIN(  70)			Float y3 = (y2 * this->sprite->get_height());
HXDLIN(  70)			Float y4 = this->intensity;
HXDLIN(  70)			this4->set_y((y + y1->_hx_float(y3,(y4 * this->sprite->get_height()),null())));
            		}
            	}


bool ShakeTween_obj::isTweenOf( ::Dynamic Object, ::Dynamic Field){
            	HX_STACKFRAME(&_hx_pos_5f32b179d409136f_75_isTweenOf)
HXDLIN(  75)		if (::hx::IsInstanceEq( this->sprite,Object )) {
HXDLIN(  75)			if (::hx::IsNotNull( Field )) {
HXDLIN(  75)				return ::hx::IsEq( Field,HX_("shake",c6,de,1c,7c) );
            			}
            			else {
