...
HXLINE(  82)			this->distance = (this->distance + ::Math_obj::sqrt((((x - this->_last->x) * (x - this->_last->x)) + ((y - this->_last->y) * (y - this->_last->y)))));
...
HXDLIN(  85)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y);
...
HXLINE( 123)						this->_index = (this->_index - 1);
...
HXLINE( 143)					this->_index = (this->_index - 1);
HXLINE( 144)					if ((this->_index == 0)) {
HXLINE( 146)						this->_index = (this->_index + 1);
