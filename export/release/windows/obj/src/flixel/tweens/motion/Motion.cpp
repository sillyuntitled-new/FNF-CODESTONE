...
HX_DEFINE_STACK_FRAME(_hx_pos_3615c645ab6bc3d8_10_new,"flixel.tweens.motion.Motion","new",0x8c813b8c,"flixel.tweens.motion.Motion.new","flixel/tweens/motion/Motion.hx",10,0xc6c8a363)
HX_LOCAL_STACK_FRAME(_hx_pos_3615c645ab6bc3d8_26_destroy,"flixel.tweens.motion.Motion","destroy",0x00e69e26,"flixel.tweens.motion.Motion.destroy","flixel/tweens/motion/Motion.hx",26,0xc6c8a363)
HX_LOCAL_STACK_FRAME(_hx_pos_3615c645ab6bc3d8_32_setObject,"flixel.tweens.motion.Motion","setObject",0x7f27082d,"flixel.tweens.motion.Motion.setObject","flixel/tweens/motion/Motion.hx",32,0xc6c8a363)
HX_LOCAL_STACK_FRAME(_hx_pos_3615c645ab6bc3d8_40_update,"flixel.tweens.motion.Motion","update",0xebe25e5d,"flixel.tweens.motion.Motion.update","flixel/tweens/motion/Motion.hx",40,0xc6c8a363)
HX_LOCAL_STACK_FRAME(_hx_pos_3615c645ab6bc3d8_46_onEnd,"flixel.tweens.motion.Motion","onEnd",0x35242628,"flixel.tweens.motion.Motion.onEnd","flixel/tweens/motion/Motion.hx",46,0xc6c8a363)
HX_LOCAL_STACK_FRAME(_hx_pos_3615c645ab6bc3d8_53_postUpdate,"flixel.tweens.motion.Motion","postUpdate",0xca0f98dd,"flixel.tweens.motion.Motion.postUpdate","flixel/tweens/motion/Motion.hx",53,0xc6c8a363)
HX_LOCAL_STACK_FRAME(_hx_pos_3615c645ab6bc3d8_61_isTweenOf,"flixel.tweens.motion.Motion","isTweenOf",0xe4ff31c4,"flixel.tweens.motion.Motion.isTweenOf","flixel/tweens/motion/Motion.hx",61,0xc6c8a363)
namespace flixel{
namespace tweens{
namespace motion{

void Motion_obj::__construct( ::Dynamic Options, ::flixel::tweens::FlxTweenManager manager){
            	HX_STACKFRAME(&_hx_pos_3615c645ab6bc3d8_10_new)
HXLINE(  20)		this->y = ((Float)0);
HXLINE(  15)		this->x = ((Float)0);
HXLINE(  10)		super::__construct(Options,manager);
            	}
...
void Motion_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_3615c645ab6bc3d8_26_destroy)
HXLINE(  27)		this->super::destroy();
HXLINE(  28)		this->_object = null();
            	}


 ::flixel::tweens::motion::Motion Motion_obj::setObject( ::flixel::FlxObject object){
            	HX_STACKFRAME(&_hx_pos_3615c645ab6bc3d8_32_setObject)
HXLINE(  33)		this->_object = object;
HXLINE(  34)		this->_wasObjectImmovable = this->_object->immovable;
HXLINE(  35)		this->_object->set_immovable(true);
...
void Motion_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3615c645ab6bc3d8_40_update)
HXLINE(  41)		this->super::update(elapsed);
HXLINE(  42)		this->postUpdate();
            	}


void Motion_obj::onEnd(){
            	HX_STACKFRAME(&_hx_pos_3615c645ab6bc3d8_46_onEnd)
HXLINE(  47)		this->_object->set_immovable(this->_wasObjectImmovable);
HXLINE(  48)		this->super::onEnd();
            	}


void Motion_obj::postUpdate(){
            	HX_STACKFRAME(&_hx_pos_3615c645ab6bc3d8_53_postUpdate)
HXDLIN(  53)		if (::hx::IsNotNull( this->_object )) {
HXLINE(  55)			this->_object->setPosition(this->x,this->y);
            		}
            	}
...
bool Motion_obj::isTweenOf( ::Dynamic object, ::Dynamic field){
            	HX_STACKFRAME(&_hx_pos_3615c645ab6bc3d8_61_isTweenOf)
HXDLIN(  61)		if (::hx::IsInstanceEq( this->_object,object )) {
HXDLIN(  61)			bool _hx_tmp;
HXDLIN(  61)			if (::hx::IsNotNull( field )) {
HXDLIN(  61)				_hx_tmp = ::hx::IsEq( field,HX_("x",78,00,00,00) );
            			}
            			else {
HXDLIN(  61)				_hx_tmp = true;
            			}
HXDLIN(  61)			if (!(_hx_tmp)) {
HXDLIN(  61)				return ::hx::IsEq( field,HX_("y",79,00,00,00) );
            			}
            			else {
HXDLIN(  61)				return true;
            			}
            		}
            		else {
