...
HXLINE(  77)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  77)		point->_inPool = false;
HXLINE(  78)		 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  78)		point1->_inPool = false;
HXLINE(  79)		point->set_x(((this->x - (( (Float)(2) ) * this->_controlX)) + this->_toX));
HXLINE(  80)		point->set_y(((this->y - (( (Float)(2) ) * this->_controlY)) + this->_toY));
HXLINE(  81)		point1->set_x(((( (Float)(2) ) * this->_controlX) - (( (Float)(2) ) * this->x)));
HXLINE(  82)		point1->set_y(((( (Float)(2) ) * this->_controlY) - (( (Float)(2) ) * this->y)));
HXLINE(  83)		Float a = (( (Float)(4) ) * ((point->x * point->x) + (point->y * point->y)));
HXDLIN(  83)		Float b = (( (Float)(4) ) * ((point->x * point1->x) + (point->y * point1->y)));
HXDLIN(  83)		Float c = ((point1->x * point1->x) + (point1->y * point1->y));
