...
HXDLIN(  44)				_g = (_g + 1);
HXLINE(  46)				::flixel::util::FlxDestroyUtil_obj::put(point);
            			}
            		}
...
HXDLIN(  84)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y);
...
HXLINE( 185)			i = (i + 1);
HXDLIN( 185)			this->_distance = (this->_distance + this->_curveD->__get((i - 1)));
            		}
HXLINE( 189)		i = 0;
...
HXLINE( 202)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 202)		point->_inPool = false;
HXLINE( 203)		 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 203)		point1->_inPool = false;
HXLINE( 205)		point->set_x(((start->x - (( (Float)(2) ) * control->x)) + finish->x));
HXLINE( 206)		point->set_y(((start->y - (( (Float)(2) ) * control->y)) + finish->y));
HXLINE( 207)		point1->set_x(((( (Float)(2) ) * control->x) - (( (Float)(2) ) * start->x)));
HXLINE( 208)		point1->set_y(((( (Float)(2) ) * control->y) - (( (Float)(2) ) * start->y)));
HXLINE( 209)		Float a = (( (Float)(4) ) * ((point->x * point->x) + (point->y * point->y)));
HXDLIN( 209)		Float b = (( (Float)(4) ) * ((point->x * point1->x) + (point->y * point1->y)));
HXDLIN( 209)		Float c = ((point1->x * point1->x) + (point1->y * point1->y));
