...
HX_DEFINE_STACK_FRAME(_hx_pos_e5cfc49bbef462de_653_new,"flixel.ui.FlxButtonEvent","new",0x4e7cabd0,"flixel.ui.FlxButtonEvent.new","flixel/ui/FlxButton.hx",653,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_e5cfc49bbef462de_665_destroy,"flixel.ui.FlxButtonEvent","destroy",0xe499806a,"flixel.ui.FlxButtonEvent.destroy","flixel/ui/FlxButton.hx",665,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_e5cfc49bbef462de_677_fire,"flixel.ui.FlxButtonEvent","fire",0x5952fa46,"flixel.ui.FlxButtonEvent.fire","flixel/ui/FlxButton.hx",677,0xc64cf442)
namespace flixel{
namespace ui{

void FlxButtonEvent_obj::__construct( ::Dynamic Callback, ::flixel::sound::FlxSound sound){
            	HX_STACKFRAME(&_hx_pos_e5cfc49bbef462de_653_new)
...
static ::flixel::util::IFlxDestroyable_obj _hx_flixel_ui_FlxButtonEvent__hx_flixel_util_IFlxDestroyable= {
	( void (::hx::Object::*)())&::flixel::ui::FlxButtonEvent_obj::destroy,
};

void *FlxButtonEvent_obj::_hx_getInterface(int inHash) {
	switch(inHash) {
		case (int)0xd4fe2fcd: return &_hx_flixel_ui_FlxButtonEvent__hx_flixel_util_IFlxDestroyable;
	}
...
void FlxButtonEvent_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_e5cfc49bbef462de_665_destroy)
...
void FlxButtonEvent_obj::fire(){
            	HX_STACKFRAME(&_hx_pos_e5cfc49bbef462de_677_fire)
...
::hx::ObjectPtr< FlxButtonEvent_obj > FlxButtonEvent_obj::__alloc(::hx::Ctx *_hx_ctx, ::Dynamic Callback, ::flixel::sound::FlxSound sound) {
	FlxButtonEvent_obj *__this = (FlxButtonEvent_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(FlxButtonEvent_obj), true, "flixel.ui.FlxButtonEvent"));
...
void FlxButtonEvent_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.ui.FlxButtonEvent",de,c3,ae,4a);
