...
static ::hx::StorageInfo FlxTypedButton_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::ui::FlxButtonEvent */ ,(int)offsetof(FlxTypedButton_obj,onUp),HX_("onUp",5a,71,b2,49)},
	{::hx::fsObject /*  ::flixel::ui::FlxButtonEvent */ ,(int)offsetof(FlxTypedButton_obj,onDown),HX_("onDown",21,01,f8,e4)},
	{::hx::fsObject /*  ::flixel::ui::FlxButtonEvent */ ,(int)offsetof(FlxTypedButton_obj,onOver),HX_("onOver",13,9a,42,ec)},
	{::hx::fsObject /*  ::flixel::ui::FlxButtonEvent */ ,(int)offsetof(FlxTypedButton_obj,onOut),HX_("onOut",af,34,6c,32)},
