...
HX_DEFINE_STACK_FRAME(_hx_pos_751aaa182788f00b_100_new,"flixel.util.FlxBaseSignal","new",0xbb277323,"flixel.util.FlxBaseSignal.new","flixel/util/FlxSignal.hx",100,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_751aaa182788f00b_119_add,"flixel.util.FlxBaseSignal","add",0xbb1d94e4,"flixel.util.FlxBaseSignal.add","flixel/util/FlxSignal.hx",119,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_751aaa182788f00b_125_addOnce,"flixel.util.FlxBaseSignal","addOnce",0xd75f8085,"flixel.util.FlxBaseSignal.addOnce","flixel/util/FlxSignal.hx",125,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_751aaa182788f00b_131_remove,"flixel.util.FlxBaseSignal","remove",0x250ad561,"flixel.util.FlxBaseSignal.remove","flixel/util/FlxSignal.hx",131,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_751aaa182788f00b_143_removeHandler,"flixel.util.FlxBaseSignal","removeHandler",0xa86de069,"flixel.util.FlxBaseSignal.removeHandler","flixel/util/FlxSignal.hx",143,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_751aaa182788f00b_153_has,"flixel.util.FlxBaseSignal","has",0xbb22e21d,"flixel.util.FlxBaseSignal.has","flixel/util/FlxSignal.hx",153,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_751aaa182788f00b_161_removeAll,"flixel.util.FlxBaseSignal","removeAll",0x27f7ae40,"flixel.util.FlxBaseSignal.removeAll","flixel/util/FlxSignal.hx",161,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_751aaa182788f00b_165_destroy,"flixel.util.FlxBaseSignal","destroy",0x75f5ed3d,"flixel.util.FlxBaseSignal.destroy","flixel/util/FlxSignal.hx",165,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_751aaa182788f00b_172_registerListener,"flixel.util.FlxBaseSignal","registerListener",0xed0a9d54,"flixel.util.FlxBaseSignal.registerListener","flixel/util/FlxSignal.hx",172,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_751aaa182788f00b_193_getHandler,"flixel.util.FlxBaseSignal","getHandler",0xa868c171,"flixel.util.FlxBaseSignal.getHandler","flixel/util/FlxSignal.hx",193,0x3c758c5e)
namespace flixel{
namespace util{

void FlxBaseSignal_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_751aaa182788f00b_100_new)
...
bool FlxBaseSignal_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x62f5da6d;
}

static ::flixel::util::IFlxSignal_obj _hx_flixel_util_FlxBaseSignal__hx_flixel_util_IFlxSignal= {
	( void (::hx::Object::*)())&::flixel::util::FlxBaseSignal_obj::destroy,
	( void (::hx::Object::*)( ::Dynamic))&::flixel::util::FlxBaseSignal_obj::add,
	( void (::hx::Object::*)( ::Dynamic))&::flixel::util::FlxBaseSignal_obj::addOnce,
	( void (::hx::Object::*)( ::Dynamic))&::flixel::util::FlxBaseSignal_obj::remove,
	( void (::hx::Object::*)())&::flixel::util::FlxBaseSignal_obj::removeAll,
	( bool (::hx::Object::*)( ::Dynamic))&::flixel::util::FlxBaseSignal_obj::has,
};

static ::flixel::util::IFlxDestroyable_obj _hx_flixel_util_FlxBaseSignal__hx_flixel_util_IFlxDestroyable= {
	( void (::hx::Object::*)())&::flixel::util::FlxBaseSignal_obj::destroy,
};

void *FlxBaseSignal_obj::_hx_getInterface(int inHash) {
	switch(inHash) {
		case (int)0x540588cf: return &_hx_flixel_util_FlxBaseSignal__hx_flixel_util_IFlxSignal;
		case (int)0xd4fe2fcd: return &_hx_flixel_util_FlxBaseSignal__hx_flixel_util_IFlxDestroyable;
	}
...
void FlxBaseSignal_obj::add( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_751aaa182788f00b_119_add)
...
void FlxBaseSignal_obj::addOnce( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_751aaa182788f00b_125_addOnce)
...
void FlxBaseSignal_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_751aaa182788f00b_131_remove)
HXDLIN( 131)		if (::hx::IsNotNull( listener )) {
HXLINE( 133)			 ::flixel::util::FlxSignalHandler handler = this->getHandler(listener);
...
void FlxBaseSignal_obj::removeHandler( ::flixel::util::FlxSignalHandler handler){
            	HX_STACKFRAME(&_hx_pos_751aaa182788f00b_143_removeHandler)
...
bool FlxBaseSignal_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_751aaa182788f00b_153_has)
...
void FlxBaseSignal_obj::removeAll(){
            	HX_STACKFRAME(&_hx_pos_751aaa182788f00b_161_removeAll)
...
void FlxBaseSignal_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_751aaa182788f00b_165_destroy)
...
HX_DEFINE_DYNAMIC_FUNC0(FlxBaseSignal_obj,destroy,(void))
 ...
 ::flixel::util::FlxSignalHandler FlxBaseSignal_obj::registerListener( ::Dynamic listener,bool dispatchOnce){
            	HX_GC_STACKFRAME(&_hx_pos_751aaa182788f00b_172_registerListener)
HXLINE( 173)		 ::flixel::util::FlxSignalHandler handler = this->getHandler(listener);
HXLINE( 175)		if (::hx::IsNull( handler )) {
HXLINE( 177)			handler =  ::flixel::util::FlxSignalHandler_obj::__alloc( HX_CTX ,listener,dispatchOnce);
...
HX_DEFINE_DYNAMIC_FUNC2(FlxBaseSignal_obj,registerListener,return )
 ...
 ::flixel::util::FlxSignalHandler FlxBaseSignal_obj::getHandler( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_751aaa182788f00b_193_getHandler)
HXLINE( 194)		{
HXLINE( 194)			int _g = 0;
HXDLIN( 194)			::Array< ::Dynamic> _g1 = this->handlers;
HXDLIN( 194)			while((_g < _g1->length)){
HXLINE( 194)				 ::flixel::util::FlxSignalHandler handler = _g1->__get(_g).StaticCast<  ::flixel::util::FlxSignalHandler >();
HXDLIN( 194)				_g = (_g + 1);
...
::hx::ObjectPtr< FlxBaseSignal_obj > FlxBaseSignal_obj::__alloc(::hx::Ctx *_hx_ctx) {
	FlxBaseSignal_obj *__this = (FlxBaseSignal_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(FlxBaseSignal_obj), true, "flixel.util.FlxBaseSignal"));
...
void FlxBaseSignal_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.util.FlxBaseSignal",b1,a5,c8,90);
