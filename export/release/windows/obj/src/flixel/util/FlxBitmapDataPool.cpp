...
int FlxBitmapDataPool_obj::length;
 ...
 ::flixel::util::FlxBitmapDataPoolNode FlxBitmapDataPool_obj::_head;

 ::flixel::util::FlxBitmapDataPoolNode FlxBitmapDataPool_obj::_tail;
...
HXLINE(  45)		 ::flixel::util::FlxBitmapDataPoolNode node = ::flixel::util::FlxBitmapDataPool_obj::_head;
...
HXLINE(  96)			 ::flixel::util::FlxBitmapDataPoolNode last = ::flixel::util::FlxBitmapDataPool_obj::_tail;
...
HXLINE( 107)		 ::flixel::util::FlxBitmapDataPoolNode node =  ::flixel::util::FlxBitmapDataPoolNode_obj::__alloc( HX_CTX ,bmd,null(),null());
...
HXLINE( 126)		 ::flixel::util::FlxBitmapDataPoolNode node = ::flixel::util::FlxBitmapDataPool_obj::_head;
HXLINE( 127)		while(::hx::IsNotNull( node )){
HXLINE( 130)			node->bmd->dispose();
...
HXLINE( 142)			 ::flixel::util::FlxBitmapDataPoolNode node = ::flixel::util::FlxBitmapDataPool_obj::_tail;
...
bool FlxBitmapDataPool_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"_head") ) { _head=ioValue.Cast<  ::flixel::util::FlxBitmapDataPoolNode >(); return true; }
		if (HX_FIELD_EQ(inName,"_tail") ) { _tail=ioValue.Cast<  ::flixel::util::FlxBitmapDataPoolNode >(); return true; }
...
static ::hx::StaticInfo FlxBitmapDataPool_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::util::FlxBitmapDataPoolNode */ ,(void *) &FlxBitmapDataPool_obj::_head,HX_("_head",ff,44,1c,f8)},
	{::hx::fsObject /*  ::flixel::util::FlxBitmapDataPoolNode */ ,(void *) &FlxBitmapDataPool_obj::_tail,HX_("_tail",6f,d2,07,00)},
