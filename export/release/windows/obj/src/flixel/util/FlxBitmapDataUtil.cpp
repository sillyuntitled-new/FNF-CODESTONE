...
HXDLIN( 142)						int v = resultRed;
HXDLIN( 142)						int color1 = (((((v) > 0xff) ? 0xff : ((v) < 0) ? 0 : (v)) & 255) << 16);
HXDLIN( 142)						int v1 = resultGreen;
HXDLIN( 142)						int color2 = (color1 | (((((v1) > 0xff) ? 0xff : ((v1) < 0) ? 0 : (v1)) & 255) << 8));
HXDLIN( 142)						int v2 = resultBlue;
HXDLIN( 142)						int color3 = (color2 | ((((v2) > 0xff) ? 0xff : ((v2) < 0) ? 0 : (v2)) & 255));
HXDLIN( 142)						int v3 = resultAlpha;
HXDLIN( 142)						color = (color3 | (((((v3) > 0xff) ? 0xff : ((v3) < 0) ? 0 : (v3)) & 255) << 24));
...
HXLINE( 206)										int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 206)										int diff = (((pixel1 >> 16) & 255) - ((pixel2 >> 16) & 255));
HXDLIN( 206)										int v;
HXDLIN( 206)										if ((diff >= 0)) {
HXLINE( 206)											v = diff;
            										}
            										else {
HXLINE( 206)											v = (256 + diff);
            										}
HXDLIN( 206)										int color1 = (((((v) > 0xff) ? 0xff : ((v) < 0) ? 0 : (v)) & 255) << 16);
...
HXLINE( 206)											v1 = (256 + diff1);
            										}
HXDLIN( 206)										int color2 = (color1 | (((((v1) > 0xff) ? 0xff : ((v1) < 0) ? 0 : (v1)) & 255) << 8));
...
HXLINE( 206)											v2 = (256 + diff2);
            										}
HXDLIN( 206)										int color3 = (color2 | ((((v2) > 0xff) ? 0xff : ((v2) < 0) ? 0 : (v2)) & 255));
HXDLIN( 206)										int v3 = 255;
HXDLIN( 206)										color = (color3 | (((((v3) > 0xff) ? 0xff : ((v3) < 0) ? 0 : (v3)) & 255) << 24));
...
HXLINE( 215)											int color4 = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 215)											int v4 = 255;
HXDLIN( 215)											int color5 = (((((v4) > 0xff) ? 0xff : ((v4) < 0) ? 0 : (v4)) & 255) << 16);
HXDLIN( 215)											int v5 = 255;
HXDLIN( 215)											int color6 = (color5 | (((((v5) > 0xff) ? 0xff : ((v5) < 0) ? 0 : (v5)) & 255) << 8));
HXDLIN( 215)											int v6 = 255;
HXDLIN( 215)											int color7 = (color6 | ((((v6) > 0xff) ? 0xff : ((v6) < 0) ? 0 : (v6)) & 255));
HXDLIN( 215)											int diff3 = (alpha1 - alpha2);
HXDLIN( 215)											int v7;
HXDLIN( 215)											if ((diff3 >= 0)) {
HXLINE( 215)												v7 = diff3;
            											}
            											else {
HXLINE( 215)												v7 = (256 + diff3);
            											}
HXDLIN( 215)											color4 = (color7 | (((((v7) > 0xff) ? 0xff : ((v7) < 0) ? 0 : (v7)) & 255) << 24));
HXDLIN( 215)											result->setPixel32(i,j,color4);
            										}
            									}
            								}
            							}
...
HXLINE( 300)						 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y);
...
HXDLIN( 330)			_this->_inPool = false;
HXDLIN( 330)			region = _this;
            		}
...
HXLINE( 371)		{
HXLINE( 371)			int _g = 0;
HXDLIN( 371)			while((_g < numHorizontalFrames)){
HXLINE( 371)				_g = (_g + 1);
...
HXDLIN( 376)					while((_g1 < numVerticalFrames)){
...
HXLINE( 414)		{
HXLINE( 414)			int _g = 0;
HXDLIN( 414)			while((_g < horizontalFrames)){
HXLINE( 414)				_g = (_g + 1);
HXLINE( 416)				tempRect->x = ( (Float)((((_g - 1) * ((frameWidth + (2 * borderX)) + spaceX)) + borderX)) );
HXLINE( 418)				{
HXLINE( 418)					int _g1 = 0;
HXDLIN( 418)					while((_g1 < borderX)){
HXLINE( 418)						_g1 = (_g1 + 1);
HXLINE( 420)						tempPoint->x = ((tempRect->x - ( (Float)((_g1 - 1)) )) - ( (Float)(1) ));
HXLINE( 421)						bitmapData->copyPixels(bitmapData,tempRect,tempPoint,null(),null(),null());
            					}
            				}
HXLINE( 424)				tempRect->x = (tempRect->x + (frameWidth - 1));
HXLINE( 426)				{
HXLINE( 426)					int _g2 = 0;
HXDLIN( 426)					while((_g2 < borderX)){
HXLINE( 426)						_g2 = (_g2 + 1);
HXLINE( 428)						tempPoint->x = ((tempRect->x + (_g2 - 1)) + 1);
...
HXLINE( 434)		{
HXLINE( 434)			tempRect->x = ( (Float)(0) );
HXDLIN( 434)			tempRect->y = ( (Float)(0) );
HXDLIN( 434)			tempRect->width = ( (Float)(bitmapData->width) );
HXDLIN( 434)			tempRect->height = ( (Float)(1) );
            		}
HXLINE( 435)		{
HXLINE( 435)			int _g3 = 0;
HXDLIN( 435)			while((_g3 < verticalFrames)){
HXLINE( 435)				_g3 = (_g3 + 1);
HXLINE( 437)				tempRect->y = ( (Float)((((_g3 - 1) * ((frameHeight + (2 * borderY)) + spaceY)) + borderY)) );
HXLINE( 439)				{
HXLINE( 439)					int _g4 = 0;
HXDLIN( 439)					while((_g4 < borderY)){
HXLINE( 439)						_g4 = (_g4 + 1);
HXLINE( 441)						tempPoint->y = ((tempRect->y - ( (Float)((_g4 - 1)) )) - ( (Float)(1) ));
HXLINE( 442)						bitmapData->copyPixels(bitmapData,tempRect,tempPoint,null(),null(),null());
            					}
            				}
HXLINE( 445)				tempRect->y = (tempRect->y + (frameHeight - 1));
HXLINE( 447)				{
HXLINE( 447)					int _g5 = 0;
HXDLIN( 447)					while((_g5 < borderY)){
HXLINE( 447)						_g5 = (_g5 + 1);
HXLINE( 449)						tempPoint->y = ((tempRect->y + (_g5 - 1)) + 1);
...
HXLINE( 481)		 ::openfl::display::BitmapData result =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(max * columns),(max * rows),true,0);
...
HXLINE( 496)				{
HXLINE( 496)					 ::flixel::math::FlxMatrix _this = ::flixel::util::FlxBitmapDataUtil_obj::matrix;
HXDLIN( 496)					_this->a = ( (Float)(1) );
HXDLIN( 496)					_this->b = ( (Float)(0) );
HXDLIN( 496)					_this->c = ( (Float)(0) );
HXDLIN( 496)					_this->d = ( (Float)(1) );
HXDLIN( 496)					_this->tx = ( (Float)(0) );
HXDLIN( 496)					_this->ty = ( (Float)(0) );
            				}
HXLINE( 497)				{
HXLINE( 497)					 ::flixel::math::FlxMatrix _this1 = ::flixel::util::FlxBitmapDataUtil_obj::matrix;
HXDLIN( 497)					_this1->tx = (_this1->tx + -(halfBrushWidth));
HXDLIN( 497)					_this1->ty = (_this1->ty + -(halfBrushHeight));
            				}
HXLINE( 498)				::flixel::util::FlxBitmapDataUtil_obj::matrix->rotate((bakedAngle * ((Float)0.017453292519943295)));
HXLINE( 499)				{
HXLINE( 499)					 ::flixel::math::FlxMatrix _this2 = ::flixel::util::FlxBitmapDataUtil_obj::matrix;
HXDLIN( 499)					_this2->tx = (_this2->tx + ((max * column) + midpointX));
HXDLIN( 499)					_this2->ty = (_this2->ty + midpointY);
            				}
