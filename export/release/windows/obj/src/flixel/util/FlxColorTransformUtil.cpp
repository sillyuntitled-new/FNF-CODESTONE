...
HXDLIN(  40)		if ((transform->redMultiplier == 1)) {
HXDLIN(  40)			_hx_tmp1 = (transform->greenMultiplier != 1);
            		}
            		else {
HXDLIN(  40)			_hx_tmp1 = true;
            		}
HXDLIN(  40)		if (!(_hx_tmp1)) {
HXDLIN(  40)			_hx_tmp = (transform->blueMultiplier != 1);
            		}
            		else {
...
HXDLIN(  56)		if ((transform->redOffset == 0)) {
HXDLIN(  56)			_hx_tmp1 = (transform->greenOffset != 0);
            		}
            		else {
HXDLIN(  56)			_hx_tmp1 = true;
            		}
HXDLIN(  56)		if (!(_hx_tmp1)) {
HXDLIN(  56)			_hx_tmp = (transform->blueOffset != 0);
            		}
            		else {
