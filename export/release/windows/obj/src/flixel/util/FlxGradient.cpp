...
HXDLIN(  32)		if ((height < 0)) {
HXLINE(  32)			_hx_tmp = (((Float)4294967296.0) + height);
            		}
            		else {
HXLINE(  32)			_hx_tmp = (height + ((Float)0.0));
            		}
HXDLIN(  32)		int _hx_int = chunkSize;
HXDLIN(  32)		Float _hx_tmp1;
HXDLIN(  32)		if ((_hx_int < 0)) {
HXLINE(  32)			_hx_tmp1 = (((Float)4294967296.0) + _hx_int);
            		}
            		else {
HXLINE(  32)			_hx_tmp1 = (_hx_int + ((Float)0.0));
            		}
HXDLIN(  32)		gradientMatrix->createGradientBox(( (Float)(width) ),(_hx_tmp / _hx_tmp1),(( (Float)(rotation) ) * ((Float)0.017453292519943295)),0,0);
...
HXLINE(  37)				_g = (_g + 1);
HXLINE(  39)				alpha->push((( (Float)(((colors->__get((_g - 1)) >> 24) & 255)) ) / ( (Float)(255) )));
            			}
            		}
...
HXLINE(  56)					_g2 = (_g2 + 1);
HXLINE(  58)					ratio->push(((_g2 - 1) * spread));
            				}
            			}
...
HXLINE(  73)				_g = (_g + 1);
HXLINE(  75)				result->push(data->getPixel32(0,(_g - 1)));
            			}
            		}
...
HXLINE( 140)			{
HXLINE( 140)				Float sx = tempBitmap2->get_scaleX();
HXDLIN( 140)				Float sy = tempBitmap2->get_scaleY();
HXDLIN( 140)				sM->a = (sM->a * sx);
HXDLIN( 140)				sM->b = (sM->b * sy);
HXDLIN( 140)				sM->c = (sM->c * sx);
HXDLIN( 140)				sM->d = (sM->d * sy);
HXDLIN( 140)				sM->tx = (sM->tx * sx);
HXDLIN( 140)				sM->ty = (sM->ty * sy);
            			}
...
HXLINE( 146)			data->fillRect( ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,remainingRect,remainingRect1,(remainingRect2 - b)),colors->__get((colors->length - 1)));
            		}
...
HXLINE( 215)		dest->copyPixels(source, ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,source->width,source->height), ::openfl::geom::Point_obj::__alloc( HX_CTX ,destX,destY),null(),null(),true);
