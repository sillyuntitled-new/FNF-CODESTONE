...
HX_LOCAL_STACK_FRAME(_hx_pos_5955daa7b9049940_35_get,"flixel.util.FlxPool","get",0x0229625c,"flixel.util.FlxPool.get","flixel/util/FlxPool.hx",35,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_5955daa7b9049940_49_put,"flixel.util.FlxPool","put",0x02304495,"flixel.util.FlxPool.put","flixel/util/FlxPool.hx",49,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_5955daa7b9049940_65_putUnsafe,"flixel.util.FlxPool","putUnsafe",0x4c705a9b,"flixel.util.FlxPool.putUnsafe","flixel/util/FlxPool.hx",65,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_5955daa7b9049940_76_preAllocate,"flixel.util.FlxPool","preAllocate",0x662e61c6,"flixel.util.FlxPool.preAllocate","flixel/util/FlxPool.hx",76,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_5955daa7b9049940_86_clear,"flixel.util.FlxPool","clear",0xa006d0d3,"flixel.util.FlxPool.clear","flixel/util/FlxPool.hx",86,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_5955daa7b9049940_95_get_length,"flixel.util.FlxPool","get_length",0x704687a9,"flixel.util.FlxPool.get_length","flixel/util/FlxPool.hx",95,0xdd4de86a)
namespace flixel{
namespace util{
...
void *FlxPool_obj::_hx_getInterface(int inHash) {
 ...
 ::Dynamic FlxPool_obj::get(){
            	HX_STACKFRAME(&_hx_pos_5955daa7b9049940_35_get)
HXLINE(  37)		if ((this->_count == 0)) {
HXLINE(  40)			return ::Type_obj::createInstance(this->_class,::cpp::VirtualArray_obj::__new(0));
            		}
HXLINE(  43)		return this->_pool->__get(--this->_count);
            	}
...
void FlxPool_obj::put( ::Dynamic obj){
            	HX_STACKFRAME(&_hx_pos_5955daa7b9049940_49_put)
...
HXLINE(  57)				::flixel::util::IFlxDestroyable_obj::destroy(obj);
HXLINE(  58)				this->_pool->set(this->_count++,obj);
            			}
            		}
            	}
...
void FlxPool_obj::putUnsafe( ::Dynamic obj){
            	HX_STACKFRAME(&_hx_pos_5955daa7b9049940_65_putUnsafe)
HXDLIN(  65)		if (::hx::IsNotNull( obj )) {
HXLINE(  69)			::flixel::util::IFlxDestroyable_obj::destroy(obj);
HXLINE(  70)			this->_pool->set(this->_count++,obj);
            		}
            	}
...
void FlxPool_obj::preAllocate(int numObjects){
            	HX_STACKFRAME(&_hx_pos_5955daa7b9049940_76_preAllocate)
HXDLIN(  76)		while(true){
HXDLIN(  76)			numObjects = (numObjects - 1);
HXDLIN(  76)			if (!(((numObjects + 1) > 0))) {
HXDLIN(  76)				goto _hx_goto_4;
            			}
HXLINE(  81)			this->_pool->set(this->_count++,::Type_obj::createInstance(this->_class,::cpp::VirtualArray_obj::__new(0)));
            		}
            		_hx_goto_4:;
            	}
...
::cpp::VirtualArray FlxPool_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_5955daa7b9049940_86_clear)
HXLINE(  87)		this->_count = 0;
HXLINE(  88)		::cpp::VirtualArray oldPool = this->_pool;
HXLINE(  89)		this->_pool = ::cpp::VirtualArray_obj::__new(0);
...
int FlxPool_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_5955daa7b9049940_95_get_length)
