...
HX_LOCAL_STACK_FRAME(_hx_pos_dc7d302d1976d073_35_get,"flixel.util.FlxPool_flixel_effects_FlxFlicker","get",0xff19dc43,"flixel.util.FlxPool_flixel_effects_FlxFlicker.get","flixel/util/FlxPool.hx",35,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_dc7d302d1976d073_49_put,"flixel.util.FlxPool_flixel_effects_FlxFlicker","put",0xff20be7c,"flixel.util.FlxPool_flixel_effects_FlxFlicker.put","flixel/util/FlxPool.hx",49,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_dc7d302d1976d073_65_putUnsafe,"flixel.util.FlxPool_flixel_effects_FlxFlicker","putUnsafe",0xc85fbbc2,"flixel.util.FlxPool_flixel_effects_FlxFlicker.putUnsafe","flixel/util/FlxPool.hx",65,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_dc7d302d1976d073_76_preAllocate,"flixel.util.FlxPool_flixel_effects_FlxFlicker","preAllocate",0x45959aad,"flixel.util.FlxPool_flixel_effects_FlxFlicker.preAllocate","flixel/util/FlxPool.hx",76,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_dc7d302d1976d073_86_clear,"flixel.util.FlxPool_flixel_effects_FlxFlicker","clear",0x1576d27a,"flixel.util.FlxPool_flixel_effects_FlxFlicker.clear","flixel/util/FlxPool.hx",86,0xdd4de86a)
HX_LOCAL_STACK_FRAME(_hx_pos_dc7d302d1976d073_95_get_length,"flixel.util.FlxPool_flixel_effects_FlxFlicker","get_length",0x65cc28a2,"flixel.util.FlxPool_flixel_effects_FlxFlicker.get_length","flixel/util/FlxPool.hx",95,0xdd4de86a)
namespace flixel{
namespace util{
...
void *FlxPool_flixel_effects_FlxFlicker_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::effects::FlxFlicker FlxPool_flixel_effects_FlxFlicker_obj::get(){
            	HX_STACKFRAME(&_hx_pos_dc7d302d1976d073_35_get)
HXLINE(  37)		if ((this->_count == 0)) {
HXLINE(  40)			return ( ( ::flixel::effects::FlxFlicker)(::Type_obj::createInstance(this->_class,::cpp::VirtualArray_obj::__new(0))) );
            		}
HXLINE(  43)		return this->_pool->__get(--this->_count).StaticCast<  ::flixel::effects::FlxFlicker >();
            	}
...
void FlxPool_flixel_effects_FlxFlicker_obj::put( ::flixel::effects::FlxFlicker obj){
            	HX_STACKFRAME(&_hx_pos_dc7d302d1976d073_49_put)
...
void FlxPool_flixel_effects_FlxFlicker_obj::putUnsafe( ::flixel::effects::FlxFlicker obj){
            	HX_STACKFRAME(&_hx_pos_dc7d302d1976d073_65_putUnsafe)
...
void FlxPool_flixel_effects_FlxFlicker_obj::preAllocate(int numObjects){
            	HX_STACKFRAME(&_hx_pos_dc7d302d1976d073_76_preAllocate)
HXDLIN(  76)		while(true){
HXDLIN(  76)			numObjects = (numObjects - 1);
HXDLIN(  76)			if (!(((numObjects + 1) > 0))) {
HXDLIN(  76)				goto _hx_goto_4;
            			}
HXLINE(  81)			this->_pool[this->_count++] = ( ( ::flixel::effects::FlxFlicker)(::Type_obj::createInstance(this->_class,::cpp::VirtualArray_obj::__new(0))) );
            		}
            		_hx_goto_4:;
            	}
...
::Array< ::Dynamic> FlxPool_flixel_effects_FlxFlicker_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_dc7d302d1976d073_86_clear)
...
int FlxPool_flixel_effects_FlxFlicker_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_dc7d302d1976d073_95_get_length)
