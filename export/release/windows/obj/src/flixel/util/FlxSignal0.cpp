...
HX_DEFINE_STACK_FRAME(_hx_pos_1cc33273a6857b14_209_new,"flixel.util.FlxSignal0","new",0x73472662,"flixel.util.FlxSignal0.new","flixel/util/FlxSignal.hx",209,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_1cc33273a6857b14_293_dispatch0,"flixel.util.FlxSignal0","dispatch0",0xad33d7b8,"flixel.util.FlxSignal0.dispatch0","flixel/util/FlxSignal.hx",293,0x3c758c5e)
namespace flixel{
namespace util{

void FlxSignal0_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_1cc33273a6857b14_209_new)
...
void FlxSignal0_obj::dispatch0(){
            	HX_STACKFRAME(&_hx_pos_1cc33273a6857b14_293_dispatch0)
HXLINE( 294)		this->processingListeners = true;
HXLINE( 295)		{
HXLINE( 295)			int _g = 0;
HXDLIN( 295)			::Array< ::Dynamic> _g1 = this->handlers;
HXDLIN( 295)			while((_g < _g1->length)){
HXLINE( 295)				 ::flixel::util::FlxSignalHandler handler = _g1->__get(_g).StaticCast<  ::flixel::util::FlxSignalHandler >();
HXDLIN( 295)				_g = (_g + 1);
...
HXLINE( 305)				 ::flixel::util::FlxSignalHandler handler1 = _g3->__get(_g2).StaticCast<  ::flixel::util::FlxSignalHandler >();
...
::hx::ObjectPtr< FlxSignal0_obj > FlxSignal0_obj::__alloc(::hx::Ctx *_hx_ctx) {
	FlxSignal0_obj *__this = (FlxSignal0_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(FlxSignal0_obj), true, "flixel.util.FlxSignal0"));
...
void FlxSignal0_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.util.FlxSignal0",70,0d,20,12);
