...
HX_DEFINE_STACK_FRAME(_hx_pos_4eb7de6aa5841a6f_237_new,"flixel.util.FlxSignal2","new",0x9a144f64,"flixel.util.FlxSignal2.new","flixel/util/FlxSignal.hx",237,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_4eb7de6aa5841a6f_293_dispatch2,"flixel.util.FlxSignal2","dispatch2",0xaef0ae3c,"flixel.util.FlxSignal2.dispatch2","flixel/util/FlxSignal.hx",293,0x3c758c5e)
namespace flixel{
namespace util{

void FlxSignal2_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_4eb7de6aa5841a6f_237_new)
...
bool FlxSignal2_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x124eb89a) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x124eb89a;
	} else {
...
void FlxSignal2_obj::dispatch2( ::Dynamic value1, ::Dynamic value2){
            	HX_STACKFRAME(&_hx_pos_4eb7de6aa5841a6f_293_dispatch2)
...
::hx::ObjectPtr< FlxSignal2_obj > FlxSignal2_obj::__alloc(::hx::Ctx *_hx_ctx) {
	FlxSignal2_obj *__this = (FlxSignal2_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(FlxSignal2_obj), true, "flixel.util.FlxSignal2"));
...
void FlxSignal2_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.util.FlxSignal2",72,0d,20,12);
