...
HX_DEFINE_STACK_FRAME(_hx_pos_86b04b9e103e4a01_251_new,"flixel.util.FlxSignal3","new",0x2d7ae3e5,"flixel.util.FlxSignal3.new","flixel/util/FlxSignal.hx",251,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_86b04b9e103e4a01_293_dispatch3,"flixel.util.FlxSignal3","dispatch3",0x2fcf197e,"flixel.util.FlxSignal3.dispatch3","flixel/util/FlxSignal.hx",293,0x3c758c5e)
namespace flixel{
namespace util{

void FlxSignal3_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_86b04b9e103e4a01_251_new)
...
bool FlxSignal3_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x124eb89b) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x124eb89b;
	} else {
...
void FlxSignal3_obj::dispatch3( ::Dynamic value1, ::Dynamic value2, ::Dynamic value3){
            	HX_STACKFRAME(&_hx_pos_86b04b9e103e4a01_293_dispatch3)
...
::hx::ObjectPtr< FlxSignal3_obj > FlxSignal3_obj::__alloc(::hx::Ctx *_hx_ctx) {
	FlxSignal3_obj *__this = (FlxSignal3_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(FlxSignal3_obj), true, "flixel.util.FlxSignal3"));
...
void FlxSignal3_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.util.FlxSignal3",73,0d,20,12);
