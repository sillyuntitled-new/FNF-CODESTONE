...
HX_DEFINE_STACK_FRAME(_hx_pos_f5c98cb4b79ba905_265_new,"flixel.util.FlxSignal4","new",0xc0e17866,"flixel.util.FlxSignal4.new","flixel/util/FlxSignal.hx",265,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_f5c98cb4b79ba905_293_dispatch4,"flixel.util.FlxSignal4","dispatch4",0xb0ad84c0,"flixel.util.FlxSignal4.dispatch4","flixel/util/FlxSignal.hx",293,0x3c758c5e)
namespace flixel{
namespace util{

void FlxSignal4_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f5c98cb4b79ba905_265_new)
...
bool FlxSignal4_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x124eb89c) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x124eb89c;
	} else {
...
void FlxSignal4_obj::dispatch4( ::Dynamic value1, ::Dynamic value2, ::Dynamic value3, ::Dynamic value4){
            	HX_STACKFRAME(&_hx_pos_f5c98cb4b79ba905_293_dispatch4)
...
::hx::ObjectPtr< FlxSignal4_obj > FlxSignal4_obj::__alloc(::hx::Ctx *_hx_ctx) {
	FlxSignal4_obj *__this = (FlxSignal4_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(FlxSignal4_obj), true, "flixel.util.FlxSignal4"));
...
void FlxSignal4_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.util.FlxSignal4",74,0d,20,12);
