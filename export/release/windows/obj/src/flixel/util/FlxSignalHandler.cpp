...
HX_DEFINE_STACK_FRAME(_hx_pos_1ea7a3370b4a4e13_83_new,"flixel.util.FlxSignalHandler","new",0x42e5b2dc,"flixel.util.FlxSignalHandler.new","flixel/util/FlxSignal.hx",83,0x3c758c5e)
HX_LOCAL_STACK_FRAME(_hx_pos_1ea7a3370b4a4e13_96_destroy,"flixel.util.FlxSignalHandler","destroy",0x7860fd76,"flixel.util.FlxSignalHandler.destroy","flixel/util/FlxSignal.hx",96,0x3c758c5e)
namespace flixel{
namespace util{

void FlxSignalHandler_obj::__construct( ::Dynamic listener,bool dispatchOnce){
            	HX_STACKFRAME(&_hx_pos_1ea7a3370b4a4e13_83_new)
...
bool FlxSignalHandler_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x5cfbbdae;
}

static ::flixel::util::IFlxDestroyable_obj _hx_flixel_util_FlxSignalHandler__hx_flixel_util_IFlxDestroyable= {
	( void (::hx::Object::*)())&::flixel::util::FlxSignalHandler_obj::destroy,
};

void *FlxSignalHandler_obj::_hx_getInterface(int inHash) {
	switch(inHash) {
		case (int)0xd4fe2fcd: return &_hx_flixel_util_FlxSignalHandler__hx_flixel_util_IFlxDestroyable;
	}
...
void FlxSignalHandler_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_1ea7a3370b4a4e13_96_destroy)
...
::hx::ObjectPtr< FlxSignalHandler_obj > FlxSignalHandler_obj::__alloc(::hx::Ctx *_hx_ctx, ::Dynamic listener,bool dispatchOnce) {
	FlxSignalHandler_obj *__this = (FlxSignalHandler_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(FlxSignalHandler_obj), true, "flixel.util.FlxSignalHandler"));
...
void FlxSignalHandler_obj::__register()
{
	...
	__mClass->mName = HX_("flixel.util.FlxSignalHandler",ea,54,ac,79);
