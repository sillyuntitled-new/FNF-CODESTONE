...
HXLINE(  99)				string = (string + ::Std_obj::string(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()));
...
HXLINE( 136)					zeroes = HX_("0",30,00,00,00);
            				}
...
HXLINE( 171)			curUnit = (curUnit + 1);
            		...
            		_hx_goto_8:;
HXLINE( 173)		return (::flixel::math::FlxMath_obj::roundDecimal(Bytes,Precision) + units->__get(curUnit));
            	}
...
HXLINE( 185)				_g = (_g + 1);
HXLINE( 187)				 ::Dynamic c = Input.charCodeAt((_g - 1));
...
HXLINE( 217)			suffix = (HX_("</font>",3c,82,5f,8e) + HX_("</b>",cf,cc,cc,27));
            		}
...
HXLINE( 493)			int _g6 = 0;
HXDLIN( 493)			int _g7 = ColorMap->length;
HXDLIN( 493)			while((_g6 < _g7)){
HXLINE( 493)				_g6 = (_g6 + 1);
HXDLIN( 493)				int i1 = (_g6 - 1);
...
HXLINE( 571)				tempBitmapData = ::openfl::utils::Assets_obj::getBitmapData(id,false,null());
            			}
            			else {
...
HXLINE( 670)		 ::EReg roman =  ::EReg_obj::__alloc( HX_CTX ,HX_("^(?=[MDCLXVI])M*(C[MD]|D?C*)(X[CL]|L?X*)(I[XV]|V?I*)$",19,35,5b,b5),HX_("i",69,00,00,00));
HXLINE( 671)		::Array< ::String > words = str.toLowerCase().split(HX_(" ",20,00,00,00));
HXLINE( 673)		{
HXLINE( 673)			int _g = 0;
HXDLIN( 673)			int _g1 = words->length;
HXDLIN( 673)			while((_g < _g1)){
HXLINE( 673)				_g = (_g + 1);
HXDLIN( 673)				int i = (_g - 1);
HXLINE( 675)				if (roman->match(words->__get(i))) {
HXLINE( 676)					words[i] = words->__get(i).toUpperCase();
            				}
            				else {
HXLINE( 677)					bool _hx_tmp;
HXDLIN( 677)					if ((i != 0)) {
HXLINE( 677)						_hx_tmp = (exempt->indexOf(words->__get(i),null()) == -1);
            					}
            					else {
HXLINE( 677)						_hx_tmp = true;
            					}
HXDLIN( 677)					if (_hx_tmp) {
HXLINE( 678)						::String _hx_tmp1 = words->__get(i).charAt(0).toUpperCase();
HXDLIN( 678)						words[i] = (_hx_tmp1 + words->__get(i).substr(1,null()));
            					}
            				}
            			}
            		}
HXLINE( 681)		return words->join(HX_(" ",20,00,00,00));
            	}
