...
HXLINE( 184)		this->_timeCounter = (this->_timeCounter + elapsed);
...
HXLINE( 188)			this->_timeCounter = (this->_timeCounter - this->time);
HXLINE( 189)			this->_loopsCounter++;
HXLINE( 191)			bool _hx_tmp2;
HXDLIN( 191)			if ((this->loops > 0)) {
HXLINE( 191)				_hx_tmp2 = (this->_loopsCounter >= this->loops);
            			}
            			else {
