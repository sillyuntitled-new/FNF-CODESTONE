...
HX_DEFINE_STACK_FRAME(_hx_pos_53443e31a49e57d3_716_new,"flixel.util.LabelValuePair","new",0x8e753503,"flixel.util.LabelValuePair.new","flixel/util/FlxStringUtil.hx",716,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_698_create,"flixel.util.LabelValuePair","create",0x3da24a39,"flixel.util.LabelValuePair.create","flixel/util/FlxStringUtil.hx",698,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_706_put,"flixel.util.LabelValuePair","put",0x8e76c772,"flixel.util.LabelValuePair.put","flixel/util/FlxStringUtil.hx",706,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_710_destroy,"flixel.util.LabelValuePair","destroy",0xc37a1f1d,"flixel.util.LabelValuePair.destroy","flixel/util/FlxStringUtil.hx",710,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_691_weak,"flixel.util.LabelValuePair","weak",0x1e0c0675,"flixel.util.LabelValuePair.weak","flixel/util/FlxStringUtil.hx",691,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_687_boot,"flixel.util.LabelValuePair","boot",0x10322e2f,"flixel.util.LabelValuePair.boot","flixel/util/FlxStringUtil.hx",687,0x4e012e33)
namespace flixel{
namespace util{

void LabelValuePair_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_716_new)
            	}
...
void *LabelValuePair_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::util::LabelValuePair LabelValuePair_obj::create(::String label, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_698_create)
HXLINE( 699)		this->label = label;
HXLINE( 700)		this->value = value;
...
void LabelValuePair_obj::put(){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_706_put)
HXDLIN( 706)		::flixel::util::LabelValuePair_obj::_pool->put(::hx::ObjectPtr<OBJ_>(this));
            	}
...
void LabelValuePair_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_710_destroy)
HXLINE( 711)		this->label = null();
HXLINE( 712)		this->value = null();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(LabelValuePair_obj,destroy,(void))
 ...
 ::flixel::util::LabelValuePair LabelValuePair_obj::weak(::String label, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_691_weak)
HXDLIN( 691)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 691)		_this->label = label;
HXDLIN( 691)		_this->value = value;
HXDLIN( 691)		return _this;
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_53443e31a49e57d3_687_boot)
HXDLIN( 687)		_pool =  ::flixel::util::FlxPool_flixel_util_LabelValuePair_obj::__alloc( HX_CTX ,::hx::ClassOf< ::flixel::util::LabelValuePair >());
            	}
}
