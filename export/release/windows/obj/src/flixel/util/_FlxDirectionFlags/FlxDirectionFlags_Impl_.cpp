...
HX_LOCAL_STACK_FRAME(_hx_pos_01e78c70af2a6c38_46_get_degrees,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_","get_degrees",0xa78a1b11,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_.get_degrees","flixel/util/FlxDirectionFlags.hx",46,0x7932e23e)
HX_LOCAL_STACK_FRAME(_hx_pos_01e78c70af2a6c38_69_get_radians,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_","get_radians",0x941f7ddc,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_.get_radians","flixel/util/FlxDirectionFlags.hx",69,0x7932e23e)
HX_LOCAL_STACK_FRAME(_hx_pos_01e78c70af2a6c38_77_has,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_","has",0xa8930bad,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_.has","flixel/util/FlxDirectionFlags.hx",77,0x7932e23e)
HX_LOCAL_STACK_FRAME(_hx_pos_01e78c70af2a6c38_85_hasAny,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_","hasAny",0x6d31713f,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_.hasAny","flixel/util/FlxDirectionFlags.hx",85,0x7932e23e)
HX_LOCAL_STACK_FRAME(_hx_pos_01e78c70af2a6c38_93_with,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_","with",0xe2077253,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_.with","flixel/util/FlxDirectionFlags.hx",93,0x7932e23e)
HX_LOCAL_STACK_FRAME(_hx_pos_01e78c70af2a6c38_101_without,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_","without",0x6ddd241b,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_.without","flixel/util/FlxDirectionFlags.hx",101,0x7932e23e)
HX_LOCAL_STACK_FRAME(_hx_pos_01e78c70af2a6c38_105_toString,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_","toString",0xba867779,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_.toString","flixel/util/FlxDirectionFlags.hx",105,0x7932e23e)
HX_LOCAL_STACK_FRAME(_hx_pos_01e78c70af2a6c38_129_fromBools,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_","fromBools",0xbe1b57d2,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_.fromBools","flixel/util/FlxDirectionFlags.hx",129,0x7932e23e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_01e78c70af2a6c38_35_boot,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_","boot",0xd42a807f,"flixel.util._FlxDirectionFlags.FlxDirectionFlags_Impl_.boot","flixel/util/FlxDirectionFlags.hx",35,0x7932e23e)
namespace flixel{
namespace util{
...
Float FlxDirectionFlags_Impl__obj::get_degrees(int this1){
            	HX_STACKFRAME(&_hx_pos_01e78c70af2a6c38_46_get_degrees)
HXDLIN(  46)		switch((int)(this1)){
            			case (int)1: {
HXLINE(  51)				return ( (Float)(180) );
            			}
            			break;
            			case (int)16: {
HXLINE(  48)				return ( (Float)(0) );
            			}
            			break;
            			case (int)256: {
HXLINE(  50)				return ( (Float)(-90) );
            			}
            			break;
            			case (int)4096: {
HXLINE(  49)				return ( (Float)(90) );
            			}
            			break;
            			default:{
HXDLIN(  46)				if ((this1 == (4096 | 16))) {
HXLINE(  52)					return ( (Float)(45) );
            				}
            				else {
HXDLIN(  46)					if ((this1 == (4096 | 1))) {
HXLINE(  53)						return ( (Float)(135) );
            					}
            					else {
HXDLIN(  46)						if ((this1 == (256 | 16))) {
HXLINE(  54)							return ( (Float)(-45) );
            						}
            						else {
HXLINE(  55)							if ((this1 == (256 | 1))) {
HXLINE(  55)								return ( (Float)(-135) );
            							}
            							else {
HXLINE(  56)								return ( (Float)(0) );
            							}
            						}
            					}
            				}
...
Float FlxDirectionFlags_Impl__obj::get_radians(int this1){
            	HX_STACKFRAME(&_hx_pos_01e78c70af2a6c38_69_get_radians)
HXDLIN(  69)		return (::flixel::util::_FlxDirectionFlags::FlxDirectionFlags_Impl__obj::get_degrees(this1) * ((Float)0.017453292519943295));
            	}
...
bool FlxDirectionFlags_Impl__obj::has(int this1,int dir){
            	HX_STACKFRAME(&_hx_pos_01e78c70af2a6c38_77_has)
HXDLIN(  77)		return ((this1 & dir) == dir);
            	}
...
bool FlxDirectionFlags_Impl__obj::hasAny(int this1,int dir){
            	HX_STACKFRAME(&_hx_pos_01e78c70af2a6c38_85_hasAny)
HXDLIN(  85)		return ((this1 & dir) > 0);
            	}
...
int FlxDirectionFlags_Impl__obj::with(int this1,int dir){
            	HX_STACKFRAME(&_hx_pos_01e78c70af2a6c38_93_with)
HXDLIN(  93)		return (this1 | dir);
            	}
...
int FlxDirectionFlags_Impl__obj::without(int this1,int dir){
            	HX_STACKFRAME(&_hx_pos_01e78c70af2a6c38_101_without)
HXDLIN( 101)		return (this1 & ~(dir));
            	}
...
::String FlxDirectionFlags_Impl__obj::toString(int this1){
            	HX_STACKFRAME(&_hx_pos_01e78c70af2a6c38_105_toString)
HXLINE( 106)		if ((this1 == 0)) {
HXLINE( 107)			return HX_("NONE",b8,da,ca,33);
            		}
HXLINE( 109)		::String str = HX_("",00,00,00,00);
HXLINE( 110)		int dir = 1;
HXDLIN( 110)		if (((this1 & dir) == dir)) {
HXLINE( 111)			str = HX_(" | L",88,07,85,15);
            		}
HXLINE( 112)		int dir1 = 16;
HXDLIN( 112)		if (((this1 & dir1) == dir1)) {
HXLINE( 113)			str = (str + HX_(" | R",8e,07,85,15));
            		}
HXLINE( 114)		int dir2 = 256;
HXDLIN( 114)		if (((this1 & dir2) == dir2)) {
HXLINE( 115)			str = (str + HX_(" | U",91,07,85,15));
            		}
HXLINE( 116)		int dir3 = 4096;
HXDLIN( 116)		if (((this1 & dir3) == dir3)) {
HXLINE( 117)			str = (str + HX_(" | D",80,07,85,15));
            		}
HXLINE( 120)		return str.substr(3,null());
            	}
...
int FlxDirectionFlags_Impl__obj::fromBools(bool left,bool right,bool up,bool down){
            	HX_STACKFRAME(&_hx_pos_01e78c70af2a6c38_129_fromBools)
HXDLIN( 129)		int _hx_tmp;
HXDLIN( 129)		if (left) {
HXDLIN( 129)			_hx_tmp = 1;
            		}
            		else {
HXDLIN( 129)			_hx_tmp = 0;
            		}
HXDLIN( 129)		int _hx_tmp1;
HXDLIN( 129)		if (right) {
HXDLIN( 129)			_hx_tmp1 = 16;
            		}
            		else {
HXDLIN( 129)			_hx_tmp1 = 0;
            		}
HXDLIN( 129)		int _hx_tmp2;
HXDLIN( 129)		if (up) {
HXDLIN( 129)			_hx_tmp2 = 256;
            		}
            		else {
HXDLIN( 129)			_hx_tmp2 = 0;
            		}
HXDLIN( 129)		int _hx_tmp3;
HXDLIN( 129)		if (down) {
HXDLIN( 129)			_hx_tmp3 = 4096;
            		}
            		else {
HXDLIN( 129)			_hx_tmp3 = 0;
            		}
...
{
            	HX_STACKFRAME(&_hx_pos_01e78c70af2a6c38_35_boot)
HXDLIN(  35)		ANY = 4369;
            	}
}
