...
HXLINE(  93)				{
HXLINE(  93)					int _g3 = 0;
HXDLIN(  93)					while((_g3 < 8)){
HXLINE(  93)						_g3 = (_g3 + 1);
HXDLIN(  93)						int col = (_g3 - 1);
...
HXDLIN( 206)					while((_g1 < end)){
HXLINE( 206)						_g1 = (_g1 + 1);
HXLINE( 208)						HT->set(( (int)(std_table->b->__get(pos_in_table)) ), ::format::jpg::_Writer::BitString_obj::__alloc( HX_CTX ,k,codevalue));
...
HXLINE( 229)						this->bitcode->set(idx, ::format::jpg::_Writer::BitString_obj::__alloc( HX_CTX ,cat,nr));
            					}
            				}
...
HXLINE( 236)					this->bitcode->set(idx, ::format::jpg::_Writer::BitString_obj::__alloc( HX_CTX ,cat,((nrupper - 1) + nrneg)));
...
HXLINE( 256)				this->bytenew = (this->bytenew | (1 << this->bytepos));
            			}
...
HXLINE( 410)				_g = (_g + 1);
HXLINE( 411)				this->byteout->writeByte(this->YTable->__get((_g - 1)));
            			}
            		}
...
HXLINE( 414)				this->byteout->writeByte(this->UVTable->__get((_g1 - 1)));
            			}
            		}
            	}
...
HXLINE( 509)		int i1 = 1;
HXLINE( 510)		while((i1 <= end0pos)){
HXLINE( 511)			int startpos = i1;
HXLINE( 513)			while(true){
HXLINE( 513)				bool _hx_tmp1;
HXDLIN( 513)				if ((this->DU->__get(i1) == ((Float)0.0))) {
HXLINE( 513)					_hx_tmp1 = (i1 <= end0pos);
            				}
            				else {
...
HXDLIN( 513)				i1 = (i1 + 1);
            			...
            			_hx_goto_47:;
HXLINE( 515)			int nrzeroes = (i1 - startpos);
HXLINE( 516)			if ((nrzeroes >= 16)) {
HXLINE( 518)				{
HXLINE( 518)					int _g1 = 0;
HXDLIN( 518)					int _g2 = (nrzeroes >> 4);
HXDLIN( 518)					while((_g1 < _g2)){
HXLINE( 518)						_g1 = (_g1 + 1);
HXDLIN( 518)						this->writeBits(M16zeroes);
            					}
            				}
HXLINE( 519)				nrzeroes = (nrzeroes & 15);
            			}
HXLINE( 521)			idx = (32767 + ::Std_obj::_hx_int(this->DU->__get(i1)));
...
HXLINE( 536)				_g = (_g + 1);
HXLINE( 537)				int offset = (((((_g - 1) + ypos) * width) + xpos) << 2);
HXLINE( 538)				{
...
HXLINE( 636)			this->writeBits( ::format::jpg::_Writer::BitString_obj::__alloc( HX_CTX ,(this->bytepos + 1),((1 << (this->bytepos + 1)) - 1)));
            		}
