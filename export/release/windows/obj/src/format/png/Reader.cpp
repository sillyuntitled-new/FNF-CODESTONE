...
HXLINE(  42)		{
HXLINE(  43)			if ((this->i->readByte() != 137)) {
HXLINE(  44)				HX_STACK_DO_THROW(HX_("Invalid header",b6,f7,77,ca));
            			}
HXLINE(  43)			if ((this->i->readByte() != 80)) {
HXLINE(  44)				HX_STACK_DO_THROW(HX_("Invalid header",b6,f7,77,ca));
            			}
HXLINE(  43)			if ((this->i->readByte() != 78)) {
HXLINE(  44)				HX_STACK_DO_THROW(HX_("Invalid header",b6,f7,77,ca));
            			}
HXLINE(  43)			if ((this->i->readByte() != 71)) {
HXLINE(  44)				HX_STACK_DO_THROW(HX_("Invalid header",b6,f7,77,ca));
            			}
HXLINE(  43)			if ((this->i->readByte() != 13)) {
HXLINE(  44)				HX_STACK_DO_THROW(HX_("Invalid header",b6,f7,77,ca));
            			}
HXLINE(  43)			if ((this->i->readByte() != 10)) {
HXLINE(  44)				HX_STACK_DO_THROW(HX_("Invalid header",b6,f7,77,ca));
            			}
HXLINE(  43)			if ((this->i->readByte() != 26)) {
HXLINE(  44)				HX_STACK_DO_THROW(HX_("Invalid header",b6,f7,77,ca));
            			}
HXLINE(  43)			if ((this->i->readByte() != 10)) {
HXLINE(  44)				HX_STACK_DO_THROW(HX_("Invalid header",b6,f7,77,ca));
...
HXLINE(  99)			{
HXLINE( 100)				{
HXLINE( 100)					int tmp = ((-1 ^ ( (int)(id.charCodeAt(0)) )) & 255);
HXDLIN( 100)					{
...
HXLINE( 101)			{
HXLINE( 101)				int len = data->length;
HXDLIN( 101)				::Array< unsigned char > b = data->b;
HXDLIN( 101)				{
HXLINE( 101)					int _g = 0;
HXDLIN( 101)					while((_g < len)){
HXLINE( 101)						_g = (_g + 1);
HXDLIN( 101)						int tmp4 = ((c_crc ^ ( (int)(_hx_array_unsafe_get(b,(_g - 1))) )) & 255);
HXDLIN( 101)						{
