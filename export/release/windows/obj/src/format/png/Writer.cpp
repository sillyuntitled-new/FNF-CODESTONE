...
HXLINE(  40)		{
HXLINE(  41)			this->o->writeByte(137);
HXDLIN(  41)			this->o->writeByte(80);
HXDLIN(  41)			this->o->writeByte(78);
HXDLIN(  41)			this->o->writeByte(71);
HXDLIN(  41)			this->o->writeByte(13);
HXDLIN(  41)			this->o->writeByte(10);
HXDLIN(  41)			this->o->writeByte(26);
HXDLIN(  41)			this->o->writeByte(10);
            		}
HXLINE(  42)		{
...
HXLINE(  43)				switch((int)(val->_hx_getIndex())){
            					case (int)0: {
HXLINE(  65)						this->writeChunk(HX_("IEND",12,33,75,30),::haxe::io::Bytes_obj::alloc(0));
            					}
            					break;
            					case (int)1: {
HXLINE(  44)						 ::Dynamic _g = val->_hx_getObject(0);
HXDLIN(  44)						{
HXLINE(  45)							 ::haxe::io::BytesOutput b =  ::haxe::io::BytesOutput_obj::__alloc( HX_CTX );
HXLINE(  46)							b->set_bigEndian(true);
HXLINE(  48)							b->writeInt32(( (int)(_g->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic)) ));
HXLINE(  49)							b->writeInt32(( (int)(_g->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic)) ));
HXLINE(  54)							b->writeByte(( (int)(_g->__Field(HX_("colbits",46,9b,c7,e6),::hx::paccDynamic)) ));
HXLINE(  55)							 ::format::png::Color _g1 = _g->__Field(HX_("color",63,71,5c,4a),::hx::paccDynamic);
HXDLIN(  55)							int _hx_tmp;
HXDLIN(  55)							switch((int)(_g1->_hx_getIndex())){
            								case (int)0: {
HXLINE(  56)									if (_g1->_hx_getBool(0)) {
HXLINE(  55)										_hx_tmp = 4;
            									}
            									else {
HXLINE(  55)										_hx_tmp = 0;
            								...
            								break;
            								case (int)1: {
HXLINE(  57)									if (_g1->_hx_getBool(0)) {
HXLINE(  55)										_hx_tmp = 6;
            									}
            									else {
HXLINE(  55)										_hx_tmp = 2;
...
HXDLIN(  62)							if (( (bool)(_g->__Field(HX_("interlaced",91,cb,78,d9),::hx::paccDynamic)) )) {
...
HXLINE(  63)							this->writeChunk(HX_("IHDR",2d,71,77,30),b->getBytes());
            					...
            					break;
            					case (int)2: {
HXLINE(  67)						this->writeChunk(HX_("IDAT",8e,65,74,30),val->_hx_getObject(0).StaticCast<  ::haxe::io::Bytes >());
            					}
            					break;
            					case (int)3: {
HXLINE(  69)						this->writeChunk(HX_("PLTE",6d,06,1b,35),val->_hx_getObject(0).StaticCast<  ::haxe::io::Bytes >());
            					}
            					break;
            					case (int)4: {
HXLINE(  71)						this->writeChunk(val->_hx_getString(0),val->_hx_getObject(1).StaticCast<  ::haxe::io::Bytes >());
            					}
            					break;
            				}
            			}
...
HXLINE(  86)		{
HXLINE(  87)			{
HXLINE(  87)				int tmp = ((-1 ^ ( (int)(id.charCodeAt(0)) )) & 255);
HXDLIN(  87)				{
...
HXLINE(  87)				crc_crc = (16777215 ^ tmp);
            			}
HXDLIN(  87)			{
...
HXLINE(  88)		{
HXLINE(  88)			int len = data->length;
HXDLIN(  88)			::Array< unsigned char > b = data->b;
HXDLIN(  88)			{
HXLINE(  88)				int _g = 0;
HXDLIN(  88)				while((_g < len)){
HXLINE(  88)					_g = (_g + 1);
HXDLIN(  88)					int tmp4 = ((crc_crc ^ ( (int)(_hx_array_unsafe_get(b,(_g - 1))) )) & 255);
HXDLIN(  88)					{
