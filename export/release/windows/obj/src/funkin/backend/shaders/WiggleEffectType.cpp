...
::funkin::backend::shaders::WiggleEffectType WiggleEffectType_obj::DREAMY;

::funkin::backend::shaders::WiggleEffectType WiggleEffectType_obj::FLAG;

::funkin::backend::shaders::WiggleEffectType WiggleEffectType_obj::HEAT_WAVE_HORIZONTAL;

::funkin::backend::shaders::WiggleEffectType WiggleEffectType_obj::HEAT_WAVE_VERTICAL;

::funkin::backend::shaders::WiggleEffectType WiggleEffectType_obj::WAVY;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("funkin.backend.shaders.WiggleEffectType",cd,4a,c4,fb), ::hx::TCanCast< WiggleEffectType_obj >,WiggleEffectType_obj_sStaticFields,0,
