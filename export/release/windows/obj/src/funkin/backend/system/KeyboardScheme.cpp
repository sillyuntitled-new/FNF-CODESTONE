...
::funkin::backend::_hx_system::KeyboardScheme KeyboardScheme_obj::Custom;

::funkin::backend::_hx_system::KeyboardScheme KeyboardScheme_obj::Duo(bool first)
{
	return ::hx::CreateEnum< KeyboardScheme_obj >(HX_("Duo",9e,ff,33,00),1,1)->_hx_init(0,first);
}

::funkin::backend::_hx_system::KeyboardScheme KeyboardScheme_obj::None;

::funkin::backend::_hx_system::KeyboardScheme KeyboardScheme_obj::Solo;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("funkin.backend.system.KeyboardScheme",14,9e,4a,29), ::hx::TCanCast< KeyboardScheme_obj >,KeyboardScheme_obj_sStaticFields,0,
