...
HX_LOCAL_STACK_FRAME(_hx_pos_ec11a2a53e5eef86_101_processEvents,"haxe.EntryPoint","processEvents",0x04eb4e60,"haxe.EntryPoint.processEvents","C:\\HaxeToolkit\\haxe\\std/haxe/EntryPoint.hx",101,0x22ebe610)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ec11a2a53e5eef86_44_boot,"haxe.EntryPoint","boot",0x3138e7ba,"haxe.EntryPoint.boot","C:\\HaxeToolkit\\haxe\\std/haxe/EntryPoint.hx",44,0x22ebe610)
...
Float EntryPoint_obj::processEvents(){
            	HX_STACKFRAME(&_hx_pos_ec11a2a53e5eef86_101_processEvents)
HXDLIN( 101)		return ( (Float)(-1) );
            	}
...
{
            	HX_STACKFRAME(&_hx_pos_ec11a2a53e5eef86_44_boot)
HXDLIN(  44)		pending = ::Array_obj< ::Dynamic>::__new();
            	}
{
