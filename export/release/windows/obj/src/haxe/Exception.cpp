...
HX_LOCAL_STACK_FRAME(_hx_pos_9d9f724dcba0f141_52_unwrap,"haxe.Exception","unwrap",0x6c26184a,"haxe.Exception.unwrap","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",52,0xc2abb812)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9d9f724dcba0f141_60_details,"haxe.Exception","details",0x13a1b73b,"haxe.Exception.details","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",60,0xc2abb812)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9d9f724dcba0f141_80_get_previous,"haxe.Exception","get_previous",0x5217ff27,"haxe.Exception.get_previous","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",80,0xc2abb812)
HX_LOCAL_STACK_FRAME(_hx_pos_9d9f724dcba0f141_84_get_native,"haxe.Exception","get_native",0xdd187087,"haxe.Exception.get_native","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",84,0xc2abb812)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9d9f724dcba0f141_30_thrown,"haxe.Exception","thrown",0x8e12fc2f,"haxe.Exception.thrown","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Exception.hx",30,0xc2abb812)
namespace haxe{
...
bool Exception_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Exception_obj::unwrap(){
            	HX_STACKFRAME(&_hx_pos_9d9f724dcba0f141_52_unwrap)
HXDLIN(  52)		return this->_hx___nativeException;
            	}
...
::String Exception_obj::details(){
            	HX_STACKFRAME(&_hx_pos_9d9f724dcba0f141_60_details)
...
HXDLIN(  60)				_hx_tmp1 = ::haxe::CallStack_HSC_obj::toString(tmp);
            			}
...
HXDLIN(  60)						result2 = ::haxe::CallStack_HSC_obj::toString(tmp1);
            					}
...
HXDLIN(  60)						result4 = ::haxe::CallStack_HSC_obj::toString(prevStack1);
            					}
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_message,return )
 ...
 ::haxe::Exception Exception_obj::get_previous(){
            	HX_STACKFRAME(&_hx_pos_9d9f724dcba0f141_80_get_previous)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_previous,return )
 ...
 ::Dynamic Exception_obj::get_native(){
            	HX_STACKFRAME(&_hx_pos_9d9f724dcba0f141_84_get_native)
HXDLIN(  84)		return this->_hx___nativeException;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Exception_obj,caught,return )
 ...
 ::Dynamic Exception_obj::thrown( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_9d9f724dcba0f141_30_thrown)
HXDLIN(  30)		if (::Std_obj::isOfType(value,::hx::ClassOf< ::haxe::Exception >())) {
HXLINE(  31)			return ( ( ::haxe::Exception)(value) )->get_native();
            		}
            		else {
HXLINE(  33)			 ::haxe::ValueException e =  ::haxe::ValueException_obj::__alloc( HX_CTX ,value,null(),null());
HXLINE(  34)			e->_hx___skipStack++;
HXLINE(  35)			return e;
            		}
