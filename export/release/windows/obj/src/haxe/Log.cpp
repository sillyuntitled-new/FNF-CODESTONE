...
HX_LOCAL_STACK_FRAME(_hx_pos_cc4c1bd12c1b2231_39_formatOutput,"haxe.Log","formatOutput",0x0271e52a,"haxe.Log.formatOutput","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/Log.hx",39,0xc6a55ebd)
namespace haxe{
...
::String Log_obj::formatOutput( ::Dynamic v, ::Dynamic infos){
            	HX_STACKFRAME(&_hx_pos_cc4c1bd12c1b2231_39_formatOutput)
...
HXDLIN(  45)				_g = (_g + 1);
HXLINE(  46)				str = (str + (HX_(", ",74,26,00,00) + ::Std_obj::string(v1)));
            			}
            		}
