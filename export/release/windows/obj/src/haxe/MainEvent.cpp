...
HX_LOCAL_STACK_FRAME(_hx_pos_6b3fe25948ba01a2_33_delay,"haxe.MainEvent","delay",0x4495dc0e,"haxe.MainEvent.delay","C:\\HaxeToolkit\\haxe\\std/haxe/MainLoop.hx",33,0x949ef6b1)
HX_LOCAL_STACK_FRAME(_hx_pos_6b3fe25948ba01a2_40_call,"haxe.MainEvent","call",0xb3de2e73,"haxe.MainEvent.call","C:\\HaxeToolkit\\haxe\\std/haxe/MainLoop.hx",40,0x949ef6b1)
HX_LOCAL_STACK_FRAME(_hx_pos_6b3fe25948ba01a2_47_stop,"haxe.MainEvent","stop",0xbe8005d7,"haxe.MainEvent.stop","C:\\HaxeToolkit\\haxe\\std/haxe/MainLoop.hx",47,0x949ef6b1)
namespace haxe{
...
void MainEvent_obj::delay( ::Dynamic t){
            	HX_STACKFRAME(&_hx_pos_6b3fe25948ba01a2_33_delay)
HXDLIN(  33)		Float _hx_tmp;
HXDLIN(  33)		if (::hx::IsNull( t )) {
HXDLIN(  33)			_hx_tmp = ::Math_obj::NEGATIVE_INFINITY;
            		}
            		else {
HXDLIN(  33)			int timer = ::lime::_hx_system::System_obj::getTimer();
HXDLIN(  33)			Float _hx_tmp1;
HXDLIN(  33)			if ((timer > 0)) {
HXDLIN(  33)				_hx_tmp1 = (( (Float)(timer) ) / ( (Float)(1000) ));
            			}
            			else {
HXDLIN(  33)				_hx_tmp1 = ( (Float)(0) );
            			}
HXDLIN(  33)			_hx_tmp = (_hx_tmp1 + t);
            		}
HXDLIN(  33)		this->nextRun = _hx_tmp;
            	}


HX_DEFINE_DYNAMIC_FUNC1(MainEvent_obj,delay,(void))

void MainEvent_obj::call(){
            	HX_STACKFRAME(&_hx_pos_6b3fe25948ba01a2_40_call)
HXDLIN(  40)		if (::hx::IsNotNull( this->f )) {
HXLINE(  41)			this->f();
            		}
            	}


HX_DEFINE_DYNAMIC_FUNC0(MainEvent_obj,call,(void))

void MainEvent_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_6b3fe25948ba01a2_47_stop)
