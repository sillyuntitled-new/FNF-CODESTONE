...
HXLINE(  59)					_g = (_g + 1);
HXLINE(  60)					{
HXLINE(  60)						 ::Dynamic _g2 = argument.charCodeAt((_g - 1));
...
HXLINE(  77)							{
HXLINE(  77)								int c = ( (int)(_g2) );
HXDLIN(  77)								if ((c >= 127)) {
HXLINE(  77)									::String x1 = ::String::fromCharCode(c);
...
HXDLIN(  77)									result->charBuf->push(c);
            								}
            							}
            						}
            						else {
...
HXLINE(  77)								{
HXLINE(  77)									int c1 = ( (int)(_g2) );
HXDLIN(  77)									if ((c1 >= 127)) {
HXLINE(  77)										::String x3 = ::String::fromCharCode(c1);
HXDLIN(  77)										if (::hx::IsNotNull( result->charBuf )) {
HXLINE(  77)											result->flush();
            										}
HXDLIN(  77)										if (::hx::IsNull( result->b )) {
...
HXLINE(  94)					_g3 = (_g3 + 1);
HXLINE(  95)					 ::Dynamic c2 = argument.charCodeAt((_g3 - 1));
HXLINE(  96)					if ((::haxe::SysTools_obj::winMetaCharacters->indexOf(c2,null()) >= 0)) {
...
HXLINE(  99)					{
HXLINE(  99)						int c3 = ( (int)(c2) );
HXDLIN(  99)						if ((c3 >= 127)) {
HXLINE(  99)							::String x6 = ::String::fromCharCode(c3);
...
HXDLIN(  99)							result9->charBuf->push(c3);
            						}
            					}
            				}
            			}
