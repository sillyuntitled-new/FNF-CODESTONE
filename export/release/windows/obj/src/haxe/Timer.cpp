...
HX_LOCAL_STACK_FRAME(_hx_pos_102f69689d37b2bb_285_stop,"haxe.Timer","stop",0xd1fd70b3,"haxe.Timer.stop","haxe/Timer.hx",285,0x1a690682)
...
void Timer_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_102f69689d37b2bb_285_stop)
HXDLIN( 285)		this->mRunning = false;
            	}
...
HXLINE( 292)			this->mFireAt = (this->mFireAt + this->mTime);
HXLINE( 293)			this->run();
            		}
            	}
