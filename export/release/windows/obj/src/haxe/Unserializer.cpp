...
HX_LOCAL_STACK_FRAME(_hx_pos_f8f88660db87045d_139_getResolver,"haxe.Unserializer","getResolver",0x4ad7fd61,"haxe.Unserializer.getResolver","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",139,0x00b9ec83)
HX_LOCAL_STACK_FRAME(_hx_pos_f8f88660db87045d_146_get,"haxe.Unserializer","get",0xa8f0923b,"haxe.Unserializer.get","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",146,0x00b9ec83)
...
HX_LOCAL_STACK_FRAME(_hx_pos_f8f88660db87045d_482_fastLength,"haxe.Unserializer","fastLength",0xaed9459d,"haxe.Unserializer.fastLength","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",482,0x00b9ec83)
HX_LOCAL_STACK_FRAME(_hx_pos_f8f88660db87045d_490_fastCharCodeAt,"haxe.Unserializer","fastCharCodeAt",0xe612bf2d,"haxe.Unserializer.fastCharCodeAt","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",490,0x00b9ec83)
HX_LOCAL_STACK_FRAME(_hx_pos_f8f88660db87045d_498_fastCharAt,"haxe.Unserializer","fastCharAt",0xc7472a20,"haxe.Unserializer.fastCharAt","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",498,0x00b9ec83)
HX_LOCAL_STACK_FRAME(_hx_pos_f8f88660db87045d_506_fastSubstr,"haxe.Unserializer","fastSubstr",0xa9dc9fe8,"haxe.Unserializer.fastSubstr","C:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",506,0x00b9ec83)
...
HX_DEFINE_DYNAMIC_FUNC1(Unserializer_obj,setResolver,(void))
 ...
 ::Dynamic Unserializer_obj::getResolver(){
            	HX_STACKFRAME(&_hx_pos_f8f88660db87045d_139_getResolver)
...
int Unserializer_obj::get(int p){
            	HX_STACKFRAME(&_hx_pos_f8f88660db87045d_146_get)
...
HXLINE( 200)			::Reflect_obj::setField(o,( (::String)(k) ),this->unserialize());
            		}
            		_hx_goto_8:;
HXLINE( 202)		this->pos++;
            	}
...
HXLINE( 410)				 ::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::alloc((((len >> 2) * 3) + size));
HXLINE( 411)				int bpos = 0;
HXLINE( 412)				while((i1 < max)){
HXLINE( 413)					i1 = (i1 + 1);
HXDLIN( 413)					int c11 = codes->__get(buf.cca((i1 - 1)));
HXLINE( 414)					i1 = (i1 + 1);
HXDLIN( 414)					int c2 = codes->__get(buf.cca((i1 - 1)));
HXLINE( 415)					{
HXLINE( 415)						bpos = (bpos + 1);
HXDLIN( 415)						bytes->b[(bpos - 1)] = ( (unsigned char)(((c11 << 2) | (c2 >> 4))) );
            					}
HXLINE( 416)					i1 = (i1 + 1);
HXDLIN( 416)					int c3 = codes->__get(buf.cca((i1 - 1)));
HXLINE( 417)					{
HXLINE( 417)						bpos = (bpos + 1);
HXDLIN( 417)						bytes->b[(bpos - 1)] = ( (unsigned char)(((c2 << 4) | (c3 >> 2))) );
            					}
HXLINE( 418)					i1 = (i1 + 1);
HXDLIN( 418)					int c4 = codes->__get(buf.cca((i1 - 1)));
HXLINE( 419)					{
...
HXLINE( 422)					i1 = (i1 + 1);
HXDLIN( 422)					int c12 = codes->__get(buf.cca((i1 - 1)));
HXLINE( 423)					i1 = (i1 + 1);
HXDLIN( 423)					int c21 = codes->__get(buf.cca((i1 - 1)));
HXLINE( 424)					{
...
HXLINE( 426)						i1 = (i1 + 1);
HXDLIN( 426)						int c31 = codes->__get(buf.cca((i1 - 1)));
HXLINE( 427)						{
...
HXLINE( 431)				this->pos = (this->pos + len);
...
HXLINE( 381)					_hx_tmp10 = (this->buf.cca(this->pos) <= 57);
            				}
            				else {
HXLINE( 381)					_hx_tmp10 = false;
            				}
HXDLIN( 381)				if (_hx_tmp10) {
HXLINE( 381)					_hx_tmp9 = (this->buf.cca((this->pos + 1)) >= 48);
            				}
            				else {
HXLINE( 381)					_hx_tmp9 = false;
            				}
HXDLIN( 381)				if (_hx_tmp9) {
HXLINE( 381)					_hx_tmp8 = (this->buf.cca((this->pos + 1)) <= 57);
            				}
            				else {
HXLINE( 381)					_hx_tmp8 = false;
            				}
HXDLIN( 381)				if (_hx_tmp8) {
HXLINE( 381)					_hx_tmp7 = (this->buf.cca((this->pos + 2)) >= 48);
            				}
            				else {
HXLINE( 381)					_hx_tmp7 = false;
            				}
HXDLIN( 381)				if (_hx_tmp7) {
HXLINE( 381)					_hx_tmp6 = (this->buf.cca((this->pos + 2)) <= 57);
            				}
            				else {
HXLINE( 381)					_hx_tmp6 = false;
            				}
HXDLIN( 381)				if (_hx_tmp6) {
HXLINE( 381)					_hx_tmp5 = (this->buf.cca((this->pos + 3)) >= 48);
            				}
            				else {
HXLINE( 381)					_hx_tmp5 = false;
            				}
HXDLIN( 381)				if (_hx_tmp5) {
HXLINE( 381)					_hx_tmp4 = (this->buf.cca((this->pos + 3)) <= 57);
            				}
            				else {
HXLINE( 381)					_hx_tmp4 = false;
            				}
HXDLIN( 381)				if (_hx_tmp4) {
HXLINE( 381)					_hx_tmp3 = (this->buf.cca((this->pos + 4)) == 45);
            				}
            				else {
...
HXLINE( 385)					this->pos = (this->pos + 19);
            				}
            				else {
...
HXLINE( 253)					_hx_tmp11 = ((this->length - this->pos) < len1);
            				}
            				else {
HXLINE( 253)					_hx_tmp11 = true;
            				}
...
HXLINE( 256)				this->pos = (this->pos + len1);
...
HXLINE( 459)		this->pos--;
HXLINE( 460)		::String _hx_tmp12 = ((HX_("Invalid char ",81,66,ec,29) + this->buf.charAt(this->pos)) + HX_(" at position ",0a,c2,01,e0));
HXDLIN( 460)		HX_STACK_DO_THROW((_hx_tmp12 + this->pos));
...
int Unserializer_obj::fastLength(::String s){
            	HX_STACKFRAME(&_hx_pos_f8f88660db87045d_482_fastLength)
...
int Unserializer_obj::fastCharCodeAt(::String s,int pos){
            	HX_STACKFRAME(&_hx_pos_f8f88660db87045d_490_fastCharCodeAt)
...
::String Unserializer_obj::fastCharAt(::String s,int pos){
            	HX_STACKFRAME(&_hx_pos_f8f88660db87045d_498_fastCharAt)
...
::String Unserializer_obj::fastSubstr(::String s,int pos,int length){
            	HX_STACKFRAME(&_hx_pos_f8f88660db87045d_506_fastSubstr)
