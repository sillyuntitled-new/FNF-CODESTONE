...
HXLINE(  88)					_g = (_g + 1);
HXLINE(  89)					if (::haxe::_CallStack::CallStack_Impl__obj::equalItems(this1->__get(i).StaticCast<  ::haxe::StackItem >(),stack->__get((_g - 1)).StaticCast<  ::haxe::StackItem >())) {
...
HXLINE( 126)								return ::haxe::_CallStack::CallStack_Impl__obj::equalItems(item1->_hx_getObject(0).StaticCast<  ::haxe::StackItem >(),item2->_hx_getObject(0).StaticCast<  ::haxe::StackItem >());
            							}
            							else {
