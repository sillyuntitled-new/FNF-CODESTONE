...
HX_LOCAL_STACK_FRAME(_hx_pos_34b82606d183bd93_57_toString,"haxe.crypto.Adler32","toString",0xfc23c0ea,"haxe.crypto.Adler32.toString","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/Adler32.hx",57,0x51878987)
...
HXLINE(  43)				_g = (_g + 1);
HXLINE(  45)				a1 = ::hx::Mod((a1 + b->b->__get((_g - 1))),65521);
...
::String Adler32_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_34b82606d183bd93_57_toString)
...
HXLINE(  66)		a->a1 = ((a1a << 8) | i->readByte());
