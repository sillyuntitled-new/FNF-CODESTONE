...
HX_LOCAL_STACK_FRAME(_hx_pos_9ec72c1fa0ba7179_116_encodeString,"haxe.crypto.BaseCode","encodeString",0x24df7852,"haxe.crypto.BaseCode.encodeString","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/BaseCode.hx",116,0x52da3542)
HX_LOCAL_STACK_FRAME(_hx_pos_9ec72c1fa0ba7179_124_decodeString,"haxe.crypto.BaseCode","decodeString",0x5b4e456a,"haxe.crypto.BaseCode.decodeString","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/BaseCode.hx",124,0x52da3542)
HX_LOCAL_STACK_FRAME(_hx_pos_9ec72c1fa0ba7179_130_encode,"haxe.crypto.BaseCode","encode",0x56322ca1,"haxe.crypto.BaseCode.encode","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/BaseCode.hx",130,0x52da3542)
HX_LOCAL_STACK_FRAME(_hx_pos_9ec72c1fa0ba7179_135_decode,"haxe.crypto.BaseCode","decode",0xc13b97b9,"haxe.crypto.BaseCode.decode","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/BaseCode.hx",135,0x52da3542)
namespace haxe{
namespace crypto{
...
::String BaseCode_obj::encodeString(::String s){
            	HX_STACKFRAME(&_hx_pos_9ec72c1fa0ba7179_116_encodeString)
...
::String BaseCode_obj::decodeString(::String s){
            	HX_STACKFRAME(&_hx_pos_9ec72c1fa0ba7179_124_decodeString)
...
::String BaseCode_obj::encode(::String s,::String base){
            	HX_GC_STACKFRAME(&_hx_pos_9ec72c1fa0ba7179_130_encode)
HXDLIN( 130)		return  ::haxe::crypto::BaseCode_obj::__alloc( HX_CTX ,::haxe::io::Bytes_obj::ofString(base,null()))->encodeString(s);
            	}
...
::String BaseCode_obj::decode(::String s,::String base){
            	HX_GC_STACKFRAME(&_hx_pos_9ec72c1fa0ba7179_135_decode)
HXDLIN( 135)		return  ::haxe::crypto::BaseCode_obj::__alloc( HX_CTX ,::haxe::io::Bytes_obj::ofString(base,null()))->decodeString(s);
            	}
