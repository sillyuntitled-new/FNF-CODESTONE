...
HXDLIN(  84)				_g = (_g + 1);
HXLINE(  85)				{
HXLINE(  86)					::String str1 = HX_("0123456789abcdef",68,7e,d5,ef).charAt(((num >> 4) & 15));
HXDLIN(  86)					str = (str + (str1 + HX_("0123456789abcdef",68,7e,d5,ef).charAt((num & 15))));
HXDLIN(  86)					::String str2 = HX_("0123456789abcdef",68,7e,d5,ef).charAt(((num >> 12) & 15));
HXDLIN(  86)					str = (str + (str2 + HX_("0123456789abcdef",68,7e,d5,ef).charAt(((num >> 8) & 15))));
HXDLIN(  86)					::String str3 = HX_("0123456789abcdef",68,7e,d5,ef).charAt(((num >> 20) & 15));
HXDLIN(  86)					str = (str + (str3 + HX_("0123456789abcdef",68,7e,d5,ef).charAt(((num >> 16) & 15))));
HXDLIN(  86)					::String str4 = HX_("0123456789abcdef",68,7e,d5,ef).charAt(((num >> 28) & 15));
HXDLIN(  86)					str = (str + (str4 + HX_("0123456789abcdef",68,7e,d5,ef).charAt(((num >> 24) & 15))));
            				}
            			}
            		}
...
HXLINE(  32)		return m->hex(m->doEncode(::haxe::crypto::Md5_obj::str2blks(s)));
            	}
...
HXLINE( 130)		blks[((nblk * 16) - 1)] = 0;
HXLINE( 138)		int i = 0;
HXLINE( 139)		int max = str1->length;
HXLINE( 140)		int l = (max * 8);
HXLINE( 141)		while((i < max)){
HXLINE( 142)			int index = (i >> 2);
HXDLIN( 142)			blks[index] = (blks->__get(index) | (( (int)(str1->b->__get(i)) ) << (::hx::Mod((l + i),4) * 8)));
HXLINE( 143)			i = (i + 1);
            		}
HXLINE( 145)		int index1 = (i >> 2);
HXDLIN( 145)		blks[index1] = (blks->__get(index1) | (128 << (::hx::Mod((l + i),4) * 8)));
HXLINE( 146)		int k = ((nblk * 16) - 2);
HXLINE( 147)		blks[k] = (l & 255);
HXLINE( 148)		blks[k] = (blks->__get(k) | ((::hx::UShr(l,8) & 255) << 8));
HXLINE( 149)		blks[k] = (blks->__get(k) | ((::hx::UShr(l,16) & 255) << 16));
HXLINE( 150)		blks[k] = (blks->__get(k) | ((::hx::UShr(l,24) & 255) << 24));
