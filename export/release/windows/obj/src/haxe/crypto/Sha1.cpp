...
HX_LOCAL_STACK_FRAME(_hx_pos_d7a45b4dfa0b9fde_136_rol,"haxe.crypto.Sha1","rol",0xdb47c24b,"haxe.crypto.Sha1.rol","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/Sha1.hx",136,0x2f3077fb)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d7a45b4dfa0b9fde_165_hex,"haxe.crypto.Sha1","hex",0xdb402317,"haxe.crypto.Sha1.hex","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/Sha1.hx",165,0x2f3077fb)
HX_LOCAL_STACK_FRAME(_hx_pos_d7a45b4dfa0b9fde_29_encode,"haxe.crypto.Sha1","encode",0xcc67df5a,"haxe.crypto.Sha1.encode","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/Sha1.hx",29,0x2f3077fb)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d7a45b4dfa0b9fde_95_str2blks,"haxe.crypto.Sha1","str2blks",0x96813717,"haxe.crypto.Sha1.str2blks","C:\\HaxeToolkit\\haxe\\std/haxe/crypto/Sha1.hx",95,0x2f3077fb)
...
int Sha1_obj::rol(int num,int cnt){
            	HX_STACKFRAME(&_hx_pos_d7a45b4dfa0b9fde_136_rol)
...
::String Sha1_obj::hex(::Array< int > a){
            	HX_STACKFRAME(&_hx_pos_d7a45b4dfa0b9fde_165_hex)
...
::String Sha1_obj::encode(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_d7a45b4dfa0b9fde_29_encode)
HXLINE(  30)		 ::haxe::crypto::Sha1 sh =  ::haxe::crypto::Sha1_obj::__alloc( HX_CTX );
HXLINE(  32)		return sh->hex(sh->doEncode(::haxe::crypto::Sha1_obj::str2blks(s)));
            	}
...
::Array< int > Sha1_obj::str2blks(::String s){
            	HX_STACKFRAME(&_hx_pos_d7a45b4dfa0b9fde_95_str2blks)
...
HXLINE( 106)				blks[p] = (blks->__get(p) | (( (int)(s1->b->__get(i)) ) << (24 - ((i & 3) << 3))));
            			}
            		}
HXLINE( 108)		int i1 = s1->length;
HXLINE( 109)		int p1 = (i1 >> 2);
HXLINE( 110)		blks[p1] = (blks->__get(p1) | (128 << (24 - ((i1 & 3) << 3))));
