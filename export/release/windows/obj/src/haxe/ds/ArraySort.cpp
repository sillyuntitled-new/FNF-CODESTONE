...
HX_LOCAL_STACK_FRAME(_hx_pos_7b65c93e89c0d147_1_doMerge,"haxe.ds.ArraySort","doMerge",0x66c5c9df,"haxe.ds.ArraySort.doMerge","?",1,0x0000003f)
...
HX_LOCAL_STACK_FRAME(_hx_pos_04e7004dc61b8255_160_compare,"haxe.ds.ArraySort","compare",0xb13b5f57,"haxe.ds.ArraySort.compare","C:\\HaxeToolkit\\haxe\\std/haxe/ds/ArraySort.hx",160,0xf1bef697)
namespace haxe{
namespace ds{
...
HXDLIN(  51)				while((_g < to)){
HXLINE(  51)					_g = (_g + 1);
HXLINE(  52)					int j = (_g - 1);
...
void ArraySort_obj::doMerge(::cpp::VirtualArray a, ::Dynamic cmp,int from,int pivot,int to,int len1,int len2){
            	HX_STACKFRAME(&_hx_pos_7b65c93e89c0d147_1_doMerge)
HXDLIN(   1)		while(true){
...
HXLINE(  91)			from = new_mid;
HXDLIN(  91)			pivot = second_cut;
HXDLIN(  91)			len1 = (len1 - len11);
HXDLIN(  91)			len2 = (len2 - len22);
            		}
            	}
...
int ArraySort_obj::compare(::cpp::VirtualArray a, ::Dynamic cmp,int i,int j){
            	HX_STACKFRAME(&_hx_pos_04e7004dc61b8255_160_compare)
