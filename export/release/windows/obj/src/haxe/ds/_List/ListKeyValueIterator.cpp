...
HX_DEFINE_STACK_FRAME(_hx_pos_bb07553d8a664db6_299_new,"haxe.ds._List.ListKeyValueIterator","new",0x709bf3d8,"haxe.ds._List.ListKeyValueIterator.new","C:\\HaxeToolkit\\haxe\\std/haxe/ds/List.hx",299,0xda78f210)
HX_LOCAL_STACK_FRAME(_hx_pos_bb07553d8a664db6_305_hasNext,"haxe.ds._List.ListKeyValueIterator","hasNext",0x6af1e4e5,"haxe.ds._List.ListKeyValueIterator.hasNext","C:\\HaxeToolkit\\haxe\\std/haxe/ds/List.hx",305,0xda78f210)
HX_LOCAL_STACK_FRAME(_hx_pos_bb07553d8a664db6_308_next,"haxe.ds._List.ListKeyValueIterator","next",0x17d96a7b,"haxe.ds._List.ListKeyValueIterator.next","C:\\HaxeToolkit\\haxe\\std/haxe/ds/List.hx",308,0xda78f210)
namespace haxe{
namespace ds{
namespace _List{

void ListKeyValueIterator_obj::__construct( ::haxe::ds::_List::ListNode head){
            	HX_STACKFRAME(&_hx_pos_bb07553d8a664db6_299_new)
...
bool ListKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_bb07553d8a664db6_305_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(ListKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic ListKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_bb07553d8a664db6_308_next)
