...
HX_LOCAL_STACK_FRAME(_hx_pos_59aca28affdf7337_72_ipad,"haxe.format.JsonPrinter","ipad",0x0d13fcd5,"haxe.format.JsonPrinter.ipad","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",72,0x660ed7d4)
HX_LOCAL_STACK_FRAME(_hx_pos_59aca28affdf7337_77_newl,"haxe.format.JsonPrinter","newl",0x1059c857,"haxe.format.JsonPrinter.newl","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",77,0x660ed7d4)
...
HX_LOCAL_STACK_FRAME(_hx_pos_59aca28affdf7337_162_objString,"haxe.format.JsonPrinter","objString",0x583a4bfd,"haxe.format.JsonPrinter.objString","C:\\HaxeToolkit\\haxe\\std/haxe/format/JsonPrinter.hx",162,0x660ed7d4)
...
void JsonPrinter_obj::ipad(){
            	HX_STACKFRAME(&_hx_pos_59aca28affdf7337_72_ipad)
...
void JsonPrinter_obj::newl(){
            	HX_STACKFRAME(&_hx_pos_59aca28affdf7337_77_newl)
...
HXLINE(  94)						_this7->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_7,1);
            					}
            					else {
...
HXLINE(  86)						_this19->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_8,1);
            					}
            					else {
...
void JsonPrinter_obj::objString( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_59aca28affdf7337_162_objString)
...
HXLINE( 222)						_this1->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_15,1);
            					}
            					else {
...
HXLINE( 220)						_this2->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_16,1);
            					}
            					else {
...
HXLINE( 216)						_this3->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_17,1);
            					}
            					else {
...
HXLINE( 224)						_this4->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_18,1);
            					}
            					else {
...
HXLINE( 218)						_this5->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_19,1);
            					}
            					else {
...
HXLINE( 212)						_this6->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_20,1);
            					}
            					else {
...
HXLINE( 214)						_this7->b = ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_21,1);
            					}
            					else {
