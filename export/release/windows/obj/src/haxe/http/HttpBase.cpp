...
HX_LOCAL_STACK_FRAME(_hx_pos_1732ad8959875cda_126_addParameter,"haxe.http.HttpBase","addParameter",0x5a5426df,"haxe.http.HttpBase.addParameter","C:\\HaxeToolkit\\haxe\\std/haxe/http/HttpBase.hx",126,0x4b84270e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1732ad8959875cda_186_request,"haxe.http.HttpBase","request",0x8a553718,"haxe.http.HttpBase.request","C:\\HaxeToolkit\\haxe\\std/haxe/http/HttpBase.hx",186,0x4b84270e)
...
void HttpBase_obj::addParameter(::String name,::String value){
            	HX_STACKFRAME(&_hx_pos_1732ad8959875cda_126_addParameter)
...
void HttpBase_obj::request( ::Dynamic post){
            	HX_GC_STACKFRAME(&_hx_pos_1732ad8959875cda_186_request)
HXDLIN( 186)		HX_STACK_DO_THROW( ::haxe::exceptions::NotImplementedException_obj::__alloc( HX_CTX ,null(),null(),::hx::SourceInfo(HX_("haxe/http/HttpBase.hx",87,57,74,d5),186,HX_("haxe.http.HttpBase",37,47,c3,bd),HX_("request",4f,df,84,44))));
            	}
