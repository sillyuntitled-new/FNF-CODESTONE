...
HXLINE( 489)		{
HXLINE( 489)			int _g = 0;
HXDLIN( 489)			int _g1 = HX_("0123456789abcdef",68,7e,d5,ef).length;
HXDLIN( 489)			while((_g < _g1)){
HXLINE( 489)				_g = (_g + 1);
HXLINE( 490)				chars->push(HX_("0123456789abcdef",68,7e,d5,ef).charCodeAt((_g - 1)));
            			}
            		}
HXLINE( 491)		{
...
HXLINE( 493)				int c = ( (int)(this->b->__get((_g2 - 1))) );
HXLINE( 494)				{
