...
HX_LOCAL_STACK_FRAME(_hx_pos_c76bafa893b9a603_175_withExtension,"haxe.io.Path","withExtension",0x256d3570,"haxe.io.Path.withExtension","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",175,0x4f1aa280)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c76bafa893b9a603_326_unescape,"haxe.io.Path","unescape",0x655df923,"haxe.io.Path.unescape","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",326,0x4f1aa280)
HX_LOCAL_STACK_FRAME(_hx_pos_c76bafa893b9a603_331_escape,"haxe.io.Path","escape",0xf1f2e5ca,"haxe.io.Path.escape","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",331,0x4f1aa280)
HX_LOCAL_STACK_FRAME(_hx_pos_c76bafa893b9a603_329_escape,"haxe.io.Path","escape",0xf1f2e5ca,"haxe.io.Path.escape","C:\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",329,0x4f1aa280)
namespace haxe{
namespace io{
...
::String Path_obj::withExtension(::String path,::String ext){
            	HX_GC_STACKFRAME(&_hx_pos_c76bafa893b9a603_175_withExtension)
...
HXLINE( 631)					c = (((c - 55232) << 10) | (tmp.cca((index + 1)) & 1023));
            				}
HXLINE( 235)				int c1 = c;
...
::String Path_obj::unescape(::String path){
            		...
            		::String _hx_run( ::EReg regex){
            			HX_GC_STACKFRAME(&_hx_pos_c76bafa893b9a603_326_unescape)
HXDLIN( 326)			return ::String::fromCharCode(( (int)(::Std_obj::parseInt(regex->matched(1))) ));
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_GC_STACKFRAME(&_hx_pos_c76bafa893b9a603_326_unescape)
HXDLIN( 326)		return  ::EReg_obj::__alloc( HX_CTX ,HX_("-x([0-9][0-9])",ac,12,39,1d),HX_("g",67,00,00,00))->map(path, ::Dynamic(new _hx_Closure_0()));
            	}
