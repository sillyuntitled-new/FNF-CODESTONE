...
int VarAccess_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("AccCtor",d5,ff,94,51)) return 7;
...
AccCtor = ::hx::CreateConstEnum< VarAccess_obj >(HX_("AccCtor",d5,ff,94,51),7);
AccInline = ::hx::CreateConstEnum< VarAccess_obj >(HX_("AccInline",5a,f6,6e,90),5);
