...
HX_LOCAL_STACK_FRAME(_hx_pos_962053f530a64077_416_isValidChar,"haxe.xml.Parser","isValidChar",0x52d1e638,"haxe.xml.Parser.isValidChar","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Parser.hx",416,0xbc28dcd7)
...
HXLINE( 242)						if (xml->exists(tmp)) {
HXLINE( 243)							HX_STACK_DO_THROW( ::haxe::xml::XmlParserException_obj::__alloc( HX_CTX ,((HX_("Duplicate attribute [",22,75,cb,05) + tmp) + HX_("]",5d,00,00,00)),str,p));
            						}
HXLINE( 244)						state = 0;
HXLINE( 245)						next = 6;
HXLINE( 246)						continue;
...
bool Parser_obj::isValidChar(int c){
            	HX_STACKFRAME(&_hx_pos_962053f530a64077_416_isValidChar)
