...
HX_LOCAL_STACK_FRAME(_hx_pos_7943a11702a17d51_49__hx_set,"haxe.xml._Access.AttribAccess_Impl_","_hx_set",0xe3daf75c,"haxe.xml._Access.AttribAccess_Impl_._hx_set","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Access.hx",49,0xd9eced32)
namespace haxe{
namespace xml{
namespace _Access{
...
::String AttribAccess_Impl__obj::_hx_set( ::Xml this1,::String name,::String value){
            	HX_STACKFRAME(&_hx_pos_7943a11702a17d51_49__hx_set)
HXLINE(  50)		if ((this1->nodeType == ::Xml_obj::Document)) {
HXLINE(  51)			HX_STACK_DO_THROW((HX_("Cannot access document attribute ",ca,30,fe,c0) + name));
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(AttribAccess_Impl__obj,_hx_set,return )
