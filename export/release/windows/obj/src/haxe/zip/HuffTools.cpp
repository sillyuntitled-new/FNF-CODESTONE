...
HXLINE(  36)				return 0;
            			...
            			break;
            			case (int)1: {
HXLINE(  39)				int da = this->treeDepth(t->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >());
HXLINE(  40)				int db = this->treeDepth(t->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >());
...
HXLINE(  51)				 ::haxe::zip::Huffman _hx_tmp = this->treeCompress(t->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >());
HXDLIN(  51)				return ::haxe::zip::Huffman_obj::NeedBit(_hx_tmp,this->treeCompress(t->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >()));
            			}
            			else {
...
HXLINE(  65)			if ((d > 0)) {
HXLINE(  66)				this->treeWalk(table,p,(cd + 1),(d - 1),t->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >());
HXLINE(  67)				this->treeWalk(table,(p | (1 << cd)),(cd + 1),(d - 1),t->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >());
            			}
            			else {
...
HXLINE(  98)		{
HXLINE(  98)			int _g1 = 0;
HXDLIN(  98)			while((_g1 < nlengths)){
HXLINE(  98)				_g1 = (_g1 + 1);
HXLINE(  99)				int p = lengths->__get(((_g1 - 1) + pos));
...
HXLINE( 105)		{
HXLINE( 105)			int _g2 = 1;
HXDLIN( 105)			int _g3 = (maxbits - 1);
...
HXDLIN( 110)			while((_g4 < nlengths)){
HXLINE( 110)				_g4 = (_g4 + 1);
HXDLIN( 110)				int i1 = (_g4 - 1);
HXLINE( 111)				int l = lengths->__get((i1 + pos));
HXLINE( 112)				if ((l != 0)) {
HXLINE( 113)					int n = tmp->__get((l - 1));
HXLINE( 114)					tmp[(l - 1)] = (n + 1);
HXLINE( 115)					bits->set(((n << 5) | l),i1);
            				}
            			}
            		}
