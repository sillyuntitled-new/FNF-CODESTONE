...
HX_LOCAL_STACK_FRAME(_hx_pos_837e338f252af104_388_run,"haxe.zip.InflateImpl","run",0x8ae2ca6f,"haxe.zip.InflateImpl.run","C:\\HaxeToolkit\\haxe\\std/haxe/zip/InflateImpl.hx",388,0xc398dbb5)
...
static const int _hx_array_data_cc1ee192_36[] = {
...
HXLINE( 170)			int _hx_tmp = this->bits;
HXDLIN( 170)			int _hx_tmp1 = this->input->readByte();
HXDLIN( 170)			this->bits = (_hx_tmp | (_hx_tmp1 << this->nbits));
HXLINE( 171)			this->nbits = (this->nbits + 8);
            		}
HXLINE( 173)		int b = (this->bits & ((1 << n) - 1));
HXLINE( 174)		this->nbits = (this->nbits - n);
HXLINE( 175)		this->bits = (this->bits >> n);
HXLINE( 176)		return b;
            	}
...
HXLINE( 186)		this->bits = (this->bits >> 1);
HXLINE( 187)		return b;
            	}
...
HXLINE( 207)		this->needed = (this->needed - len);
HXLINE( 208)		this->outpos = (this->outpos + len);
            	}
...
HXDLIN( 229)		switch((int)(h->_hx_getIndex())){
            			case (int)0: {
HXLINE( 230)				return h->_hx_getInt(0);
            			}
            			break;
            			case (int)1: {
HXLINE( 231)				 ::haxe::zip::Huffman _hx_tmp;
HXDLIN( 231)				if (this->getBit()) {
HXLINE( 231)					_hx_tmp = h->_hx_getObject(1).StaticCast<  ::haxe::zip::Huffman >();
            				}
            				else {
HXLINE( 231)					_hx_tmp = h->_hx_getObject(0).StaticCast<  ::haxe::zip::Huffman >();
            				}
HXDLIN( 231)				return this->applyHuffman(_hx_tmp);
            			}
            			break;
            			case (int)2: {
HXLINE( 232)				return this->applyHuffman(h->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >()->__get(this->getBits(h->_hx_getInt(0))).StaticCast<  ::haxe::zip::Huffman >());
            			}
            			break;
            		}
HXLINE( 229)		return 0;
...
HXLINE( 320)						{
HXLINE( 320)							int _g = 0;
HXDLIN( 320)							while((_g < hclen)){
HXLINE( 320)								_g = (_g + 1);
HXLINE( 321)								this->lengths[::haxe::zip::InflateImpl_obj::CODE_LENGTHS_POS->__get((_g - 1))] = this->getBits(3);
            							}
            						}
HXLINE( 322)						{
HXLINE( 322)							int _g1 = hclen;
HXDLIN( 322)							while((_g1 < 19)){
HXLINE( 322)								_g1 = (_g1 + 1);
HXLINE( 323)								this->lengths[::haxe::zip::InflateImpl_obj::CODE_LENGTHS_POS->__get((_g1 - 1))] = 0;
            							}
            						}
...
HXLINE( 339)				this->len = (this->len - rlen);
HXLINE( 340)				this->addBytes(bytes,0,rlen);
HXLINE( 341)				if ((this->len == 0)) {
HXLINE( 342)					 ::haxe::zip::_InflateImpl::State _hx_tmp5;
HXDLIN( 342)					if (this->isFinal) {
HXLINE( 342)						_hx_tmp5 = ::haxe::zip::_InflateImpl::State_obj::Crc_dyn();
            					}
            					else {
HXLINE( 342)						_hx_tmp5 = ::haxe::zip::_InflateImpl::State_obj::Block_dyn();
            					}
HXDLIN( 342)					this->state = _hx_tmp5;
            				}
...
HXLINE( 293)				if (!(calc->equals(::haxe::crypto::Adler32_obj::read(this->input)))) {
...
HXLINE( 352)					bool _hx_tmp6;
HXDLIN( 352)					if ((this->len > 0)) {
HXLINE( 352)						_hx_tmp6 = (this->needed > 0);
            					}
            					else {
HXLINE( 352)						_hx_tmp6 = false;
            					}
HXDLIN( 352)					if (!(_hx_tmp6)) {
...
HXLINE( 356)					this->len = (this->len - rlen1);
            				}
            				_hx_goto_22:;
...
HXLINE( 347)				this->len = (this->len - rlen2);
...
::Array< int > InflateImpl_obj::CODE_LENGTHS_POS;
 ...
 ::haxe::io::Bytes InflateImpl_obj::run( ::haxe::io::Input i, ::Dynamic __o_bufsize){
            		 ::Dynamic bufsize = __o_bufsize;
            		if (::hx::IsNull(__o_bufsize)) bufsize = 65536;
            	HX_GC_STACKFRAME(&_hx_pos_837e338f252af104_388_run)
HXLINE( 389)		 ::haxe::io::Bytes buf = ::haxe::io::Bytes_obj::alloc(( (int)(bufsize) ));
HXLINE( 390)		 ::haxe::io::BytesBuffer output =  ::haxe::io::BytesBuffer_obj::__alloc( HX_CTX );
HXLINE( 391)		 ::haxe::zip::InflateImpl inflate =  ::haxe::zip::InflateImpl_obj::__alloc( HX_CTX ,i,null(),null());
HXLINE( 392)		while(true){
HXLINE( 393)			int len = inflate->readBytes(buf,0,( (int)(bufsize) ));
HXLINE( 394)			{
HXLINE( 394)				bool _hx_tmp;
HXDLIN( 394)				if ((len >= 0)) {
HXLINE( 394)					_hx_tmp = (len > buf->length);
            				}
            				else {
HXLINE( 394)					_hx_tmp = true;
            				}
HXDLIN( 394)				if (_hx_tmp) {
HXLINE( 394)					HX_STACK_DO_THROW(::haxe::io::Error_obj::OutsideBounds_dyn());
            				}
HXDLIN( 394)				::Array< unsigned char > b2 = buf->b;
HXDLIN( 394)				{
HXLINE( 394)					int _g = 0;
HXDLIN( 394)					while((_g < len)){
HXLINE( 394)						_g = (_g + 1);
HXDLIN( 394)						output->b->push(b2->__get((_g - 1)));
            					}
            				}
            			}
HXLINE( 395)			if (::hx::IsLess( len,bufsize )) {
HXLINE( 396)				goto _hx_goto_24;
            			}
            		}
            		_hx_goto_24:;
HXLINE( 398)		return output->getBytes();
            	}
...
HXDLIN(  97)		LEN_EXTRA_BITS_TBL = ::Array_obj< int >::fromData( _hx_array_data_cc1ee192_28,31);
            	}
{
            	HX_STACKFRAME(&_hx_pos_837e338f252af104_100_boot)
HXDLIN( 100)		LEN_BASE_VAL_TBL = ::Array_obj< int >::fromData( _hx_array_data_cc1ee192_30,29);
            	}
{
            	HX_STACKFRAME(&_hx_pos_837e338f252af104_103_boot)
HXDLIN( 103)		DIST_EXTRA_BITS_TBL = ::Array_obj< int >::fromData( _hx_array_data_cc1ee192_32,32);
            	}
{
            	HX_STACKFRAME(&_hx_pos_837e338f252af104_106_boot)
HXDLIN( 106)		DIST_BASE_VAL_TBL = ::Array_obj< int >::fromData( _hx_array_data_cc1ee192_34,30);
            	}
{
            	HX_STACKFRAME(&_hx_pos_837e338f252af104_109_boot)
HXDLIN( 109)		CODE_LENGTHS_POS = ::Array_obj< int >::fromData( _hx_array_data_cc1ee192_36,19);
            	}
{
