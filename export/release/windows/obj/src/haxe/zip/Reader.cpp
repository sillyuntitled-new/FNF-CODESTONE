...
HX_LOCAL_STACK_FRAME(_hx_pos_0e0824d2a0189e14_196_readZip,"haxe.zip.Reader","readZip",0x2845d555,"haxe.zip.Reader.readZip","C:\\HaxeToolkit\\haxe\\std/haxe/zip/Reader.hx",196,0x0c8b1c7d)
...
HXLINE(  45)		return  ::Date_obj::__alloc( HX_CTX ,((d >> 9) + 1980),(((d >> 5) & 15) - 1),(d & 31),((t >> 11) & 31),((t >> 5) & 63),((t & 31) << 1));
            	}
...
HXLINE(  63)								_g = (_g + 1);
HXDLIN(  63)								data->b->push(b2->__get((_g - 1)));
            							}
            						}
            					}
...
HXLINE(  68)					fields->add(::haxe::zip::ExtraField_obj::FInfoZipUnicodePath(this->i->read((len - 5))->toString(),crc));
            				}
            			}
            			else {
...
HXLINE( 166)						tmp = ::haxe::io::Bytes_obj::alloc(65536);
            					}
...
HXLINE( 170)						int n = z->readBytes(tmp,0,65536);
HXLINE( 171)						{
...
HXDLIN( 171)							{
HXLINE( 171)								int _g = 0;
HXDLIN( 171)								while((_g < n)){
HXLINE( 171)									_g = (_g + 1);
HXDLIN( 171)									out->b->push(b2->__get((_g - 1)));
            								}
            							}
            						}
HXLINE( 172)						if ((n < 65536)) {
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,read,return )
 ...
 ::haxe::ds::List Reader_obj::readZip( ::haxe::io::Input i){
            	HX_GC_STACKFRAME(&_hx_pos_0e0824d2a0189e14_196_readZip)
HXDLIN( 196)		return  ::haxe::zip::Reader_obj::__alloc( HX_CTX ,i)->read();
            	}
