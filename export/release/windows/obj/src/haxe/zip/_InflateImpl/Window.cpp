...
HX_LOCAL_STACK_FRAME(_hx_pos_8510a39dc8fa11fa_29_boot,"haxe.zip._InflateImpl.Window","boot",0x076dfb3f,"haxe.zip._InflateImpl.Window.boot","C:\\HaxeToolkit\\haxe\\std/haxe/zip/InflateImpl.hx",29,0xc398dbb5)
HX_LOCAL_STACK_FRAME(_hx_pos_8510a39dc8fa11fa_30_boot,"haxe.zip._InflateImpl.Window","boot",0x076dfb3f,"haxe.zip._InflateImpl.Window.boot","C:\\HaxeToolkit\\haxe\\std/haxe/zip/InflateImpl.hx",30,0xc398dbb5)
namespace haxe{
namespace zip{
...
HXLINE(  48)		this->pos = (this->pos - 32768);
...
HXLINE(  57)		this->pos = (this->pos + len);
            	}
...
static ::hx::StaticInfo Window_obj_sStaticStorageInfo[] = {
	{::hx::fsInt,(void *) &Window_obj::SIZE,HX_("SIZE",c1,68,14,37)},
	{::hx::fsInt,(void *) &Window_obj::BUFSIZE,HX_("BUFSIZE",54,4d,ff,39)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
{
{
            	HX_STACKFRAME(&_hx_pos_8510a39dc8fa11fa_29_boot)
HXDLIN(  29)		SIZE = 32768;
            	}
{
            	HX_STACKFRAME(&_hx_pos_8510a39dc8fa11fa_30_boot)
HXDLIN(  30)		BUFSIZE = 65536;
            	}
}
