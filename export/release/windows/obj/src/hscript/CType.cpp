...
::hscript::CType CType_obj::CTExpr( ::hscript::Expr e)
{
	return ::hx::CreateEnum< CType_obj >(HX_("CTExpr",86,10,89,55),6,1)->_hx_init(0,e);
}
...
bool CType_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("CTExpr",86,10,89,55)) { outValue = CType_obj::CTExpr_dyn(); return true; }
...
int CType_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("CTExpr",86,10,89,55)) return 6;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(CType_obj,CTExpr,return)
...
int CType_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_("CTExpr",86,10,89,55)) return 1;
...
::hx::Val CType_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("CTExpr",86,10,89,55)) return CTExpr_dyn();
