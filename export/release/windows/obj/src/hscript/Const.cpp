...
::hscript::Const Const_obj::CString(::String s, ::Dynamic i)
{
	return ::hx::CreateEnum< Const_obj >(HX_("CString",74,b1,e2,27),2,2)->_hx_init(0,s)->_hx_init(1,i);
}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Const_obj,CString,return)
