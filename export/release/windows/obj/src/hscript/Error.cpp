...
HX_DEFINE_STACK_FRAME(_hx_pos_b829cf87eef33326_306_new,"hscript.Error","new",0x4a2914df,"hscript.Error.new","hscript/Expr.hx",306,0x44b487ad)
HX_LOCAL_STACK_FRAME(_hx_pos_b829cf87eef33326_314_toString,"hscript.Error","toString",0x3655dfcd,"hscript.Error.toString","hscript/Expr.hx",314,0x44b487ad)
namespace hscript{

void Error_obj::__construct( ::hscript::ErrorDef e,int pmin,int pmax,::String origin,int line){
            	HX_STACKFRAME(&_hx_pos_b829cf87eef33326_306_new)
HXLINE( 307)		this->e = e;
HXLINE( 308)		this->pmin = pmin;
HXLINE( 309)		this->pmax = pmax;
HXLINE( 310)		this->origin = origin;
HXLINE( 311)		this->line = line;
            	}
...
::String Error_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_b829cf87eef33326_314_toString)
HXDLIN( 314)		return ::hscript::Printer_obj::errorToString(::hx::ObjectPtr<OBJ_>(this));
            	}
