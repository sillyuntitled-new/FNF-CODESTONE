...
::hscript::ErrorDef ErrorDef_obj::EAlreadyExistingClass(::String className)
{
	return ::hx::CreateEnum< ErrorDef_obj >(HX_("EAlreadyExistingClass",da,1f,4e,dd),11,1)->_hx_init(0,className);
}

::hscript::ErrorDef ErrorDef_obj::ECustom(::String msg)
{
...
::hscript::ErrorDef ErrorDef_obj::EInvalidClass(::String className)
{
	return ::hx::CreateEnum< ErrorDef_obj >(HX_("EInvalidClass",a6,0d,a2,82),10,1)->_hx_init(0,className);
}
...
::hscript::ErrorDef ErrorDef_obj::EInvalidPreprocessor(::String msg)
{
...
{
	if (inName==HX_("EAlreadyExistingClass",da,1f,4e,dd)) { outValue = ErrorDef_obj::EAlreadyExistingClass_dyn(); return true; }
	...
	if (inName==HX_("EInvalidClass",a6,0d,a2,82)) { outValue = ErrorDef_obj::EInvalidClass_dyn(); return true; }
...
{
	if (inName==HX_("EAlreadyExistingClass",da,1f,4e,dd)) return 11;
	...
	if (inName==HX_("EInvalidClass",a6,0d,a2,82)) return 10;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ErrorDef_obj,EAlreadyExistingClass,return)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ErrorDef_obj,EInvalidClass,return)
...
{
	if (inName==HX_("EAlreadyExistingClass",da,1f,4e,dd)) return 1;
	...
	if (inName==HX_("EInvalidClass",a6,0d,a2,82)) return 1;
...
{
	if (inName==HX_("EAlreadyExistingClass",da,1f,4e,dd)) return EAlreadyExistingClass_dyn();
	...
	if (inName==HX_("EInvalidClass",a6,0d,a2,82)) return EInvalidClass_dyn();
...
static ::String ErrorDef_obj_sStaticFields[] = {
	...
	HX_("EInvalidClass",a6,0d,a2,82),
	HX_("EAlreadyExistingClass",da,1f,4e,dd),
	::String(null())
};
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("hscript.ErrorDef",58,1a,2a,4c), ::hx::TCanCast< ErrorDef_obj >,ErrorDef_obj_sStaticFields,0,
