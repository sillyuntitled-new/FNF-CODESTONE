...
::hscript::Token Token_obj::TRegex(::String e,::String f)
{
	return ::hx::CreateEnum< Token_obj >(HX_("TRegex",d3,ed,e6,0f),18,2)->_hx_init(0,e)->_hx_init(1,f);
}
...
bool Token_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("TRegex",d3,ed,e6,0f)) { outValue = Token_obj::TRegex_dyn(); return true; }
...
int Token_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("TRegex",d3,ed,e6,0f)) return 18;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Token_obj,TRegex,return)
...
int Token_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_("TRegex",d3,ed,e6,0f)) return 2;
...
::hx::Val Token_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("TRegex",d3,ed,e6,0f)) return TRegex_dyn();
