...
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_105_exec,"lime._internal.backend.native.NativeApplication","exec",0xbef024b8,"lime._internal.backend.native.NativeApplication.exec","lime/_internal/backend/native/NativeApplication.hx",105,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_159_exit,"lime._internal.backend.native.NativeApplication","exit",0xbef02845,"lime._internal.backend.native.NativeApplication.exit","lime/_internal/backend/native/NativeApplication.hx",159,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_169_handleApplicationEvent,"lime._internal.backend.native.NativeApplication","handleApplicationEvent",0x2fd54159,"lime._internal.backend.native.NativeApplication.handleApplicationEvent","lime/_internal/backend/native/NativeApplication.hx",169,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_182_handleClipboardEvent,"lime._internal.backend.native.NativeApplication","handleClipboardEvent",0xc0a84753,"lime._internal.backend.native.NativeApplication.handleClipboardEvent","lime/_internal/backend/native/NativeApplication.hx",182,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_187_handleDropEvent,"lime._internal.backend.native.NativeApplication","handleDropEvent",0x7f7bbedc,"lime._internal.backend.native.NativeApplication.handleDropEvent","lime/_internal/backend/native/NativeApplication.hx",187,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_195_handleGamepadEvent,"lime._internal.backend.native.NativeApplication","handleGamepadEvent",0x1eeb62e8,"lime._internal.backend.native.NativeApplication.handleGamepadEvent","lime/_internal/backend/native/NativeApplication.hx",195,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_219_handleJoystickEvent,"lime._internal.backend.native.NativeApplication","handleJoystickEvent",0xd92b03af,"lime._internal.backend.native.NativeApplication.handleJoystickEvent","lime/_internal/backend/native/NativeApplication.hx",219,0xc1eba895)
...
HXLINE(  96)			{
HXLINE(  96)				int _g = 0;
HXDLIN(  96)				::Array< ::Dynamic> _g1 = ::haxe::Timer_obj::sRunningTimers;
HXDLIN(  96)				while((_g < _g1->length)){
HXLINE(  96)					 ::haxe::Timer timer = _g1->__get(_g).StaticCast<  ::haxe::Timer >();
HXDLIN(  96)					_g = (_g + 1);
HXLINE(  97)					bool _hx_tmp;
HXDLIN(  97)					if (::hx::IsNotNull( timer )) {
HXLINE(  97)						_hx_tmp = timer->mRunning;
            					}
            					else {
HXLINE(  97)						_hx_tmp = false;
            					}
HXDLIN(  97)					if (_hx_tmp) {
HXLINE(  97)						timer->mFireAt = (timer->mFireAt + offset1);
            					}
            				}
            			}
HXLINE(  99)			this->pauseTimer = -1;
            		}
            	}
...
int NativeApplication_obj::exec(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_105_exec)
HXLINE( 108)		::lime::_internal::backend::native::NativeCFFI_obj::lime_application_event_manager_register(::hx::DynamicPtr(this->handleApplicationEvent_dyn()),::hx::DynamicPtr(this->applicationEventInfo));
HXLINE( 109)		::lime::_internal::backend::native::NativeCFFI_obj::lime_clipboard_event_manager_register(::hx::DynamicPtr(this->handleClipboardEvent_dyn()),::hx::DynamicPtr(this->clipboardEventInfo));
HXLINE( 110)		::lime::_internal::backend::native::NativeCFFI_obj::lime_drop_event_manager_register(::hx::DynamicPtr(this->handleDropEvent_dyn()),::hx::DynamicPtr(this->dropEventInfo));
HXLINE( 111)		::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_event_manager_register(::hx::DynamicPtr(this->handleGamepadEvent_dyn()),::hx::DynamicPtr(this->gamepadEventInfo));
HXLINE( 112)		::lime::_internal::backend::native::NativeCFFI_obj::lime_joystick_event_manager_register(::hx::DynamicPtr(this->handleJoystickEvent_dyn()),::hx::DynamicPtr(this->joystickEventInfo));
HXLINE( 113)		::lime::_internal::backend::native::NativeCFFI_obj::lime_key_event_manager_register(::hx::DynamicPtr(this->handleKeyEvent_dyn()),::hx::DynamicPtr(this->keyEventInfo));
HXLINE( 114)		::lime::_internal::backend::native::NativeCFFI_obj::lime_mouse_event_manager_register(::hx::DynamicPtr(this->handleMouseEvent_dyn()),::hx::DynamicPtr(this->mouseEventInfo));
HXLINE( 115)		::lime::_internal::backend::native::NativeCFFI_obj::lime_render_event_manager_register(::hx::DynamicPtr(this->handleRenderEvent_dyn()),::hx::DynamicPtr(this->renderEventInfo));
HXLINE( 116)		::lime::_internal::backend::native::NativeCFFI_obj::lime_text_event_manager_register(::hx::DynamicPtr(this->handleTextEvent_dyn()),::hx::DynamicPtr(this->textEventInfo));
HXLINE( 117)		::lime::_internal::backend::native::NativeCFFI_obj::lime_touch_event_manager_register(::hx::DynamicPtr(this->handleTouchEvent_dyn()),::hx::DynamicPtr(this->touchEventInfo));
HXLINE( 118)		::lime::_internal::backend::native::NativeCFFI_obj::lime_window_event_manager_register(::hx::DynamicPtr(this->handleWindowEvent_dyn()),::hx::DynamicPtr(this->windowEventInfo));
HXLINE( 145)		int result = ::lime::_internal::backend::native::NativeCFFI_obj::lime_application_exec(::hx::DynamicPtr(this->handle));
HXLINE( 148)		this->parent->onExit->dispatch(result);
...
void NativeApplication_obj::exit(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_159_exit)
HXLINE( 160)		::lime::media::AudioManager_obj::shutdown();
HXLINE( 163)		::lime::_internal::backend::native::NativeCFFI_obj::lime_application_quit(::hx::DynamicPtr(this->handle));
            	}
...
void NativeApplication_obj::handleApplicationEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_169_handleApplicationEvent)
HXDLIN( 169)		if ((this->applicationEventInfo->type == 0)) {
HXLINE( 172)			this->updateTimer();
...
void NativeApplication_obj::handleClipboardEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_182_handleClipboardEvent)
HXDLIN( 182)		::lime::_hx_system::Clipboard_obj::_hx___update();
            	}
...
void NativeApplication_obj::handleDropEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_187_handleDropEvent)
HXDLIN( 187)		int _g = 0;
HXDLIN( 187)		::Array< ::Dynamic> _g1 = this->parent->_hx___windows;
HXDLIN( 187)		while((_g < _g1->length)){
HXDLIN( 187)			 ::lime::ui::Window window = _g1->__get(_g).StaticCast<  ::lime::ui::Window >();
HXDLIN( 187)			_g = (_g + 1);
...
void NativeApplication_obj::handleGamepadEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_195_handleGamepadEvent)
HXDLIN( 195)		switch((int)(this->gamepadEventInfo->type)){
            			case (int)0: {
HXLINE( 198)				 ::lime::ui::Gamepad gamepad = ( ( ::lime::ui::Gamepad)(::lime::ui::Gamepad_obj::devices->get(this->gamepadEventInfo->id)) );
HXLINE( 199)				if (::hx::IsNotNull( gamepad )) {
HXLINE( 199)					gamepad->onAxisMove->dispatch(this->gamepadEventInfo->axis,this->gamepadEventInfo->axisValue);
            				}
            			}
            			break;
            			case (int)1: {
HXLINE( 202)				 ::lime::ui::Gamepad gamepad1 = ( ( ::lime::ui::Gamepad)(::lime::ui::Gamepad_obj::devices->get(this->gamepadEventInfo->id)) );
...
HXLINE( 203)					gamepad1->onButtonDown->dispatch(this->gamepadEventInfo->button);
            			...
            			break;
            			case (int)2: {
HXLINE( 206)				 ::lime::ui::Gamepad gamepad2 = ( ( ::lime::ui::Gamepad)(::lime::ui::Gamepad_obj::devices->get(this->gamepadEventInfo->id)) );
HXLINE( 207)				if (::hx::IsNotNull( gamepad2 )) {
HXLINE( 207)					gamepad2->onButtonUp->dispatch(this->gamepadEventInfo->button);
            				}
            			}
            			break;
            			case (int)3: {
HXLINE( 210)				::lime::ui::Gamepad_obj::_hx___connect(this->gamepadEventInfo->id);
            			}
            			break;
            			case (int)4: {
HXLINE( 213)				::lime::ui::Gamepad_obj::_hx___disconnect(this->gamepadEventInfo->id);
            			}
            			break;
            		}
            	}
...
void NativeApplication_obj::handleJoystickEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_219_handleJoystickEvent)
HXDLIN( 219)		switch((int)(this->joystickEventInfo->type)){
            			case (int)0: {
HXLINE( 222)				 ::lime::ui::Joystick joystick = ( ( ::lime::ui::Joystick)(::lime::ui::Joystick_obj::devices->get(this->joystickEventInfo->id)) );
HXLINE( 223)				if (::hx::IsNotNull( joystick )) {
HXLINE( 223)					joystick->onAxisMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->x);
            				}
            			}
            			break;
            			case (int)1: {
HXLINE( 226)				 ::lime::ui::Joystick joystick1 = ( ( ::lime::ui::Joystick)(::lime::ui::Joystick_obj::devices->get(this->joystickEventInfo->id)) );
HXLINE( 227)				if (::hx::IsNotNull( joystick1 )) {
HXLINE( 227)					joystick1->onHatMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->eventValue);
            				}
            			}
            			break;
            			case (int)2: {
...
HXLINE( 255)			int keyCode = ::Std_obj::_hx_int(this->keyEventInfo->keyCode);
...
HXLINE( 584)					_g = (_g + 1);
HXLINE( 586)					timer = ::haxe::Timer_obj::sRunningTimers->__get((_g - 1)).StaticCast<  ::haxe::Timer >();
HXLINE( 588)					bool _hx_tmp;
HXDLIN( 588)					if (::hx::IsNotNull( timer )) {
HXLINE( 588)						_hx_tmp = timer->mRunning;
            					}
            					else {
HXLINE( 588)						_hx_tmp = false;
            					}
HXDLIN( 588)					if (_hx_tmp) {
HXLINE( 590)						if ((currentTime >= timer->mFireAt)) {
HXLINE( 592)							timer->mFireAt = (timer->mFireAt + timer->mTime);
...
HXLINE( 604)				::Array< ::Dynamic> _this = ::haxe::Timer_obj::sRunningTimers;
HXDLIN( 604)				::Array< ::Dynamic> _g2 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 604)				{
HXLINE( 604)					int _g3 = 0;
HXDLIN( 604)					while((_g3 < _this->length)){
HXLINE( 604)						 ::haxe::Timer v = _this->__get(_g3).StaticCast<  ::haxe::Timer >();
HXDLIN( 604)						_g3 = (_g3 + 1);
HXLINE( 606)						bool _hx_tmp1;
HXDLIN( 606)						if (::hx::IsNotNull( v )) {
HXLINE( 606)							_hx_tmp1 = v->mRunning;
            						}
            						else {
HXLINE( 606)							_hx_tmp1 = false;
            						}
HXLINE( 604)						if (_hx_tmp1) {
