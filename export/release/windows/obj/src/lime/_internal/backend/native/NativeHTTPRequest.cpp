...
HXDLIN( 397)			{
HXLINE( 397)				int _g = 0;
HXDLIN( 397)				while((_g < len)){
HXLINE( 397)					_g = (_g + 1);
HXDLIN( 397)					_this->b->push(b2->__get((_g - 1)));
            				}
            			}
            		}
...
HXLINE( 468)		( ( ::lime::app::Promise_haxe_io_Bytes)(state->__Field(HX_("promise",9b,cd,e9,f7),::hx::paccDynamic)) )->error( ::lime::net::_HTTPRequestErrorResponse_obj::__alloc( HX_CTX , ::Dynamic(state->__Field(HX_("error",c8,cb,29,73),::hx::paccDynamic)),null()));
...
HXLINE( 506)			if ((::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->wait(1000) == 0)) {
...
HXLINE( 581)						instance->promise->error( ::lime::net::_HTTPRequestErrorResponse_obj::__alloc( HX_CTX ,error,responseData));
            					}
            					else {
...
HXLINE( 587)						instance->promise->error( ::lime::net::_HTTPRequestErrorResponse_obj::__alloc( HX_CTX ,error1,responseData1));
            					}
            				}
            			}
            			else {
HXLINE( 592)				::String error2 = ::lime::net::curl::CURL_obj::strerror(( (int)(state->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic)) ));
HXLINE( 593)				instance->promise->error( ::lime::net::_HTTPRequestErrorResponse_obj::__alloc( HX_CTX ,error2,null()));
            			}
