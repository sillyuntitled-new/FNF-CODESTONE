...
HX_LOCAL_STACK_FRAME(_hx_pos_65c657fec0b420d3_2085_getString,"lime._internal.backend.native.NativeOpenGLRenderContext","getString",0x49d36afa,"lime._internal.backend.native.NativeOpenGLRenderContext.getString","lime/_internal/backend/native/NativeOpenGLRenderContext.hx",2085,0xd33553db)
HX_LOCAL_STACK_FRAME(_hx_pos_65c657fec0b420d3_2098_getStringi,"lime._internal.backend.native.NativeOpenGLRenderContext","getStringi",0x4f2a302f,"lime._internal.backend.native.NativeOpenGLRenderContext.getStringi","lime/_internal/backend/native/NativeOpenGLRenderContext.hx",2098,0xd33553db)
...
HXLINE(1461)		return ( ( ::Dynamic)(result(this->_hx___getObjectID(program),uniformBlockIndex)) );
            	}
...
HXLINE(1506)		return ( ( ::Dynamic)(result(this->_hx___getObjectID(program))) );
            	}
...
HXLINE(1840)				 ::lime::utils::ArrayBufferView params1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,4,3);
...
HXLINE(1814)				 ::lime::utils::ArrayBufferView params2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,4,8);
...
HXLINE(1803)				return data;
            			...
            			break;
            			case (int)3386: {
HXLINE(1835)				 ::lime::utils::ArrayBufferView params4 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,2,3);
...
HXLINE(1865)				return ::lime::graphics::opengl::_GLTexture::GLTexture_Impl__obj::fromInt(this->getInteger(pname));
            			}
            			break;
            			case (int)34467: {
...
HXLINE(1849)				return ::lime::graphics::opengl::_GLBuffer::GLBuffer_Impl__obj::fromInt(this->getInteger(pname));
            			}
            			break;
            			case (int)35725: {
HXLINE(1853)				return ::lime::graphics::opengl::_GLProgram::GLProgram_Impl__obj::fromInt(this->getInteger(pname));
            			}
            			break;
            			case (int)36006: {
HXLINE(1857)				return ::lime::graphics::opengl::_GLFramebuffer::GLFramebuffer_Impl__obj::fromInt(this->getInteger(pname));
            			}
            			break;
            			case (int)36007: {
HXLINE(1861)				return ::lime::graphics::opengl::_GLRenderbuffer::GLRenderbuffer_Impl__obj::fromInt(this->getInteger(pname));
            			}
            			break;
...
HXLINE(1907)		return ( ( ::Dynamic)(result(this->_hx___getObjectID(program))) );
            	}
...
HXLINE(2045)		return ( ( ::Dynamic)(result(this->_hx___getObjectID(shader))) );
            	}
...
HXLINE(2072)		return ( ( ::Dynamic)(result(this->_hx___getObjectID(shader))) );
            	}
...
::String NativeOpenGLRenderContext_obj::getString(int name){
            	HX_STACKFRAME(&_hx_pos_65c657fec0b420d3_2085_getString)
HXDLIN(2085)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_string(name)) );
            	}
...
::String NativeOpenGLRenderContext_obj::getStringi(int name,int index){
            	HX_STACKFRAME(&_hx_pos_65c657fec0b420d3_2098_getStringi)
HXDLIN(2098)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_get_stringi(name,index)) );
            	}
...
HXLINE(2219)		return ( ( ::Dynamic)(result(this->_hx___getObjectID(program),index)) );
            	}
...
HXLINE(2234)		switch((int)(( (int)(this->getActiveUniform(program,location)->__Field(HX_("type",ba,f2,08,4d),::hx::paccDynamic)) ))){
            			case (int)5124: {
HXLINE(2239)				ints = 1;
            			}
            			break;
...
HXLINE(2312)							 ::lime::utils::ArrayBufferView this1;
...
HXLINE(2318)								 ::lime::utils::ArrayBufferView this2;
...
HXLINE(3305)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("AMD_compressed_3DC_texture",97,af,9a,80), ::Dynamic(new _hx_Closure_0()));
HXLINE(3306)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("AMD_compressed_ATC_texture",15,0b,6c,91), ::Dynamic(new _hx_Closure_1()));
HXLINE(3307)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("AMD_performance_monitor",e4,7a,6c,36), ::Dynamic(new _hx_Closure_2()));
HXLINE(3308)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("AMD_program_binary_Z400",b6,66,58,28), ::Dynamic(new _hx_Closure_3()));
HXLINE(3309)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("ANGLE_framebuffer_blit",53,5d,fe,07), ::Dynamic(new _hx_Closure_4()));
HXLINE(3310)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("ANGLE_framebuffer_multisample",05,66,2b,e3), ::Dynamic(new _hx_Closure_5()));
HXLINE(3311)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("ANGLE_instanced_arrays",56,74,86,10), ::Dynamic(new _hx_Closure_6()));
HXLINE(3312)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("ANGLE_pack_reverse_row_order",f2,1c,e0,65), ::Dynamic(new _hx_Closure_7()));
HXLINE(3313)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("ANGLE_texture_compression_dxt3",fc,60,dc,b5), ::Dynamic(new _hx_Closure_8()));
HXLINE(3314)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("ANGLE_texture_compression_dxt5",fe,60,dc,b5), ::Dynamic(new _hx_Closure_9()));
HXLINE(3315)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("ANGLE_texture_usage",b1,62,6e,c1), ::Dynamic(new _hx_Closure_10()));
HXLINE(3316)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("ANGLE_translated_shader_source",58,8f,67,10), ::Dynamic(new _hx_Closure_11()));
HXLINE(3317)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("APPLE_copy_texture_levels",58,36,ee,e5), ::Dynamic(new _hx_Closure_12()));
HXLINE(3318)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("APPLE_framebuffer_multisample",8c,c4,4f,00), ::Dynamic(new _hx_Closure_13()));
HXLINE(3319)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("APPLE_rgb_422",3d,ac,a1,11), ::Dynamic(new _hx_Closure_14()));
HXLINE(3320)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("APPLE_sync",c0,e6,8c,8c), ::Dynamic(new _hx_Closure_15()));
HXLINE(3321)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("APPLE_texture_format_BGRA8888",13,8a,88,e2), ::Dynamic(new _hx_Closure_16()));
HXLINE(3322)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("APPLE_texture_max_level",40,37,3d,be), ::Dynamic(new _hx_Closure_17()));
HXLINE(3323)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("ARM_mali_program_binary",c7,33,f6,92), ::Dynamic(new _hx_Closure_18()));
HXLINE(3324)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("ARM_mali_shader_binary",50,43,81,cb), ::Dynamic(new _hx_Closure_19()));
HXLINE(3325)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("ARM_rgba8",81,03,5e,47), ::Dynamic(new _hx_Closure_20()));
HXLINE(3326)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("DMP_shader_binary",43,70,06,89), ::Dynamic(new _hx_Closure_21()));
HXLINE(3327)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_bgra",72,74,1a,40), ::Dynamic(new _hx_Closure_22()));
HXLINE(3328)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_blend_minmax",7e,f3,2e,cd), ::Dynamic(new _hx_Closure_23()));
HXLINE(3329)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_color_buffer_float",b7,19,0b,dd), ::Dynamic(new _hx_Closure_24()));
HXLINE(3330)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_color_buffer_half_float",d5,e8,0a,44), ::Dynamic(new _hx_Closure_25()));
HXLINE(3331)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_debug_label",ca,3b,0e,9c), ::Dynamic(new _hx_Closure_26()));
HXLINE(3332)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_debug_marker",24,63,59,61), ::Dynamic(new _hx_Closure_27()));
HXLINE(3333)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_discard_framebuffer",0e,f8,79,f7), ::Dynamic(new _hx_Closure_28()));
HXLINE(3334)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_map_buffer_range",7f,25,48,f8), ::Dynamic(new _hx_Closure_29()));
HXLINE(3335)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_multi_draw_arrays",51,b2,0b,91), ::Dynamic(new _hx_Closure_30()));
HXLINE(3336)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_multisampled_render_to_texture",40,d2,98,03), ::Dynamic(new _hx_Closure_31()));
HXLINE(3337)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_multiview_draw_buffers",f7,b6,e5,c5), ::Dynamic(new _hx_Closure_32()));
HXLINE(3338)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_occlusion_query_boolean",81,a7,94,3d), ::Dynamic(new _hx_Closure_33()));
HXLINE(3339)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_packed_depth_stencil",f7,88,e3,09), ::Dynamic(new _hx_Closure_34()));
HXLINE(3340)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_read_format_bgra",11,c1,96,f4), ::Dynamic(new _hx_Closure_35()));
HXLINE(3341)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_robustness",c6,8a,39,e5), ::Dynamic(new _hx_Closure_36()));
HXLINE(3342)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_sRGB",18,00,47,4b), ::Dynamic(new _hx_Closure_37()));
HXLINE(3343)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_separate_shader_objects",18,2e,eb,43), ::Dynamic(new _hx_Closure_38()));
HXLINE(3344)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_shader_framebuffer_fetch",0c,04,5a,6d), ::Dynamic(new _hx_Closure_39()));
HXLINE(3345)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_shader_texture_lod",c1,4c,48,65), ::Dynamic(new _hx_Closure_40()));
HXLINE(3346)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_shadow_samplers",ec,92,50,09), ::Dynamic(new _hx_Closure_41()));
HXLINE(3347)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_texture_compression_dxt1",6c,ae,f4,76), ::Dynamic(new _hx_Closure_42()));
HXLINE(3348)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_texture_compression_s3tc",6a,86,aa,80), ::Dynamic(new _hx_Closure_43()));
HXLINE(3349)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_texture_filter_anisotropic",4c,4c,32,3d), ::Dynamic(new _hx_Closure_44()));
HXLINE(3350)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_texture_format_BGRA8888",5a,d2,bd,b2), ::Dynamic(new _hx_Closure_45()));
HXLINE(3351)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_texture_rg",17,ce,12,89), ::Dynamic(new _hx_Closure_46()));
HXLINE(3352)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_texture_storage",99,91,8f,9d), ::Dynamic(new _hx_Closure_47()));
HXLINE(3353)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_texture_type_2_10_10_10_REV",93,7e,34,b8), ::Dynamic(new _hx_Closure_48()));
HXLINE(3354)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("EXT_unpack_subimage",4a,96,0e,d9), ::Dynamic(new _hx_Closure_49()));
HXLINE(3355)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("FJ_shader_binary_GCCSO",e4,a3,c9,4b), ::Dynamic(new _hx_Closure_50()));
HXLINE(3356)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("IMG_multisampled_render_to_texture",1e,8d,48,50), ::Dynamic(new _hx_Closure_51()));
HXLINE(3357)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("IMG_program_binary",b8,93,3a,05), ::Dynamic(new _hx_Closure_52()));
HXLINE(3358)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("IMG_read_format",a4,2a,ef,b9), ::Dynamic(new _hx_Closure_53()));
HXLINE(3359)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("IMG_shader_binary",7f,ec,f0,da), ::Dynamic(new _hx_Closure_54()));
HXLINE(3360)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("IMG_texture_compression_pvrtc",02,61,85,d1), ::Dynamic(new _hx_Closure_55()));
HXLINE(3361)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("KHR_debug",69,7f,d0,07), ::Dynamic(new _hx_Closure_56()));
HXLINE(3362)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("KHR_texture_compression_astc_ldr",63,29,b6,ea), ::Dynamic(new _hx_Closure_57()));
HXLINE(3363)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("NV_coverage_sample",aa,83,fd,db), ::Dynamic(new _hx_Closure_58()));
HXLINE(3364)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("NV_depth_nonlinear",ff,77,4d,c4), ::Dynamic(new _hx_Closure_59()));
HXLINE(3365)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("NV_draw_buffers",8f,0e,de,94), ::Dynamic(new _hx_Closure_60()));
HXLINE(3366)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("NV_fbo_color_attachments",d1,a3,ac,87), ::Dynamic(new _hx_Closure_61()));
HXLINE(3367)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("NV_fence",3a,78,71,5f), ::Dynamic(new _hx_Closure_62()));
HXLINE(3368)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("NV_read_buffer",52,78,29,ea), ::Dynamic(new _hx_Closure_63()));
HXLINE(3369)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("NV_read_buffer_front",bc,e1,e8,d2), ::Dynamic(new _hx_Closure_64()));
HXLINE(3370)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("NV_read_depth",f1,85,77,c1), ::Dynamic(new _hx_Closure_65()));
HXLINE(3371)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("NV_read_depth_stencil",6e,76,04,4b), ::Dynamic(new _hx_Closure_66()));
HXLINE(3372)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("NV_read_stencil",6a,ea,92,c8), ::Dynamic(new _hx_Closure_67()));
HXLINE(3373)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("NV_texture_compression_s3tc_update",45,2a,b6,00), ::Dynamic(new _hx_Closure_68()));
HXLINE(3374)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("NV_texture_npot_2D_mipmap",78,dc,c7,30), ::Dynamic(new _hx_Closure_69()));
HXLINE(3375)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("NVX_gpu_memory_info",6a,ad,9a,42), ::Dynamic(new _hx_Closure_70()));
HXLINE(3376)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_EGL_image",44,24,7d,2c), ::Dynamic(new _hx_Closure_71()));
HXLINE(3377)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_EGL_image_external",e6,6c,9f,93), ::Dynamic(new _hx_Closure_72()));
HXLINE(3378)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_compressed_ETC1_RGB8_texture",cd,f1,a0,b8), ::Dynamic(new _hx_Closure_73()));
HXLINE(3379)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_compressed_paletted_texture",a1,ed,5e,8e), ::Dynamic(new _hx_Closure_74()));
HXLINE(3380)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_depth24",83,70,fd,a0), ::Dynamic(new _hx_Closure_75()));
HXLINE(3381)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_depth32",60,71,fd,a0), ::Dynamic(new _hx_Closure_76()));
HXLINE(3382)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_depth_texture",dd,ed,8f,e2), ::Dynamic(new _hx_Closure_77()));
HXLINE(3383)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_element_index_uint",cc,fa,20,b1), ::Dynamic(new _hx_Closure_78()));
HXLINE(3384)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_get_program_binary",27,f4,1a,01), ::Dynamic(new _hx_Closure_79()));
HXLINE(3385)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_mapbuffer",1a,2d,9e,e1), ::Dynamic(new _hx_Closure_80()));
HXLINE(3386)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_packed_depth_stencil",7b,19,31,fc), ::Dynamic(new _hx_Closure_81()));
HXLINE(3387)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_required_internalformat",52,c5,46,29), ::Dynamic(new _hx_Closure_82()));
HXLINE(3388)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_rgb8_rgba8",d2,44,3a,66), ::Dynamic(new _hx_Closure_83()));
HXLINE(3389)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_standard_derivatives",8c,cb,00,04), ::Dynamic(new _hx_Closure_84()));
HXLINE(3390)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_stencil1",f7,0f,03,29), ::Dynamic(new _hx_Closure_85()));
HXLINE(3391)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_stencil4",fa,0f,03,29), ::Dynamic(new _hx_Closure_86()));
HXLINE(3392)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_surfaceless_context",74,4b,ea,b9), ::Dynamic(new _hx_Closure_87()));
HXLINE(3393)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_texture_3D",97,1a,cf,b4), ::Dynamic(new _hx_Closure_88()));
HXLINE(3394)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_texture_float",76,0b,21,02), ::Dynamic(new _hx_Closure_89()));
HXLINE(3395)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_texture_float_linear",ce,52,3e,d7), ::Dynamic(new _hx_Closure_90()));
HXLINE(3396)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_texture_half_float",b6,42,f5,f2), ::Dynamic(new _hx_Closure_91()));
HXLINE(3397)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_texture_half_float_linear",8e,83,0b,8c), ::Dynamic(new _hx_Closure_92()));
HXLINE(3398)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_texture_npot",4d,89,dd,01), ::Dynamic(new _hx_Closure_93()));
HXLINE(3399)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_vertex_array_object",de,b2,44,8d), ::Dynamic(new _hx_Closure_94()));
HXLINE(3400)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_vertex_half_float",89,d9,95,ca), ::Dynamic(new _hx_Closure_95()));
HXLINE(3401)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("OES_vertex_type_10_10_10_2",de,be,f1,06), ::Dynamic(new _hx_Closure_96()));
HXLINE(3402)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("QCOM_alpha_test",c2,a6,01,c4), ::Dynamic(new _hx_Closure_97()));
HXLINE(3403)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("QCOM_binning_control",4a,6c,46,7b), ::Dynamic(new _hx_Closure_98()));
HXLINE(3404)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("QCOM_driver_control",35,0f,f7,9e), ::Dynamic(new _hx_Closure_99()));
HXLINE(3405)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("QCOM_extended_get",3f,13,03,b6), ::Dynamic(new _hx_Closure_100()));
HXLINE(3406)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("QCOM_extended_get2",13,c4,ad,8c), ::Dynamic(new _hx_Closure_101()));
HXLINE(3407)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("QCOM_perfmon_global_mode",74,f2,13,ad), ::Dynamic(new _hx_Closure_102()));
HXLINE(3408)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("QCOM_tiled_rendering",f4,8a,1f,ec), ::Dynamic(new _hx_Closure_103()));
HXLINE(3409)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("QCOM_writeonly_rendering",09,44,22,8a), ::Dynamic(new _hx_Closure_104()));
HXLINE(3410)			::lime::_internal::backend::native::NativeOpenGLRenderContext_obj::_hx___extensionObjectConstructors->set(HX_("VIV_shader_binary",5f,4e,50,1f), ::Dynamic(new _hx_Closure_105()));
            		}
