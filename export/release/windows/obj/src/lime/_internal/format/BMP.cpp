...
HXLINE(  53)			{
HXLINE(  53)				position = 1;
HXDLIN(  53)				data->b[0] = ( (unsigned char)(66) );
            			}
HXLINE(  54)			{
HXLINE(  54)				position = 2;
HXDLIN(  54)				data->b[1] = ( (unsigned char)(77) );
            			}
HXLINE(  55)			{
HXLINE(  55)				int v = data->length;
HXDLIN(  55)				data->b[2] = ( (unsigned char)((v & 255)) );
HXDLIN(  55)				data->b[3] = ( (unsigned char)(((v >> 8) & 255)) );
HXDLIN(  55)				data->b[4] = ( (unsigned char)(((v >> 16) & 255)) );
HXDLIN(  55)				data->b[5] = ( (unsigned char)((::hx::UShr(v,24) & 255)) );
            			}
HXLINE(  56)			position = 6;
HXLINE(  57)			{
HXLINE(  57)				data->b[6] = ( (unsigned char)(0) );
HXDLIN(  57)				data->b[7] = ( (unsigned char)(0) );
            			}
HXLINE(  58)			position = 8;
HXLINE(  59)			{
HXLINE(  59)				data->b[8] = ( (unsigned char)(0) );
HXDLIN(  59)				data->b[9] = ( (unsigned char)(0) );
            			}
HXLINE(  60)			position = 10;
HXLINE(  61)			{
HXLINE(  61)				int v1 = (fileHeaderLength + infoHeaderLength);
HXDLIN(  61)				data->b[10] = ( (unsigned char)((v1 & 255)) );
HXDLIN(  61)				data->b[11] = ( (unsigned char)(((v1 >> 8) & 255)) );
HXDLIN(  61)				data->b[12] = ( (unsigned char)(((v1 >> 16) & 255)) );
HXDLIN(  61)				data->b[13] = ( (unsigned char)((::hx::UShr(v1,24) & 255)) );
            			}
HXLINE(  62)			position = 14;
            		}
HXLINE(  65)		{
...
HXLINE( 172)						readPosition = ((((image->height - 1) - (_g1 - 1)) * 4) * image->width);
HXLINE( 174)						{
...
HXLINE( 119)						readPosition = ((((image->height - 1) - (_g7 - 1)) * 4) * image->width);
HXLINE( 121)						{
...
HXLINE( 141)							readPosition = ((((image->height - 1) - (_g11 - 1)) * 4) * image->width);
HXLINE( 143)							{
