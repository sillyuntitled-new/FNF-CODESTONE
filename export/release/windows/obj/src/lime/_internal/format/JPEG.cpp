...
HXDLIN(  33)			if ((::hx::Mod(0,_this->bytesPerElement) != 0)) {
...
HXDLIN(  58)			if ((::hx::Mod(0,_this->bytesPerElement) != 0)) {
...
HXLINE( 112)				 ::Dynamic data =  ::Dynamic(::hx::Anon_obj::Create(4)
            					->setFixed(0,HX_("pixels",2d,ef,a9,8c),image->buffer->data->buffer)
...
HXLINE( 122)				 ::format::jpg::Writer_obj::__alloc( HX_CTX ,output)->write(data);
