...
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_115_convertToData,"lime._internal.graphics.ImageCanvasUtil","convertToData",0xc05d09a7,"lime._internal.graphics.ImageCanvasUtil.convertToData","lime/_internal/graphics/ImageCanvasUtil.hx",115,0x04a6dce0)
...
void ImageCanvasUtil_obj::convertToData( ::lime::graphics::Image image,::hx::Null< bool >  __o_clear){
            		bool clear = __o_clear.Default(false);
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_115_convertToData)
HXDLIN( 115)		image->type = ::lime::graphics::ImageType_obj::DATA_dyn();
            	}
...
HXLINE( 143)			tempData->copyChannel(alphaImage, ::lime::math::Rectangle_obj::__alloc( HX_CTX ,(sourceRect->x + alphaPoint->x),(sourceRect->y + alphaPoint->y),sourceRect->width,sourceRect->height), ::lime::math::Vector2_obj::__alloc( HX_CTX ,sourceRect->x,sourceRect->y),::lime::graphics::ImageChannel_obj::ALPHA_dyn(),::lime::graphics::ImageChannel_obj::ALPHA_dyn());
...
HXLINE( 152)				_hx_tmp6 = sourceImage->get_transparent();
            			}
            			else {
...
HXDLIN( 170)			 ::Dynamic _hx_tmp7 = sourceImage->buffer->get_src();
HXDLIN( 170)			int _hx_tmp8 = ::Std_obj::_hx_int((sourceRect->x + sourceImage->offsetX));
HXLINE( 171)			int _hx_tmp9 = ::Std_obj::_hx_int((sourceRect->y + sourceImage->offsetY));
HXDLIN( 171)			int _hx_tmp10 = ::Std_obj::_hx_int(sourceRect->width);
HXDLIN( 171)			int _hx_tmp11 = ::Std_obj::_hx_int(sourceRect->height);
HXDLIN( 171)			int _hx_tmp12 = ::Std_obj::_hx_int((destPoint->x + image->offsetX));
HXLINE( 172)			int _hx_tmp13 = ::Std_obj::_hx_int((destPoint->y + image->offsetY));
HXDLIN( 172)			int _hx_tmp14 = ::Std_obj::_hx_int(sourceRect->width);
HXLINE( 170)			image1(_hx_tmp7,_hx_tmp8,_hx_tmp9,_hx_tmp10,_hx_tmp11,_hx_tmp12,_hx_tmp13,_hx_tmp14,::Std_obj::_hx_int(sourceRect->height));
            		}
