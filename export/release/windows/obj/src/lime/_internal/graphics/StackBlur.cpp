...
HXLINE(  64)		int w1 = (width - 1);
HXLINE(  65)		int h1 = (height - 1);
...
;
HXLINE( 117)				{
HXLINE( 117)					int _g2 = 1;
HXDLIN( 117)					while((_g2 < rxp1)){
HXLINE( 117)						_g2 = (_g2 + 1);
HXDLIN( 117)						int i1 = (_g2 - 1);
HXLINE( 119)						int p1;
HXDLIN( 119)						if ((w1 < i1)) {
HXLINE( 119)							p1 = w1;
            						}
...
HXDLIN( 128)					while((_g3 < width)){
HXLINE( 128)						_g3 = (_g3 + 1);
HXLINE( 130)						{
HXLINE( 130)							yi = (yi + 1);
HXDLIN( 130)							 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (yi - 1)),::hx::UShr((r * mtx),stx));
            						}
HXLINE( 131)						{
HXLINE( 131)							yi = (yi + 1);
HXDLIN( 131)							 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (yi - 1)),::hx::UShr((g * mtx),stx));
            						}
HXLINE( 132)						{
HXLINE( 132)							yi = (yi + 1);
HXDLIN( 132)							 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (yi - 1)),::hx::UShr((b * mtx),stx));
            						}
HXLINE( 133)						{
HXLINE( 133)							yi = (yi + 1);
HXDLIN( 133)							 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (yi - 1)),::hx::UShr((a * mtx),stx));
            						}
HXLINE( 134)						int p2;
HXDLIN( 134)						p = (((_g3 - 1) + radiusX) + 1);
HXDLIN( 134)						if ((p < w1)) {
HXLINE( 134)							p2 = p;
            						}
            						else {
...
HXLINE( 141)				yw = (yw + width);
HXLINE( 143)				y = (y - 1);
            			} while((y > 0));
;
HXLINE( 147)			{
HXLINE( 147)				int _g4 = 0;
HXDLIN( 147)				while((_g4 < width)){
HXLINE( 147)					_g4 = (_g4 + 1);
HXDLIN( 147)					int x = (_g4 - 1);
HXLINE( 149)					yi = (x << 2);
...
HXDLIN( 155)						while((_g5 < ryp1)){
HXLINE( 155)							_g5 = (_g5 + 1);
HXLINE( 157)							sy->r = pr;
HXLINE( 158)							sy->g = pg;
HXLINE( 159)							sy->b = pb;
HXLINE( 160)							sy->a = pa;
...
HXLINE( 163)					yp = width;
HXLINE( 164)					{
HXLINE( 164)						int _g6 = 1;
HXDLIN( 164)						int _g7 = (radiusY + 1);
...
HXLINE( 171)							sy = sy->n;
HXLINE( 172)							if (((_g6 - 1) < h1)) {
HXLINE( 174)								yp = (yp + width);
            							}
            						}
            					}
HXLINE( 177)					yi = x;
...
HXDLIN( 182)						while((_g8 < height)){
HXLINE( 182)							_g8 = (_g8 + 1);
HXLINE( 184)							p = (yi << 2);
HXLINE( 185)							{
HXLINE( 185)								pa = ::hx::UShr((a * mty),sty);
HXDLIN( 185)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 3)),pa);
            							}
HXLINE( 186)							if ((pa > 0)) {
HXLINE( 188)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + p),::hx::UShr((r * mty),sty));
HXLINE( 189)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 1)),::hx::UShr((g * mty),sty));
HXLINE( 190)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 2)),::hx::UShr((b * mty),sty));
            							}
            							else {
...
HXDLIN( 194)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + p),val);
            							}
HXLINE( 196)							int p3;
HXDLIN( 196)							p = ((_g8 - 1) + ryp1);
HXDLIN( 196)							if ((p < h1)) {
HXLINE( 196)								p3 = p;
            							}
            							else {
...
HXLINE( 201)							si = si->n;
HXLINE( 202)							yi = (yi + width);
            						}
            					}
            					else {
HXLINE( 207)						int _g9 = 0;
HXDLIN( 207)						while((_g9 < height)){
HXLINE( 207)							_g9 = (_g9 + 1);
HXLINE( 209)							p = (yi << 2);
HXLINE( 210)							{
HXLINE( 210)								pa = ::hx::UShr((a * mty),sty);
HXDLIN( 210)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 3)),pa);
            							}
HXLINE( 211)							if ((pa > 0)) {
HXLINE( 213)								f = (( (Float)(255) ) / ( (Float)(pa) ));
HXLINE( 214)								pr = ::Std_obj::_hx_int((( (Float)(::hx::UShr((r * mty),sty)) ) * f));
HXLINE( 215)								pg = ::Std_obj::_hx_int((( (Float)(::hx::UShr((g * mty),sty)) ) * f));
HXLINE( 216)								pb = ::Std_obj::_hx_int((( (Float)(::hx::UShr((b * mty),sty)) ) * f));
HXLINE( 217)								{
HXLINE( 217)									int val1;
...
HXDLIN( 217)									 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + p),val1);
            								}
HXLINE( 218)								{
HXLINE( 218)									int val2;
...
HXDLIN( 218)									 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 1)),val2);
            								}
HXLINE( 219)								{
HXLINE( 219)									int val3;
...
HXDLIN( 219)									 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 2)),val3);
            								}
            							}
            							else {
HXLINE( 223)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 2)),0);
HXDLIN( 223)								int val4 = 0;
HXDLIN( 223)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + (p + 1)),val4);
HXDLIN( 223)								 ::__hxcpp_memory_set_byte(px->buffer->b,(px->byteOffset + p),val4);
            							}
HXLINE( 225)							int p4;
HXDLIN( 225)							p = ((_g9 - 1) + ryp1);
HXDLIN( 225)							if ((p < h1)) {
HXLINE( 225)								p4 = p;
            							}
            							else {
