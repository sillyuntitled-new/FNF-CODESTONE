...
HXLINE( 521)				this->_hx___onGamepadConnect(( ( ::lime::ui::Gamepad)(gamepad->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) ));
            			}
            		}
...
HXLINE( 528)				this->_hx___onJoystickConnect(( ( ::lime::ui::Joystick)(joystick->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) ));
            			}
            		}
