...
HXLINE( 418)			sourceRect->width = (sourceRect->width + sourceRect->x);
HXLINE( 419)			sourceRect->x = ( (Float)(0) );
            		}
HXLINE( 422)		if ((sourceRect->y < 0)) {
HXLINE( 424)			sourceRect->height = (sourceRect->height + sourceRect->y);
...
HXLINE( 433)			sourceRect->width = (sourceRect->width + destPoint->x);
HXLINE( 434)			sourceRect->x = (sourceRect->x - destPoint->x);
HXLINE( 435)			destPoint->x = ( (Float)(0) );
            		}
HXLINE( 438)		if ((destPoint->y < 0)) {
HXLINE( 440)			sourceRect->height = (sourceRect->height + destPoint->y);
HXLINE( 441)			sourceRect->y = (sourceRect->y - destPoint->y);
...
HXLINE( 791)						return bgra;
HXLINE( 789)						goto _hx_goto_11;
            					}
            					/* default */{
HXLINE( 793)						int rgba1 = 0;
HXDLIN( 793)						rgba1 = ((((((::hx::UShr(color,16) & 255) & 255) << 24) | (((::hx::UShr(color,8) & 255) & 255) << 16)) | (((color & 255) & 255) << 8)) | ((::hx::UShr(color,24) & 255) & 255));
...
HXLINE( 833)						return bgra;
HXLINE( 831)						goto _hx_goto_13;
            					}
            					/* default */{
HXLINE( 835)						int rgba1 = 0;
HXDLIN( 835)						rgba1 = ((((((::hx::UShr(color,16) & 255) & 255) << 24) | (((::hx::UShr(color,8) & 255) & 255) << 16)) | (((color & 255) & 255) << 8)) | ((::hx::UShr(color,24) & 255) & 255));
...
HXLINE(1390)			r->width = (r->width - -(r->x));
...
HXLINE(1398)			r->height = (r->height - -(r->y));
...
HXLINE(1406)			r->width = (r->width - ((r->x + r->width) - ( (Float)(this->width) )));
HXLINE(1408)			if ((r->width <= 0)) {
HXLINE(1408)				return null();
            			}
            		}
HXLINE(1411)		if (((r->y + r->height) >= this->height)) {
HXLINE(1413)			r->height = (r->height - ((r->y + r->height) - ( (Float)(this->height) )));
...
HXDLIN(1481)			{
HXLINE(1481)				newByteLength = bufferByteLength;
...
HXDLIN(1559)				{
HXLINE(1559)					newByteLength = bufferByteLength;
...
HXLINE(1576)				 ::haxe::io::Bytes bytes = ::sys::io::File_obj::getBytes(path);
HXLINE(1578)				 ::haxe::ds::List png =  ::format::png::Reader_obj::__alloc( HX_CTX , ::haxe::io::BytesInput_obj::__alloc( HX_CTX ,bytes,0,bytes->length))->read();
HXLINE(1579)				 ::haxe::io::Bytes data = ::format::png::Tools_obj::extract32(png,null(),null());
HXLINE(1580)				 ::Dynamic header = ::format::png::Tools_obj::getHeader(png);
HXLINE(1582)				 ::haxe::io::Bytes buffer3 = ::haxe::io::Bytes_obj::ofData(data->b);
HXDLIN(1582)				 ::lime::utils::ArrayBufferView this2;
HXDLIN(1582)				if (::hx::IsNotNull( buffer3 )) {
HXLINE(1582)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1582)					if ((::hx::Mod(0,_this1->bytesPerElement) != 0)) {
HXLINE(1582)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN(1582)					int bufferByteLength1 = buffer3->length;
HXDLIN(1582)					int newByteLength1 = bufferByteLength1;
HXDLIN(1582)					{
HXLINE(1582)						newByteLength1 = bufferByteLength1;
HXDLIN(1582)						if ((::hx::Mod(bufferByteLength1,_this1->bytesPerElement) != 0)) {
HXLINE(1582)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN(1582)						if ((newByteLength1 < 0)) {
HXLINE(1582)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
HXDLIN(1582)					_this1->buffer = buffer3;
HXDLIN(1582)					_this1->byteOffset = 0;
HXDLIN(1582)					_this1->byteLength = newByteLength1;
HXDLIN(1582)					_this1->length = ::Std_obj::_hx_int((( (Float)(newByteLength1) ) / ( (Float)(_this1->bytesPerElement) )));
HXDLIN(1582)					this2 = _this1;
            				}
            				else {
HXLINE(1582)					HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            				}
HXDLIN(1582)				 ::lime::utils::ArrayBufferView data1 = this2;
HXLINE(1583)				int length = (( (int)(header->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic)) ) * ( (int)(header->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic)) ));
HXLINE(1586)				{
HXLINE(1586)					int _g = 0;
HXDLIN(1586)					while((_g < length)){
HXLINE(1586)						_g = (_g + 1);
HXDLIN(1586)						int i = (_g - 1);
HXLINE(1588)						 ::Dynamic b = ( ::__hxcpp_memory_get_byte(data1->buffer->b,(data1->byteOffset + (i * 4))) & 255);
HXLINE(1589)						 ::Dynamic g = ( ::__hxcpp_memory_get_byte(data1->buffer->b,(data1->byteOffset + ((i * 4) + 1))) & 255);
HXLINE(1590)						 ::Dynamic r = ( ::__hxcpp_memory_get_byte(data1->buffer->b,(data1->byteOffset + ((i * 4) + 2))) & 255);
HXLINE(1591)						 ::Dynamic a = ( ::__hxcpp_memory_get_byte(data1->buffer->b,(data1->byteOffset + ((i * 4) + 3))) & 255);
HXLINE(1593)						 ::__hxcpp_memory_set_byte(data1->buffer->b,(data1->byteOffset + (i * 4)),( (int)(r) ));
HXLINE(1594)						 ::__hxcpp_memory_set_byte(data1->buffer->b,(data1->byteOffset + ((i * 4) + 1)),( (int)(g) ));
HXLINE(1595)						 ::__hxcpp_memory_set_byte(data1->buffer->b,(data1->byteOffset + ((i * 4) + 2)),( (int)(b) ));
HXLINE(1596)						 ::__hxcpp_memory_set_byte(data1->buffer->b,(data1->byteOffset + ((i * 4) + 3)),( (int)(a) ));
            					}
            				}
HXLINE(1599)				buffer =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,data1,header->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic),header->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic),null(),null());
            			} catch( ::Dynamic _hx_e) {
...
HXLINE(1037)		return  ::lime::net::_HTTPRequest_lime_graphics_Image_obj::__alloc( HX_CTX ,null())->load(path)->then( ::Dynamic(new _hx_Closure_0()));
            	}
