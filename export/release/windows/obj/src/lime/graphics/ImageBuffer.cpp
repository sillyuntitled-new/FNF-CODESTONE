...
HXLINE( 175)			 ::lime::utils::ArrayBufferView this1;
HXDLIN( 175)			if (::hx::IsNotNull( bytes )) {
HXLINE( 175)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 175)				if ((::hx::Mod(0,_this->bytesPerElement) != 0)) {
...
HXDLIN( 175)				{
HXLINE( 175)					newByteLength = bufferByteLength;
