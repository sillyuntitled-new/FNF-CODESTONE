...
HX_LOCAL_STACK_FRAME(_hx_pos_cd8fe9e91aca1c90_484_get_dash,"lime.graphics.cairo.Cairo","get_dash",0xed05b631,"lime.graphics.cairo.Cairo.get_dash","lime/graphics/cairo/Cairo.hx",484,0x0918a4c7)
...
::Array< Float > Cairo_obj::get_dash(){
            	HX_STACKFRAME(&_hx_pos_cd8fe9e91aca1c90_484_get_dash)
HXDLIN( 484)		return ( (::Array< Float >)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_get_dash(::hx::DynamicPtr(this->handle))) )) );
            	}
