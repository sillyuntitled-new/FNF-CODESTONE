...
HXLINE( 297)			this->a = (this->a * cos);
HXLINE( 298)			this->d = (this->d * cos);
            		}
            		else {
...
HXLINE( 366)			this->b = (this->b * -(norm));
HXLINE( 367)			this->c = (this->c * -(norm));
...
HXLINE( 435)		this->a = (this->a * sx);
HXLINE( 436)		this->b = (this->b * sy);
HXLINE( 437)		this->c = (this->c * sx);
HXLINE( 438)		this->d = (this->d * sy);
HXLINE( 439)		this->tx = (this->tx * sx);
HXLINE( 440)		this->ty = (this->ty * sy);
            	}
...
HXLINE( 574)		this->tx = (this->tx + dx);
HXLINE( 575)		this->ty = (this->ty + dy);
            	}
