...
HXLINE( 175)		this->x = (this->x - dx);
HXLINE( 176)		this->width = (this->width + (dx * ( (Float)(2) )));
HXLINE( 177)		this->y = (this->y - dy);
HXLINE( 178)		this->height = (this->height + (dy * ( (Float)(2) )));
            	}
...
HXLINE( 266)		this->x = (this->x + dx);
HXLINE( 267)		this->y = (this->y + dy);
            	}
...
HXLINE( 276)		this->x = (this->x + vector->x);
HXLINE( 277)		this->y = (this->y + vector->y);
            	}
...
HXLINE( 375)		this->width = (this->width - (l - this->x));
HXLINE( 376)		this->x = l;
HXLINE( 377)		return l;
            	}
...
HXLINE( 410)		this->height = (this->height - (t - this->y));
HXLINE( 411)		this->y = t;
HXLINE( 412)		return t;
            	}
