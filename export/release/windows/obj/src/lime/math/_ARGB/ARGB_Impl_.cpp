...
HXLINE( 152)		switch((int)(format)){
            			case (int)0: {
HXLINE( 161)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),(::hx::UShr(this1,16) & 255));
HXLINE( 162)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),(::hx::UShr(this1,8) & 255));
HXLINE( 163)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),(this1 & 255));
HXLINE( 164)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),(::hx::UShr(this1,24) & 255));
            			}
            			break;
            			case (int)1: {
HXLINE( 167)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),(::hx::UShr(this1,24) & 255));
HXLINE( 168)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),(::hx::UShr(this1,16) & 255));
HXLINE( 169)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),(::hx::UShr(this1,8) & 255));
HXLINE( 170)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),(this1 & 255));
            			}
            			break;
            			case (int)2: {
HXLINE( 155)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),(this1 & 255));
HXLINE( 156)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),(::hx::UShr(this1,8) & 255));
HXLINE( 157)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),(::hx::UShr(this1,16) & 255));
HXLINE( 158)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),(::hx::UShr(this1,24) & 255));
            			}
            			break;
            		}
            	}
