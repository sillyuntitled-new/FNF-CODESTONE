...
HXLINE( 208)		switch((int)(format)){
            			case (int)0: {
HXLINE( 217)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),(::hx::UShr(this1,24) & 255));
HXLINE( 218)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),(::hx::UShr(this1,16) & 255));
HXLINE( 219)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),(::hx::UShr(this1,8) & 255));
HXLINE( 220)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),(this1 & 255));
            			}
            			break;
            			case (int)1: {
HXLINE( 223)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),(this1 & 255));
HXLINE( 224)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),(::hx::UShr(this1,24) & 255));
HXLINE( 225)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),(::hx::UShr(this1,16) & 255));
HXLINE( 226)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),(::hx::UShr(this1,8) & 255));
            			}
            			break;
            			case (int)2: {
HXLINE( 211)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + offset),(::hx::UShr(this1,8) & 255));
HXLINE( 212)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 1)),(::hx::UShr(this1,16) & 255));
HXLINE( 213)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 2)),(::hx::UShr(this1,24) & 255));
HXLINE( 214)				 ::__hxcpp_memory_set_byte(data->buffer->b,(data->byteOffset + (offset + 3)),(this1 & 255));
            			}
            			break;
            		}
            	}
