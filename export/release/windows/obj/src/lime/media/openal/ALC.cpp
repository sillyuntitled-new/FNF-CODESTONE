...
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_136_getIntegerv,"lime.media.openal.ALC","getIntegerv",0x44f57d42,"lime.media.openal.ALC.getIntegerv","lime/media/openal/ALC.hx",136,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_150_getString,"lime.media.openal.ALC","getString",0x9e1cd69b,"lime.media.openal.ALC.getString","lime/media/openal/ALC.hx",150,0x4354dabb)
...
::Array< int > ALC_obj::getIntegerv( ::Dynamic device,int param,int size){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_136_getIntegerv)
HXDLIN( 136)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_integerv(::hx::DynamicPtr(device),param,size)) );
            	}
...
::String ALC_obj::getString( ::Dynamic device,int param){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_150_getString)
HXDLIN( 150)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_string(::hx::DynamicPtr(device),param)) );
            	}
