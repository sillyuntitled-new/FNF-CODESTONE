...
HX_LOCAL_STACK_FRAME(_hx_pos_66fce3bdaaf914c3_407_fromBytes,"lime.net._HTTPRequest_lime_media_AudioBuffer","fromBytes",0x6d972591,"lime.net._HTTPRequest_lime_media_AudioBuffer.fromBytes","lime/media/AudioBuffer.hx",407,0xf6fabaad)
namespace lime{
namespace net{
...
bool _HTTPRequest_lime_media_AudioBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic _HTTPRequest_lime_media_AudioBuffer_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_66fce3bdaaf914c3_407_fromBytes)
HXDLIN( 407)		return ::lime::media::AudioBuffer_obj::fromBytes(bytes);
            	}
