...
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_63_escape,"lime.net.curl.CURL","escape",0x44306d6b,"lime.net.curl.CURL.escape","lime/net/curl/CURL.hx",63,0x82d3899b)
...
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_240_unescape,"lime.net.curl.CURL","unescape",0xe7c56b04,"lime.net.curl.CURL.unescape","lime/net/curl/CURL.hx",240,0x82d3899b)
...
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_227_strerror,"lime.net.curl.CURL","strerror",0x9bdff9e1,"lime.net.curl.CURL.strerror","lime/net/curl/CURL.hx",227,0x82d3899b)
HX_LOCAL_STACK_FRAME(_hx_pos_eb990c46aed3e3e1_253_version,"lime.net.curl.CURL","version",0x3f0069ee,"lime.net.curl.CURL.version","lime/net/curl/CURL.hx",253,0x82d3899b)
...
::String CURL_obj::escape(::String url,int length){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_63_escape)
HXDLIN(  63)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_curl_easy_escape(::hx::DynamicPtr(this->handle),url,length)) );
            	}
...
::String CURL_obj::unescape(::String url,int inLength,int outLength){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_240_unescape)
HXDLIN( 240)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_curl_easy_unescape(::hx::DynamicPtr(this->handle),url,inLength,outLength)) );
            	}
...
::String CURL_obj::strerror(int code){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_227_strerror)
HXDLIN( 227)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_curl_easy_strerror(code)) );
            	}
...
::String CURL_obj::version(){
            	HX_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_253_version)
HXDLIN( 253)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_curl_version()) );
            	}
