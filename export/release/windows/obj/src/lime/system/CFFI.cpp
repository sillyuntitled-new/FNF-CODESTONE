...
HX_LOCAL_STACK_FRAME(_hx_pos_9b11a74d7222574a_255___loaderTrace,"lime.system.CFFI","__loaderTrace",0x9278b410,"lime.system.CFFI.__loaderTrace","lime/system/CFFI.hx",255,0x441ad672)
HX_LOCAL_STACK_FRAME(_hx_pos_9b11a74d7222574a_326___sysName,"lime.system.CFFI","__sysName",0x178f5196,"lime.system.CFFI.__sysName","lime/system/CFFI.hx",326,0x441ad672)
...
void CFFI_obj::_hx___loaderTrace(::String message){
            	HX_STACKFRAME(&_hx_pos_9b11a74d7222574a_255___loaderTrace)
HXDLIN( 255)		if (::hx::IsNotNull( ::Sys_obj::getEnv(HX_("OPENFL_LOAD_DEBUG",a9,1b,ff,9b)) )) {
...
::String CFFI_obj::_hx___sysName(){
            	HX_STACKFRAME(&_hx_pos_9b11a74d7222574a_326___sysName)
HXDLIN( 326)		return ( (::String)(::cpp::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("sys_string",03,f9,de,46),0)()) );
            	}
