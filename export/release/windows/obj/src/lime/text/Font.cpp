...
HX_LOCAL_STACK_FRAME(_hx_pos_51012fd6257f8a4a_156_loadFromFile,"lime.text.Font","loadFromFile",0x5ed36963,"lime.text.Font.loadFromFile","lime/text/Font.hx",156,0x3be57807)
...
HXLINE( 114)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_font_outline_decompose(::hx::DynamicPtr(this->src),20480)) );
            	}
...
HXDLIN( 194)		return ( (::Array< int >)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_font_get_glyph_indices(::hx::DynamicPtr(this->src),characters)) )) );
            	}
...
HXLINE( 232)			int width = (((( (int)(bytes->b->__get(4)) ) | (( (int)(bytes->b->__get(5)) ) << 8)) | (( (int)(bytes->b->__get(6)) ) << 16)) | (( (int)(bytes->b->__get(7)) ) << 24));
HXLINE( 234)			int height = (((( (int)(bytes->b->__get(8)) ) | (( (int)(bytes->b->__get(9)) ) << 8)) | (( (int)(bytes->b->__get(10)) ) << 16)) | (( (int)(bytes->b->__get(11)) ) << 24));
HXLINE( 236)			int x = (((( (int)(bytes->b->__get(12)) ) | (( (int)(bytes->b->__get(13)) ) << 8)) | (( (int)(bytes->b->__get(14)) ) << 16)) | (( (int)(bytes->b->__get(15)) ) << 24));
HXLINE( 238)			int y = (((( (int)(bytes->b->__get(16)) ) | (( (int)(bytes->b->__get(17)) ) << 8)) | (( (int)(bytes->b->__get(18)) ) << 16)) | (( (int)(bytes->b->__get(19)) ) << 24));
HXLINE( 241)			 ::haxe::io::Bytes data = bytes->sub(20,(width * height));
HXLINE( 244)			 ::lime::utils::ArrayBufferView this1;
HXDLIN( 244)			if (::hx::IsNotNull( data )) {
HXLINE( 244)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 244)				if ((::hx::Mod(0,_this->bytesPerElement) != 0)) {
...
HXDLIN( 244)				{
HXLINE( 244)					newByteLength = bufferByteLength;
...
HXLINE( 245)			 ::lime::graphics::Image image =  ::lime::graphics::Image_obj::__alloc( HX_CTX , ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,width,height,8,null()),0,0,width,height,null(),null());
...
HXLINE( 270)				glyphList->push(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)());
            			}
            		}
...
HXLINE( 292)			int count = (((( (int)(bytes->b->__get(0)) ) | (( (int)(bytes->b->__get(1)) ) << 8)) | (( (int)(bytes->b->__get(2)) ) << 16)) | (( (int)(bytes->b->__get(3)) ) << 24));
HXLINE( 293)			bytesPosition = 4;
...
HXDLIN( 385)						int _g3 = height;
HXDLIN( 385)						while((_g2 < _g3)){
HXLINE( 385)							_g2 = (_g2 + 1);
HXLINE( 387)							dataPosition = ((((_g2 - 1) + offsetY) * bufferWidth) + offsetX);
...
HXLINE( 409)			 ::lime::utils::ArrayBufferView this1;
...
HXDLIN( 409)				if ((::hx::Mod(0,_this->bytesPerElement) != 0)) {
...
HXDLIN( 409)				{
HXLINE( 409)					newByteLength = bufferByteLength;
...
HXLINE( 158)			return null();
            	...
            	HX_GC_STACKFRAME(&_hx_pos_51012fd6257f8a4a_156_loadFromFile)
HXDLIN( 156)		return  ::lime::net::_HTTPRequest_lime_text_Font_obj::__alloc( HX_CTX ,null())->load(path)->then( ::Dynamic(new _hx_Closure_0()));
            	}
