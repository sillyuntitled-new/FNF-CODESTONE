...
HX_LOCAL_STACK_FRAME(_hx_pos_8982c1de16066810_87_glyphToString,"lime.text.harfbuzz._HBFont.HBFont_Impl_","glyphToString",0xb4ce8cdf,"lime.text.harfbuzz._HBFont.HBFont_Impl_.glyphToString","lime/text/harfbuzz/HBFont.hx",87,0x4233424e)
...
::String HBFont_Impl__obj::glyphToString( ::Dynamic this1,int codepoint){
            	HX_STACKFRAME(&_hx_pos_8982c1de16066810_87_glyphToString)
HXDLIN(  87)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_font_glyph_to_string(::hx::DynamicPtr(this1),codepoint)) );
            	}
