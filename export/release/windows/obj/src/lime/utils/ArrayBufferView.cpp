...
HXDLIN( 174)						if (((in_byteOffset + newByteLength) > bufferByteLength)) {
HXLINE( 174)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
...
HXDLIN( 177)						if (((in_byteOffset1 + newByteLength1) > bufferByteLength1)) {
HXLINE( 177)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
...
HXDLIN( 180)						if (((in_byteOffset2 + newByteLength2) > bufferByteLength2)) {
HXLINE( 180)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
...
HXDLIN( 183)						if (((in_byteOffset3 + newByteLength3) > bufferByteLength3)) {
HXLINE( 183)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
...
HXDLIN( 186)						if (((in_byteOffset4 + newByteLength4) > bufferByteLength4)) {
HXLINE( 186)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
...
HXDLIN( 189)						if (((in_byteOffset5 + newByteLength5) > bufferByteLength5)) {
HXLINE( 189)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
...
HXDLIN( 192)						if (((in_byteOffset6 + newByteLength6) > bufferByteLength6)) {
HXLINE( 192)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
...
HXDLIN( 195)						if (((in_byteOffset7 + newByteLength7) > bufferByteLength7)) {
HXLINE( 195)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
...
HXDLIN( 198)						if (((in_byteOffset8 + newByteLength8) > bufferByteLength8)) {
HXLINE( 198)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
...
HXLINE(  59)			int cloneLength = (srcData->length - srcByteOffset);
...
HXLINE(  99)			if (((in_byteOffset + newByteLength) > bufferByteLength)) {
...
HXLINE( 154)		int cloneLength = (src->length - srcByteOffset);
...
HXLINE( 380)					 ::__hxcpp_memory_set_float(this->buffer->b,((offset + i) * this->bytesPerElement),array->__get(i));
HXLINE( 381)					i = (i + 1);
            				}
            			}
            			break;
...
HXLINE( 387)					 ::__hxcpp_memory_set_double(this->buffer->b,((offset + i) * this->bytesPerElement),array->__get(i));
HXLINE( 388)					i = (i + 1);
            				}
            			}
            			break;
