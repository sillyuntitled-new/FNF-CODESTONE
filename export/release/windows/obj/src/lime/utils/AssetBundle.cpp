...
HX_LOCAL_STACK_FRAME(_hx_pos_1c6e87ef27a4e464_32_fromBytes,"lime.utils.AssetBundle","fromBytes",0x091e83cf,"lime.utils.AssetBundle.fromBytes","lime/utils/AssetBundle.hx",32,0xe7f27664)
HX_LOCAL_STACK_FRAME(_hx_pos_1c6e87ef27a4e464_39_fromFile,"lime.utils.AssetBundle","fromFile",0x7c52cb98,"lime.utils.AssetBundle.fromFile","lime/utils/AssetBundle.hx",39,0xe7f27664)
...
bool AssetBundle_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::utils::AssetBundle AssetBundle_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_GC_STACKFRAME(&_hx_pos_1c6e87ef27a4e464_32_fromBytes)
HXDLIN(  32)		return ::lime::utils::AssetBundle_obj::_hx___extractBundle( ::haxe::io::BytesInput_obj::__alloc( HX_CTX ,bytes,null(),null()));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AssetBundle_obj,fromBytes,return )
 ...
 ::lime::utils::AssetBundle AssetBundle_obj::fromFile(::String path){
            	HX_STACKFRAME(&_hx_pos_1c6e87ef27a4e464_39_fromFile)
HXDLIN(  39)		return ::lime::utils::AssetBundle_obj::_hx___extractBundle(::sys::io::File_obj::read(path,null()));
            	}
...
HXLINE(  63)				if (( (bool)(val->__Field(HX_("compressed",81,4c,da,67),::hx::paccDynamic)) )) {
HXLINE(  66)					::Dynamic this1 = bundle->data;
HXDLIN(  66)					::String key = ( (::String)(val->__Field(HX_("fileName",e7,5a,43,62),::hx::paccDynamic)) );
HXDLIN(  66)					( ( ::haxe::ds::StringMap)(this1) )->set(key,::lime::utils::_Bytes::Bytes_Impl__obj::decompress(( ( ::haxe::io::Bytes)(val->__Field(HX_("data",2a,56,63,42),::hx::paccDynamic)) ),::lime::utils::CompressionAlgorithm_obj::DEFLATE_dyn()));
            				}
            				else {
HXLINE(  70)					bundle->data->set(( (::String)(val->__Field(HX_("fileName",e7,5a,43,62),::hx::paccDynamic)) ), ::Dynamic(val->__Field(HX_("data",2a,56,63,42),::hx::paccDynamic)));
            				}
HXLINE(  72)				bundle->paths->push( ::Dynamic(val->__Field(HX_("fileName",e7,5a,43,62),::hx::paccDynamic)));
            			}
            		}
