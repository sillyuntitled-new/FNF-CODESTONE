...
HXLINE(  91)			while(( (bool)(keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  91)				::String key = ( (::String)(keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  93)				if (::StringTools_obj::startsWith(key,prefix)) {
HXLINE(  95)					this->audio->remove(key);
            				}
            			}
HXLINE(  99)			 ::Dynamic keys1 = this->font->keys();
HXLINE( 101)			while(( (bool)(keys1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 101)				::String key1 = ( (::String)(keys1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 103)				if (::StringTools_obj::startsWith(key1,prefix)) {
HXLINE( 105)					this->font->remove(key1);
            				}
            			}
HXLINE( 109)			 ::Dynamic keys2 = this->image->keys();
HXLINE( 111)			while(( (bool)(keys2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 111)				::String key2 = ( (::String)(keys2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 113)				if (::StringTools_obj::startsWith(key2,prefix)) {
HXLINE( 115)					this->image->remove(key2);
            				}
            			}
            		}
            	}
