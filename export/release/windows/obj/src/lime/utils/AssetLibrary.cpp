...
HXLINE(  72)		this->isCompressed = false;
...
HXLINE( 518)				return ::lime::app::Future_obj::withValue(::Type_obj::createInstance(this->classTypes->get(id),::cpp::VirtualArray_obj::__new(0)));
            			}
            			else {
...
HXLINE( 646)				this->bytesLoaded = (this->bytesLoaded + size);
            			}
            			else {
HXLINE( 650)				 ::Dynamic cache = this->bytesLoadedCache->get(id);
HXLINE( 652)				if (::hx::IsLess( cache,size )) {
HXLINE( 654)					this->bytesLoaded = (this->bytesLoaded + (( (int)(size) ) - ( (int)(cache) )));
            				}
            			}
...
HXLINE( 787)					int _hx_tmp2 = this->bytesTotal;
HXDLIN( 787)					this->bytesTotal = (_hx_tmp2 + this->sizes->get(id));
            				}
            			}
            		}
            	}
...
HXLINE( 958)					this->bytesLoaded = (this->bytesLoaded + (bytesLoaded - ( (int)(cache) )));
            				}
            			}
            			else {
HXLINE( 963)				this->bytesLoaded = (this->bytesLoaded + bytesLoaded);
            			}
...
void AssetLibrary_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(isCompressed,"isCompressed");
	HX_MARK_END_CLASS();
}
...
void AssetLibrary_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(isCompressed,"isCompressed");
}
...
::hx::Val AssetLibrary_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"isCompressed") ) { return ::hx::Val( isCompressed ); }
		break;
	case 13:
...
::hx::Val AssetLibrary_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"isCompressed") ) { isCompressed=inValue.Cast< bool >(); return inValue; }
		break;
	case 16:
...
static ::hx::StorageInfo AssetLibrary_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(AssetLibrary_obj,tag),HX_("tag",5a,5a,58,00)},
	{::hx::fsBool,(int)offsetof(AssetLibrary_obj,isCompressed),HX_("isCompressed",0b,75,f9,39)},
	{ ::hx::fsUnknown, 0, null()}
};
