...
HX_LOCAL_STACK_FRAME(_hx_pos_66fab05f10e06d2c_19_debug,"lime.utils.Log","debug",0x08fb4af3,"lime.utils.Log.debug","lime/utils/Log.hx",19,0x300eb2b2)
...
HX_LOCAL_STACK_FRAME(_hx_pos_66fab05f10e06d2c_66_print,"lime.utils.Log","print",0xfa6750cd,"lime.utils.Log.print","lime/utils/Log.hx",66,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_66fab05f10e06d2c_79_println,"lime.utils.Log","println",0xdf773c8f,"lime.utils.Log.println","lime/utils/Log.hx",79,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_66fab05f10e06d2c_91_verbose,"lime.utils.Log","verbose",0xccfd3822,"lime.utils.Log.verbose","lime/utils/Log.hx",91,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_66fab05f10e06d2c_103_warn,"lime.utils.Log","warn",0xf9125da6,"lime.utils.Log.warn","lime/utils/Log.hx",103,0x300eb2b2)
HX_LOCAL_STACK_FRAME(_hx_pos_66fab05f10e06d2c_15_boot,"lime.utils.Log","boot",0xeb3b7f92,"lime.utils.Log.boot","lime/utils/Log.hx",15,0x300eb2b2)
namespace lime{
namespace utils{
...
HXLINE( 121)		::Array< ::String > args = ::Sys_obj::args();
HXLINE( 122)		bool _hx_tmp;
HXDLIN( 122)		if (!((args->indexOf(HX_("-v",a9,27,00,00),null()) > -1))) {
HXLINE( 122)			_hx_tmp = (args->indexOf(HX_("-verbose",f5,e6,97,7f),null()) > -1);
            		}
            		else {
HXLINE( 122)			_hx_tmp = true;
            		}
HXDLIN( 122)		if (_hx_tmp) {
HXLINE( 124)			::lime::utils::Log_obj::level = 5;
            		}
            		else {
HXLINE( 132)			::lime::utils::Log_obj::level = 3;
            		}
            	}
...
void Log_obj::debug( ::Dynamic message, ::Dynamic info){
            	HX_STACKFRAME(&_hx_pos_66fab05f10e06d2c_19_debug)
HXDLIN(  19)		if ((::lime::utils::Log_obj::level >= 4)) {
HXLINE(  24)			::String message1 = ( (::String)(((HX_("[",5b,00,00,00) + info->__Field(HX_("className",a3,92,3d,dc),::hx::paccDynamic)) + HX_("] ",23,51,00,00))) );
HXDLIN(  24)			::Sys_obj::println(::Std_obj::string((message1 + ::Std_obj::string(message))));
            		}
            	}
...
HXDLIN(  31)		if ((::lime::utils::Log_obj::level >= 1)) {
HXLINE(  33)			if (::lime::utils::Log_obj::throwErrors) {
HXLINE(  38)				HX_STACK_DO_THROW(message);
            			}
            			else {
HXLINE(  43)				::String _hx_tmp = ( (::String)(((HX_("[",5b,00,00,00) + info->__Field(HX_("className",a3,92,3d,dc),::hx::paccDynamic)) + HX_("] ",23,51,00,00))) );
HXDLIN(  43)				::funkin::backend::_hx_system::Logs_obj::trace((_hx_tmp + ::Std_obj::string(message)),2,12,null());
            			}
            		}
            	}
...
HXDLIN(  53)		if ((::lime::utils::Log_obj::level >= 3)) {
HXLINE(  56)			::String _hx_tmp = ( (::String)(((HX_("[",5b,00,00,00) + info->__Field(HX_("className",a3,92,3d,dc),::hx::paccDynamic)) + HX_("] ",23,51,00,00))) );
HXDLIN(  56)			::funkin::backend::_hx_system::Logs_obj::trace((_hx_tmp + ::Std_obj::string(message)),0,12,null());
            		}
            	}
...
void Log_obj::print( ::Dynamic message){
            	HX_STACKFRAME(&_hx_pos_66fab05f10e06d2c_66_print)
HXDLIN(  66)		::Sys_obj::print(::Std_obj::string(message));
            	}
...
void Log_obj::println( ::Dynamic message){
            	HX_STACKFRAME(&_hx_pos_66fab05f10e06d2c_79_println)
HXDLIN(  79)		::Sys_obj::println(::Std_obj::string(message));
            	}
...
void Log_obj::verbose( ::Dynamic message, ::Dynamic info){
            	HX_STACKFRAME(&_hx_pos_66fab05f10e06d2c_91_verbose)
HXDLIN(  91)		if ((::lime::utils::Log_obj::level >= 5)) {
HXLINE(  94)			::String _hx_tmp = ( (::String)(((HX_("[",5b,00,00,00) + info->__Field(HX_("className",a3,92,3d,dc),::hx::paccDynamic)) + HX_("] ",23,51,00,00))) );
HXDLIN(  94)			::funkin::backend::_hx_system::Logs_obj::trace((_hx_tmp + ::Std_obj::string(message)),4,null(),null());
            		}
            	}
...
void Log_obj::warn( ::Dynamic message, ::Dynamic info){
            	HX_STACKFRAME(&_hx_pos_66fab05f10e06d2c_103_warn)
HXDLIN( 103)		if ((::lime::utils::Log_obj::level >= 2)) {
HXLINE( 106)			::String _hx_tmp = ( (::String)(((HX_("[",5b,00,00,00) + info->__Field(HX_("className",a3,92,3d,dc),::hx::paccDynamic)) + HX_("] ",23,51,00,00))) );
HXDLIN( 106)			::funkin::backend::_hx_system::Logs_obj::trace((_hx_tmp + ::Std_obj::string(message)),1,14,null());
            		}
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_66fab05f10e06d2c_15_boot)
HXDLIN(  15)		throwErrors = false;
            	}
}
