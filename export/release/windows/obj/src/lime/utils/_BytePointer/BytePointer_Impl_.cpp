...
HXLINE( 117)		 ::haxe::io::Bytes buffer = bytePointer->bytes;
...
HXDLIN( 117)		if (::hx::IsNotNull( buffer )) {
...
HXLINE( 128)		 ::haxe::io::Bytes buffer = bytePointer->bytes;
...
HXLINE( 139)		 ::haxe::io::Bytes buffer = bytePointer->bytes;
...
HXLINE( 150)		 ::haxe::io::Bytes buffer = bytePointer->bytes;
...
HXLINE( 161)		 ::haxe::io::Bytes buffer = bytePointer->bytes;
...
HXDLIN( 161)		if (::hx::IsNotNull( buffer )) {
...
HXLINE( 172)		 ::haxe::io::Bytes buffer = bytePointer->bytes;
...
HXDLIN( 172)		if (::hx::IsNotNull( buffer )) {
...
HXLINE( 183)		 ::haxe::io::Bytes buffer = bytePointer->bytes;
...
HXLINE( 194)		 ::haxe::io::Bytes buffer = bytePointer->bytes;
...
HXDLIN( 194)		if (::hx::IsNotNull( buffer )) {
