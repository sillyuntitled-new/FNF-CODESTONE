...
HX_LOCAL_STACK_FRAME(_hx_pos_ac34df134646625a_31_fromInt,"lime.utils._DataPointer.DataPointer_Impl_","fromInt",0xca24ece6,"lime.utils._DataPointer.DataPointer_Impl_.fromInt","lime/utils/DataPointer.hx",31,0x48d01ae3)
...
Float DataPointer_Impl__obj::fromInt(int value){
            	HX_STACKFRAME(&_hx_pos_ac34df134646625a_31_fromInt)
HXDLIN(  31)		return ::lime::utils::_DataPointer::DataPointer_Impl__obj::_new(( (Float)(value) ));
            	}
...
HXLINE( 155)		return ::lime::utils::_DataPointer::DataPointer_Impl__obj::_new(::lime::_internal::backend::native::NativeCFFI_obj::lime_data_pointer_offset(data,offset));
            	}
