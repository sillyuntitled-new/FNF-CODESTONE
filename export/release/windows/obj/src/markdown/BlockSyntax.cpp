...
HXLINE( 134)			::markdown::BlockSyntax_obj::syntaxes = ::Array_obj< ::Dynamic>::__new(12)->init(0, ::markdown::EmptyBlockSyntax_obj::__alloc( HX_CTX ))->init(1, ::markdown::BlockHtmlSyntax_obj::__alloc( HX_CTX ))->init(2, ::markdown::SetextHeaderSyntax_obj::__alloc( HX_CTX ))->init(3, ::markdown::HeaderSyntax_obj::__alloc( HX_CTX ))->init(4, ::markdown::CodeBlockSyntax_obj::__alloc( HX_CTX ))->init(5, ::markdown::GitHubCodeBlockSyntax_obj::__alloc( HX_CTX ))->init(6, ::markdown::BlockquoteSyntax_obj::__alloc( HX_CTX ))->init(7, ::markdown::HorizontalRuleSyntax_obj::__alloc( HX_CTX ))->init(8, ::markdown::UnorderedListSyntax_obj::__alloc( HX_CTX ))->init(9, ::markdown::OrderedListSyntax_obj::__alloc( HX_CTX ))->init(10, ::markdown::TableSyntax_obj::__alloc( HX_CTX ))->init(11, ::markdown::ParagraphSyntax_obj::__alloc( HX_CTX ));
            		}
...
HXDLIN(  98)		RE_CODE =  ::EReg_obj::__alloc( HX_CTX ,HX_("^```([^`]*)\\s*$",56,ee,02,a9),HX_("",00,00,00,00));
            	}
{
