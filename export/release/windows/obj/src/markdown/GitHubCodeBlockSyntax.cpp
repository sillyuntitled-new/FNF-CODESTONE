...
HXLINE( 373)		::String source = this->parseChildLines(parser)->join(HX_("\n",0a,00,00,00));
HXLINE( 375)		if (parser->document->codeBlockSyntaxes->exists(syntax)) {
HXLINE( 377)			code = ::markdown::ElementNode_obj::text(HX_("code",2d,b1,c4,41),( (::String)(parser->document->codeBlockSyntaxes->get(syntax)(source)) ));
            		}
            		else {
