...
HXLINE(  37)				_g->push(k->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)());
            			}
            		}
HXLINE(  38)		_g->sort(::markdown::HtmlRenderer_obj::sortAttributes_dyn());
HXLINE(  39)		{
HXLINE(  39)			int _g1 = 0;
HXDLIN(  39)			while((_g1 < _g->length)){
HXLINE(  39)				::String name = _g->__get(_g1);
HXDLIN(  39)				_g1 = (_g1 + 1);
HXLINE(  40)				{
HXLINE(  40)					 ::StringBuf _this3 = this->buffer;
HXDLIN(  40)					::String x1 = ((((HX_(" ",20,00,00,00) + name) + HX_("=\"",45,35,00,00)) + element->attributes->get(name)) + HX_("\"",22,00,00,00));
...
HXLINE(  45)					_this5->b = ::Array_obj< ::String >::fromData( _hx_array_data_2396a6cd_8,1);
            				}
            				else {
...
HXLINE(  48)					_this6->b = ::Array_obj< ::String >::fromData( _hx_array_data_2396a6cd_9,1);
            				}
            				else {
