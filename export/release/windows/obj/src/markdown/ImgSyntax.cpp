...
HXLINE( 452)			::Dynamic node = this->linkResolver(( ( ::markdown::TextNode)(state->children->__get(0)) )->text);
...
HXLINE( 495)			img->attributes->set(HX_("alt",29,f9,49,00),( ( ::markdown::TextNode)(state->children->__get(0)) )->text);
            		}
