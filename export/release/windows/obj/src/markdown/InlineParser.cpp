...
HXLINE(  96)		this->stack->push( ::markdown::TagState_obj::__alloc( HX_CTX ,0,0,null()));
...
HXLINE( 103)					_g = (_g + 1);
HXLINE( 104)					if (this->stack->__get((this->stack->length - (_g - 1))).StaticCast<  ::markdown::TagState >()->tryMatch(::hx::ObjectPtr<OBJ_>(this))) {
...
HXDLIN( 174)		this->pos = (this->pos + length);
            	}
...
HXLINE( 178)		this->pos = (this->pos + length);
