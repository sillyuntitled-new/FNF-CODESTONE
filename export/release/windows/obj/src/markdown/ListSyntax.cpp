...
HXLINE( 482)				items->push( ::markdown::ListItem_obj::__alloc( HX_CTX ,childLines->__get(0).StaticCast< ::Array< ::String > >()));
...
HXLINE( 561)						_g2 = (_g2 + 1);
HXLINE( 563)						if (::markdown::BlockSyntax_obj::RE_EMPTY->match(items->__get(i).StaticCast<  ::markdown::ListItem >()->lines->__get((len - (_g2 - 1))))) {
...
HXLINE( 620)					itemNodes->push( ::markdown::ElementNode_obj::__alloc( HX_CTX ,HX_("li",7d,5e,00,00),parser->document->parseInline(item->lines->__get(0))));
            				}
            			}
            		}
