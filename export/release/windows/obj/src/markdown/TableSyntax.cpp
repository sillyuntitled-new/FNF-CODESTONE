...
HXDLIN( 700)			index1[0] = (index1->__get(0) + 1);
...
HXDLIN( 704)			while((_g < lines->length)){
            				HX_BEGIN_LOCAL_FUNC_S4(::hx::LocalFunc,_hx_Closure_2,::Array< ::Dynamic>,cols, ::markdown::BlockParser,parser,::Array< int >,index1,::Array< ::String >,aligns) HXARGC(1)
            				::String _hx_run( ::EReg e){
...
HXLINE( 715)					::Array< int > index = index1;
HXDLIN( 715)					index[0] = (index->__get(0) + 1);
...
HXLINE( 708)				::Array< int > index1 = ::Array_obj< int >::fromData( _hx_array_data_b1d564f2_10,1);
HXLINE( 709)				::markdown::TableSyntax_obj::CELL_PATTERN->map(line, ::Dynamic(new _hx_Closure_2(cols,parser,index1,aligns)));
            			}
            		}
HXLINE( 720)		return  ::markdown::ElementNode_obj::__alloc( HX_CTX ,HX_("table",0e,b8,e3,0a),::Array_obj< ::Dynamic>::__new(2)->init(0, ::markdown::ElementNode_obj::__alloc( HX_CTX ,HX_("thead",94,73,86,0f),heads))->init(1, ::markdown::ElementNode_obj::__alloc( HX_CTX ,HX_("tbody",16,c5,96,0b),rows)));
            	}
