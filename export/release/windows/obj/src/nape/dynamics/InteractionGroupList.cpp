...
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_244_get_length,"nape.dynamics.InteractionGroupList","get_length",0x4c0c0efe,"nape.dynamics.InteractionGroupList.get_length","nape/dynamics/InteractionGroupList.hx",244,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_346_has,"nape.dynamics.InteractionGroupList","has",0xa27b812b,"nape.dynamics.InteractionGroupList.has","nape/dynamics/InteractionGroupList.hx",346,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_363_at,"nape.dynamics.InteractionGroupList","at",0xfc22f842,"nape.dynamics.InteractionGroupList.at","nape/dynamics/InteractionGroupList.hx",363,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_416_push,"nape.dynamics.InteractionGroupList","push",0x8eee66e9,"nape.dynamics.InteractionGroupList.push","nape/dynamics/InteractionGroupList.hx",416,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_447_unshift,"nape.dynamics.InteractionGroupList","unshift",0x0353e1da,"nape.dynamics.InteractionGroupList.unshift","nape/dynamics/InteractionGroupList.hx",447,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_478_pop,"nape.dynamics.InteractionGroupList","pop",0xa2819f62,"nape.dynamics.InteractionGroupList.pop","nape/dynamics/InteractionGroupList.hx",478,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_519_shift,"nape.dynamics.InteractionGroupList","shift",0x33400493,"nape.dynamics.InteractionGroupList.shift","nape/dynamics/InteractionGroupList.hx",519,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_564_add,"nape.dynamics.InteractionGroupList","add",0xa27633f2,"nape.dynamics.InteractionGroupList.add","nape/dynamics/InteractionGroupList.hx",564,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_576_remove,"nape.dynamics.InteractionGroupList","remove",0x86e09313,"nape.dynamics.InteractionGroupList.remove","nape/dynamics/InteractionGroupList.hx",576,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_614_clear,"nape.dynamics.InteractionGroupList","clear",0xff78899e,"nape.dynamics.InteractionGroupList.clear","nape/dynamics/InteractionGroupList.hx",614,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_633_empty,"nape.dynamics.InteractionGroupList","empty",0x26f7529e,"nape.dynamics.InteractionGroupList.empty","nape/dynamics/InteractionGroupList.hx",633,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_647_iterator,"nape.dynamics.InteractionGroupList","iterator",0x54f8d27d,"nape.dynamics.InteractionGroupList.iterator","nape/dynamics/InteractionGroupList.hx",647,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_662_copy,"nape.dynamics.InteractionGroupList","copy",0x865210c4,"nape.dynamics.InteractionGroupList.copy","nape/dynamics/InteractionGroupList.hx",662,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_684_merge,"nape.dynamics.InteractionGroupList","merge",0xbce3bac9,"nape.dynamics.InteractionGroupList.merge","nape/dynamics/InteractionGroupList.hx",684,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_702_toString,"nape.dynamics.InteractionGroupList","toString",0xf9cd593b,"nape.dynamics.InteractionGroupList.toString","nape/dynamics/InteractionGroupList.hx",702,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_732_foreach,"nape.dynamics.InteractionGroupList","foreach",0x6484fbdb,"nape.dynamics.InteractionGroupList.foreach","nape/dynamics/InteractionGroupList.hx",732,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_779_filter,"nape.dynamics.InteractionGroupList","filter",0x078d1687,"nape.dynamics.InteractionGroupList.filter","nape/dynamics/InteractionGroupList.hx",779,0x068b827f)
HX_LOCAL_STACK_FRAME(_hx_pos_6aeac6de7555f0ba_304_fromArray,"nape.dynamics.InteractionGroupList","fromArray",0x4b714c60,"nape.dynamics.InteractionGroupList.fromArray","nape/dynamics/InteractionGroupList.hx",304,0x068b827f)
namespace nape{
namespace dynamics{
...
bool InteractionGroupList_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2501ed67;
}
...
HXLINE( 418)			HX_STACK_DO_THROW(((HX_("Error: ",4e,a8,5b,b7) + HX_("InteractionGroup",2d,2e,ee,3f)) + HX_("List is immutable",6e,b9,49,ba)));
            		}
...
HXLINE( 449)			HX_STACK_DO_THROW(((HX_("Error: ",4e,a8,5b,b7) + HX_("InteractionGroup",2d,2e,ee,3f)) + HX_("List is immutable",6e,b9,49,ba)));
            		}
...
HXLINE( 480)			HX_STACK_DO_THROW(((HX_("Error: ",4e,a8,5b,b7) + HX_("InteractionGroup",2d,2e,ee,3f)) + HX_("List is immutable",6e,b9,49,ba)));
            		}
...
HXLINE( 489)		 ::zpp_nape::dynamics::ZPP_InteractionGroup ret = null();
...
HXLINE( 498)			 ::zpp_nape::util::ZNPNode_ZPP_InteractionGroup ite;
...
HXLINE( 498)				 ::zpp_nape::util::ZNPList_ZPP_InteractionGroup ite1 = this->zpp_inner->inner;
HXDLIN( 498)				this->zpp_inner->valmod();
HXDLIN( 498)				if (this->zpp_inner->zip_length) {
HXLINE( 498)					this->zpp_inner->zip_length = false;
HXDLIN( 498)					this->zpp_inner->user_length = this->zpp_inner->inner->length;
...
HXLINE( 521)			HX_STACK_DO_THROW(((HX_("Error: ",4e,a8,5b,b7) + HX_("InteractionGroup",2d,2e,ee,3f)) + HX_("List is immutable",6e,b9,49,ba)));
            		}
...
HXLINE( 530)		 ::zpp_nape::dynamics::ZPP_InteractionGroup ret = null();
...
HXLINE( 533)			 ::zpp_nape::util::ZNPNode_ZPP_InteractionGroup ite;
...
HXLINE( 533)				 ::zpp_nape::util::ZNPList_ZPP_InteractionGroup ite1 = this->zpp_inner->inner;
HXDLIN( 533)				this->zpp_inner->valmod();
HXDLIN( 533)				if (this->zpp_inner->zip_length) {
HXLINE( 533)					this->zpp_inner->zip_length = false;
HXDLIN( 533)					this->zpp_inner->user_length = this->zpp_inner->inner->length;
...
HXLINE( 578)			HX_STACK_DO_THROW(((HX_("Error: ",4e,a8,5b,b7) + HX_("InteractionGroup",2d,2e,ee,3f)) + HX_("List is immutable",6e,b9,49,ba)));
            		}
...
HXLINE( 587)			{
HXLINE( 588)				 ::zpp_nape::util::ZNPNode_ZPP_InteractionGroup cx_ite = this->zpp_inner->inner->head;
...
void InteractionGroupList_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_6aeac6de7555f0ba_614_clear)
HXLINE( 616)		if (this->zpp_inner->immutable) {
HXLINE( 616)			HX_STACK_DO_THROW(((HX_("Error: ",4e,a8,5b,b7) + HX_("InteractionGroup",2d,2e,ee,3f)) + HX_("List is immutable",6e,b9,49,ba)));
            		}
...
HXLINE( 663)		 ::nape::dynamics::InteractionGroupList ret =  ::nape::dynamics::InteractionGroupList_obj::__alloc( HX_CTX );
HXLINE( 664)		{
HXLINE( 664)			this->zpp_inner->valmod();
HXDLIN( 664)			 ::nape::dynamics::InteractionGroupIterator _g = ::nape::dynamics::InteractionGroupIterator_obj::get(::hx::ObjectPtr<OBJ_>(this));
HXDLIN( 664)			while(true){
HXLINE( 664)				_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 664)				 ::nape::dynamics::InteractionGroupList _this = _g->zpp_inner;
...
HXDLIN( 664)				 ::nape::dynamics::InteractionGroup i = _g->zpp_inner->at(_g->zpp_i++);
HXDLIN( 664)				if (deep) {
HXLINE( 666)					HX_STACK_DO_THROW(((HX_("Error: ",4e,a8,5b,b7) + HX_("InteractionGroup",2d,2e,ee,3f)) + HX_(" is not a copyable type",89,ec,2e,8b)));
            				}
...
void InteractionGroupList_obj::merge( ::nape::dynamics::InteractionGroupList xs){
            	HX_STACKFRAME(&_hx_pos_6aeac6de7555f0ba_684_merge)
...
HXDLIN( 688)			 ::nape::dynamics::InteractionGroupIterator _g = ::nape::dynamics::InteractionGroupIterator_obj::get(xs);
HXDLIN( 688)			while(true){
HXLINE( 688)				_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 688)				 ::nape::dynamics::InteractionGroupList _this = _g->zpp_inner;
...
HXDLIN( 688)				 ::nape::dynamics::InteractionGroup x = _g->zpp_inner->at(_g->zpp_i++);
...
HXDLIN( 705)			 ::nape::dynamics::InteractionGroupIterator _g = ::nape::dynamics::InteractionGroupIterator_obj::get(::hx::ObjectPtr<OBJ_>(this));
HXDLIN( 705)			while(true){
HXLINE( 705)				_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 705)				 ::nape::dynamics::InteractionGroupList _this = _g->zpp_inner;
...
HXDLIN( 705)				 ::nape::dynamics::InteractionGroup i = _g->zpp_inner->at(_g->zpp_i++);
HXLINE( 706)				if (!(fst)) {
...
HXDLIN( 736)		 ::nape::dynamics::InteractionGroupIterator it = ::nape::dynamics::InteractionGroupIterator_obj::get(::hx::ObjectPtr<OBJ_>(this));
HXLINE( 737)		while(true){
HXLINE( 737)			it->zpp_inner->zpp_inner->valmod();
HXDLIN( 737)			 ::nape::dynamics::InteractionGroupList _this = it->zpp_inner;
...
HXLINE( 785)			 ::nape::dynamics::InteractionGroup x = this->at(i);
HXLINE( 786)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXLINE( 310)		 ::nape::dynamics::InteractionGroupList ret =  ::nape::dynamics::InteractionGroupList_obj::__alloc( HX_CTX );
HXLINE( 311)		{
HXLINE( 311)			int _g = 0;
HXDLIN( 311)			while((_g < array->length)){
HXLINE( 311)				 ::nape::dynamics::InteractionGroup i = array->__get(_g).StaticCast<  ::nape::dynamics::InteractionGroup >();
HXDLIN( 311)				_g = (_g + 1);
...
static ::hx::StorageInfo InteractionGroupList_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::zpp_nape::util::ZPP_InteractionGroupList */ ,(int)offsetof(InteractionGroupList_obj,zpp_inner),HX_("zpp_inner",51,65,85,78)},
	{ ::hx::fsUnknown, 0, null()}
};
...
{
	InteractionGroupList_obj _hx_dummy;
	InteractionGroupList_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("nape.dynamics.InteractionGroupList",bf,25,45,b0);
