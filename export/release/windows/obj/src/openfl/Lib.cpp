...
HX_LOCAL_STACK_FRAME(_hx_pos_c4ab5e3027df58c9_496_sendToURL,"openfl.Lib","sendToURL",0xb7c4ca65,"openfl.Lib.sendToURL","openfl/Lib.hx",496,0x62fb7c98)
...
HXLINE(  86)			( ( ::haxe::Timer)(::openfl::Lib_obj::_hx___timers->get(id)) )->stop();
...
HXLINE( 102)			( ( ::haxe::Timer)(::openfl::Lib_obj::_hx___timers->get(id)) )->stop();
...
void Lib_obj::sendToURL( ::openfl::net::URLRequest request){
            	HX_GC_STACKFRAME(&_hx_pos_c4ab5e3027df58c9_496_sendToURL)
HXDLIN( 496)		 ::openfl::net::URLLoader_obj::__alloc( HX_CTX ,null())->load(request);
            	}
