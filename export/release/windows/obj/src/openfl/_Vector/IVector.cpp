...
HX_LOCAL_STACK_FRAME(_hx_pos_d7693ed8053d108e_2014_boot,"openfl._Vector.IVector","boot",0x499ba4fe,"openfl._Vector.IVector.boot","openfl/Vector.hx",2014,0x4a01873c)
namespace openfl{
namespace _Vector{
...
{
{
            	HX_STACKFRAME(&_hx_pos_d7693ed8053d108e_2014_boot)
HXDLIN(2014)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
