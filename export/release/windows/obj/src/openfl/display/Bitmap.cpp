...
HXLINE( 137)			bounds->x = ( (Float)(0) );
HXDLIN( 137)			bounds->y = ( (Float)(0) );
HXDLIN( 137)			bounds->width = ( (Float)(this->_hx___bitmapData->width) );
HXDLIN( 137)			bounds->height = ( (Float)(this->_hx___bitmapData->height) );
            		}
            		else {
HXLINE( 141)			bounds->x = ( (Float)(0) );
HXDLIN( 141)			bounds->y = ( (Float)(0) );
HXDLIN( 141)			bounds->width = ( (Float)(0) );
HXDLIN( 141)			bounds->height = ( (Float)(0) );
            		}
