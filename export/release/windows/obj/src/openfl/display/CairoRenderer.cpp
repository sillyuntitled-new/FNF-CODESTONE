...
HXLINE(  74)		{
HXLINE(  74)			 ::openfl::geom::Matrix _this = this->_hx___matrix;
HXDLIN(  74)			_this->a = transform->a;
HXDLIN(  74)			_this->b = transform->b;
HXDLIN(  74)			_this->c = transform->c;
HXDLIN(  74)			_this->d = transform->d;
HXDLIN(  74)			_this->tx = transform->tx;
HXDLIN(  74)			_this->ty = transform->ty;
            		}
...
HXLINE(  78)			 ::openfl::geom::Matrix _this1 = this->_hx___matrix;
HXDLIN(  78)			 ::openfl::geom::Matrix m = this->_hx___worldTransform;
HXDLIN(  78)			Float a1 = ((_this1->a * m->a) + (_this1->b * m->c));
HXDLIN(  78)			_this1->b = ((_this1->a * m->b) + (_this1->b * m->d));
HXDLIN(  78)			_this1->a = a1;
HXDLIN(  78)			Float c1 = ((_this1->c * m->a) + (_this1->d * m->c));
HXDLIN(  78)			_this1->d = ((_this1->c * m->b) + (_this1->d * m->d));
HXDLIN(  78)			_this1->c = c1;
HXDLIN(  78)			Float tx1 = (((_this1->tx * m->a) + (_this1->ty * m->c)) + m->tx);
HXDLIN(  78)			_this1->ty = (((_this1->tx * m->b) + (_this1->ty * m->d)) + m->ty);
HXDLIN(  78)			_this1->tx = tx1;
            		}
