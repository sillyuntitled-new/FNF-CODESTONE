...
HXLINE(  82)				{
HXLINE(  82)					 ::openfl::geom::Matrix _this = this->_hx___tempMatrix;
HXDLIN(  82)					_this->a = transform->a;
HXDLIN(  82)					_this->b = transform->b;
HXDLIN(  82)					_this->c = transform->c;
HXDLIN(  82)					_this->d = transform->d;
HXDLIN(  82)					_this->tx = transform->tx;
HXDLIN(  82)					_this->ty = transform->ty;
            				}
HXLINE(  83)				{
HXLINE(  83)					 ::openfl::geom::Matrix _this1 = this->_hx___tempMatrix;
HXDLIN(  83)					 ::openfl::geom::Matrix m = this->_hx___worldTransform;
HXDLIN(  83)					Float a1 = ((_this1->a * m->a) + (_this1->b * m->c));
HXDLIN(  83)					_this1->b = ((_this1->a * m->b) + (_this1->b * m->d));
HXDLIN(  83)					_this1->a = a1;
HXDLIN(  83)					Float c1 = ((_this1->c * m->a) + (_this1->d * m->c));
HXDLIN(  83)					_this1->d = ((_this1->c * m->b) + (_this1->d * m->d));
HXDLIN(  83)					_this1->c = c1;
HXDLIN(  83)					Float tx1 = (((_this1->tx * m->a) + (_this1->ty * m->c)) + m->tx);
HXDLIN(  83)					_this1->ty = (((_this1->tx * m->b) + (_this1->ty * m->d)) + m->ty);
HXDLIN(  83)					_this1->tx = tx1;
            				}
