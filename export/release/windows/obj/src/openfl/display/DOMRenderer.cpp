...
HXLINE( 475)			{
HXLINE( 475)				 ::openfl::geom::Matrix sourceMatrix = displayObject->_hx___renderTransform;
HXDLIN( 475)				matrix->a = sourceMatrix->a;
HXDLIN( 475)				matrix->b = sourceMatrix->b;
HXDLIN( 475)				matrix->c = sourceMatrix->c;
HXDLIN( 475)				matrix->d = sourceMatrix->d;
HXDLIN( 475)				matrix->tx = sourceMatrix->tx;
HXDLIN( 475)				matrix->ty = sourceMatrix->ty;
            			}
...
HXLINE( 486)				{
HXLINE( 486)					 ::openfl::geom::Rectangle _this = displayObject->_hx___worldClip;
HXDLIN( 486)					_this->x = clip->x;
HXDLIN( 486)					_this->y = clip->y;
HXDLIN( 486)					_this->width = clip->width;
HXDLIN( 486)					_this->height = clip->height;
            				}
