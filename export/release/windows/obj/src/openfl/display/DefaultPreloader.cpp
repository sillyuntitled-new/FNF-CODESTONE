...
HXLINE( 127)		if (((((((Float)0.299) * ( (Float)(((backgroundColor >> 16) & 255)) )) + (((Float)0.587) * ( (Float)(((backgroundColor >> 8) & 255)) ))) + (((Float)0.114) * ( (Float)((backgroundColor & 255)) ))) < 70)) {
HXLINE( 129)			color = 16777215;
            		}
HXLINE( 134)		Float y = ((this->getHeight() / ( (Float)(2) )) - ((Float)3.5));
HXLINE( 135)		Float width = (this->getWidth() - ( (Float)(60) ));
...
HXLINE( 141)		this->outline->get_graphics()->drawRect(( (Float)(0) ),( (Float)(0) ),width,( (Float)(7) ));
HXLINE( 142)		this->outline->set_x(( (Float)(30) ));
...
HXLINE( 149)		this->progress->get_graphics()->drawRect(( (Float)(0) ),( (Float)(0) ),(width - ( (Float)(4) )),( (Float)(3) ));
HXLINE( 150)		this->progress->set_x(( (Float)(32) ));
HXLINE( 151)		this->progress->set_y((y + 2));
...
HXLINE( 260)		Float percent = (( (Float)((elapsed - this->startAnimation)) ) / ( (Float)((this->endAnimation - this->startAnimation)) ));
