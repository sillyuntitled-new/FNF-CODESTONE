...
HXLINE(1168)			{
HXLINE(1168)				 ::openfl::geom::Matrix sourceMatrix = this->_hx___getWorldTransform();
HXDLIN(1168)				matrix->a = sourceMatrix->a;
HXDLIN(1168)				matrix->b = sourceMatrix->b;
HXDLIN(1168)				matrix->c = sourceMatrix->c;
HXDLIN(1168)				matrix->d = sourceMatrix->d;
HXDLIN(1168)				matrix->tx = sourceMatrix->tx;
HXDLIN(1168)				matrix->ty = sourceMatrix->ty;
            			}
HXLINE(1170)			 ::openfl::geom::Matrix targetMatrix = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE(1172)			{
HXLINE(1172)				 ::openfl::geom::Matrix sourceMatrix1 = targetCoordinateSpace->_hx___getWorldTransform();
HXDLIN(1172)				targetMatrix->a = sourceMatrix1->a;
HXDLIN(1172)				targetMatrix->b = sourceMatrix1->b;
HXDLIN(1172)				targetMatrix->c = sourceMatrix1->c;
HXDLIN(1172)				targetMatrix->d = sourceMatrix1->d;
HXDLIN(1172)				targetMatrix->tx = sourceMatrix1->tx;
HXDLIN(1172)				targetMatrix->ty = sourceMatrix1->ty;
            			}
HXLINE(1173)			targetMatrix->invert();
HXLINE(1175)			{
HXLINE(1175)				Float a1 = ((matrix->a * targetMatrix->a) + (matrix->b * targetMatrix->c));
HXDLIN(1175)				matrix->b = ((matrix->a * targetMatrix->b) + (matrix->b * targetMatrix->d));
HXDLIN(1175)				matrix->a = a1;
HXDLIN(1175)				Float c1 = ((matrix->c * targetMatrix->a) + (matrix->d * targetMatrix->c));
HXDLIN(1175)				matrix->d = ((matrix->c * targetMatrix->b) + (matrix->d * targetMatrix->d));
HXDLIN(1175)				matrix->c = c1;
HXDLIN(1175)				Float tx1 = (((matrix->tx * targetMatrix->a) + (matrix->ty * targetMatrix->c)) + targetMatrix->tx);
HXDLIN(1175)				matrix->ty = (((matrix->tx * targetMatrix->b) + (matrix->ty * targetMatrix->d)) + targetMatrix->ty);
HXDLIN(1175)				matrix->tx = tx1;
            			}
HXLINE(1177)			::openfl::geom::Matrix_obj::_hx___pool->release(targetMatrix);
            		}
            		else {
HXLINE(1181)			matrix->a = ( (Float)(1) );
HXDLIN(1181)			matrix->b = ( (Float)(0) );
HXDLIN(1181)			matrix->c = ( (Float)(0) );
HXDLIN(1181)			matrix->d = ( (Float)(1) );
HXDLIN(1181)			matrix->tx = ( (Float)(0) );
HXDLIN(1181)			matrix->ty = ( (Float)(0) );
            		}
...
HXLINE(1255)			return currentBounds->intersects(obj->getBounds(::hx::ObjectPtr<OBJ_>(this)));
            		}
...
HXLINE(1553)			{
HXLINE(1553)				 ::openfl::geom::Rectangle sourceRect = this->_hx___scrollRect;
HXDLIN(1553)				r->x = sourceRect->x;
HXDLIN(1553)				r->y = sourceRect->y;
HXDLIN(1553)				r->width = sourceRect->width;
HXDLIN(1553)				r->height = sourceRect->height;
            			}
...
HXLINE(1850)			 ::openfl::geom::Matrix _this = this->_hx___worldTransform;
HXDLIN(1850)			_this->a = local->a;
HXDLIN(1850)			_this->b = local->b;
HXDLIN(1850)			_this->c = local->c;
HXDLIN(1850)			_this->d = local->d;
HXDLIN(1850)			_this->tx = local->tx;
HXDLIN(1850)			_this->ty = local->ty;
            		}
...
HXLINE(1859)			 ::openfl::geom::Matrix _this1 = this->_hx___renderTransform;
HXDLIN(1859)			_this1->a = local->a;
HXDLIN(1859)			_this1->b = local->b;
HXDLIN(1859)			_this1->c = local->c;
HXDLIN(1859)			_this1->d = local->d;
HXDLIN(1859)			_this1->tx = local->tx;
HXDLIN(1859)			_this1->ty = local->ty;
            		}
HXLINE(1862)		if (::hx::IsNotNull( this->_hx___scrollRect )) {
HXLINE(1864)			 ::openfl::geom::Matrix _this2 = this->_hx___renderTransform;
HXDLIN(1864)			Float px = -(this->_hx___scrollRect->x);
HXDLIN(1864)			Float py = -(this->_hx___scrollRect->y);
HXDLIN(1864)			_this2->tx = (((px * _this2->a) + (py * _this2->c)) + _this2->tx);
HXDLIN(1864)			_this2->ty = (((px * _this2->b) + (py * _this2->d)) + _this2->ty);
            		}
            	}
...
HXLINE(1975)		{
HXLINE(1975)			matrix->a = ( (Float)(1) );
HXDLIN(1975)			matrix->b = ( (Float)(0) );
HXDLIN(1975)			matrix->c = ( (Float)(0) );
HXDLIN(1975)			matrix->d = ( (Float)(1) );
HXDLIN(1975)			matrix->tx = ( (Float)(0) );
HXDLIN(1975)			matrix->ty = ( (Float)(0) );
            		}
...
HXLINE(2124)			{
HXLINE(2124)				 ::openfl::geom::Rectangle _this = this->_hx___scale9Grid;
HXDLIN(2124)				_this->x = value->x;
HXDLIN(2124)				_this->y = value->y;
HXDLIN(2124)				_this->width = value->width;
HXDLIN(2124)				_this->height = value->height;
            			}
            		}
            		else {
...
HXLINE(2222)			{
HXLINE(2222)				 ::openfl::geom::Rectangle _this = this->_hx___scrollRect;
HXDLIN(2222)				_this->x = value->x;
HXDLIN(2222)				_this->y = value->y;
HXDLIN(2222)				_this->width = value->width;
HXDLIN(2222)				_this->height = value->height;
            			}
            		}
            		else {
...
HXLINE(2310)		{
HXLINE(2310)			matrix->a = ( (Float)(1) );
HXDLIN(2310)			matrix->b = ( (Float)(0) );
HXDLIN(2310)			matrix->c = ( (Float)(0) );
HXDLIN(2310)			matrix->d = ( (Float)(1) );
HXDLIN(2310)			matrix->tx = ( (Float)(0) );
HXDLIN(2310)			matrix->ty = ( (Float)(0) );
            		}
