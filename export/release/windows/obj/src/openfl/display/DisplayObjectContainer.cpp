...
HXLINE( 450)			child->_hx___dispatchWithCapture( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("removed",a0,1f,00,f3),true,null()));
...
HXLINE( 799)			if (!(this->_hx___scrollRect->contains(point->x,point->y))) {
