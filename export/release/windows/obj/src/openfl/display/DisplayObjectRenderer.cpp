...
HXLINE( 111)			displayObject->_hx___customRenderEvent->allowSmoothing = this->_hx___allowSmoothing;
HXLINE( 112)			{
HXLINE( 112)				 ::openfl::geom::Matrix _this = displayObject->_hx___customRenderEvent->objectMatrix;
HXDLIN( 112)				 ::openfl::geom::Matrix sourceMatrix = displayObject->_hx___renderTransform;
HXDLIN( 112)				_this->a = sourceMatrix->a;
HXDLIN( 112)				_this->b = sourceMatrix->b;
HXDLIN( 112)				_this->c = sourceMatrix->c;
HXDLIN( 112)				_this->d = sourceMatrix->d;
HXDLIN( 112)				_this->tx = sourceMatrix->tx;
HXDLIN( 112)				_this->ty = sourceMatrix->ty;
            			}
...
HXLINE( 114)			displayObject->_hx___customRenderEvent->renderer = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 116)			::String _hx_switch_0 = this->_hx___type;
...
HXLINE( 119)				if (!(this->_hx___cleared)) {
HXLINE( 119)					this->_hx___clear();
            				}
HXLINE( 121)				 ::openfl::display::OpenGLRenderer renderer = ( ( ::openfl::display::OpenGLRenderer)(::hx::ObjectPtr<OBJ_>(this)) );
HXLINE( 122)				renderer->setShader(displayObject->_hx___worldShader);
HXLINE( 123)				renderer->_hx___context3D->_hx___flushGL();
...
HXLINE( 144)				return;
            			...
            			_hx_goto_11:;
HXLINE( 147)			this->_hx___setBlendMode(displayObject->_hx___worldBlendMode);
HXLINE( 148)			this->_hx___pushMaskObject(displayObject,null());
HXLINE( 150)			displayObject->dispatchEvent(displayObject->_hx___customRenderEvent);
HXLINE( 152)			this->_hx___popMaskObject(displayObject,null());
HXLINE( 154)			if ((this->_hx___type == HX_("opengl",6f,64,94,21))) {
HXLINE( 157)				( ( ::openfl::display::OpenGLRenderer)(::hx::ObjectPtr<OBJ_>(this)) )->setViewport();
            			}
            		}
            	}
...
HXLINE( 223)						_hx_tmp1 = (this->_hx___type == HX_("opengl",6f,64,94,21));
            					}
            					else {
...
HXLINE( 228)					_hx_tmp4 = (this->_hx___type == HX_("opengl",6f,64,94,21));
            				}
            				else {
...
HXLINE( 235)					_hx_tmp6 = (this->_hx___type == HX_("opengl",6f,64,94,21));
            				}
            				else {
...
HXLINE( 248)		if (::hx::IsNotNull( this->_hx___worldColorTransform )) {
HXLINE( 248)			colorTransform->_hx___combine(this->_hx___worldColorTransform);
            		}
...
HXLINE( 253)			if ((this->_hx___type != HX_("opengl",6f,64,94,21))) {
...
HXLINE( 254)			if ((this->_hx___type == HX_("opengl",6f,64,94,21))) {
...
HXLINE( 266)			::String renderType = this->_hx___type;
...
HXDLIN( 292)			if ((this->_hx___type == HX_("dom",82,42,4c,00))) {
...
HXLINE( 326)				_hx_tmp20 = (this->_hx___type != HX_("opengl",6f,64,94,21));
            			}
            			else {
...
HXLINE( 351)			{
HXLINE( 351)				 ::openfl::geom::Matrix _this = displayObject->_hx___cacheBitmapMatrix;
HXDLIN( 351)				_this->a = bitmapMatrix->a;
HXDLIN( 351)				_this->b = bitmapMatrix->b;
HXDLIN( 351)				_this->c = bitmapMatrix->c;
HXDLIN( 351)				_this->d = bitmapMatrix->d;
HXDLIN( 351)				_this->tx = bitmapMatrix->tx;
HXDLIN( 351)				_this->ty = bitmapMatrix->ty;
            			}
...
HXLINE( 373)					filterWidth = ::Math_obj::floor((rect->width * pixelRatio));
            				}
            				else {
HXLINE( 373)					filterWidth = 0;
            				}
HXLINE( 374)				if ((rect->height > 0)) {
HXLINE( 374)					filterHeight = ::Math_obj::floor((rect->height * pixelRatio));
            				}
            				else {
...
HXLINE( 411)					bool allowFramebuffer = (this->_hx___type == HX_("opengl",6f,64,94,21));
...
HXLINE( 430)						{
HXLINE( 430)							rect->x = ( (Float)(0) );
HXDLIN( 430)							rect->y = ( (Float)(0) );
HXDLIN( 430)							rect->width = ( (Float)(filterWidth) );
HXDLIN( 430)							rect->height = ( (Float)(filterHeight) );
            						}
...
HXLINE( 468)				{
HXLINE( 468)					 ::openfl::geom::Matrix _this1 = displayObject->_hx___cacheBitmap->_hx___worldTransform;
HXDLIN( 468)					 ::openfl::geom::Matrix sourceMatrix = displayObject->_hx___worldTransform;
HXDLIN( 468)					_this1->a = sourceMatrix->a;
HXDLIN( 468)					_this1->b = sourceMatrix->b;
HXDLIN( 468)					_this1->c = sourceMatrix->c;
HXDLIN( 468)					_this1->d = sourceMatrix->d;
HXDLIN( 468)					_this1->tx = sourceMatrix->tx;
HXDLIN( 468)					_this1->ty = sourceMatrix->ty;
            				}
HXLINE( 470)				if (::hx::IsInstanceEq( bitmapMatrix,displayObject->_hx___renderTransform )) {
HXLINE( 472)					{
HXLINE( 472)						 ::openfl::geom::Matrix _this2 = displayObject->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 472)						_this2->a = ( (Float)(1) );
HXDLIN( 472)						_this2->b = ( (Float)(0) );
HXDLIN( 472)						_this2->c = ( (Float)(0) );
HXDLIN( 472)						_this2->d = ( (Float)(1) );
HXDLIN( 472)						_this2->tx = ( (Float)(0) );
HXDLIN( 472)						_this2->ty = ( (Float)(0) );
            					}
HXLINE( 473)					{
HXLINE( 473)						 ::openfl::geom::Matrix _this3 = displayObject->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 473)						Float sx = (( (Float)(1) ) / pixelRatio);
HXDLIN( 473)						Float sy = (( (Float)(1) ) / pixelRatio);
HXDLIN( 473)						_this3->a = (_this3->a * sx);
HXDLIN( 473)						_this3->b = (_this3->b * sy);
HXDLIN( 473)						_this3->c = (_this3->c * sx);
HXDLIN( 473)						_this3->d = (_this3->d * sy);
HXDLIN( 473)						_this3->tx = (_this3->tx * sx);
HXDLIN( 473)						_this3->ty = (_this3->ty * sy);
            					}
...
HXLINE( 479)					{
HXLINE( 479)						 ::openfl::geom::Matrix _this4 = displayObject->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 479)						 ::openfl::geom::Matrix sourceMatrix1 = displayObject->_hx___cacheBitmapMatrix;
HXDLIN( 479)						_this4->a = sourceMatrix1->a;
HXDLIN( 479)						_this4->b = sourceMatrix1->b;
HXDLIN( 479)						_this4->c = sourceMatrix1->c;
HXDLIN( 479)						_this4->d = sourceMatrix1->d;
HXDLIN( 479)						_this4->tx = sourceMatrix1->tx;
HXDLIN( 479)						_this4->ty = sourceMatrix1->ty;
            					}
HXLINE( 480)					displayObject->_hx___cacheBitmap->_hx___renderTransform->invert();
HXLINE( 481)					{
HXLINE( 481)						 ::openfl::geom::Matrix _this5 = displayObject->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 481)						 ::openfl::geom::Matrix m = displayObject->_hx___renderTransform;
HXDLIN( 481)						Float a1 = ((_this5->a * m->a) + (_this5->b * m->c));
HXDLIN( 481)						_this5->b = ((_this5->a * m->b) + (_this5->b * m->d));
HXDLIN( 481)						_this5->a = a1;
HXDLIN( 481)						Float c1 = ((_this5->c * m->a) + (_this5->d * m->c));
HXDLIN( 481)						_this5->d = ((_this5->c * m->b) + (_this5->d * m->d));
HXDLIN( 481)						_this5->c = c1;
HXDLIN( 481)						Float tx1 = (((_this5->tx * m->a) + (_this5->ty * m->c)) + m->tx);
HXDLIN( 481)						_this5->ty = (((_this5->tx * m->b) + (_this5->ty * m->d)) + m->ty);
HXDLIN( 481)						_this5->tx = tx1;
            					}
...
HXLINE( 489)			displayObject->_hx___cacheBitmap->smoothing = this->_hx___allowSmoothing;
...
HXLINE( 505)						displayObject->_hx___cacheBitmapRenderer =  ::openfl::display::OpenGLRenderer_obj::__alloc( HX_CTX ,::hx::TCast<  ::openfl::display::OpenGLRenderer >::cast(::hx::ObjectPtr<OBJ_>(this))->_hx___context3D,displayObject->_hx___cacheBitmapData);
            					}
            					else {
...
HXLINE( 535)				displayObject->_hx___cacheBitmapRenderer->_hx___allowSmoothing = this->_hx___allowSmoothing;
...
HXLINE( 539)				{
HXLINE( 539)					 ::openfl::geom::Matrix _this6 = displayObject->_hx___cacheBitmapRenderer->_hx___worldTransform;
HXDLIN( 539)					 ::openfl::geom::Matrix sourceMatrix2 = displayObject->_hx___renderTransform;
HXDLIN( 539)					_this6->a = sourceMatrix2->a;
HXDLIN( 539)					_this6->b = sourceMatrix2->b;
HXDLIN( 539)					_this6->c = sourceMatrix2->c;
HXDLIN( 539)					_this6->d = sourceMatrix2->d;
HXDLIN( 539)					_this6->tx = sourceMatrix2->tx;
HXDLIN( 539)					_this6->ty = sourceMatrix2->ty;
            				}
HXLINE( 540)				displayObject->_hx___cacheBitmapRenderer->_hx___worldTransform->invert();
HXLINE( 541)				{
HXLINE( 541)					 ::openfl::geom::Matrix _this7 = displayObject->_hx___cacheBitmapRenderer->_hx___worldTransform;
HXDLIN( 541)					 ::openfl::geom::Matrix m1 = displayObject->_hx___cacheBitmapMatrix;
HXDLIN( 541)					Float a11 = ((_this7->a * m1->a) + (_this7->b * m1->c));
HXDLIN( 541)					_this7->b = ((_this7->a * m1->b) + (_this7->b * m1->d));
HXDLIN( 541)					_this7->a = a11;
HXDLIN( 541)					Float c11 = ((_this7->c * m1->a) + (_this7->d * m1->c));
HXDLIN( 541)					_this7->d = ((_this7->c * m1->b) + (_this7->d * m1->d));
HXDLIN( 541)					_this7->c = c11;
HXDLIN( 541)					Float tx11 = (((_this7->tx * m1->a) + (_this7->ty * m1->c)) + m1->tx);
HXDLIN( 541)					_this7->ty = (((_this7->tx * m1->b) + (_this7->ty * m1->d)) + m1->ty);
HXDLIN( 541)					_this7->tx = tx11;
            				}
...
HXLINE( 544)				{
HXLINE( 544)					 ::openfl::geom::Matrix _this8 = displayObject->_hx___cacheBitmapRenderer->_hx___worldTransform;
HXDLIN( 544)					_this8->a = (_this8->a * pixelRatio);
HXDLIN( 544)					_this8->b = (_this8->b * pixelRatio);
HXDLIN( 544)					_this8->c = (_this8->c * pixelRatio);
HXDLIN( 544)					_this8->d = (_this8->d * pixelRatio);
HXDLIN( 544)					_this8->tx = (_this8->tx * pixelRatio);
HXDLIN( 544)					_this8->ty = (_this8->ty * pixelRatio);
            				}
...
HXLINE( 555)					 ::openfl::display::OpenGLRenderer parentRenderer = ( ( ::openfl::display::OpenGLRenderer)(::hx::ObjectPtr<OBJ_>(this)) );
...
HXLINE( 643)						{
HXLINE( 643)							 ::openfl::geom::Matrix _this9 = childRenderer->_hx___worldTransform;
HXDLIN( 643)							_this9->a = ( (Float)(1) );
HXDLIN( 643)							_this9->b = ( (Float)(0) );
HXDLIN( 643)							_this9->c = ( (Float)(0) );
HXDLIN( 643)							_this9->d = ( (Float)(1) );
HXDLIN( 643)							_this9->tx = ( (Float)(0) );
HXDLIN( 643)							_this9->ty = ( (Float)(0) );
            						}
...
HXDLIN( 661)										shader = filter2->_hx___initShader(childRenderer,(_g6 - 1),shader1);
...
HXLINE( 828)				if ((this->_hx___type == HX_("dom",82,42,4c,00))) {
HXLINE( 831)					( ( ::openfl::display::DOMRenderer)(::hx::ObjectPtr<OBJ_>(this)) )->_hx___renderDrawableClear(displayObject->_hx___cacheBitmap);
            				}
