...
HXLINE( 309)					ratios->push(::Math_obj::ceil(((( (Float)((_g2 - 1)) ) / ( (Float)((colors->length - 1)) )) * ( (Float)(255) ))));
            				}
            			}
            		}
...
HXLINE( 765)				switch((int)(( (int)(command->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) ))){
            					case (int)1: {
...
HXLINE( 837)			length = indices->_hx___array->length;
            		}
            		else {
HXLINE( 837)			length = ::Math_obj::floor((( (Float)(rects->_hx___array->length) ) / ( (Float)(4) )));
            		}
HXLINE( 838)		if ((length == 0)) {
HXLINE( 838)			return;
            		}
HXLINE( 840)		if (::hx::IsNotNull( transforms )) {
HXLINE( 842)			if ((transforms->_hx___array->length >= (length * 6))) {
HXLINE( 844)				transformABCD = true;
HXLINE( 845)				transformXY = true;
            			}
            			else {
HXLINE( 847)				if ((transforms->_hx___array->length >= (length * 4))) {
HXLINE( 849)					transformABCD = true;
            				}
            				else {
HXLINE( 851)					if ((transforms->_hx___array->length >= (length * 2))) {
...
HXLINE( 871)				{
HXLINE( 871)					Float widtha = rects->get((ri + 2));
HXDLIN( 871)					Float heighta = rects->get((ri + 3));
HXDLIN( 871)					tileRect->x = ( (Float)(0) );
HXDLIN( 871)					tileRect->y = ( (Float)(0) );
HXDLIN( 871)					tileRect->width = widtha;
HXDLIN( 871)					tileRect->height = heighta;
            				}
HXLINE( 873)				bool _hx_tmp;
HXDLIN( 873)				if (!((tileRect->width <= 0))) {
HXLINE( 873)					_hx_tmp = (tileRect->height <= 0);
            				}
            				else {
...
HXLINE( 878)					_hx_tmp1 = transformXY;
            				}
            				else {
HXLINE( 878)					_hx_tmp1 = false;
            				}
HXDLIN( 878)				if (_hx_tmp1) {
HXLINE( 880)					ti = (i * 6);
HXLINE( 881)					{
HXLINE( 881)						Float a = transforms->get(ti);
HXDLIN( 881)						Float b = transforms->get((ti + 1));
HXDLIN( 881)						Float c = transforms->get((ti + 2));
HXDLIN( 881)						Float d = transforms->get((ti + 3));
HXDLIN( 881)						Float tx = transforms->get((ti + 4));
HXDLIN( 881)						Float ty = transforms->get((ti + 5));
HXDLIN( 881)						tileTransform->a = a;
HXDLIN( 881)						tileTransform->b = b;
HXDLIN( 881)						tileTransform->c = c;
HXDLIN( 881)						tileTransform->d = d;
HXDLIN( 881)						tileTransform->tx = tx;
HXDLIN( 881)						tileTransform->ty = ty;
            					}
            				}
            				else {
...
HXLINE( 885)						ti = (i * 4);
HXLINE( 886)						{
HXLINE( 886)							Float a1 = transforms->get(ti);
HXDLIN( 886)							Float b1 = transforms->get((ti + 1));
HXDLIN( 886)							Float c1 = transforms->get((ti + 2));
HXDLIN( 886)							Float d1 = transforms->get((ti + 3));
HXDLIN( 886)							tileTransform->a = a1;
HXDLIN( 886)							tileTransform->b = b1;
HXDLIN( 886)							tileTransform->c = c1;
HXDLIN( 886)							tileTransform->d = d1;
HXDLIN( 886)							tileTransform->tx = tileRect->x;
HXDLIN( 886)							tileTransform->ty = tileRect->y;
            						}
            					}
            					else {
...
HXLINE(1064)			_hx_tmp = (vertices->_hx___array->length == 0);
            		}
            		else {
...
HXLINE(1066)		int vertLength = ::Std_obj::_hx_int((( (Float)(vertices->_hx___array->length) ) / ( (Float)(2) )));
...
HXDLIN(1079)				while((_g < vertLength)){
HXLINE(1079)					_g = (_g + 1);
HXLINE(1081)					indices->push((_g - 1));
            				}
            			}
            		}
...
HXLINE(1096)		{
HXLINE(1096)			int _g1 = 0;
HXDLIN(1096)			while((_g1 < vertLength)){
HXLINE(1096)				_g1 = (_g1 + 1);
HXDLIN(1096)				int i = (_g1 - 1);
...
HXLINE(1258)					ratios->push(::Math_obj::ceil(((( (Float)((_g2 - 1)) ) / ( (Float)((colors->length - 1)) )) * ( (Float)(255) ))));
            				}
            			}
            		}
...
HXLINE(1829)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1829)								data->oPos = (data->oPos + 2);
HXDLIN(1829)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1829)								data->iPos = (data->iPos + 1);
HXDLIN(1829)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1829)								data->oPos = (data->oPos + 4);
HXDLIN(1829)								data->iiPos = (data->iiPos + 2);
HXDLIN(1829)								data->ffPos = (data->ffPos + 1);
HXDLIN(1829)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1829)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1829)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1829)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1829)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1829)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1829)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1829)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1829)								data->fPos = (data->fPos + 5);
HXDLIN(1829)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1829)								data->oPos = (data->oPos + 4);
...
HXDLIN(1829)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1829)								data->oPos = (data->oPos + 4);
HXDLIN(1829)								data->iPos = (data->iPos + 1);
HXDLIN(1829)								data->fPos = (data->fPos + 2);
HXDLIN(1829)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1829)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1829)								data->fPos = (data->fPos + 2);
...
HXLINE(1833)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1833)								data->oPos = (data->oPos + 2);
HXDLIN(1833)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1833)								data->iPos = (data->iPos + 1);
HXDLIN(1833)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1833)								data->oPos = (data->oPos + 4);
HXDLIN(1833)								data->iiPos = (data->iiPos + 2);
HXDLIN(1833)								data->ffPos = (data->ffPos + 1);
HXDLIN(1833)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1833)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1833)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1833)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1833)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1833)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1833)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1833)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1833)								data->fPos = (data->fPos + 5);
HXDLIN(1833)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1833)								data->oPos = (data->oPos + 4);
...
HXDLIN(1833)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1833)								data->oPos = (data->oPos + 4);
HXDLIN(1833)								data->iPos = (data->iPos + 1);
HXDLIN(1833)								data->fPos = (data->fPos + 2);
HXDLIN(1833)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1833)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1833)								data->fPos = (data->fPos + 2);
...
HXLINE(1837)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1837)								data->oPos = (data->oPos + 2);
HXDLIN(1837)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1837)								data->iPos = (data->iPos + 1);
HXDLIN(1837)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1837)								data->oPos = (data->oPos + 4);
HXDLIN(1837)								data->iiPos = (data->iiPos + 2);
HXDLIN(1837)								data->ffPos = (data->ffPos + 1);
HXDLIN(1837)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1837)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1837)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1837)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1837)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1837)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1837)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1837)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1837)								data->fPos = (data->fPos + 5);
HXDLIN(1837)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1837)								data->oPos = (data->oPos + 4);
...
HXDLIN(1837)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1837)								data->oPos = (data->oPos + 4);
HXDLIN(1837)								data->iPos = (data->iPos + 1);
HXDLIN(1837)								data->fPos = (data->fPos + 2);
HXDLIN(1837)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1837)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1837)								data->fPos = (data->fPos + 2);
...
HXLINE(1770)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1770)								data->oPos = (data->oPos + 2);
HXDLIN(1770)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1770)								data->iPos = (data->iPos + 1);
HXDLIN(1770)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1770)								data->oPos = (data->oPos + 4);
HXDLIN(1770)								data->iiPos = (data->iiPos + 2);
HXDLIN(1770)								data->ffPos = (data->ffPos + 1);
HXDLIN(1770)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1770)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1770)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1770)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1770)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1770)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1770)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1770)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1770)								data->fPos = (data->fPos + 5);
HXDLIN(1770)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1770)								data->oPos = (data->oPos + 4);
...
HXDLIN(1770)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1770)								data->oPos = (data->oPos + 4);
HXDLIN(1770)								data->iPos = (data->iPos + 1);
HXDLIN(1770)								data->fPos = (data->fPos + 2);
HXDLIN(1770)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1770)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1770)								data->fPos = (data->fPos + 2);
...
HXLINE(1774)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1774)								data->oPos = (data->oPos + 2);
HXDLIN(1774)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1774)								data->iPos = (data->iPos + 1);
HXDLIN(1774)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1774)								data->oPos = (data->oPos + 4);
HXDLIN(1774)								data->iiPos = (data->iiPos + 2);
HXDLIN(1774)								data->ffPos = (data->ffPos + 1);
HXDLIN(1774)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1774)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1774)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1774)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1774)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1774)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1774)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1774)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1774)								data->fPos = (data->fPos + 5);
HXDLIN(1774)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1774)								data->oPos = (data->oPos + 4);
...
HXDLIN(1774)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1774)								data->oPos = (data->oPos + 4);
HXDLIN(1774)								data->iPos = (data->iPos + 1);
HXDLIN(1774)								data->fPos = (data->fPos + 2);
HXDLIN(1774)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1774)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1774)								data->fPos = (data->fPos + 2);
...
HXLINE(1786)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1786)								data->oPos = (data->oPos + 2);
HXDLIN(1786)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1786)								data->iPos = (data->iPos + 1);
HXDLIN(1786)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1786)								data->oPos = (data->oPos + 4);
HXDLIN(1786)								data->iiPos = (data->iiPos + 2);
HXDLIN(1786)								data->ffPos = (data->ffPos + 1);
HXDLIN(1786)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1786)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1786)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1786)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1786)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1786)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1786)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1786)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1786)								data->fPos = (data->fPos + 5);
HXDLIN(1786)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1786)								data->oPos = (data->oPos + 4);
...
HXDLIN(1786)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1786)								data->oPos = (data->oPos + 4);
HXDLIN(1786)								data->iPos = (data->iPos + 1);
HXDLIN(1786)								data->fPos = (data->fPos + 2);
HXDLIN(1786)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1786)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1786)								data->fPos = (data->fPos + 2);
...
HXLINE(1790)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1790)								data->oPos = (data->oPos + 2);
HXDLIN(1790)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1790)								data->iPos = (data->iPos + 1);
HXDLIN(1790)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1790)								data->oPos = (data->oPos + 4);
HXDLIN(1790)								data->iiPos = (data->iiPos + 2);
HXDLIN(1790)								data->ffPos = (data->ffPos + 1);
HXDLIN(1790)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1790)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1790)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1790)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1790)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1790)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1790)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1790)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1790)								data->fPos = (data->fPos + 5);
HXDLIN(1790)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1790)								data->oPos = (data->oPos + 4);
...
HXDLIN(1790)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1790)								data->oPos = (data->oPos + 4);
HXDLIN(1790)								data->iPos = (data->iPos + 1);
HXDLIN(1790)								data->fPos = (data->fPos + 2);
HXDLIN(1790)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1790)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1790)								data->fPos = (data->fPos + 2);
...
HXLINE(1794)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1794)								data->oPos = (data->oPos + 2);
HXDLIN(1794)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1794)								data->iPos = (data->iPos + 1);
HXDLIN(1794)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1794)								data->oPos = (data->oPos + 4);
HXDLIN(1794)								data->iiPos = (data->iiPos + 2);
HXDLIN(1794)								data->ffPos = (data->ffPos + 1);
HXDLIN(1794)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1794)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1794)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1794)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1794)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1794)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1794)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1794)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1794)								data->fPos = (data->fPos + 5);
HXDLIN(1794)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1794)								data->oPos = (data->oPos + 4);
...
HXDLIN(1794)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1794)								data->oPos = (data->oPos + 4);
HXDLIN(1794)								data->iPos = (data->iPos + 1);
HXDLIN(1794)								data->fPos = (data->fPos + 2);
HXDLIN(1794)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1794)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1794)								data->fPos = (data->fPos + 2);
...
HXLINE(1798)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1798)								data->oPos = (data->oPos + 2);
HXDLIN(1798)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1798)								data->iPos = (data->iPos + 1);
HXDLIN(1798)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1798)								data->oPos = (data->oPos + 4);
HXDLIN(1798)								data->iiPos = (data->iiPos + 2);
HXDLIN(1798)								data->ffPos = (data->ffPos + 1);
HXDLIN(1798)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1798)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1798)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1798)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1798)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1798)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1798)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1798)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1798)								data->fPos = (data->fPos + 5);
HXDLIN(1798)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1798)								data->oPos = (data->oPos + 4);
...
HXDLIN(1798)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1798)								data->oPos = (data->oPos + 4);
HXDLIN(1798)								data->iPos = (data->iPos + 1);
HXDLIN(1798)								data->fPos = (data->fPos + 2);
HXDLIN(1798)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1798)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1798)								data->fPos = (data->fPos + 2);
...
HXLINE(1825)							switch((int)(data->prev->_hx_getIndex())){
            								case (int)0: {
HXLINE(1825)									data->oPos = (data->oPos + 2);
HXDLIN(1825)									data->bPos = (data->bPos + 2);
            								}
            								break;
            								case (int)1: {
HXLINE(1825)									data->iPos = (data->iPos + 1);
HXDLIN(1825)									data->fPos = (data->fPos + 1);
            								}
            								break;
            								case (int)2: {
HXLINE(1825)									data->oPos = (data->oPos + 4);
HXDLIN(1825)									data->iiPos = (data->iiPos + 2);
HXDLIN(1825)									data->ffPos = (data->ffPos + 1);
HXDLIN(1825)									data->fPos = (data->fPos + 1);
            								}
            								break;
            								case (int)3: {
HXLINE(1825)									data->oPos = (data->oPos + 1);
            								}
            								break;
            								case (int)4: {
HXLINE(1825)									data->fPos = (data->fPos + 6);
            								}
            								break;
            								case (int)5: {
HXLINE(1825)									data->fPos = (data->fPos + 4);
            								}
            								break;
            								case (int)6: {
HXLINE(1825)									data->fPos = (data->fPos + 3);
            								}
            								break;
            								case (int)7: {
HXLINE(1825)									data->fPos = (data->fPos + 4);
            								...
            								break;
            								case (int)8: {
HXLINE(1825)									data->oPos = (data->oPos + 3);
            								}
            								break;
            								case (int)9: {
HXLINE(1825)									data->fPos = (data->fPos + 4);
            								...
            								break;
            								case (int)10: {
HXLINE(1825)									data->fPos = (data->fPos + 5);
HXDLIN(1825)									data->oPos = (data->oPos + 1);
            								}
            								break;
            								case (int)12: {
HXLINE(1825)									data->oPos = (data->oPos + 4);
...
HXDLIN(1825)									data->fPos = (data->fPos + 1);
            								...
            								case (int)16: {
HXLINE(1825)									data->oPos = (data->oPos + 4);
HXDLIN(1825)									data->iPos = (data->iPos + 1);
HXDLIN(1825)									data->fPos = (data->fPos + 2);
HXDLIN(1825)									data->bPos = (data->bPos + 1);
            								}
            								break;
            								case (int)17: {
HXLINE(1825)									data->fPos = (data->fPos + 2);
            								}
            								break;
            								case (int)18: {
HXLINE(1825)									data->fPos = (data->fPos + 2);
...
HXLINE(1812)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1812)								data->oPos = (data->oPos + 2);
HXDLIN(1812)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1812)								data->iPos = (data->iPos + 1);
HXDLIN(1812)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1812)								data->oPos = (data->oPos + 4);
HXDLIN(1812)								data->iiPos = (data->iiPos + 2);
HXDLIN(1812)								data->ffPos = (data->ffPos + 1);
HXDLIN(1812)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1812)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1812)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1812)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1812)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1812)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1812)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1812)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1812)								data->fPos = (data->fPos + 5);
HXDLIN(1812)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1812)								data->oPos = (data->oPos + 4);
...
HXDLIN(1812)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1812)								data->oPos = (data->oPos + 4);
HXDLIN(1812)								data->iPos = (data->iPos + 1);
HXDLIN(1812)								data->fPos = (data->fPos + 2);
HXDLIN(1812)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1812)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1812)								data->fPos = (data->fPos + 2);
...
HXLINE(1804)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1804)								data->oPos = (data->oPos + 2);
HXDLIN(1804)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1804)								data->iPos = (data->iPos + 1);
HXDLIN(1804)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1804)								data->oPos = (data->oPos + 4);
HXDLIN(1804)								data->iiPos = (data->iiPos + 2);
HXDLIN(1804)								data->ffPos = (data->ffPos + 1);
HXDLIN(1804)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1804)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1804)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1804)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1804)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1804)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1804)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1804)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1804)								data->fPos = (data->fPos + 5);
HXDLIN(1804)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1804)								data->oPos = (data->oPos + 4);
...
HXDLIN(1804)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1804)								data->oPos = (data->oPos + 4);
HXDLIN(1804)								data->iPos = (data->iPos + 1);
HXDLIN(1804)								data->fPos = (data->fPos + 2);
HXDLIN(1804)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1804)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1804)								data->fPos = (data->fPos + 2);
...
HXLINE(1819)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1819)								data->oPos = (data->oPos + 2);
HXDLIN(1819)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1819)								data->iPos = (data->iPos + 1);
HXDLIN(1819)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1819)								data->oPos = (data->oPos + 4);
HXDLIN(1819)								data->iiPos = (data->iiPos + 2);
HXDLIN(1819)								data->ffPos = (data->ffPos + 1);
HXDLIN(1819)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1819)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1819)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1819)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1819)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1819)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1819)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1819)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1819)								data->fPos = (data->fPos + 5);
HXDLIN(1819)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1819)								data->oPos = (data->oPos + 4);
...
HXDLIN(1819)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1819)								data->oPos = (data->oPos + 4);
HXDLIN(1819)								data->iPos = (data->iPos + 1);
HXDLIN(1819)								data->fPos = (data->fPos + 2);
HXDLIN(1819)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1819)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1819)								data->fPos = (data->fPos + 2);
...
HXDLIN(1819)						 ::openfl::display::_internal::DrawCommandReader c9 = data;
HXLINE(1820)						stroke =  ::openfl::display::GraphicsStroke_obj::__alloc( HX_CTX ,c9->buffer->o->__get(c9->oPos),c9->buffer->b->__get(c9->bPos),c9->buffer->o->__get((c9->oPos + 1)),c9->buffer->o->__get((c9->oPos + 2)),c9->buffer->o->__get((c9->oPos + 3)),c9->buffer->f->__get((c9->fPos + 1)),null());
HXLINE(1821)						stroke->fill =  ::openfl::display::GraphicsSolidFill_obj::__alloc( HX_CTX ,c9->buffer->i->__get(c9->iPos),c9->buffer->f->__get(c9->fPos));
...
HXLINE(1778)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1778)								data->oPos = (data->oPos + 2);
HXDLIN(1778)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1778)								data->iPos = (data->iPos + 1);
HXDLIN(1778)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1778)								data->oPos = (data->oPos + 4);
HXDLIN(1778)								data->iiPos = (data->iiPos + 2);
HXDLIN(1778)								data->ffPos = (data->ffPos + 1);
HXDLIN(1778)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1778)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1778)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1778)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1778)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1778)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1778)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1778)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1778)								data->fPos = (data->fPos + 5);
HXDLIN(1778)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1778)								data->oPos = (data->oPos + 4);
...
HXDLIN(1778)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1778)								data->oPos = (data->oPos + 4);
HXDLIN(1778)								data->iPos = (data->iPos + 1);
HXDLIN(1778)								data->fPos = (data->fPos + 2);
HXDLIN(1778)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1778)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1778)								data->fPos = (data->fPos + 2);
...
HXDLIN(1778)						 ::openfl::display::_internal::DrawCommandReader c10 = data;
HXLINE(1779)						path->lineTo(c10->buffer->f->__get(c10->fPos),c10->buffer->f->__get((c10->fPos + 1)));
            					}
            					break;
            					case (int)18: {
HXLINE(1782)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1782)								data->oPos = (data->oPos + 2);
HXDLIN(1782)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1782)								data->iPos = (data->iPos + 1);
HXDLIN(1782)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1782)								data->oPos = (data->oPos + 4);
HXDLIN(1782)								data->iiPos = (data->iiPos + 2);
HXDLIN(1782)								data->ffPos = (data->ffPos + 1);
HXDLIN(1782)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1782)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1782)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1782)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1782)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1782)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1782)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1782)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1782)								data->fPos = (data->fPos + 5);
HXDLIN(1782)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1782)								data->oPos = (data->oPos + 4);
...
HXDLIN(1782)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1782)								data->oPos = (data->oPos + 4);
HXDLIN(1782)								data->iPos = (data->iPos + 1);
HXDLIN(1782)								data->fPos = (data->fPos + 2);
HXDLIN(1782)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1782)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1782)								data->fPos = (data->fPos + 2);
...
HXDLIN(1782)						 ::openfl::display::_internal::DrawCommandReader c11 = data;
HXLINE(1783)						path->moveTo(c11->buffer->f->__get(c11->fPos),c11->buffer->f->__get((c11->fPos + 1)));
            					}
            					break;
            					default:{
HXLINE(1844)						switch((int)(data->prev->_hx_getIndex())){
            							case (int)0: {
HXLINE(1844)								data->oPos = (data->oPos + 2);
HXDLIN(1844)								data->bPos = (data->bPos + 2);
            							}
            							break;
            							case (int)1: {
HXLINE(1844)								data->iPos = (data->iPos + 1);
HXDLIN(1844)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)2: {
HXLINE(1844)								data->oPos = (data->oPos + 4);
HXDLIN(1844)								data->iiPos = (data->iiPos + 2);
HXDLIN(1844)								data->ffPos = (data->ffPos + 1);
HXDLIN(1844)								data->fPos = (data->fPos + 1);
            							}
            							break;
            							case (int)3: {
HXLINE(1844)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)4: {
HXLINE(1844)								data->fPos = (data->fPos + 6);
            							}
            							break;
            							case (int)5: {
HXLINE(1844)								data->fPos = (data->fPos + 4);
            							}
            							break;
            							case (int)6: {
HXLINE(1844)								data->fPos = (data->fPos + 3);
            							}
            							break;
            							case (int)7: {
HXLINE(1844)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)8: {
HXLINE(1844)								data->oPos = (data->oPos + 3);
            							}
            							break;
            							case (int)9: {
HXLINE(1844)								data->fPos = (data->fPos + 4);
            							...
            							break;
            							case (int)10: {
HXLINE(1844)								data->fPos = (data->fPos + 5);
HXDLIN(1844)								data->oPos = (data->oPos + 1);
            							}
            							break;
            							case (int)12: {
HXLINE(1844)								data->oPos = (data->oPos + 4);
...
HXDLIN(1844)								data->fPos = (data->fPos + 1);
            							...
            							case (int)16: {
HXLINE(1844)								data->oPos = (data->oPos + 4);
HXDLIN(1844)								data->iPos = (data->iPos + 1);
HXDLIN(1844)								data->fPos = (data->fPos + 2);
HXDLIN(1844)								data->bPos = (data->bPos + 1);
            							}
            							break;
            							case (int)17: {
HXLINE(1844)								data->fPos = (data->fPos + 2);
            							}
            							break;
            							case (int)18: {
HXLINE(1844)								data->fPos = (data->fPos + 2);
