...
HX_DEFINE_STACK_FRAME(_hx_pos_642a1830a16331e0_86_new,"openfl.display.GraphicsShader","new",0xf37fb62c,"openfl.display.GraphicsShader.new","openfl/display/GraphicsShader.hx",86,0x1b418782)
namespace openfl{
namespace display{

void GraphicsShader_obj::__construct( ::openfl::utils::ByteArrayData code){
            	HX_STACKFRAME(&_hx_pos_642a1830a16331e0_86_new)
...
HXLINE(  87)		super::__construct(code);
