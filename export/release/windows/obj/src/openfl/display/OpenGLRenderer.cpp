...
HXLINE( 496)		{
HXLINE( 496)			_matrix->a = transform->a;
HXDLIN( 496)			_matrix->b = transform->b;
HXDLIN( 496)			_matrix->c = transform->c;
HXDLIN( 496)			_matrix->d = transform->d;
HXDLIN( 496)			_matrix->tx = transform->tx;
HXDLIN( 496)			_matrix->ty = transform->ty;
            		}
HXLINE( 497)		{
HXLINE( 497)			 ::openfl::geom::Matrix m = this->_hx___worldTransform;
HXDLIN( 497)			Float a1 = ((_matrix->a * m->a) + (_matrix->b * m->c));
HXDLIN( 497)			_matrix->b = ((_matrix->a * m->b) + (_matrix->b * m->d));
HXDLIN( 497)			_matrix->a = a1;
HXDLIN( 497)			Float c1 = ((_matrix->c * m->a) + (_matrix->d * m->c));
HXDLIN( 497)			_matrix->d = ((_matrix->c * m->b) + (_matrix->d * m->d));
HXDLIN( 497)			_matrix->c = c1;
HXDLIN( 497)			Float tx1 = (((_matrix->tx * m->a) + (_matrix->ty * m->c)) + m->tx);
HXDLIN( 497)			_matrix->ty = (((_matrix->tx * m->b) + (_matrix->ty * m->d)) + m->ty);
HXDLIN( 497)			_matrix->tx = tx1;
            		}
...
HXLINE( 692)				{
HXLINE( 692)					 ::openfl::geom::Matrix _this = shape->_hx___renderTransform;
HXDLIN( 692)					 ::openfl::geom::Matrix sourceMatrix = object->_hx___renderTransform;
HXDLIN( 692)					_this->a = sourceMatrix->a;
HXDLIN( 692)					_this->b = sourceMatrix->b;
HXDLIN( 692)					_this->c = sourceMatrix->c;
HXDLIN( 692)					_this->d = sourceMatrix->d;
HXDLIN( 692)					_this->tx = sourceMatrix->tx;
HXDLIN( 692)					_this->ty = sourceMatrix->ty;
            				}
...
HXLINE( 717)		{
HXLINE( 717)			_matrix->a = transform->a;
HXDLIN( 717)			_matrix->b = transform->b;
HXDLIN( 717)			_matrix->c = transform->c;
HXDLIN( 717)			_matrix->d = transform->d;
HXDLIN( 717)			_matrix->tx = transform->tx;
HXDLIN( 717)			_matrix->ty = transform->ty;
            		}
HXLINE( 718)		{
HXLINE( 718)			 ::openfl::geom::Matrix m = this->_hx___worldTransform;
HXDLIN( 718)			Float a1 = ((_matrix->a * m->a) + (_matrix->b * m->c));
HXDLIN( 718)			_matrix->b = ((_matrix->a * m->b) + (_matrix->b * m->d));
HXDLIN( 718)			_matrix->a = a1;
HXDLIN( 718)			Float c1 = ((_matrix->c * m->a) + (_matrix->d * m->c));
HXDLIN( 718)			_matrix->d = ((_matrix->c * m->b) + (_matrix->d * m->d));
HXDLIN( 718)			_matrix->c = c1;
HXDLIN( 718)			Float tx1 = (((_matrix->tx * m->a) + (_matrix->ty * m->c)) + m->tx);
HXDLIN( 718)			_matrix->ty = (((_matrix->tx * m->b) + (_matrix->ty * m->d)) + m->ty);
HXDLIN( 718)			_matrix->tx = tx1;
            		}
...
HXLINE( 759)			{
HXLINE( 759)				 ::openfl::geom::Rectangle _this = ::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle;
HXDLIN( 759)				_this->x = ( (Float)(this->_hx___offsetX) );
HXDLIN( 759)				_this->y = ( (Float)(this->_hx___offsetY) );
HXDLIN( 759)				_this->width = ( (Float)(this->_hx___displayWidth) );
HXDLIN( 759)				_this->height = ( (Float)(this->_hx___displayHeight) );
            			}
...
HXLINE( 775)					{
HXLINE( 775)						 ::openfl::geom::Rectangle _this1 = ::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle;
HXDLIN( 775)						_this1->x = ( (Float)(0) );
HXDLIN( 775)						_this1->y = ( (Float)(0) );
HXDLIN( 775)						_this1->width = ( (Float)(this->_hx___offsetX) );
HXDLIN( 775)						_this1->height = ( (Float)(this->_hx___height) );
            					}
...
HXLINE( 784)					{
HXLINE( 784)						 ::openfl::geom::Rectangle _this2 = ::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle;
HXDLIN( 784)						_this2->x = ( (Float)((this->_hx___offsetX + this->_hx___displayWidth)) );
HXDLIN( 784)						_this2->y = ( (Float)(0) );
HXDLIN( 784)						_this2->width = ( (Float)(this->_hx___width) );
HXDLIN( 784)						_this2->height = ( (Float)(this->_hx___height) );
            					}
...
HXLINE( 796)					{
HXLINE( 796)						 ::openfl::geom::Rectangle _this3 = ::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle;
HXDLIN( 796)						_this3->x = ( (Float)(0) );
HXDLIN( 796)						_this3->y = ( (Float)(0) );
HXDLIN( 796)						_this3->width = ( (Float)(this->_hx___width) );
HXDLIN( 796)						_this3->height = ( (Float)(this->_hx___offsetY) );
            					}
...
HXLINE( 805)					{
HXLINE( 805)						 ::openfl::geom::Rectangle _this4 = ::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle;
HXDLIN( 805)						_this4->x = ( (Float)(0) );
HXDLIN( 805)						_this4->y = ( (Float)((this->_hx___offsetY + this->_hx___displayHeight)) );
HXDLIN( 805)						_this4->width = ( (Float)(this->_hx___width) );
HXDLIN( 805)						_this4->height = ( (Float)(this->_hx___height) );
            					}
...
HXLINE( 819)			{
HXLINE( 819)				 ::openfl::geom::Rectangle _this5 = ::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle;
HXDLIN( 819)				_this5->x = ( (Float)(this->_hx___offsetX) );
HXDLIN( 819)				_this5->y = ( (Float)(this->_hx___offsetY) );
HXDLIN( 819)				_this5->width = ( (Float)(this->_hx___displayWidth) );
HXDLIN( 819)				_this5->height = ( (Float)(this->_hx___displayHeight) );
            			}
...
HXLINE( 998)			{
HXLINE( 998)				 ::openfl::geom::Rectangle _this = ::openfl::display::OpenGLRenderer_obj::_hx___scissorRectangle;
HXDLIN( 998)				_this->x = ( (Float)(x) );
HXDLIN( 998)				_this->y = ( (Float)(y) );
HXDLIN( 998)				_this->width = ( (Float)(width) );
HXDLIN( 998)				_this->height = ( (Float)(height) );
            			}
