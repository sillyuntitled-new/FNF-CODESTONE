...
HXLINE( 357)			{
HXLINE( 357)				 ::openfl::geom::Matrix sourceMatrix = this->_hx___getWorldTransform();
HXDLIN( 357)				matrix->a = sourceMatrix->a;
HXDLIN( 357)				matrix->b = sourceMatrix->b;
HXDLIN( 357)				matrix->c = sourceMatrix->c;
HXDLIN( 357)				matrix->d = sourceMatrix->d;
HXDLIN( 357)				matrix->tx = sourceMatrix->tx;
HXDLIN( 357)				matrix->ty = sourceMatrix->ty;
            			}
HXLINE( 358)			 ::openfl::geom::Matrix targetMatrix = ::openfl::geom::Matrix_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 360)			{
HXLINE( 360)				 ::openfl::geom::Matrix sourceMatrix1 = targetCoordinateSpace->_hx___getWorldTransform();
HXDLIN( 360)				targetMatrix->a = sourceMatrix1->a;
HXDLIN( 360)				targetMatrix->b = sourceMatrix1->b;
HXDLIN( 360)				targetMatrix->c = sourceMatrix1->c;
HXDLIN( 360)				targetMatrix->d = sourceMatrix1->d;
HXDLIN( 360)				targetMatrix->tx = sourceMatrix1->tx;
HXDLIN( 360)				targetMatrix->ty = sourceMatrix1->ty;
            			}
HXLINE( 361)			targetMatrix->invert();
HXLINE( 363)			{
HXLINE( 363)				Float a1 = ((matrix->a * targetMatrix->a) + (matrix->b * targetMatrix->c));
HXDLIN( 363)				matrix->b = ((matrix->a * targetMatrix->b) + (matrix->b * targetMatrix->d));
HXDLIN( 363)				matrix->a = a1;
HXDLIN( 363)				Float c1 = ((matrix->c * targetMatrix->a) + (matrix->d * targetMatrix->c));
HXDLIN( 363)				matrix->d = ((matrix->c * targetMatrix->b) + (matrix->d * targetMatrix->d));
HXDLIN( 363)				matrix->c = c1;
HXDLIN( 363)				Float tx1 = (((matrix->tx * targetMatrix->a) + (matrix->ty * targetMatrix->c)) + targetMatrix->tx);
HXDLIN( 363)				matrix->ty = (((matrix->tx * targetMatrix->b) + (matrix->ty * targetMatrix->d)) + targetMatrix->ty);
HXDLIN( 363)				matrix->tx = tx1;
            			}
HXLINE( 366)			::openfl::geom::Matrix_obj::_hx___pool->release(targetMatrix);
            		}
            		else {
HXLINE( 371)			matrix->a = ( (Float)(1) );
HXDLIN( 371)			matrix->b = ( (Float)(0) );
HXDLIN( 371)			matrix->c = ( (Float)(0) );
HXDLIN( 371)			matrix->d = ( (Float)(1) );
HXDLIN( 371)			matrix->tx = ( (Float)(0) );
HXDLIN( 371)			matrix->ty = ( (Float)(0) );
            		}
...
HXLINE( 440)			return currentBounds->intersects(obj->getBounds(::hx::ObjectPtr<OBJ_>(this)));
            		}
...
HXLINE( 468)					result->x = ( (Float)(0) );
HXDLIN( 468)					result->y = ( (Float)(0) );
HXDLIN( 468)					result->width = ( (Float)(0) );
HXDLIN( 468)					result->height = ( (Float)(0) );
            				}
            				else {
HXLINE( 473)					 ::openfl::geom::Rectangle _g = parentTileset->getRect(this->get_id());
HXLINE( 475)					if (::hx::IsNull( _g )) {
HXLINE( 476)						result->x = ( (Float)(0) );
HXDLIN( 476)						result->y = ( (Float)(0) );
HXDLIN( 476)						result->width = ( (Float)(0) );
HXDLIN( 476)						result->height = ( (Float)(0) );
            					}
            					else {
HXLINE( 478)						result->x = _g->x;
HXDLIN( 478)						result->y = _g->y;
HXDLIN( 478)						result->width = _g->width;
HXDLIN( 478)						result->height = _g->height;
            					}
            				}
            			}
            			else {
HXLINE( 484)				result->x = ( (Float)(0) );
HXDLIN( 484)				result->y = ( (Float)(0) );
HXDLIN( 484)				result->width = ( (Float)(0) );
HXDLIN( 484)				result->height = ( (Float)(0) );
            			}
            		}
            		else {
HXLINE( 489)			 ::openfl::display::Tileset sourceRect = this->get_tileset();
HXDLIN( 489)			 ::openfl::geom::Rectangle sourceRect1 = sourceRect->getRect(this->get_id());
HXDLIN( 489)			result->x = sourceRect1->x;
HXDLIN( 489)			result->y = sourceRect1->y;
HXDLIN( 489)			result->width = sourceRect1->width;
HXDLIN( 489)			result->height = sourceRect1->height;
            		}
...
HXLINE( 517)			 ::openfl::geom::Matrix m = this->parent->_hx___getWorldTransform();
HXDLIN( 517)			Float a1 = ((retval->a * m->a) + (retval->b * m->c));
HXDLIN( 517)			retval->b = ((retval->a * m->b) + (retval->b * m->d));
HXDLIN( 517)			retval->a = a1;
HXDLIN( 517)			Float c1 = ((retval->c * m->a) + (retval->d * m->c));
HXDLIN( 517)			retval->d = ((retval->c * m->b) + (retval->d * m->d));
HXDLIN( 517)			retval->c = c1;
HXDLIN( 517)			Float tx1 = (((retval->tx * m->a) + (retval->ty * m->c)) + m->tx);
HXDLIN( 517)			retval->ty = (((retval->tx * m->b) + (retval->ty * m->d)) + m->ty);
HXDLIN( 517)			retval->tx = tx1;
            		}
...
HXLINE( 774)				this->get_rotation();
HXLINE( 779)				this->_hx___matrix->a = (this->_hx___rotationCosine * value);
HXLINE( 780)				this->_hx___matrix->b = (this->_hx___rotationSine * value);
            			}
...
HXLINE( 818)				this->get_rotation();
HXLINE( 823)				this->_hx___matrix->c = (-(this->_hx___rotationSine) * value);
HXLINE( 824)				this->_hx___matrix->d = (this->_hx___rotationCosine * value);
            			}
