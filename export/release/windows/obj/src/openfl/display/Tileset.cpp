...
HXDLIN( 115)				_g = (_g + 1);
HXLINE( 117)				{
HXLINE( 117)					rect->x = ( (Float)(tileData->x) );
HXDLIN( 117)					rect->y = ( (Float)(tileData->y) );
HXDLIN( 117)					rect->width = ( (Float)(tileData->width) );
HXDLIN( 117)					rect->height = ( (Float)(tileData->height) );
            				}
