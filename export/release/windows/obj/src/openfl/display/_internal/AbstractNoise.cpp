...
HXLINE(  65)			r = this->mixI(((dest >> 16) & 255),r,u);
HXLINE(  66)			g = this->mixI(((dest >> 8) & 255),g,u);
HXLINE(  67)			b = this->mixI((dest & 255),b,u);
            		}
...
HXLINE(  80)			r = this->mixI(((dest1 >> 16) & 255),r,u1);
HXLINE(  81)			g = this->mixI(((dest1 >> 8) & 255),g,u1);
HXLINE(  82)			b = this->mixI((dest1 & 255),b,u1);
            		}
...
HXLINE( 160)				this->persistence_max = (this->persistence_max + fPers);
