...
HXLINE( 437)		int len = uvt->_hx___array->length;
HXLINE( 439)		{
HXLINE( 439)			int _g = 1;
...
HXLINE( 761)							length = indices->_hx___array->length;
            						}
            						else {
HXLINE( 761)							length = ::Math_obj::floor((( (Float)(rects->_hx___array->length) ) / ( (Float)(4) )));
            						}
HXLINE( 762)						if ((length == 0)) {
HXLINE( 762)							return;
            						}
HXLINE( 764)						if (::hx::IsNotNull( transforms )) {
HXLINE( 766)							if ((transforms->_hx___array->length >= (length * 6))) {
HXLINE( 768)								transformABCD = true;
HXLINE( 769)								transformXY = true;
            							}
            							else {
HXLINE( 771)								if ((transforms->_hx___array->length >= (length * 4))) {
HXLINE( 773)									transformABCD = true;
            								}
            								else {
HXLINE( 775)									if ((transforms->_hx___array->length >= (length * 2))) {
...
HXLINE( 797)								{
HXLINE( 797)									Float xa = rects->get(ri);
HXDLIN( 797)									Float ya = rects->get((ri + 1));
HXDLIN( 797)									Float widtha = rects->get((ri + 2));
HXDLIN( 797)									Float heighta = rects->get((ri + 3));
HXDLIN( 797)									tileRect->x = xa;
HXDLIN( 797)									tileRect->y = ya;
HXDLIN( 797)									tileRect->width = widtha;
HXDLIN( 797)									tileRect->height = heighta;
            								}
HXLINE( 799)								bool _hx_tmp;
HXDLIN( 799)								if (!((tileRect->width <= 0))) {
HXLINE( 799)									_hx_tmp = (tileRect->height <= 0);
            								}
            								else {
...
HXLINE( 804)									_hx_tmp1 = transformXY;
            								}
            								else {
...
HXLINE( 806)									ti = (i * 6);
HXLINE( 807)									{
HXLINE( 807)										Float a = transforms->get(ti);
HXDLIN( 807)										Float b1 = transforms->get((ti + 1));
HXDLIN( 807)										Float c9 = transforms->get((ti + 2));
HXDLIN( 807)										Float d = transforms->get((ti + 3));
HXDLIN( 807)										Float tx = transforms->get((ti + 4));
HXDLIN( 807)										Float ty = transforms->get((ti + 5));
HXDLIN( 807)										tileTransform->a = a;
HXDLIN( 807)										tileTransform->b = b1;
HXDLIN( 807)										tileTransform->c = c9;
HXDLIN( 807)										tileTransform->d = d;
HXDLIN( 807)										tileTransform->tx = tx;
HXDLIN( 807)										tileTransform->ty = ty;
            									}
            								}
            								else {
...
HXLINE( 812)										ti = (i * 4);
HXLINE( 813)										{
HXLINE( 813)											Float a1 = transforms->get(ti);
HXDLIN( 813)											Float b2 = transforms->get((ti + 1));
HXDLIN( 813)											Float c10 = transforms->get((ti + 2));
HXDLIN( 813)											Float d1 = transforms->get((ti + 3));
HXDLIN( 813)											tileTransform->a = a1;
HXDLIN( 813)											tileTransform->b = b2;
HXDLIN( 813)											tileTransform->c = c10;
HXDLIN( 813)											tileTransform->d = d1;
HXDLIN( 813)											tileTransform->tx = tileRect->x;
HXDLIN( 813)											tileTransform->ty = tileRect->y;
            										}
            									}
            									else {
...
HXLINE( 829)								{
HXLINE( 829)									Float a11 = ((tileTransform->a * transform->a) + (tileTransform->b * transform->c));
HXDLIN( 829)									tileTransform->b = ((tileTransform->a * transform->b) + (tileTransform->b * transform->d));
HXDLIN( 829)									tileTransform->a = a11;
HXDLIN( 829)									Float c11 = ((tileTransform->c * transform->a) + (tileTransform->d * transform->c));
HXDLIN( 829)									tileTransform->d = ((tileTransform->c * transform->b) + (tileTransform->d * transform->d));
HXDLIN( 829)									tileTransform->c = c11;
HXDLIN( 829)									Float tx1 = (((tileTransform->tx * transform->a) + (tileTransform->ty * transform->c)) + transform->tx);
HXDLIN( 829)									tileTransform->ty = (((tileTransform->tx * transform->b) + (tileTransform->ty * transform->d)) + transform->ty);
HXDLIN( 829)									tileTransform->tx = tx1;
            								}
HXLINE( 838)								 ::lime::graphics::cairo::Cairo _hx_tmp2 = ::openfl::display::_internal::CairoGraphics_obj::cairo;
HXDLIN( 838)								_hx_tmp2->set_matrix(tileTransform->_hx___toMatrix3());
...
HXLINE( 875)						 ::lime::graphics::cairo::Cairo _hx_tmp3 = ::openfl::display::_internal::CairoGraphics_obj::cairo;
HXDLIN( 875)						_hx_tmp3->set_matrix(::openfl::display::_internal::CairoGraphics_obj::graphics->_hx___renderTransform->_hx___toMatrix3());
...
HXDLIN( 541)						 ::openfl::display::_internal::DrawCommandReader c12 = data;
HXLINE( 542)						hasPath = true;
HXLINE( 543)						::openfl::display::_internal::CairoGraphics_obj::cairo->rectangle((c12->buffer->f->__get(c12->fPos) - offsetX),(c12->buffer->f->__get((c12->fPos + 1)) - offsetY),c12->buffer->f->__get((c12->fPos + 2)),c12->buffer->f->__get((c12->fPos + 3)));
            					}
            					break;
            					case (int)10: {
...
HXDLIN( 571)						 ::openfl::display::_internal::DrawCommandReader c13 = data;
HXLINE( 572)						hasPath = true;
HXLINE( 573)						::openfl::display::_internal::CairoGraphics_obj::drawRoundRect((c13->buffer->f->__get(c13->fPos) - offsetX),(c13->buffer->f->__get((c13->fPos + 1)) - offsetY),c13->buffer->f->__get((c13->fPos + 2)),c13->buffer->f->__get((c13->fPos + 3)),c13->buffer->f->__get((c13->fPos + 4)),c13->buffer->o->__get(c13->oPos));
            					}
            					break;
            					case (int)12: {
...
HXDLIN( 879)						 ::openfl::display::_internal::DrawCommandReader c14 = data;
HXLINE( 880)						 ::openfl::_Vector::FloatVector v = ( ( ::openfl::_Vector::FloatVector)(c14->buffer->o->__get(c14->oPos)) );
HXLINE( 881)						 ::openfl::_Vector::IntVector ind = ( ( ::openfl::_Vector::IntVector)(c14->buffer->o->__get((c14->oPos + 1))) );
HXLINE( 882)						 ::openfl::_Vector::FloatVector uvt = ( ( ::openfl::_Vector::FloatVector)(c14->buffer->o->__get((c14->oPos + 2))) );
HXLINE( 883)						bool colorFill = ::hx::IsNull( ::openfl::display::_internal::CairoGraphics_obj::bitmapFill );
HXLINE( 885)						bool _hx_tmp4;
HXDLIN( 885)						if (colorFill) {
HXLINE( 885)							_hx_tmp4 = ::hx::IsNotNull( uvt );
            						}
            						else {
HXLINE( 885)							_hx_tmp4 = false;
            						}
HXDLIN( 885)						if (_hx_tmp4) {
...
HXDLIN( 902)									int _g5 = ::Std_obj::_hx_int((( (Float)(v->_hx___array->length) ) / ( (Float)(2) )));
...
HXLINE( 909)							bool skipT = (( ( ::openfl::_Vector::FloatVector)(c14->buffer->o->__get((c14->oPos + 2))) )->_hx___array->length != v->_hx___array->length);
HXLINE( 910)							 ::Dynamic normalizedUVT = ::openfl::display::_internal::CairoGraphics_obj::normalizeUVT(uvt,skipT);
...
HXLINE( 926)						int i2 = 0;
HXLINE( 927)						int l = ind->_hx___array->length;
HXLINE( 929)						int a_;
HXDLIN( 929)						int b_;
HXDLIN( 929)						int c_;
HXLINE( 930)						int iax;
...
HXLINE( 959)							 ::Dynamic _hx_switch_0 = c14->buffer->o->__get((c14->oPos + 3));
            							if (  (_hx_switch_0==0) ){
...
HXLINE( 991)							 ::lime::graphics::cairo::Cairo _hx_tmp5 = ::openfl::display::_internal::CairoGraphics_obj::cairo;
HXDLIN( 991)							_hx_tmp5->set_matrix(::openfl::display::_internal::CairoGraphics_obj::graphics->_hx___renderTransform->_hx___toMatrix3());
...
HXLINE(1039)						 ::lime::graphics::cairo::Cairo _hx_tmp6 = ::openfl::display::_internal::CairoGraphics_obj::cairo;
HXDLIN(1039)						_hx_tmp6->set_matrix(::openfl::display::_internal::CairoGraphics_obj::graphics->_hx___renderTransform->_hx___toMatrix3());
            					}
            					break;
            					case (int)14: {
...
HXDLIN( 681)						 ::openfl::display::_internal::DrawCommandReader c15 = data;
HXLINE( 682)						bool _hx_tmp7;
HXDLIN( 682)						if (stroke) {
HXLINE( 682)							_hx_tmp7 = ::openfl::display::_internal::CairoGraphics_obj::hasStroke;
            						}
            						else {
...
HXLINE( 688)						::openfl::display::_internal::CairoGraphics_obj::strokePattern = ::openfl::display::_internal::CairoGraphics_obj::createImagePattern(( ( ::openfl::display::BitmapData)(c15->buffer->o->__get(c15->oPos)) ),( ( ::openfl::geom::Matrix)(c15->buffer->o->__get((c15->oPos + 1))) ),c15->buffer->b->__get(c15->bPos),c15->buffer->b->__get((c15->bPos + 1)));
...
HXDLIN( 668)						 ::openfl::display::_internal::DrawCommandReader c16 = data;
HXLINE( 669)						bool _hx_tmp8;
HXDLIN( 669)						if (stroke) {
HXLINE( 669)							_hx_tmp8 = ::openfl::display::_internal::CairoGraphics_obj::hasStroke;
            						}
            						else {
...
HXLINE( 675)						::openfl::display::_internal::CairoGraphics_obj::strokePattern = ::openfl::display::_internal::CairoGraphics_obj::createGradientPattern(c16->buffer->o->__get(c16->oPos),c16->buffer->ii->__get(c16->iiPos).StaticCast< ::Array< int > >(),c16->buffer->ff->__get(c16->ffPos).StaticCast< ::Array< Float > >(),c16->buffer->ii->__get((c16->iiPos + 1)).StaticCast< ::Array< int > >(),( ( ::openfl::geom::Matrix)(c16->buffer->o->__get((c16->oPos + 1))) ),c16->buffer->o->__get((c16->oPos + 2)),c16->buffer->o->__get((c16->oPos + 3)),c16->buffer->f->__get(c16->fPos));
...
HXDLIN( 605)						 ::openfl::display::_internal::DrawCommandReader c17 = data;
HXLINE( 606)						bool _hx_tmp9;
HXDLIN( 606)						if (stroke) {
HXLINE( 606)							_hx_tmp9 = ::openfl::display::_internal::CairoGraphics_obj::hasStroke;
            						}
            						else {
HXLINE( 606)							_hx_tmp9 = false;
            						}
HXDLIN( 606)						if (_hx_tmp9) {
...
HXLINE( 613)						if (::hx::IsNull( c17->buffer->o->__get(c17->oPos) )) {
...
HXLINE( 621)							Float _hx_tmp10;
HXDLIN( 621)							if (::hx::IsGreater( c17->buffer->o->__get(c17->oPos),0 )) {
HXLINE( 621)								_hx_tmp10 = ( (Float)(c17->buffer->o->__get(c17->oPos)) );
            							}
            							else {
HXLINE( 621)								_hx_tmp10 = ( (Float)(1) );
            							}
HXDLIN( 621)							::openfl::display::_internal::CairoGraphics_obj::cairo->set_lineWidth(_hx_tmp10);
HXLINE( 623)							if (::hx::IsNull( c17->buffer->o->__get((c17->oPos + 3)) )) {
HXLINE( 625)								::openfl::display::_internal::CairoGraphics_obj::cairo->set_lineJoin(1);
            							}
            							else {
HXLINE( 629)								int _hx_tmp11;
HXDLIN( 629)								 ::Dynamic _hx_switch_1 = c17->buffer->o->__get((c17->oPos + 3));
            								if (  (_hx_switch_1==0) ){
HXLINE( 629)									_hx_tmp11 = 2;
HXDLIN( 629)									goto _hx_goto_19;
            								}
            								if (  (_hx_switch_1==1) ){
HXLINE( 629)									_hx_tmp11 = 0;
HXDLIN( 629)									goto _hx_goto_19;
            								}
            								/* default */{
HXLINE( 629)									_hx_tmp11 = 1;
            								}
            								_hx_goto_19:;
HXDLIN( 629)								::openfl::display::_internal::CairoGraphics_obj::cairo->set_lineJoin(_hx_tmp11);
            							}
HXLINE( 637)							if (::hx::IsNull( c17->buffer->o->__get((c17->oPos + 2)) )) {
HXLINE( 639)								::openfl::display::_internal::CairoGraphics_obj::cairo->set_lineCap(1);
            							}
            							else {
HXLINE( 643)								int _hx_tmp12;
HXDLIN( 643)								 ::Dynamic _hx_switch_2 = c17->buffer->o->__get((c17->oPos + 2));
            								if (  (_hx_switch_2==0) ){
HXLINE( 643)									_hx_tmp12 = 0;
HXDLIN( 643)									goto _hx_goto_20;
            								}
            								if (  (_hx_switch_2==2) ){
HXLINE( 643)									_hx_tmp12 = 2;
HXDLIN( 643)									goto _hx_goto_20;
            								}
            								/* default */{
HXLINE( 643)									_hx_tmp12 = 1;
            								}
            								_hx_goto_20:;
HXDLIN( 643)								::openfl::display::_internal::CairoGraphics_obj::cairo->set_lineCap(_hx_tmp12);
            							}
HXLINE( 651)							::openfl::display::_internal::CairoGraphics_obj::cairo->set_miterLimit(c17->buffer->f->__get((c17->fPos + 1)));
HXLINE( 653)							r = (( (Float)(::hx::UShr((c17->buffer->i->__get(c17->iPos) & 16711680),16)) ) / ( (Float)(255) ));
HXLINE( 654)							g = (( (Float)(::hx::UShr((c17->buffer->i->__get(c17->iPos) & 65280),8)) ) / ( (Float)(255) ));
HXLINE( 655)							b = (( (Float)((c17->buffer->i->__get(c17->iPos) & 255)) ) / ( (Float)(255) ));
HXLINE( 657)							if ((c17->buffer->f->__get(c17->fPos) == 1)) {
...
HXLINE( 663)								::openfl::display::_internal::CairoGraphics_obj::strokePattern = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createRGBA(r,g,b,c17->buffer->f->__get(c17->fPos));
            							}
            						}
            					}
            					break;
...
HXDLIN( 576)						 ::openfl::display::_internal::DrawCommandReader c18 = data;
HXLINE( 577)						hasPath = true;
HXLINE( 578)						::openfl::display::_internal::CairoGraphics_obj::cairo->lineTo((c18->buffer->f->__get(c18->fPos) - offsetX),(c18->buffer->f->__get((c18->fPos + 1)) - offsetY));
HXLINE( 580)						positionX = c18->buffer->f->__get(c18->fPos);
HXLINE( 581)						positionY = c18->buffer->f->__get((c18->fPos + 1));
HXLINE( 583)						bool _hx_tmp13;
HXDLIN( 583)						if ((positionX == startX)) {
HXLINE( 583)							_hx_tmp13 = (positionY == startY);
            						}
            						else {
HXLINE( 583)							_hx_tmp13 = false;
            						}
HXDLIN( 583)						if (_hx_tmp13) {
...
HXDLIN( 589)						 ::openfl::display::_internal::DrawCommandReader c19 = data;
HXLINE( 590)						::openfl::display::_internal::CairoGraphics_obj::cairo->moveTo((c19->buffer->f->__get(c19->fPos) - offsetX),(c19->buffer->f->__get((c19->fPos + 1)) - offsetY));
HXLINE( 592)						positionX = c19->buffer->f->__get(c19->fPos);
HXLINE( 593)						positionY = c19->buffer->f->__get((c19->fPos + 1));
HXLINE( 595)						bool _hx_tmp14;
HXDLIN( 595)						bool _hx_tmp15;
HXDLIN( 595)						if (setStart) {
HXLINE( 595)							_hx_tmp15 = (c19->buffer->f->__get(c19->fPos) != startX);
            						}
            						else {
HXLINE( 595)							_hx_tmp15 = false;
            						}
HXDLIN( 595)						if (_hx_tmp15) {
HXLINE( 595)							_hx_tmp14 = (c19->buffer->f->__get((c19->fPos + 1)) != startY);
            						}
            						else {
HXLINE( 595)							_hx_tmp14 = false;
            						}
HXDLIN( 595)						if (_hx_tmp14) {
HXLINE( 597)							closeGap = true;
            						}
HXLINE( 600)						startX = c19->buffer->f->__get(c19->fPos);
HXLINE( 601)						startY = c19->buffer->f->__get((c19->fPos + 1));
...
HXLINE(1058)			bool _hx_tmp16;
HXDLIN(1058)			if (stroke) {
HXLINE(1058)				_hx_tmp16 = ::openfl::display::_internal::CairoGraphics_obj::hasStroke;
            			}
            			else {
HXLINE(1058)				_hx_tmp16 = false;
            			}
HXDLIN(1058)			if (_hx_tmp16) {
HXLINE(1060)				if (::openfl::display::_internal::CairoGraphics_obj::hasFill) {
HXLINE(1062)					bool _hx_tmp17;
HXDLIN(1062)					if ((positionX == startX)) {
HXLINE(1062)						_hx_tmp17 = (positionY != startY);
            					}
            					else {
HXLINE(1062)						_hx_tmp17 = true;
            					}
HXDLIN(1062)					if (_hx_tmp17) {
...
HXLINE(1070)						_hx_tmp19 = (positionX == startX);
            					}
            					else {
HXLINE(1070)						_hx_tmp19 = false;
            					}
HXDLIN(1070)					if (_hx_tmp19) {
HXLINE(1070)						_hx_tmp18 = (positionY == startY);
            					}
            					else {
...
HXLINE(1079)			bool _hx_tmp20;
HXDLIN(1079)			if (!(stroke)) {
HXLINE(1079)				_hx_tmp20 = ::openfl::display::_internal::CairoGraphics_obj::hasFill;
            			}
            			else {
HXLINE(1079)				_hx_tmp20 = false;
            			}
HXDLIN(1079)			if (_hx_tmp20) {
...
HXLINE(1086)					{
HXLINE(1086)						 ::openfl::geom::Matrix sourceMatrix = ::openfl::display::_internal::CairoGraphics_obj::fillPatternMatrix;
HXDLIN(1086)						matrix->a = sourceMatrix->a;
HXDLIN(1086)						matrix->b = sourceMatrix->b;
HXDLIN(1086)						matrix->c = sourceMatrix->c;
HXDLIN(1086)						matrix->d = sourceMatrix->d;
HXDLIN(1086)						matrix->tx = sourceMatrix->tx;
HXDLIN(1086)						matrix->ty = sourceMatrix->ty;
            					}
HXLINE(1087)					matrix->invert();
HXLINE(1089)					if (::hx::IsNotNull( ::openfl::display::_internal::CairoGraphics_obj::pendingMatrix )) {
HXLINE(1091)						 ::openfl::geom::Matrix m = ::openfl::display::_internal::CairoGraphics_obj::pendingMatrix;
HXDLIN(1091)						Float a12 = ((matrix->a * m->a) + (matrix->b * m->c));
HXDLIN(1091)						matrix->b = ((matrix->a * m->b) + (matrix->b * m->d));
HXDLIN(1091)						matrix->a = a12;
HXDLIN(1091)						Float c110 = ((matrix->c * m->a) + (matrix->d * m->c));
HXDLIN(1091)						matrix->d = ((matrix->c * m->b) + (matrix->d * m->d));
HXDLIN(1091)						matrix->c = c110;
HXDLIN(1091)						Float tx11 = (((matrix->tx * m->a) + (matrix->ty * m->c)) + m->tx);
HXDLIN(1091)						matrix->ty = (((matrix->tx * m->b) + (matrix->ty * m->d)) + m->ty);
HXDLIN(1091)						matrix->tx = tx11;
            					}
HXLINE(1094)					 ::Dynamic _hx_tmp21 = ::openfl::display::_internal::CairoGraphics_obj::fillPattern;
HXDLIN(1094)					::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_matrix(_hx_tmp21,matrix->_hx___toMatrix3());
...
HXLINE(1103)					 ::lime::graphics::cairo::Cairo _hx_tmp22 = ::openfl::display::_internal::CairoGraphics_obj::cairo;
HXDLIN(1103)					_hx_tmp22->transform(::openfl::display::_internal::CairoGraphics_obj::pendingMatrix->_hx___toMatrix3());
...
HXLINE(1105)					 ::lime::graphics::cairo::Cairo _hx_tmp23 = ::openfl::display::_internal::CairoGraphics_obj::cairo;
HXDLIN(1105)					_hx_tmp23->transform(::openfl::display::_internal::CairoGraphics_obj::inversePendingMatrix->_hx___toMatrix3());
            				}
            				else {
