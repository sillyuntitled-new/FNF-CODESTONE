...
HXLINE(  61)					{
HXLINE(  61)						Float dy = transform->ty;
HXDLIN(  61)						matrix->tx = (matrix->tx + transform->tx);
HXDLIN(  61)						matrix->ty = (matrix->ty + dy);
            					}
...
HXLINE( 164)					{
HXLINE( 164)						Float sx = (( (Float)(1) ) / graphics->_hx___bitmapScale);
HXDLIN( 164)						Float sy = (( (Float)(1) ) / graphics->_hx___bitmapScale);
HXDLIN( 164)						renderTransform1->a = (renderTransform1->a * sx);
HXDLIN( 164)						renderTransform1->b = (renderTransform1->b * sy);
HXDLIN( 164)						renderTransform1->c = (renderTransform1->c * sx);
HXDLIN( 164)						renderTransform1->d = (renderTransform1->d * sy);
HXDLIN( 164)						renderTransform1->tx = (renderTransform1->tx * sx);
HXDLIN( 164)						renderTransform1->ty = (renderTransform1->ty * sy);
            					}
HXLINE( 165)					{
HXLINE( 165)						Float a1 = ((renderTransform1->a * transform->a) + (renderTransform1->b * transform->c));
HXDLIN( 165)						renderTransform1->b = ((renderTransform1->a * transform->b) + (renderTransform1->b * transform->d));
HXDLIN( 165)						renderTransform1->a = a1;
HXDLIN( 165)						Float c1 = ((renderTransform1->c * transform->a) + (renderTransform1->d * transform->c));
HXDLIN( 165)						renderTransform1->d = ((renderTransform1->c * transform->b) + (renderTransform1->d * transform->d));
HXDLIN( 165)						renderTransform1->c = c1;
HXDLIN( 165)						Float tx1 = (((renderTransform1->tx * transform->a) + (renderTransform1->ty * transform->c)) + transform->tx);
HXDLIN( 165)						renderTransform1->ty = (((renderTransform1->tx * transform->b) + (renderTransform1->ty * transform->d)) + transform->ty);
HXDLIN( 165)						renderTransform1->tx = tx1;
            					}
