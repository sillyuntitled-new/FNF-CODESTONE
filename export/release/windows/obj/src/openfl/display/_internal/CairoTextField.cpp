...
HXLINE(  86)			{
HXLINE(  86)				 ::openfl::geom::Rectangle _this = graphics->_hx___bounds;
HXDLIN(  86)				_this->x = bounds->x;
HXDLIN(  86)				_this->y = bounds->y;
HXDLIN(  86)				_this->width = bounds->width;
HXDLIN(  86)				_this->height = bounds->height;
            			}
            		}
...
HXLINE( 151)			graphics->_hx___cairo =  ::lime::graphics::cairo::Cairo_obj::__alloc( HX_CTX ,bitmap->getSurface());
...
HXLINE( 188)		{
HXLINE( 188)			 ::openfl::geom::Matrix sourceMatrix = graphics->_hx___renderTransform;
HXDLIN( 188)			matrix->a = sourceMatrix->a;
HXDLIN( 188)			matrix->b = sourceMatrix->b;
HXDLIN( 188)			matrix->c = sourceMatrix->c;
HXDLIN( 188)			matrix->d = sourceMatrix->d;
HXDLIN( 188)			matrix->tx = sourceMatrix->tx;
HXDLIN( 188)			matrix->ty = sourceMatrix->ty;
            		}
HXLINE( 189)		{
HXLINE( 189)			matrix->a = (matrix->a * pixelRatio);
HXDLIN( 189)			matrix->b = (matrix->b * pixelRatio);
HXDLIN( 189)			matrix->c = (matrix->c * pixelRatio);
HXDLIN( 189)			matrix->d = (matrix->d * pixelRatio);
HXDLIN( 189)			matrix->tx = (matrix->tx * pixelRatio);
HXDLIN( 189)			matrix->ty = (matrix->ty * pixelRatio);
            		}
...
HXLINE( 211)			cairo->setSourceRGB((( (Float)(::hx::UShr((color & 16711680),16)) ) / ( (Float)(255) )),(( (Float)(::hx::UShr((color & 65280),8)) ) / ( (Float)(255) )),(( (Float)((color & 255)) ) / ( (Float)(255) )));
HXLINE( 212)			cairo->fillPreserve();
            		}
HXLINE( 215)		if (textEngine->border) {
HXLINE( 217)			int color1 = textEngine->borderColor;
HXLINE( 222)			cairo->setSourceRGB((( (Float)(::hx::UShr((color1 & 16711680),16)) ) / ( (Float)(255) )),(( (Float)(::hx::UShr((color1 & 65280),8)) ) / ( (Float)(255) )),(( (Float)((color1 & 255)) ) / ( (Float)(255) )));
...
HXLINE( 237)					_g = (_g + 1);
HXLINE( 239)					scrollY = (scrollY - textEngine->lineHeights->get((_g - 1)));
            				}
            			}
...
HXLINE( 250)					r = (( (Float)(::hx::UShr((( (int)(color2) ) & 16711680),16)) ) / ( (Float)(255) ));
HXLINE( 251)					g = (( (Float)(::hx::UShr((( (int)(color2) ) & 65280),8)) ) / ( (Float)(255) ));
HXLINE( 252)					b = (( (Float)((( (int)(color2) ) & 255)) ) / ( (Float)(255) ));
...
HXLINE( 323)											scrollY1 = (scrollY1 + textEngine->lineHeights->get(((_g6 - 1) - 1)));
            										}
            									}
...
HXLINE( 396)												selectedGylphs->push(glyphs->__get((_g8 - 1)).StaticCast<  ::lime::graphics::cairo::CairoGlyph >());
            											}
            										}
...
HXLINE( 412)							Float y1 = ((::Math_obj::ceil((((group1->offsetY + scrollY) + group1->ascent) - bounds->y)) + ::Math_obj::floor((group1->ascent * ((Float)0.185)))) + ((Float)0.5));
...
HXLINE( 428)						scrollY2 = (scrollY2 + textEngine->lineHeights->get((_g10 - 1)));
            					}
            				}
HXLINE( 431)				 ::Dynamic color3 = textField->get_defaultTextFormat()->color;
HXLINE( 436)				cairo->setSourceRGB((( (Float)(::hx::UShr((( (int)(color3) ) & 16711680),16)) ) / ( (Float)(255) )),(( (Float)(::hx::UShr((( (int)(color3) ) & 65280),8)) ) / ( (Float)(255) )),(( (Float)((( (int)(color3) ) & 255)) ) / ( (Float)(255) )));
