...
HXLINE(  44)		{
HXLINE(  44)			rect->x = ( (Float)(0) );
HXDLIN(  44)			rect->y = ( (Float)(0) );
HXDLIN(  44)			rect->width = ( (Float)(tilemap->_hx___width) );
HXDLIN(  44)			rect->height = ( (Float)(tilemap->_hx___height) );
            		}
...
HXDLIN(  47)		::openfl::display::_internal::CairoTilemap_obj::renderTileContainer(tilemap->_hx___group,renderer,tilemap->_hx___renderTransform,tilemap->_hx___tileset,_hx_tmp1,tilemap->tileAlphaEnabled,alpha,tilemap->tileBlendModeEnabled,tilemap->_hx___worldBlendMode,null(),null(),null(),rect, ::lime::math::Matrix3_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
...
HXLINE(  70)		 ::openfl::display::Tileset tileset;
...
HXDLIN(  80)				_g = (_g + 1);
HXLINE(  82)				{
HXLINE(  82)					Float tx = -(tile->get_originX());
HXDLIN(  82)					Float ty = -(tile->get_originY());
HXDLIN(  82)					tileTransform->a = ( (Float)(1) );
HXDLIN(  82)					tileTransform->b = ( (Float)(0) );
HXDLIN(  82)					tileTransform->c = ( (Float)(0) );
HXDLIN(  82)					tileTransform->d = ( (Float)(1) );
HXDLIN(  82)					tileTransform->tx = tx;
HXDLIN(  82)					tileTransform->ty = ty;
            				}
HXLINE(  83)				{
HXLINE(  83)					 ::openfl::geom::Matrix m = tile->get_matrix();
HXDLIN(  83)					Float a1 = ((tileTransform->a * m->a) + (tileTransform->b * m->c));
HXDLIN(  83)					tileTransform->b = ((tileTransform->a * m->b) + (tileTransform->b * m->d));
HXDLIN(  83)					tileTransform->a = a1;
HXDLIN(  83)					Float c1 = ((tileTransform->c * m->a) + (tileTransform->d * m->c));
HXDLIN(  83)					tileTransform->d = ((tileTransform->c * m->b) + (tileTransform->d * m->d));
HXDLIN(  83)					tileTransform->c = c1;
HXDLIN(  83)					Float tx1 = (((tileTransform->tx * m->a) + (tileTransform->ty * m->c)) + m->tx);
HXDLIN(  83)					tileTransform->ty = (((tileTransform->tx * m->b) + (tileTransform->ty * m->d)) + m->ty);
HXDLIN(  83)					tileTransform->tx = tx1;
            				}
HXLINE(  84)				{
HXLINE(  84)					Float a11 = ((tileTransform->a * parentTransform->a) + (tileTransform->b * parentTransform->c));
HXDLIN(  84)					tileTransform->b = ((tileTransform->a * parentTransform->b) + (tileTransform->b * parentTransform->d));
HXDLIN(  84)					tileTransform->a = a11;
HXDLIN(  84)					Float c11 = ((tileTransform->c * parentTransform->a) + (tileTransform->d * parentTransform->c));
HXDLIN(  84)					tileTransform->d = ((tileTransform->c * parentTransform->b) + (tileTransform->d * parentTransform->d));
HXDLIN(  84)					tileTransform->c = c11;
HXDLIN(  84)					Float tx11 = (((tileTransform->tx * parentTransform->a) + (tileTransform->ty * parentTransform->c)) + parentTransform->tx);
HXDLIN(  84)					tileTransform->ty = (((tileTransform->tx * parentTransform->b) + (tileTransform->ty * parentTransform->d)) + parentTransform->ty);
HXDLIN(  84)					tileTransform->tx = tx11;
            				}
...
HXLINE( 113)							_hx_tmp2 = (tileRect->width <= 0);
            						}
            						else {
HXLINE( 113)							_hx_tmp2 = true;
            						}
HXDLIN( 113)						if (!(_hx_tmp2)) {
HXLINE( 113)							_hx_tmp1 = (tileRect->height <= 0);
            						}
            						else {
...
HXLINE( 120)						{
HXLINE( 120)							rect->x = ( (Float)(tileData->x) );
HXDLIN( 120)							rect->y = ( (Float)(tileData->y) );
HXDLIN( 120)							rect->width = ( (Float)(tileData->width) );
HXDLIN( 120)							rect->height = ( (Float)(tileData->height) );
            						}
...
HXLINE( 131)						int _hx_tmp3;
HXDLIN( 131)						if (smooth) {
HXLINE( 131)							_hx_tmp3 = 1;
            						}
            						else {
HXLINE( 131)							_hx_tmp3 = 3;
            						}
HXDLIN( 131)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp3);
