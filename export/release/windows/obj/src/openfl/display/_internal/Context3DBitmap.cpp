...
HXLINE(  48)			context->drawTriangles(bitmap->_hx___bitmapData->getIndexBuffer(context,null()),null(),null());
...
HXDLIN(  76)						{
HXLINE(  76)							Float widtha = bitmap->get_width();
HXDLIN(  76)							Float heighta = bitmap->get_height();
HXDLIN(  76)							rect->x = ( (Float)(0) );
HXDLIN(  76)							rect->y = ( (Float)(0) );
HXDLIN(  76)							rect->width = widtha;
HXDLIN(  76)							rect->height = heighta;
            						}
...
HXLINE( 104)			context->drawTriangles(bitmap->_hx___bitmapData->getIndexBuffer(context,null()),null(),null());
