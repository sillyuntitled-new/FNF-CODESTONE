...
HXLINE(  38)		context->drawTriangles(bitmapData->getIndexBuffer(context,null()),null(),null());
...
HXLINE(  62)		context->drawTriangles(bitmapData->getIndexBuffer(context,null()),null(),null());
