...
HXLINE(  38)			{
HXLINE(  38)				Float widtha = displayObject->get_width();
HXDLIN(  38)				Float heighta = displayObject->get_height();
HXDLIN(  38)				rect->x = ( (Float)(0) );
HXDLIN(  38)				rect->y = ( (Float)(0) );
HXDLIN(  38)				rect->width = widtha;
HXDLIN(  38)				rect->height = heighta;
            			}
...
HXDLIN(  68)						{
HXLINE(  68)							Float widtha = displayObject->get_width();
HXDLIN(  68)							Float heighta = displayObject->get_height();
HXDLIN(  68)							rect->x = ( (Float)(0) );
HXDLIN(  68)							rect->y = ( (Float)(0) );
HXDLIN(  68)							rect->width = widtha;
HXDLIN(  68)							rect->height = heighta;
            						}
