...
HXLINE(  50)				{
HXLINE(  50)					Float sx = (( (Float)(1) ) / graphics->_hx___bitmapScale);
HXDLIN(  50)					Float sy = (( (Float)(1) ) / graphics->_hx___bitmapScale);
HXDLIN(  50)					matrix->a = (matrix->a * sx);
HXDLIN(  50)					matrix->b = (matrix->b * sy);
HXDLIN(  50)					matrix->c = (matrix->c * sx);
HXDLIN(  50)					matrix->d = (matrix->d * sy);
HXDLIN(  50)					matrix->tx = (matrix->tx * sx);
HXDLIN(  50)					matrix->ty = (matrix->ty * sy);
            				}
HXLINE(  51)				{
HXLINE(  51)					 ::openfl::geom::Matrix m = graphics->_hx___worldTransform;
HXDLIN(  51)					Float a1 = ((matrix->a * m->a) + (matrix->b * m->c));
HXDLIN(  51)					matrix->b = ((matrix->a * m->b) + (matrix->b * m->d));
HXDLIN(  51)					matrix->a = a1;
HXDLIN(  51)					Float c1 = ((matrix->c * m->a) + (matrix->d * m->c));
HXDLIN(  51)					matrix->d = ((matrix->c * m->b) + (matrix->d * m->d));
HXDLIN(  51)					matrix->c = c1;
HXDLIN(  51)					Float tx1 = (((matrix->tx * m->a) + (matrix->ty * m->c)) + m->tx);
HXDLIN(  51)					matrix->ty = (((matrix->tx * m->b) + (matrix->ty * m->d)) + m->ty);
HXDLIN(  51)					matrix->tx = tx1;
            				}
...
HXLINE(  67)				context->drawTriangles(graphics->_hx___bitmap->getIndexBuffer(context,null()),null(),null());
...
HXLINE( 105)				context->drawTriangles(graphics->_hx___bitmap->getIndexBuffer(context,null()),null(),null());
