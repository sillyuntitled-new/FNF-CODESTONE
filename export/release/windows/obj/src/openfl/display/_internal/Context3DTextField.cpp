...
HXDLIN(  40)						{
HXLINE(  40)							Float widtha = textField->get_width();
HXDLIN(  40)							Float heighta = textField->get_height();
HXDLIN(  40)							rect->x = ( (Float)(0) );
HXDLIN(  40)							rect->y = ( (Float)(0) );
HXDLIN(  40)							rect->width = widtha;
HXDLIN(  40)							rect->height = heighta;
            						}
