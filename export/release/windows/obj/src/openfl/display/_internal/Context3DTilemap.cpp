...
HXLINE(  71)			::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex = (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex + 8);
            		}
...
HXLINE( 111)		 ::openfl::display::Tileset tileset;
...
HXDLIN( 126)				_g = (_g + 1);
HXLINE( 128)				{
HXLINE( 128)					Float tx = -(tile->get_originX());
HXDLIN( 128)					Float ty = -(tile->get_originY());
HXDLIN( 128)					tileTransform->a = ( (Float)(1) );
HXDLIN( 128)					tileTransform->b = ( (Float)(0) );
HXDLIN( 128)					tileTransform->c = ( (Float)(0) );
HXDLIN( 128)					tileTransform->d = ( (Float)(1) );
HXDLIN( 128)					tileTransform->tx = tx;
HXDLIN( 128)					tileTransform->ty = ty;
            				}
HXLINE( 129)				{
HXLINE( 129)					 ::openfl::geom::Matrix m = tile->get_matrix();
HXDLIN( 129)					Float a1 = ((tileTransform->a * m->a) + (tileTransform->b * m->c));
HXDLIN( 129)					tileTransform->b = ((tileTransform->a * m->b) + (tileTransform->b * m->d));
HXDLIN( 129)					tileTransform->a = a1;
HXDLIN( 129)					Float c1 = ((tileTransform->c * m->a) + (tileTransform->d * m->c));
HXDLIN( 129)					tileTransform->d = ((tileTransform->c * m->b) + (tileTransform->d * m->d));
HXDLIN( 129)					tileTransform->c = c1;
HXDLIN( 129)					Float tx1 = (((tileTransform->tx * m->a) + (tileTransform->ty * m->c)) + m->tx);
HXDLIN( 129)					tileTransform->ty = (((tileTransform->tx * m->b) + (tileTransform->ty * m->d)) + m->ty);
HXDLIN( 129)					tileTransform->tx = tx1;
            				}
HXLINE( 130)				{
HXLINE( 130)					Float a11 = ((tileTransform->a * parentTransform->a) + (tileTransform->b * parentTransform->c));
HXDLIN( 130)					tileTransform->b = ((tileTransform->a * parentTransform->b) + (tileTransform->b * parentTransform->d));
HXDLIN( 130)					tileTransform->a = a11;
HXDLIN( 130)					Float c11 = ((tileTransform->c * parentTransform->a) + (tileTransform->d * parentTransform->c));
HXDLIN( 130)					tileTransform->d = ((tileTransform->c * parentTransform->b) + (tileTransform->d * parentTransform->d));
HXDLIN( 130)					tileTransform->c = c11;
HXDLIN( 130)					Float tx11 = (((tileTransform->tx * parentTransform->a) + (tileTransform->ty * parentTransform->c)) + parentTransform->tx);
HXDLIN( 130)					tileTransform->ty = (((tileTransform->tx * parentTransform->b) + (tileTransform->ty * parentTransform->d)) + parentTransform->ty);
HXDLIN( 130)					tileTransform->tx = tx11;
            				}
...
HXLINE( 197)							_hx_tmp3 = (tileRect->width <= 0);
            						}
            						else {
HXLINE( 197)							_hx_tmp3 = true;
            						}
HXDLIN( 197)						if (!(_hx_tmp3)) {
HXLINE( 197)							_hx_tmp2 = (tileRect->height <= 0);
            						}
            						else {
...
HXLINE( 209)						{
HXLINE( 209)							rect->x = ( (Float)(tileData->x) );
HXDLIN( 209)							rect->y = ( (Float)(tileData->y) );
HXDLIN( 209)							rect->width = ( (Float)(tileData->width) );
HXDLIN( 209)							rect->height = ( (Float)(tileData->height) );
            						}
...
HXDLIN( 256)							 ::__hxcpp_memory_set_float(this17->buffer->b,(this17->byteOffset + (((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * 0)) + 4) * 4)),alpha);
            						}
HXDLIN( 256)						{
HXLINE( 256)							 ::lime::utils::ArrayBufferView this18 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 256)							 ::__hxcpp_memory_set_float(this18->buffer->b,(this18->byteOffset + (((vertexOffset + ::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex) + 4) * 4)),alpha);
            						}
HXDLIN( 256)						{
HXLINE( 256)							 ::lime::utils::ArrayBufferView this19 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 256)							 ::__hxcpp_memory_set_float(this19->buffer->b,(this19->byteOffset + (((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * 2)) + 4) * 4)),alpha);
            						}
HXDLIN( 256)						{
HXLINE( 256)							 ::lime::utils::ArrayBufferView this20 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 256)							 ::__hxcpp_memory_set_float(this20->buffer->b,(this20->byteOffset + (((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * 3)) + 4) * 4)),alpha);
            						}
            					}
...
HXDLIN( 266)									 ::__hxcpp_memory_set_float(this21->buffer->b,(this21->byteOffset + (((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) * 4)),colorTransform->redMultiplier);
            								}
HXLINE( 267)								{
HXLINE( 267)									 ::lime::utils::ArrayBufferView this22 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 267)									 ::__hxcpp_memory_set_float(this22->buffer->b,(this22->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 1) * 4)),colorTransform->greenMultiplier);
            								}
HXLINE( 268)								{
HXLINE( 268)									 ::lime::utils::ArrayBufferView this23 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 268)									 ::__hxcpp_memory_set_float(this23->buffer->b,(this23->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 2) * 4)),colorTransform->blueMultiplier);
            								}
HXLINE( 269)								{
HXLINE( 269)									 ::lime::utils::ArrayBufferView this24 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 269)									 ::__hxcpp_memory_set_float(this24->buffer->b,(this24->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 3) * 4)),colorTransform->alphaMultiplier);
            								}
HXLINE( 271)								{
HXLINE( 271)									 ::lime::utils::ArrayBufferView this25 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 271)									 ::__hxcpp_memory_set_float(this25->buffer->b,(this25->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 4) * 4)),colorTransform->redOffset);
            								}
HXLINE( 272)								{
HXLINE( 272)									 ::lime::utils::ArrayBufferView this26 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 272)									 ::__hxcpp_memory_set_float(this26->buffer->b,(this26->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 5) * 4)),colorTransform->greenOffset);
            								}
HXLINE( 273)								{
HXLINE( 273)									 ::lime::utils::ArrayBufferView this27 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 273)									 ::__hxcpp_memory_set_float(this27->buffer->b,(this27->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 6) * 4)),colorTransform->blueOffset);
            								}
HXLINE( 274)								{
HXLINE( 274)									 ::lime::utils::ArrayBufferView this28 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 274)									 ::__hxcpp_memory_set_float(this28->buffer->b,(this28->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + ctPosition) + 7) * 4)),colorTransform->alphaOffset);
            								}
            							}
            						}
            						else {
...
HXLINE( 294)					::openfl::display::_internal::Context3DTilemap_obj::vertexDataPosition = (::openfl::display::_internal::Context3DTilemap_obj::vertexDataPosition + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * 4));
            				}
            			}
            		}
...
HXLINE( 383)				::openfl::display::_internal::Context3DTilemap_obj::lastFlushedPosition = (::openfl::display::_internal::Context3DTilemap_obj::lastFlushedPosition + length);
            			}
            			_hx_goto_7:;
...
HXLINE( 426)		{
HXLINE( 426)			rect->x = ( (Float)(0) );
HXDLIN( 426)			rect->y = ( (Float)(0) );
HXDLIN( 426)			rect->width = ( (Float)(tilemap->_hx___width) );
HXDLIN( 426)			rect->height = ( (Float)(tilemap->_hx___height) );
            		}
...
HXDLIN( 450)						{
HXLINE( 450)							Float widtha = tilemap->get_width();
HXDLIN( 450)							Float heighta = tilemap->get_height();
HXDLIN( 450)							rect->x = ( (Float)(0) );
HXDLIN( 450)							rect->y = ( (Float)(0) );
HXDLIN( 450)							rect->width = widtha;
HXDLIN( 450)							rect->height = heighta;
            						}
...
HXLINE( 478)		 ::openfl::display::Tileset tileset;
