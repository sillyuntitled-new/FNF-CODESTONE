...
HX_LOCAL_STACK_FRAME(_hx_pos_b5919670cea5e831_56_renderDrawable,"openfl.display._internal.DOMVideo","renderDrawable",0x32b7dbcd,"openfl.display._internal.DOMVideo.renderDrawable","openfl/display/_internal/DOMVideo.hx",56,0x240265a6)
...
void DOMVideo_obj::renderDrawable( ::openfl::media::Video video, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_b5919670cea5e831_56_renderDrawable)
HXDLIN(  56)		renderer->_hx___renderEvent(video);
            	}
