...
HXLINE( 129)										color2 = (color2 + (this->noise(((_scale_x + ((Float)1.0)) * frequency),((_scale_y + ((Float)1.0)) * frequency),(_scale_z * frequency)) * persistence));
            									}
HXLINE( 132)									if ((2 < channels)) {
HXLINE( 134)										color3 = (color3 + (this->noise(((_scale_x + ((Float)2.0)) * frequency),((_scale_y + ((Float)2.0)) * frequency),(_scale_z * frequency)) * persistence));
            									}
            								}
            							}
            						}
...
HXLINE( 249)		g22 = (g22 + (u * ((g1 + g11) - g22)));
HXLINE( 250)		g42 = (g42 + (u * ((g3 + g31) - g42)));
HXLINE( 251)		g62 = (g62 + (u * ((g5 + g51) - g62)));
HXLINE( 252)		g82 = (g82 + (u * ((g7 + g71) - g82)));
