...
HXDLIN( 149)			while((_g2 < boolCount)){
...
HXLINE( 156)				this->paramDataLength = (this->paramDataLength + length);
...
HXDLIN( 165)			while((_g3 < floatCount)){
HXLINE( 165)				_g3 = (_g3 + 1);
HXDLIN( 165)				int i2 = (_g3 - 1);
...
HXLINE( 172)				this->paramDataLength = (this->paramDataLength + length);
...
HXDLIN( 181)			while((_g4 < intCount)){
HXLINE( 181)				_g4 = (_g4 + 1);
HXDLIN( 181)				int i3 = (_g4 - 1);
...
HXLINE( 188)				this->paramDataLength = (this->paramDataLength + length);
...
HXLINE( 204)					{
HXLINE( 204)						 ::lime::utils::ArrayBufferView _this = data;
HXDLIN( 204)						 ::lime::utils::ArrayBufferView view = this->paramData;
...
HXLINE( 204)							_this->buffer->blit((0 * _this->bytesPerElement),view->buffer,view->byteOffset,view->byteLength);
            						}
            						else {
...
HXLINE( 216)		{
HXLINE( 216)			int _g5 = 0;
HXDLIN( 216)			int _g6 = this->paramCount;
HXDLIN( 216)			while((_g5 < _g6)){
HXLINE( 216)				_g5 = (_g5 + 1);
HXDLIN( 216)				int i4 = (_g5 - 1);
...
HXLINE( 225)					{
HXLINE( 225)						int _g7 = 0;
HXDLIN( 225)						while((_g7 < length1)){
HXLINE( 225)							_g7 = (_g7 + 1);
HXLINE( 227)							{
HXLINE( 227)								 ::lime::utils::ArrayBufferView this3 = this->paramData;
HXDLIN( 227)								Float val;
HXDLIN( 227)								if (boolParam->value->__get((_g7 - 1))) {
...
HXLINE( 236)						{
HXLINE( 236)							int _g8 = 0;
HXDLIN( 236)							while((_g8 < length1)){
HXLINE( 236)								_g8 = (_g8 + 1);
HXLINE( 238)								{
HXLINE( 238)									 ::lime::utils::ArrayBufferView this4 = this->paramData;
HXDLIN( 238)									 ::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + (paramPosition * 4)),floatParam->value->__get((_g8 - 1)));
            								}
...
HXLINE( 247)						{
HXLINE( 247)							int _g9 = 0;
HXDLIN( 247)							while((_g9 < length1)){
HXLINE( 247)								_g9 = (_g9 + 1);
HXLINE( 249)								{
HXLINE( 249)									 ::lime::utils::ArrayBufferView this5 = this->paramData;
HXDLIN( 249)									 ::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + (paramPosition * 4)),( (Float)(intParam->value->__get((_g9 - 1))) ));
            								}
