...
HX_LOCAL_STACK_FRAME(_hx_pos_0f6a02916d47e310_56_dispose,"openfl.display3D.IndexBuffer3D","dispose",0xbcffb1db,"openfl.display3D.IndexBuffer3D.dispose","openfl/display3D/IndexBuffer3D.hx",56,0x3d934296)
...
void IndexBuffer3D_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_0f6a02916d47e310_56_dispose)
HXDLIN(  56)		this->_hx___context->gl->deleteBuffer(this->_hx___id);
            	}
...
HXDLIN(  83)		 ::Dynamic byteoffset = (byteArrayOffset + (startOffset * 2));
...
HXDLIN(  83)				if (((in_byteOffset + newByteLength) > bufferByteLength)) {
HXLINE(  83)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
