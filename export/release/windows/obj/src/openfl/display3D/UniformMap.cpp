...
HXLINE(1063)						this->_hx___registerLookup->set((uniform1->regIndex + (_g4 - 1)),uniform1).StaticCast<  ::openfl::display3D::Uniform >();
            					}
            				}
            			}
            		}
...
HXLINE(1102)		if ((end > this->_hx___registerLookup->_hx___array->get_length())) {
HXLINE(1104)			end = this->_hx___registerLookup->_hx___array->get_length();
            		}
