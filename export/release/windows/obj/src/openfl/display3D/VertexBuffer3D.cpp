...
HX_LOCAL_STACK_FRAME(_hx_pos_8e0849c8e2179fab_84_dispose,"openfl.display3D.VertexBuffer3D","dispose",0x6b6860bf,"openfl.display3D.VertexBuffer3D.dispose","openfl/display3D/VertexBuffer3D.hx",84,0xb1ad396e)
...
void VertexBuffer3D_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_8e0849c8e2179fab_84_dispose)
HXDLIN(  84)		this->_hx___context->gl->deleteBuffer(this->_hx___id);
            	}
...
HXDLIN( 113)		 ::Dynamic byteoffset = (byteArrayOffset + (startVertex * this->_hx___stride));
...
HXDLIN( 113)				if (((in_byteOffset + newByteLength) > bufferByteLength)) {
HXLINE( 113)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
...
HXLINE( 172)					_this->buffer->blit((0 * _this->bytesPerElement),existingFloat32Array->buffer,existingFloat32Array->byteOffset,existingFloat32Array->byteLength);
            				}
            				else {
