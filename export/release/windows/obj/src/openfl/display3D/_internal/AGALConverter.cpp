...
HXLINE(  50)		return _hx_int64_make(byteArray->readInt(),low);
            	}
...
HXLINE( 140)					map->addSR(sr2,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn(),null());
            				...
            				break;
            				case (int)5: {
HXLINE( 146)					if ((sr1->toGLSL(null(),null()).indexOf(HX_(".",2e,00,00,00),null()) > -1)) {
...
HXLINE( 480)				_hx_tmp4 = (version.indexOf(HX_("WebGL",99,9f,e9,5a),null()) > -1);
            			}
            			else {
