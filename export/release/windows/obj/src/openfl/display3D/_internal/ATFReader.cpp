...
HXLINE( 137)									uploadCallback(side,level,(_g4 - 1),(this->width >> level),(this->height >> level),blockLength,bytes);
            								}
            							}
            						}
            					}
