...
HXLINE( 941)		return  ::openfl::display::_internal::SamplerState_obj::__alloc( HX_CTX ,wrap,filter,mipfilter,(( (Float)(((this->b << 24) >> 24)) ) / ((Float)8.0)),((this->s & 4) == 4),((this->s & 1) == 1),(this->t == 2));
            	}
