...
HXLINE( 996)				switch((int)((this->s & 3))){
            					case (int)0: {
HXLINE( 999)						swizzle = HX_("x",78,00,00,00);
            					}
            					break;
            					case (int)1: {
HXLINE(1001)						swizzle = HX_("y",79,00,00,00);
            					}
            					break;
            					case (int)2: {
HXLINE(1003)						swizzle = HX_("z",7a,00,00,00);
            					}
            					break;
            					case (int)3: {
HXLINE(1005)						swizzle = HX_("w",77,00,00,00);
            					}
            					break;
            				}
            			}
...
HXLINE(1035)			str = (str + ((((HX_("[ int(",3e,aa,07,15) + (((indexRegister + this->n) + HX_(".",2e,00,00,00)) + indexComponent)) + HX_(") +",74,38,1f,00)) + offset) + HX_("]",5d,00,00,00)));
            		}
