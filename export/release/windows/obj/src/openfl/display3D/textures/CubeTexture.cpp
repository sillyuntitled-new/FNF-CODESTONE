...
HXLINE( 149)		if (((this->_hx___size >> miplevel) == 0)) {
HXLINE( 149)			return;
            		}
...
HXLINE( 253)		this->_hx___uploadedSides = (this->_hx___uploadedSides | (1 << side));
            	}
...
HXDLIN( 368)					if ((::hx::Mod(0,_this->bytesPerElement) != 0)) {
...
HXLINE( 368)						newByteLength = bufferByteLength;
...
HXDLIN( 368)						if ((newByteLength > bufferByteLength)) {
HXLINE( 368)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
...
HXLINE( 376)				 ::Dynamic byteoffset = size;
HXDLIN( 376)				if (::hx::IsNull( byteoffset )) {
HXLINE( 376)					byteoffset = 0;
            				}
...
HXDLIN( 376)						if (((in_byteOffset + newByteLength1) > bufferByteLength1)) {
HXLINE( 376)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
HXDLIN( 376)					_this1->buffer = bytes;
HXDLIN( 376)					_this1->byteOffset = in_byteOffset;
...
HXDLIN( 383)					if ((::hx::Mod(0,_this2->bytesPerElement) != 0)) {
...
HXLINE( 383)						newByteLength2 = bufferByteLength2;
...
HXDLIN( 383)						if ((newByteLength2 > bufferByteLength2)) {
HXLINE( 383)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
HXDLIN( 383)					_this2->buffer = bytes;
HXDLIN( 383)					_this2->byteOffset = 0;
...
HXDLIN( 392)					{
HXLINE( 392)						::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),this1,null(),0);
...
HXDLIN( 392)					{
HXLINE( 392)						::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),this2,null(),0);
...
HXDLIN( 392)					{
HXLINE( 392)						::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),this3,null(),0);
...
HXDLIN( 392)					{
HXLINE( 392)						::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),this4,null(),0);
...
HXDLIN( 392)					{
HXLINE( 392)						::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),this5,null(),0);
...
HXDLIN( 392)					{
HXLINE( 392)						::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),this6,null(),0);
