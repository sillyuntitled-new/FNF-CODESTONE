...
HXLINE( 326)				 ::lime::utils::ArrayBufferView this1;
HXDLIN( 326)				if (::hx::IsNotNull( bytes )) {
HXLINE( 326)					 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 326)					if ((::hx::Mod(0,_this->bytesPerElement) != 0)) {
...
HXLINE( 326)						newByteLength = bufferByteLength;
...
HXDLIN( 326)						if ((newByteLength > bufferByteLength)) {
HXLINE( 326)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
...
HXLINE( 335)				 ::Dynamic byteoffset = size;
HXDLIN( 335)				if (::hx::IsNull( byteoffset )) {
HXLINE( 335)					byteoffset = 0;
            				}
HXDLIN( 335)				 ::lime::utils::ArrayBufferView this2;
HXDLIN( 335)				if (::hx::IsNotNull( bytes )) {
HXLINE( 335)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 335)					int in_byteOffset = ( (int)(byteoffset) );
HXDLIN( 335)					if ((in_byteOffset < 0)) {
HXLINE( 335)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 335)					if ((::hx::Mod(in_byteOffset,_this1->bytesPerElement) != 0)) {
HXLINE( 335)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 335)					int bufferByteLength1 = bytes->length;
HXDLIN( 335)					int newByteLength1 = bufferByteLength1;
HXDLIN( 335)					if (::hx::IsNull( size )) {
HXLINE( 335)						newByteLength1 = (bufferByteLength1 - in_byteOffset);
HXDLIN( 335)						if ((::hx::Mod(bufferByteLength1,_this1->bytesPerElement) != 0)) {
HXLINE( 335)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
...
HXLINE( 335)						newByteLength1 = (size * _this1->bytesPerElement);
HXDLIN( 335)						if (((in_byteOffset + newByteLength1) > bufferByteLength1)) {
HXLINE( 335)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
HXDLIN( 335)					_this1->buffer = bytes;
HXDLIN( 335)					_this1->byteOffset = in_byteOffset;
HXDLIN( 335)					_this1->byteLength = newByteLength1;
HXDLIN( 335)					_this1->length = ::Std_obj::_hx_int((( (Float)(newByteLength1) ) / ( (Float)(_this1->bytesPerElement) )));
HXDLIN( 335)					this2 = _this1;
            				}
            				else {
...
HXLINE( 342)				 ::lime::utils::ArrayBufferView this3;
HXDLIN( 342)				if (::hx::IsNotNull( bytes )) {
HXLINE( 342)					 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 342)					if ((::hx::Mod(0,_this2->bytesPerElement) != 0)) {
...
HXLINE( 342)						newByteLength2 = bufferByteLength2;
HXDLIN( 342)						if ((::hx::Mod(bufferByteLength2,_this2->bytesPerElement) != 0)) {
HXLINE( 342)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
...
HXLINE( 342)						newByteLength2 = (blockLength * _this2->bytesPerElement);
HXDLIN( 342)						if ((newByteLength2 > bufferByteLength2)) {
HXLINE( 342)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
HXDLIN( 342)					_this2->buffer = bytes;
HXDLIN( 342)					_this2->byteOffset = 0;
HXDLIN( 342)					_this2->byteLength = newByteLength2;
HXDLIN( 342)					_this2->length = ::Std_obj::_hx_int((( (Float)(newByteLength2) ) / ( (Float)(_this2->bytesPerElement) )));
HXDLIN( 342)					this3 = _this2;
            				}
            				else {
...
HXDLIN( 349)				{
HXLINE( 349)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),this1,null(),0);
