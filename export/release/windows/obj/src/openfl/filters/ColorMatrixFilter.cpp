...
HXLINE( 193)							destPixel = (((((::Std_obj::_hx_int(::Math_obj::max(( (Float)(0) ),::Math_obj::min((((((this->_hx___matrix->__get(0) * ( (Float)((::hx::UShr(sourcePixel,24) & 255)) )) + (this->_hx___matrix->__get(1) * ( (Float)((::hx::UShr(sourcePixel,16) & 255)) ))) + (this->_hx___matrix->__get(2) * ( (Float)((::hx::UShr(sourcePixel,8) & 255)) ))) + (this->_hx___matrix->__get(3) * ( (Float)((sourcePixel & 255)) ))) + this->_hx___matrix->__get(4)),( (Float)(255) )))) & 255) << 24) | (((::hx::UShr(destPixel,16) & 255) & 255) << 16)) | (((::hx::UShr(destPixel,8) & 255) & 255) << 8)) | ((destPixel & 255) & 255));
HXLINE( 197)							destPixel = ((((((::hx::UShr(destPixel,24) & 255) & 255) << 24) | ((::Std_obj::_hx_int(::Math_obj::max(( (Float)(0) ),::Math_obj::min((((((this->_hx___matrix->__get(5) * ( (Float)((::hx::UShr(sourcePixel,24) & 255)) )) + (this->_hx___matrix->__get(6) * ( (Float)((::hx::UShr(sourcePixel,16) & 255)) ))) + (this->_hx___matrix->__get(7) * ( (Float)((::hx::UShr(sourcePixel,8) & 255)) ))) + (this->_hx___matrix->__get(8) * ( (Float)((sourcePixel & 255)) ))) + this->_hx___matrix->__get(9)),( (Float)(255) )))) & 255) << 16)) | (((::hx::UShr(destPixel,8) & 255) & 255) << 8)) | ((destPixel & 255) & 255));
HXLINE( 201)							destPixel = ((((((::hx::UShr(destPixel,24) & 255) & 255) << 24) | (((::hx::UShr(destPixel,16) & 255) & 255) << 16)) | ((::Std_obj::_hx_int(::Math_obj::max(( (Float)(0) ),::Math_obj::min((((((this->_hx___matrix->__get(10) * ( (Float)((::hx::UShr(sourcePixel,24) & 255)) )) + (this->_hx___matrix->__get(11) * ( (Float)((::hx::UShr(sourcePixel,16) & 255)) ))) + (this->_hx___matrix->__get(12) * ( (Float)((::hx::UShr(sourcePixel,8) & 255)) ))) + (this->_hx___matrix->__get(13) * ( (Float)((sourcePixel & 255)) ))) + this->_hx___matrix->__get(14)),( (Float)(255) )))) & 255) << 8)) | ((destPixel & 255) & 255));
HXLINE( 205)							destPixel = ((((((::hx::UShr(destPixel,24) & 255) & 255) << 24) | (((::hx::UShr(destPixel,16) & 255) & 255) << 16)) | (((::hx::UShr(destPixel,8) & 255) & 255) << 8)) | (::Std_obj::_hx_int(::Math_obj::max(( (Float)(0) ),::Math_obj::min((((((this->_hx___matrix->__get(15) * ( (Float)((::hx::UShr(sourcePixel,24) & 255)) )) + (this->_hx___matrix->__get(16) * ( (Float)((::hx::UShr(sourcePixel,16) & 255)) ))) + (this->_hx___matrix->__get(17) * ( (Float)((::hx::UShr(sourcePixel,8) & 255)) ))) + (this->_hx___matrix->__get(18) * ( (Float)((sourcePixel & 255)) ))) + this->_hx___matrix->__get(19)),( (Float)(255) )))) & 255));
            						}
HXLINE( 211)						{
...
HXDLIN( 211)							switch((int)(destFormat)){
            								case (int)0: {
HXLINE( 211)									 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),(::hx::UShr(destPixel,24) & 255));
HXDLIN( 211)									 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 1)),(::hx::UShr(destPixel,16) & 255));
HXDLIN( 211)									 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),(::hx::UShr(destPixel,8) & 255));
HXDLIN( 211)									 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),(destPixel & 255));
            								}
            								break;
            								case (int)1: {
HXLINE( 211)									 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),(destPixel & 255));
HXDLIN( 211)									 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 1)),(::hx::UShr(destPixel,24) & 255));
HXDLIN( 211)									 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),(::hx::UShr(destPixel,16) & 255));
HXDLIN( 211)									 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),(::hx::UShr(destPixel,8) & 255));
            								}
            								break;
            								case (int)2: {
HXLINE( 211)									 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),(::hx::UShr(destPixel,8) & 255));
HXDLIN( 211)									 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 1)),(::hx::UShr(destPixel,16) & 255));
HXDLIN( 211)									 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 2)),(::hx::UShr(destPixel,24) & 255));
HXDLIN( 211)									 ::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + (destOffset + 3)),(destPixel & 255));
            								}
            								break;
            							}
