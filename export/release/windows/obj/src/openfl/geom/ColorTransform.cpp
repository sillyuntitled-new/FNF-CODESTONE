...
HXLINE( 193)		this->redMultiplier = (this->redMultiplier * second->redMultiplier);
HXLINE( 194)		this->greenMultiplier = (this->greenMultiplier * second->greenMultiplier);
HXLINE( 195)		this->blueMultiplier = (this->blueMultiplier * second->blueMultiplier);
HXLINE( 196)		this->alphaMultiplier = (this->alphaMultiplier * second->alphaMultiplier);
            	}
...
HXLINE( 232)		this->redMultiplier = (this->redMultiplier * ct->redMultiplier);
HXLINE( 233)		this->greenMultiplier = (this->greenMultiplier * ct->greenMultiplier);
HXLINE( 234)		this->blueMultiplier = (this->blueMultiplier * ct->blueMultiplier);
HXLINE( 235)		this->alphaMultiplier = (this->alphaMultiplier * ct->alphaMultiplier);
HXLINE( 237)		this->redOffset = (this->redOffset + ct->redOffset);
HXLINE( 238)		this->greenOffset = (this->greenOffset + ct->greenOffset);
HXLINE( 239)		this->blueOffset = (this->blueOffset + ct->blueOffset);
HXLINE( 240)		this->alphaOffset = (this->alphaOffset + ct->alphaOffset);
            	}
...
HXLINE( 335)			::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,20,8);
            		}
HXLINE( 338)		{
HXLINE( 338)			 ::lime::utils::ArrayBufferView this1 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 338)			 ::__hxcpp_memory_set_float(this1->buffer->b,this1->byteOffset,this->redMultiplier);
            		}
HXLINE( 339)		{
HXLINE( 339)			 ::lime::utils::ArrayBufferView this2 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 339)			 ::__hxcpp_memory_set_float(this2->buffer->b,(this2->byteOffset + 16),(this->redOffset / ( (Float)(255) )));
            		}
HXLINE( 340)		{
HXLINE( 340)			 ::lime::utils::ArrayBufferView this3 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 340)			 ::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + 24),this->greenMultiplier);
            		}
HXLINE( 341)		{
HXLINE( 341)			 ::lime::utils::ArrayBufferView this4 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 341)			 ::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + 36),(this->greenOffset / ( (Float)(255) )));
            		}
HXLINE( 342)		{
HXLINE( 342)			 ::lime::utils::ArrayBufferView this5 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 342)			 ::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + 48),this->blueMultiplier);
            		}
HXLINE( 343)		{
HXLINE( 343)			 ::lime::utils::ArrayBufferView this6 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 343)			 ::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + 56),(this->blueOffset / ( (Float)(255) )));
            		}
HXLINE( 344)		{
HXLINE( 344)			 ::lime::utils::ArrayBufferView this7 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 344)			 ::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + 72),this->alphaMultiplier);
            		}
HXLINE( 345)		{
HXLINE( 345)			 ::lime::utils::ArrayBufferView this8 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 345)			 ::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + 76),(this->alphaOffset / ( (Float)(255) )));
            		}
