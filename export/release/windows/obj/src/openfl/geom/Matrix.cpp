...
HXLINE( 446)			this->a = (this->a * cos);
HXLINE( 447)			this->d = (this->d * cos);
            		}
            		else {
...
HXLINE( 524)			this->b = (this->b * -(norm));
HXLINE( 525)			this->c = (this->c * -(norm));
...
HXLINE( 603)		this->a = (this->a * sx);
HXLINE( 604)		this->b = (this->b * sy);
HXLINE( 605)		this->c = (this->c * sx);
HXLINE( 606)		this->d = (this->d * sy);
HXLINE( 607)		this->tx = (this->tx * sx);
HXLINE( 608)		this->ty = (this->ty * sy);
            	}
...
HXLINE( 697)		this->tx = (this->tx + dx);
HXLINE( 698)		this->ty = (this->ty + dy);
            	}
...
HXLINE( 704)		 ::lime::utils::ArrayBufferView _hx___array =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,9,8);
HXLINE( 710)		if (transpose) {
HXLINE( 712)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,_hx___array->byteOffset,this->a);
HXLINE( 713)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 4),this->b);
HXLINE( 714)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 8),0);
HXLINE( 715)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 12),this->c);
HXLINE( 716)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 16),this->d);
HXLINE( 717)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 20),0);
HXLINE( 718)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 24),this->tx);
HXLINE( 719)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 28),this->ty);
HXLINE( 720)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 32),1);
            		}
            		else {
HXLINE( 724)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,_hx___array->byteOffset,this->a);
HXLINE( 725)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 4),this->c);
HXLINE( 726)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 8),this->tx);
HXLINE( 727)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 12),this->b);
HXLINE( 728)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 16),this->d);
HXLINE( 729)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 20),this->ty);
HXLINE( 730)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 24),0);
HXLINE( 731)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 28),0);
HXLINE( 732)			 ::__hxcpp_memory_set_float(_hx___array->buffer->b,(_hx___array->byteOffset + 32),1);
            		}
HXLINE( 735)		return _hx___array;
            	}
...
HXDLIN(  77)			m->a = ( (Float)(1) );
HXDLIN(  77)			m->b = ( (Float)(0) );
HXDLIN(  77)			m->c = ( (Float)(0) );
HXDLIN(  77)			m->d = ( (Float)(1) );
HXDLIN(  77)			m->tx = ( (Float)(0) );
HXDLIN(  77)			m->ty = ( (Float)(0) );
            		}
