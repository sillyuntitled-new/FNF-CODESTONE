...
HXLINE( 352)		this->x = (this->x - dx);
HXLINE( 353)		this->width = (this->width + (dx * ( (Float)(2) )));
HXLINE( 354)		this->y = (this->y - dy);
HXLINE( 355)		this->height = (this->height + (dy * ( (Float)(2) )));
            	}
...
HXLINE( 469)		this->x = (this->x + dx);
HXLINE( 470)		this->y = (this->y + dy);
            	}
...
HXLINE( 482)		this->x = (this->x + point->x);
HXLINE( 483)		this->y = (this->y + point->y);
            	}
...
HXLINE( 570)		this->x = (this->x + offsetX);
HXLINE( 571)		this->y = (this->y + offsetY);
HXLINE( 572)		this->width = (this->width + (offsetRight - offsetX));
HXLINE( 573)		this->height = (this->height + (offsetBottom - offsetY));
            	}
...
HXLINE( 648)		{
HXLINE( 648)			rect->x = (tx0 + m->tx);
HXDLIN( 648)			rect->y = (ty0 + m->ty);
HXDLIN( 648)			rect->width = (tx1 - tx0);
HXDLIN( 648)			rect->height = (ty1 - ty0);
            		}
            	}
...
HXLINE( 682)		this->width = (this->width - (l - this->x));
HXLINE( 683)		this->x = l;
HXLINE( 684)		return l;
            	}
...
HXLINE( 717)		this->height = (this->height - (t - this->y));
HXLINE( 718)		this->y = t;
HXLINE( 719)		return t;
            	}
...
HXLINE(  63)			r->x = ( (Float)(0) );
HXDLIN(  63)			r->y = ( (Float)(0) );
HXDLIN(  63)			r->width = ( (Float)(0) );
HXDLIN(  63)			r->height = ( (Float)(0) );
            		}
