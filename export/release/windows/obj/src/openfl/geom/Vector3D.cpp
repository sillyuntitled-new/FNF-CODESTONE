...
HXLINE( 270)		this->x = (this->x - a->x);
HXLINE( 271)		this->y = (this->y - a->y);
HXLINE( 272)		this->z = (this->z - a->z);
            	}
...
HXLINE( 346)		this->x = (this->x + a->x);
HXLINE( 347)		this->y = (this->y + a->y);
HXLINE( 348)		this->z = (this->z + a->z);
            	}
...
HXLINE( 386)		this->x = (this->x * ( (Float)(-1) ));
HXLINE( 387)		this->y = (this->y * ( (Float)(-1) ));
HXLINE( 388)		this->z = (this->z * ( (Float)(-1) ));
            	}
...
HXLINE( 402)		if ((l != 0)) {
HXLINE( 404)			this->x = (this->x / l);
HXLINE( 405)			this->y = (this->y / l);
HXLINE( 406)			this->z = (this->z / l);
            		}
HXLINE( 409)		return l;
            	}
...
HXLINE( 424)		this->x = (this->x / this->w);
HXLINE( 425)		this->y = (this->y / this->w);
HXLINE( 426)		this->z = (this->z / this->w);
            	}
...
HXLINE( 440)		this->x = (this->x * s);
HXLINE( 441)		this->y = (this->y * s);
HXLINE( 442)		this->z = (this->z * s);
            	}
