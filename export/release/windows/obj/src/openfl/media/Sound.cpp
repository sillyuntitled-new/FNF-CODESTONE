...
HX_LOCAL_STACK_FRAME(_hx_pos_5a9f676c476e7e7b_691_AudioBuffer_onURLLoad,"openfl.media.Sound","AudioBuffer_onURLLoad",0x80e63186,"openfl.media.Sound.AudioBuffer_onURLLoad","openfl/media/Sound.hx",691,0x46a01619)
...
HXDLIN( 481)			if ((aNeg1 != (bytesLength < 0))) {
...
HXDLIN( 580)			if ((aNeg1 != (bytesLength < 0))) {
...
HXDLIN( 591)			if ((::hx::Mod(0,_this->bytesPerElement) != 0)) {
...
HXDLIN( 591)			{
HXLINE( 591)				newByteLength = bufferByteLength;
...
HXLINE( 645)		source->offset = ( (Float)(::Std_obj::_hx_int(startTime)) );
HXLINE( 646)		if ((loops > 1)) {
HXLINE( 646)			source->_hx___backend->setLoops((loops - 1));
            		}
HXLINE( 648)		source->_hx___backend->setGain(volume);
HXLINE( 650)		 ::lime::math::Vector4 position = source->_hx___backend->getPosition();
HXLINE( 651)		position->x = pan;
HXLINE( 652)		position->z = (( (Float)(-1) ) * ::Math_obj::sqrt((( (Float)(1) ) - ::Math_obj::pow(pan,( (Float)(2) )))));
HXLINE( 653)		source->_hx___backend->setPosition(position);
...
HXLINE( 675)				return ((((( (Float)(this->_hx___buffer->data->length) ) / ( (Float)(this->_hx___buffer->channels) )) / ( (Float)((this->_hx___buffer->bitsPerSample >> 3)) )) / ( (Float)(this->_hx___buffer->sampleRate) )) * ( (Float)(1000) ));
            			}
            			else {
HXLINE( 676)				if (::hx::IsNotNull( this->_hx___buffer->_hx___srcVorbisFile )) {
HXLINE( 677)					::cpp::Int64 x = this->_hx___buffer->_hx___srcVorbisFile->pcmTotal(null());
HXLINE( 678)					Float lhs = (( (Float)(_hx_int64_high(x)) ) * ((Float)4294967296.));
HXDLIN( 678)					Float _hx_tmp = (_hx_int64_low(x) + lhs);
HXDLIN( 678)					return ((_hx_tmp / ( (Float)(this->_hx___buffer->sampleRate) )) * ( (Float)(1000) ));
            				}
            			}
            		}
HXLINE( 684)		return ( (Float)(0) );
            	}
...
void Sound_obj::AudioBuffer_onURLLoad( ::lime::media::AudioBuffer buffer){
            	HX_GC_STACKFRAME(&_hx_pos_5a9f676c476e7e7b_691_AudioBuffer_onURLLoad)
HXDLIN( 691)		if (::hx::IsNull( buffer )) {
HXLINE( 693)			this->dispatchEvent( ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),null(),null(),null(),null()));
            		}
            		else {
HXLINE( 697)			this->_hx___buffer = buffer;
HXLINE( 698)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()));
            		}
            	}
