...
HXLINE( 290)		{
HXLINE( 290)			bounds->x = ( (Float)(0) );
HXDLIN( 290)			bounds->y = ( (Float)(0) );
HXDLIN( 290)			bounds->width = this->_hx___width;
HXDLIN( 290)			bounds->height = this->_hx___height;
            		}
...
HXLINE( 307)			this->_hx___indexBufferData =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,6,6);
HXLINE( 308)			{
...
HXLINE( 385)			this->_hx___vertexBufferData =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,20,8);
HXLINE( 387)			{
...
HXDLIN( 389)				 ::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + 12),1);
            			}
HXLINE( 390)			{
HXLINE( 390)				 ::lime::utils::ArrayBufferView this4 = this->_hx___vertexBufferData;
HXDLIN( 390)				 ::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + 16),1);
            			}
HXLINE( 391)			{
...
HXDLIN( 392)				 ::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + 36),1);
            			}
HXLINE( 393)			{
...
HXDLIN( 394)				 ::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + 52),1);
            			}
