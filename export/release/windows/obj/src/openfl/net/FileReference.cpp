...
HXLINE(1351)			_gthis->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()));
            		}
...
HXLINE(1391)			::sys::io::File_obj::saveBytes(this->_hx___path,::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(this->_hx___data));
