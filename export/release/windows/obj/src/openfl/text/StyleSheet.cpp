...
HXLINE( 115)		 ::haxe::ds::StringMap ast =  ::openfl::text::_internal::CSSParser_obj::__alloc( HX_CTX ,_g)->parse(CSSText);
...
HXLINE( 227)			this->_hx___applyStyleObject(this->_hx___styles->get(styleName),textFormat);
            		}
            	}
