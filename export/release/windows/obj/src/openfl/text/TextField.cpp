...
HX_LOCAL_STACK_FRAME(_hx_pos_d001dbc361c2c159_2232___stopTextInput,"openfl.text.TextField","__stopTextInput",0x6c7c2cf7,"openfl.text.TextField.__stopTextInput","openfl/text/TextField.hx",2232,0xccf02094)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d001dbc361c2c159_2513_set_antiAliasType,"openfl.text.TextField","set_antiAliasType",0x7a7f3727,"openfl.text.TextField.set_antiAliasType","openfl/text/TextField.hx",2513,0xccf02094)
...
HXLINE( 845)		this->_hx___textEngine->textFormatRanges->push( ::openfl::text::_internal::TextFormatRange_obj::__alloc( HX_CTX ,this->_hx___textFormat,0,0));
...
HXLINE( 875)		this->_hx___textEngine->textFormatRanges->get((this->_hx___textEngine->textFormatRanges->_hx___array->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->end = this->_hx___text.length;
...
HXLINE( 925)				_g = (_g + 1);
HXLINE( 927)				y = (y + this->_hx___textEngine->lineHeights->get((_g - 1)));
            			}
            		}
HXLINE( 930)		{
...
HXLINE( 970)		if ((this->_hx___textEngine->lineBreaks->_hx___array->length == 0)) {
HXLINE( 970)			return 0;
            		}
HXLINE( 972)		{
HXLINE( 972)			int _g = 0;
HXDLIN( 972)			int _g1 = this->_hx___textEngine->lineBreaks->_hx___array->length;
...
HXLINE( 980)		return (this->_hx___textEngine->lineBreaks->get((this->_hx___textEngine->lineBreaks->_hx___array->length - 1)) + 1);
            	}
...
HXLINE(1022)				_g = (_g + 1);
HXLINE(1024)				y = (y + this->_hx___textEngine->lineHeights->get((_g - 1)));
            			}
            		}
HXLINE(1027)		{
...
HXLINE(1487)			while((index < this->_hx___textEngine->textFormatRanges->_hx___array->get_length())){
...
HXLINE(1767)			this->stage->window->setTextInputRect( ::lime::math::Rectangle_obj::__alloc( HX_CTX ,bounds->x,bounds->y,bounds->width,bounds->height));
...
HXLINE(1807)		{
HXLINE(1807)			 ::openfl::geom::Rectangle sourceRect = this->_hx___textEngine->bounds;
HXDLIN(1807)			bounds->x = sourceRect->x;
HXDLIN(1807)			bounds->y = sourceRect->y;
HXDLIN(1807)			bounds->width = sourceRect->width;
HXDLIN(1807)			bounds->height = sourceRect->height;
            		}
HXLINE(1808)		{
HXLINE(1808)			bounds->x = (bounds->x + this->_hx___offsetX);
HXDLIN(1808)			bounds->y = (bounds->y + this->_hx___offsetY);
            		}
...
HXLINE(1838)						{
HXLINE(1838)							rect->x = x;
HXDLIN(1838)							rect->y = group1->offsetY;
HXDLIN(1838)							rect->width = lastPosition;
HXDLIN(1838)							rect->height = (group1->ascent + group1->descent);
            						}
...
HXLINE(1875)							y = (y - this->_hx___textEngine->lineHeights->get((_g2 - 1)));
            						}
            					}
...
HXLINE(1907)				_g = (_g + 1);
HXLINE(1909)				y = (y + this->_hx___textEngine->lineHeights->get((_g - 1)));
            			}
            		}
...
HXDLIN(1917)			int _g3 = this->_hx___textEngine->layoutGroups->_hx___array->get_length();
...
HXLINE(1921)				if ((i < (this->_hx___textEngine->layoutGroups->_hx___array->get_length() - 1))) {
...
HXLINE(2056)				int maxLength = ((this->_hx___textEngine->maxChars - this->_hx___text.length) + (endIndex - beginIndex));
...
HXLINE(2076)		while((i < this->_hx___textEngine->textFormatRanges->_hx___array->get_length())){
...
HXLINE(2091)						range->end = (range->end + offset);
            					}
            				}
            				else {
HXLINE(2094)					if ((range->end >= beginIndex)) {
HXLINE(2098)						if ((range->start >= beginIndex)) {
HXLINE(2101)							range->start = (range->start + offset);
HXLINE(2102)							range->end = (range->end + offset);
            						}
            						else {
...
HXLINE(2120)						range->start = (range->start + offset);
HXLINE(2121)						range->end = (range->end + offset);
            					}
            					else {
...
HXLINE(2126)							range->end = (range->end + offset);
            						}
            						else {
...
HXDLIN(2131)								i = (i - 1);
HXDLIN(2131)								::cpp::VirtualArray items = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(2131)								this1->__SetField(HX_("__tempIndex",3e,e8,54,22),(i + 1),::hx::paccDynamic);
HXDLIN(2131)								{
HXLINE(2131)									int _g_current = 0;
HXDLIN(2131)									while((_g_current < items->get_length())){
HXLINE(2131)										_g_current = (_g_current + 1);
HXDLIN(2131)										( ( ::openfl::_Vector::ObjectVector)(this1) )->insertAt(( (int)(this1->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),( ( ::openfl::text::_internal::TextFormatRange)(items->__get((_g_current - 1))) ));
...
HXLINE(2138)									range->end = (range->end + offset);
            								}
            								else {
...
HXLINE(2151)		if ((this->_hx___textEngine->textFormatRanges->_hx___array->get_length() == 0)) {
...
HXLINE(2161)					 ::openfl::text::_internal::TextFormatRange _hx_tmp13 = this->_hx___textEngine->textFormatRanges->get((this->_hx___textEngine->textFormatRanges->_hx___array->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
...
HXLINE(2164)					::Dynamic this4 = this->_hx___textEngine->textFormatRanges;
HXDLIN(2164)					 ::openfl::text::TextFormat value2 = this->get_defaultTextFormat()->clone();
HXLINE(2165)					 ::openfl::text::_internal::TextFormatRange value3 = this->_hx___textEngine->textFormatRanges->get((this->_hx___textEngine->textFormatRanges->_hx___array->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXLINE(2164)					( ( ::openfl::_Vector::ObjectVector)(this4) )->push( ::openfl::text::_internal::TextFormatRange_obj::__alloc( HX_CTX ,value2,value3->end,this->_hx___text.length));
            				}
            			}
            		}
...
void TextField_obj::_hx___stopTextInput(){
            	HX_STACKFRAME(&_hx_pos_d001dbc361c2c159_2232___stopTextInput)
HXDLIN(2232)		this->_hx___disableInput();
            	}
...
HXLINE(2301)				caret->x = (caret->x + caret->width);
            			}
...
HXLINE(2308)				Float caret1 = caret->x;
HXDLIN(2308)				if (!((caret1 > ((tempScrollH + this->get_width()) - ( (Float)(4) ))))) {
...
HXLINE(2368)				if ((i >= this->_hx___textEngine->lineHeights->_hx___array->length)) {
HXLINE(2370)					i = (this->_hx___textEngine->lineHeights->_hx___array->length - 1);
            				}
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,get_antiAliasType,return )
 ...
 ::Dynamic TextField_obj::set_antiAliasType( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_d001dbc361c2c159_2513_set_antiAliasType)
HXDLIN(2513)		return (this->_hx___textEngine->antiAliasType = value);
            	}
...
HXLINE(3002)		if ((this->_hx___textEngine->textFormatRanges->_hx___array->get_length() > 1)) {
HXLINE(3004)			::Dynamic this1 = this->_hx___textEngine->textFormatRanges;
HXDLIN(3004)			int deleteCount = (this->_hx___textEngine->textFormatRanges->_hx___array->get_length() - 1);
HXDLIN(3004)			::cpp::VirtualArray items = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(3004)			this1->__SetField(HX_("__tempIndex",3e,e8,54,22),1,::hx::paccDynamic);
HXDLIN(3004)			{
HXLINE(3004)				int _g_current = 0;
HXDLIN(3004)				while((_g_current < items->get_length())){
HXLINE(3004)					_g_current = (_g_current + 1);
HXDLIN(3004)					( ( ::openfl::_Vector::ObjectVector)(this1) )->insertAt(( (int)(this1->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),( ( ::openfl::text::_internal::TextFormatRange)(items->__get((_g_current - 1))) ));
...
HXLINE(3011)		range->end = value.length;
...
HXLINE(3035)				( ( ::openfl::text::_internal::TextFormatRange)(range->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) )->format->color = value;
            			}
            		}
...
HXLINE(3415)					this->_hx___startCursorTimer();
            			...
            			break;
            			case (int)97: {
HXDLIN(3377)				if (this->get_selectable()) {
...
HXLINE(3586)					this->_hx___textEngine->textFormatRanges->get((this->_hx___textEngine->textFormatRanges->_hx___array->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->end = this->_hx___text.length;
            				}
            			}
            			break;
            			case (int)120: {
