...
HX_LOCAL_STACK_FRAME(_hx_pos_ca3ccb00e898dca3_38_stripComments,"openfl.text._internal.CSSParser","stripComments",0x50263aeb,"openfl.text._internal.CSSParser.stripComments","openfl/text/_internal/CSSParser.hx",38,0xe8359bd2)
...
::String CSSParser_obj::stripComments(::String css){
            	HX_GC_STACKFRAME(&_hx_pos_ca3ccb00e898dca3_38_stripComments)
HXDLIN(  38)		return  ::EReg_obj::__alloc( HX_CTX ,this->commentRegex,HX_("ig",de,5b,00,00))->replace(css,HX_("",00,00,00,00));
            	}
...
HXLINE( 174)					this->intelligentCSSPush(::Array_obj< ::Dynamic>::__new(1)->init(0,base),found->__get((_g2 - 1)).StaticCast<  ::haxe::ds::StringMap >(),null());
            				}
            			}
...
HXLINE( 206)				_g = (_g + 1);
HXLINE( 208)				 ::haxe::ds::StringMap obj = objectArray->__get((_g - 1)).StaticCast<  ::haxe::ds::StringMap >();
...
HXLINE( 319)				_g = (_g + 1);
HXLINE( 321)				this->intelligentCSSPush(objectArray,newArray->__get((_g - 1)).StaticCast<  ::haxe::ds::StringMap >(),reverse);
            			}
            		}
HXLINE( 323)		{
...
HXLINE( 325)				 ::haxe::ds::StringMap cobj = objectArray->__get((_g2 - 1)).StaticCast<  ::haxe::ds::StringMap >();
...
HXLINE( 344)		minimalObject->get_bool(HX_("selector",1f,33,6d,b1));
...
HXLINE( 382)						 ::haxe::ds::StringMap rule = mRules->__get((_g2 - 1)).StaticCast<  ::haxe::ds::StringMap >();
...
HXLINE( 388)							( (::Array< ::Dynamic>)(cssObject->get(HX_("rules",f7,63,56,f1))) )->push(rule);
            						}
            						else {
