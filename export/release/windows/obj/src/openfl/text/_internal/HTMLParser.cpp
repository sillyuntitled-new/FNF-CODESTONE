...
HXLINE(  78)			if ((textFormatRanges->_hx___array->get_length() > 1)) {
HXLINE(  80)				int deleteCount = (textFormatRanges->_hx___array->get_length() - 1);
HXDLIN(  80)				::cpp::VirtualArray items = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(  80)				textFormatRanges->_hx___tempIndex = 1;
HXDLIN(  80)				{
HXLINE(  80)					int _g_current = 0;
HXDLIN(  80)					while((_g_current < items->get_length())){
HXLINE(  80)						_g_current = (_g_current + 1);
HXDLIN(  80)						textFormatRanges->insertAt(textFormatRanges->_hx___tempIndex,( ( ::openfl::text::_internal::TextFormatRange)(items->__get((_g_current - 1))) ));
...
HXLINE(  92)			{
HXLINE(  92)				int deleteCount1 = textFormatRanges->_hx___array->get_length();
HXDLIN(  92)				::cpp::VirtualArray items1 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(  92)				textFormatRanges->_hx___tempIndex = 0;
HXDLIN(  92)				{
HXLINE(  92)					int _g_current1 = 0;
HXDLIN(  92)					while((_g_current1 < items1->get_length())){
HXLINE(  92)						_g_current1 = (_g_current1 + 1);
HXDLIN(  92)						textFormatRanges->insertAt(textFormatRanges->_hx___tempIndex,( ( ::openfl::text::_internal::TextFormatRange)(items1->__get((_g_current1 - 1))) ));
...
HXLINE( 129)							_hx_tmp1 = (textFormatRanges->_hx___array->get_length() > 0);
            						}
            						else {
...
HXDLIN( 190)								if ((textFormatRanges->_hx___array->get_length() > 0)) {
...
HXLINE( 198)								textFormatRanges->push( ::openfl::text::_internal::TextFormatRange_obj::__alloc( HX_CTX ,bulletFormat,value.length,(value.length + HX_W(u"\u2022 ",e61c,95c3).length)));
HXLINE( 199)								value = (value + HX_W(u"\u2022 ",e61c,95c3));
HXLINE( 189)								goto _hx_goto_3;
            							}
            							if (  (_hx_switch_0==HX_("p",70,00,00,00)) ){
HXLINE( 178)								bool _hx_tmp5;
HXDLIN( 178)								if ((textFormatRanges->_hx___array->get_length() > 0)) {
...
HXLINE( 298)			if ((textFormatRanges->_hx___array->get_length() == 0)) {
