...
HXLINE( 111)				formatMap->set(hash, ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions()));
            			}
            		}
            		else {
HXLINE( 116)			 ::haxe::ds::IntMap formatMap1 =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 117)			 ::openfl::text::_internal::CacheMeasurement measurement1 =  ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions());
HXLINE( 118)			measurement1->hash = hash;
HXLINE( 119)			formatMap1->set(hash,measurement1);
...
HXLINE(  26)				_g = (_g + 1);
HXLINE(  28)				chr = key.charCodeAt((_g - 1));
