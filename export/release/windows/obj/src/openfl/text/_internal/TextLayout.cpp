...
HXLINE(  95)		::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_script(::hx::DynamicPtr(this->_hx___hbBuffer),(int)1517910393);
HXLINE(  96)		{
HXLINE(  96)			 ::Dynamic this2 = this->_hx___hbBuffer;
HXDLIN(  96)			 ::Dynamic value1 = ::lime::text::harfbuzz::_HBLanguage::HBLanguage_Impl__obj::_new(language);
HXDLIN(  96)			::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_language(::hx::DynamicPtr(this2),::hx::DynamicPtr(value1));
            		}
            	}
...
HXLINE( 177)								this->get_positions()->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,0, ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0), ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0)));
            							}
            						}
HXLINE( 180)						Float _hx_tmp6 = ((( (Float)(position->xAdvance) ) / ( (Float)(64) )) + this->letterSpacing);
HXDLIN( 180)						Float _hx_tmp7 = (( (Float)(position->yAdvance) ) / ( (Float)(64) ));
HXLINE( 181)						Float _hx_tmp8 = (( (Float)(position->xOffset) ) / ( (Float)(64) ));
HXDLIN( 181)						Float _hx_tmp9 = (( (Float)(position->yOffset) ) / ( (Float)(64) ));
HXLINE( 180)						this->get_positions()->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,info->codepoint, ::lime::math::Vector2_obj::__alloc( HX_CTX ,_hx_tmp6,_hx_tmp7), ::lime::math::Vector2_obj::__alloc( HX_CTX ,_hx_tmp8,_hx_tmp9)));
...
::hx::Val TextLayout_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"glyphs") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( get_glyphs() ); }
