...
HXLINE(  92)			while(( (bool)(keys->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  92)				::String key = ( (::String)(keys->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  94)				if (::StringTools_obj::startsWith(key,prefix)) {
HXLINE(  96)					this->removeBitmapData(key);
            				}
            			}
HXLINE( 100)			 ::Dynamic keys1 = this->font->keys();
HXLINE( 102)			while(( (bool)(keys1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 102)				::String key1 = ( (::String)(keys1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 104)				if (::StringTools_obj::startsWith(key1,prefix)) {
HXLINE( 106)					this->removeFont(key1);
            				}
            			}
HXLINE( 110)			 ::Dynamic keys2 = this->sound->keys();
HXLINE( 112)			while(( (bool)(keys2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 112)				::String key2 = ( (::String)(keys2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 114)				if (::StringTools_obj::startsWith(key2,prefix)) {
HXLINE( 116)					this->removeSound(key2);
            				}
            			}
            		}
            	}
