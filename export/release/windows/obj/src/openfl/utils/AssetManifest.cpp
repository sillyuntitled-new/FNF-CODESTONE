...
HX_LOCAL_STACK_FRAME(_hx_pos_1234d8b224456494_79_fromBytes,"openfl.utils.AssetManifest","fromBytes",0xff1bd477,"openfl.utils.AssetManifest.fromBytes","openfl/utils/AssetManifest.hx",79,0x22e5353c)
HX_LOCAL_STACK_FRAME(_hx_pos_1234d8b224456494_89_fromFile,"openfl.utils.AssetManifest","fromFile",0x23e247f0,"openfl.utils.AssetManifest.fromFile","openfl/utils/AssetManifest.hx",89,0x22e5353c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1234d8b224456494_123_parse,"openfl.utils.AssetManifest","parse",0x72d94f09,"openfl.utils.AssetManifest.parse","openfl/utils/AssetManifest.hx",123,0x22e5353c)
...
HX_DEFINE_DYNAMIC_FUNC2(AssetManifest_obj,addText,(void))
 ...
 ::openfl::utils::AssetManifest AssetManifest_obj::fromBytes( ::haxe::io::Bytes bytes,::String rootPath){
            	HX_STACKFRAME(&_hx_pos_1234d8b224456494_79_fromBytes)
HXDLIN(  79)		return ::openfl::utils::AssetManifest_obj::_hx___fromLimeManifest(::lime::utils::AssetManifest_obj::fromBytes(bytes,rootPath));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(AssetManifest_obj,fromBytes,return )
 ...
 ::openfl::utils::AssetManifest AssetManifest_obj::fromFile(::String path,::String rootPath){
            	HX_STACKFRAME(&_hx_pos_1234d8b224456494_89_fromFile)
HXDLIN(  89)		return ::openfl::utils::AssetManifest_obj::_hx___fromLimeManifest(::lime::utils::AssetManifest_obj::fromFile(path,rootPath));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(AssetManifest_obj,loadFromFile,return )
 ...
 ::openfl::utils::AssetManifest AssetManifest_obj::parse(::String data,::String rootPath){
            	HX_STACKFRAME(&_hx_pos_1234d8b224456494_123_parse)
HXDLIN( 123)		return ::openfl::utils::AssetManifest_obj::_hx___fromLimeManifest(::lime::utils::AssetManifest_obj::parse(data,rootPath));
            	}
