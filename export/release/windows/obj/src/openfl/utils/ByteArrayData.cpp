...
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_1367_unwrapAMFValue,"openfl.utils.ByteArrayData","unwrapAMFValue",0xd4092248,"openfl.utils.ByteArrayData.unwrapAMFValue","openfl/utils/ByteArray.hx",1367,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_dd5cdbe7a8b93fcc_1397_unwrapAMF3Value,"openfl.utils.ByteArrayData","unwrapAMF3Value",0x58c2bb67,"openfl.utils.ByteArrayData.unwrapAMF3Value","openfl/utils/ByteArray.hx",1397,0xaa5cee4a)
...
HXLINE(1278)			this->position = (this->position + 8);
HXLINE(1279)			int pos = (this->position - 8);
HXDLIN(1279)			bool _hx_tmp;
HXDLIN(1279)			if ((pos >= 0)) {
HXLINE(1279)				_hx_tmp = ((pos + 8) > this->length);
            			}
            			else {
...
HXLINE(1286)			return ::haxe::io::FPHelper_obj::i64ToDouble(this->readInt(),ch1);
            		}
...
HXDLIN(1333)		switch((int)(this->objectEncoding)){
            			case (int)0: {
HXLINE(1337)				 ::haxe::io::BytesInput input =  ::haxe::io::BytesInput_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),this->position,null());
HXLINE(1339)				 ::Dynamic data = ::openfl::utils::ByteArrayData_obj::unwrapAMFValue( ::format::amf::Reader_obj::__alloc( HX_CTX ,input)->read());
HXLINE(1340)				this->position = input->pos;
HXLINE(1341)				return data;
            			}
            			break;
            			case (int)3: {
HXLINE(1344)				 ::haxe::io::BytesInput input1 =  ::haxe::io::BytesInput_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),this->position,null());
HXLINE(1346)				 ::Dynamic data1 = ::openfl::utils::ByteArrayData_obj::unwrapAMF3Value( ::format::amf3::Reader_obj::__alloc( HX_CTX ,input1)->read());
HXLINE(1347)				this->position = input1->pos;
HXLINE(1348)				return data1;
            			}
            			break;
            			case (int)10: {
HXLINE(1353)				return ::haxe::Unserializer_obj::run(this->readUTF());
            			}
            			break;
            			case (int)12: {
HXLINE(1357)				return  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,this->readUTF())->doParse();
            			}
            			break;
            			default:{
...
void ByteArrayData_obj::writeObject( ::Dynamic object){
            	HX_GC_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1663_writeObject)
HXDLIN(1663)		switch((int)(this->objectEncoding)){
            			case (int)0: {
HXLINE(1667)				 ::format::amf::Value value = ::format::amf::Tools_obj::encode(object);
HXLINE(1668)				 ::haxe::io::BytesOutput output =  ::haxe::io::BytesOutput_obj::__alloc( HX_CTX );
HXLINE(1670)				 ::format::amf::Writer_obj::__alloc( HX_CTX ,output)->write(value);
HXLINE(1671)				this->writeBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(output->getBytes()),null(),null());
            			}
            			break;
            			case (int)3: {
HXLINE(1674)				 ::format::amf3::Value value1 = ::format::amf3::Tools_obj::encode(object);
HXLINE(1675)				 ::haxe::io::BytesOutput output1 =  ::haxe::io::BytesOutput_obj::__alloc( HX_CTX );
HXLINE(1677)				 ::format::amf3::Writer_obj::__alloc( HX_CTX ,output1)->write(value1);
HXLINE(1678)				this->writeBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(output1->getBytes()),null(),null());
            			}
            			break;
            			case (int)10: {
HXLINE(1683)				this->writeUTF(::haxe::Serializer_obj::run(object));
            			}
            			break;
            			case (int)12: {
HXLINE(1686)				 ::Dynamic replacer = null();
HXDLIN(1686)				::String space = null();
HXLINE(1687)				this->writeUTF(::haxe::format::JsonPrinter_obj::print(object,replacer,space));
            			}
            			break;
            			default:{
HXLINE(1690)				return;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ByteArrayData_obj,fromBytes,return )
 ...
 ::Dynamic ByteArrayData_obj::unwrapAMFValue( ::format::amf::Value val){
            	HX_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1367_unwrapAMFValue)
HXDLIN(1367)		switch((int)(val->_hx_getIndex())){
            			case (int)0: {
HXLINE(1370)				return val->_hx_getFloat(0);
            			}
            			break;
            			case (int)1: {
HXLINE(1372)				return val->_hx_getBool(0);
            			}
            			break;
            			case (int)2: {
HXLINE(1374)				return val->_hx_getString(0);
            			}
            			break;
            			case (int)3: {
HXLINE(1384)				 ::haxe::ds::StringMap _g = val->_hx_getObject(0).StaticCast<  ::haxe::ds::StringMap >();
HXLINE(1386)				 ::Dynamic obj =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE(1387)				{
HXLINE(1387)					 ::Dynamic name = _g->keys();
HXDLIN(1387)					while(( (bool)(name->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1387)						::String name1 = ( (::String)(name->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(1389)						::Reflect_obj::setField(obj,name1,::openfl::utils::ByteArrayData_obj::unwrapAMFValue(_g->get(name1)));
            					}
            				}
HXLINE(1391)				return obj;
            			}
            			break;
            			case (int)4: {
HXLINE(1376)				return val->_hx_getObject(0).StaticCast<  ::Date >();
            			}
            			break;
            			case (int)5: {
...
HXLINE(1380)				return null();
            			...
            			break;
            			case (int)7: {
HXLINE(1381)				::Array< ::Dynamic> _g1 = val->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE(1382)				 ::Dynamic f = ::openfl::utils::ByteArrayData_obj::unwrapAMFValue_dyn();
HXDLIN(1382)				::cpp::VirtualArray result = ::cpp::VirtualArray_obj::__new(_g1->length);
HXDLIN(1382)				{
HXLINE(1382)					int _g2 = 0;
HXDLIN(1382)					int _g3 = _g1->length;
HXDLIN(1382)					while((_g2 < _g3)){
HXLINE(1382)						_g2 = (_g2 + 1);
HXDLIN(1382)						int i = (_g2 - 1);
HXDLIN(1382)						{
HXLINE(1382)							 ::Dynamic inValue = f(_hx_array_unsafe_get(_g1,i));
HXDLIN(1382)							result->__unsafe_set(i,inValue);
            						}
            					}
            				}
HXDLIN(1382)				return result;
            			}
            			break;
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ByteArrayData_obj,unwrapAMFValue,return )

 ::Dynamic ByteArrayData_obj::unwrapAMF3Value( ::format::amf3::Value val){
            	HX_GC_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1397_unwrapAMF3Value)
HXDLIN(1397)		switch((int)(val->_hx_getIndex())){
            			case (int)0: {
HXLINE(1405)				return null();
            			}
            			break;
            			case (int)1: {
HXLINE(1406)				return null();
            			}
            			break;
            			case (int)2: {
HXLINE(1401)				return val->_hx_getBool(0);
            			}
            			break;
            			case (int)3: {
HXLINE(1400)				return val->_hx_getInt(0);
            			}
            			break;
            			case (int)4: {
HXLINE(1399)				return val->_hx_getFloat(0);
            			}
            			break;
            			case (int)5: {
HXLINE(1402)				return val->_hx_getString(0);
            			}
            			break;
            			case (int)6: {
HXLINE(1403)				return val->_hx_getObject(0).StaticCast<  ::Date >();
            			}
            			break;
            			case (int)7: {
HXLINE(1411)				 ::haxe::ds::StringMap _g = val->_hx_getObject(0).StaticCast<  ::haxe::ds::StringMap >();
HXLINE(1412)				 ::Dynamic obj =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE(1413)				{
HXLINE(1413)					 ::Dynamic name = _g->keys();
HXDLIN(1413)					while(( (bool)(name->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1413)						::String name1 = ( (::String)(name->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(1415)						::Reflect_obj::setField(obj,name1,::openfl::utils::ByteArrayData_obj::unwrapAMF3Value(_g->get(name1)));
            					}
            				}
HXLINE(1417)				return obj;
            			}
            			break;
            			case (int)8: {
HXLINE(1407)				::Array< ::Dynamic> _g1 = val->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN(1407)				 ::Dynamic f = ::openfl::utils::ByteArrayData_obj::unwrapAMF3Value_dyn();
HXDLIN(1407)				::cpp::VirtualArray result = ::cpp::VirtualArray_obj::__new(_g1->length);
HXDLIN(1407)				{
HXLINE(1407)					int _g2 = 0;
HXDLIN(1407)					int _g3 = _g1->length;
HXDLIN(1407)					while((_g2 < _g3)){
HXLINE(1407)						_g2 = (_g2 + 1);
HXDLIN(1407)						int i = (_g2 - 1);
HXDLIN(1407)						{
HXLINE(1407)							 ::Dynamic inValue = f(_hx_array_unsafe_get(_g1,i));
HXDLIN(1407)							result->__unsafe_set(i,inValue);
            						}
            					}
            				}
HXDLIN(1407)				return result;
            			}
            			break;
            			case (int)9: {
HXLINE(1408)				::Array< ::Dynamic> _g4 = val->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN(1408)				 ::Dynamic f1 = ::openfl::utils::ByteArrayData_obj::unwrapAMF3Value_dyn();
HXDLIN(1408)				int length = _g4->length;
HXDLIN(1408)				::cpp::VirtualArray r = ::cpp::VirtualArray_obj::__new(length);
HXDLIN(1408)				{
HXLINE(1408)					int _g5 = 0;
HXDLIN(1408)					while((_g5 < length)){
HXLINE(1408)						_g5 = (_g5 + 1);
HXDLIN(1408)						int i1 = (_g5 - 1);
HXDLIN(1408)						 ::Dynamic v = f1(_hx_array_unsafe_get(_g4,i1));
HXDLIN(1408)						r->__unsafe_set(i1,v);
            					}
            				}
HXDLIN(1408)				return r;
            			}
            			break;
            			case (int)10: {
HXLINE(1404)				return val->_hx_getObject(0).StaticCast<  ::Xml >();
            			}
            			break;
            			case (int)11: {
HXLINE(1409)				return ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(val->_hx_getObject(0).StaticCast<  ::haxe::io::Bytes >());
            			}
            			break;
            			case (int)12: {
HXLINE(1419)				 ::haxe::ds::EnumValueMap _g6 = val->_hx_getObject(0).StaticCast<  ::haxe::ds::EnumValueMap >();
HXLINE(1420)				::Dynamic map = null();
HXLINE(1421)				{
HXLINE(1421)					 ::Dynamic key = _g6->keys();
HXDLIN(1421)					while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1421)						 ::format::amf3::Value key1 = key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXLINE(1424)						if (::hx::IsNull( map )) {
HXLINE(1426)							switch((int)(key1->_hx_getIndex())){
            								case (int)3: {
HXLINE(1429)									map =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
            								}
            								break;
            								case (int)5: {
HXLINE(1428)									map =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            								}
            								break;
            								default:{
HXLINE(1430)									map =  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX );
            								}
            							}
            						}
HXLINE(1433)						 ::Dynamic _hx_tmp = ::openfl::utils::ByteArrayData_obj::unwrapAMF3Value(key1);
HXDLIN(1433)						::haxe::IMap_obj::set(map,_hx_tmp,::openfl::utils::ByteArrayData_obj::unwrapAMF3Value(_g6->get(key1).StaticCast<  ::format::amf3::Value >()));
            					}
            				}
HXLINE(1437)				if (::hx::IsNull( map )) {
HXLINE(1439)					map =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            				}
HXLINE(1441)				return map;
            			}
            			break;
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ByteArrayData_obj,unwrapAMF3Value,return )
...
bool ByteArrayData_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"unwrapAMFValue") ) { outValue = unwrapAMFValue_dyn(); return true; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"__defaultEndian") ) { outValue = ( _hx___defaultEndian ); return true; }
		if (HX_FIELD_EQ(inName,"unwrapAMF3Value") ) { outValue = unwrapAMF3Value_dyn(); return true; }
		break;
	case 17:
...
static ::String ByteArrayData_obj_sStaticFields[] = {
	...
	HX_("unwrapAMFValue",da,fe,6e,d4),
	HX_("unwrapAMF3Value",95,de,7d,b1),
