...
HXLINE( 846)		int this1 = this->emitCode;
HXDLIN( 846)		Float _hx_tmp1;
HXDLIN( 846)		if ((this1 < 0)) {
HXLINE( 846)			_hx_tmp1 = (((Float)4294967296.0) + this1);
            		}
            		else {
HXLINE( 846)			_hx_tmp1 = (this1 + ((Float)0.0));
            		}
HXLINE( 841)		::String _hx_tmp2 = ((_hx_tmp + ::Std_obj::string(_hx_tmp1)) + HX_(", range=",54,d5,eb,be));
HXLINE( 848)		int this2 = this->range;
HXDLIN( 848)		Float _hx_tmp3;
HXDLIN( 848)		if ((this2 < 0)) {
HXLINE( 848)			_hx_tmp3 = (((Float)4294967296.0) + this2);
            		}
            		else {
HXLINE( 848)			_hx_tmp3 = (this2 + ((Float)0.0));
            		}
HXLINE( 841)		::String _hx_tmp4 = ((_hx_tmp2 + ::Std_obj::string(_hx_tmp3)) + HX_(", flags=",8a,28,74,3f));
HXLINE( 850)		int this3 = this->flags;
HXDLIN( 850)		Float _hx_tmp5;
HXDLIN( 850)		if ((this3 < 0)) {
HXLINE( 850)			_hx_tmp5 = (((Float)4294967296.0) + this3);
            		}
            		else {
HXLINE( 850)			_hx_tmp5 = (this3 + ((Float)0.0));
            		}
