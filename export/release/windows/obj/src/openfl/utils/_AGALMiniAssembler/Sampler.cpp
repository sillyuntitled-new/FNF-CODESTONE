...
HXDLIN( 875)		int this1 = this->flag;
HXDLIN( 875)		Float _hx_tmp1;
HXDLIN( 875)		if ((this1 < 0)) {
HXDLIN( 875)			_hx_tmp1 = (((Float)4294967296.0) + this1);
            		}
            		else {
HXDLIN( 875)			_hx_tmp1 = (this1 + ((Float)0.0));
            		}
HXDLIN( 875)		::String _hx_tmp2 = ((_hx_tmp + ::Std_obj::string(_hx_tmp1)) + HX_("\", mask=",fb,aa,f1,8c));
HXDLIN( 875)		int this2 = this->mask;
HXDLIN( 875)		Float _hx_tmp3;
HXDLIN( 875)		if ((this2 < 0)) {
HXDLIN( 875)			_hx_tmp3 = (((Float)4294967296.0) + this2);
            		}
            		else {
HXDLIN( 875)			_hx_tmp3 = (this2 + ((Float)0.0));
            		}
