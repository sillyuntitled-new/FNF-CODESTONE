...
static ::haxe::IMap_obj _hx_openfl_utils__Dictionary_ClassMap__hx_haxe_IMap= {
	...
	( ::Dynamic (::hx::Object::*)())&::openfl::utils::_Dictionary::ClassMap_obj::copy_ee952b4b,
...
::Dynamic ClassMap_obj::copy_ee952b4b() {
			return copy();
}
...
HXDLIN( 236)		return this->types->exists(::Type_obj::getClassName(key));
            	}
...
HXDLIN( 241)		return this->values->get(::Type_obj::getClassName(key));
            	}
