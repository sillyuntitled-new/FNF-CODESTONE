...
HX_LOCAL_STACK_FRAME(_hx_pos_4de4efe70e9aaf52_79_fileTransfert,"sys.Http","fileTransfert",0xe32d4448,"sys.Http.fileTransfert","C:\\HaxeToolkit\\haxe\\std/sys/Http.hx",79,0x92a61a9b)
HX_LOCAL_STACK_FRAME(_hx_pos_4de4efe70e9aaf52_83_fileTransfer,"sys.Http","fileTransfer",0xaf8312ac,"sys.Http.fileTransfer","C:\\HaxeToolkit\\haxe\\std/sys/Http.hx",83,0x92a61a9b)
...
HX_LOCAL_STACK_FRAME(_hx_pos_4de4efe70e9aaf52_264_getResponseHeaderValues,"sys.Http","getResponseHeaderValues",0x8ec97061,"sys.Http.getResponseHeaderValues","C:\\HaxeToolkit\\haxe\\std/sys/Http.hx",264,0x92a61a9b)
...
void Http_obj::fileTransfert(::String argname,::String filename, ::haxe::io::Input file,int size,::String __o_mimeType){
            	...
            	HX_STACKFRAME(&_hx_pos_4de4efe70e9aaf52_79_fileTransfert)
HXDLIN(  79)		this->fileTransfer(argname,filename,file,size,mimeType);
            	}
...
void Http_obj::fileTransfer(::String argname,::String filename, ::haxe::io::Input file,int size,::String __o_mimeType){
            		::String mimeType = __o_mimeType;
            		if (::hx::IsNull(__o_mimeType)) mimeType = HX_("application/octet-stream",5d,f8,82,30);
            	HX_STACKFRAME(&_hx_pos_4de4efe70e9aaf52_83_fileTransfer)
HXDLIN(  83)		this->file =  ::Dynamic(::hx::Anon_obj::Create(5)
...
HXLINE( 145)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_11,1);
            						}
            						else {
...
HXLINE( 147)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_12,1);
            						}
            						else {
...
HXLINE( 148)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_13,1);
            						}
            						else {
...
HXLINE( 151)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_15,1);
            						}
            						else {
...
HXLINE( 152)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_16,1);
            						}
            						else {
...
HXLINE( 154)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_17,1);
            						}
            						else {
...
HXLINE( 156)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_18,1);
            				}
            				else {
...
HXLINE( 158)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_19,1);
            				}
            				else {
...
HXLINE( 159)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_20,1);
            				}
            				else {
...
HXLINE( 161)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_21,1);
            				}
            				else {
...
HXLINE( 163)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_22,1);
            				}
            				else {
...
HXLINE( 164)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_23,1);
            				}
            				else {
...
::Array< ::String > Http_obj::getResponseHeaderValues(::String key){
            	HX_STACKFRAME(&_hx_pos_4de4efe70e9aaf52_264_getResponseHeaderValues)
HXLINE( 265)		::Array< ::String > array = ( (::Array< ::String >)(this->responseHeadersSameKey->get(key)) );
HXLINE( 266)		if (::hx::IsNull( array )) {
HXLINE( 267)			::String singleValue = this->responseHeaders->get_string(key);
HXLINE( 268)			if (::hx::IsNull( singleValue )) {
HXLINE( 268)				return null();
            			}
            			else {
HXLINE( 268)				return ::Array_obj< ::String >::__new(1)->init(0,singleValue);
            			}
            		}
            		else {
HXLINE( 270)			return array;
            		}
HXLINE( 266)		return null();
            	}


HX_DEFINE_DYNAMIC_FUNC1(Http_obj,getResponseHeaderValues,return )
...
HXLINE( 387)				int l = hval.length;
HXDLIN( 387)				int r = 0;
HXDLIN( 387)				while(true){
HXLINE( 387)					bool hval1;
HXDLIN( 387)					if ((r < l)) {
HXLINE( 387)						hval1 = ::StringTools_obj::isSpace(hval,((l - r) - 1));
            					}
            					else {
HXLINE( 387)						hval1 = false;
            					}
HXDLIN( 387)					if (!(hval1)) {
...
HXDLIN( 387)					r = (r + 1);
            				...
            				_hx_goto_32:;
HXDLIN( 387)				::String s1;
HXDLIN( 387)				if ((r > 0)) {
HXLINE( 387)					s1 = hval.substr(0,(l - r));
            				}
            				else {
HXLINE( 387)					s1 = hval;
            				}
HXDLIN( 387)				int l1 = s1.length;
HXDLIN( 387)				int r1 = 0;
HXDLIN( 387)				while(true){
HXLINE( 387)					bool hval2;
HXDLIN( 387)					if ((r1 < l1)) {
HXLINE( 387)						hval2 = ::StringTools_obj::isSpace(s1,r1);
            					}
            					else {
HXLINE( 387)						hval2 = false;
            					}
HXDLIN( 387)					if (!(hval2)) {
HXLINE( 387)						goto _hx_goto_33;
            					}
HXDLIN( 387)					r1 = (r1 + 1);
            				}
            				_hx_goto_33:;
HXDLIN( 387)				if ((r1 > 0)) {
HXLINE( 387)					hval = s1.substr(r1,(l1 - r1));
            				}
            				else {
HXLINE( 387)					hval = s1;
            				}
...
::hx::Val Http_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 22:
		...
		break;
	case 23:
		if (HX_FIELD_EQ(inName,"getResponseHeaderValues") ) { return ::hx::Val( getResponseHeaderValues_dyn() ); }
	}
...
static ::String Http_obj_sMemberFields[] = {
	...
	HX_("getResponseHeaderValues",26,dd,9d,ed),
