...
HX_LOCAL_STACK_FRAME(_hx_pos_d9357d86f6a2fb2a_53_insertEventByTime,"sys.thread.EventLoop","insertEventByTime",0xe81712b2,"sys.thread.EventLoop.insertEventByTime","C:\\HaxeToolkit\\haxe\\std/sys/thread/EventLoop.hx",53,0x60c7a9aa)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d9357d86f6a2fb2a_168_wait,"sys.thread.EventLoop","wait",0x3b187a68,"sys.thread.EventLoop.wait","C:\\HaxeToolkit\\haxe\\std/sys/thread/EventLoop.hx",168,0x60c7a9aa)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d9357d86f6a2fb2a_205___progress,"sys.thread.EventLoop","__progress",0x484a8300,"sys.thread.EventLoop.__progress","C:\\HaxeToolkit\\haxe\\std/sys/thread/EventLoop.hx",205,0x60c7a9aa)
namespace sys{
namespace thread{
...
void EventLoop_obj::insertEventByTime( ::sys::thread::_EventLoop::RegularEvent event){
            	HX_STACKFRAME(&_hx_pos_d9357d86f6a2fb2a_53_insertEventByTime)
HXDLIN(  53)		 ::sys::thread::_EventLoop::RegularEvent _g = this->regularEvents;
HXLINE(  54)		if (::hx::IsNull( _g )) {
HXLINE(  55)			this->regularEvents = event;
            		}
            		else {
HXLINE(  56)			 ::sys::thread::_EventLoop::RegularEvent current = _g;
HXDLIN(  56)			{
HXLINE(  57)				 ::sys::thread::_EventLoop::RegularEvent previous = null();
HXLINE(  58)				while(true){
HXLINE(  59)					if (::hx::IsNull( current )) {
HXLINE(  60)						previous->next = event;
HXLINE(  61)						event->previous = previous;
HXLINE(  62)						goto _hx_goto_3;
            					}
            					else {
HXLINE(  63)						if ((event->nextRunTime < current->nextRunTime)) {
HXLINE(  64)							event->next = current;
HXLINE(  65)							current->previous = event;
HXLINE(  66)							if (::hx::IsNull( previous )) {
HXLINE(  68)								this->regularEvents = event;
            							}
            							else {
HXLINE(  70)								event->previous = previous;
HXLINE(  71)								previous->next = event;
HXLINE(  72)								current->previous = event;
            							}
HXLINE(  74)							goto _hx_goto_3;
            						}
            						else {
HXLINE(  76)							previous = current;
HXLINE(  77)							current = current->next;
            						}
            					}
            				}
            				_hx_goto_3:;
...
HXLINE( 133)		this->waitLock->release();
HXLINE( 134)		this->mutex->release();
            	}
...
bool EventLoop_obj::wait( ::Dynamic timeout){
            	HX_STACKFRAME(&_hx_pos_d9357d86f6a2fb2a_168_wait)
...
HX_DEFINE_DYNAMIC_FUNC0(EventLoop_obj,loop,(void))
 ...
 ::Dynamic EventLoop_obj::_hx___progress(Float now,::Array< ::Dynamic> recycleRegular,::Array< ::Dynamic> recycleOneTimers){
            	HX_STACKFRAME(&_hx_pos_d9357d86f6a2fb2a_205___progress)
HXLINE( 207)		int eventsToRunIdx = 0;
HXLINE( 209)		Float nextEventAt = ( (Float)(-1) );
HXLINE( 211)		this->mutex->acquire();
HXLINE( 213)		while(this->waitLock->wait(((Float)0.0))){
            		}
HXLINE( 215)		 ::sys::thread::_EventLoop::RegularEvent current = this->regularEvents;
HXLINE( 216)		while(::hx::IsNotNull( current )){
HXLINE( 217)			if ((current->nextRunTime <= now)) {
HXLINE( 218)				eventsToRunIdx = (eventsToRunIdx + 1);
HXDLIN( 218)				recycleRegular[(eventsToRunIdx - 1)] = current;
HXLINE( 219)				 ::sys::thread::_EventLoop::RegularEvent current1 = current;
HXDLIN( 219)				current1->nextRunTime = (current1->nextRunTime + current->interval);
HXLINE( 220)				nextEventAt = ( (Float)(-2) );
            			}
            			else {
HXLINE( 221)				bool _hx_tmp;
HXDLIN( 221)				if ((nextEventAt != -1)) {
HXLINE( 221)					_hx_tmp = (current->nextRunTime < nextEventAt);
            				}
            				else {
...
HXLINE( 226)		this->mutex->release();
HXLINE( 229)		{
HXLINE( 229)			int _g = 0;
HXDLIN( 229)			int _g1 = eventsToRunIdx;
HXDLIN( 229)			while((_g < _g1)){
HXLINE( 229)				_g = (_g + 1);
HXDLIN( 229)				int i = (_g - 1);
HXLINE( 230)				if (!(recycleRegular->__get(i).StaticCast<  ::sys::thread::_EventLoop::RegularEvent >()->cancelled)) {
HXLINE( 231)					recycleRegular->__get(i).StaticCast<  ::sys::thread::_EventLoop::RegularEvent >()->run();
            				}
HXLINE( 232)				recycleRegular[i] = null();
            			}
            		}
HXLINE( 234)		eventsToRunIdx = 0;
HXLINE( 238)		this->mutex->acquire();
HXLINE( 239)		{
HXLINE( 239)			::Array< ::Dynamic> _this = this->oneTimeEvents;
HXDLIN( 239)			int _g_current = 0;
HXDLIN( 239)			while((_g_current < _this->length)){
HXLINE( 239)				 ::Dynamic _g_value = _this->__get(_g_current);
HXDLIN( 239)				_g_current = (_g_current + 1);
HXLINE( 240)				if (::hx::IsNull( _g_value )) {
HXLINE( 242)					goto _hx_goto_28;
            				}
            				else {
HXLINE( 244)					eventsToRunIdx = (eventsToRunIdx + 1);
HXDLIN( 244)					recycleOneTimers[(eventsToRunIdx - 1)] = _g_value;
HXLINE( 245)					this->oneTimeEvents[(_g_current - 1)] = null();
            				}
            			}
            			_hx_goto_28:;
            		}
HXLINE( 248)		this->oneTimeEventsIdx = 0;
HXLINE( 249)		bool hasPromisedEvents = (this->promisedEventsCount > 0);
HXLINE( 250)		this->mutex->release();
HXLINE( 253)		{
HXLINE( 253)			int _g2 = 0;
HXDLIN( 253)			int _g3 = eventsToRunIdx;
HXDLIN( 253)			while((_g2 < _g3)){
HXLINE( 253)				_g2 = (_g2 + 1);
HXDLIN( 253)				int i1 = (_g2 - 1);
HXLINE( 254)				recycleOneTimers->__get(i1)();
HXLINE( 255)				recycleOneTimers[i1] = null();
            			}
            		}
HXLINE( 259)		if (this->isMainThread) {
HXLINE( 260)			Float next = ::haxe::MainLoop_obj::tick();
HXLINE( 261)			if (::haxe::MainLoop_obj::hasEvents()) {
HXLINE( 262)				eventsToRunIdx = (eventsToRunIdx + 1);
HXLINE( 263)				if ((nextEventAt > next)) {
HXLINE( 264)					nextEventAt = next;
            				}
            			}
            		}
HXLINE( 269)		if ((eventsToRunIdx > 0)) {
HXLINE( 270)			nextEventAt = ( (Float)(-2) );
            		}
HXLINE( 272)		return  ::Dynamic(::hx::Anon_obj::Create(2)
