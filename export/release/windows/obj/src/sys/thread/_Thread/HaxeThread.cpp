...
HX_LOCAL_STACK_FRAME(_hx_pos_5f636ea23ce47cfc_175_sendMessage,"sys.thread._Thread.HaxeThread","sendMessage",0xaee82de9,"sys.thread._Thread.HaxeThread.sendMessage","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",175,0x5ec2eeb7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_5f636ea23ce47cfc_138_runWithEventLoop,"sys.thread._Thread.HaxeThread","runWithEventLoop",0x05de45a3,"sys.thread._Thread.HaxeThread.runWithEventLoop","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",138,0x5ec2eeb7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_5f636ea23ce47cfc_179_currentHandle,"sys.thread._Thread.HaxeThread","currentHandle",0x697e5fcb,"sys.thread._Thread.HaxeThread.currentHandle","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",179,0x5ec2eeb7)
HX_LOCAL_STACK_FRAME(_hx_pos_5f636ea23ce47cfc_183_createHandle,"sys.thread._Thread.HaxeThread","createHandle",0xc0d817fa,"sys.thread._Thread.HaxeThread.createHandle","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",183,0x5ec2eeb7)
HX_LOCAL_STACK_FRAME(_hx_pos_5f636ea23ce47cfc_187_readMessage,"sys.thread._Thread.HaxeThread","readMessage",0x77c76d9b,"sys.thread._Thread.HaxeThread.readMessage","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",187,0x5ec2eeb7)
namespace sys{
namespace thread{
namespace _Thread{
...
void HaxeThread_obj::sendMessage( ::Dynamic msg){
            	HX_STACKFRAME(&_hx_pos_5f636ea23ce47cfc_175_sendMessage)
...
void HaxeThread_obj::runWithEventLoop( ::Dynamic job){
            	HX_GC_STACKFRAME(&_hx_pos_5f636ea23ce47cfc_138_runWithEventLoop)
...
HXLINE( 145)				thread->events = null();
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE( 146)					 ::haxe::Exception _g1 = ::haxe::Exception_obj::caught(_g);
HXDLIN( 146)					{
HXLINE( 147)						thread->events = null();
HXLINE( 148)						HX_STACK_DO_THROW(_g1);
            					}
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(HaxeThread_obj,dropThread,(void))
 ...
 ::Dynamic HaxeThread_obj::currentHandle(){
            	HX_STACKFRAME(&_hx_pos_5f636ea23ce47cfc_179_currentHandle)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(HaxeThread_obj,currentHandle,return )
 ...
 ::Dynamic HaxeThread_obj::createHandle( ::Dynamic callb){
            	HX_STACKFRAME(&_hx_pos_5f636ea23ce47cfc_183_createHandle)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(HaxeThread_obj,createHandle,return )
 ...
 ::Dynamic HaxeThread_obj::readMessage(bool block){
            	HX_STACKFRAME(&_hx_pos_5f636ea23ce47cfc_187_readMessage)
