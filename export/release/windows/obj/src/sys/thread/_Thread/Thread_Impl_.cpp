...
HX_LOCAL_STACK_FRAME(_hx_pos_1eb101978d3f352a_31_sendMessage,"sys.thread._Thread.Thread_Impl_","sendMessage",0x86585e43,"sys.thread._Thread.Thread_Impl_.sendMessage","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",31,0x5ec2eeb7)
HX_LOCAL_STACK_FRAME(_hx_pos_1eb101978d3f352a_35_current,"sys.thread._Thread.Thread_Impl_","current",0x8b912f1d,"sys.thread._Thread.Thread_Impl_.current","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",35,0x5ec2eeb7)
HX_LOCAL_STACK_FRAME(_hx_pos_1eb101978d3f352a_39_create,"sys.thread._Thread.Thread_Impl_","create",0xfa0cbc98,"sys.thread._Thread.Thread_Impl_.create","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",39,0x5ec2eeb7)
HX_LOCAL_STACK_FRAME(_hx_pos_1eb101978d3f352a_43_runWithEventLoop,"sys.thread._Thread.Thread_Impl_","runWithEventLoop",0x55de8f09,"sys.thread._Thread.Thread_Impl_.runWithEventLoop","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",43,0x5ec2eeb7)
HX_LOCAL_STACK_FRAME(_hx_pos_1eb101978d3f352a_47_createWithEventLoop,"sys.thread._Thread.Thread_Impl_","createWithEventLoop",0x5626bd00,"sys.thread._Thread.Thread_Impl_.createWithEventLoop","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",47,0x5ec2eeb7)
...
void Thread_Impl__obj::sendMessage( ::sys::thread::_Thread::HaxeThread this1, ::Dynamic msg){
            	HX_STACKFRAME(&_hx_pos_1eb101978d3f352a_31_sendMessage)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Thread_Impl__obj,sendMessage,(void))
 ...
 ::sys::thread::_Thread::HaxeThread Thread_Impl__obj::current(){
            	HX_STACKFRAME(&_hx_pos_1eb101978d3f352a_35_current)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Thread_Impl__obj,current,return )
 ...
 ::sys::thread::_Thread::HaxeThread Thread_Impl__obj::create( ::Dynamic job){
            	HX_STACKFRAME(&_hx_pos_1eb101978d3f352a_39_create)
...
void Thread_Impl__obj::runWithEventLoop( ::Dynamic job){
            	HX_STACKFRAME(&_hx_pos_1eb101978d3f352a_43_runWithEventLoop)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Thread_Impl__obj,runWithEventLoop,(void))
 ...
 ::sys::thread::_Thread::HaxeThread Thread_Impl__obj::createWithEventLoop( ::Dynamic job){
            	HX_STACKFRAME(&_hx_pos_1eb101978d3f352a_47_createWithEventLoop)
