...
HX_DEFINE_STACK_FRAME(_hx_pos_ec8b91de38cbe726_15846_new,"zpp_nape.util.ZNPNode_ZPP_SimpleVert","new",0x66910346,"zpp_nape.util.ZNPNode_ZPP_SimpleVert.new","zpp_nape/util/Lists.hx",15846,0x9f4e6754)
HX_LOCAL_STACK_FRAME(_hx_pos_ec8b91de38cbe726_15874_alloc,"zpp_nape.util.ZNPNode_ZPP_SimpleVert","alloc",0x77afdcdb,"zpp_nape.util.ZNPNode_ZPP_SimpleVert.alloc","zpp_nape/util/Lists.hx",15874,0x9f4e6754)
HX_LOCAL_STACK_FRAME(_hx_pos_ec8b91de38cbe726_15878_free,"zpp_nape.util.ZNPNode_ZPP_SimpleVert","free",0x5311f306,"zpp_nape.util.ZNPNode_ZPP_SimpleVert.free","zpp_nape/util/Lists.hx",15878,0x9f4e6754)
HX_LOCAL_STACK_FRAME(_hx_pos_ec8b91de38cbe726_15885_elem,"zpp_nape.util.ZNPNode_ZPP_SimpleVert","elem",0x52642ee9,"zpp_nape.util.ZNPNode_ZPP_SimpleVert.elem","zpp_nape/util/Lists.hx",15885,0x9f4e6754)
HX_LOCAL_STACK_FRAME(_hx_pos_ec8b91de38cbe726_15847_boot,"zpp_nape.util.ZNPNode_ZPP_SimpleVert","boot",0x506ada8c,"zpp_nape.util.ZNPNode_ZPP_SimpleVert.boot","zpp_nape/util/Lists.hx",15847,0x9f4e6754)
namespace zpp_nape{
namespace util{

void ZNPNode_ZPP_SimpleVert_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_ec8b91de38cbe726_15846_new)
HXLINE(15880)		this->elt = null();
HXLINE(15871)		this->next = null();
            	}
...
bool ZNPNode_ZPP_SimpleVert_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x19ce3784;
}

void ZNPNode_ZPP_SimpleVert_obj::alloc(){
            	HX_STACKFRAME(&_hx_pos_ec8b91de38cbe726_15874_alloc)
            	}
...
void ZNPNode_ZPP_SimpleVert_obj::free(){
            	HX_STACKFRAME(&_hx_pos_ec8b91de38cbe726_15878_free)
HXDLIN(15878)		this->elt = null();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ZNPNode_ZPP_SimpleVert_obj,free,(void))
 ...
 ::zpp_nape::geom::ZPP_SimpleVert ZNPNode_ZPP_SimpleVert_obj::elem(){
            	HX_STACKFRAME(&_hx_pos_ec8b91de38cbe726_15885_elem)
HXDLIN(15885)		return this->elt;
            	}
...
static ::hx::StorageInfo ZNPNode_ZPP_SimpleVert_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::zpp_nape::util::ZNPNode_ZPP_SimpleVert */ ,(int)offsetof(ZNPNode_ZPP_SimpleVert_obj,next),HX_("next",f3,84,02,49)},
	{::hx::fsObject /*  ::zpp_nape::geom::ZPP_SimpleVert */ ,(int)offsetof(ZNPNode_ZPP_SimpleVert_obj,elt),HX_("elt",2d,02,4d,00)},
	{ ::hx::fsUnknown, 0, null()}
};
static ::hx::StaticInfo ZNPNode_ZPP_SimpleVert_obj_sStaticStorageInfo[] = {
	{::hx::fsObject /*  ::zpp_nape::util::ZNPNode_ZPP_SimpleVert */ ,(void *) &ZNPNode_ZPP_SimpleVert_obj::zpp_pool,HX_("zpp_pool",81,5d,d4,38)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
{
	ZNPNode_ZPP_SimpleVert_obj _hx_dummy;
	ZNPNode_ZPP_SimpleVert_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("zpp_nape.util.ZNPNode_ZPP_SimpleVert",54,a8,b8,dc);
...
{
{
            	HX_STACKFRAME(&_hx_pos_ec8b91de38cbe726_15847_boot)
HXDLIN(15847)		zpp_pool = null();
            	}
}
