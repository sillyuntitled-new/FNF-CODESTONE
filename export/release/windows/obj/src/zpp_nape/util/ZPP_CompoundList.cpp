...
HX_DEFINE_STACK_FRAME(_hx_pos_4a4641d0573b027a_16681_new,"zpp_nape.util.ZPP_CompoundList","new",0xf2460f0b,"zpp_nape.util.ZPP_CompoundList.new","zpp_nape/util/Lists.hx",16681,0x9f4e6754)
HX_LOCAL_STACK_FRAME(_hx_pos_4a4641d0573b027a_16702_valmod,"zpp_nape.util.ZPP_CompoundList","valmod",0x0d40f8b6,"zpp_nape.util.ZPP_CompoundList.valmod","zpp_nape/util/Lists.hx",16702,0x9f4e6754)
HX_LOCAL_STACK_FRAME(_hx_pos_4a4641d0573b027a_16712_modified,"zpp_nape.util.ZPP_CompoundList","modified",0x56fb90be,"zpp_nape.util.ZPP_CompoundList.modified","zpp_nape/util/Lists.hx",16712,0x9f4e6754)
HX_LOCAL_STACK_FRAME(_hx_pos_4a4641d0573b027a_16719_modify_test,"zpp_nape.util.ZPP_CompoundList","modify_test",0xa063b722,"zpp_nape.util.ZPP_CompoundList.modify_test","zpp_nape/util/Lists.hx",16719,0x9f4e6754)
HX_LOCAL_STACK_FRAME(_hx_pos_4a4641d0573b027a_16723_validate,"zpp_nape.util.ZPP_CompoundList","validate",0x4517860b,"zpp_nape.util.ZPP_CompoundList.validate","zpp_nape/util/Lists.hx",16723,0x9f4e6754)
HX_LOCAL_STACK_FRAME(_hx_pos_4a4641d0573b027a_16728_invalidate,"zpp_nape.util.ZPP_CompoundList","invalidate",0x03cdd630,"zpp_nape.util.ZPP_CompoundList.invalidate","zpp_nape/util/Lists.hx",16728,0x9f4e6754)
HX_LOCAL_STACK_FRAME(_hx_pos_4a4641d0573b027a_16695_get,"zpp_nape.util.ZPP_CompoundList","get",0xf240bf41,"zpp_nape.util.ZPP_CompoundList.get","zpp_nape/util/Lists.hx",16695,0x9f4e6754)
HX_LOCAL_STACK_FRAME(_hx_pos_4a4641d0573b027a_16689_boot,"zpp_nape.util.ZPP_CompoundList","boot",0x03201b27,"zpp_nape.util.ZPP_CompoundList.boot","zpp_nape/util/Lists.hx",16689,0x9f4e6754)
namespace zpp_nape{
namespace util{

void ZPP_CompoundList_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_4a4641d0573b027a_16681_new)
HXLINE(16736)		this->user_length = 0;
HXLINE(16735)		this->zip_length = false;
HXLINE(16734)		this->push_ite = null();
HXLINE(16733)		this->at_ite = null();
HXLINE(16732)		this->at_index = 0;
HXLINE(16694)		this->reverse_flag = false;
HXLINE(16693)		this->dontremove = false;
HXLINE(16692)		this->subber = null();
HXLINE(16691)		this->post_adder = null();
HXLINE(16690)		this->adder = null();
HXLINE(16688)		this->_modifiable = null();
HXLINE(16687)		this->_validate = null();
HXLINE(16686)		this->_invalidate = null();
HXLINE(16685)		this->_invalidated = false;
HXLINE(16684)		this->immutable = false;
HXLINE(16683)		this->inner = null();
HXLINE(16682)		this->outer = null();
HXLINE(16738)		this->inner =  ::zpp_nape::util::ZNPList_ZPP_Compound_obj::__alloc( HX_CTX );
HXLINE(16739)		this->_invalidated = true;
            	}

Dynamic ZPP_CompoundList_obj::__CreateEmpty() { return new ZPP_CompoundList_obj; }

void *ZPP_CompoundList_obj::_hx_vtable = 0;

Dynamic ZPP_CompoundList_obj::__Create(::hx::DynamicArray inArgs)
{
	::hx::ObjectPtr< ZPP_CompoundList_obj > _hx_result = new ZPP_CompoundList_obj();
	_hx_result->__construct();
	return _hx_result;
}

bool ZPP_CompoundList_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1cde5601;
}

void ZPP_CompoundList_obj::valmod(){
            	HX_STACKFRAME(&_hx_pos_4a4641d0573b027a_16702_valmod)
HXLINE(16703)		this->validate();
HXLINE(16704)		if (this->inner->modified) {
HXLINE(16705)			if (this->inner->pushmod) {
HXLINE(16705)				this->push_ite = null();
            			}
HXLINE(16706)			this->at_ite = null();
HXLINE(16707)			this->inner->modified = false;
HXLINE(16708)			this->inner->pushmod = false;
HXLINE(16709)			this->zip_length = true;
            		}
            	}
...
void ZPP_CompoundList_obj::modified(){
            	HX_STACKFRAME(&_hx_pos_4a4641d0573b027a_16712_modified)
HXLINE(16713)		this->zip_length = true;
HXLINE(16714)		this->at_ite = null();
HXLINE(16715)		this->push_ite = null();
            	}
...
void ZPP_CompoundList_obj::modify_test(){
            	HX_STACKFRAME(&_hx_pos_4a4641d0573b027a_16719_modify_test)
HXDLIN(16719)		if (::hx::IsNotNull( this->_modifiable )) {
HXDLIN(16719)			this->_modifiable();
            		}
            	}
...
void ZPP_CompoundList_obj::validate(){
            	HX_STACKFRAME(&_hx_pos_4a4641d0573b027a_16723_validate)
HXDLIN(16723)		if (this->_invalidated) {
HXLINE(16724)			this->_invalidated = false;
HXLINE(16725)			if (::hx::IsNotNull( this->_validate )) {
HXLINE(16725)				this->_validate();
            			}
            		}
            	}
...
void ZPP_CompoundList_obj::invalidate(){
            	HX_STACKFRAME(&_hx_pos_4a4641d0573b027a_16728_invalidate)
HXLINE(16729)		this->_invalidated = true;
HXLINE(16730)		if (::hx::IsNotNull( this->_invalidate )) {
HXLINE(16730)			this->_invalidate(::hx::ObjectPtr<OBJ_>(this));
            		}
            	}
...
bool ZPP_CompoundList_obj::internal;
 ...
 ::nape::phys::CompoundList ZPP_CompoundList_obj::get( ::zpp_nape::util::ZNPList_ZPP_Compound list,::hx::Null< bool >  __o_imm){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_4a4641d0573b027a_16695_get)
HXLINE(16696)		 ::nape::phys::CompoundList ret =  ::nape::phys::CompoundList_obj::__alloc( HX_CTX );
HXLINE(16697)		ret->zpp_inner->inner = list;
HXLINE(16698)		if (imm) {
HXLINE(16698)			ret->zpp_inner->immutable = true;
            		}
HXLINE(16699)		ret->zpp_inner->zip_length = true;
HXLINE(16700)		return ret;
            	}
...
::hx::ObjectPtr< ZPP_CompoundList_obj > ZPP_CompoundList_obj::__new() {
	::hx::ObjectPtr< ZPP_CompoundList_obj > __this = new ZPP_CompoundList_obj();
	__this->__construct();
	return __this;
}

::hx::ObjectPtr< ZPP_CompoundList_obj > ZPP_CompoundList_obj::__alloc(::hx::Ctx *_hx_ctx) {
	ZPP_CompoundList_obj *__this = (ZPP_CompoundList_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(ZPP_CompoundList_obj), true, "zpp_nape.util.ZPP_CompoundList"));
	*(void **)__this = ZPP_CompoundList_obj::_hx_vtable;
	__this->__construct();
	return __this;
}
...
::hx::Val ZPP_CompoundList_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
...
::hx::Val ZPP_CompoundList_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
...
static ::hx::StorageInfo ZPP_CompoundList_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::nape::phys::CompoundList */ ,(int)offsetof(ZPP_CompoundList_obj,outer),HX_("outer",7b,b8,28,37)},
	{::hx::fsObject /*  ::zpp_nape::util::ZNPList_ZPP_Compound */ ,(int)offsetof(ZPP_CompoundList_obj,inner),HX_("inner",96,31,1c,be)},
	{::hx::fsBool,(int)offsetof(ZPP_CompoundList_obj,immutable),HX_("immutable",42,28,c7,66)},
	{::hx::fsBool,(int)offsetof(ZPP_CompoundList_obj,_invalidated),HX_("_invalidated",8a,e0,b5,23)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(ZPP_CompoundList_obj,_invalidate),HX_("_invalidate",9a,e6,b3,59)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(ZPP_CompoundList_obj,_validate),HX_("_validate",f5,c7,79,4c)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(ZPP_CompoundList_obj,_modifiable),HX_("_modifiable",23,cc,cf,0c)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(ZPP_CompoundList_obj,adder),HX_("adder",ce,d4,43,1c)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(ZPP_CompoundList_obj,post_adder),HX_("post_adder",6f,28,cf,38)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(ZPP_CompoundList_obj,subber),HX_("subber",cf,fb,fd,99)},
	{::hx::fsBool,(int)offsetof(ZPP_CompoundList_obj,dontremove),HX_("dontremove",95,cf,b2,03)},
	{::hx::fsBool,(int)offsetof(ZPP_CompoundList_obj,reverse_flag),HX_("reverse_flag",29,93,06,7a)},
	{::hx::fsInt,(int)offsetof(ZPP_CompoundList_obj,at_index),HX_("at_index",86,ef,d2,3d)},
	{::hx::fsObject /*  ::zpp_nape::util::ZNPNode_ZPP_Compound */ ,(int)offsetof(ZPP_CompoundList_obj,at_ite),HX_("at_ite",8e,a1,34,d2)},
	{::hx::fsObject /*  ::zpp_nape::util::ZNPNode_ZPP_Compound */ ,(int)offsetof(ZPP_CompoundList_obj,push_ite),HX_("push_ite",f5,5d,33,23)},
	{::hx::fsBool,(int)offsetof(ZPP_CompoundList_obj,zip_length),HX_("zip_length",c4,c5,11,3c)},
	{::hx::fsInt,(int)offsetof(ZPP_CompoundList_obj,user_length),HX_("user_length",9a,c3,4e,06)},
	{ ::hx::fsUnknown, 0, null()}
};
static ::hx::StaticInfo ZPP_CompoundList_obj_sStaticStorageInfo[] = {
	{::hx::fsBool,(void *) &ZPP_CompoundList_obj::internal,HX_("internal",3d,67,76,28)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif

static ::String ZPP_CompoundList_obj_sMemberFields[] = {
...
static void ZPP_CompoundList_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ZPP_CompoundList_obj::internal,"internal");
};

#ifdef HXCPP_VISIT_ALLOCS
static void ZPP_CompoundList_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
static ::String ZPP_CompoundList_obj_sStaticFields[] = {
...
{
	ZPP_CompoundList_obj _hx_dummy;
	ZPP_CompoundList_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("zpp_nape.util.ZPP_CompoundList",99,2d,a1,4e);
	...
	__mClass->mMarkFunc = ZPP_CompoundList_obj_sMarkStatics;
	__mClass->mStatics = ::hx::Class_obj::dupFunctions(ZPP_CompoundList_obj_sStaticFields);
	__mClass->mMembers = ::hx::Class_obj::dupFunctions(ZPP_CompoundList_obj_sMemberFields);
	__mClass->mCanCast = ::hx::TCanCast< ZPP_CompoundList_obj >;
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = ZPP_CompoundList_obj_sVisitStatics;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mMemberStorageInfo = ZPP_CompoundList_obj_sMemberStorageInfo;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mStaticStorageInfo = ZPP_CompoundList_obj_sStaticStorageInfo;
#endif
...
{
{
            	HX_STACKFRAME(&_hx_pos_4a4641d0573b027a_16689_boot)
HXDLIN(16689)		internal = false;
            	}
}
